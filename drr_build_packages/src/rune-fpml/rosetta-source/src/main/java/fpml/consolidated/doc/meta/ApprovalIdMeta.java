...
import fpml.consolidated.doc.validation.ApprovalIdTypeFormatValidator;
import fpml.consolidated.doc.validation.ApprovalIdValidator;
import fpml.consolidated.doc.validation.exists.ApprovalIdOnlyExistsValidator;
...
public class ApprovalIdMeta implements RosettaMetaData<ApprovalId> {
	...
	@Override
	public Validator<? super ApprovalId> validator(ValidatorFactory factory) {
		return factory.<ApprovalId>create(ApprovalIdValidator.class);
	}

	@Override
	public Validator<? super ApprovalId> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ApprovalId>create(ApprovalIdTypeFormatValidator.class);
	}
