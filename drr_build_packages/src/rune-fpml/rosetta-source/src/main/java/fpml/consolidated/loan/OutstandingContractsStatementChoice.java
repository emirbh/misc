...
import fpml.consolidated.loan.meta.OutstandingContractsStatementChoiceMeta;
 ...
 *
 */
@RosettaDataType(value="OutstandingContractsStatementChoice", builder=OutstandingContractsStatementChoice.OutstandingContractsStatementChoiceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="OutstandingContractsStatementChoice", model="fpml", builder=OutstandingContractsStatementChoice.OutstandingContractsStatementChoiceBuilderImpl.class, version="2.1.1")
public interface OutstandingContractsStatementChoice extends RosettaModelObject {
	 ...
	 * version "confirmation-5.13"
	 *
	 * Provision A collection of loan contracts.
	 *
	 */
	 ...
	 * version "confirmation-5.13"
	 *
	 * Provision A collection of letter of credits.
	 *
	 */
	...
	class OutstandingContractsStatementChoiceBuilderImpl implements OutstandingContractsStatementChoice.OutstandingContractsStatementChoiceBuilder {
		...
		@RuneAttribute("loanContract")
		@Override
		public OutstandingContractsStatementChoice.OutstandingContractsStatementChoiceBuilder setLoanContract(LoanContract _loanContract) {
			this.loanContract = _loanContract == null ? null : _loanContract.toBuilder();
			return this;
		}
		...
		@RuneAttribute("letterOfCredit")
		@Override
		public OutstandingContractsStatementChoice.OutstandingContractsStatementChoiceBuilder setLetterOfCredit(LetterOfCredit _letterOfCredit) {
