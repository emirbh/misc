...
public class KeyValueOnlyExistsValidator implements ValidatorWithArg<KeyValue, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends KeyValue> ValidationResult<KeyValue> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("KeyValue", ValidationResult.ValidationType.ONLY_EXISTS, "KeyValue", path, "");
		}
		return failure("KeyValue", ValidationResult.ValidationType.ONLY_EXISTS, "KeyValue", path, "",
