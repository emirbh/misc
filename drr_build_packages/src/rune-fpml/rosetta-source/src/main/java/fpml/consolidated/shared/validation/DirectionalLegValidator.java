		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("DirectionalLeg", ValidationResult.ValidationType.CARDINALITY, "DirectionalLeg", path, "", res.getError());
				}
				return success("DirectionalLeg", ValidationResult.ValidationType.CARDINALITY, "DirectionalLeg", path, "");
			})
			.collect(toList());
	}
