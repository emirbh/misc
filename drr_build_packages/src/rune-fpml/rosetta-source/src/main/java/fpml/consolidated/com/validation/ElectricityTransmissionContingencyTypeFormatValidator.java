		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ElectricityTransmissionContingency", ValidationResult.ValidationType.TYPE_FORMAT, "ElectricityTransmissionContingency", path, "", res.getError());
				}
				return success("ElectricityTransmissionContingency", ValidationResult.ValidationType.TYPE_FORMAT, "ElectricityTransmissionContingency", path, "");
			})
			.collect(toList());
	}
