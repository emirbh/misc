		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CoalTransportationEquipment", ValidationResult.ValidationType.CARDINALITY, "CoalTransportationEquipment", path, "", res.getError());
				}
				return success("CoalTransportationEquipment", ValidationResult.ValidationType.CARDINALITY, "CoalTransportationEquipment", path, "");
			})
			.collect(toList());
	}
