...
public class DateListOnlyExistsValidator implements ValidatorWithArg<DateList, Set<String>> {
	...
	public <T2 extends DateList> ValidationResult<DateList> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("date", ExistenceChecker.isSet((List<ZonedDateTime>) o.getDate()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("DateList", ValidationResult.ValidationType.ONLY_EXISTS, "DateList", path, "");
		}
		return failure("DateList", ValidationResult.ValidationType.ONLY_EXISTS, "DateList", path, "",
