...
import fpml.consolidated.eq.shared.meta.BoundedCorrelationMeta;
 ...
 *
 * Provision A type describing correlation bounds, which form a cap and a floor on the realized correlation.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="BoundedCorrelation", builder=BoundedCorrelation.BoundedCorrelationBuilderImpl.class, version="2.1.1")
@RuneDataType(value="BoundedCorrelation", model="fpml", builder=BoundedCorrelation.BoundedCorrelationBuilderImpl.class, version="2.1.1")
public interface BoundedCorrelation extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Minimum Boundary as a percentage of the Strike Price.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Maximum Boundary as a percentage of the Strike Price.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class BoundedCorrelationImpl implements BoundedCorrelation {
		...
		@RuneAttribute("minimumBoundaryPercent")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("maximumBoundaryPercent")
	...
	class BoundedCorrelationBuilderImpl implements BoundedCorrelation.BoundedCorrelationBuilder {
		...
		@RuneAttribute("minimumBoundaryPercent")
		@Override
		public BoundedCorrelation.BoundedCorrelationBuilder setMinimumBoundaryPercent(BigDecimal _minimumBoundaryPercent) {
			this.minimumBoundaryPercent = _minimumBoundaryPercent == null ? null : _minimumBoundaryPercent;
			return this;
		}
		...
		@RuneAttribute("maximumBoundaryPercent")
		@Override
		public BoundedCorrelation.BoundedCorrelationBuilder setMaximumBoundaryPercent(BigDecimal _maximumBoundaryPercent) {
			this.maximumBoundaryPercent = _maximumBoundaryPercent == null ? null : _maximumBoundaryPercent;
			return this;
		}
