...
import fpml.consolidated.doc.meta.AdmissionToTradingMeta;
 ...
 *
 * Provision Information about whether and when a product was admitted to trading on a facility.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="AdmissionToTrading", builder=AdmissionToTrading.AdmissionToTradingBuilderImpl.class, version="2.1.1")
@RuneDataType(value="AdmissionToTrading", model="fpml", builder=AdmissionToTrading.AdmissionToTradingBuilderImpl.class, version="2.1.1")
public interface AdmissionToTrading extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Whether the issuer of the financial instrument has requested or approved the trading or admission to trading of their financial instruments on a trading venue.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Date and time of the request for admission to trading on the trading venue.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Date and time the issuer has approved admission to trading or trading in its financial instruments on a trading venue.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Date and time of the admission to trading on the trading venue or the date and time when the instrument was first traded or an order or quote was first received by the trading venue.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Date and time when the financial instrument ceases to be traded or to be admitted to trading on the trading venue.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class AdmissionToTradingBuilderImpl implements AdmissionToTrading.AdmissionToTradingBuilder {
		...
		@RuneAttribute("requested")
		@Override
		public AdmissionToTrading.AdmissionToTradingBuilder setRequested(Boolean _requested) {
			this.requested = _requested == null ? null : _requested;
			return this;
		}
		...
		@RuneAttribute("requestDate")
		@Override
		public AdmissionToTrading.AdmissionToTradingBuilder setRequestDate(ZonedDateTime _requestDate) {
			this.requestDate = _requestDate == null ? null : _requestDate;
			return this;
		}
		...
		@RuneAttribute("approvalDate")
		@Override
		public AdmissionToTrading.AdmissionToTradingBuilder setApprovalDate(ZonedDateTime _approvalDate) {
			this.approvalDate = _approvalDate == null ? null : _approvalDate;
			return this;
		}
		...
		@RuneAttribute("admissionDate")
		@Override
		public AdmissionToTrading.AdmissionToTradingBuilder setAdmissionDate(ZonedDateTime _admissionDate) {
			this.admissionDate = _admissionDate == null ? null : _admissionDate;
			return this;
		}
		...
		@RuneAttribute("terminationDate")
		@Override
		public AdmissionToTrading.AdmissionToTradingBuilder setTerminationDate(ZonedDateTime _terminationDate) {
