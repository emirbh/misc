...
import fpml.consolidated.shared.validation.PartialExerciseTypeFormatValidator;
import fpml.consolidated.shared.validation.PartialExerciseValidator;
import fpml.consolidated.shared.validation.datarule.PartialExerciseChoice;
import fpml.consolidated.shared.validation.exists.PartialExerciseOnlyExistsValidator;
...
public class PartialExerciseMeta implements RosettaMetaData<PartialExercise> {
	...
	public List<Validator<? super PartialExercise>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<PartialExercise>create(PartialExerciseChoice.class)
		);
	}
