...
public class EquityOptionTransactionSupplementOnlyExistsValidator implements ValidatorWithArg<EquityOptionTransactionSupplement, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends EquityOptionTransactionSupplement> ValidationResult<EquityOptionTransactionSupplement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("exchangeTradedContractNearest", ExistenceChecker.isSet((Boolean) o.getExchangeTradedContractNearest()))
		...
		if (setFields.equals(fields)) {
			return success("EquityOptionTransactionSupplement", ValidationResult.ValidationType.ONLY_EXISTS, "EquityOptionTransactionSupplement", path, "");
		}
		return failure("EquityOptionTransactionSupplement", ValidationResult.ValidationType.ONLY_EXISTS, "EquityOptionTransactionSupplement", path, "",
