 ...
 * @version 2.1.1
 */
@RosettaDataRule("MultipleExerciseChoice1")
@ImplementedBy(MultipleExerciseChoice1.Default.class)
public interface MultipleExerciseChoice1 extends Validator<MultipleExercise> {
	
	String NAME = "MultipleExerciseChoice1";
	String DEFINITION = "optional choice minimumNotionalAmount, minimumNumberOfOptions";
	
	class Default implements MultipleExerciseChoice1 {
		...
		private ComparisonResult executeDataRule(MultipleExercise multipleExercise) {
			try {
				return choice(MapperS.of(multipleExercise), Arrays.asList("minimumNotionalAmount", "minimumNumberOfOptions"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements MultipleExerciseChoice1 {
