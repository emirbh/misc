...
import fpml.consolidated.credit.event.notification.meta.RepudiationMoratoriumMeta;
 ...
 *
 */
@RosettaDataType(value="RepudiationMoratorium", builder=RepudiationMoratorium.RepudiationMoratoriumBuilderImpl.class, version="2.1.1")
@RuneDataType(value="RepudiationMoratorium", model="fpml", builder=RepudiationMoratorium.RepudiationMoratoriumBuilderImpl.class, version="2.1.1")
