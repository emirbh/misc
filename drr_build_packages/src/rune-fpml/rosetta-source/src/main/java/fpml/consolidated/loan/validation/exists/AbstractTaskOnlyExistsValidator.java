...
public class AbstractTaskOnlyExistsValidator implements ValidatorWithArg<AbstractTask, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractTask> ValidationResult<AbstractTask> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractTask", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractTask", path, "");
		}
		return failure("AbstractTask", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractTask", path, "",
