...
import fpml.consolidated.credit.event.notification.meta.ObligationAccelerationEventMeta;
 ...
 *
 */
@RosettaDataType(value="ObligationAccelerationEvent", builder=ObligationAccelerationEvent.ObligationAccelerationEventBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ObligationAccelerationEvent", model="fpml", builder=ObligationAccelerationEvent.ObligationAccelerationEventBuilderImpl.class, version="2.1.1")
