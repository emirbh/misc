		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeChangeContent", ValidationResult.ValidationType.TYPE_FORMAT, "TradeChangeContent", path, "", res.getError());
				}
				return success("TradeChangeContent", ValidationResult.ValidationType.TYPE_FORMAT, "TradeChangeContent", path, "");
			})
			.collect(toList());
	}
