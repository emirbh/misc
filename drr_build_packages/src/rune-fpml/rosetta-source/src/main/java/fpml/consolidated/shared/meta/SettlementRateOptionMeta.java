...
import fpml.consolidated.shared.validation.SettlementRateOptionTypeFormatValidator;
import fpml.consolidated.shared.validation.SettlementRateOptionValidator;
import fpml.consolidated.shared.validation.exists.SettlementRateOptionOnlyExistsValidator;
...
public class SettlementRateOptionMeta implements RosettaMetaData<SettlementRateOption> {
	...
	@Override
	public Validator<? super SettlementRateOption> validator(ValidatorFactory factory) {
		return factory.<SettlementRateOption>create(SettlementRateOptionValidator.class);
	}

	@Override
	public Validator<? super SettlementRateOption> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SettlementRateOption>create(SettlementRateOptionTypeFormatValidator.class);
	}
