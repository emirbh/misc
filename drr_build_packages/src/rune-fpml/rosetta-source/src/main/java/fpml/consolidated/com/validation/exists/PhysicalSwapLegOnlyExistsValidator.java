...
public class PhysicalSwapLegOnlyExistsValidator implements ValidatorWithArg<PhysicalSwapLeg, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends PhysicalSwapLeg> ValidationResult<PhysicalSwapLeg> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("PhysicalSwapLeg", ValidationResult.ValidationType.ONLY_EXISTS, "PhysicalSwapLeg", path, "");
		}
		return failure("PhysicalSwapLeg", ValidationResult.ValidationType.ONLY_EXISTS, "PhysicalSwapLeg", path, "",
