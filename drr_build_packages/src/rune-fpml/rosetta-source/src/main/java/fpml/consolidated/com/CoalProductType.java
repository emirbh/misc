...
import fpml.consolidated.com.meta.CoalProductTypeMeta;
 ...
 *
 * Provision A scheme identifying the types of coal for a physically settled coal trade.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CoalProductType", builder=CoalProductType.CoalProductTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CoalProductType", model="fpml", builder=CoalProductType.CoalProductTypeBuilderImpl.class, version="2.1.1")
public interface CoalProductType extends RosettaModelObject {
	...
	class CoalProductTypeImpl implements CoalProductType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("commodityCoalProductTypeScheme")
	...
	class CoalProductTypeBuilderImpl implements CoalProductType.CoalProductTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CoalProductType.CoalProductTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("commodityCoalProductTypeScheme")
		@Override
		public CoalProductType.CoalProductTypeBuilder setCommodityCoalProductTypeScheme(String _commodityCoalProductTypeScheme) {
			this.commodityCoalProductTypeScheme = _commodityCoalProductTypeScheme == null ? null : _commodityCoalProductTypeScheme;
			return this;
		}
