		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TaxFormType", ValidationResult.ValidationType.CARDINALITY, "TaxFormType", path, "", res.getError());
				}
				return success("TaxFormType", ValidationResult.ValidationType.CARDINALITY, "TaxFormType", path, "");
			})
			.collect(toList());
	}
