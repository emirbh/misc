...
import fpml.consolidated.ird.validation.CalculationPeriodDatesReferenceTypeFormatValidator;
import fpml.consolidated.ird.validation.CalculationPeriodDatesReferenceValidator;
import fpml.consolidated.ird.validation.exists.CalculationPeriodDatesReferenceOnlyExistsValidator;
...
public class CalculationPeriodDatesReferenceMeta implements RosettaMetaData<CalculationPeriodDatesReference> {
	...
	@Override
	public Validator<? super CalculationPeriodDatesReference> validator(ValidatorFactory factory) {
		return factory.<CalculationPeriodDatesReference>create(CalculationPeriodDatesReferenceValidator.class);
	}

	@Override
	public Validator<? super CalculationPeriodDatesReference> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CalculationPeriodDatesReference>create(CalculationPeriodDatesReferenceTypeFormatValidator.class);
	}
