...
public class CollateralAllocationAcknowledgementTypeFormatValidator implements Validator<CollateralAllocationAcknowledgement> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CollateralAllocationAcknowledgement", ValidationResult.ValidationType.TYPE_FORMAT, "CollateralAllocationAcknowledgement", path, "", res.getError());
				}
				return success("CollateralAllocationAcknowledgement", ValidationResult.ValidationType.TYPE_FORMAT, "CollateralAllocationAcknowledgement", path, "");
			})
			.collect(toList());
	}
