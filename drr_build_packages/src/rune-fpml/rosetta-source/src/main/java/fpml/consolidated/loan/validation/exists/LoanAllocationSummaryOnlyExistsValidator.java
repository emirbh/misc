...
public class LoanAllocationSummaryOnlyExistsValidator implements ValidatorWithArg<LoanAllocationSummary, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationSummary> ValidationResult<LoanAllocationSummary> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationSummary", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationSummary", path, "");
		}
		return failure("LoanAllocationSummary", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationSummary", path, "",
