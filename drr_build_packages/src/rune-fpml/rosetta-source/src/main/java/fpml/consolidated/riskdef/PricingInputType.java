...
import fpml.consolidated.riskdef.meta.PricingInputTypeMeta;
 ...
 *
 */
@RosettaDataType(value="PricingInputType", builder=PricingInputType.PricingInputTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PricingInputType", model="fpml", builder=PricingInputType.PricingInputTypeBuilderImpl.class, version="2.1.1")
public interface PricingInputType extends RosettaModelObject {
	...
	class PricingInputTypeImpl implements PricingInputType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("pricingInputTypeScheme")
	...
	class PricingInputTypeBuilderImpl implements PricingInputType.PricingInputTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public PricingInputType.PricingInputTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("pricingInputTypeScheme")
		@Override
		public PricingInputType.PricingInputTypeBuilder setPricingInputTypeScheme(String _pricingInputTypeScheme) {
			this.pricingInputTypeScheme = _pricingInputTypeScheme == null ? null : _pricingInputTypeScheme;
			return this;
		}
