...
import fpml.consolidated.doc.meta.InstrumentTradePrincipalMeta;
 ...
 *
 * Provision A structure describing the value in "native" currency of an instrument that was traded.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="InstrumentTradePrincipal", builder=InstrumentTradePrincipal.InstrumentTradePrincipalBuilderImpl.class, version="2.1.1")
@RuneDataType(value="InstrumentTradePrincipal", model="fpml", builder=InstrumentTradePrincipal.InstrumentTradePrincipalBuilderImpl.class, version="2.1.1")
public interface InstrumentTradePrincipal extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The net and/or gross value of the amount traded in native currency.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class InstrumentTradePrincipalBuilderImpl implements InstrumentTradePrincipal.InstrumentTradePrincipalBuilder {
		...
		@RuneAttribute("principalAmount")
		@Override
		public InstrumentTradePrincipal.InstrumentTradePrincipalBuilder setPrincipalAmount(NetAndGross _principalAmount) {
