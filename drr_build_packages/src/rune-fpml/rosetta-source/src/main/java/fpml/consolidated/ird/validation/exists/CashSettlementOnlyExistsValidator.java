...
public class CashSettlementOnlyExistsValidator implements ValidatorWithArg<CashSettlement, Set<String>> {
	...
	public <T2 extends CashSettlement> ValidationResult<CashSettlement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("midMarketValuation", ExistenceChecker.isSet((MidMarketValuation) o.getMidMarketValuation()))
				.put("replacementValue", ExistenceChecker.isSet((ReplacementValue) o.getReplacementValue()))
				.put("parYieldCurveUnadjustedMethod", ExistenceChecker.isSet((YieldCurveMethod) o.getParYieldCurveUnadjustedMethod()))
				.put("collateralizedCashPriceMethod", ExistenceChecker.isSet((CollateralizedCashPriceMethod) o.getCollateralizedCashPriceMethod()))
		...
		if (setFields.equals(fields)) {
			return success("CashSettlement", ValidationResult.ValidationType.ONLY_EXISTS, "CashSettlement", path, "");
		}
		return failure("CashSettlement", ValidationResult.ValidationType.ONLY_EXISTS, "CashSettlement", path, "",
