...
public class ValuationReportExceptionOnlyExistsValidator implements ValidatorWithArg<ValuationReportException, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ValuationReportException> ValidationResult<ValuationReportException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ValuationReportException", ValidationResult.ValidationType.ONLY_EXISTS, "ValuationReportException", path, "");
		}
		return failure("ValuationReportException", ValidationResult.ValidationType.ONLY_EXISTS, "ValuationReportException", path, "",
