 ...
 *
 */
@RosettaDataType(value="OptionStrike", builder=OptionStrike.OptionStrikeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="OptionStrike", model="fpml", builder=OptionStrike.OptionStrikeBuilderImpl.class, version="2.1.1")
public interface OptionStrike extends OptionNumericStrike {
	...
	class OptionStrikeBuilderImpl extends OptionNumericStrike.OptionNumericStrikeBuilderImpl implements OptionStrike.OptionStrikeBuilder {
		...
		@Override
		public OptionStrike.OptionStrikeBuilder setStrikePrice(BigDecimal _strikePrice) {
		...
		@Override
		public OptionStrike.OptionStrikeBuilder setStrikePercentage(BigDecimal _strikePercentage) {
		...
		@RuneAttribute("currency")
		@Override
		public OptionStrike.OptionStrikeBuilder setCurrency(Currency _currency) {
