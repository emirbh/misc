		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ExecutionAdviceAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "ExecutionAdviceAcknowledgement", path, "", res.getError());
				}
				return success("ExecutionAdviceAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "ExecutionAdviceAcknowledgement", path, "");
			})
			.collect(toList());
	}
