...
public class PrincipalExchangeOnlyExistsValidator implements ValidatorWithArg<PrincipalExchange, Set<String>> {
	...
	public <T2 extends PrincipalExchange> ValidationResult<PrincipalExchange> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("unadjustedPrincipalExchangeDate", ExistenceChecker.isSet((ZonedDateTime) o.getUnadjustedPrincipalExchangeDate()))
				.put("adjustedPrincipalExchangeDate", ExistenceChecker.isSet((ZonedDateTime) o.getAdjustedPrincipalExchangeDate()))
		...
		if (setFields.equals(fields)) {
			return success("PrincipalExchange", ValidationResult.ValidationType.ONLY_EXISTS, "PrincipalExchange", path, "");
		}
		return failure("PrincipalExchange", ValidationResult.ValidationType.ONLY_EXISTS, "PrincipalExchange", path, "",
