...
import fpml.consolidated.loan.validation.RevolverTypeFormatValidator;
import fpml.consolidated.loan.validation.RevolverValidator;
import fpml.consolidated.loan.validation.exists.RevolverOnlyExistsValidator;
...
public class RevolverMeta implements RosettaMetaData<Revolver> {
	...
	@Override
	public Validator<? super Revolver> validator(ValidatorFactory factory) {
		return factory.<Revolver>create(RevolverValidator.class);
	}

	@Override
	public Validator<? super Revolver> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Revolver>create(RevolverTypeFormatValidator.class);
	}
