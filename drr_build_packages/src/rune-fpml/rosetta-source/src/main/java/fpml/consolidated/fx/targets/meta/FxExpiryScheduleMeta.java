...
import fpml.consolidated.fx.targets.validation.FxExpiryScheduleTypeFormatValidator;
import fpml.consolidated.fx.targets.validation.FxExpiryScheduleValidator;
...
import fpml.consolidated.fx.targets.validation.exists.FxExpiryScheduleOnlyExistsValidator;
...
public class FxExpiryScheduleMeta implements RosettaMetaData<FxExpirySchedule> {
	...
	@Override
	public Validator<? super FxExpirySchedule> validator(ValidatorFactory factory) {
		return factory.<FxExpirySchedule>create(FxExpiryScheduleValidator.class);
	}

	@Override
	public Validator<? super FxExpirySchedule> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FxExpirySchedule>create(FxExpiryScheduleTypeFormatValidator.class);
	}
