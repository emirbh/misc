		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanTradeNotification", ValidationResult.ValidationType.TYPE_FORMAT, "LoanTradeNotification", path, "", res.getError());
				}
				return success("LoanTradeNotification", ValidationResult.ValidationType.TYPE_FORMAT, "LoanTradeNotification", path, "");
			})
			.collect(toList());
	}
