...
import fpml.consolidated.loan.validation.AssociationToAssetIdTypeFormatValidator;
import fpml.consolidated.loan.validation.AssociationToAssetIdValidator;
import fpml.consolidated.loan.validation.exists.AssociationToAssetIdOnlyExistsValidator;
...
public class AssociationToAssetIdMeta implements RosettaMetaData<AssociationToAssetId> {
	...
	@Override
	public Validator<? super AssociationToAssetId> validator(ValidatorFactory factory) {
		return factory.<AssociationToAssetId>create(AssociationToAssetIdValidator.class);
	}

	@Override
	public Validator<? super AssociationToAssetId> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssociationToAssetId>create(AssociationToAssetIdTypeFormatValidator.class);
	}
