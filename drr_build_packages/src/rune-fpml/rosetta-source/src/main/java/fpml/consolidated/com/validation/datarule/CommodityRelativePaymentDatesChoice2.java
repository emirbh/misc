 ...
 * @version 2.1.1
 */
@RosettaDataRule("CommodityRelativePaymentDatesChoice2")
@ImplementedBy(CommodityRelativePaymentDatesChoice2.Default.class)
public interface CommodityRelativePaymentDatesChoice2 extends Validator<CommodityRelativePaymentDates> {
	
	String NAME = "CommodityRelativePaymentDatesChoice2";
	...
	class Default implements CommodityRelativePaymentDatesChoice2 {
		...
		private ComparisonResult executeDataRule(CommodityRelativePaymentDates commodityRelativePaymentDates) {
			try {
				return choice(MapperS.of(commodityRelativePaymentDates), Arrays.asList("calculationPeriodsReference", "calculationPeriodsScheduleReference", "calculationPeriodsDatesReference"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements CommodityRelativePaymentDatesChoice2 {
