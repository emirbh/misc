...
public class CommodityNotionalQuantityScheduleValidator implements Validator<CommodityNotionalQuantitySchedule> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityNotionalQuantitySchedule", ValidationResult.ValidationType.CARDINALITY, "CommodityNotionalQuantitySchedule", path, "", res.getError());
				}
				return success("CommodityNotionalQuantitySchedule", ValidationResult.ValidationType.CARDINALITY, "CommodityNotionalQuantitySchedule", path, "");
			})
			.collect(toList());
	}
