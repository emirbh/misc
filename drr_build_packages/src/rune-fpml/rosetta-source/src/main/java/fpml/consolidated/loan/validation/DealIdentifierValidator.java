...
public class DealIdentifierValidator implements Validator<DealIdentifier> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("DealIdentifier", ValidationResult.ValidationType.CARDINALITY, "DealIdentifier", path, "", res.getError());
				}
				return success("DealIdentifier", ValidationResult.ValidationType.CARDINALITY, "DealIdentifier", path, "");
			})
			.collect(toList());
	}
