...
public class FixedLegOnlyExistsValidator implements ValidatorWithArg<FixedLeg, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FixedLeg> ValidationResult<FixedLeg> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FixedLeg", ValidationResult.ValidationType.ONLY_EXISTS, "FixedLeg", path, "");
		}
		return failure("FixedLeg", ValidationResult.ValidationType.ONLY_EXISTS, "FixedLeg", path, "",
