		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ServiceProcessingCycle", ValidationResult.ValidationType.CARDINALITY, "ServiceProcessingCycle", path, "", res.getError());
				}
				return success("ServiceProcessingCycle", ValidationResult.ValidationType.CARDINALITY, "ServiceProcessingCycle", path, "");
			})
			.collect(toList());
	}
