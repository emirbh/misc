...
import fpml.consolidated.option.shared.validation.TriggerTypeFormatValidator;
import fpml.consolidated.option.shared.validation.TriggerValidator;
import fpml.consolidated.option.shared.validation.datarule.TriggerChoice;
import fpml.consolidated.option.shared.validation.exists.TriggerOnlyExistsValidator;
...
public class TriggerMeta implements RosettaMetaData<Trigger> {
	...
	public List<Validator<? super Trigger>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<Trigger>create(TriggerChoice.class)
		);
	}
