...
import fpml.consolidated.com.meta.CommodityDeliveryPointMeta;
 ...
 *
 * Provision A scheme identifying the types of the Delivery Point for a physically settled commodity trade.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CommodityDeliveryPoint", builder=CommodityDeliveryPoint.CommodityDeliveryPointBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityDeliveryPoint", model="fpml", builder=CommodityDeliveryPoint.CommodityDeliveryPointBuilderImpl.class, version="2.1.1")
public interface CommodityDeliveryPoint extends RosettaModelObject {
	...
	class CommodityDeliveryPointBuilderImpl implements CommodityDeliveryPoint.CommodityDeliveryPointBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CommodityDeliveryPoint.CommodityDeliveryPointBuilder setValue(String _value) {
		...
		@RuneAttribute("deliveryPointScheme")
		@Override
		public CommodityDeliveryPoint.CommodityDeliveryPointBuilder setDeliveryPointScheme(String _deliveryPointScheme) {
