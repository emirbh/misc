...
public class RepoChoiceOnlyExistsValidator implements ValidatorWithArg<RepoChoice, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RepoChoice> ValidationResult<RepoChoice> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RepoChoice", ValidationResult.ValidationType.ONLY_EXISTS, "RepoChoice", path, "");
		}
		return failure("RepoChoice", ValidationResult.ValidationType.ONLY_EXISTS, "RepoChoice", path, "",
