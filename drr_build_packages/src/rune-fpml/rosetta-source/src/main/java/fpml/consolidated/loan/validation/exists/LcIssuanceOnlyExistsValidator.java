...
public class LcIssuanceOnlyExistsValidator implements ValidatorWithArg<LcIssuance, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LcIssuance> ValidationResult<LcIssuance> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LcIssuance", ValidationResult.ValidationType.ONLY_EXISTS, "LcIssuance", path, "");
		}
		return failure("LcIssuance", ValidationResult.ValidationType.ONLY_EXISTS, "LcIssuance", path, "",
