...
import fpml.consolidated.shared.meta.RelativeDatesMeta;
 ...
 *
 * Provision A type describing a set of dates defined as relative to another set of dates.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="RelativeDates", builder=RelativeDates.RelativeDatesBuilderImpl.class, version="2.1.1")
@RuneDataType(value="RelativeDates", model="fpml", builder=RelativeDates.RelativeDatesBuilderImpl.class, version="2.1.1")
public interface RelativeDates extends RelativeDateOffset {
	...
	interface RelativeDatesBuilder extends RelativeDates, RelativeDateOffset.RelativeDateOffsetBuilder {
		...
		@Override
		RelativeDates.RelativeDatesBuilder setBusinessCentersReference(BusinessCentersReference businessCentersReference);
		@Override
	...
	class RelativeDatesBuilderImpl extends RelativeDateOffset.RelativeDateOffsetBuilderImpl implements RelativeDates.RelativeDatesBuilder {
		...
		@RuneAttribute("id")
		@Override
		public RelativeDates.RelativeDatesBuilder setId(String _id) {
		...
		@Override
		public RelativeDates.RelativeDatesBuilder setBusinessCentersReference(BusinessCentersReference _businessCentersReference) {
		...
		@Override
		public RelativeDates.RelativeDatesBuilder setDateRelativeTo(DateReference _dateRelativeTo) {
		...
		@Override
		public RelativeDates.RelativeDatesBuilder setAdjustedDate(IdentifiedDate _adjustedDate) {
