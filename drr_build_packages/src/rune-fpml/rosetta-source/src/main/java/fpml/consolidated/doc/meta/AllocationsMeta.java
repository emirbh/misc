...
import fpml.consolidated.doc.validation.AllocationsTypeFormatValidator;
import fpml.consolidated.doc.validation.AllocationsValidator;
import fpml.consolidated.doc.validation.exists.AllocationsOnlyExistsValidator;
...
public class AllocationsMeta implements RosettaMetaData<Allocations> {
	...
	@Override
	public Validator<? super Allocations> validator(ValidatorFactory factory) {
		return factory.<Allocations>create(AllocationsValidator.class);
	}

	@Override
	public Validator<? super Allocations> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Allocations>create(AllocationsTypeFormatValidator.class);
	}
