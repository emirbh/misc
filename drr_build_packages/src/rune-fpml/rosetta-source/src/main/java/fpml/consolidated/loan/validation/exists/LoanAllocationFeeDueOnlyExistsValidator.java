...
public class LoanAllocationFeeDueOnlyExistsValidator implements ValidatorWithArg<LoanAllocationFeeDue, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationFeeDue> ValidationResult<LoanAllocationFeeDue> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationFeeDue", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationFeeDue", path, "");
		}
		return failure("LoanAllocationFeeDue", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationFeeDue", path, "",
