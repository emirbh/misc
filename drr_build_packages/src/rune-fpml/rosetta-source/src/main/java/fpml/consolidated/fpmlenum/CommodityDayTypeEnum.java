...
public enum CommodityDayTypeEnum {
	 ...
	 *
	 */
	@RosettaEnumValue(value = "CommodityBusiness") 
	COMMODITY_BUSINESS("CommodityBusiness", null),
	 ...
	 *
	 */
	@RosettaEnumValue(value = "GasFlow") 
	GAS_FLOW("GasFlow", null),
	 ...
	 *
	 */
	@RosettaEnumValue(value = "NearbyContractDay") 
	NEARBY_CONTRACT_DAY("NearbyContractDay", null)
;
