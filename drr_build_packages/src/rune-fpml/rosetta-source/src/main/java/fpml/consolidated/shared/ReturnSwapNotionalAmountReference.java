...
import fpml.consolidated.shared.meta.ReturnSwapNotionalAmountReferenceMeta;
 ...
 *
 */
@RosettaDataType(value="ReturnSwapNotionalAmountReference", builder=ReturnSwapNotionalAmountReference.ReturnSwapNotionalAmountReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ReturnSwapNotionalAmountReference", model="fpml", builder=ReturnSwapNotionalAmountReference.ReturnSwapNotionalAmountReferenceBuilderImpl.class, version="2.1.1")
public interface ReturnSwapNotionalAmountReference extends Reference {
	...
	class ReturnSwapNotionalAmountReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements ReturnSwapNotionalAmountReference.ReturnSwapNotionalAmountReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public ReturnSwapNotionalAmountReference.ReturnSwapNotionalAmountReferenceBuilder setHref(String _href) {
