		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ClearanceSystem", ValidationResult.ValidationType.CARDINALITY, "ClearanceSystem", path, "", res.getError());
				}
				return success("ClearanceSystem", ValidationResult.ValidationType.CARDINALITY, "ClearanceSystem", path, "");
			})
			.collect(toList());
	}
