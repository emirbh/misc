		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PartyProfileId", ValidationResult.ValidationType.CARDINALITY, "PartyProfileId", path, "", res.getError());
				}
				return success("PartyProfileId", ValidationResult.ValidationType.CARDINALITY, "PartyProfileId", path, "");
			})
			.collect(toList());
	}
