		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("Documentation", ValidationResult.ValidationType.TYPE_FORMAT, "Documentation", path, "", res.getError());
				}
				return success("Documentation", ValidationResult.ValidationType.TYPE_FORMAT, "Documentation", path, "");
			})
			.collect(toList());
	}
