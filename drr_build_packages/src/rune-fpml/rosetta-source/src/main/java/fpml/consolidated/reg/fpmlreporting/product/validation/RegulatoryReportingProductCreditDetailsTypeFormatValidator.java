...
public class RegulatoryReportingProductCreditDetailsTypeFormatValidator implements Validator<RegulatoryReportingProductCreditDetails> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RegulatoryReportingProductCreditDetails", ValidationResult.ValidationType.TYPE_FORMAT, "RegulatoryReportingProductCreditDetails", path, "", res.getError());
				}
				return success("RegulatoryReportingProductCreditDetails", ValidationResult.ValidationType.TYPE_FORMAT, "RegulatoryReportingProductCreditDetails", path, "");
			})
			.collect(toList());
	}
