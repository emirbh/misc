		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityMetalShape", ValidationResult.ValidationType.CARDINALITY, "CommodityMetalShape", path, "", res.getError());
				}
				return success("CommodityMetalShape", ValidationResult.ValidationType.CARDINALITY, "CommodityMetalShape", path, "");
			})
			.collect(toList());
	}
