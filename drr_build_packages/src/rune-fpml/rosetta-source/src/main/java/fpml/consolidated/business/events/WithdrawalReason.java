...
import fpml.consolidated.business.events.meta.WithdrawalReasonMeta;
 ...
 *
 * Provision A type that describes why a trade was withdrawn.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="WithdrawalReason", builder=WithdrawalReason.WithdrawalReasonBuilderImpl.class, version="2.1.1")
@RuneDataType(value="WithdrawalReason", model="fpml", builder=WithdrawalReason.WithdrawalReasonBuilderImpl.class, version="2.1.1")
public interface WithdrawalReason extends RosettaModelObject {
	...
	class WithdrawalReasonImpl implements WithdrawalReason {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("withdrawalReasonScheme")
	...
	class WithdrawalReasonBuilderImpl implements WithdrawalReason.WithdrawalReasonBuilder {
		...
		@RuneAttribute("value")
		@Override
		public WithdrawalReason.WithdrawalReasonBuilder setValue(String _value) {
		...
		@RuneAttribute("withdrawalReasonScheme")
		@Override
		public WithdrawalReason.WithdrawalReasonBuilder setWithdrawalReasonScheme(String _withdrawalReasonScheme) {
			this.withdrawalReasonScheme = _withdrawalReasonScheme == null ? null : _withdrawalReasonScheme;
			return this;
		}
