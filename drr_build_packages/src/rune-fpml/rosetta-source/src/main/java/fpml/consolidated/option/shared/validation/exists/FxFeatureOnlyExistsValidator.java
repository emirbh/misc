...
public class FxFeatureOnlyExistsValidator implements ValidatorWithArg<FxFeature, Set<String>> {
	...
	public <T2 extends FxFeature> ValidationResult<FxFeature> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("referenceCurrency", ExistenceChecker.isSet((IdentifiedCurrency) o.getReferenceCurrency()))
		...
		if (setFields.equals(fields)) {
			return success("FxFeature", ValidationResult.ValidationType.ONLY_EXISTS, "FxFeature", path, "");
		}
		return failure("FxFeature", ValidationResult.ValidationType.ONLY_EXISTS, "FxFeature", path, "",
