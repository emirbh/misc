...
public class LegacyInterestPaymentOnlyExistsValidator implements ValidatorWithArg<LegacyInterestPayment, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LegacyInterestPayment> ValidationResult<LegacyInterestPayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LegacyInterestPayment", ValidationResult.ValidationType.ONLY_EXISTS, "LegacyInterestPayment", path, "");
		}
		return failure("LegacyInterestPayment", ValidationResult.ValidationType.ONLY_EXISTS, "LegacyInterestPayment", path, "",
