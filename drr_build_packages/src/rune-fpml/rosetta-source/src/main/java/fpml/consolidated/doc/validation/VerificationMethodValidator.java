		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("VerificationMethod", ValidationResult.ValidationType.CARDINALITY, "VerificationMethod", path, "", res.getError());
				}
				return success("VerificationMethod", ValidationResult.ValidationType.CARDINALITY, "VerificationMethod", path, "");
			})
			.collect(toList());
	}
