		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PartyRoleType", ValidationResult.ValidationType.CARDINALITY, "PartyRoleType", path, "", res.getError());
				}
				return success("PartyRoleType", ValidationResult.ValidationType.CARDINALITY, "PartyRoleType", path, "");
			})
			.collect(toList());
	}
