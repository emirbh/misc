...
public class RegulatoryClassificationMifirRTS22_2015OnlyExistsValidator implements ValidatorWithArg<RegulatoryClassificationMifirRTS22_2015, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RegulatoryClassificationMifirRTS22_2015> ValidationResult<RegulatoryClassificationMifirRTS22_2015> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RegulatoryClassificationMifirRTS22_2015", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryClassificationMifirRTS22_2015", path, "");
		}
		return failure("RegulatoryClassificationMifirRTS22_2015", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryClassificationMifirRTS22_2015", path, "",
