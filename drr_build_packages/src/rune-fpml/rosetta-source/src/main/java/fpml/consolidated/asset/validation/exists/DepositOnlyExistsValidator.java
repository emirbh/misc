...
public class DepositOnlyExistsValidator implements ValidatorWithArg<Deposit, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends Deposit> ValidationResult<Deposit> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("Deposit", ValidationResult.ValidationType.ONLY_EXISTS, "Deposit", path, "");
		}
		return failure("Deposit", ValidationResult.ValidationType.ONLY_EXISTS, "Deposit", path, "",
