...
public class CollateralOnlyExistsValidator implements ValidatorWithArg<Collateral, Set<String>> {
	...
	public <T2 extends Collateral> ValidationResult<Collateral> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("independentAmount", ExistenceChecker.isSet((List<? extends IndependentAmount>) o.getIndependentAmount()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Collateral", ValidationResult.ValidationType.ONLY_EXISTS, "Collateral", path, "");
		}
		return failure("Collateral", ValidationResult.ValidationType.ONLY_EXISTS, "Collateral", path, "",
