...
public class FacilityPrepaymentFeePaymentOnlyExistsValidator implements ValidatorWithArg<FacilityPrepaymentFeePayment, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FacilityPrepaymentFeePayment> ValidationResult<FacilityPrepaymentFeePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FacilityPrepaymentFeePayment", ValidationResult.ValidationType.ONLY_EXISTS, "FacilityPrepaymentFeePayment", path, "");
		}
		return failure("FacilityPrepaymentFeePayment", ValidationResult.ValidationType.ONLY_EXISTS, "FacilityPrepaymentFeePayment", path, "",
