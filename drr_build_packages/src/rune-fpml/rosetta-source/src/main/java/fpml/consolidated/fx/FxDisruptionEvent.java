...
import fpml.consolidated.fx.meta.FxDisruptionEventMeta;
 ...
 *
 * Provision The base class for all disruption events
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FxDisruptionEvent", builder=FxDisruptionEvent.FxDisruptionEventBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxDisruptionEvent", model="fpml", builder=FxDisruptionEvent.FxDisruptionEventBuilderImpl.class, version="2.1.1")
