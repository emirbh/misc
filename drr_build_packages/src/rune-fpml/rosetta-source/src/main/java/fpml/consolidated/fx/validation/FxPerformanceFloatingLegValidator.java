		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxPerformanceFloatingLeg", ValidationResult.ValidationType.CARDINALITY, "FxPerformanceFloatingLeg", path, "", res.getError());
				}
				return success("FxPerformanceFloatingLeg", ValidationResult.ValidationType.CARDINALITY, "FxPerformanceFloatingLeg", path, "");
			})
			.collect(toList());
	}
