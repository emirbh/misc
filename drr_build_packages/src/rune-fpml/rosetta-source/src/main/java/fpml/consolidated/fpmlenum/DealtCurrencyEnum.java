...
public enum DealtCurrencyEnum {
	 ...
	 *
	 */
	@RosettaEnumValue(value = "ExchangedCurrency1") 
	EXCHANGED_CURRENCY_1("ExchangedCurrency1", null),
	 ...
	 *
	 */
	@RosettaEnumValue(value = "ExchangedCurrency2") 
	EXCHANGED_CURRENCY_2("ExchangedCurrency2", null)
;
