		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PartyName", ValidationResult.ValidationType.TYPE_FORMAT, "PartyName", path, "", res.getError());
				}
				return success("PartyName", ValidationResult.ValidationType.TYPE_FORMAT, "PartyName", path, "");
			})
			.collect(toList());
	}
