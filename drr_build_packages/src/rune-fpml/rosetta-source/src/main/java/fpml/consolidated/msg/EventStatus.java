...
import fpml.consolidated.msg.meta.EventStatusMeta;
 ...
 *
 * Provision A coding scheme used to describe the matching/confirmation status of a trade, post-trade event, position, or cash flows.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="EventStatus", builder=EventStatus.EventStatusBuilderImpl.class, version="2.1.1")
@RuneDataType(value="EventStatus", model="fpml", builder=EventStatus.EventStatusBuilderImpl.class, version="2.1.1")
public interface EventStatus extends RosettaModelObject {
	...
	class EventStatusImpl implements EventStatus {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("eventStatusScheme")
	...
	class EventStatusBuilderImpl implements EventStatus.EventStatusBuilder {
		...
		@RuneAttribute("value")
		@Override
		public EventStatus.EventStatusBuilder setValue(String _value) {
		...
		@RuneAttribute("eventStatusScheme")
		@Override
		public EventStatus.EventStatusBuilder setEventStatusScheme(String _eventStatusScheme) {
			this.eventStatusScheme = _eventStatusScheme == null ? null : _eventStatusScheme;
			return this;
		}
