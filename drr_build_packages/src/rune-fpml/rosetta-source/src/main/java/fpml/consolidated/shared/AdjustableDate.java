...
import fpml.consolidated.shared.meta.AdjustableDateMeta;
 ...
 *
 */
@RosettaDataType(value="AdjustableDate", builder=AdjustableDate.AdjustableDateBuilderImpl.class, version="2.1.1")
@RuneDataType(value="AdjustableDate", model="fpml", builder=AdjustableDate.AdjustableDateBuilderImpl.class, version="2.1.1")
public interface AdjustableDate extends RosettaModelObject {
	...
	class AdjustableDateBuilderImpl implements AdjustableDate.AdjustableDateBuilder {
		...
		@RuneAttribute("id")
		@Override
		public AdjustableDate.AdjustableDateBuilder setId(String _id) {
		...
		@RuneAttribute("unadjustedDate")
		@Override
		public AdjustableDate.AdjustableDateBuilder setUnadjustedDate(IdentifiedDate _unadjustedDate) {
		...
		@RuneAttribute("adjustedDate")
		@Override
		public AdjustableDate.AdjustableDateBuilder setAdjustedDate(IdentifiedDate _adjustedDate) {
