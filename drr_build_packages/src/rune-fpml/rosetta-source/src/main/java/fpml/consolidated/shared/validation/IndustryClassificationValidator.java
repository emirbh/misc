		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("IndustryClassification", ValidationResult.ValidationType.CARDINALITY, "IndustryClassification", path, "", res.getError());
				}
				return success("IndustryClassification", ValidationResult.ValidationType.CARDINALITY, "IndustryClassification", path, "");
			})
			.collect(toList());
	}
