...
import fpml.consolidated.msg.validation.PartyMessageInformationTypeFormatValidator;
import fpml.consolidated.msg.validation.PartyMessageInformationValidator;
import fpml.consolidated.msg.validation.exists.PartyMessageInformationOnlyExistsValidator;
...
public class PartyMessageInformationMeta implements RosettaMetaData<PartyMessageInformation> {
	...
	@Override
	public Validator<? super PartyMessageInformation> validator(ValidatorFactory factory) {
		return factory.<PartyMessageInformation>create(PartyMessageInformationValidator.class);
	}

	@Override
	public Validator<? super PartyMessageInformation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PartyMessageInformation>create(PartyMessageInformationTypeFormatValidator.class);
	}
