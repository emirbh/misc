...
public class SettledEntityMatrixOnlyExistsValidator implements ValidatorWithArg<SettledEntityMatrix, Set<String>> {
	...
	public <T2 extends SettledEntityMatrix> ValidationResult<SettledEntityMatrix> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("matrixSource", ExistenceChecker.isSet((MatrixSource) o.getMatrixSource()))
		...
		if (setFields.equals(fields)) {
			return success("SettledEntityMatrix", ValidationResult.ValidationType.ONLY_EXISTS, "SettledEntityMatrix", path, "");
		}
		return failure("SettledEntityMatrix", ValidationResult.ValidationType.ONLY_EXISTS, "SettledEntityMatrix", path, "",
