...
public class LcTerminationOnlyExistsValidator implements ValidatorWithArg<LcTermination, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LcTermination> ValidationResult<LcTermination> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LcTermination", ValidationResult.ValidationType.ONLY_EXISTS, "LcTermination", path, "");
		}
		return failure("LcTermination", ValidationResult.ValidationType.ONLY_EXISTS, "LcTermination", path, "",
