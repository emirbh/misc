 ...
 * @version 2.1.1
 */
@RosettaDataRule("FixedPriceLegChoice1")
@ImplementedBy(FixedPriceLegChoice1.Default.class)
public interface FixedPriceLegChoice1 extends Validator<FixedPriceLeg> {
	
	String NAME = "FixedPriceLegChoice1";
	...
	class Default implements FixedPriceLegChoice1 {
		...
		private ComparisonResult executeDataRule(FixedPriceLeg fixedPriceLeg) {
			try {
				return choice(MapperS.of(fixedPriceLeg), Arrays.asList("calculationDates", "calculationPeriods", "calculationPeriodsSchedule", "calculationPeriodsReference", "calculationPeriodsScheduleReference", "calculationPeriodsDatesReference"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements FixedPriceLegChoice1 {
