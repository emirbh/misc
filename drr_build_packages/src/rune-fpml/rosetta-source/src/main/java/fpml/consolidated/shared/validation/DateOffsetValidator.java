		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("DateOffset", ValidationResult.ValidationType.CARDINALITY, "DateOffset", path, "", res.getError());
				}
				return success("DateOffset", ValidationResult.ValidationType.CARDINALITY, "DateOffset", path, "");
			})
			.collect(toList());
	}
