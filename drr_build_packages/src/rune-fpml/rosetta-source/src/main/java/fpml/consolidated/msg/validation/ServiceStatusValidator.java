		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ServiceStatus", ValidationResult.ValidationType.CARDINALITY, "ServiceStatus", path, "", res.getError());
				}
				return success("ServiceStatus", ValidationResult.ValidationType.CARDINALITY, "ServiceStatus", path, "");
			})
			.collect(toList());
	}
