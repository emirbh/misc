...
import fpml.consolidated.fx.targets.meta.FxPivotMeta;
 ...
 *
 * Provision Pivot is expressed as Schedule, with an initial value and optional steps.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FxPivot", builder=FxPivot.FxPivotBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxPivot", model="fpml", builder=FxPivot.FxPivotBuilderImpl.class, version="2.1.1")
public interface FxPivot extends Schedule {
	...
	interface FxPivotBuilder extends FxPivot, Schedule.ScheduleBuilder {
		...
		@Override
		FxPivot.FxPivotBuilder addStep(Step step);
		@Override
		FxPivot.FxPivotBuilder addStep(Step step, int idx);
		@Override
		FxPivot.FxPivotBuilder addStep(List<? extends Step> step);
		@Override
		FxPivot.FxPivotBuilder setStep(List<? extends Step> step);
	...
	class FxPivotBuilderImpl extends Schedule.ScheduleBuilderImpl implements FxPivot.FxPivotBuilder {
		...
		@RuneAttribute("id")
		@Override
		public FxPivot.FxPivotBuilder setId(String _id) {
		...
		@Override
		public FxPivot.FxPivotBuilder setInitialValue(BigDecimal _initialValue) {
		...
		@RuneAttribute("step")
		@Override
		public FxPivot.FxPivotBuilder addStep(Step _step) {
			if (_step != null) {
		...
		@Override
		public FxPivot.FxPivotBuilder addStep(Step _step, int idx) {
