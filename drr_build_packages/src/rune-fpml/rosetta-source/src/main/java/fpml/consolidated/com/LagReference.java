...
import fpml.consolidated.com.meta.LagReferenceMeta;
 ...
 *
 */
@RosettaDataType(value="LagReference", builder=LagReference.LagReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="LagReference", model="fpml", builder=LagReference.LagReferenceBuilderImpl.class, version="2.1.1")
public interface LagReference extends Reference {
	...
	class LagReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements LagReference.LagReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public LagReference.LagReferenceBuilder setHref(String _href) {
