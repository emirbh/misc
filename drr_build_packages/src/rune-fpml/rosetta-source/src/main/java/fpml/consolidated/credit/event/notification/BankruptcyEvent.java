...
import fpml.consolidated.credit.event.notification.meta.BankruptcyEventMeta;
 ...
 *
 */
@RosettaDataType(value="BankruptcyEvent", builder=BankruptcyEvent.BankruptcyEventBuilderImpl.class, version="2.1.1")
@RuneDataType(value="BankruptcyEvent", model="fpml", builder=BankruptcyEvent.BankruptcyEventBuilderImpl.class, version="2.1.1")
