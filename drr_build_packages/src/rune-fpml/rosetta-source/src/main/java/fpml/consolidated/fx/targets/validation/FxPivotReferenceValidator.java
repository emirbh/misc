		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxPivotReference", ValidationResult.ValidationType.CARDINALITY, "FxPivotReference", path, "", res.getError());
				}
				return success("FxPivotReference", ValidationResult.ValidationType.CARDINALITY, "FxPivotReference", path, "");
			})
			.collect(toList());
	}
