...
public class TradingEventSummaryOnlyExistsValidator implements ValidatorWithArg<TradingEventSummary, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends TradingEventSummary> ValidationResult<TradingEventSummary> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("eventIdentifier", ExistenceChecker.isSet((List<? extends BusinessEventIdentifier>) o.getEventIdentifier()))
				.put("eventType", ExistenceChecker.isSet((EventType) o.getEventType()))
		...
		if (setFields.equals(fields)) {
			return success("TradingEventSummary", ValidationResult.ValidationType.ONLY_EXISTS, "TradingEventSummary", path, "");
		}
		return failure("TradingEventSummary", ValidationResult.ValidationType.ONLY_EXISTS, "TradingEventSummary", path, "",
