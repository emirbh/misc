 ...
 * @version 2.1.1
 */
@RosettaDataRule("CommodityExerciseChoice1")
@ImplementedBy(CommodityExerciseChoice1.Default.class)
public interface CommodityExerciseChoice1 extends Validator<CommodityExercise> {
	
	String NAME = "CommodityExerciseChoice1";
	String DEFINITION = "optional choice americanExercise, europeanExercise";
	
	class Default implements CommodityExerciseChoice1 {
		...
		private ComparisonResult executeDataRule(CommodityExercise commodityExercise) {
			try {
				return choice(MapperS.of(commodityExercise), Arrays.asList("americanExercise", "europeanExercise"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements CommodityExerciseChoice1 {
