		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("Rollover", ValidationResult.ValidationType.TYPE_FORMAT, "Rollover", path, "", res.getError());
				}
				return success("Rollover", ValidationResult.ValidationType.TYPE_FORMAT, "Rollover", path, "");
			})
			.collect(toList());
	}
