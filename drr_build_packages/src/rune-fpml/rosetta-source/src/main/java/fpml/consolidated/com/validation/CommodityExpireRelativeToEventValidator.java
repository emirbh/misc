		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityExpireRelativeToEvent", ValidationResult.ValidationType.CARDINALITY, "CommodityExpireRelativeToEvent", path, "", res.getError());
				}
				return success("CommodityExpireRelativeToEvent", ValidationResult.ValidationType.CARDINALITY, "CommodityExpireRelativeToEvent", path, "");
			})
			.collect(toList());
	}
