...
import fpml.consolidated.credit.event.notification.meta.RepudiationMoratoriumEventMeta;
 ...
 *
 */
@RosettaDataType(value="RepudiationMoratoriumEvent", builder=RepudiationMoratoriumEvent.RepudiationMoratoriumEventBuilderImpl.class, version="2.1.1")
@RuneDataType(value="RepudiationMoratoriumEvent", model="fpml", builder=RepudiationMoratoriumEvent.RepudiationMoratoriumEventBuilderImpl.class, version="2.1.1")
