...
import fpml.consolidated.asset.meta.BasketIdMeta;
 ...
 *
 */
@RosettaDataType(value="BasketId", builder=BasketId.BasketIdBuilderImpl.class, version="2.1.1")
@RuneDataType(value="BasketId", model="fpml", builder=BasketId.BasketIdBuilderImpl.class, version="2.1.1")
public interface BasketId extends RosettaModelObject {
	...
	class BasketIdBuilderImpl implements BasketId.BasketIdBuilder {
		...
		@RuneAttribute("value")
		@Override
		public BasketId.BasketIdBuilder setValue(String _value) {
		...
		@RuneAttribute("basketIdScheme")
		@Override
		public BasketId.BasketIdBuilder setBasketIdScheme(String _basketIdScheme) {
			this.basketIdScheme = _basketIdScheme == null ? null : _basketIdScheme;
			return this;
		}
