...
import fpml.consolidated.ird.meta.PriceSourceDisruptionMeta;
 ...
 *
 * Provision A type defining the parameters used to get a price quote to replace the settlement rate option that is disrupted.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
...
public interface PriceSourceDisruption extends RosettaModelObject {
	...
	class PriceSourceDisruptionBuilderImpl implements PriceSourceDisruption.PriceSourceDisruptionBuilder {
		...
		@RuneAttribute("fallbackReferencePrice")
		@Override
		public PriceSourceDisruption.PriceSourceDisruptionBuilder setFallbackReferencePrice(FallbackReferencePrice _fallbackReferencePrice) {
