...
import fpml.consolidated.option.shared.meta.StrategyFeatureMeta;
 ...
 *
 * Provision A type for definining equity option simple strike or calendar spread strategy features.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="StrategyFeature", builder=StrategyFeature.StrategyFeatureBuilderImpl.class, version="2.1.1")
@RuneDataType(value="StrategyFeature", model="fpml", builder=StrategyFeature.StrategyFeatureBuilderImpl.class, version="2.1.1")
public interface StrategyFeature extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Definition of the upper strike in a strike spread.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Definition of the later expiration date in a calendar spread.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class StrategyFeatureBuilderImpl implements StrategyFeature.StrategyFeatureBuilder {
		...
		@RuneAttribute("strikeSpread")
		@Override
		public StrategyFeature.StrategyFeatureBuilder setStrikeSpread(StrikeSpread _strikeSpread) {
			this.strikeSpread = _strikeSpread == null ? null : _strikeSpread.toBuilder();
			return this;
		}
		...
		@RuneAttribute("calendarSpread")
		@Override
		public StrategyFeature.StrategyFeatureBuilder setCalendarSpread(CalendarSpread _calendarSpread) {
			this.calendarSpread = _calendarSpread == null ? null : _calendarSpread.toBuilder();
			return this;
		}
