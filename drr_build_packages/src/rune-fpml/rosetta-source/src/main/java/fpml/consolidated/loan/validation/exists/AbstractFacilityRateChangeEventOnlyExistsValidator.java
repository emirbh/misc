...
public class AbstractFacilityRateChangeEventOnlyExistsValidator implements ValidatorWithArg<AbstractFacilityRateChangeEvent, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractFacilityRateChangeEvent> ValidationResult<AbstractFacilityRateChangeEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractFacilityRateChangeEvent", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractFacilityRateChangeEvent", path, "");
		}
		return failure("AbstractFacilityRateChangeEvent", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractFacilityRateChangeEvent", path, "",
