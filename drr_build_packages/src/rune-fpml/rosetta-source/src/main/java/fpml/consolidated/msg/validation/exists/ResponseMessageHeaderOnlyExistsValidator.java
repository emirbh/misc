...
public class ResponseMessageHeaderOnlyExistsValidator implements ValidatorWithArg<ResponseMessageHeader, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ResponseMessageHeader> ValidationResult<ResponseMessageHeader> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ResponseMessageHeader", ValidationResult.ValidationType.ONLY_EXISTS, "ResponseMessageHeader", path, "");
		}
		return failure("ResponseMessageHeader", ValidationResult.ValidationType.ONLY_EXISTS, "ResponseMessageHeader", path, "",
