...
public class RepresentationsValidator implements Validator<Representations> {
	...
	private List<ComparisonResult> getComparisonResults(Representations o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("nonReliance", (Boolean) o.getNonReliance() != null ? 1 : 0, 0, 1), 
				checkCardinality("agreementsRegardingHedging", (Boolean) o.getAgreementsRegardingHedging() != null ? 1 : 0, 0, 1), 
