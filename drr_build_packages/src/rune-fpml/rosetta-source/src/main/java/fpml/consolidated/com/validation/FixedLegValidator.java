...
public class FixedLegValidator implements Validator<FixedLeg> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FixedLeg", ValidationResult.ValidationType.CARDINALITY, "FixedLeg", path, "", res.getError());
				}
				return success("FixedLeg", ValidationResult.ValidationType.CARDINALITY, "FixedLeg", path, "");
			})
			.collect(toList());
	}
