...
import fpml.consolidated.shared.validation.ResourceTypeFormatValidator;
import fpml.consolidated.shared.validation.ResourceValidator;
import fpml.consolidated.shared.validation.datarule.ResourceChoice;
import fpml.consolidated.shared.validation.exists.ResourceOnlyExistsValidator;
...
public class ResourceMeta implements RosettaMetaData<Resource> {
	...
	public List<Validator<? super Resource>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<Resource>create(ResourceChoice.class)
		);
	}
