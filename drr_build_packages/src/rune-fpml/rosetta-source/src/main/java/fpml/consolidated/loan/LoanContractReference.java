...
import fpml.consolidated.loan.meta.LoanContractReferenceMeta;
 ...
 *
 * Provision A reference to a loan contract.
 *
 */
@RosettaDataType(value="LoanContractReference", builder=LoanContractReference.LoanContractReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="LoanContractReference", model="fpml", builder=LoanContractReference.LoanContractReferenceBuilderImpl.class, version="2.1.1")
public interface LoanContractReference extends Reference {
	...
	class LoanContractReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements LoanContractReference.LoanContractReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public LoanContractReference.LoanContractReferenceBuilder setHref(String _href) {
