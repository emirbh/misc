...
import fpml.consolidated.asset.meta.UnderlyingAssetTrancheMeta;
 ...
 *
 */
@RosettaDataType(value="UnderlyingAssetTranche", builder=UnderlyingAssetTranche.UnderlyingAssetTrancheBuilderImpl.class, version="2.1.1")
@RuneDataType(value="UnderlyingAssetTranche", model="fpml", builder=UnderlyingAssetTranche.UnderlyingAssetTrancheBuilderImpl.class, version="2.1.1")
public interface UnderlyingAssetTranche extends RosettaModelObject {
	...
	class UnderlyingAssetTrancheImpl implements UnderlyingAssetTranche {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("loanTrancheScheme")
	...
	class UnderlyingAssetTrancheBuilderImpl implements UnderlyingAssetTranche.UnderlyingAssetTrancheBuilder {
		...
		@RuneAttribute("value")
		@Override
		public UnderlyingAssetTranche.UnderlyingAssetTrancheBuilder setValue(String _value) {
		...
		@RuneAttribute("loanTrancheScheme")
		@Override
		public UnderlyingAssetTranche.UnderlyingAssetTrancheBuilder setLoanTrancheScheme(String _loanTrancheScheme) {
			this.loanTrancheScheme = _loanTrancheScheme == null ? null : _loanTrancheScheme;
			return this;
		}
