...
import fpml.consolidated.fx.targets.meta.FxStrikeReferenceMeta;
 ...
 *
 * Provision Reference to a strike structure.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FxStrikeReference", builder=FxStrikeReference.FxStrikeReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxStrikeReference", model="fpml", builder=FxStrikeReference.FxStrikeReferenceBuilderImpl.class, version="2.1.1")
public interface FxStrikeReference extends Reference {
	...
	class FxStrikeReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements FxStrikeReference.FxStrikeReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public FxStrikeReference.FxStrikeReferenceBuilder setHref(String _href) {
