...
public class CollateralPositionOnlyExistsValidator implements ValidatorWithArg<CollateralPosition, Set<String>> {
	...
	public <T2 extends CollateralPosition> ValidationResult<CollateralPosition> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("valuationAmount", ExistenceChecker.isSet((PositiveMoney) o.getValuationAmount()))
		...
		if (setFields.equals(fields)) {
			return success("CollateralPosition", ValidationResult.ValidationType.ONLY_EXISTS, "CollateralPosition", path, "");
		}
		return failure("CollateralPosition", ValidationResult.ValidationType.ONLY_EXISTS, "CollateralPosition", path, "",
