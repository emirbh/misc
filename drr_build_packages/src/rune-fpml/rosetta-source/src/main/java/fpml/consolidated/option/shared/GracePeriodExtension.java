...
import fpml.consolidated.option.shared.meta.GracePeriodExtensionMeta;
 ...
 *
 */
@RosettaDataType(value="GracePeriodExtension", builder=GracePeriodExtension.GracePeriodExtensionBuilderImpl.class, version="2.1.1")
@RuneDataType(value="GracePeriodExtension", model="fpml", builder=GracePeriodExtension.GracePeriodExtensionBuilderImpl.class, version="2.1.1")
public interface GracePeriodExtension extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Indicates whether the grace period extension provision is applicable.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The number of calendar or business days after any due date that the reference entity has to fulfil its obligations before a failure to pay credit event is deemed to have occurred. ISDA 2003 Term: Grace Period.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class GracePeriodExtensionBuilderImpl implements GracePeriodExtension.GracePeriodExtensionBuilder {
		...
		@RuneAttribute("applicable")
		@Override
		public GracePeriodExtension.GracePeriodExtensionBuilder setApplicable(Boolean _applicable) {
		...
		@RuneAttribute("gracePeriod")
		@Override
		public GracePeriodExtension.GracePeriodExtensionBuilder setGracePeriod(Offset _gracePeriod) {
			this.gracePeriod = _gracePeriod == null ? null : _gracePeriod.toBuilder();
			return this;
		}
