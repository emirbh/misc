...
public class RequestClearingEligibilityOnlyExistsValidator implements ValidatorWithArg<RequestClearingEligibility, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RequestClearingEligibility> ValidationResult<RequestClearingEligibility> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("requestingPartyReference", ExistenceChecker.isSet((PartyReference) o.getRequestingPartyReference()))
		...
		if (setFields.equals(fields)) {
			return success("RequestClearingEligibility", ValidationResult.ValidationType.ONLY_EXISTS, "RequestClearingEligibility", path, "");
		}
		return failure("RequestClearingEligibility", ValidationResult.ValidationType.ONLY_EXISTS, "RequestClearingEligibility", path, "",
