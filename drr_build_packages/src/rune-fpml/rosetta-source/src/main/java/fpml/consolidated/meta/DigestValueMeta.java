...
import fpml.consolidated.validation.DigestValueTypeFormatValidator;
import fpml.consolidated.validation.DigestValueValidator;
import fpml.consolidated.validation.exists.DigestValueOnlyExistsValidator;
...
public class DigestValueMeta implements RosettaMetaData<DigestValue> {
	...
	@Override
	public Validator<? super DigestValue> validator(ValidatorFactory factory) {
		return factory.<DigestValue>create(DigestValueValidator.class);
	}

	@Override
	public Validator<? super DigestValue> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DigestValue>create(DigestValueTypeFormatValidator.class);
	}
