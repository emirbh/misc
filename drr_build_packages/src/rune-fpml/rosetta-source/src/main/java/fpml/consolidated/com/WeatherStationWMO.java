...
import fpml.consolidated.com.meta.WeatherStationWMOMeta;
 ...
 *
 * Provision A code identifying a Weather Index WMO.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="WeatherStationWMO", builder=WeatherStationWMO.WeatherStationWMOBuilderImpl.class, version="2.1.1")
@RuneDataType(value="WeatherStationWMO", model="fpml", builder=WeatherStationWMO.WeatherStationWMOBuilderImpl.class, version="2.1.1")
public interface WeatherStationWMO extends RosettaModelObject {
	...
	class WeatherStationWMOImpl implements WeatherStationWMO {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("weatherStationWMOScheme")
	...
	class WeatherStationWMOBuilderImpl implements WeatherStationWMO.WeatherStationWMOBuilder {
		...
		@RuneAttribute("value")
		@Override
		public WeatherStationWMO.WeatherStationWMOBuilder setValue(String _value) {
		...
		@RuneAttribute("weatherStationWMOScheme")
		@Override
		public WeatherStationWMO.WeatherStationWMOBuilder setWeatherStationWMOScheme(String _weatherStationWMOScheme) {
			this.weatherStationWMOScheme = _weatherStationWMOScheme == null ? null : _weatherStationWMOScheme;
			return this;
		}
		...
		@RuneAttribute("id")
		@Override
		public WeatherStationWMO.WeatherStationWMOBuilder setId(String _id) {
