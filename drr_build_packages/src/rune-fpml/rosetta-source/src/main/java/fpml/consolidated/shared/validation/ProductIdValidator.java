		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ProductId", ValidationResult.ValidationType.CARDINALITY, "ProductId", path, "", res.getError());
				}
				return success("ProductId", ValidationResult.ValidationType.CARDINALITY, "ProductId", path, "");
			})
			.collect(toList());
	}
