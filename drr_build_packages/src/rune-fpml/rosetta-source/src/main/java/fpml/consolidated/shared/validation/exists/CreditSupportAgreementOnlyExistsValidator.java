...
public class CreditSupportAgreementOnlyExistsValidator implements ValidatorWithArg<CreditSupportAgreement, Set<String>> {
	...
	public <T2 extends CreditSupportAgreement> ValidationResult<CreditSupportAgreement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("type", ExistenceChecker.isSet((CreditSupportAgreementType) o._getType()))
		...
		if (setFields.equals(fields)) {
			return success("CreditSupportAgreement", ValidationResult.ValidationType.ONLY_EXISTS, "CreditSupportAgreement", path, "");
		}
		return failure("CreditSupportAgreement", ValidationResult.ValidationType.ONLY_EXISTS, "CreditSupportAgreement", path, "",
