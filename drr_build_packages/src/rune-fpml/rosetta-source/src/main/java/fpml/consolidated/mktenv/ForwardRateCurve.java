...
import fpml.consolidated.mktenv.meta.ForwardRateCurveMeta;
 ...
 *
 * Provision A curve used to model a set of forward interest rates. Used for forecasting interest rates as part of a pricing calculation.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ForwardRateCurve", builder=ForwardRateCurve.ForwardRateCurveBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ForwardRateCurve", model="fpml", builder=ForwardRateCurve.ForwardRateCurveBuilderImpl.class, version="2.1.1")
public interface ForwardRateCurve extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A reference to the rate index whose forwards are modeled.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The curve of forward values.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class ForwardRateCurveBuilderImpl implements ForwardRateCurve.ForwardRateCurveBuilder {
		...
		@RuneAttribute("assetReference")
		@Override
		public ForwardRateCurve.ForwardRateCurveBuilder setAssetReference(AssetReference _assetReference) {
		...
		@RuneAttribute("rateCurve")
		@Override
		public ForwardRateCurve.ForwardRateCurveBuilder setRateCurve(TermCurve _rateCurve) {
