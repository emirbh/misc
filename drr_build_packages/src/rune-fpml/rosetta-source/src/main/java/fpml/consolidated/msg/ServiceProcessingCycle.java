...
import fpml.consolidated.msg.meta.ServiceProcessingCycleMeta;
 ...
 *
 * Provision A type that can be used to describe the processing phase of a service. For example, EndOfDay, Intraday.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ServiceProcessingCycle", builder=ServiceProcessingCycle.ServiceProcessingCycleBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ServiceProcessingCycle", model="fpml", builder=ServiceProcessingCycle.ServiceProcessingCycleBuilderImpl.class, version="2.1.1")
public interface ServiceProcessingCycle extends RosettaModelObject {
	...
	class ServiceProcessingCycleImpl implements ServiceProcessingCycle {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("serviceProcessingCycleScheme")
	...
	class ServiceProcessingCycleBuilderImpl implements ServiceProcessingCycle.ServiceProcessingCycleBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ServiceProcessingCycle.ServiceProcessingCycleBuilder setValue(String _value) {
		...
		@RuneAttribute("serviceProcessingCycleScheme")
		@Override
		public ServiceProcessingCycle.ServiceProcessingCycleBuilder setServiceProcessingCycleScheme(String _serviceProcessingCycleScheme) {
			this.serviceProcessingCycleScheme = _serviceProcessingCycleScheme == null ? null : _serviceProcessingCycleScheme;
			return this;
		}
