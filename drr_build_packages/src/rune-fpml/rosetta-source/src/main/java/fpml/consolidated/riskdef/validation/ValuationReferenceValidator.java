		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ValuationReference", ValidationResult.ValidationType.CARDINALITY, "ValuationReference", path, "", res.getError());
				}
				return success("ValuationReference", ValidationResult.ValidationType.CARDINALITY, "ValuationReference", path, "");
			})
			.collect(toList());
	}
