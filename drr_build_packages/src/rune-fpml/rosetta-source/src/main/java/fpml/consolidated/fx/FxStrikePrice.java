...
import fpml.consolidated.fx.meta.FxStrikePriceMeta;
 ...
 *
 */
@RosettaDataType(value="FxStrikePrice", builder=FxStrikePrice.FxStrikePriceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxStrikePrice", model="fpml", builder=FxStrikePrice.FxStrikePriceBuilderImpl.class, version="2.1.1")
public interface FxStrikePrice extends RosettaModelObject {
	...
	class FxStrikePriceBuilderImpl implements FxStrikePrice.FxStrikePriceBuilder {
		...
		@RuneAttribute("rate")
		@Override
		public FxStrikePrice.FxStrikePriceBuilder setRate(BigDecimal _rate) {
		...
		@RuneAttribute("strikeQuoteBasis")
		@Override
		public FxStrikePrice.FxStrikePriceBuilder setStrikeQuoteBasis(StrikeQuoteBasisEnum _strikeQuoteBasis) {
