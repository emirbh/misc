...
public class ReplacementValueMethodBaseOnlyExistsValidator implements ValidatorWithArg<ReplacementValueMethodBase, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ReplacementValueMethodBase> ValidationResult<ReplacementValueMethodBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ReplacementValueMethodBase", ValidationResult.ValidationType.ONLY_EXISTS, "ReplacementValueMethodBase", path, "");
		}
		return failure("ReplacementValueMethodBase", ValidationResult.ValidationType.ONLY_EXISTS, "ReplacementValueMethodBase", path, "",
