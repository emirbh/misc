...
public class BusinessDateRangeOnlyExistsValidator implements ValidatorWithArg<BusinessDateRange, Set<String>> {
	...
	public <T2 extends BusinessDateRange> ValidationResult<BusinessDateRange> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("unadjustedFirstDate", ExistenceChecker.isSet((ZonedDateTime) o.getUnadjustedFirstDate()))
				.put("unadjustedLastDate", ExistenceChecker.isSet((ZonedDateTime) o.getUnadjustedLastDate()))
		...
		if (setFields.equals(fields)) {
			return success("BusinessDateRange", ValidationResult.ValidationType.ONLY_EXISTS, "BusinessDateRange", path, "");
		}
		return failure("BusinessDateRange", ValidationResult.ValidationType.ONLY_EXISTS, "BusinessDateRange", path, "",
