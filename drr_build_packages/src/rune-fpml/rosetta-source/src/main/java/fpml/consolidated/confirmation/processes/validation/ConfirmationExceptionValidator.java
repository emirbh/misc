...
public class ConfirmationExceptionValidator implements Validator<ConfirmationException> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ConfirmationException", ValidationResult.ValidationType.CARDINALITY, "ConfirmationException", path, "", res.getError());
				}
				return success("ConfirmationException", ValidationResult.ValidationType.CARDINALITY, "ConfirmationException", path, "");
			})
			.collect(toList());
	}
