...
public class FallbackRateOnlyExistsValidator implements ValidatorWithArg<FallbackRate, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FallbackRate> ValidationResult<FallbackRate> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FallbackRate", ValidationResult.ValidationType.ONLY_EXISTS, "FallbackRate", path, "");
		}
		return failure("FallbackRate", ValidationResult.ValidationType.ONLY_EXISTS, "FallbackRate", path, "",
