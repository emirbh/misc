 ...
 *
 */
@RosettaDataType(value="DeliverableObligations", builder=DeliverableObligations.DeliverableObligationsBuilderImpl.class, version="2.1.1")
@RuneDataType(value="DeliverableObligations", model="fpml", builder=DeliverableObligations.DeliverableObligationsBuilderImpl.class, version="2.1.1")
public interface DeliverableObligations extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Used in both obligations and deliverable obligations to represent a class or type of securities which apply. ISDA 2003 Term: Obligation Category/Deliverable Obligation Category
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An obligation and deliverable obligation characteristic. The currency or currencies in which an obligation or deliverable obligation must be payable. ISDA 2003 Term: Specified Currency
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An obligation and deliverable obligation characteristic. Any obligation that is not primarily (majority) owed to a Sovereign or Supranational Organization. ISDA 2003 Term: Not Sovereign Lender
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An obligation and deliverable obligation characteristic. Indicates whether or not the obligation is quoted, listed or ordinarily purchased and sold on an exchange. ISDA 2003 Term: Listed
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A deliverable obligation characteristic. A loan that is capable of being assigned with the consent of the Reference Entity or the guarantor, if any, of the loan or any agent. ISDA 2003 Term: Consent Required Loan
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A deliverable obligation characteristic. An obligation that is transferable to institutional investors without any contractual, statutory or regulatory restrictions. ISDA 2003 Term: Transferable
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A deliverable obligation characteristic. An obligation that has a remaining maturity from the Physical Settlement Date of not greater than the period specified. ISDA 2003 Term: Maximum Maturity
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A deliverable obligation characteristic. An obligation at time of default is due to mature and due to be repaid, or as a result of downgrade/bankruptcy is due to be repaid as a result of an acceleration clause. ISDA 2003 Term: Accelerated or Matured
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A deliverable obligation characteristic. Any obligation that is not a bearer instrument. This applies to Bonds only and is meant to avoid tax, fraud and security/delivery provisions that can potentially be associated with Bearer Bonds. ISDA 2003 Term: Not Bearer
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An obligation and deliverable obligation characteristic. Defined in the ISDA published additional provisions for U.S. Municipal as Reference Entity. ISDA 2003 Term: Full Faith and Credit Obligation Liability
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An obligation and deliverable obligation characteristic. Defined in the ISDA published additional provisions for U.S. Municipal as Reference Entity. ISDA 2003 Term: General Fund Obligation Liability
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An obligation and deliverable obligation characteristic. Defined in the ISDA published additional provisions for U.S. Municipal as Reference Entity. ISDA 2003 Term: Revenue Obligation Liability
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision ISDA 1999 Term: Indirect Loan Participation. NOTE: Only applicable as a deliverable obligation under ISDA Credit 1999.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A free format string to specify any excluded obligations or deliverable obligations, as the case may be, of the reference entity or excluded types of obligations or deliverable obligations. ISDA 2003 Term: Excluded Obligations/Excluded Deliverable Obligations
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision This element is used to specify any other obligations of a reference entity in both obligations and deliverable obligations. The obligations can be specified free-form. ISDA 2003 Term: Other Obligations of a Reference Entity
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class DeliverableObligationsImpl implements DeliverableObligations {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("consentRequiredLoan")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("directLoanParticipation")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("acceleratedOrMatured")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("indirectLoanParticipation")
	...
	class DeliverableObligationsBuilderImpl implements DeliverableObligations.DeliverableObligationsBuilder {
		...
		@RuneAttribute("accruedInterest")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setAccruedInterest(Boolean _accruedInterest) {
		...
		@RuneAttribute("category")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setCategory(ObligationCategoryEnum _category) {
		...
		@RuneAttribute("notSubordinated")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setNotSubordinated(Boolean _notSubordinated) {
		...
		@RuneAttribute("specifiedCurrency")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setSpecifiedCurrency(SpecifiedCurrency _specifiedCurrency) {
		...
		@RuneAttribute("notSovereignLender")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setNotSovereignLender(Boolean _notSovereignLender) {
		...
		@RuneAttribute("notDomesticCurrency")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setNotDomesticCurrency(NotDomesticCurrency _notDomesticCurrency) {
		...
		@RuneAttribute("notDomesticLaw")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setNotDomesticLaw(Boolean _notDomesticLaw) {
		...
		@RuneAttribute("listed")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setListed(Boolean _listed) {
		...
		@RuneAttribute("notContingent")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setNotContingent(Boolean _notContingent) {
		...
		@RuneAttribute("notDomesticIssuance")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setNotDomesticIssuance(Boolean _notDomesticIssuance) {
		...
		@RuneAttribute("assignableLoan")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setAssignableLoan(PCDeliverableObligationCharac _assignableLoan) {
		...
		@RuneAttribute("consentRequiredLoan")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setConsentRequiredLoan(PCDeliverableObligationCharac _consentRequiredLoan) {
		...
		@RuneAttribute("directLoanParticipation")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setDirectLoanParticipation(LoanParticipation _directLoanParticipation) {
		...
		@RuneAttribute("transferable")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setTransferable(Boolean _transferable) {
		...
		@RuneAttribute("maximumMaturity")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setMaximumMaturity(Period _maximumMaturity) {
		...
		@RuneAttribute("acceleratedOrMatured")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setAcceleratedOrMatured(Boolean _acceleratedOrMatured) {
		...
		@RuneAttribute("notBearer")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setNotBearer(Boolean _notBearer) {
		...
		@RuneAttribute("fullFaithAndCreditObLiability")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setFullFaithAndCreditObLiability(Boolean _fullFaithAndCreditObLiability) {
		...
		@RuneAttribute("generalFundObligationLiability")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setGeneralFundObligationLiability(Boolean _generalFundObligationLiability) {
		...
		@RuneAttribute("revenueObligationLiability")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setRevenueObligationLiability(Boolean _revenueObligationLiability) {
		...
		@RuneAttribute("indirectLoanParticipation")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setIndirectLoanParticipation(LoanParticipation _indirectLoanParticipation) {
		...
		@RuneAttribute("excluded")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setExcluded(String _excluded) {
		...
		@RuneAttribute("othReferenceEntityObligations")
		@Override
		public DeliverableObligations.DeliverableObligationsBuilder setOthReferenceEntityObligations(String _othReferenceEntityObligations) {
