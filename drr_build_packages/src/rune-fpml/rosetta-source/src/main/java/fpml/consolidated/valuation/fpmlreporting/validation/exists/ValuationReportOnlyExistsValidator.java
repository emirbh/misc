...
public class ValuationReportOnlyExistsValidator implements ValidatorWithArg<ValuationReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ValuationReport> ValidationResult<ValuationReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("generatedDateTime", ExistenceChecker.isSet((ZonedDateTime) o.getGeneratedDateTime()))
		...
		if (setFields.equals(fields)) {
			return success("ValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "ValuationReport", path, "");
		}
		return failure("ValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "ValuationReport", path, "",
