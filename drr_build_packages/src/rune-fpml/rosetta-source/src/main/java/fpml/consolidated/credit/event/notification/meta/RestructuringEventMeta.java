...
import fpml.consolidated.credit.event.notification.RestructuringEvent;
import fpml.consolidated.credit.event.notification.validation.RestructuringEventTypeFormatValidator;
import fpml.consolidated.credit.event.notification.validation.RestructuringEventValidator;
import fpml.consolidated.credit.event.notification.validation.exists.RestructuringEventOnlyExistsValidator;
...
public class RestructuringEventMeta implements RosettaMetaData<RestructuringEvent> {
	...
	@Override
	public Validator<? super RestructuringEvent> validator(ValidatorFactory factory) {
		return factory.<RestructuringEvent>create(RestructuringEventValidator.class);
	}

	@Override
	public Validator<? super RestructuringEvent> typeFormatValidator(ValidatorFactory factory) {
		return factory.<RestructuringEvent>create(RestructuringEventTypeFormatValidator.class);
	}
