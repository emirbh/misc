...
import fpml.consolidated.cd.meta.ObligationsMeta;
 ...
 *
 */
@RosettaDataType(value="Obligations", builder=Obligations.ObligationsBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Obligations", model="fpml", builder=Obligations.ObligationsBuilderImpl.class, version="2.1.1")
public interface Obligations extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Applies to Loan CDS, to indicate what lien level is appropriate for a deliverable obligation. Applies to European Loan CDS, to indicate the Ranking of the obligation. Example: a 2nd lien Loan CDS would imply that the deliverable obligations are 1st or 2nd lien loans.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An obligation and deliverable obligation characteristic. Defined in the ISDA published Standard Terms Supplement for use with CDS Transactions on Leveraged Loans. ISDA 2003 Term: Cash Settlement Only.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An obligation and deliverable obligation characteristic. Defined in the ISDA published Standard Terms Supplement for use with CDS Transactions on Leveraged Loans. ISDA 2003 Term: Delivery of Commitments.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An obligation and deliverable obligation characteristic. Defined in the ISDA published Standard Terms Supplement for use with CDS Transactions on Leveraged Loans. ISDA 2003 Term: Continuity.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processRosetta(path.newSubPath("designatedPriority"), processor, Lien.class, getDesignatedPriority());
	...
	interface ObligationsBuilder extends Obligations, RosettaModelObjectBuilder {
		...
		Lien.LienBuilder getOrCreateDesignatedPriority();
		@Override
		Lien.LienBuilder getDesignatedPriority();
		...
		Obligations.ObligationsBuilder setDesignatedPriority(Lien designatedPriority);
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			...
			processor.processBasic(path.newSubPath("excluded"), String.class, getExcluded(), this);
			processor.processBasic(path.newSubPath("othReferenceEntityObligations"), String.class, getOthReferenceEntityObligations(), this);
			processRosetta(path.newSubPath("designatedPriority"), processor, Lien.LienBuilder.class, getDesignatedPriority());
			processor.processBasic(path.newSubPath("cashSettlementOnly"), Boolean.class, getCashSettlementOnly(), this);
			processor.processBasic(path.newSubPath("deliveryOfCommitments"), Boolean.class, getDeliveryOfCommitments(), this);
			processor.processBasic(path.newSubPath("continuity"), Boolean.class, getContinuity(), this);
		}
	...
	class ObligationsImpl implements Obligations {
		...
		private final Lien designatedPriority;
	...
	class ObligationsBuilderImpl implements Obligations.ObligationsBuilder {
		...
		protected Lien.LienBuilder designatedPriority;
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("designatedPriority")
		public Lien.LienBuilder getDesignatedPriority() {
			return designatedPriority;
		}
		
		@Override
		public Lien.LienBuilder getOrCreateDesignatedPriority() {
			Lien.LienBuilder result;
			if (designatedPriority!=null) {
				result = designatedPriority;
			}
			else {
				result = designatedPriority = Lien.builder();
			}
		...
		@RuneAttribute("designatedPriority")
		@Override
		public Obligations.ObligationsBuilder setDesignatedPriority(Lien _designatedPriority) {
		...
		public boolean hasData() {
			...
			if (getDesignatedPriority()!=null && getDesignatedPriority().hasData()) return true;
