...
import fpml.consolidated.shared.meta.ResourceMeta;
 ...
 *
 * Provision Describes the resource that contains the media representation of a business event (i.e used for stating the Publicly Available Information). For example, can describe a file or a URL that represents the event. This type is an extended version of a type defined by RIXML (www.rixml.org).
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="Resource", builder=Resource.ResourceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Resource", model="fpml", builder=Resource.ResourceBuilderImpl.class, version="2.1.1")
public interface Resource extends RosettaModelObject {
	...
	class ResourceBuilderImpl implements Resource.ResourceBuilder {
		...
		@RuneAttribute("resourceId")
		@Override
		public Resource.ResourceBuilder setResourceId(ResourceId _resourceId) {
		...
		@RuneAttribute("resourceType")
		@Override
		public Resource.ResourceBuilder setResourceType(ResourceType _resourceType) {
		...
		@RuneAttribute("language")
		@Override
		public Resource.ResourceBuilder setLanguage(Language _language) {
		...
		@RuneAttribute("mimeType")
		@Override
		public Resource.ResourceBuilder setMimeType(MimeType _mimeType) {
		...
		@RuneAttribute("hexadecimalBinary")
		@Override
		public Resource.ResourceBuilder setHexadecimalBinary(String _hexadecimalBinary) {
		...
		@RuneAttribute("base64Binary")
		@Override
		public Resource.ResourceBuilder setBase64Binary(String _base64Binary) {
