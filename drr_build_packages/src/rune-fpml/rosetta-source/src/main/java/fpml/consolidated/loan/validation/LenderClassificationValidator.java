		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LenderClassification", ValidationResult.ValidationType.CARDINALITY, "LenderClassification", path, "", res.getError());
				}
				return success("LenderClassification", ValidationResult.ValidationType.CARDINALITY, "LenderClassification", path, "");
			})
			.collect(toList());
	}
