		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxTrigger", ValidationResult.ValidationType.TYPE_FORMAT, "FxTrigger", path, "", res.getError());
				}
				return success("FxTrigger", ValidationResult.ValidationType.TYPE_FORMAT, "FxTrigger", path, "");
			})
			.collect(toList());
	}
