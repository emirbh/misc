...
public class NonpublicExecutionReportExceptionValidator implements Validator<NonpublicExecutionReportException> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("NonpublicExecutionReportException", ValidationResult.ValidationType.CARDINALITY, "NonpublicExecutionReportException", path, "", res.getError());
				}
				return success("NonpublicExecutionReportException", ValidationResult.ValidationType.CARDINALITY, "NonpublicExecutionReportException", path, "");
			})
			.collect(toList());
	}
