...
import fpml.consolidated.shared.meta.PricingStructureReferenceMeta;
 ...
 *
 * Provision Reference to a pricing structure or any derived components (i.e. yield curve).
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="PricingStructureReference", builder=PricingStructureReference.PricingStructureReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PricingStructureReference", model="fpml", builder=PricingStructureReference.PricingStructureReferenceBuilderImpl.class, version="2.1.1")
public interface PricingStructureReference extends Reference {
	...
	class PricingStructureReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements PricingStructureReference.PricingStructureReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public PricingStructureReference.PricingStructureReferenceBuilder setHref(String _href) {
