...
public class RegulatoryClassificationMifirRTS6a_2015Validator implements Validator<RegulatoryClassificationMifirRTS6a_2015> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RegulatoryClassificationMifirRTS6a_2015", ValidationResult.ValidationType.CARDINALITY, "RegulatoryClassificationMifirRTS6a_2015", path, "", res.getError());
				}
				return success("RegulatoryClassificationMifirRTS6a_2015", ValidationResult.ValidationType.CARDINALITY, "RegulatoryClassificationMifirRTS6a_2015", path, "");
			})
			.collect(toList());
	}
