...
public class MiscFeePaymentOnlyExistsValidator implements ValidatorWithArg<MiscFeePayment, Set<String>> {
	...
	public <T2 extends MiscFeePayment> ValidationResult<MiscFeePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("type", ExistenceChecker.isSet((MiscFeeType) o._getType()))
		...
		if (setFields.equals(fields)) {
			return success("MiscFeePayment", ValidationResult.ValidationType.ONLY_EXISTS, "MiscFeePayment", path, "");
		}
		return failure("MiscFeePayment", ValidationResult.ValidationType.ONLY_EXISTS, "MiscFeePayment", path, "",
