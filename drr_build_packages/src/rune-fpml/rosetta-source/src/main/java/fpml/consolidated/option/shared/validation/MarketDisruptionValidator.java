		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MarketDisruption", ValidationResult.ValidationType.CARDINALITY, "MarketDisruption", path, "", res.getError());
				}
				return success("MarketDisruption", ValidationResult.ValidationType.CARDINALITY, "MarketDisruption", path, "");
			})
			.collect(toList());
	}
