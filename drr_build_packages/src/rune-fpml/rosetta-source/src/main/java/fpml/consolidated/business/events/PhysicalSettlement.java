...
import fpml.consolidated.business.events.meta.PhysicalSettlementMeta;
 ...
 *
 * Provision A structure that describes how an option settles into a physical trade.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="PhysicalSettlement", builder=PhysicalSettlement.PhysicalSettlementBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PhysicalSettlement", model="fpml", builder=PhysicalSettlement.PhysicalSettlementBuilderImpl.class, version="2.1.1")
public interface PhysicalSettlement extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The ID of the trade that resulted from the physical settlement.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The trade that resulted from the physical settlement.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class PhysicalSettlementImpl implements PhysicalSettlement {
		...
		@RuneAttribute("resultingTradeIdentifier")
	...
	class PhysicalSettlementBuilderImpl implements PhysicalSettlement.PhysicalSettlementBuilder {
		...
		@RuneAttribute("resultingTradeIdentifier")
		@Override
		public PhysicalSettlement.PhysicalSettlementBuilder setResultingTradeIdentifier(PartyTradeIdentifier _resultingTradeIdentifier) {
			this.resultingTradeIdentifier = _resultingTradeIdentifier == null ? null : _resultingTradeIdentifier.toBuilder();
			return this;
		}
		...
		@RuneAttribute("resultingTrade")
		@Override
		public PhysicalSettlement.PhysicalSettlementBuilder setResultingTrade(Trade _resultingTrade) {
		...
		@RuneAttribute("product")
		@Override
		public PhysicalSettlement.PhysicalSettlementBuilder setProduct(Product _product) {
