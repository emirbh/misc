...
public class BreakageFeePaymentOnlyExistsValidator implements ValidatorWithArg<BreakageFeePayment, Set<String>> {
	...
	public <T2 extends BreakageFeePayment> ValidationResult<BreakageFeePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("breakageFeeClaimDate", ExistenceChecker.isSet((ZonedDateTime) o.getBreakageFeeClaimDate()))
		...
		if (setFields.equals(fields)) {
			return success("BreakageFeePayment", ValidationResult.ValidationType.ONLY_EXISTS, "BreakageFeePayment", path, "");
		}
		return failure("BreakageFeePayment", ValidationResult.ValidationType.ONLY_EXISTS, "BreakageFeePayment", path, "",
