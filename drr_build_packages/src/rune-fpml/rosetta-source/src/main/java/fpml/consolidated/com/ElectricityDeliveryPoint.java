...
import fpml.consolidated.com.meta.ElectricityDeliveryPointMeta;
 ...
 *
 * Provision A scheme identifying the types of the Delivery Point for a physically settled electricity trade.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ElectricityDeliveryPoint", builder=ElectricityDeliveryPoint.ElectricityDeliveryPointBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ElectricityDeliveryPoint", model="fpml", builder=ElectricityDeliveryPoint.ElectricityDeliveryPointBuilderImpl.class, version="2.1.1")
public interface ElectricityDeliveryPoint extends RosettaModelObject {
	...
	class ElectricityDeliveryPointBuilderImpl implements ElectricityDeliveryPoint.ElectricityDeliveryPointBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ElectricityDeliveryPoint.ElectricityDeliveryPointBuilder setValue(String _value) {
		...
		@RuneAttribute("deliveryPointScheme")
		@Override
		public ElectricityDeliveryPoint.ElectricityDeliveryPointBuilder setDeliveryPointScheme(String _deliveryPointScheme) {
