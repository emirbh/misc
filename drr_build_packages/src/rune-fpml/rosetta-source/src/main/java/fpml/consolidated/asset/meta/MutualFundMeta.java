...
import fpml.consolidated.asset.validation.MutualFundTypeFormatValidator;
import fpml.consolidated.asset.validation.MutualFundValidator;
import fpml.consolidated.asset.validation.exists.MutualFundOnlyExistsValidator;
...
public class MutualFundMeta implements RosettaMetaData<MutualFund> {
	...
	@Override
	public Validator<? super MutualFund> validator(ValidatorFactory factory) {
		return factory.<MutualFund>create(MutualFundValidator.class);
	}

	@Override
	public Validator<? super MutualFund> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MutualFund>create(MutualFundTypeFormatValidator.class);
	}
