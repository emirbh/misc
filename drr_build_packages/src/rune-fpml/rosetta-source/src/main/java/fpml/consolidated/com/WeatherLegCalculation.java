 ...
 *
 * Provision A type to capture details of the calculation of the Payment Amount on a Weather Index Transaction.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="WeatherLegCalculation", builder=WeatherLegCalculation.WeatherLegCalculationBuilderImpl.class, version="2.1.1")
@RuneDataType(value="WeatherLegCalculation", model="fpml", builder=WeatherLegCalculation.WeatherLegCalculationBuilderImpl.class, version="2.1.1")
public interface WeatherLegCalculation extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision If Reference Level Equals Zero is specified to be applicable then CPD means, for any day during the Calculation Period, (A) 1 if the Daily Precipitation for that day is greater than or equal to the CPD Reference Level or (B) zero if the the Daily Precipitation for that day is less than the CPD Reference Level. If Reference Level Equals Zero is specified not to be applicable then CPD means, for any day during the Calculation Period, (A) 1 if the Daily Precipitation for that day is greater than the CPD Reference Level or 0 if the Daily Precipitation for that day is less than or equal to the CPD Reference Level.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The number of days following the final day of the Calculation Period specified in the Confirmation on which is is practicable to provide the notice that the Calculation Agent is required to give for that Settlement Date or Payment Date.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A day on which commmercial banks settle payments and are open for general business in the place(s) specified in the Confirmation. See Section 1.3 of the ISDA 2005 Commodity Definitions.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The date payment often revised after its publication, this indicates if the payment date could be recalculated.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision If 'dataCorrection'=true, this indicates how long after the initial publication of the data corrections can be made.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The maximum total payment amount that will be paid in any particular transaction.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The maximum payment amount that will be paid in any particular Calculation Period.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class WeatherLegCalculationImpl implements WeatherLegCalculation {
		...
		@Accessor(AccessorType.GETTER)
		@Required
		@RuneAttribute("referenceLevelEqualsZero")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("correctionPeriod")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("maximumPaymentAmount")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("maximumTransactionPaymentAmount")
	...
	class WeatherLegCalculationBuilderImpl implements WeatherLegCalculation.WeatherLegCalculationBuilder {
		...
		@RuneAttribute("settlementLevel")
		@Override
		public WeatherLegCalculation.WeatherLegCalculationBuilder setSettlementLevel(WeatherSettlementLevelEnum _settlementLevel) {
		...
		@RuneAttribute("referenceLevelEqualsZero")
		@Override
		public WeatherLegCalculation.WeatherLegCalculationBuilder setReferenceLevelEqualsZero(Boolean _referenceLevelEqualsZero) {
		...
		@RuneAttribute("calculationDate")
		@Override
		public WeatherLegCalculation.WeatherLegCalculationBuilder setCalculationDate(Period _calculationDate) {
		...
		@RuneAttribute("businessDays")
		@Override
		public WeatherLegCalculation.WeatherLegCalculationBuilder setBusinessDays(BusinessCenter _businessDays) {
		...
		@RuneAttribute("dataCorrection")
		@Override
		public WeatherLegCalculation.WeatherLegCalculationBuilder setDataCorrection(Boolean _dataCorrection) {
		...
		@RuneAttribute("correctionPeriod")
		@Override
		public WeatherLegCalculation.WeatherLegCalculationBuilder setCorrectionPeriod(Period _correctionPeriod) {
		...
		@RuneAttribute("maximumPaymentAmount")
		@Override
		public WeatherLegCalculation.WeatherLegCalculationBuilder setMaximumPaymentAmount(NonNegativeMoney _maximumPaymentAmount) {
		...
		@RuneAttribute("maximumTransactionPaymentAmount")
		@Override
		public WeatherLegCalculation.WeatherLegCalculationBuilder setMaximumTransactionPaymentAmount(NonNegativeMoney _maximumTransactionPaymentAmount) {
		...
		@RuneAttribute("rounding")
		@Override
		public WeatherLegCalculation.WeatherLegCalculationBuilder setRounding(Rounding _rounding) {
