		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityForward", ValidationResult.ValidationType.TYPE_FORMAT, "CommodityForward", path, "", res.getError());
				}
				return success("CommodityForward", ValidationResult.ValidationType.TYPE_FORMAT, "CommodityForward", path, "");
			})
			.collect(toList());
	}
