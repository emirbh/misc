...
public class MoneyRefOnlyExistsValidator implements ValidatorWithArg<MoneyRef, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends MoneyRef> ValidationResult<MoneyRef> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("MoneyRef", ValidationResult.ValidationType.ONLY_EXISTS, "MoneyRef", path, "");
		}
		return failure("MoneyRef", ValidationResult.ValidationType.ONLY_EXISTS, "MoneyRef", path, "",
