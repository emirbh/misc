...
public class FxRateAssetOnlyExistsValidator implements ValidatorWithArg<FxRateAsset, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FxRateAsset> ValidationResult<FxRateAsset> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("rateSource", ExistenceChecker.isSet((FxSpotRateSource) o.getRateSource()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("FxRateAsset", ValidationResult.ValidationType.ONLY_EXISTS, "FxRateAsset", path, "");
		}
		return failure("FxRateAsset", ValidationResult.ValidationType.ONLY_EXISTS, "FxRateAsset", path, "",
