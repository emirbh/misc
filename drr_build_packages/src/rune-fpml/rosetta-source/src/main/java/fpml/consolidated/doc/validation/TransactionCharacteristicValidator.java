		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TransactionCharacteristic", ValidationResult.ValidationType.CARDINALITY, "TransactionCharacteristic", path, "", res.getError());
				}
				return success("TransactionCharacteristic", ValidationResult.ValidationType.CARDINALITY, "TransactionCharacteristic", path, "");
			})
			.collect(toList());
	}
