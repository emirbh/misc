...
import fpml.consolidated.loan.validation.DefaultRateExpiryTypeFormatValidator;
import fpml.consolidated.loan.validation.DefaultRateExpiryValidator;
import fpml.consolidated.loan.validation.exists.DefaultRateExpiryOnlyExistsValidator;
...
public class DefaultRateExpiryMeta implements RosettaMetaData<DefaultRateExpiry> {
	...
	@Override
	public Validator<? super DefaultRateExpiry> validator(ValidatorFactory factory) {
		return factory.<DefaultRateExpiry>create(DefaultRateExpiryValidator.class);
	}

	@Override
	public Validator<? super DefaultRateExpiry> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DefaultRateExpiry>create(DefaultRateExpiryTypeFormatValidator.class);
	}
