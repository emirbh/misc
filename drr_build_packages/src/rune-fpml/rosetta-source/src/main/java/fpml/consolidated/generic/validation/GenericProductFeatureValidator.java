		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("GenericProductFeature", ValidationResult.ValidationType.CARDINALITY, "GenericProductFeature", path, "", res.getError());
				}
				return success("GenericProductFeature", ValidationResult.ValidationType.CARDINALITY, "GenericProductFeature", path, "");
			})
			.collect(toList());
	}
