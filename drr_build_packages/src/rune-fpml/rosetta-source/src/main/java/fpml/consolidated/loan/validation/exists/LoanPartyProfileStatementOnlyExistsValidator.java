...
public class LoanPartyProfileStatementOnlyExistsValidator implements ValidatorWithArg<LoanPartyProfileStatement, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanPartyProfileStatement> ValidationResult<LoanPartyProfileStatement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("partyProfile", ExistenceChecker.isSet((PartyProfile) o.getPartyProfile()))
		...
		if (setFields.equals(fields)) {
			return success("LoanPartyProfileStatement", ValidationResult.ValidationType.ONLY_EXISTS, "LoanPartyProfileStatement", path, "");
		}
		return failure("LoanPartyProfileStatement", ValidationResult.ValidationType.ONLY_EXISTS, "LoanPartyProfileStatement", path, "",
