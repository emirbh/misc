		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("GasQuality", ValidationResult.ValidationType.CARDINALITY, "GasQuality", path, "", res.getError());
				}
				return success("GasQuality", ValidationResult.ValidationType.CARDINALITY, "GasQuality", path, "");
			})
			.collect(toList());
	}
