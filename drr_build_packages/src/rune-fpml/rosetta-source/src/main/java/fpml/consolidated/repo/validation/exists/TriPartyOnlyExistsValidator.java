...
public class TriPartyOnlyExistsValidator implements ValidatorWithArg<TriParty, Set<String>> {
	...
	public <T2 extends TriParty> ValidationResult<TriParty> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("deliveryByValue", ExistenceChecker.isSet((Boolean) o.getDeliveryByValue()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("TriParty", ValidationResult.ValidationType.ONLY_EXISTS, "TriParty", path, "");
		}
		return failure("TriParty", ValidationResult.ValidationType.ONLY_EXISTS, "TriParty", path, "",
