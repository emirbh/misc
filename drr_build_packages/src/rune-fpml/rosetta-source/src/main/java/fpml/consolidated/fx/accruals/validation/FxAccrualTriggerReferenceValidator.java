		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxAccrualTriggerReference", ValidationResult.ValidationType.CARDINALITY, "FxAccrualTriggerReference", path, "", res.getError());
				}
				return success("FxAccrualTriggerReference", ValidationResult.ValidationType.CARDINALITY, "FxAccrualTriggerReference", path, "");
			})
			.collect(toList());
	}
