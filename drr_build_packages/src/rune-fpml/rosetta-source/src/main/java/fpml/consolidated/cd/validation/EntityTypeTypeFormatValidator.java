		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EntityType", ValidationResult.ValidationType.TYPE_FORMAT, "EntityType", path, "", res.getError());
				}
				return success("EntityType", ValidationResult.ValidationType.TYPE_FORMAT, "EntityType", path, "");
			})
			.collect(toList());
	}
