...
import fpml.consolidated.com.meta.CalculationPeriodsDatesReferenceMeta;
 ...
 *
 * Provision A pointer style reference to single-day-duration calculation periods defined elsewhere - note that this schedule consists of a parameterised schedule in a calculationPeriodsSchedule container.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CalculationPeriodsDatesReference", builder=CalculationPeriodsDatesReference.CalculationPeriodsDatesReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CalculationPeriodsDatesReference", model="fpml", builder=CalculationPeriodsDatesReference.CalculationPeriodsDatesReferenceBuilderImpl.class, version="2.1.1")
public interface CalculationPeriodsDatesReference extends Reference {
	...
	class CalculationPeriodsDatesReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements CalculationPeriodsDatesReference.CalculationPeriodsDatesReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public CalculationPeriodsDatesReference.CalculationPeriodsDatesReferenceBuilder setHref(String _href) {
