...
import fpml.consolidated.asset.Option;
...
public class OptionOnlyExistsValidator implements ValidatorWithArg<Option, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends Option> ValidationResult<Option> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("Option", ValidationResult.ValidationType.ONLY_EXISTS, "Option", path, "");
		}
		return failure("Option", ValidationResult.ValidationType.ONLY_EXISTS, "Option", path, "",
