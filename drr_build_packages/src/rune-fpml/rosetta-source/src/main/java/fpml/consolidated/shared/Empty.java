...
import fpml.consolidated.shared.meta.EmptyMeta;
 ...
 *
 * Provision A special type meant to be used for elements with no content and no attributes.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="Empty", builder=Empty.EmptyBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Empty", model="fpml", builder=Empty.EmptyBuilderImpl.class, version="2.1.1")
