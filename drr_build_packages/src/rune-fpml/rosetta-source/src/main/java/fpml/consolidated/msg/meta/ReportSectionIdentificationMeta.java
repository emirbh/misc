...
import fpml.consolidated.msg.validation.ReportSectionIdentificationTypeFormatValidator;
import fpml.consolidated.msg.validation.ReportSectionIdentificationValidator;
import fpml.consolidated.msg.validation.exists.ReportSectionIdentificationOnlyExistsValidator;
...
public class ReportSectionIdentificationMeta implements RosettaMetaData<ReportSectionIdentification> {
	...
	@Override
	public Validator<? super ReportSectionIdentification> validator(ValidatorFactory factory) {
		return factory.<ReportSectionIdentification>create(ReportSectionIdentificationValidator.class);
	}

	@Override
	public Validator<? super ReportSectionIdentification> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ReportSectionIdentification>create(ReportSectionIdentificationTypeFormatValidator.class);
	}
