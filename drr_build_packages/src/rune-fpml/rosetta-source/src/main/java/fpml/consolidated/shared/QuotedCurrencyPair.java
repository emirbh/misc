...
import fpml.consolidated.shared.meta.QuotedCurrencyPairMeta;
 ...
 *
 */
@RosettaDataType(value="QuotedCurrencyPair", builder=QuotedCurrencyPair.QuotedCurrencyPairBuilderImpl.class, version="2.1.1")
@RuneDataType(value="QuotedCurrencyPair", model="fpml", builder=QuotedCurrencyPair.QuotedCurrencyPairBuilderImpl.class, version="2.1.1")
public interface QuotedCurrencyPair extends RosettaModelObject {
	...
	class QuotedCurrencyPairBuilderImpl implements QuotedCurrencyPair.QuotedCurrencyPairBuilder {
		...
		@RuneAttribute("currency1")
		@Override
		public QuotedCurrencyPair.QuotedCurrencyPairBuilder setCurrency1(Currency _currency1) {
		...
		@RuneAttribute("currency2")
		@Override
		public QuotedCurrencyPair.QuotedCurrencyPairBuilder setCurrency2(Currency _currency2) {
		...
		@RuneAttribute("quoteBasis")
		@Override
		public QuotedCurrencyPair.QuotedCurrencyPairBuilder setQuoteBasis(QuoteBasisEnum _quoteBasis) {
