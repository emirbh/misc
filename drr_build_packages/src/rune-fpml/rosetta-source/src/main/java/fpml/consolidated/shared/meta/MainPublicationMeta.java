...
import fpml.consolidated.shared.validation.MainPublicationTypeFormatValidator;
import fpml.consolidated.shared.validation.MainPublicationValidator;
import fpml.consolidated.shared.validation.exists.MainPublicationOnlyExistsValidator;
...
public class MainPublicationMeta implements RosettaMetaData<MainPublication> {
	...
	@Override
	public Validator<? super MainPublication> validator(ValidatorFactory factory) {
		return factory.<MainPublication>create(MainPublicationValidator.class);
	}

	@Override
	public Validator<? super MainPublication> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MainPublication>create(MainPublicationTypeFormatValidator.class);
	}
