...
import fpml.consolidated.cd.meta.NotDomesticCurrencyMeta;
 ...
 *
 */
@RosettaDataType(value="NotDomesticCurrency", builder=NotDomesticCurrency.NotDomesticCurrencyBuilderImpl.class, version="2.1.1")
@RuneDataType(value="NotDomesticCurrency", model="fpml", builder=NotDomesticCurrency.NotDomesticCurrencyBuilderImpl.class, version="2.1.1")
public interface NotDomesticCurrency extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Indicates whether the not domestic currency provision is applicable.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An explicit specification of the domestic currency.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class NotDomesticCurrencyBuilderImpl implements NotDomesticCurrency.NotDomesticCurrencyBuilder {
		...
		@RuneAttribute("applicable")
		@Override
		public NotDomesticCurrency.NotDomesticCurrencyBuilder setApplicable(Boolean _applicable) {
		...
		@RuneAttribute("currency")
		@Override
		public NotDomesticCurrency.NotDomesticCurrencyBuilder setCurrency(Currency _currency) {
