		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CoalDeliveryPoint", ValidationResult.ValidationType.CARDINALITY, "CoalDeliveryPoint", path, "", res.getError());
				}
				return success("CoalDeliveryPoint", ValidationResult.ValidationType.CARDINALITY, "CoalDeliveryPoint", path, "");
			})
			.collect(toList());
	}
