		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("GoverningLaw", ValidationResult.ValidationType.CARDINALITY, "GoverningLaw", path, "", res.getError());
				}
				return success("GoverningLaw", ValidationResult.ValidationType.CARDINALITY, "GoverningLaw", path, "");
			})
			.collect(toList());
	}
