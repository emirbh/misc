...
public class FormulaOnlyExistsValidator implements ValidatorWithArg<Formula, Set<String>> {
	...
	public <T2 extends Formula> ValidationResult<Formula> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("math", ExistenceChecker.isSet((fpml.consolidated.shared.Math) o.getMath()))
		...
		if (setFields.equals(fields)) {
			return success("Formula", ValidationResult.ValidationType.ONLY_EXISTS, "Formula", path, "");
		}
		return failure("Formula", ValidationResult.ValidationType.ONLY_EXISTS, "Formula", path, "",
