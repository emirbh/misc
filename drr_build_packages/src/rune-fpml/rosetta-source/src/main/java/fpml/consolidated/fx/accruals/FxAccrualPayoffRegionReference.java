...
import fpml.consolidated.fx.accruals.meta.FxAccrualPayoffRegionReferenceMeta;
 ...
 *
 * Provision Reference to a FX Accrual Payoff Region.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FxAccrualPayoffRegionReference", builder=FxAccrualPayoffRegionReference.FxAccrualPayoffRegionReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxAccrualPayoffRegionReference", model="fpml", builder=FxAccrualPayoffRegionReference.FxAccrualPayoffRegionReferenceBuilderImpl.class, version="2.1.1")
public interface FxAccrualPayoffRegionReference extends Reference {
	...
	class FxAccrualPayoffRegionReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements FxAccrualPayoffRegionReference.FxAccrualPayoffRegionReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public FxAccrualPayoffRegionReference.FxAccrualPayoffRegionReferenceBuilder setHref(String _href) {
