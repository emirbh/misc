...
import fpml.consolidated.shared.meta.ResourceLengthMeta;
 ...
 *
 * Provision The type that indicates the length of the resource.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ResourceLength", builder=ResourceLength.ResourceLengthBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ResourceLength", model="fpml", builder=ResourceLength.ResourceLengthBuilderImpl.class, version="2.1.1")
public interface ResourceLength extends RosettaModelObject {
	...
	class ResourceLengthBuilderImpl implements ResourceLength.ResourceLengthBuilder {
		...
		@RuneAttribute("lengthUnit")
		@Override
		public ResourceLength.ResourceLengthBuilder setLengthUnit(LengthUnitEnum _lengthUnit) {
			this.lengthUnit = _lengthUnit == null ? null : _lengthUnit;
			return this;
		}
		...
		@RuneAttribute("lengthValue")
		@Override
		public ResourceLength.ResourceLengthBuilder setLengthValue(BigDecimal _lengthValue) {
			this.lengthValue = _lengthValue == null ? null : _lengthValue;
			return this;
		}
