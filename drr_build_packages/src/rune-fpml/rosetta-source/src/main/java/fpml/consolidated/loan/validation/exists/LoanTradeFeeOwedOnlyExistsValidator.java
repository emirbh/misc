...
public class LoanTradeFeeOwedOnlyExistsValidator implements ValidatorWithArg<LoanTradeFeeOwed, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTradeFeeOwed> ValidationResult<LoanTradeFeeOwed> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeFeeOwed", ValidationResult.ValidationType.ONLY_EXISTS, "LoanTradeFeeOwed", path, "");
		}
		return failure("LoanTradeFeeOwed", ValidationResult.ValidationType.ONLY_EXISTS, "LoanTradeFeeOwed", path, "",
