...
import fpml.consolidated.shared.validation.LanguageTypeFormatValidator;
import fpml.consolidated.shared.validation.LanguageValidator;
import fpml.consolidated.shared.validation.exists.LanguageOnlyExistsValidator;
...
public class LanguageMeta implements RosettaMetaData<Language> {
	...
	@Override
	public Validator<? super Language> validator(ValidatorFactory factory) {
		return factory.<Language>create(LanguageValidator.class);
	}

	@Override
	public Validator<? super Language> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Language>create(LanguageTypeFormatValidator.class);
	}
