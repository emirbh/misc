...
public class RequestAllocationRetractedOnlyExistsValidator implements ValidatorWithArg<RequestAllocationRetracted, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RequestAllocationRetracted> ValidationResult<RequestAllocationRetracted> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("blockTradeIdentifier", ExistenceChecker.isSet((TradeIdentifier) o.getBlockTradeIdentifier()))
				.put("allocations", ExistenceChecker.isSet((Allocations) o.getAllocations()))
		...
		if (setFields.equals(fields)) {
			return success("RequestAllocationRetracted", ValidationResult.ValidationType.ONLY_EXISTS, "RequestAllocationRetracted", path, "");
		}
		return failure("RequestAllocationRetracted", ValidationResult.ValidationType.ONLY_EXISTS, "RequestAllocationRetracted", path, "",
