...
import fpml.consolidated.shared.meta.ResourceTypeMeta;
 ...
 *
 * Provision The data type used for describing the type or purpose of a resource, e.g. "Confirmation".
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ResourceType", builder=ResourceType.ResourceTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ResourceType", model="fpml", builder=ResourceType.ResourceTypeBuilderImpl.class, version="2.1.1")
public interface ResourceType extends RosettaModelObject {
	...
	class ResourceTypeImpl implements ResourceType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("resourceTypeScheme")
	...
	class ResourceTypeBuilderImpl implements ResourceType.ResourceTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ResourceType.ResourceTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("resourceTypeScheme")
		@Override
		public ResourceType.ResourceTypeBuilder setResourceTypeScheme(String _resourceTypeScheme) {
			this.resourceTypeScheme = _resourceTypeScheme == null ? null : _resourceTypeScheme;
			return this;
		}
