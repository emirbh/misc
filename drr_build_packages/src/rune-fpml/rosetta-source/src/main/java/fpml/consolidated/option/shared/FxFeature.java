...
import fpml.consolidated.option.shared.meta.FxFeatureMeta;
 ...
 *
 * Provision A type for defining Fx Features.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FxFeature", builder=FxFeature.FxFeatureBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxFeature", model="fpml", builder=FxFeature.FxFeatureBuilderImpl.class, version="2.1.1")
public interface FxFeature extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Specifies the reference currency of the trade.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 *
	 */
	IdentifiedCurrency getReferenceCurrency();
	/**
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision If “Quanto” is specified as the Settlement Type in the relevant Transaction Supplement, an amount, as determined by the Calculation Agent in accordance with the Section 8.2 of the Equity Definitions.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision If “Cross-Currency” is specified as the Settlement Type in the relevant Transaction Supplement, an amount in the Settlement Currency, determined by the Calculation Agent as being equal to the number of Options exercised or deemed exercised, multiplied by: (Settlement Price – Strike Price) / (Strike Price – Settlement Price) x Multiplier x one unit of the Reference Currency converted into an amount in the Settlement Currency using the rate of exchange of the Settlement Currency as quoted on the Reference Price Source on the Valuation Date, provided that if the above is equal to a negative amount the Option Cash Settlement Amount shall be deemed to be zero.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	default void process(RosettaPath path, Processor processor) {
		processRosetta(path.newSubPath("referenceCurrency"), processor, IdentifiedCurrency.class, getReferenceCurrency());
	...
	interface FxFeatureBuilder extends FxFeature, RosettaModelObjectBuilder {
		IdentifiedCurrency.IdentifiedCurrencyBuilder getOrCreateReferenceCurrency();
		@Override
		IdentifiedCurrency.IdentifiedCurrencyBuilder getReferenceCurrency();
		...
		FxFeature.FxFeatureBuilder setReferenceCurrency(IdentifiedCurrency referenceCurrency);
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			processRosetta(path.newSubPath("referenceCurrency"), processor, IdentifiedCurrency.IdentifiedCurrencyBuilder.class, getReferenceCurrency());
	...
	class FxFeatureImpl implements FxFeature {
		private final IdentifiedCurrency referenceCurrency;
	...
	class FxFeatureBuilderImpl implements FxFeature.FxFeatureBuilder {
		...
		protected IdentifiedCurrency.IdentifiedCurrencyBuilder referenceCurrency;
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("referenceCurrency")
		public IdentifiedCurrency.IdentifiedCurrencyBuilder getReferenceCurrency() {
			return referenceCurrency;
		}
		
		@Override
		public IdentifiedCurrency.IdentifiedCurrencyBuilder getOrCreateReferenceCurrency() {
			IdentifiedCurrency.IdentifiedCurrencyBuilder result;
			if (referenceCurrency!=null) {
				result = referenceCurrency;
			}
			else {
				result = referenceCurrency = IdentifiedCurrency.builder();
			}
		...
		@RuneAttribute("referenceCurrency")
		@Override
		public FxFeature.FxFeatureBuilder setReferenceCurrency(IdentifiedCurrency _referenceCurrency) {
		...
		@RuneAttribute("composite")
		@Override
		public FxFeature.FxFeatureBuilder setComposite(Composite _composite) {
		...
		@RuneAttribute("quanto")
		@Override
		public FxFeature.FxFeatureBuilder setQuanto(Quanto _quanto) {
			this.quanto = _quanto == null ? null : _quanto.toBuilder();
			return this;
		}
		...
		@RuneAttribute("crossCurrency")
		@Override
		public FxFeature.FxFeatureBuilder setCrossCurrency(Composite _crossCurrency) {
			this.crossCurrency = _crossCurrency == null ? null : _crossCurrency.toBuilder();
			return this;
		}
