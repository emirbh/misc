...
public class CashflowTypeOnlyExistsValidator implements ValidatorWithArg<CashflowType, Set<String>> {
	...
	public <T2 extends CashflowType> ValidationResult<CashflowType> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("cashflowTypeScheme", ExistenceChecker.isSet((String) o.getCashflowTypeScheme()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CashflowType", ValidationResult.ValidationType.ONLY_EXISTS, "CashflowType", path, "");
		}
		return failure("CashflowType", ValidationResult.ValidationType.ONLY_EXISTS, "CashflowType", path, "",
