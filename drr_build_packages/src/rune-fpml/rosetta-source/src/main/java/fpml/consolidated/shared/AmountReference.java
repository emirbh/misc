...
import fpml.consolidated.shared.meta.AmountReferenceMeta;
 ...
 *
 * Provision Specifies a reference to a monetary amount.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="AmountReference", builder=AmountReference.AmountReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="AmountReference", model="fpml", builder=AmountReference.AmountReferenceBuilderImpl.class, version="2.1.1")
public interface AmountReference extends Reference {
	...
	class AmountReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements AmountReference.AmountReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public AmountReference.AmountReferenceBuilder setHref(String _href) {
