...
public class RegulatoryReportingStatusOnlyExistsValidator implements ValidatorWithArg<RegulatoryReportingStatus, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RegulatoryReportingStatus> ValidationResult<RegulatoryReportingStatus> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RegulatoryReportingStatus", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryReportingStatus", path, "");
		}
		return failure("RegulatoryReportingStatus", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryReportingStatus", path, "",
