...
public class NonpublicExecutionReportOnlyExistsValidator implements ValidatorWithArg<NonpublicExecutionReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends NonpublicExecutionReport> ValidationResult<NonpublicExecutionReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("scheduledDate", ExistenceChecker.isSet((List<? extends ScheduledDateBase>) o.getScheduledDate()))
		...
		if (setFields.equals(fields)) {
			return success("NonpublicExecutionReport", ValidationResult.ValidationType.ONLY_EXISTS, "NonpublicExecutionReport", path, "");
		}
		return failure("NonpublicExecutionReport", ValidationResult.ValidationType.ONLY_EXISTS, "NonpublicExecutionReport", path, "",
