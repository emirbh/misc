...
public class ContractualTermsSupplementOnlyExistsValidator implements ValidatorWithArg<ContractualTermsSupplement, Set<String>> {
	...
	public <T2 extends ContractualTermsSupplement> ValidationResult<ContractualTermsSupplement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("type", ExistenceChecker.isSet((ContractualSupplement) o._getType()))
		...
		if (setFields.equals(fields)) {
			return success("ContractualTermsSupplement", ValidationResult.ValidationType.ONLY_EXISTS, "ContractualTermsSupplement", path, "");
		}
		return failure("ContractualTermsSupplement", ValidationResult.ValidationType.ONLY_EXISTS, "ContractualTermsSupplement", path, "",
