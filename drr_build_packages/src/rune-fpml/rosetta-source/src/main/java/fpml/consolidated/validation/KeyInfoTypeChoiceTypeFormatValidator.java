		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("KeyInfoTypeChoice", ValidationResult.ValidationType.TYPE_FORMAT, "KeyInfoTypeChoice", path, "", res.getError());
				}
				return success("KeyInfoTypeChoice", ValidationResult.ValidationType.TYPE_FORMAT, "KeyInfoTypeChoice", path, "");
			})
			.collect(toList());
	}
