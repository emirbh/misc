...
import fpml.consolidated.doc.meta.ExecutionDateTimeMeta;
 ...
 *
 * Provision A type defining the trade execution date time and the source of it. For use inside containing types which already have a Reference to a Party that has assigned this trade execution date time.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ExecutionDateTime", builder=ExecutionDateTime.ExecutionDateTimeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ExecutionDateTime", model="fpml", builder=ExecutionDateTime.ExecutionDateTimeBuilderImpl.class, version="2.1.1")
public interface ExecutionDateTime extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Identification of the source (e.g. clock id) generating the execution date time.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class ExecutionDateTimeImpl implements ExecutionDateTime {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("executionDateTimeScheme")
	...
	class ExecutionDateTimeBuilderImpl implements ExecutionDateTime.ExecutionDateTimeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ExecutionDateTime.ExecutionDateTimeBuilder setValue(ZonedDateTime _value) {
		...
		@RuneAttribute("executionDateTimeScheme")
		@Override
		public ExecutionDateTime.ExecutionDateTimeBuilder setExecutionDateTimeScheme(String _executionDateTimeScheme) {
			this.executionDateTimeScheme = _executionDateTimeScheme == null ? null : _executionDateTimeScheme;
			return this;
		}
