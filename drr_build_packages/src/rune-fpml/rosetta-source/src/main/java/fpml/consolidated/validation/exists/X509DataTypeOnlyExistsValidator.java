...
public class X509DataTypeOnlyExistsValidator implements ValidatorWithArg<X509DataType, Set<String>> {
	...
	public <T2 extends X509DataType> ValidationResult<X509DataType> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("X509DataType", ValidationResult.ValidationType.ONLY_EXISTS, "X509DataType", path, "");
		}
		return failure("X509DataType", ValidationResult.ValidationType.ONLY_EXISTS, "X509DataType", path, "",
