...
public class StrikeScheduleOnlyExistsValidator implements ValidatorWithArg<StrikeSchedule, Set<String>> {
	...
	public <T2 extends StrikeSchedule> ValidationResult<StrikeSchedule> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("buyer", ExistenceChecker.isSet((IdentifiedPayerReceiver) o.getBuyer()))
				.put("seller", ExistenceChecker.isSet((IdentifiedPayerReceiver) o.getSeller()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("StrikeSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "StrikeSchedule", path, "");
		}
		return failure("StrikeSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "StrikeSchedule", path, "",
