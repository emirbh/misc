...
import fpml.consolidated.asset.meta.FacilityTypeMeta;
 ...
 *
 * Provision A type describing the type of loan facility.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FacilityType", builder=FacilityType.FacilityTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FacilityType", model="fpml", builder=FacilityType.FacilityTypeBuilderImpl.class, version="2.1.1")
public interface FacilityType extends RosettaModelObject {
	...
	class FacilityTypeImpl implements FacilityType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("facilityTypeScheme")
	...
	class FacilityTypeBuilderImpl implements FacilityType.FacilityTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public FacilityType.FacilityTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("facilityTypeScheme")
		@Override
		public FacilityType.FacilityTypeBuilder setFacilityTypeScheme(String _facilityTypeScheme) {
			this.facilityTypeScheme = _facilityTypeScheme == null ? null : _facilityTypeScheme;
			return this;
		}
