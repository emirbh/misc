...
public class InterestCapitalizationValidator implements Validator<InterestCapitalization> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("InterestCapitalization", ValidationResult.ValidationType.CARDINALITY, "InterestCapitalization", path, "", res.getError());
				}
				return success("InterestCapitalization", ValidationResult.ValidationType.CARDINALITY, "InterestCapitalization", path, "");
			})
			.collect(toList());
	}
