...
import fpml.consolidated.asset.validation.LienTypeFormatValidator;
import fpml.consolidated.asset.validation.LienValidator;
import fpml.consolidated.asset.validation.exists.LienOnlyExistsValidator;
...
public class LienMeta implements RosettaMetaData<Lien> {
	...
	@Override
	public Validator<? super Lien> validator(ValidatorFactory factory) {
		return factory.<Lien>create(LienValidator.class);
	}

	@Override
	public Validator<? super Lien> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Lien>create(LienTypeFormatValidator.class);
	}
