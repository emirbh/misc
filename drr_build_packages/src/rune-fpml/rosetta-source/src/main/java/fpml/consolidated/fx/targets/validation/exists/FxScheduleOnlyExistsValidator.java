...
public class FxScheduleOnlyExistsValidator implements ValidatorWithArg<FxSchedule, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FxSchedule> ValidationResult<FxSchedule> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FxSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "FxSchedule", path, "");
		}
		return failure("FxSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "FxSchedule", path, "",
