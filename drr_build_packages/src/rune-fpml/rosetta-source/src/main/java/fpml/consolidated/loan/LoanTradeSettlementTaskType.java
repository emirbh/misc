...
import fpml.consolidated.loan.meta.LoanTradeSettlementTaskTypeMeta;
 ...
 *
 * Provision A structure that uniquely identifies a settlement task type within a syndicated loan structure.
 *
 */
@RosettaDataType(value="LoanTradeSettlementTaskType", builder=LoanTradeSettlementTaskType.LoanTradeSettlementTaskTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="LoanTradeSettlementTaskType", model="fpml", builder=LoanTradeSettlementTaskType.LoanTradeSettlementTaskTypeBuilderImpl.class, version="2.1.1")
public interface LoanTradeSettlementTaskType extends RosettaModelObject {
	...
	class LoanTradeSettlementTaskTypeImpl implements LoanTradeSettlementTaskType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("tradeSettlementTaskTypeScheme")
	...
	class LoanTradeSettlementTaskTypeBuilderImpl implements LoanTradeSettlementTaskType.LoanTradeSettlementTaskTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public LoanTradeSettlementTaskType.LoanTradeSettlementTaskTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("tradeSettlementTaskTypeScheme")
		@Override
		public LoanTradeSettlementTaskType.LoanTradeSettlementTaskTypeBuilder setTradeSettlementTaskTypeScheme(String _tradeSettlementTaskTypeScheme) {
			this.tradeSettlementTaskTypeScheme = _tradeSettlementTaskTypeScheme == null ? null : _tradeSettlementTaskTypeScheme;
			return this;
		}
