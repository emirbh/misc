...
import fpml.consolidated.doc.meta.ConfirmationMethodMeta;
 ...
 *
 * Provision A type used to represent the type of mechanism that can be used to confirm a trade.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ConfirmationMethod", builder=ConfirmationMethod.ConfirmationMethodBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ConfirmationMethod", model="fpml", builder=ConfirmationMethod.ConfirmationMethodBuilderImpl.class, version="2.1.1")
public interface ConfirmationMethod extends RosettaModelObject {
	...
	class ConfirmationMethodImpl implements ConfirmationMethod {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("confirmationMethodScheme")
	...
	class ConfirmationMethodBuilderImpl implements ConfirmationMethod.ConfirmationMethodBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ConfirmationMethod.ConfirmationMethodBuilder setValue(String _value) {
		...
		@RuneAttribute("confirmationMethodScheme")
		@Override
		public ConfirmationMethod.ConfirmationMethodBuilder setConfirmationMethodScheme(String _confirmationMethodScheme) {
			this.confirmationMethodScheme = _confirmationMethodScheme == null ? null : _confirmationMethodScheme;
			return this;
		}
