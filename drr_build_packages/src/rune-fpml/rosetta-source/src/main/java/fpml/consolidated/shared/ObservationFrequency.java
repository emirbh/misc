...
import fpml.consolidated.shared.meta.ObservationFrequencyMeta;
 ...
 *
 */
@RosettaDataType(value="ObservationFrequency", builder=ObservationFrequency.ObservationFrequencyBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ObservationFrequency", model="fpml", builder=ObservationFrequency.ObservationFrequencyBuilderImpl.class, version="2.1.1")
public interface ObservationFrequency extends Period {
	...
	class ObservationFrequencyImpl extends Period.PeriodImpl implements ObservationFrequency {
		...
		@RuneAttribute("periodConvention")
	...
	class ObservationFrequencyBuilderImpl extends Period.PeriodBuilderImpl implements ObservationFrequency.ObservationFrequencyBuilder {
		...
		@RuneAttribute("id")
		@Override
		public ObservationFrequency.ObservationFrequencyBuilder setId(String _id) {
		...
		@Override
		public ObservationFrequency.ObservationFrequencyBuilder setPeriodMultiplier(Integer _periodMultiplier) {
		...
		@Override
		public ObservationFrequency.ObservationFrequencyBuilder setPeriod(PeriodEnum _period) {
		...
		@RuneAttribute("periodConvention")
		@Override
		public ObservationFrequency.ObservationFrequencyBuilder setPeriodConvention(RollConventionEnum _periodConvention) {
			this.periodConvention = _periodConvention == null ? null : _periodConvention;
			return this;
		}
