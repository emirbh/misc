...
import fpml.consolidated.shared.meta.OffsetMeta;
 ...
 *
 * Provision A type defining an offset used in calculating a new date relative to a reference date. E.g. calendar days, business days, Commodity Business days, etc..
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="Offset", builder=Offset.OffsetBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Offset", model="fpml", builder=Offset.OffsetBuilderImpl.class, version="2.1.1")
public interface Offset extends Period {
	...
	class OffsetBuilderImpl extends Period.PeriodBuilderImpl implements Offset.OffsetBuilder {
		...
		@RuneAttribute("id")
		@Override
		public Offset.OffsetBuilder setId(String _id) {
		...
		@Override
		public Offset.OffsetBuilder setPeriodMultiplier(Integer _periodMultiplier) {
		...
		@Override
		public Offset.OffsetBuilder setPeriod(PeriodEnum _period) {
		...
		@RuneAttribute("dayType")
		@Override
		public Offset.OffsetBuilder setDayType(DayTypeEnum _dayType) {
