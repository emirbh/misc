...
public class VerificationStatusNotificationTypeFormatValidator implements Validator<VerificationStatusNotification> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("VerificationStatusNotification", ValidationResult.ValidationType.TYPE_FORMAT, "VerificationStatusNotification", path, "", res.getError());
				}
				return success("VerificationStatusNotification", ValidationResult.ValidationType.TYPE_FORMAT, "VerificationStatusNotification", path, "");
			})
			.collect(toList());
	}
