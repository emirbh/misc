...
public class AccruingFeeChangeOnlyExistsValidator implements ValidatorWithArg<AccruingFeeChange, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AccruingFeeChange> ValidationResult<AccruingFeeChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("accruingFeeOption", ExistenceChecker.isSet((AccruingFeeOption) o.getAccruingFeeOption()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AccruingFeeChange", ValidationResult.ValidationType.ONLY_EXISTS, "AccruingFeeChange", path, "");
		}
		return failure("AccruingFeeChange", ValidationResult.ValidationType.ONLY_EXISTS, "AccruingFeeChange", path, "",
