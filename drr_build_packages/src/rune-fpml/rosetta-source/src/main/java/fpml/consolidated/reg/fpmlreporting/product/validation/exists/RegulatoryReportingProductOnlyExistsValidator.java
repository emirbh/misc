...
public class RegulatoryReportingProductOnlyExistsValidator implements ValidatorWithArg<RegulatoryReportingProduct, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RegulatoryReportingProduct> ValidationResult<RegulatoryReportingProduct> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RegulatoryReportingProduct", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryReportingProduct", path, "");
		}
		return failure("RegulatoryReportingProduct", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryReportingProduct", path, "",
