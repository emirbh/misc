...
public class VarianceLegOnlyExistsValidator implements ValidatorWithArg<VarianceLeg, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends VarianceLeg> ValidationResult<VarianceLeg> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("amount", ExistenceChecker.isSet((VarianceAmount) o.getAmount()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("VarianceLeg", ValidationResult.ValidationType.ONLY_EXISTS, "VarianceLeg", path, "");
		}
		return failure("VarianceLeg", ValidationResult.ValidationType.ONLY_EXISTS, "VarianceLeg", path, "",
