...
import fpml.consolidated.shared.meta.MatchIdMeta;
 ...
 *
 * Provision An identifier used to identify matched cashflows.
 *
 */
@RosettaDataType(value="MatchId", builder=MatchId.MatchIdBuilderImpl.class, version="2.1.1")
@RuneDataType(value="MatchId", model="fpml", builder=MatchId.MatchIdBuilderImpl.class, version="2.1.1")
public interface MatchId extends RosettaModelObject {
	...
	class MatchIdBuilderImpl implements MatchId.MatchIdBuilder {
		...
		@RuneAttribute("value")
		@Override
		public MatchId.MatchIdBuilder setValue(String _value) {
		...
		@RuneAttribute("matchIdScheme")
		@Override
		public MatchId.MatchIdBuilder setMatchIdScheme(String _matchIdScheme) {
			this.matchIdScheme = _matchIdScheme == null ? null : _matchIdScheme;
			return this;
		}
