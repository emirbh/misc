...
import fpml.consolidated.msg.validation.ReportIdTypeFormatValidator;
import fpml.consolidated.msg.validation.ReportIdValidator;
import fpml.consolidated.msg.validation.exists.ReportIdOnlyExistsValidator;
...
public class ReportIdMeta implements RosettaMetaData<ReportId> {
	...
	@Override
	public Validator<? super ReportId> validator(ValidatorFactory factory) {
		return factory.<ReportId>create(ReportIdValidator.class);
	}

	@Override
	public Validator<? super ReportId> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ReportId>create(ReportIdTypeFormatValidator.class);
	}
