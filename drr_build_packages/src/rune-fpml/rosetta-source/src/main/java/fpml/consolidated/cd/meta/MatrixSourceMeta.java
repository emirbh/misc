...
import fpml.consolidated.cd.validation.MatrixSourceTypeFormatValidator;
import fpml.consolidated.cd.validation.MatrixSourceValidator;
import fpml.consolidated.cd.validation.exists.MatrixSourceOnlyExistsValidator;
...
public class MatrixSourceMeta implements RosettaMetaData<MatrixSource> {
	...
	@Override
	public Validator<? super MatrixSource> validator(ValidatorFactory factory) {
		return factory.<MatrixSource>create(MatrixSourceValidator.class);
	}

	@Override
	public Validator<? super MatrixSource> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MatrixSource>create(MatrixSourceTypeFormatValidator.class);
	}
