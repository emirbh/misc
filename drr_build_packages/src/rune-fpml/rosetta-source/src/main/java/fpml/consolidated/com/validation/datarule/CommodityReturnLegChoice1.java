 ...
 * @version 2.1.1
 */
@RosettaDataRule("CommodityReturnLegChoice1")
@ImplementedBy(CommodityReturnLegChoice1.Default.class)
public interface CommodityReturnLegChoice1 extends Validator<CommodityReturnLeg> {
	
	String NAME = "CommodityReturnLegChoice1";
	String DEFINITION = "required choice commodity, commodityBasket";
	
	class Default implements CommodityReturnLegChoice1 {
		...
		private ComparisonResult executeDataRule(CommodityReturnLeg commodityReturnLeg) {
			try {
				return choice(MapperS.of(commodityReturnLeg), Arrays.asList("commodity", "commodityBasket"), ChoiceRuleValidationMethod.REQUIRED);
			}
			catch (Exception ex) {
	...
	class NoOp implements CommodityReturnLegChoice1 {
