...
import fpml.consolidated.doc.meta.ReportingRoleMeta;
 ...
 *
 * Provision A type containing a code representing the role of a party in a report, e.g. the originator, the recipient, the counterparty, etc. This is used to clarify which participant's information is being reported.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ReportingRole", builder=ReportingRole.ReportingRoleBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ReportingRole", model="fpml", builder=ReportingRole.ReportingRoleBuilderImpl.class, version="2.1.1")
public interface ReportingRole extends RosettaModelObject {
	...
	class ReportingRoleImpl implements ReportingRole {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("reportingRoleScheme")
	...
	class ReportingRoleBuilderImpl implements ReportingRole.ReportingRoleBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ReportingRole.ReportingRoleBuilder setValue(String _value) {
		...
		@RuneAttribute("reportingRoleScheme")
		@Override
		public ReportingRole.ReportingRoleBuilder setReportingRoleScheme(String _reportingRoleScheme) {
			this.reportingRoleScheme = _reportingRoleScheme == null ? null : _reportingRoleScheme;
			return this;
		}
		...
		@RuneAttribute("id")
		@Override
		public ReportingRole.ReportingRoleBuilder setId(String _id) {
