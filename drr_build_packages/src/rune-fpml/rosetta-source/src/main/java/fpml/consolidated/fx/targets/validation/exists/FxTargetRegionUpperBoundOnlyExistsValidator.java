...
public class FxTargetRegionUpperBoundOnlyExistsValidator implements ValidatorWithArg<FxTargetRegionUpperBound, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FxTargetRegionUpperBound> ValidationResult<FxTargetRegionUpperBound> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FxTargetRegionUpperBound", ValidationResult.ValidationType.ONLY_EXISTS, "FxTargetRegionUpperBound", path, "");
		}
		return failure("FxTargetRegionUpperBound", ValidationResult.ValidationType.ONLY_EXISTS, "FxTargetRegionUpperBound", path, "",
