...
public class CoalPhysicalLegOnlyExistsValidator implements ValidatorWithArg<CoalPhysicalLeg, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CoalPhysicalLeg> ValidationResult<CoalPhysicalLeg> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("deliveryConditions", ExistenceChecker.isSet((CoalDelivery) o.getDeliveryConditions()))
		...
		if (setFields.equals(fields)) {
			return success("CoalPhysicalLeg", ValidationResult.ValidationType.ONLY_EXISTS, "CoalPhysicalLeg", path, "");
		}
		return failure("CoalPhysicalLeg", ValidationResult.ValidationType.ONLY_EXISTS, "CoalPhysicalLeg", path, "",
