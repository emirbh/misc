...
public class AccrualOptionChangeOnlyExistsValidator implements ValidatorWithArg<AccrualOptionChange, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AccrualOptionChange> ValidationResult<AccrualOptionChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("letterOfCreditReference", ExistenceChecker.isSet((List<? extends LetterOfCreditReference>) o.getLetterOfCreditReference()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AccrualOptionChange", ValidationResult.ValidationType.ONLY_EXISTS, "AccrualOptionChange", path, "");
		}
		return failure("AccrualOptionChange", ValidationResult.ValidationType.ONLY_EXISTS, "AccrualOptionChange", path, "",
