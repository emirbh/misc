...
public class ClearingEligibilityAcknowledgementValidator implements Validator<ClearingEligibilityAcknowledgement> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ClearingEligibilityAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "ClearingEligibilityAcknowledgement", path, "", res.getError());
				}
				return success("ClearingEligibilityAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "ClearingEligibilityAcknowledgement", path, "");
			})
			.collect(toList());
	}
