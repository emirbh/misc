		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommoditySettlementPeriodsPriceSchedule", ValidationResult.ValidationType.CARDINALITY, "CommoditySettlementPeriodsPriceSchedule", path, "", res.getError());
				}
				return success("CommoditySettlementPeriodsPriceSchedule", ValidationResult.ValidationType.CARDINALITY, "CommoditySettlementPeriodsPriceSchedule", path, "");
			})
			.collect(toList());
	}
