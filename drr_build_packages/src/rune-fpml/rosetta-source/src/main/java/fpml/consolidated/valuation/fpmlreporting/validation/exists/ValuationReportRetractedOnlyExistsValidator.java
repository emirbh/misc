...
public class ValuationReportRetractedOnlyExistsValidator implements ValidatorWithArg<ValuationReportRetracted, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ValuationReportRetracted> ValidationResult<ValuationReportRetracted> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("reportIdentification", ExistenceChecker.isSet((ReportIdentification) o.getReportIdentification()))
				...
				.put("partyTradeInformation", ExistenceChecker.isSet((List<? extends PartyTradeInformationSimple>) o.getPartyTradeInformation()))
		...
		if (setFields.equals(fields)) {
			return success("ValuationReportRetracted", ValidationResult.ValidationType.ONLY_EXISTS, "ValuationReportRetracted", path, "");
		}
		return failure("ValuationReportRetracted", ValidationResult.ValidationType.ONLY_EXISTS, "ValuationReportRetracted", path, "",
