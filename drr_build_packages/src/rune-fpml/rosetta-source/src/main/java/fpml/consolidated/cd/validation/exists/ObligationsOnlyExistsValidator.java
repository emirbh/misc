...
public class ObligationsOnlyExistsValidator implements ValidatorWithArg<Obligations, Set<String>> {
	...
	public <T2 extends Obligations> ValidationResult<Obligations> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("designatedPriority", ExistenceChecker.isSet((Lien) o.getDesignatedPriority()))
		...
		if (setFields.equals(fields)) {
			return success("Obligations", ValidationResult.ValidationType.ONLY_EXISTS, "Obligations", path, "");
		}
		return failure("Obligations", ValidationResult.ValidationType.ONLY_EXISTS, "Obligations", path, "",
