...
public class RegulatoryClassificationMifirRTS6b_2015Validator implements Validator<RegulatoryClassificationMifirRTS6b_2015> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RegulatoryClassificationMifirRTS6b_2015", ValidationResult.ValidationType.CARDINALITY, "RegulatoryClassificationMifirRTS6b_2015", path, "", res.getError());
				}
				return success("RegulatoryClassificationMifirRTS6b_2015", ValidationResult.ValidationType.CARDINALITY, "RegulatoryClassificationMifirRTS6b_2015", path, "");
			})
			.collect(toList());
	}
