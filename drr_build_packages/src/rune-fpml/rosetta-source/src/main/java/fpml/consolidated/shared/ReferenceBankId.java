...
import fpml.consolidated.shared.meta.ReferenceBankIdMeta;
 ...
 *
 */
@RosettaDataType(value="ReferenceBankId", builder=ReferenceBankId.ReferenceBankIdBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ReferenceBankId", model="fpml", builder=ReferenceBankId.ReferenceBankIdBuilderImpl.class, version="2.1.1")
public interface ReferenceBankId extends RosettaModelObject {
	...
	class ReferenceBankIdImpl implements ReferenceBankId {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("referenceBankIdScheme")
	...
	class ReferenceBankIdBuilderImpl implements ReferenceBankId.ReferenceBankIdBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ReferenceBankId.ReferenceBankIdBuilder setValue(String _value) {
		...
		@RuneAttribute("referenceBankIdScheme")
		@Override
		public ReferenceBankId.ReferenceBankIdBuilder setReferenceBankIdScheme(String _referenceBankIdScheme) {
			this.referenceBankIdScheme = _referenceBankIdScheme == null ? null : _referenceBankIdScheme;
			return this;
		}
