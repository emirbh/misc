...
import fpml.consolidated.eq.shared.meta.ReturnSwapEarlyTerminationMeta;
 ...
 *
 * Provision A type describing the date from which each of the party may be allowed to terminate the trade.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ReturnSwapEarlyTermination", builder=ReturnSwapEarlyTermination.ReturnSwapEarlyTerminationBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ReturnSwapEarlyTermination", model="fpml", builder=ReturnSwapEarlyTermination.ReturnSwapEarlyTerminationBuilderImpl.class, version="2.1.1")
public interface ReturnSwapEarlyTermination extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Specifies the date from which the early termination clause can be exercised.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class ReturnSwapEarlyTerminationBuilderImpl implements ReturnSwapEarlyTermination.ReturnSwapEarlyTerminationBuilder {
		...
		@RuneAttribute("partyReference")
		@Override
		public ReturnSwapEarlyTermination.ReturnSwapEarlyTerminationBuilder setPartyReference(PartyReference _partyReference) {
		...
		@RuneAttribute("startingDate")
		@Override
		public ReturnSwapEarlyTermination.ReturnSwapEarlyTerminationBuilder setStartingDate(StartingDate _startingDate) {
