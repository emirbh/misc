		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FloatingRateCalculation", ValidationResult.ValidationType.TYPE_FORMAT, "FloatingRateCalculation", path, "", res.getError());
				}
				return success("FloatingRateCalculation", ValidationResult.ValidationType.TYPE_FORMAT, "FloatingRateCalculation", path, "");
			})
			.collect(toList());
	}
