...
public class SpreadScheduleOnlyExistsValidator implements ValidatorWithArg<SpreadSchedule, Set<String>> {
	...
	public <T2 extends SpreadSchedule> ValidationResult<SpreadSchedule> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("type", ExistenceChecker.isSet((SpreadScheduleType) o._getType()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("SpreadSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "SpreadSchedule", path, "");
		}
		return failure("SpreadSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "SpreadSchedule", path, "",
