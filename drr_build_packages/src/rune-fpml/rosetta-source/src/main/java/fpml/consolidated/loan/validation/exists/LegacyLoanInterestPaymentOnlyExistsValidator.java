...
public class LegacyLoanInterestPaymentOnlyExistsValidator implements ValidatorWithArg<LegacyLoanInterestPayment, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LegacyLoanInterestPayment> ValidationResult<LegacyLoanInterestPayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LegacyLoanInterestPayment", ValidationResult.ValidationType.ONLY_EXISTS, "LegacyLoanInterestPayment", path, "");
		}
		return failure("LegacyLoanInterestPayment", ValidationResult.ValidationType.ONLY_EXISTS, "LegacyLoanInterestPayment", path, "",
