...
import fpml.consolidated.ird.meta.BondReferenceMeta;
 ...
 *
 * Provision A type including a reference to a bond to support the representation of an asset swap or Condition Precedent Bond.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="BondReference", builder=BondReference.BondReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="BondReference", model="fpml", builder=BondReference.BondReferenceBuilderImpl.class, version="2.1.1")
public interface BondReference extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Reference to a bond underlyer.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision To indicate whether the Condition Precedent Bond is applicable. The swap contract is only valid if the bond is issued and if there is any dispute over the terms of fixed stream then the bond terms would be used.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision To indicate whether the Discrepancy Clause is applicable.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class BondReferenceBuilderImpl implements BondReference.BondReferenceBuilder {
		...
		@RuneAttribute("bond")
		@Override
		public BondReference.BondReferenceBuilder setBond(Bond _bond) {
