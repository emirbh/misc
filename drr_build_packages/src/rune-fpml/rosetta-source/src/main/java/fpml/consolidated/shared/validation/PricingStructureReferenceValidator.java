		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PricingStructureReference", ValidationResult.ValidationType.CARDINALITY, "PricingStructureReference", path, "", res.getError());
				}
				return success("PricingStructureReference", ValidationResult.ValidationType.CARDINALITY, "PricingStructureReference", path, "");
			})
			.collect(toList());
	}
