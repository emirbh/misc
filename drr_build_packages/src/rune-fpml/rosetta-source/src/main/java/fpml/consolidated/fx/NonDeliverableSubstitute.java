...
import fpml.consolidated.fx.meta.NonDeliverableSubstituteMeta;
 ...
 *
 * Provision Describes a currency which may be delivered instead
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="NonDeliverableSubstitute", builder=NonDeliverableSubstitute.NonDeliverableSubstituteBuilderImpl.class, version="2.1.1")
@RuneDataType(value="NonDeliverableSubstitute", model="fpml", builder=NonDeliverableSubstitute.NonDeliverableSubstituteBuilderImpl.class, version="2.1.1")
public interface NonDeliverableSubstitute extends FxDisruptionFallback {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The code for the currency which can be delivered if settlement in the original non-deliverable currency is not possible.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class NonDeliverableSubstituteBuilderImpl extends FxDisruptionFallback.FxDisruptionFallbackBuilderImpl implements NonDeliverableSubstitute.NonDeliverableSubstituteBuilder {
		...
		@RuneAttribute("currency")
		@Override
		public NonDeliverableSubstitute.NonDeliverableSubstituteBuilder setCurrency(Currency _currency) {
