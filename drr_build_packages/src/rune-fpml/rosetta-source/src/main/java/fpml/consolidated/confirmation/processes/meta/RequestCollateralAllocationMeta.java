...
import fpml.consolidated.confirmation.processes.validation.RequestCollateralAllocationTypeFormatValidator;
import fpml.consolidated.confirmation.processes.validation.RequestCollateralAllocationValidator;
import fpml.consolidated.confirmation.processes.validation.exists.RequestCollateralAllocationOnlyExistsValidator;
...
public class RequestCollateralAllocationMeta implements RosettaMetaData<RequestCollateralAllocation> {
	...
	@Override
	public Validator<? super RequestCollateralAllocation> validator(ValidatorFactory factory) {
		return factory.<RequestCollateralAllocation>create(RequestCollateralAllocationValidator.class);
	}

	@Override
	public Validator<? super RequestCollateralAllocation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<RequestCollateralAllocation>create(RequestCollateralAllocationTypeFormatValidator.class);
	}
