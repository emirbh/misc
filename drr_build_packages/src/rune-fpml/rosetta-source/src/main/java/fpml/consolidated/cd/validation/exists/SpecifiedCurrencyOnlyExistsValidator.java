...
public class SpecifiedCurrencyOnlyExistsValidator implements ValidatorWithArg<SpecifiedCurrency, Set<String>> {
	...
	public <T2 extends SpecifiedCurrency> ValidationResult<SpecifiedCurrency> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("currency", ExistenceChecker.isSet((List<? extends Currency>) o.getCurrency()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("SpecifiedCurrency", ValidationResult.ValidationType.ONLY_EXISTS, "SpecifiedCurrency", path, "");
		}
		return failure("SpecifiedCurrency", ValidationResult.ValidationType.ONLY_EXISTS, "SpecifiedCurrency", path, "",
