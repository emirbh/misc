		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxAccrual", ValidationResult.ValidationType.TYPE_FORMAT, "FxAccrual", path, "", res.getError());
				}
				return success("FxAccrual", ValidationResult.ValidationType.TYPE_FORMAT, "FxAccrual", path, "");
			})
			.collect(toList());
	}
