...
import fpml.consolidated.shared.meta.AdjustableDatesOrRelativeDateOffsetMeta;
 ...
 *
 * Provision A type for defining a series of dates, either as a list of adjustable dates, or a as a repeating sequence from a base date
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="AdjustableDatesOrRelativeDateOffset", builder=AdjustableDatesOrRelativeDateOffset.AdjustableDatesOrRelativeDateOffsetBuilderImpl.class, version="2.1.1")
@RuneDataType(value="AdjustableDatesOrRelativeDateOffset", model="fpml", builder=AdjustableDatesOrRelativeDateOffset.AdjustableDatesOrRelativeDateOffsetBuilderImpl.class, version="2.1.1")
public interface AdjustableDatesOrRelativeDateOffset extends RosettaModelObject {
	...
	class AdjustableDatesOrRelativeDateOffsetBuilderImpl implements AdjustableDatesOrRelativeDateOffset.AdjustableDatesOrRelativeDateOffsetBuilder {
		...
		@RuneAttribute("adjustableDates")
		@Override
		public AdjustableDatesOrRelativeDateOffset.AdjustableDatesOrRelativeDateOffsetBuilder setAdjustableDates(AdjustableDates _adjustableDates) {
		...
		@RuneAttribute("relativeDate")
		@Override
		public AdjustableDatesOrRelativeDateOffset.AdjustableDatesOrRelativeDateOffsetBuilder setRelativeDate(RelativeDateOffset _relativeDate) {
