...
import fpml.consolidated.com.meta.CommodityHubCodeMeta;
 ...
 *
 * Provision A scheme identifying the code for a hub or other reference for a physically settled commodity trade.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CommodityHubCode", builder=CommodityHubCode.CommodityHubCodeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityHubCode", model="fpml", builder=CommodityHubCode.CommodityHubCodeBuilderImpl.class, version="2.1.1")
public interface CommodityHubCode extends RosettaModelObject {
	...
	class CommodityHubCodeBuilderImpl implements CommodityHubCode.CommodityHubCodeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CommodityHubCode.CommodityHubCodeBuilder setValue(String _value) {
		...
		@RuneAttribute("hubCodeScheme")
		@Override
		public CommodityHubCode.CommodityHubCodeBuilder setHubCodeScheme(String _hubCodeScheme) {
			this.hubCodeScheme = _hubCodeScheme == null ? null : _hubCodeScheme;
			return this;
		}
