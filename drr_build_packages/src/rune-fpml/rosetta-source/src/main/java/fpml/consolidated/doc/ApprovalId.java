...
import fpml.consolidated.doc.meta.ApprovalIdMeta;
 ...
 *
 * Provision An approval identifier allocated by a party. FpML does not define the domain values associated with this element.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ApprovalId", builder=ApprovalId.ApprovalIdBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ApprovalId", model="fpml", builder=ApprovalId.ApprovalIdBuilderImpl.class, version="2.1.1")
public interface ApprovalId extends RosettaModelObject {
	...
	class ApprovalIdImpl implements ApprovalId {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("approvalIdScheme")
	...
	class ApprovalIdBuilderImpl implements ApprovalId.ApprovalIdBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ApprovalId.ApprovalIdBuilder setValue(String _value) {
		...
		@RuneAttribute("approvalIdScheme")
		@Override
		public ApprovalId.ApprovalIdBuilder setApprovalIdScheme(String _approvalIdScheme) {
			this.approvalIdScheme = _approvalIdScheme == null ? null : _approvalIdScheme;
			return this;
		}
		...
		@RuneAttribute("id")
		@Override
		public ApprovalId.ApprovalIdBuilder setId(String _id) {
