		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("GasDeliveryPoint", ValidationResult.ValidationType.CARDINALITY, "GasDeliveryPoint", path, "", res.getError());
				}
				return success("GasDeliveryPoint", ValidationResult.ValidationType.CARDINALITY, "GasDeliveryPoint", path, "");
			})
			.collect(toList());
	}
