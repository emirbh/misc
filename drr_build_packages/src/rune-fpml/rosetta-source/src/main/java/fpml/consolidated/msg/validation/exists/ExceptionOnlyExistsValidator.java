...
public class ExceptionOnlyExistsValidator implements ValidatorWithArg<fpml.consolidated.msg.Exception, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends fpml.consolidated.msg.Exception> ValidationResult<fpml.consolidated.msg.Exception> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("Exception", ValidationResult.ValidationType.ONLY_EXISTS, "Exception", path, "");
		}
		return failure("Exception", ValidationResult.ValidationType.ONLY_EXISTS, "Exception", path, "",
