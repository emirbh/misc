		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxDigitalOption", ValidationResult.ValidationType.TYPE_FORMAT, "FxDigitalOption", path, "", res.getError());
				}
				return success("FxDigitalOption", ValidationResult.ValidationType.TYPE_FORMAT, "FxDigitalOption", path, "");
			})
			.collect(toList());
	}
