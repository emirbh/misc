...
public class AbstractLoanContractPaymentEventValidator implements Validator<AbstractLoanContractPaymentEvent> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractLoanContractPaymentEvent", ValidationResult.ValidationType.CARDINALITY, "AbstractLoanContractPaymentEvent", path, "", res.getError());
				}
				return success("AbstractLoanContractPaymentEvent", ValidationResult.ValidationType.CARDINALITY, "AbstractLoanContractPaymentEvent", path, "");
			})
			.collect(toList());
	}
