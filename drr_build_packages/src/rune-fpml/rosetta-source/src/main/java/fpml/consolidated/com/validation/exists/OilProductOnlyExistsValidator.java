...
public class OilProductOnlyExistsValidator implements ValidatorWithArg<OilProduct, Set<String>> {
	...
	public <T2 extends OilProduct> ValidationResult<OilProduct> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("type", ExistenceChecker.isSet((OilProductType) o._getType()))
		...
		if (setFields.equals(fields)) {
			return success("OilProduct", ValidationResult.ValidationType.ONLY_EXISTS, "OilProduct", path, "");
		}
		return failure("OilProduct", ValidationResult.ValidationType.ONLY_EXISTS, "OilProduct", path, "",
