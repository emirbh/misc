...
import fpml.consolidated.fx.accruals.meta.FxAccrualPayoffRegionMeta;
 ...
 *
 */
@RosettaDataType(value="FxAccrualPayoffRegion", builder=FxAccrualPayoffRegion.FxAccrualPayoffRegionBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxAccrualPayoffRegion", model="fpml", builder=FxAccrualPayoffRegion.FxAccrualPayoffRegionBuilderImpl.class, version="2.1.1")
public interface FxAccrualPayoffRegion extends RosettaModelObject {
	...
	class FxAccrualPayoffRegionBuilderImpl implements FxAccrualPayoffRegion.FxAccrualPayoffRegionBuilder {
		...
		@RuneAttribute("id")
		@Override
		public FxAccrualPayoffRegion.FxAccrualPayoffRegionBuilder setId(String _id) {
