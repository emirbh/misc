...
public class ClassifiablePaymentOnlyExistsValidator implements ValidatorWithArg<ClassifiablePayment, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ClassifiablePayment> ValidationResult<ClassifiablePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("paymentType", ExistenceChecker.isSet((List<? extends PaymentType>) o.getPaymentType()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ClassifiablePayment", ValidationResult.ValidationType.ONLY_EXISTS, "ClassifiablePayment", path, "");
		}
		return failure("ClassifiablePayment", ValidationResult.ValidationType.ONLY_EXISTS, "ClassifiablePayment", path, "",
