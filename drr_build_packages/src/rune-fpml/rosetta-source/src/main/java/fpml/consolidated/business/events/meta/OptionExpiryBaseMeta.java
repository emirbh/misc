...
import fpml.consolidated.business.events.validation.OptionExpiryBaseTypeFormatValidator;
import fpml.consolidated.business.events.validation.OptionExpiryBaseValidator;
import fpml.consolidated.business.events.validation.exists.OptionExpiryBaseOnlyExistsValidator;
...
public class OptionExpiryBaseMeta implements RosettaMetaData<OptionExpiryBase> {
	...
	@Override
	public Validator<? super OptionExpiryBase> validator(ValidatorFactory factory) {
		return factory.<OptionExpiryBase>create(OptionExpiryBaseValidator.class);
	}

	@Override
	public Validator<? super OptionExpiryBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<OptionExpiryBase>create(OptionExpiryBaseTypeFormatValidator.class);
	}
