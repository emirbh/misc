...
public class SimplePaymentOnlyExistsValidator implements ValidatorWithArg<SimplePayment, Set<String>> {
	...
	public <T2 extends SimplePayment> ValidationResult<SimplePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("SimplePayment", ValidationResult.ValidationType.ONLY_EXISTS, "SimplePayment", path, "");
		}
		return failure("SimplePayment", ValidationResult.ValidationType.ONLY_EXISTS, "SimplePayment", path, "",
