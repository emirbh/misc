...
public class QuotationOnlyExistsValidator implements ValidatorWithArg<Quotation, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends Quotation> ValidationResult<Quotation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("sensitivitySet", ExistenceChecker.isSet((List<? extends SensitivitySet>) o.getSensitivitySet()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Quotation", ValidationResult.ValidationType.ONLY_EXISTS, "Quotation", path, "");
		}
		return failure("Quotation", ValidationResult.ValidationType.ONLY_EXISTS, "Quotation", path, "",
