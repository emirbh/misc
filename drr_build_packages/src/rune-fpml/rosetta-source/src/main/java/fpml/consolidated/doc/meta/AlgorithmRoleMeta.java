...
import fpml.consolidated.doc.validation.AlgorithmRoleTypeFormatValidator;
import fpml.consolidated.doc.validation.AlgorithmRoleValidator;
import fpml.consolidated.doc.validation.exists.AlgorithmRoleOnlyExistsValidator;
...
public class AlgorithmRoleMeta implements RosettaMetaData<AlgorithmRole> {
	...
	@Override
	public Validator<? super AlgorithmRole> validator(ValidatorFactory factory) {
		return factory.<AlgorithmRole>create(AlgorithmRoleValidator.class);
	}

	@Override
	public Validator<? super AlgorithmRole> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AlgorithmRole>create(AlgorithmRoleTypeFormatValidator.class);
	}
