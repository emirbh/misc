...
import fpml.consolidated.shared.meta.MatrixTypeMeta;
 ...
 *
 */
@RosettaDataType(value="MatrixType", builder=MatrixType.MatrixTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="MatrixType", model="fpml", builder=MatrixType.MatrixTypeBuilderImpl.class, version="2.1.1")
public interface MatrixType extends RosettaModelObject {
	...
	class MatrixTypeImpl implements MatrixType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("matrixTypeScheme")
	...
	class MatrixTypeBuilderImpl implements MatrixType.MatrixTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public MatrixType.MatrixTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("matrixTypeScheme")
		@Override
		public MatrixType.MatrixTypeBuilder setMatrixTypeScheme(String _matrixTypeScheme) {
			this.matrixTypeScheme = _matrixTypeScheme == null ? null : _matrixTypeScheme;
			return this;
		}
