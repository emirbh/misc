		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MimeType", ValidationResult.ValidationType.CARDINALITY, "MimeType", path, "", res.getError());
				}
				return success("MimeType", ValidationResult.ValidationType.CARDINALITY, "MimeType", path, "");
			})
			.collect(toList());
	}
