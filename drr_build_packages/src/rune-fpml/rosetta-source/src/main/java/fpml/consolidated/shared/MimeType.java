...
import fpml.consolidated.shared.meta.MimeTypeMeta;
 ...
 *
 * Provision The type that indicates the type of media used to store the content. MimeType is used to determine the software product(s) that can read the content. MIME types are described in RFC 2046.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="MimeType", builder=MimeType.MimeTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="MimeType", model="fpml", builder=MimeType.MimeTypeBuilderImpl.class, version="2.1.1")
public interface MimeType extends RosettaModelObject {
	...
	class MimeTypeBuilderImpl implements MimeType.MimeTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public MimeType.MimeTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("mimeTypeScheme")
		@Override
		public MimeType.MimeTypeBuilder setMimeTypeScheme(String _mimeTypeScheme) {
			this.mimeTypeScheme = _mimeTypeScheme == null ? null : _mimeTypeScheme;
			return this;
		}
