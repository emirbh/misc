...
import fpml.consolidated.shared.meta.RoutingIdMeta;
 ...
 *
 */
@RosettaDataType(value="RoutingId", builder=RoutingId.RoutingIdBuilderImpl.class, version="2.1.1")
@RuneDataType(value="RoutingId", model="fpml", builder=RoutingId.RoutingIdBuilderImpl.class, version="2.1.1")
public interface RoutingId extends RosettaModelObject {
	...
	class RoutingIdImpl implements RoutingId {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("routingIdCodeScheme")
	...
	class RoutingIdBuilderImpl implements RoutingId.RoutingIdBuilder {
		...
		@RuneAttribute("value")
		@Override
		public RoutingId.RoutingIdBuilder setValue(String _value) {
		...
		@RuneAttribute("routingIdCodeScheme")
		@Override
		public RoutingId.RoutingIdBuilder setRoutingIdCodeScheme(String _routingIdCodeScheme) {
			this.routingIdCodeScheme = _routingIdCodeScheme == null ? null : _routingIdCodeScheme;
			return this;
		}
