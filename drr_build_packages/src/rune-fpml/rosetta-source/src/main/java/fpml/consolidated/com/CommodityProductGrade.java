...
import fpml.consolidated.com.meta.CommodityProductGradeMeta;
 ...
 *
 * Provision A scheme identifying the grade of physical commodity product to be delivered.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CommodityProductGrade", builder=CommodityProductGrade.CommodityProductGradeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityProductGrade", model="fpml", builder=CommodityProductGrade.CommodityProductGradeBuilderImpl.class, version="2.1.1")
public interface CommodityProductGrade extends RosettaModelObject {
	...
	class CommodityProductGradeImpl implements CommodityProductGrade {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("productGradeScheme")
	...
	class CommodityProductGradeBuilderImpl implements CommodityProductGrade.CommodityProductGradeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CommodityProductGrade.CommodityProductGradeBuilder setValue(String _value) {
		...
		@RuneAttribute("productGradeScheme")
		@Override
		public CommodityProductGrade.CommodityProductGradeBuilder setProductGradeScheme(String _productGradeScheme) {
			this.productGradeScheme = _productGradeScheme == null ? null : _productGradeScheme;
			return this;
		}
