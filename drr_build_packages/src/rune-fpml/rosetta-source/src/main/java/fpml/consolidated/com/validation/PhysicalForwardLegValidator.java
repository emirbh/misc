...
public class PhysicalForwardLegValidator implements Validator<PhysicalForwardLeg> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PhysicalForwardLeg", ValidationResult.ValidationType.CARDINALITY, "PhysicalForwardLeg", path, "", res.getError());
				}
				return success("PhysicalForwardLeg", ValidationResult.ValidationType.CARDINALITY, "PhysicalForwardLeg", path, "");
			})
			.collect(toList());
	}
