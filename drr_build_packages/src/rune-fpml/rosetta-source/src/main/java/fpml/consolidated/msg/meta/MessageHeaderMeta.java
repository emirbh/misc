...
import fpml.consolidated.msg.validation.MessageHeaderTypeFormatValidator;
import fpml.consolidated.msg.validation.MessageHeaderValidator;
import fpml.consolidated.msg.validation.exists.MessageHeaderOnlyExistsValidator;
...
public class MessageHeaderMeta implements RosettaMetaData<MessageHeader> {
	...
	@Override
	public Validator<? super MessageHeader> validator(ValidatorFactory factory) {
		return factory.<MessageHeader>create(MessageHeaderValidator.class);
	}

	@Override
	public Validator<? super MessageHeader> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MessageHeader>create(MessageHeaderTypeFormatValidator.class);
	}
