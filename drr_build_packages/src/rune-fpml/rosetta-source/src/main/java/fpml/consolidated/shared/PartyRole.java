...
import fpml.consolidated.shared.meta.PartyRoleMeta;
 ...
 *
 * Provision A type describing a role played by a party in one or more transactions. Examples include roles such as guarantor, custodian, confirmation service provider, etc. This can be extended to provide custom roles.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="PartyRole", builder=PartyRole.PartyRoleBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PartyRole", model="fpml", builder=PartyRole.PartyRoleBuilderImpl.class, version="2.1.1")
public interface PartyRole extends RosettaModelObject {
	...
	class PartyRoleBuilderImpl implements PartyRole.PartyRoleBuilder {
		...
		@RuneAttribute("value")
		@Override
		public PartyRole.PartyRoleBuilder setValue(String _value) {
		...
		@RuneAttribute("partyRoleScheme")
		@Override
		public PartyRole.PartyRoleBuilder setPartyRoleScheme(String _partyRoleScheme) {
			this.partyRoleScheme = _partyRoleScheme == null ? null : _partyRoleScheme;
			return this;
		}
