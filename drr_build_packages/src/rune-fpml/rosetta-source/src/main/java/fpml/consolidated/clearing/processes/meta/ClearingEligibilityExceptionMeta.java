...
import fpml.consolidated.clearing.processes.ClearingEligibilityException;
import fpml.consolidated.clearing.processes.validation.ClearingEligibilityExceptionTypeFormatValidator;
import fpml.consolidated.clearing.processes.validation.ClearingEligibilityExceptionValidator;
import fpml.consolidated.clearing.processes.validation.exists.ClearingEligibilityExceptionOnlyExistsValidator;
...
public class ClearingEligibilityExceptionMeta implements RosettaMetaData<ClearingEligibilityException> {
	...
	@Override
	public Validator<? super ClearingEligibilityException> validator(ValidatorFactory factory) {
		return factory.<ClearingEligibilityException>create(ClearingEligibilityExceptionValidator.class);
	}

	@Override
	public Validator<? super ClearingEligibilityException> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ClearingEligibilityException>create(ClearingEligibilityExceptionTypeFormatValidator.class);
	}
