...
public class LoanAllocationSettlementDateFinalizationValidator implements Validator<LoanAllocationSettlementDateFinalization> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanAllocationSettlementDateFinalization", ValidationResult.ValidationType.CARDINALITY, "LoanAllocationSettlementDateFinalization", path, "", res.getError());
				}
				return success("LoanAllocationSettlementDateFinalization", ValidationResult.ValidationType.CARDINALITY, "LoanAllocationSettlementDateFinalization", path, "");
			})
			.collect(toList());
	}
