		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MatchId", ValidationResult.ValidationType.CARDINALITY, "MatchId", path, "", res.getError());
				}
				return success("MatchId", ValidationResult.ValidationType.CARDINALITY, "MatchId", path, "");
			})
			.collect(toList());
	}
