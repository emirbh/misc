		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityPipeline", ValidationResult.ValidationType.CARDINALITY, "CommodityPipeline", path, "", res.getError());
				}
				return success("CommodityPipeline", ValidationResult.ValidationType.CARDINALITY, "CommodityPipeline", path, "");
			})
			.collect(toList());
	}
