		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilitySummary", ValidationResult.ValidationType.TYPE_FORMAT, "FacilitySummary", path, "", res.getError());
				}
				return success("FacilitySummary", ValidationResult.ValidationType.TYPE_FORMAT, "FacilitySummary", path, "");
			})
			.collect(toList());
	}
