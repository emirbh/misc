...
import fpml.consolidated.com.validation.CommodityExpireRelativeToEventTypeFormatValidator;
import fpml.consolidated.com.validation.CommodityExpireRelativeToEventValidator;
import fpml.consolidated.com.validation.exists.CommodityExpireRelativeToEventOnlyExistsValidator;
...
public class CommodityExpireRelativeToEventMeta implements RosettaMetaData<CommodityExpireRelativeToEvent> {
	...
	@Override
	public Validator<? super CommodityExpireRelativeToEvent> validator(ValidatorFactory factory) {
		return factory.<CommodityExpireRelativeToEvent>create(CommodityExpireRelativeToEventValidator.class);
	}

	@Override
	public Validator<? super CommodityExpireRelativeToEvent> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CommodityExpireRelativeToEvent>create(CommodityExpireRelativeToEventTypeFormatValidator.class);
	}
