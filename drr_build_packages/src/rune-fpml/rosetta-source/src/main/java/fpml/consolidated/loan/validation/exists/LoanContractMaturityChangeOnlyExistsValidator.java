...
public class LoanContractMaturityChangeOnlyExistsValidator implements ValidatorWithArg<LoanContractMaturityChange, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanContractMaturityChange> ValidationResult<LoanContractMaturityChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("currentMaturityDate", ExistenceChecker.isSet((ZonedDateTime) o.getCurrentMaturityDate()))
				.put("priorMaturityDate", ExistenceChecker.isSet((ZonedDateTime) o.getPriorMaturityDate()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("LoanContractMaturityChange", ValidationResult.ValidationType.ONLY_EXISTS, "LoanContractMaturityChange", path, "");
		}
		return failure("LoanContractMaturityChange", ValidationResult.ValidationType.ONLY_EXISTS, "LoanContractMaturityChange", path, "",
