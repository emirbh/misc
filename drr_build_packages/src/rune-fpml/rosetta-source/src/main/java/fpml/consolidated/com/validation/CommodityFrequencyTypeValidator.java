		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityFrequencyType", ValidationResult.ValidationType.CARDINALITY, "CommodityFrequencyType", path, "", res.getError());
				}
				return success("CommodityFrequencyType", ValidationResult.ValidationType.CARDINALITY, "CommodityFrequencyType", path, "");
			})
			.collect(toList());
	}
