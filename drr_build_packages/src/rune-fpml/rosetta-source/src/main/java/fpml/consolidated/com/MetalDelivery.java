 ...
 *
 */
@RosettaDataType(value="MetalDelivery", builder=MetalDelivery.MetalDeliveryBuilderImpl.class, version="2.1.1")
@RuneDataType(value="MetalDelivery", model="fpml", builder=MetalDelivery.MetalDeliveryBuilderImpl.class, version="2.1.1")
public interface MetalDelivery extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The Delivery Point for a physically settled non-precious metal transaction.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision "Risk of loss" may also be used, equivalently, on confirmation documents.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The +/- percent tolerance in seller's option which applies to the total quantity delivered over all shipment periods.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The +/- percentage quantity tolerance in seller's option which applied to each shipment period.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class MetalDeliveryImpl implements MetalDelivery {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("totalQuantityTolerance")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("periodQuantityTolerance")
	...
	class MetalDeliveryBuilderImpl implements MetalDelivery.MetalDeliveryBuilder {
		...
		@RuneAttribute("deliveryLocation")
		@Override
		public MetalDelivery.MetalDeliveryBuilder setDeliveryLocation(CommodityDeliveryPoint _deliveryLocation) {
		...
		@RuneAttribute("risk")
		@Override
		public MetalDelivery.MetalDeliveryBuilder setRisk(CommodityDeliveryRisk _risk) {
		...
		@RuneAttribute("totalQuantityTolerance")
		@Override
		public MetalDelivery.MetalDeliveryBuilder setTotalQuantityTolerance(BigDecimal _totalQuantityTolerance) {
		...
		@RuneAttribute("periodQuantityTolerance")
		@Override
		public MetalDelivery.MetalDeliveryBuilder setPeriodQuantityTolerance(BigDecimal _periodQuantityTolerance) {
		...
		@RuneAttribute("title")
		@Override
		public MetalDelivery.MetalDeliveryBuilder setTitle(MetalTitleEnum _title) {
