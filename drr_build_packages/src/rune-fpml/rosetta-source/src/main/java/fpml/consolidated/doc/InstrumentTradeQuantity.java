 ...
 *
 * Provision A structure describing the amount of an instrument that was traded.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="InstrumentTradeQuantity", builder=InstrumentTradeQuantity.InstrumentTradeQuantityBuilderImpl.class, version="2.1.1")
@RuneDataType(value="InstrumentTradeQuantity", model="fpml", builder=InstrumentTradeQuantity.InstrumentTradeQuantityBuilderImpl.class, version="2.1.1")
public interface InstrumentTradeQuantity extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The (absolute) number of units of the underlying instrument that were traded.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The monetary value of the security (eg. fixed income security) that was traded).
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class InstrumentTradeQuantityBuilderImpl implements InstrumentTradeQuantity.InstrumentTradeQuantityBuilder {
		...
		@RuneAttribute("number")
		@Override
		public InstrumentTradeQuantity.InstrumentTradeQuantityBuilder setNumber(BigDecimal _number) {
		...
		@RuneAttribute("nominal")
		@Override
		public InstrumentTradeQuantity.InstrumentTradeQuantityBuilder setNominal(Money _nominal) {
