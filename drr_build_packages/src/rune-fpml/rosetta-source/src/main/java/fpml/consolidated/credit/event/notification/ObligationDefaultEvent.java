...
import fpml.consolidated.credit.event.notification.meta.ObligationDefaultEventMeta;
 ...
 *
 */
@RosettaDataType(value="ObligationDefaultEvent", builder=ObligationDefaultEvent.ObligationDefaultEventBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ObligationDefaultEvent", model="fpml", builder=ObligationDefaultEvent.ObligationDefaultEventBuilderImpl.class, version="2.1.1")
