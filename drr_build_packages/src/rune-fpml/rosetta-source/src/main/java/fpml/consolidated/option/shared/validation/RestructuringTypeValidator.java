		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RestructuringType", ValidationResult.ValidationType.CARDINALITY, "RestructuringType", path, "", res.getError());
				}
				return success("RestructuringType", ValidationResult.ValidationType.CARDINALITY, "RestructuringType", path, "");
			})
			.collect(toList());
	}
