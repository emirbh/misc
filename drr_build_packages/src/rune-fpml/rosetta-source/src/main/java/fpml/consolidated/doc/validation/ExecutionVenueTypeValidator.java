		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ExecutionVenueType", ValidationResult.ValidationType.CARDINALITY, "ExecutionVenueType", path, "", res.getError());
				}
				return success("ExecutionVenueType", ValidationResult.ValidationType.CARDINALITY, "ExecutionVenueType", path, "");
			})
			.collect(toList());
	}
