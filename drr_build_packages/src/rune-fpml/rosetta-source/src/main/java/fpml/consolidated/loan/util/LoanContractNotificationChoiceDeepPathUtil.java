...
public class LoanContractNotificationChoiceDeepPathUtil {
	public FacilityReference chooseFacilityReference(LoanContractNotificationChoice loanContractNotificationChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(loanContractNotificationChoice).<LoanContractIdentifier>map("getContractIdentifier", _loanContractNotificationChoice -> _loanContractNotificationChoice.getContractIdentifier());
		...
		final MapperS<LoanContractSummary> contractSummary = MapperS.of(loanContractNotificationChoice).<LoanContractSummary>map("getContractSummary", _loanContractNotificationChoice -> _loanContractNotificationChoice.getContractSummary());
		...
		final MapperS<LoanContract> contract = MapperS.of(loanContractNotificationChoice).<LoanContract>map("getContract", _loanContractNotificationChoice -> _loanContractNotificationChoice.getContract());
	...
	public List<ContractId> chooseContractId(LoanContractNotificationChoice loanContractNotificationChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(loanContractNotificationChoice).<LoanContractIdentifier>map("getContractIdentifier", _loanContractNotificationChoice -> _loanContractNotificationChoice.getContractIdentifier());
		if (exists(contractIdentifier).getOrDefault(false)) {
	...
	public String chooseId(LoanContractNotificationChoice loanContractNotificationChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(loanContractNotificationChoice).<LoanContractIdentifier>map("getContractIdentifier", _loanContractNotificationChoice -> _loanContractNotificationChoice.getContractIdentifier());
		if (exists(contractIdentifier).getOrDefault(false)) {
	...
	public PartyReference choosePartyReference(LoanContractNotificationChoice loanContractNotificationChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(loanContractNotificationChoice).<LoanContractIdentifier>map("getContractIdentifier", _loanContractNotificationChoice -> _loanContractNotificationChoice.getContractIdentifier());
		if (exists(contractIdentifier).getOrDefault(false)) {
	...
	public List<VersionedContractId> chooseVersionedContractId(LoanContractNotificationChoice loanContractNotificationChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(loanContractNotificationChoice).<LoanContractIdentifier>map("getContractIdentifier", _loanContractNotificationChoice -> _loanContractNotificationChoice.getContractIdentifier());
		if (exists(contractIdentifier).getOrDefault(false)) {
