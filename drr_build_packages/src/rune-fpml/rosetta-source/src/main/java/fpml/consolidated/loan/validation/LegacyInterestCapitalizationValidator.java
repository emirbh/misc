...
public class LegacyInterestCapitalizationValidator implements Validator<LegacyInterestCapitalization> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LegacyInterestCapitalization", ValidationResult.ValidationType.CARDINALITY, "LegacyInterestCapitalization", path, "", res.getError());
				}
				return success("LegacyInterestCapitalization", ValidationResult.ValidationType.CARDINALITY, "LegacyInterestCapitalization", path, "");
			})
			.collect(toList());
	}
