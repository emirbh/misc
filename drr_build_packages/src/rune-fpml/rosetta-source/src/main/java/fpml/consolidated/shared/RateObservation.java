...
import fpml.consolidated.shared.meta.RateObservationMeta;
 ...
 *
 * Provision A type defining parameters associated with an individual observation or fixing. This type forms part of the cashflow representation of a stream.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="RateObservation", builder=RateObservation.RateObservationBuilderImpl.class, version="2.1.1")
@RuneDataType(value="RateObservation", model="fpml", builder=RateObservation.RateObservationBuilderImpl.class, version="2.1.1")
public interface RateObservation extends RosettaModelObject {
	 ...
	 *
	 */
	ZonedDateTime getAdjustedFixingDate();
	/**
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 *
	 */
	FallbackRateObservation getFallback();
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processor.processBasic(path.newSubPath("resetDate"), ZonedDateTime.class, getResetDate(), this);
		processor.processBasic(path.newSubPath("adjustedFixingDate"), ZonedDateTime.class, getAdjustedFixingDate(), this);
		...
		processRosetta(path.newSubPath("fallback"), processor, FallbackRateObservation.class, getFallback());
	}
	...
	interface RateObservationBuilder extends RateObservation, RosettaModelObjectBuilder {
		...
		FallbackRateObservation.FallbackRateObservationBuilder getOrCreateFallback();
		@Override
		FallbackRateObservation.FallbackRateObservationBuilder getFallback();
		RateObservation.RateObservationBuilder setId(String id);
		RateObservation.RateObservationBuilder setResetDate(ZonedDateTime resetDate);
		RateObservation.RateObservationBuilder setAdjustedFixingDate(ZonedDateTime adjustedFixingDate);
		...
		RateObservation.RateObservationBuilder setFallback(FallbackRateObservation fallback);
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			...
			processor.processBasic(path.newSubPath("forecastRate"), BigDecimal.class, getForecastRate(), this);
			processor.processBasic(path.newSubPath("treatedForecastRate"), BigDecimal.class, getTreatedForecastRate(), this);
			processRosetta(path.newSubPath("fallback"), processor, FallbackRateObservation.FallbackRateObservationBuilder.class, getFallback());
		}
	...
	class RateObservationImpl implements RateObservation {
		...
		private final ZonedDateTime adjustedFixingDate;
		...
		private final FallbackRateObservation fallback;
		...
		public ZonedDateTime getAdjustedFixingDate() {
		...
		public FallbackRateObservation getFallback() {
			return fallback;
		}
	...
	class RateObservationBuilderImpl implements RateObservation.RateObservationBuilder {
		...
		protected String id;
		protected ZonedDateTime resetDate;
		protected ZonedDateTime adjustedFixingDate;
		...
		protected FallbackRateObservation.FallbackRateObservationBuilder fallback;
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("fallback")
		public FallbackRateObservation.FallbackRateObservationBuilder getFallback() {
			return fallback;
		}
		
		@Override
		public FallbackRateObservation.FallbackRateObservationBuilder getOrCreateFallback() {
			FallbackRateObservation.FallbackRateObservationBuilder result;
			if (fallback!=null) {
				result = fallback;
			}
			else {
				result = fallback = FallbackRateObservation.builder();
			}
		...
		@RuneAttribute("id")
		@Override
		public RateObservation.RateObservationBuilder setId(String _id) {
		...
		@RuneAttribute("resetDate")
		@Override
		public RateObservation.RateObservationBuilder setResetDate(ZonedDateTime _resetDate) {
		...
		@RuneAttribute("adjustedFixingDate")
		@Override
		public RateObservation.RateObservationBuilder setAdjustedFixingDate(ZonedDateTime _adjustedFixingDate) {
		...
		@RuneAttribute("rateReference")
		@Override
		public RateObservation.RateObservationBuilder setRateReference(RateReference _rateReference) {
		...
		@RuneAttribute("fallback")
		@Override
		public RateObservation.RateObservationBuilder setFallback(FallbackRateObservation _fallback) {
			this.fallback = _fallback == null ? null : _fallback.toBuilder();
			return this;
		}
