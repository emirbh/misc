 ...
 * @version 2.1.1
 */
@RosettaDataRule("GeneralTermsChoice")
@ImplementedBy(GeneralTermsChoice.Default.class)
public interface GeneralTermsChoice extends Validator<GeneralTerms> {
	
	String NAME = "GeneralTermsChoice";
	String DEFINITION = "required choice referenceInformation, indexReferenceInformation, basketReferenceInformation";
	
	class Default implements GeneralTermsChoice {
	...
	class NoOp implements GeneralTermsChoice {
