...
public class RegulatoryWithdrawalOnlyExistsValidator implements ValidatorWithArg<RegulatoryWithdrawal, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RegulatoryWithdrawal> ValidationResult<RegulatoryWithdrawal> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("inapplicableRegulation", ExistenceChecker.isSet((List<? extends InapplicableRegulation>) o.getInapplicableRegulation()))
				.put("withdrawalReason", ExistenceChecker.isSet((String) o.getWithdrawalReason()))
				.put("fullyWithdrawn", ExistenceChecker.isSet((Boolean) o.getFullyWithdrawn()))
		...
		if (setFields.equals(fields)) {
			return success("RegulatoryWithdrawal", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryWithdrawal", path, "");
		}
		return failure("RegulatoryWithdrawal", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryWithdrawal", path, "",
