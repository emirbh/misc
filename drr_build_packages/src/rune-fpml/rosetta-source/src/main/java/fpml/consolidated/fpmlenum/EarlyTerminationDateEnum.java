 ...
 *
 * Provision Symbolic specification of early termination date.
 *
 */
...
public enum EarlyTerminationDateEnum {
	 ...
	 *
	 */
	@RosettaEnumValue(value = "AfterFirstResetDate") 
	AFTER_FIRST_RESET_DATE("AfterFirstResetDate", null),
	 ...
	 *
	 */
	@RosettaEnumValue(value = "AsSpecifiedInMCA") 
	AS_SPECIFIED_IN_MCA("AsSpecifiedInMCA", null)
;
