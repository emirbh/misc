...
public class LcRenewalOnlyExistsValidator implements ValidatorWithArg<LcRenewal, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LcRenewal> ValidationResult<LcRenewal> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LcRenewal", ValidationResult.ValidationType.ONLY_EXISTS, "LcRenewal", path, "");
		}
		return failure("LcRenewal", ValidationResult.ValidationType.ONLY_EXISTS, "LcRenewal", path, "",
