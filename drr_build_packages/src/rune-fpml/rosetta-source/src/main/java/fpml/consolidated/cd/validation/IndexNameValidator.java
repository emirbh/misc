		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("IndexName", ValidationResult.ValidationType.CARDINALITY, "IndexName", path, "", res.getError());
				}
				return success("IndexName", ValidationResult.ValidationType.CARDINALITY, "IndexName", path, "");
			})
			.collect(toList());
	}
