...
public class CommodityTriggerOnlyExistsValidator implements ValidatorWithArg<CommodityTrigger, Set<String>> {
	...
	public <T2 extends CommodityTrigger> ValidationResult<CommodityTrigger> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("levelPrice", ExistenceChecker.isSet((CommodityFixedPrice) o.getLevelPrice()))
		...
		if (setFields.equals(fields)) {
			return success("CommodityTrigger", ValidationResult.ValidationType.ONLY_EXISTS, "CommodityTrigger", path, "");
		}
		return failure("CommodityTrigger", ValidationResult.ValidationType.ONLY_EXISTS, "CommodityTrigger", path, "",
