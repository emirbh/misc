...
import fpml.consolidated.shared.validation.IdentifiedPayerReceiverTypeFormatValidator;
import fpml.consolidated.shared.validation.IdentifiedPayerReceiverValidator;
import fpml.consolidated.shared.validation.exists.IdentifiedPayerReceiverOnlyExistsValidator;
...
public class IdentifiedPayerReceiverMeta implements RosettaMetaData<IdentifiedPayerReceiver> {
	...
	@Override
	public Validator<? super IdentifiedPayerReceiver> validator(ValidatorFactory factory) {
		return factory.<IdentifiedPayerReceiver>create(IdentifiedPayerReceiverValidator.class);
	}

	@Override
	public Validator<? super IdentifiedPayerReceiver> typeFormatValidator(ValidatorFactory factory) {
		return factory.<IdentifiedPayerReceiver>create(IdentifiedPayerReceiverTypeFormatValidator.class);
	}
