		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("OrderIdentifier", ValidationResult.ValidationType.TYPE_FORMAT, "OrderIdentifier", path, "", res.getError());
				}
				return success("OrderIdentifier", ValidationResult.ValidationType.TYPE_FORMAT, "OrderIdentifier", path, "");
			})
			.collect(toList());
	}
