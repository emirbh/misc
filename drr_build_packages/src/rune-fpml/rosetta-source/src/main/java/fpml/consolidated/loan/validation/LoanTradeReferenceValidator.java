		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanTradeReference", ValidationResult.ValidationType.CARDINALITY, "LoanTradeReference", path, "", res.getError());
				}
				return success("LoanTradeReference", ValidationResult.ValidationType.CARDINALITY, "LoanTradeReference", path, "");
			})
			.collect(toList());
	}
