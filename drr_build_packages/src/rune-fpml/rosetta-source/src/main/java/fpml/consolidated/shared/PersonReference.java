...
import fpml.consolidated.shared.meta.PersonReferenceMeta;
 ...
 *
 * Provision Reference to an individual.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="PersonReference", builder=PersonReference.PersonReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PersonReference", model="fpml", builder=PersonReference.PersonReferenceBuilderImpl.class, version="2.1.1")
public interface PersonReference extends Reference {
	...
	class PersonReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements PersonReference.PersonReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public PersonReference.PersonReferenceBuilder setHref(String _href) {
