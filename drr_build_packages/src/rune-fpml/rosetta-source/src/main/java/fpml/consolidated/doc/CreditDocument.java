...
import fpml.consolidated.doc.meta.CreditDocumentMeta;
 ...
 *
 * Provision A credit arrangement used in support of swaps trading.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CreditDocument", builder=CreditDocument.CreditDocumentBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CreditDocument", model="fpml", builder=CreditDocument.CreditDocumentBuilderImpl.class, version="2.1.1")
public interface CreditDocument extends RosettaModelObject {
	...
	class CreditDocumentImpl implements CreditDocument {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("creditDocumentScheme")
	...
	class CreditDocumentBuilderImpl implements CreditDocument.CreditDocumentBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CreditDocument.CreditDocumentBuilder setValue(String _value) {
		...
		@RuneAttribute("creditDocumentScheme")
		@Override
		public CreditDocument.CreditDocumentBuilder setCreditDocumentScheme(String _creditDocumentScheme) {
			this.creditDocumentScheme = _creditDocumentScheme == null ? null : _creditDocumentScheme;
			return this;
		}
