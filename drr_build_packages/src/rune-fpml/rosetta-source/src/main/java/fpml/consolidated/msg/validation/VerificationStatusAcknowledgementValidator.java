...
public class VerificationStatusAcknowledgementValidator implements Validator<VerificationStatusAcknowledgement> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("VerificationStatusAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "VerificationStatusAcknowledgement", path, "", res.getError());
				}
				return success("VerificationStatusAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "VerificationStatusAcknowledgement", path, "");
			})
			.collect(toList());
	}
