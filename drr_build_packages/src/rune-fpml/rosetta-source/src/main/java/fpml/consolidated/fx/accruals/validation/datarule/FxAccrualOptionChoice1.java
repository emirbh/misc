 ...
 * @version 2.1.1
 */
@RosettaDataRule("FxAccrualOptionChoice1")
@ImplementedBy(FxAccrualOptionChoice1.Default.class)
public interface FxAccrualOptionChoice1 extends Validator<FxAccrualOption> {
	
	String NAME = "FxAccrualOptionChoice1";
	String DEFINITION = "required choice settlementDate, settlementSchedule";
	
	class Default implements FxAccrualOptionChoice1 {
		...
		private ComparisonResult executeDataRule(FxAccrualOption fxAccrualOption) {
			try {
				return choice(MapperS.of(fxAccrualOption), Arrays.asList("settlementDate", "settlementSchedule"), ChoiceRuleValidationMethod.REQUIRED);
			}
			catch (Exception ex) {
	...
	class NoOp implements FxAccrualOptionChoice1 {
