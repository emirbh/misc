...
import fpml.consolidated.loan.meta.TaxFormTypeMeta;
 ...
 *
 * Provision A scheme that describes tax form types.
 *
 */
@RosettaDataType(value="TaxFormType", builder=TaxFormType.TaxFormTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="TaxFormType", model="fpml", builder=TaxFormType.TaxFormTypeBuilderImpl.class, version="2.1.1")
public interface TaxFormType extends RosettaModelObject {
	...
	class TaxFormTypeImpl implements TaxFormType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("taxFormTypeScheme")
	...
	class TaxFormTypeBuilderImpl implements TaxFormType.TaxFormTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public TaxFormType.TaxFormTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("taxFormTypeScheme")
		@Override
		public TaxFormType.TaxFormTypeBuilder setTaxFormTypeScheme(String _taxFormTypeScheme) {
			this.taxFormTypeScheme = _taxFormTypeScheme == null ? null : _taxFormTypeScheme;
			return this;
		}
