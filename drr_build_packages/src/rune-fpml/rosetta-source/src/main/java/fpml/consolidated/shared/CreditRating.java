...
import fpml.consolidated.shared.meta.CreditRatingMeta;
 ...
 *
 * Provision A party's credit rating.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CreditRating", builder=CreditRating.CreditRatingBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CreditRating", model="fpml", builder=CreditRating.CreditRatingBuilderImpl.class, version="2.1.1")
public interface CreditRating extends RosettaModelObject {
	...
	class CreditRatingImpl implements CreditRating {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("creditRatingScheme")
	...
	class CreditRatingBuilderImpl implements CreditRating.CreditRatingBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CreditRating.CreditRatingBuilder setValue(String _value) {
		...
		@RuneAttribute("creditRatingScheme")
		@Override
		public CreditRating.CreditRatingBuilder setCreditRatingScheme(String _creditRatingScheme) {
			this.creditRatingScheme = _creditRatingScheme == null ? null : _creditRatingScheme;
			return this;
		}
