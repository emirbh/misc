 ...
 * @version 2.1.1
 */
@RosettaDataRule("MortgageChoice0")
@ImplementedBy(MortgageChoice0.Default.class)
public interface MortgageChoice0 extends Validator<Mortgage> {
	
	String NAME = "MortgageChoice0";
	String DEFINITION = "optional choice insurer, insurerReference";
	
	class Default implements MortgageChoice0 {
	...
	class NoOp implements MortgageChoice0 {
