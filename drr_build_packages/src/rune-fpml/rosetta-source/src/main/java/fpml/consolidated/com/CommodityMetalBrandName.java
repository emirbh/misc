...
import fpml.consolidated.com.meta.CommodityMetalBrandNameMeta;
 ...
 *
 * Provision The name of the entity that issues the brand
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CommodityMetalBrandName", builder=CommodityMetalBrandName.CommodityMetalBrandNameBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityMetalBrandName", model="fpml", builder=CommodityMetalBrandName.CommodityMetalBrandNameBuilderImpl.class, version="2.1.1")
public interface CommodityMetalBrandName extends RosettaModelObject {
	...
	class CommodityMetalBrandNameImpl implements CommodityMetalBrandName {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("commodityMetalBrandNameScheme")
	...
	class CommodityMetalBrandNameBuilderImpl implements CommodityMetalBrandName.CommodityMetalBrandNameBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CommodityMetalBrandName.CommodityMetalBrandNameBuilder setValue(String _value) {
		...
		@RuneAttribute("commodityMetalBrandNameScheme")
		@Override
		public CommodityMetalBrandName.CommodityMetalBrandNameBuilder setCommodityMetalBrandNameScheme(String _commodityMetalBrandNameScheme) {
			this.commodityMetalBrandNameScheme = _commodityMetalBrandNameScheme == null ? null : _commodityMetalBrandNameScheme;
			return this;
		}
