...
import fpml.consolidated.loan.meta.LoanAllocationNotificationChoice2Meta;
 ...
 *
 */
@RosettaDataType(value="LoanAllocationNotificationChoice2", builder=LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2BuilderImpl.class, version="2.1.1")
@RuneDataType(value="LoanAllocationNotificationChoice2", model="fpml", builder=LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2BuilderImpl.class, version="2.1.1")
public interface LoanAllocationNotificationChoice2 extends RosettaModelObject {

	LoanAllocationNotificationChoice2Meta metaData = new LoanAllocationNotificationChoice2Meta();
	...
	/*********************** Build Methods  ***********************/
	LoanAllocationNotificationChoice2 build();
	
	LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder toBuilder();
	
	static LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder builder() {
		return new LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2BuilderImpl();
	}

	/*********************** Utility Methods  ***********************/
	@Override
	default RosettaMetaData<? extends LoanAllocationNotificationChoice2> metaData() {
		return metaData;
	}
	
	@Override
	@RuneAttribute("@type")
	default Class<? extends LoanAllocationNotificationChoice2> getType() {
		return LoanAllocationNotificationChoice2.class;
	}
	...
	/*********************** Builder Interface  ***********************/
	interface LoanAllocationNotificationChoice2Builder extends LoanAllocationNotificationChoice2, RosettaModelObjectBuilder {
		...
		LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setLetterOfCreditIdentifier(LoanContractIdentifier letterOfCreditIdentifier);
		LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setLetterOfCreditSummary(LetterOfCreditSummary letterOfCreditSummary);
		LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setLetterOfCredit(LetterOfCredit letterOfCredit);
		LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setContractIdentifier(LoanContractIdentifier contractIdentifier);
		LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setContractSummary(LoanContractSummary contractSummary);
		LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setContract(LoanContract contract);
		...
		LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder prune();
	}

	/*********************** Immutable Implementation of LoanAllocationNotificationChoice2  ***********************/
	class LoanAllocationNotificationChoice2Impl implements LoanAllocationNotificationChoice2 {
		...
		protected LoanAllocationNotificationChoice2Impl(LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder builder) {
		...
		@Override
		public LoanAllocationNotificationChoice2 build() {
			return this;
		}
		
		@Override
		public LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder toBuilder() {
			LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder builder = builder();
			setBuilderFields(builder);
			return builder;
		}
		
		protected void setBuilderFields(LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder builder) {
		...
		public boolean equals(Object o) {
			...
			LoanAllocationNotificationChoice2 _that = getType().cast(o);
	...
	/*********************** Builder Implementation of LoanAllocationNotificationChoice2  ***********************/
	class LoanAllocationNotificationChoice2BuilderImpl implements LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder {
		...
		@RuneAttribute("letterOfCreditIdentifier")
		@Override
		public LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setLetterOfCreditIdentifier(LoanContractIdentifier _letterOfCreditIdentifier) {
		...
		@RuneAttribute("letterOfCreditSummary")
		@Override
		public LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setLetterOfCreditSummary(LetterOfCreditSummary _letterOfCreditSummary) {
		...
		@RuneAttribute("letterOfCredit")
		@Override
		public LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setLetterOfCredit(LetterOfCredit _letterOfCredit) {
		...
		@RuneAttribute("contractIdentifier")
		@Override
		public LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setContractIdentifier(LoanContractIdentifier _contractIdentifier) {
		...
		@RuneAttribute("contractSummary")
		@Override
		public LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setContractSummary(LoanContractSummary _contractSummary) {
		...
		@RuneAttribute("contract")
		@Override
		public LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder setContract(LoanContract _contract) {
		...
		@Override
		public LoanAllocationNotificationChoice2 build() {
			return new LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Impl(this);
		}
		...
		@Override
		public LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder prune() {
		...
		@SuppressWarnings("unchecked")
		@Override
		public LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder merge(RosettaModelObjectBuilder other, BuilderMerger merger) {
			LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder o = (LoanAllocationNotificationChoice2.LoanAllocationNotificationChoice2Builder) other;
		...
		@Override
		public String toString() {
			return "LoanAllocationNotificationChoice2Builder {" +
				"letterOfCreditIdentifier=" + this.letterOfCreditIdentifier + ", " +
				"letterOfCreditSummary=" + this.letterOfCreditSummary + ", " +
				"letterOfCredit=" + this.letterOfCredit + ", " +
				"contractIdentifier=" + this.contractIdentifier + ", " +
