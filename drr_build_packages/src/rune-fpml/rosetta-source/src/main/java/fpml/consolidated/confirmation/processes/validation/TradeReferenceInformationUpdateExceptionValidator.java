...
public class TradeReferenceInformationUpdateExceptionValidator implements Validator<TradeReferenceInformationUpdateException> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeReferenceInformationUpdateException", ValidationResult.ValidationType.CARDINALITY, "TradeReferenceInformationUpdateException", path, "", res.getError());
				}
				return success("TradeReferenceInformationUpdateException", ValidationResult.ValidationType.CARDINALITY, "TradeReferenceInformationUpdateException", path, "");
			})
			.collect(toList());
	}
