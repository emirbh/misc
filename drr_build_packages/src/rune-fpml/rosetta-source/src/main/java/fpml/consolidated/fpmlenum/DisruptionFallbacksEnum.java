 ...
 *
 * Provision The specification of how disruption fallbacks will be represented.
 *
 */
...
public enum DisruptionFallbacksEnum {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The Disruption Fallback(s) are determined by reference to the relevant Master Agreement.
	 *
	 */
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The Disruption Fallback(s) are determined by reference to the relevant Confirmation.
	 *
	 */
