...
public class LoanTradeFeeDueOnlyExistsValidator implements ValidatorWithArg<LoanTradeFeeDue, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTradeFeeDue> ValidationResult<LoanTradeFeeDue> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeFeeDue", ValidationResult.ValidationType.ONLY_EXISTS, "LoanTradeFeeDue", path, "");
		}
		return failure("LoanTradeFeeDue", ValidationResult.ValidationType.ONLY_EXISTS, "LoanTradeFeeDue", path, "",
