...
public class LoanAllocationSettlementDateFinalizationOnlyExistsValidator implements ValidatorWithArg<LoanAllocationSettlementDateFinalization, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationSettlementDateFinalization> ValidationResult<LoanAllocationSettlementDateFinalization> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationSettlementDateFinalization", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationSettlementDateFinalization", path, "");
		}
		return failure("LoanAllocationSettlementDateFinalization", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationSettlementDateFinalization", path, "",
