...
import fpml.consolidated.cd.meta.ProtectionTermsReferenceMeta;
 ...
 *
 * Provision Reference to protectionTerms component.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ProtectionTermsReference", builder=ProtectionTermsReference.ProtectionTermsReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ProtectionTermsReference", model="fpml", builder=ProtectionTermsReference.ProtectionTermsReferenceBuilderImpl.class, version="2.1.1")
public interface ProtectionTermsReference extends Reference {
	...
	class ProtectionTermsReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements ProtectionTermsReference.ProtectionTermsReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public ProtectionTermsReference.ProtectionTermsReferenceBuilder setHref(String _href) {
