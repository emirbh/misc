...
import fpml.consolidated.loan.validation.LoanContractReferenceTypeFormatValidator;
import fpml.consolidated.loan.validation.LoanContractReferenceValidator;
import fpml.consolidated.loan.validation.exists.LoanContractReferenceOnlyExistsValidator;
...
public class LoanContractReferenceMeta implements RosettaMetaData<LoanContractReference> {
	...
	@Override
	public Validator<? super LoanContractReference> validator(ValidatorFactory factory) {
		return factory.<LoanContractReference>create(LoanContractReferenceValidator.class);
	}

	@Override
	public Validator<? super LoanContractReference> typeFormatValidator(ValidatorFactory factory) {
		return factory.<LoanContractReference>create(LoanContractReferenceTypeFormatValidator.class);
	}
