		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AmountRef", ValidationResult.ValidationType.TYPE_FORMAT, "AmountRef", path, "", res.getError());
				}
				return success("AmountRef", ValidationResult.ValidationType.TYPE_FORMAT, "AmountRef", path, "");
			})
			.collect(toList());
	}
