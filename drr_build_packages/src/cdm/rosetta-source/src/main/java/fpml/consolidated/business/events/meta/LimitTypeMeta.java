...
import fpml.consolidated.business.events.validation.LimitTypeTypeFormatValidator;
import fpml.consolidated.business.events.validation.LimitTypeValidator;
import fpml.consolidated.business.events.validation.exists.LimitTypeOnlyExistsValidator;
...
public class LimitTypeMeta implements RosettaMetaData<LimitType> {
	...
	@Override
	public Validator<? super LimitType> validator(ValidatorFactory factory) {
		return factory.<LimitType>create(LimitTypeValidator.class);
	}

	@Override
	public Validator<? super LimitType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<LimitType>create(LimitTypeTypeFormatValidator.class);
	}
