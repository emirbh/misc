...
import fpml.consolidated.eq.shared.validation.PrincipalExchangeDescriptionsTypeFormatValidator;
import fpml.consolidated.eq.shared.validation.PrincipalExchangeDescriptionsValidator;
import fpml.consolidated.eq.shared.validation.exists.PrincipalExchangeDescriptionsOnlyExistsValidator;
...
public class PrincipalExchangeDescriptionsMeta implements RosettaMetaData<PrincipalExchangeDescriptions> {
	...
	@Override
	public Validator<? super PrincipalExchangeDescriptions> validator(ValidatorFactory factory) {
		return factory.<PrincipalExchangeDescriptions>create(PrincipalExchangeDescriptionsValidator.class);
	}

	@Override
	public Validator<? super PrincipalExchangeDescriptions> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PrincipalExchangeDescriptions>create(PrincipalExchangeDescriptionsTypeFormatValidator.class);
	}
