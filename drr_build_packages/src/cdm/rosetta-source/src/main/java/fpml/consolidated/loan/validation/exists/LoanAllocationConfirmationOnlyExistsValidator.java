...
public class LoanAllocationConfirmationOnlyExistsValidator implements ValidatorWithArg<LoanAllocationConfirmation, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationConfirmation> ValidationResult<LoanAllocationConfirmation> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationConfirmation", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationConfirmation", path, "");
		}
		return failure("LoanAllocationConfirmation", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationConfirmation", path, "",
