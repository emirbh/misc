...
public class ReportContentsOnlyExistsValidator implements ValidatorWithArg<ReportContents, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ReportContents> ValidationResult<ReportContents> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("queryPortfolio", ExistenceChecker.isSet((QueryPortfolio) o.getQueryPortfolio()))
		...
		if (setFields.equals(fields)) {
			return success("ReportContents", ValidationResult.ValidationType.ONLY_EXISTS, "ReportContents", path, "");
		}
		return failure("ReportContents", ValidationResult.ValidationType.ONLY_EXISTS, "ReportContents", path, "",
