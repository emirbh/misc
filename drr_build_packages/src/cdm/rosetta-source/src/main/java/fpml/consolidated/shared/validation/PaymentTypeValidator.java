		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PaymentType", ValidationResult.ValidationType.CARDINALITY, "PaymentType", path, "", res.getError());
				}
				return success("PaymentType", ValidationResult.ValidationType.CARDINALITY, "PaymentType", path, "");
			})
			.collect(toList());
	}
