...
public class FxTypeFormatValidator implements Validator<Fx> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("Fx", ValidationResult.ValidationType.TYPE_FORMAT, "Fx", path, "", res.getError());
				}
				return success("Fx", ValidationResult.ValidationType.TYPE_FORMAT, "Fx", path, "");
			})
			.collect(toList());
	}
