		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityReference", ValidationResult.ValidationType.CARDINALITY, "FacilityReference", path, "", res.getError());
				}
				return success("FacilityReference", ValidationResult.ValidationType.CARDINALITY, "FacilityReference", path, "");
			})
			.collect(toList());
	}
