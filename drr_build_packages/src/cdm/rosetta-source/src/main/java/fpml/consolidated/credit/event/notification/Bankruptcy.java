...
import fpml.consolidated.credit.event.notification.meta.BankruptcyMeta;
 ...
 *
 */
@RosettaDataType(value="Bankruptcy", builder=Bankruptcy.BankruptcyBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Bankruptcy", model="fpml", builder=Bankruptcy.BankruptcyBuilderImpl.class, version="2.1.1")
