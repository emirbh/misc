...
import fpml.consolidated.shared.meta.RelatedPersonMeta;
 ...
 *
 */
@RosettaDataType(value="RelatedPerson", builder=RelatedPerson.RelatedPersonBuilderImpl.class, version="2.1.1")
@RuneDataType(value="RelatedPerson", model="fpml", builder=RelatedPerson.RelatedPersonBuilderImpl.class, version="2.1.1")
public interface RelatedPerson extends RosettaModelObject {
	...
	class RelatedPersonBuilderImpl implements RelatedPerson.RelatedPersonBuilder {
		...
		@RuneAttribute("personReference")
		@Override
		public RelatedPerson.RelatedPersonBuilder setPersonReference(PersonReference _personReference) {
		...
		@RuneAttribute("role")
		@Override
		public RelatedPerson.RelatedPersonBuilder setRole(PersonRole _role) {
