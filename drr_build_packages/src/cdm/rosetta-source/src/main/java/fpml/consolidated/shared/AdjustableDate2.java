...
import fpml.consolidated.shared.meta.AdjustableDate2Meta;
 ...
 *
 * Provision A type that is different from AdjustableDate in two regards. First, date adjustments can be specified with either a dateAdjustments element or a reference to an existing dateAdjustments element. Second, it does not require the specification of date adjustments.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="AdjustableDate2", builder=AdjustableDate2.AdjustableDate2BuilderImpl.class, version="2.1.1")
@RuneDataType(value="AdjustableDate2", model="fpml", builder=AdjustableDate2.AdjustableDate2BuilderImpl.class, version="2.1.1")
public interface AdjustableDate2 extends RosettaModelObject {
	...
	class AdjustableDate2BuilderImpl implements AdjustableDate2.AdjustableDate2Builder {
		...
		@RuneAttribute("id")
		@Override
		public AdjustableDate2.AdjustableDate2Builder setId(String _id) {
		...
		@RuneAttribute("unadjustedDate")
		@Override
		public AdjustableDate2.AdjustableDate2Builder setUnadjustedDate(IdentifiedDate _unadjustedDate) {
		...
		@RuneAttribute("dateAdjustments")
		@Override
		public AdjustableDate2.AdjustableDate2Builder setDateAdjustments(BusinessDayAdjustments _dateAdjustments) {
		...
		@RuneAttribute("dateAdjustmentsReference")
		@Override
		public AdjustableDate2.AdjustableDate2Builder setDateAdjustmentsReference(BusinessDayAdjustmentsReference _dateAdjustmentsReference) {
		...
		@RuneAttribute("adjustedDate")
		@Override
		public AdjustableDate2.AdjustableDate2Builder setAdjustedDate(IdentifiedDate _adjustedDate) {
