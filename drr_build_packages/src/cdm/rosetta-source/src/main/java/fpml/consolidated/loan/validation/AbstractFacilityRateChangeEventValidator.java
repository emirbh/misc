...
public class AbstractFacilityRateChangeEventValidator implements Validator<AbstractFacilityRateChangeEvent> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractFacilityRateChangeEvent", ValidationResult.ValidationType.CARDINALITY, "AbstractFacilityRateChangeEvent", path, "", res.getError());
				}
				return success("AbstractFacilityRateChangeEvent", ValidationResult.ValidationType.CARDINALITY, "AbstractFacilityRateChangeEvent", path, "");
			})
			.collect(toList());
	}
