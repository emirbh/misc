...
import fpml.consolidated.shared.validation.StepBaseTypeFormatValidator;
import fpml.consolidated.shared.validation.StepBaseValidator;
import fpml.consolidated.shared.validation.exists.StepBaseOnlyExistsValidator;
...
public class StepBaseMeta implements RosettaMetaData<StepBase> {
	...
	@Override
	public Validator<? super StepBase> validator(ValidatorFactory factory) {
		return factory.<StepBase>create(StepBaseValidator.class);
	}

	@Override
	public Validator<? super StepBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<StepBase>create(StepBaseTypeFormatValidator.class);
	}
