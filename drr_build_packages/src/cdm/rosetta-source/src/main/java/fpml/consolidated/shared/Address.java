 ...
 *
 * Provision A type that represents a physical postal address.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="Address", builder=Address.AddressBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Address", model="fpml", builder=Address.AddressBuilderImpl.class, version="2.1.1")
public interface Address extends RosettaModelObject {
	...
	class AddressBuilderImpl implements Address.AddressBuilder {
		...
		@RuneAttribute("streetAddress")
		@Override
		public Address.AddressBuilder setStreetAddress(StreetAddress _streetAddress) {
		...
		@RuneAttribute("country")
		@Override
		public Address.AddressBuilder setCountry(CountryCode _country) {
