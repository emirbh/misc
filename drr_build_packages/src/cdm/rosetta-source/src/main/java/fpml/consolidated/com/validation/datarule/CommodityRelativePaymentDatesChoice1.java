 ...
 * @version 2.1.1
 */
@RosettaDataRule("CommodityRelativePaymentDatesChoice1")
@ImplementedBy(CommodityRelativePaymentDatesChoice1.Default.class)
public interface CommodityRelativePaymentDatesChoice1 extends Validator<CommodityRelativePaymentDates> {
	
	String NAME = "CommodityRelativePaymentDatesChoice1";
	String DEFINITION = "optional choice payRelativeTo, payRelativeToEvent";
	
	class Default implements CommodityRelativePaymentDatesChoice1 {
		...
		private ComparisonResult executeDataRule(CommodityRelativePaymentDates commodityRelativePaymentDates) {
			try {
				return choice(MapperS.of(commodityRelativePaymentDates), Arrays.asList("payRelativeTo", "payRelativeToEvent"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements CommodityRelativePaymentDatesChoice1 {
