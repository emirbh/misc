		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("Lien", ValidationResult.ValidationType.CARDINALITY, "Lien", path, "", res.getError());
				}
				return success("Lien", ValidationResult.ValidationType.CARDINALITY, "Lien", path, "");
			})
			.collect(toList());
	}
