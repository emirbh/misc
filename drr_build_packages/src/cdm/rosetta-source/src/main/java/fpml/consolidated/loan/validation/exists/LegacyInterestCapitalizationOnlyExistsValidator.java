...
public class LegacyInterestCapitalizationOnlyExistsValidator implements ValidatorWithArg<LegacyInterestCapitalization, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LegacyInterestCapitalization> ValidationResult<LegacyInterestCapitalization> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("accrualSchedule", ExistenceChecker.isSet((List<? extends LegacyAccrualPeriod>) o.getAccrualSchedule()))
		...
		if (setFields.equals(fields)) {
			return success("LegacyInterestCapitalization", ValidationResult.ValidationType.ONLY_EXISTS, "LegacyInterestCapitalization", path, "");
		}
		return failure("LegacyInterestCapitalization", ValidationResult.ValidationType.ONLY_EXISTS, "LegacyInterestCapitalization", path, "",
