		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ImplementationSpecificationVersion", ValidationResult.ValidationType.TYPE_FORMAT, "ImplementationSpecificationVersion", path, "", res.getError());
				}
				return success("ImplementationSpecificationVersion", ValidationResult.ValidationType.TYPE_FORMAT, "ImplementationSpecificationVersion", path, "");
			})
			.collect(toList());
	}
