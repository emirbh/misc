...
public class LoanAllocationTransferFeeDueOnlyExistsValidator implements ValidatorWithArg<LoanAllocationTransferFeeDue, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationTransferFeeDue> ValidationResult<LoanAllocationTransferFeeDue> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationTransferFeeDue", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationTransferFeeDue", path, "");
		}
		return failure("LoanAllocationTransferFeeDue", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationTransferFeeDue", path, "",
