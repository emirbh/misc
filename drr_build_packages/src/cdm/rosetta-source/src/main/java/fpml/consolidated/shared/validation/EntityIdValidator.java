		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EntityId", ValidationResult.ValidationType.CARDINALITY, "EntityId", path, "", res.getError());
				}
				return success("EntityId", ValidationResult.ValidationType.CARDINALITY, "EntityId", path, "");
			})
			.collect(toList());
	}
