...
import fpml.consolidated.loan.validation.LoanTradingLetterOfCreditAccrualTypeFormatValidator;
import fpml.consolidated.loan.validation.LoanTradingLetterOfCreditAccrualValidator;
import fpml.consolidated.loan.validation.exists.LoanTradingLetterOfCreditAccrualOnlyExistsValidator;
...
public class LoanTradingLetterOfCreditAccrualMeta implements RosettaMetaData<LoanTradingLetterOfCreditAccrual> {
	...
	@Override
	public Validator<? super LoanTradingLetterOfCreditAccrual> validator(ValidatorFactory factory) {
		return factory.<LoanTradingLetterOfCreditAccrual>create(LoanTradingLetterOfCreditAccrualValidator.class);
	}

	@Override
	public Validator<? super LoanTradingLetterOfCreditAccrual> typeFormatValidator(ValidatorFactory factory) {
		return factory.<LoanTradingLetterOfCreditAccrual>create(LoanTradingLetterOfCreditAccrualTypeFormatValidator.class);
	}
