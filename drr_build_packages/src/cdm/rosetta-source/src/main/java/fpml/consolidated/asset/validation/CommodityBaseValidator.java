		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityBase", ValidationResult.ValidationType.CARDINALITY, "CommodityBase", path, "", res.getError());
				}
				return success("CommodityBase", ValidationResult.ValidationType.CARDINALITY, "CommodityBase", path, "");
			})
			.collect(toList());
	}
