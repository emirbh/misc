		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TaskIdentifier", ValidationResult.ValidationType.TYPE_FORMAT, "TaskIdentifier", path, "", res.getError());
				}
				return success("TaskIdentifier", ValidationResult.ValidationType.TYPE_FORMAT, "TaskIdentifier", path, "");
			})
			.collect(toList());
	}
