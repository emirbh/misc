...
import fpml.consolidated.loan.validation.FacilityIdentifierTypeFormatValidator;
import fpml.consolidated.loan.validation.FacilityIdentifierValidator;
import fpml.consolidated.loan.validation.exists.FacilityIdentifierOnlyExistsValidator;
...
public class FacilityIdentifierMeta implements RosettaMetaData<FacilityIdentifier> {
	...
	@Override
	public Validator<? super FacilityIdentifier> validator(ValidatorFactory factory) {
		return factory.<FacilityIdentifier>create(FacilityIdentifierValidator.class);
	}

	@Override
	public Validator<? super FacilityIdentifier> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FacilityIdentifier>create(FacilityIdentifierTypeFormatValidator.class);
	}
