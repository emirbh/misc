...
public class VarianceOptionTransactionSupplementOnlyExistsValidator implements ValidatorWithArg<VarianceOptionTransactionSupplement, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends VarianceOptionTransactionSupplement> ValidationResult<VarianceOptionTransactionSupplement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("varianceSwapTransactionSupplement", ExistenceChecker.isSet((VarianceSwapTransactionSupplement) o.getVarianceSwapTransactionSupplement()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("VarianceOptionTransactionSupplement", ValidationResult.ValidationType.ONLY_EXISTS, "VarianceOptionTransactionSupplement", path, "");
		}
		return failure("VarianceOptionTransactionSupplement", ValidationResult.ValidationType.ONLY_EXISTS, "VarianceOptionTransactionSupplement", path, "",
