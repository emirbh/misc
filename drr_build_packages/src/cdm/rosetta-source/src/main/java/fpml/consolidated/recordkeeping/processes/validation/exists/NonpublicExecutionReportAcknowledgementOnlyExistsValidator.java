...
public class NonpublicExecutionReportAcknowledgementOnlyExistsValidator implements ValidatorWithArg<NonpublicExecutionReportAcknowledgement, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends NonpublicExecutionReportAcknowledgement> ValidationResult<NonpublicExecutionReportAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("NonpublicExecutionReportAcknowledgement", ValidationResult.ValidationType.ONLY_EXISTS, "NonpublicExecutionReportAcknowledgement", path, "");
		}
		return failure("NonpublicExecutionReportAcknowledgement", ValidationResult.ValidationType.ONLY_EXISTS, "NonpublicExecutionReportAcknowledgement", path, "",
