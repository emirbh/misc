		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CoalTransportationEquipment", ValidationResult.ValidationType.TYPE_FORMAT, "CoalTransportationEquipment", path, "", res.getError());
				}
				return success("CoalTransportationEquipment", ValidationResult.ValidationType.TYPE_FORMAT, "CoalTransportationEquipment", path, "");
			})
			.collect(toList());
	}
