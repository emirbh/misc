...
public class AbstractFacilityPaymentEventOnlyExistsValidator implements ValidatorWithArg<AbstractFacilityPaymentEvent, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractFacilityPaymentEvent> ValidationResult<AbstractFacilityPaymentEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractFacilityPaymentEvent", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractFacilityPaymentEvent", path, "");
		}
		return failure("AbstractFacilityPaymentEvent", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractFacilityPaymentEvent", path, "",
