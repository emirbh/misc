...
import fpml.consolidated.asset.meta.AssetMeasureTypeMeta;
 ...
 *
 * Provision A scheme identifying the types of measures that can be used to describe an asset.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="AssetMeasureType", builder=AssetMeasureType.AssetMeasureTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="AssetMeasureType", model="fpml", builder=AssetMeasureType.AssetMeasureTypeBuilderImpl.class, version="2.1.1")
public interface AssetMeasureType extends RosettaModelObject {
	...
	class AssetMeasureTypeImpl implements AssetMeasureType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("assetMeasureScheme")
	...
	class AssetMeasureTypeBuilderImpl implements AssetMeasureType.AssetMeasureTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public AssetMeasureType.AssetMeasureTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("assetMeasureScheme")
		@Override
		public AssetMeasureType.AssetMeasureTypeBuilder setAssetMeasureScheme(String _assetMeasureScheme) {
			this.assetMeasureScheme = _assetMeasureScheme == null ? null : _assetMeasureScheme;
			return this;
		}
