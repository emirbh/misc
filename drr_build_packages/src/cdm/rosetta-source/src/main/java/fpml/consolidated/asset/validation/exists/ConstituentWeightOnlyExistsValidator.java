...
public class ConstituentWeightOnlyExistsValidator implements ValidatorWithArg<ConstituentWeight, Set<String>> {
	...
	public <T2 extends ConstituentWeight> ValidationResult<ConstituentWeight> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("basketAmount", ExistenceChecker.isSet((Money) o.getBasketAmount()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ConstituentWeight", ValidationResult.ValidationType.ONLY_EXISTS, "ConstituentWeight", path, "");
		}
		return failure("ConstituentWeight", ValidationResult.ValidationType.ONLY_EXISTS, "ConstituentWeight", path, "",
