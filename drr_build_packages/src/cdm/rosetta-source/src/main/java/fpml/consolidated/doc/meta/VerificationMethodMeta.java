...
import fpml.consolidated.doc.validation.VerificationMethodTypeFormatValidator;
import fpml.consolidated.doc.validation.VerificationMethodValidator;
import fpml.consolidated.doc.validation.exists.VerificationMethodOnlyExistsValidator;
...
public class VerificationMethodMeta implements RosettaMetaData<VerificationMethod> {
	...
	@Override
	public Validator<? super VerificationMethod> validator(ValidatorFactory factory) {
		return factory.<VerificationMethod>create(VerificationMethodValidator.class);
	}

	@Override
	public Validator<? super VerificationMethod> typeFormatValidator(ValidatorFactory factory) {
		return factory.<VerificationMethod>create(VerificationMethodTypeFormatValidator.class);
	}
