 ...
 *
 * Provision Excess Emission Penalty related parameters.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="EEPParameters", builder=EEPParameters.EEPParametersBuilderImpl.class, version="2.1.1")
@RuneDataType(value="EEPParameters", model="fpml", builder=EEPParameters.EEPParametersBuilderImpl.class, version="2.1.1")
public interface EEPParameters extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision If Excess Emission Penalty is specified to be applicable in the Confirmation then the Excess Emission Penalty will be determined in the manner specified in the Confirmation (see other EEP parameters)
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Used to determine how provisions in Part [7] Page 7 (B) Failure to Deliver Not Remedied are to be applied.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision When "true" the EEP Equivalent is applicable. See Part [7] definition of EEP Equivalent.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision When "true" the Excess Emissions Penalty is applicable. See Part [7] definition of Excess Emissions Penalty.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class EEPParametersImpl implements EEPParameters {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("equivalentApplicable")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("penaltyApplicable")
	...
	class EEPParametersBuilderImpl implements EEPParameters.EEPParametersBuilder {
		...
		@RuneAttribute("eEPApplicable")
		@Override
		public EEPParameters.EEPParametersBuilder setEEPApplicable(Boolean _eEPApplicable) {
		...
		@RuneAttribute("riskPeriod")
		@Override
		public EEPParameters.EEPParametersBuilder setRiskPeriod(EEPRiskPeriod _riskPeriod) {
		...
		@RuneAttribute("equivalentApplicable")
		@Override
		public EEPParameters.EEPParametersBuilder setEquivalentApplicable(Boolean _equivalentApplicable) {
		...
		@RuneAttribute("penaltyApplicable")
		@Override
		public EEPParameters.EEPParametersBuilder setPenaltyApplicable(Boolean _penaltyApplicable) {
