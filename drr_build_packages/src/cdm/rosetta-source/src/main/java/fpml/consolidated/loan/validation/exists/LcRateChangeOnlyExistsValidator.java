...
public class LcRateChangeOnlyExistsValidator implements ValidatorWithArg<LcRateChange, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LcRateChange> ValidationResult<LcRateChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LcRateChange", ValidationResult.ValidationType.ONLY_EXISTS, "LcRateChange", path, "");
		}
		return failure("LcRateChange", ValidationResult.ValidationType.ONLY_EXISTS, "LcRateChange", path, "",
