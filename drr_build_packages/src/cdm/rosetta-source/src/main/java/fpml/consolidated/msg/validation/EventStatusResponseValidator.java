...
public class EventStatusResponseValidator implements Validator<EventStatusResponse> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EventStatusResponse", ValidationResult.ValidationType.CARDINALITY, "EventStatusResponse", path, "", res.getError());
				}
				return success("EventStatusResponse", ValidationResult.ValidationType.CARDINALITY, "EventStatusResponse", path, "");
			})
			.collect(toList());
	}
