...
import fpml.consolidated.volatility.swaps.meta.VolatilityMeta;
 ...
 *
 */
@RosettaDataType(value="Volatility", builder=Volatility.VolatilityBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Volatility", model="fpml", builder=Volatility.VolatilityBuilderImpl.class, version="2.1.1")
public interface Volatility extends CalculationFromObservation {
	...
	interface VolatilityBuilder extends Volatility, CalculationFromObservation.CalculationFromObservationBuilder {
		...
		@Override
		Volatility.VolatilityBuilder setInitialLevel(BigDecimal initialLevel);
		@Override
		Volatility.VolatilityBuilder setInitialLevelSource(DeterminationMethod initialLevelSource);
		@Override
	...
	class VolatilityBuilderImpl extends CalculationFromObservation.CalculationFromObservationBuilderImpl implements Volatility.VolatilityBuilder {
		...
		@Override
		public Volatility.VolatilityBuilder setInitialLevel(BigDecimal _initialLevel) {
		...
		@Override
		public Volatility.VolatilityBuilder setInitialLevelSource(DeterminationMethod _initialLevelSource) {
		...
		@Override
		public Volatility.VolatilityBuilder setClosingLevel(Boolean _closingLevel) {
		...
		@Override
		public Volatility.VolatilityBuilder setExpiringLevel(Boolean _expiringLevel) {
		...
		@Override
		public Volatility.VolatilityBuilder setExpectedN(Integer _expectedN) {
		...
		@RuneAttribute("volatilityCap")
		@Override
		public Volatility.VolatilityBuilder setVolatilityCap(VolatilityCap _volatilityCap) {
		...
		@RuneAttribute("volatilityStrikePrice")
		@Override
		public Volatility.VolatilityBuilder setVolatilityStrikePrice(BigDecimal _volatilityStrikePrice) {
		...
		@RuneAttribute("vegaNotionalAmount")
		@Override
		public Volatility.VolatilityBuilder setVegaNotionalAmount(BigDecimal _vegaNotionalAmount) {
