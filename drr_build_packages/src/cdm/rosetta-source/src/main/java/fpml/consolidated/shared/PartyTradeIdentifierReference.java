...
import fpml.consolidated.shared.meta.PartyTradeIdentifierReferenceMeta;
 ...
 *
 * Provision A reference to a partyTradeIdentifier object.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="PartyTradeIdentifierReference", builder=PartyTradeIdentifierReference.PartyTradeIdentifierReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PartyTradeIdentifierReference", model="fpml", builder=PartyTradeIdentifierReference.PartyTradeIdentifierReferenceBuilderImpl.class, version="2.1.1")
public interface PartyTradeIdentifierReference extends Reference {
	...
	class PartyTradeIdentifierReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements PartyTradeIdentifierReference.PartyTradeIdentifierReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public PartyTradeIdentifierReference.PartyTradeIdentifierReferenceBuilder setHref(String _href) {
