		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EntityType", ValidationResult.ValidationType.CARDINALITY, "EntityType", path, "", res.getError());
				}
				return success("EntityType", ValidationResult.ValidationType.CARDINALITY, "EntityType", path, "");
			})
			.collect(toList());
	}
