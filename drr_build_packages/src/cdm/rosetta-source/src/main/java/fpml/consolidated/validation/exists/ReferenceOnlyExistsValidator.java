...
public class ReferenceOnlyExistsValidator implements ValidatorWithArg<Reference, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends Reference> ValidationResult<Reference> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("Reference", ValidationResult.ValidationType.ONLY_EXISTS, "Reference", path, "");
		}
		return failure("Reference", ValidationResult.ValidationType.ONLY_EXISTS, "Reference", path, "",
