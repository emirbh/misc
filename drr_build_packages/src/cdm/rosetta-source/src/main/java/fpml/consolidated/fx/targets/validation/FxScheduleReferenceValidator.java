		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxScheduleReference", ValidationResult.ValidationType.CARDINALITY, "FxScheduleReference", path, "", res.getError());
				}
				return success("FxScheduleReference", ValidationResult.ValidationType.CARDINALITY, "FxScheduleReference", path, "");
			})
			.collect(toList());
	}
