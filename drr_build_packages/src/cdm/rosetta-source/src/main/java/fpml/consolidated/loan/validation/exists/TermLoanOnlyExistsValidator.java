...
public class TermLoanOnlyExistsValidator implements ValidatorWithArg<TermLoan, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends TermLoan> ValidationResult<TermLoan> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("TermLoan", ValidationResult.ValidationType.ONLY_EXISTS, "TermLoan", path, "");
		}
		return failure("TermLoan", ValidationResult.ValidationType.ONLY_EXISTS, "TermLoan", path, "",
