		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractFacilityContractEvent", ValidationResult.ValidationType.TYPE_FORMAT, "AbstractFacilityContractEvent", path, "", res.getError());
				}
				return success("AbstractFacilityContractEvent", ValidationResult.ValidationType.TYPE_FORMAT, "AbstractFacilityContractEvent", path, "");
			})
			.collect(toList());
	}
