...
import fpml.consolidated.cd.meta.EntityTypeMeta;
 ...
 *
 * Provision Defines a coding scheme of the entity types defined in the ISDA First to Default documentation.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="EntityType", builder=EntityType.EntityTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="EntityType", model="fpml", builder=EntityType.EntityTypeBuilderImpl.class, version="2.1.1")
public interface EntityType extends RosettaModelObject {
	...
	class EntityTypeImpl implements EntityType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("entityTypeScheme")
	...
	class EntityTypeBuilderImpl implements EntityType.EntityTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public EntityType.EntityTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("entityTypeScheme")
		@Override
		public EntityType.EntityTypeBuilder setEntityTypeScheme(String _entityTypeScheme) {
			this.entityTypeScheme = _entityTypeScheme == null ? null : _entityTypeScheme;
			return this;
		}
