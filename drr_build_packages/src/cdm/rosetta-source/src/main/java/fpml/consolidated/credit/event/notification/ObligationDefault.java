...
import fpml.consolidated.credit.event.notification.meta.ObligationDefaultMeta;
 ...
 *
 */
@RosettaDataType(value="ObligationDefault", builder=ObligationDefault.ObligationDefaultBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ObligationDefault", model="fpml", builder=ObligationDefault.ObligationDefaultBuilderImpl.class, version="2.1.1")
