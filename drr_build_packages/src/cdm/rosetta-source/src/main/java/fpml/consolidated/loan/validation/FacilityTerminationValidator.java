...
public class FacilityTerminationValidator implements Validator<FacilityTermination> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityTermination", ValidationResult.ValidationType.CARDINALITY, "FacilityTermination", path, "", res.getError());
				}
				return success("FacilityTermination", ValidationResult.ValidationType.CARDINALITY, "FacilityTermination", path, "");
			})
			.collect(toList());
	}
