...
import fpml.consolidated.eq.shared.meta.InterestLegResetDatesMeta;
 ...
 *
 */
@RosettaDataType(value="InterestLegResetDates", builder=InterestLegResetDates.InterestLegResetDatesBuilderImpl.class, version="2.1.1")
@RuneDataType(value="InterestLegResetDates", model="fpml", builder=InterestLegResetDates.InterestLegResetDatesBuilderImpl.class, version="2.1.1")
public interface InterestLegResetDates extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Initial fixing date expressed as an offset to another date defined elsewhere in the document.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Specifies the fixing date relative to the reset date in terms of a business days offset, or by providing a series of adjustable dates.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class InterestLegResetDatesBuilderImpl implements InterestLegResetDates.InterestLegResetDatesBuilder {
		...
		@RuneAttribute("calculationPeriodDatesReference")
		@Override
		public InterestLegResetDates.InterestLegResetDatesBuilder setCalculationPeriodDatesReference(InterestLegCalculationPeriodDatesReference _calculationPeriodDatesReference) {
		...
		@RuneAttribute("resetRelativeTo")
		@Override
		public InterestLegResetDates.InterestLegResetDatesBuilder setResetRelativeTo(ResetRelativeToEnum _resetRelativeTo) {
		...
		@RuneAttribute("resetFrequency")
		@Override
		public InterestLegResetDates.InterestLegResetDatesBuilder setResetFrequency(ResetFrequency _resetFrequency) {
		...
		@RuneAttribute("initialFixingDate")
		@Override
		public InterestLegResetDates.InterestLegResetDatesBuilder setInitialFixingDate(RelativeDateOffset _initialFixingDate) {
		...
		@RuneAttribute("fixingDates")
		@Override
		public InterestLegResetDates.InterestLegResetDatesBuilder setFixingDates(AdjustableDatesOrRelativeDateOffset _fixingDates) {
