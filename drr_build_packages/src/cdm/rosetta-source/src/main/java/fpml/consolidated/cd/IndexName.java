...
import fpml.consolidated.cd.meta.IndexNameMeta;
 ...
 *
 */
@RosettaDataType(value="IndexName", builder=IndexName.IndexNameBuilderImpl.class, version="2.1.1")
@RuneDataType(value="IndexName", model="fpml", builder=IndexName.IndexNameBuilderImpl.class, version="2.1.1")
public interface IndexName extends RosettaModelObject {
	...
	class IndexNameBuilderImpl implements IndexName.IndexNameBuilder {
		...
		@RuneAttribute("value")
		@Override
		public IndexName.IndexNameBuilder setValue(String _value) {
		...
		@RuneAttribute("indexNameScheme")
		@Override
		public IndexName.IndexNameBuilder setIndexNameScheme(String _indexNameScheme) {
			this.indexNameScheme = _indexNameScheme == null ? null : _indexNameScheme;
			return this;
		}
