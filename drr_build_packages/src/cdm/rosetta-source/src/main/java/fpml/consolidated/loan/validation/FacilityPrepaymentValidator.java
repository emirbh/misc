...
public class FacilityPrepaymentValidator implements Validator<FacilityPrepayment> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityPrepayment", ValidationResult.ValidationType.CARDINALITY, "FacilityPrepayment", path, "", res.getError());
				}
				return success("FacilityPrepayment", ValidationResult.ValidationType.CARDINALITY, "FacilityPrepayment", path, "");
			})
			.collect(toList());
	}
