		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxCurve", ValidationResult.ValidationType.CARDINALITY, "FxCurve", path, "", res.getError());
				}
				return success("FxCurve", ValidationResult.ValidationType.CARDINALITY, "FxCurve", path, "");
			})
			.collect(toList());
	}
