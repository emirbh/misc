...
import fpml.consolidated.shared.validation.InformationSourceTypeFormatValidator;
import fpml.consolidated.shared.validation.InformationSourceValidator;
import fpml.consolidated.shared.validation.exists.InformationSourceOnlyExistsValidator;
...
public class InformationSourceMeta implements RosettaMetaData<InformationSource> {
	...
	@Override
	public Validator<? super InformationSource> validator(ValidatorFactory factory) {
		return factory.<InformationSource>create(InformationSourceValidator.class);
	}

	@Override
	public Validator<? super InformationSource> typeFormatValidator(ValidatorFactory factory) {
		return factory.<InformationSource>create(InformationSourceTypeFormatValidator.class);
	}
