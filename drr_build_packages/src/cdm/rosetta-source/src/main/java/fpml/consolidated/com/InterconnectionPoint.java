...
import fpml.consolidated.com.meta.InterconnectionPointMeta;
 ...
 *
 * Provision Identification of the border(s) or border point(s) of a transportation contract. Use the list of EIC codes for timelines for electricity (T Codes) or the list of EIC codes for measurement points for gas (Z Codes).
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="InterconnectionPoint", builder=InterconnectionPoint.InterconnectionPointBuilderImpl.class, version="2.1.1")
@RuneDataType(value="InterconnectionPoint", model="fpml", builder=InterconnectionPoint.InterconnectionPointBuilderImpl.class, version="2.1.1")
public interface InterconnectionPoint extends RosettaModelObject {
	...
	class InterconnectionPointImpl implements InterconnectionPoint {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("interconnectionPointScheme")
	...
	class InterconnectionPointBuilderImpl implements InterconnectionPoint.InterconnectionPointBuilder {
		...
		@RuneAttribute("value")
		@Override
		public InterconnectionPoint.InterconnectionPointBuilder setValue(String _value) {
		...
		@RuneAttribute("interconnectionPointScheme")
		@Override
		public InterconnectionPoint.InterconnectionPointBuilder setInterconnectionPointScheme(String _interconnectionPointScheme) {
			this.interconnectionPointScheme = _interconnectionPointScheme == null ? null : _interconnectionPointScheme;
			return this;
		}
