...
import fpml.consolidated.shared.meta.ProposedCollateralAllocationChoiceMeta;
 ...
 *
 */
@RosettaDataType(value="ProposedCollateralAllocationChoice", builder=ProposedCollateralAllocationChoice.ProposedCollateralAllocationChoiceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ProposedCollateralAllocationChoice", model="fpml", builder=ProposedCollateralAllocationChoice.ProposedCollateralAllocationChoiceBuilderImpl.class, version="2.1.1")
public interface ProposedCollateralAllocationChoice extends RosettaModelObject {
	 ...
	 * version "confirmation-5.13"
	 *
	 * Provision Collateral allocation by value.
	 *
	 */
	...
	class ProposedCollateralAllocationChoiceImpl implements ProposedCollateralAllocationChoice {
		...
		@Required
		@RuneAttribute("collateralValueAllocation")
	...
	class ProposedCollateralAllocationChoiceBuilderImpl implements ProposedCollateralAllocationChoice.ProposedCollateralAllocationChoiceBuilder {
		...
		@RuneAttribute("collateralValueAllocation")
		@Override
		public ProposedCollateralAllocationChoice.ProposedCollateralAllocationChoiceBuilder setCollateralValueAllocation(CollateralValueAllocation _collateralValueAllocation) {
			this.collateralValueAllocation = _collateralValueAllocation == null ? null : _collateralValueAllocation.toBuilder();
			return this;
		}
