...
public class RolloverOnlyExistsValidator implements ValidatorWithArg<Rollover, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends Rollover> ValidationResult<Rollover> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("currentContracts", ExistenceChecker.isSet((LoanContractsReference) o.getCurrentContracts()))
				.put("newContracts", ExistenceChecker.isSet((LoanContractList) o.getNewContracts()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Rollover", ValidationResult.ValidationType.ONLY_EXISTS, "Rollover", path, "");
		}
		return failure("Rollover", ValidationResult.ValidationType.ONLY_EXISTS, "Rollover", path, "",
