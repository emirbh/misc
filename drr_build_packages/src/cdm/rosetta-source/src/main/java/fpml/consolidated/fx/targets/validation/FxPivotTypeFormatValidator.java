		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxPivot", ValidationResult.ValidationType.TYPE_FORMAT, "FxPivot", path, "", res.getError());
				}
				return success("FxPivot", ValidationResult.ValidationType.TYPE_FORMAT, "FxPivot", path, "");
			})
			.collect(toList());
	}
