...
public class PartyTradeInformationOnlyExistsValidator implements ValidatorWithArg<PartyTradeInformation, Set<String>> {
	...
	public <T2 extends PartyTradeInformation> ValidationResult<PartyTradeInformation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("collateralPortfolioInitialMargin", ExistenceChecker.isSet((PortfolioName) o.getCollateralPortfolioInitialMargin()))
				.put("collateralPortfolioVariationMargin", ExistenceChecker.isSet((PortfolioName) o.getCollateralPortfolioVariationMargin()))
				...
				.put("blockTradeIndicator", ExistenceChecker.isSet((Boolean) o.getBlockTradeIndicator()))
		...
		if (setFields.equals(fields)) {
			return success("PartyTradeInformation", ValidationResult.ValidationType.ONLY_EXISTS, "PartyTradeInformation", path, "");
		}
		return failure("PartyTradeInformation", ValidationResult.ValidationType.ONLY_EXISTS, "PartyTradeInformation", path, "",
