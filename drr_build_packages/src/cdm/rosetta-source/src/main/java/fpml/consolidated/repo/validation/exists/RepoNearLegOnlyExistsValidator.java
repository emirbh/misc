...
public class RepoNearLegOnlyExistsValidator implements ValidatorWithArg<RepoNearLeg, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RepoNearLeg> ValidationResult<RepoNearLeg> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RepoNearLeg", ValidationResult.ValidationType.ONLY_EXISTS, "RepoNearLeg", path, "");
		}
		return failure("RepoNearLeg", ValidationResult.ValidationType.ONLY_EXISTS, "RepoNearLeg", path, "",
