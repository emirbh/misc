...
public class LoanTradeConfirmationOnlyExistsValidator implements ValidatorWithArg<LoanTradeConfirmation, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTradeConfirmation> ValidationResult<LoanTradeConfirmation> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeConfirmation", ValidationResult.ValidationType.ONLY_EXISTS, "LoanTradeConfirmation", path, "");
		}
		return failure("LoanTradeConfirmation", ValidationResult.ValidationType.ONLY_EXISTS, "LoanTradeConfirmation", path, "",
