...
import fpml.consolidated.option.shared.meta.BarrierMeta;
 ...
 *
 */
@RosettaDataType(value="Barrier", builder=Barrier.BarrierBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Barrier", model="fpml", builder=Barrier.BarrierBuilderImpl.class, version="2.1.1")
public interface Barrier extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A trigger level approached from beneath.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A trigger level approached from above.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class BarrierBuilderImpl implements Barrier.BarrierBuilder {
		...
		@RuneAttribute("barrierCap")
		@Override
		public Barrier.BarrierBuilder setBarrierCap(TriggerEvent _barrierCap) {
			this.barrierCap = _barrierCap == null ? null : _barrierCap.toBuilder();
			return this;
		}
		...
		@RuneAttribute("barrierFloor")
		@Override
		public Barrier.BarrierBuilder setBarrierFloor(TriggerEvent _barrierFloor) {
			this.barrierFloor = _barrierFloor == null ? null : _barrierFloor.toBuilder();
			return this;
		}
