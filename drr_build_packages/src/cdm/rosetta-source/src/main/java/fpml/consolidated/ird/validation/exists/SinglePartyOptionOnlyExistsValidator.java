...
public class SinglePartyOptionOnlyExistsValidator implements ValidatorWithArg<SinglePartyOption, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends SinglePartyOption> ValidationResult<SinglePartyOption> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("SinglePartyOption", ValidationResult.ValidationType.ONLY_EXISTS, "SinglePartyOption", path, "");
		}
		return failure("SinglePartyOption", ValidationResult.ValidationType.ONLY_EXISTS, "SinglePartyOption", path, "",
