...
public class AbstractLoanContractPaymentEventOnlyExistsValidator implements ValidatorWithArg<AbstractLoanContractPaymentEvent, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractLoanContractPaymentEvent> ValidationResult<AbstractLoanContractPaymentEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanContractPaymentEvent", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractLoanContractPaymentEvent", path, "");
		}
		return failure("AbstractLoanContractPaymentEvent", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractLoanContractPaymentEvent", path, "",
