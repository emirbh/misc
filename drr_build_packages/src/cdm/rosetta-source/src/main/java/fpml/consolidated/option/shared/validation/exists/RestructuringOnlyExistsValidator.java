...
public class RestructuringOnlyExistsValidator implements ValidatorWithArg<Restructuring, Set<String>> {
	...
	public <T2 extends Restructuring> ValidationResult<Restructuring> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("restructuringType", ExistenceChecker.isSet((RestructuringType) o.getRestructuringType()))
		...
		if (setFields.equals(fields)) {
			return success("Restructuring", ValidationResult.ValidationType.ONLY_EXISTS, "Restructuring", path, "");
		}
		return failure("Restructuring", ValidationResult.ValidationType.ONLY_EXISTS, "Restructuring", path, "",
