		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("Deposit", ValidationResult.ValidationType.TYPE_FORMAT, "Deposit", path, "", res.getError());
				}
				return success("Deposit", ValidationResult.ValidationType.TYPE_FORMAT, "Deposit", path, "");
			})
			.collect(toList());
	}
