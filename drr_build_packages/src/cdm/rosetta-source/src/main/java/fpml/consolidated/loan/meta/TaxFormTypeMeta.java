...
import fpml.consolidated.loan.validation.TaxFormTypeTypeFormatValidator;
import fpml.consolidated.loan.validation.TaxFormTypeValidator;
import fpml.consolidated.loan.validation.exists.TaxFormTypeOnlyExistsValidator;
...
public class TaxFormTypeMeta implements RosettaMetaData<TaxFormType> {
	...
	@Override
	public Validator<? super TaxFormType> validator(ValidatorFactory factory) {
		return factory.<TaxFormType>create(TaxFormTypeValidator.class);
	}

	@Override
	public Validator<? super TaxFormType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<TaxFormType>create(TaxFormTypeTypeFormatValidator.class);
	}
