...
import fpml.consolidated.ird.meta.FxLinkedNotionalAmountMeta;
 ...
 *
 * Provision A type to describe the cashflow representation for fx linked notionals.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FxLinkedNotionalAmount", builder=FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxLinkedNotionalAmount", model="fpml", builder=FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilderImpl.class, version="2.1.1")
public interface FxLinkedNotionalAmount extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The date on which the fx spot rate is observed. This date should already be adjusted for any applicable business day convention.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 *
	 */
	ZonedDateTime getAdjustedFxSpotFixingDate();
	/**
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 * version "recordkeeping-5.13"
	 *
	 * Provision The actual observed fx spot rate.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The calculation period notional amount.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processor.processBasic(path.newSubPath("adjustedFxSpotFixingDate"), ZonedDateTime.class, getAdjustedFxSpotFixingDate(), this);
	...
	interface FxLinkedNotionalAmountBuilder extends FxLinkedNotionalAmount, RosettaModelObjectBuilder {
		FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder setResetDate(ZonedDateTime resetDate);
		FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder setAdjustedFxSpotFixingDate(ZonedDateTime adjustedFxSpotFixingDate);
	...
	class FxLinkedNotionalAmountImpl implements FxLinkedNotionalAmount {
		...
		private final ZonedDateTime adjustedFxSpotFixingDate;
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("adjustedFxSpotFixingDate")
		public ZonedDateTime getAdjustedFxSpotFixingDate() {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("observedFxSpotRate")
	...
	class FxLinkedNotionalAmountBuilderImpl implements FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder {
		...
		protected ZonedDateTime adjustedFxSpotFixingDate;
		...
		@RuneAttribute("resetDate")
		@Override
		public FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder setResetDate(ZonedDateTime _resetDate) {
		...
		@RuneAttribute("adjustedFxSpotFixingDate")
		@Override
		public FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder setAdjustedFxSpotFixingDate(ZonedDateTime _adjustedFxSpotFixingDate) {
			this.adjustedFxSpotFixingDate = _adjustedFxSpotFixingDate == null ? null : _adjustedFxSpotFixingDate;
			return this;
		}
		...
		@RuneAttribute("observedFxSpotRate")
		@Override
		public FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder setObservedFxSpotRate(BigDecimal _observedFxSpotRate) {
			this.observedFxSpotRate = _observedFxSpotRate == null ? null : _observedFxSpotRate;
			return this;
		}
		...
		@RuneAttribute("notionalAmount")
		@Override
		public FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder setNotionalAmount(BigDecimal _notionalAmount) {
