...
public class ExchangeRateOnlyExistsValidator implements ValidatorWithArg<ExchangeRate, Set<String>> {
	...
	public <T2 extends ExchangeRate> ValidationResult<ExchangeRate> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ExchangeRate", ValidationResult.ValidationType.ONLY_EXISTS, "ExchangeRate", path, "");
		}
		return failure("ExchangeRate", ValidationResult.ValidationType.ONLY_EXISTS, "ExchangeRate", path, "",
