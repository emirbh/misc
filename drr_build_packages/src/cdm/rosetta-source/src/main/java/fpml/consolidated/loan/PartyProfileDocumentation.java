...
import fpml.consolidated.loan.meta.PartyProfileDocumentationMeta;
 ...
 *
 * Provision A structure that defines documentation related to a party profile.
 *
 */
@RosettaDataType(value="PartyProfileDocumentation", builder=PartyProfileDocumentation.PartyProfileDocumentationBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PartyProfileDocumentation", model="fpml", builder=PartyProfileDocumentation.PartyProfileDocumentationBuilderImpl.class, version="2.1.1")
public interface PartyProfileDocumentation extends RosettaModelObject {
	...
	class PartyProfileDocumentationBuilderImpl implements PartyProfileDocumentation.PartyProfileDocumentationBuilder {
		...
		@RuneAttribute("taxForm")
		@Override
		public PartyProfileDocumentation.PartyProfileDocumentationBuilder setTaxForm(TaxForm _taxForm) {
			this.taxForm = _taxForm == null ? null : _taxForm.toBuilder();
			return this;
		}
