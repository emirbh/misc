...
import fpml.consolidated.com.meta.CommodityPhysicalExerciseMeta;
 ...
 *
 * Provision The parameters for defining how the physically-settled commodity option can be exercised and how it is settled.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CommodityPhysicalExercise", builder=CommodityPhysicalExercise.CommodityPhysicalExerciseBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityPhysicalExercise", model="fpml", builder=CommodityPhysicalExercise.CommodityPhysicalExerciseBuilderImpl.class, version="2.1.1")
public interface CommodityPhysicalExercise extends RosettaModelObject {
	...
	class CommodityPhysicalExerciseBuilderImpl implements CommodityPhysicalExercise.CommodityPhysicalExerciseBuilder {
		...
		@RuneAttribute("americanExercise")
		@Override
		public CommodityPhysicalExercise.CommodityPhysicalExerciseBuilder setAmericanExercise(CommodityPhysicalAmericanExercise _americanExercise) {
		...
		@RuneAttribute("europeanExercise")
		@Override
		public CommodityPhysicalExercise.CommodityPhysicalExerciseBuilder setEuropeanExercise(CommodityPhysicalEuropeanExercise _europeanExercise) {
		...
		@RuneAttribute("automaticExercise")
		@Override
		public CommodityPhysicalExercise.CommodityPhysicalExerciseBuilder setAutomaticExercise(Boolean _automaticExercise) {
		...
		@RuneAttribute("writtenConfirmation")
		@Override
		public CommodityPhysicalExercise.CommodityPhysicalExerciseBuilder setWrittenConfirmation(Boolean _writtenConfirmation) {
		...
		@RuneAttribute("clearingInstructions")
		@Override
		public CommodityPhysicalExercise.CommodityPhysicalExerciseBuilder setClearingInstructions(SwaptionPhysicalSettlement _clearingInstructions) {
