		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("OptionBase", ValidationResult.ValidationType.CARDINALITY, "OptionBase", path, "", res.getError());
				}
				return success("OptionBase", ValidationResult.ValidationType.CARDINALITY, "OptionBase", path, "");
			})
			.collect(toList());
	}
