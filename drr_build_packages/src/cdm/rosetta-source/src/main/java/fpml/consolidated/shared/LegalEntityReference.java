...
import fpml.consolidated.shared.meta.LegalEntityReferenceMeta;
 ...
 *
 * Provision References a credit entity defined elsewhere in the document.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="LegalEntityReference", builder=LegalEntityReference.LegalEntityReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="LegalEntityReference", model="fpml", builder=LegalEntityReference.LegalEntityReferenceBuilderImpl.class, version="2.1.1")
public interface LegalEntityReference extends Reference {
	...
	class LegalEntityReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements LegalEntityReference.LegalEntityReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public LegalEntityReference.LegalEntityReferenceBuilder setHref(String _href) {
