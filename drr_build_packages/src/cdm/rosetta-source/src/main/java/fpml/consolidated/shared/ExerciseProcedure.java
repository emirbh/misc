...
import fpml.consolidated.shared.meta.ExerciseProcedureMeta;
 ...
 *
 */
@RosettaDataType(value="ExerciseProcedure", builder=ExerciseProcedure.ExerciseProcedureBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ExerciseProcedure", model="fpml", builder=ExerciseProcedure.ExerciseProcedureBuilderImpl.class, version="2.1.1")
public interface ExerciseProcedure extends RosettaModelObject {
	...
	class ExerciseProcedureImpl implements ExerciseProcedure {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("limitedRightToConfirm")
	...
	class ExerciseProcedureBuilderImpl implements ExerciseProcedure.ExerciseProcedureBuilder {
		...
		@RuneAttribute("manualExercise")
		@Override
		public ExerciseProcedure.ExerciseProcedureBuilder setManualExercise(ManualExercise _manualExercise) {
		...
		@RuneAttribute("automaticExercise")
		@Override
		public ExerciseProcedure.ExerciseProcedureBuilder setAutomaticExercise(AutomaticExercise _automaticExercise) {
		...
		@RuneAttribute("followUpConfirmation")
		@Override
		public ExerciseProcedure.ExerciseProcedureBuilder setFollowUpConfirmation(Boolean _followUpConfirmation) {
		...
		@RuneAttribute("limitedRightToConfirm")
		@Override
		public ExerciseProcedure.ExerciseProcedureBuilder setLimitedRightToConfirm(Boolean _limitedRightToConfirm) {
			this.limitedRightToConfirm = _limitedRightToConfirm == null ? null : _limitedRightToConfirm;
			return this;
		}
		...
		@RuneAttribute("splitTicket")
		@Override
		public ExerciseProcedure.ExerciseProcedureBuilder setSplitTicket(Boolean _splitTicket) {
			this.splitTicket = _splitTicket == null ? null : _splitTicket;
			return this;
		}
