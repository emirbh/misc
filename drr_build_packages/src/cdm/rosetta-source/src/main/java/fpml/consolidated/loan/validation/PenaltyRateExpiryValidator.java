...
public class PenaltyRateExpiryValidator implements Validator<PenaltyRateExpiry> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PenaltyRateExpiry", ValidationResult.ValidationType.CARDINALITY, "PenaltyRateExpiry", path, "", res.getError());
				}
				return success("PenaltyRateExpiry", ValidationResult.ValidationType.CARDINALITY, "PenaltyRateExpiry", path, "");
			})
			.collect(toList());
	}
