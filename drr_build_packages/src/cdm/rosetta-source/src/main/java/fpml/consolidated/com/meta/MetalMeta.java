...
import fpml.consolidated.com.validation.MetalTypeFormatValidator;
import fpml.consolidated.com.validation.MetalValidator;
import fpml.consolidated.com.validation.exists.MetalOnlyExistsValidator;
...
public class MetalMeta implements RosettaMetaData<Metal> {
	...
	@Override
	public Validator<? super Metal> validator(ValidatorFactory factory) {
		return factory.<Metal>create(MetalValidator.class);
	}

	@Override
	public Validator<? super Metal> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Metal>create(MetalTypeFormatValidator.class);
	}
