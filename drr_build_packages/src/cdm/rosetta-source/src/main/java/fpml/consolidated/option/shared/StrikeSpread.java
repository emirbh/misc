...
import fpml.consolidated.option.shared.meta.StrikeSpreadMeta;
 ...
 *
 * Provision A type for defining a strike spread feature.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="StrikeSpread", builder=StrikeSpread.StrikeSpreadBuilderImpl.class, version="2.1.1")
@RuneDataType(value="StrikeSpread", model="fpml", builder=StrikeSpread.StrikeSpreadBuilderImpl.class, version="2.1.1")
public interface StrikeSpread extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Upper strike in a strike spread.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Number of options at the upper strike price in a strike spread.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class StrikeSpreadImpl implements StrikeSpread {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("upperStrikeNumberOfOptions")
	...
	class StrikeSpreadBuilderImpl implements StrikeSpread.StrikeSpreadBuilder {
		...
		@RuneAttribute("upperStrike")
		@Override
		public StrikeSpread.StrikeSpreadBuilder setUpperStrike(OptionStrike _upperStrike) {
			this.upperStrike = _upperStrike == null ? null : _upperStrike.toBuilder();
			return this;
		}
		...
		@RuneAttribute("upperStrikeNumberOfOptions")
		@Override
		public StrikeSpread.StrikeSpreadBuilder setUpperStrikeNumberOfOptions(BigDecimal _upperStrikeNumberOfOptions) {
			this.upperStrikeNumberOfOptions = _upperStrikeNumberOfOptions == null ? null : _upperStrikeNumberOfOptions;
			return this;
		}
