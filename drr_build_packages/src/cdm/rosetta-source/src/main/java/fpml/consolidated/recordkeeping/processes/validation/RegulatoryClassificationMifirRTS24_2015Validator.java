...
public class RegulatoryClassificationMifirRTS24_2015Validator implements Validator<RegulatoryClassificationMifirRTS24_2015> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RegulatoryClassificationMifirRTS24_2015", ValidationResult.ValidationType.CARDINALITY, "RegulatoryClassificationMifirRTS24_2015", path, "", res.getError());
				}
				return success("RegulatoryClassificationMifirRTS24_2015", ValidationResult.ValidationType.CARDINALITY, "RegulatoryClassificationMifirRTS24_2015", path, "");
			})
			.collect(toList());
	}
