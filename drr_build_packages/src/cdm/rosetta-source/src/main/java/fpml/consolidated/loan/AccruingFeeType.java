...
import fpml.consolidated.loan.meta.AccruingFeeTypeMeta;
 ...
 *
 * Provision A list of all eligible accruing facility-level fee types.
 *
 */
@RosettaDataType(value="AccruingFeeType", builder=AccruingFeeType.AccruingFeeTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="AccruingFeeType", model="fpml", builder=AccruingFeeType.AccruingFeeTypeBuilderImpl.class, version="2.1.1")
public interface AccruingFeeType extends RosettaModelObject {
	...
	class AccruingFeeTypeImpl implements AccruingFeeType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("accruingFeeTypeScheme")
	...
	class AccruingFeeTypeBuilderImpl implements AccruingFeeType.AccruingFeeTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public AccruingFeeType.AccruingFeeTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("accruingFeeTypeScheme")
		@Override
		public AccruingFeeType.AccruingFeeTypeBuilder setAccruingFeeTypeScheme(String _accruingFeeTypeScheme) {
			this.accruingFeeTypeScheme = _accruingFeeTypeScheme == null ? null : _accruingFeeTypeScheme;
			return this;
		}
