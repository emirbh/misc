...
public class LoanTradeTransferFeeOwedOnlyExistsValidator implements ValidatorWithArg<LoanTradeTransferFeeOwed, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTradeTransferFeeOwed> ValidationResult<LoanTradeTransferFeeOwed> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeTransferFeeOwed", ValidationResult.ValidationType.ONLY_EXISTS, "LoanTradeTransferFeeOwed", path, "");
		}
		return failure("LoanTradeTransferFeeOwed", ValidationResult.ValidationType.ONLY_EXISTS, "LoanTradeTransferFeeOwed", path, "",
