		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AssetClass", ValidationResult.ValidationType.TYPE_FORMAT, "AssetClass", path, "", res.getError());
				}
				return success("AssetClass", ValidationResult.ValidationType.TYPE_FORMAT, "AssetClass", path, "");
			})
			.collect(toList());
	}
