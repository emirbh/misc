...
public class LoanFloatingRateOnlyExistsValidator implements ValidatorWithArg<LoanFloatingRate, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanFloatingRate> ValidationResult<LoanFloatingRate> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("isCompoundingBalance", ExistenceChecker.isSet((Boolean) o.getIsCompoundingBalance()))
		...
		if (setFields.equals(fields)) {
			return success("LoanFloatingRate", ValidationResult.ValidationType.ONLY_EXISTS, "LoanFloatingRate", path, "");
		}
		return failure("LoanFloatingRate", ValidationResult.ValidationType.ONLY_EXISTS, "LoanFloatingRate", path, "",
