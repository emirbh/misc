...
public class BorrowingOnlyExistsValidator implements ValidatorWithArg<Borrowing, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends Borrowing> ValidationResult<Borrowing> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("conditionsPrecedentMet", ExistenceChecker.isSet((ConditionsPrecedentMetEnum) o.getConditionsPrecedentMet()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Borrowing", ValidationResult.ValidationType.ONLY_EXISTS, "Borrowing", path, "");
		}
		return failure("Borrowing", ValidationResult.ValidationType.ONLY_EXISTS, "Borrowing", path, "",
