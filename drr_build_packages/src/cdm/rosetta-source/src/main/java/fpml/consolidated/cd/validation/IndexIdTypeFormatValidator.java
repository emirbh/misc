		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("IndexId", ValidationResult.ValidationType.TYPE_FORMAT, "IndexId", path, "", res.getError());
				}
				return success("IndexId", ValidationResult.ValidationType.TYPE_FORMAT, "IndexId", path, "");
			})
			.collect(toList());
	}
