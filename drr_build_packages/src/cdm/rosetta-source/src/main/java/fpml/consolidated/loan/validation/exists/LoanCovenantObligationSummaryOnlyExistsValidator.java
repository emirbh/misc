...
public class LoanCovenantObligationSummaryOnlyExistsValidator implements ValidatorWithArg<LoanCovenantObligationSummary, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanCovenantObligationSummary> ValidationResult<LoanCovenantObligationSummary> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanCovenantObligationSummary", ValidationResult.ValidationType.ONLY_EXISTS, "LoanCovenantObligationSummary", path, "");
		}
		return failure("LoanCovenantObligationSummary", ValidationResult.ValidationType.ONLY_EXISTS, "LoanCovenantObligationSummary", path, "",
