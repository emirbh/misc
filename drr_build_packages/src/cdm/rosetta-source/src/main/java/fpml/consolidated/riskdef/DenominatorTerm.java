...
import fpml.consolidated.riskdef.meta.DenominatorTermMeta;
 ...
 *
 * Provision The type defining a denominator term of the formula. Its value is (sum of weighted partials) ^ power.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="DenominatorTerm", builder=DenominatorTerm.DenominatorTermBuilderImpl.class, version="2.1.1")
@RuneDataType(value="DenominatorTerm", model="fpml", builder=DenominatorTerm.DenominatorTermBuilderImpl.class, version="2.1.1")
public interface DenominatorTerm extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The power to which this term is raised.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class DenominatorTermBuilderImpl implements DenominatorTerm.DenominatorTermBuilder {
		...
		@RuneAttribute("weightedPartial")
		@Override
		public DenominatorTerm.DenominatorTermBuilder setWeightedPartial(WeightedPartialDerivative _weightedPartial) {
			this.weightedPartial = _weightedPartial == null ? null : _weightedPartial.toBuilder();
			return this;
		}
		...
		@RuneAttribute("power")
		@Override
		public DenominatorTerm.DenominatorTermBuilder setPower(Integer _power) {
			this.power = _power == null ? null : _power;
			return this;
		}
