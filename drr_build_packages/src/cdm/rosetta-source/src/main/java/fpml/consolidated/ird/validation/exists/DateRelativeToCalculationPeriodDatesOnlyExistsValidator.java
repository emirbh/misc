...
public class DateRelativeToCalculationPeriodDatesOnlyExistsValidator implements ValidatorWithArg<DateRelativeToCalculationPeriodDates, Set<String>> {
	...
	public <T2 extends DateRelativeToCalculationPeriodDates> ValidationResult<DateRelativeToCalculationPeriodDates> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("calculationPeriodDatesReference", ExistenceChecker.isSet((List<? extends CalculationPeriodDatesReference>) o.getCalculationPeriodDatesReference()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("DateRelativeToCalculationPeriodDates", ValidationResult.ValidationType.ONLY_EXISTS, "DateRelativeToCalculationPeriodDates", path, "");
		}
		return failure("DateRelativeToCalculationPeriodDates", ValidationResult.ValidationType.ONLY_EXISTS, "DateRelativeToCalculationPeriodDates", path, "",
