...
import fpml.consolidated.shared.meta.LegIdMeta;
 ...
 *
 */
@RosettaDataType(value="LegId", builder=LegId.LegIdBuilderImpl.class, version="2.1.1")
@RuneDataType(value="LegId", model="fpml", builder=LegId.LegIdBuilderImpl.class, version="2.1.1")
public interface LegId extends RosettaModelObject {
	...
	class LegIdBuilderImpl implements LegId.LegIdBuilder {
		...
		@RuneAttribute("value")
		@Override
		public LegId.LegIdBuilder setValue(String _value) {
		...
		@RuneAttribute("legIdScheme")
		@Override
		public LegId.LegIdBuilder setLegIdScheme(String _legIdScheme) {
			this.legIdScheme = _legIdScheme == null ? null : _legIdScheme;
			return this;
		}
