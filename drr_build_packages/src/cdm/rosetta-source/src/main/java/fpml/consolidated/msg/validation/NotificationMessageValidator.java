...
public class NotificationMessageValidator implements Validator<NotificationMessage> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("NotificationMessage", ValidationResult.ValidationType.CARDINALITY, "NotificationMessage", path, "", res.getError());
				}
				return success("NotificationMessage", ValidationResult.ValidationType.CARDINALITY, "NotificationMessage", path, "");
			})
			.collect(toList());
	}
