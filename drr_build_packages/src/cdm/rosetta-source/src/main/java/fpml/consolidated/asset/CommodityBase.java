...
import fpml.consolidated.asset.meta.CommodityBaseMeta;
 ...
 *
 */
@RosettaDataType(value="CommodityBase", builder=CommodityBase.CommodityBaseBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityBase", model="fpml", builder=CommodityBase.CommodityBaseBuilderImpl.class, version="2.1.1")
public interface CommodityBase extends RosettaModelObject {
	...
	class CommodityBaseImpl implements CommodityBase {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("commodityBaseScheme")
	...
	class CommodityBaseBuilderImpl implements CommodityBase.CommodityBaseBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CommodityBase.CommodityBaseBuilder setValue(String _value) {
		...
		@RuneAttribute("commodityBaseScheme")
		@Override
		public CommodityBase.CommodityBaseBuilder setCommodityBaseScheme(String _commodityBaseScheme) {
			this.commodityBaseScheme = _commodityBaseScheme == null ? null : _commodityBaseScheme;
			return this;
		}
