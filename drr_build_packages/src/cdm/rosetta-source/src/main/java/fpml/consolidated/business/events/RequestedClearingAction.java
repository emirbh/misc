...
import fpml.consolidated.business.events.meta.RequestedClearingActionMeta;
 ...
 *
 * Provision A type that describes whether a trade is to be cleared.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="RequestedClearingAction", builder=RequestedClearingAction.RequestedClearingActionBuilderImpl.class, version="2.1.1")
@RuneDataType(value="RequestedClearingAction", model="fpml", builder=RequestedClearingAction.RequestedClearingActionBuilderImpl.class, version="2.1.1")
public interface RequestedClearingAction extends RosettaModelObject {
	...
	class RequestedClearingActionImpl implements RequestedClearingAction {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("requestedClearingActionScheme")
	...
	class RequestedClearingActionBuilderImpl implements RequestedClearingAction.RequestedClearingActionBuilder {
		...
		@RuneAttribute("value")
		@Override
		public RequestedClearingAction.RequestedClearingActionBuilder setValue(String _value) {
		...
		@RuneAttribute("requestedClearingActionScheme")
		@Override
		public RequestedClearingAction.RequestedClearingActionBuilder setRequestedClearingActionScheme(String _requestedClearingActionScheme) {
			this.requestedClearingActionScheme = _requestedClearingActionScheme == null ? null : _requestedClearingActionScheme;
			return this;
		}
