...
import fpml.consolidated.option.shared.meta.KnockMeta;
 ...
 *
 * Provision Knock In means option to exercise comes into existence. Knock Out means option to exercise goes out of existence.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="Knock", builder=Knock.KnockBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Knock", model="fpml", builder=Knock.KnockBuilderImpl.class, version="2.1.1")
public interface Knock extends RosettaModelObject {
	...
	class KnockBuilderImpl implements Knock.KnockBuilder {
		...
		@RuneAttribute("knockIn")
		@Override
		public Knock.KnockBuilder setKnockIn(TriggerEvent _knockIn) {
		...
		@RuneAttribute("knockOut")
		@Override
		public Knock.KnockBuilder setKnockOut(TriggerEvent _knockOut) {
