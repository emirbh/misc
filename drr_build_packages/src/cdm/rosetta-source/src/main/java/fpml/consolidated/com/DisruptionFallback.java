...
import fpml.consolidated.com.meta.DisruptionFallbackMeta;
 ...
 *
 * Provision A Disruption Fallback.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="DisruptionFallback", builder=DisruptionFallback.DisruptionFallbackBuilderImpl.class, version="2.1.1")
@RuneDataType(value="DisruptionFallback", model="fpml", builder=DisruptionFallback.DisruptionFallbackBuilderImpl.class, version="2.1.1")
public interface DisruptionFallback extends RosettaModelObject {
	...
	class DisruptionFallbackImpl implements DisruptionFallback {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("commodityMarketDisruptionFallbackScheme")
	...
	class DisruptionFallbackBuilderImpl implements DisruptionFallback.DisruptionFallbackBuilder {
		...
		@RuneAttribute("value")
		@Override
		public DisruptionFallback.DisruptionFallbackBuilder setValue(String _value) {
		...
		@RuneAttribute("commodityMarketDisruptionFallbackScheme")
		@Override
		public DisruptionFallback.DisruptionFallbackBuilder setCommodityMarketDisruptionFallbackScheme(String _commodityMarketDisruptionFallbackScheme) {
			this.commodityMarketDisruptionFallbackScheme = _commodityMarketDisruptionFallbackScheme == null ? null : _commodityMarketDisruptionFallbackScheme;
			return this;
		}
