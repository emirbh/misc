...
public class LoanContractNotificationOnlyExistsValidator implements ValidatorWithArg<LoanContractNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanContractNotification> ValidationResult<LoanContractNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("facilityPosition", ExistenceChecker.isSet((List<? extends FacilityPosition>) o.getFacilityPosition()))
				...
				.put("loanContractNotificationChoice", ExistenceChecker.isSet((List<? extends LoanContractNotificationChoice>) o.getLoanContractNotificationChoice()))
		...
		if (setFields.equals(fields)) {
			return success("LoanContractNotification", ValidationResult.ValidationType.ONLY_EXISTS, "LoanContractNotification", path, "");
		}
		return failure("LoanContractNotification", ValidationResult.ValidationType.ONLY_EXISTS, "LoanContractNotification", path, "",
