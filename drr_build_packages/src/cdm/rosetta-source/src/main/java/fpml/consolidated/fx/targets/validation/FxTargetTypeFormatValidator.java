		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxTarget", ValidationResult.ValidationType.TYPE_FORMAT, "FxTarget", path, "", res.getError());
				}
				return success("FxTarget", ValidationResult.ValidationType.TYPE_FORMAT, "FxTarget", path, "");
			})
			.collect(toList());
	}
