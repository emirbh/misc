...
public class EquityCorporateEventsValidator implements Validator<EquityCorporateEvents> {
	...
	private List<ComparisonResult> getComparisonResults(EquityCorporateEvents o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("shareForShare", (ShareExtraordinaryEventEnum) o.getShareForShare() != null ? 1 : 0, 0, 1), 
				checkCardinality("shareForOther", (ShareExtraordinaryEventEnum) o.getShareForOther() != null ? 1 : 0, 0, 1), 
				checkCardinality("shareForCombined", (ShareExtraordinaryEventEnum) o.getShareForCombined() != null ? 1 : 0, 0, 1)
			);
	}
