...
import fpml.consolidated.asset.meta.QuantityUnitMeta;
 ...
 *
 */
@RosettaDataType(value="QuantityUnit", builder=QuantityUnit.QuantityUnitBuilderImpl.class, version="2.1.1")
@RuneDataType(value="QuantityUnit", model="fpml", builder=QuantityUnit.QuantityUnitBuilderImpl.class, version="2.1.1")
public interface QuantityUnit extends RosettaModelObject {
	...
	class QuantityUnitImpl implements QuantityUnit {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("quantityUnitScheme")
	...
	class QuantityUnitBuilderImpl implements QuantityUnit.QuantityUnitBuilder {
		...
		@RuneAttribute("value")
		@Override
		public QuantityUnit.QuantityUnitBuilder setValue(String _value) {
		...
		@RuneAttribute("quantityUnitScheme")
		@Override
		public QuantityUnit.QuantityUnitBuilder setQuantityUnitScheme(String _quantityUnitScheme) {
			this.quantityUnitScheme = _quantityUnitScheme == null ? null : _quantityUnitScheme;
			return this;
		}
