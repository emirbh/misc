...
public class TradeReferenceInformationUpdateAcknowledgementValidator implements Validator<TradeReferenceInformationUpdateAcknowledgement> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeReferenceInformationUpdateAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "TradeReferenceInformationUpdateAcknowledgement", path, "", res.getError());
				}
				return success("TradeReferenceInformationUpdateAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "TradeReferenceInformationUpdateAcknowledgement", path, "");
			})
			.collect(toList());
	}
