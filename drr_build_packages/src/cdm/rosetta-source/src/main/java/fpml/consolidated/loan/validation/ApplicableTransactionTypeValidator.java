		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ApplicableTransactionType", ValidationResult.ValidationType.CARDINALITY, "ApplicableTransactionType", path, "", res.getError());
				}
				return success("ApplicableTransactionType", ValidationResult.ValidationType.CARDINALITY, "ApplicableTransactionType", path, "");
			})
			.collect(toList());
	}
