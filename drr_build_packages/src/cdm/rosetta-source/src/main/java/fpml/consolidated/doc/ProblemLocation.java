...
import fpml.consolidated.doc.meta.ProblemLocationMeta;
 ...
 *
 * Provision Provides a lexical location (i.e. a line number and character for bad XML) or an XPath location (i.e. place to identify the bad location for valid XML).
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ProblemLocation", builder=ProblemLocation.ProblemLocationBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ProblemLocation", model="fpml", builder=ProblemLocation.ProblemLocationBuilderImpl.class, version="2.1.1")
public interface ProblemLocation extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The value of the locationType attribute defines which type of location has been given. It may take the values 'lexical' or 'xpath'.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class ProblemLocationBuilderImpl implements ProblemLocation.ProblemLocationBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ProblemLocation.ProblemLocationBuilder setValue(String _value) {
		...
		@RuneAttribute("locationType")
		@Override
		public ProblemLocation.ProblemLocationBuilder setLocationType(String _locationType) {
			this.locationType = _locationType == null ? null : _locationType;
			return this;
		}
