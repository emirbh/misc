...
import fpml.consolidated.option.shared.validation.CreditEventsTypeFormatValidator;
import fpml.consolidated.option.shared.validation.CreditEventsValidator;
import fpml.consolidated.option.shared.validation.exists.CreditEventsOnlyExistsValidator;
...
public class CreditEventsMeta implements RosettaMetaData<CreditEvents> {
	...
	@Override
	public Validator<? super CreditEvents> validator(ValidatorFactory factory) {
		return factory.<CreditEvents>create(CreditEventsValidator.class);
	}

	@Override
	public Validator<? super CreditEvents> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CreditEvents>create(CreditEventsTypeFormatValidator.class);
	}
