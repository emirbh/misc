...
import fpml.consolidated.com.meta.CommodityPhysicalEuropeanExerciseMeta;
 ...
 *
 * Provision The parameters for defining the expiration date(s) and time(s) for a European style option.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CommodityPhysicalEuropeanExercise", builder=CommodityPhysicalEuropeanExercise.CommodityPhysicalEuropeanExerciseBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityPhysicalEuropeanExercise", model="fpml", builder=CommodityPhysicalEuropeanExercise.CommodityPhysicalEuropeanExerciseBuilderImpl.class, version="2.1.1")
public interface CommodityPhysicalEuropeanExercise extends Exercise {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The Expiration Date of a single expiry European-style option or the first Expiration Date of a multiple expiry or daily expiring option.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The Expiration Date(s) of a European-style option.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The Expiration Date(s) of a European-style option where it is relative to the occurrence of an external event.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class CommodityPhysicalEuropeanExerciseBuilderImpl extends Exercise.ExerciseBuilderImpl implements CommodityPhysicalEuropeanExercise.CommodityPhysicalEuropeanExerciseBuilder {
		...
		@RuneAttribute("id")
		@Override
		public CommodityPhysicalEuropeanExercise.CommodityPhysicalEuropeanExerciseBuilder setId(String _id) {
		...
		@RuneAttribute("expirationDate")
		@Override
		public CommodityPhysicalEuropeanExercise.CommodityPhysicalEuropeanExerciseBuilder setExpirationDate(AdjustableOrRelativeDate _expirationDate) {
		...
		@RuneAttribute("expirationDates")
		@Override
		public CommodityPhysicalEuropeanExercise.CommodityPhysicalEuropeanExerciseBuilder setExpirationDates(AdjustableRelativeOrPeriodicDates2 _expirationDates) {
		...
		@RuneAttribute("relativeExpirationDates")
		@Override
		public CommodityPhysicalEuropeanExercise.CommodityPhysicalEuropeanExerciseBuilder setRelativeExpirationDates(CommodityRelativeExpirationDates _relativeExpirationDates) {
		...
		@RuneAttribute("expirationTime")
		@Override
		public CommodityPhysicalEuropeanExercise.CommodityPhysicalEuropeanExerciseBuilder setExpirationTime(PrevailingTime _expirationTime) {
