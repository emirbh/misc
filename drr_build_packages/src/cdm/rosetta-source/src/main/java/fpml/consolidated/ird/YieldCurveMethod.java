...
import fpml.consolidated.ird.meta.YieldCurveMethodMeta;
 ...
 *
 * Provision A type defining the parameters required for each of the ISDA defined yield curve methods for cash settlement.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="YieldCurveMethod", builder=YieldCurveMethod.YieldCurveMethodBuilderImpl.class, version="2.1.1")
@RuneDataType(value="YieldCurveMethod", model="fpml", builder=YieldCurveMethod.YieldCurveMethodBuilderImpl.class, version="2.1.1")
public interface YieldCurveMethod extends RosettaModelObject {
	...
	class YieldCurveMethodBuilderImpl implements YieldCurveMethod.YieldCurveMethodBuilder {
		...
		@RuneAttribute("settlementRateSource")
		@Override
		public YieldCurveMethod.YieldCurveMethodBuilder setSettlementRateSource(SettlementRateSource _settlementRateSource) {
		...
		@RuneAttribute("quotationRateType")
		@Override
		public YieldCurveMethod.YieldCurveMethodBuilder setQuotationRateType(QuotationRateTypeEnum _quotationRateType) {
