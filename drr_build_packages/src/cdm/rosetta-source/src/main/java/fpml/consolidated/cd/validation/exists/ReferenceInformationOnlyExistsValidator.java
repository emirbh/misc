...
public class ReferenceInformationOnlyExistsValidator implements ValidatorWithArg<ReferenceInformation, Set<String>> {
	...
	public <T2 extends ReferenceInformation> ValidationResult<ReferenceInformation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("referencePrice", ExistenceChecker.isSet((BigDecimal) o.getReferencePrice()))
		...
		if (setFields.equals(fields)) {
			return success("ReferenceInformation", ValidationResult.ValidationType.ONLY_EXISTS, "ReferenceInformation", path, "");
		}
		return failure("ReferenceInformation", ValidationResult.ValidationType.ONLY_EXISTS, "ReferenceInformation", path, "",
