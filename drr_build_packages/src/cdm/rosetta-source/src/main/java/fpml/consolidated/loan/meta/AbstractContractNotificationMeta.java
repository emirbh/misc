...
import fpml.consolidated.loan.validation.AbstractContractNotificationTypeFormatValidator;
import fpml.consolidated.loan.validation.AbstractContractNotificationValidator;
import fpml.consolidated.loan.validation.exists.AbstractContractNotificationOnlyExistsValidator;
...
public class AbstractContractNotificationMeta implements RosettaMetaData<AbstractContractNotification> {
	...
	@Override
	public Validator<? super AbstractContractNotification> validator(ValidatorFactory factory) {
		return factory.<AbstractContractNotification>create(AbstractContractNotificationValidator.class);
	}

	@Override
	public Validator<? super AbstractContractNotification> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AbstractContractNotification>create(AbstractContractNotificationTypeFormatValidator.class);
	}
