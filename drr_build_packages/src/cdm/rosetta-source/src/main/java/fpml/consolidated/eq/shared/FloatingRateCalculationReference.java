...
import fpml.consolidated.eq.shared.meta.FloatingRateCalculationReferenceMeta;
 ...
 *
 * Provision Reference to a floating rate calculation of interest calculation component.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FloatingRateCalculationReference", builder=FloatingRateCalculationReference.FloatingRateCalculationReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FloatingRateCalculationReference", model="fpml", builder=FloatingRateCalculationReference.FloatingRateCalculationReferenceBuilderImpl.class, version="2.1.1")
public interface FloatingRateCalculationReference extends Reference {
	...
	class FloatingRateCalculationReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements FloatingRateCalculationReference.FloatingRateCalculationReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public FloatingRateCalculationReference.FloatingRateCalculationReferenceBuilder setHref(String _href) {
