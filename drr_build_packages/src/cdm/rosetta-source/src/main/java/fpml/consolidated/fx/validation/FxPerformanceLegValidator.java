		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxPerformanceLeg", ValidationResult.ValidationType.CARDINALITY, "FxPerformanceLeg", path, "", res.getError());
				}
				return success("FxPerformanceLeg", ValidationResult.ValidationType.CARDINALITY, "FxPerformanceLeg", path, "");
			})
			.collect(toList());
	}
