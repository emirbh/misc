...
public class RequestRegulatoryReportingStatusMessageOnlyExistsValidator implements ValidatorWithArg<RequestRegulatoryReportingStatusMessage, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RequestRegulatoryReportingStatusMessage> ValidationResult<RequestRegulatoryReportingStatusMessage> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestRegulatoryReportingStatusMessage", ValidationResult.ValidationType.ONLY_EXISTS, "RequestRegulatoryReportingStatusMessage", path, "");
		}
		return failure("RequestRegulatoryReportingStatusMessage", ValidationResult.ValidationType.ONLY_EXISTS, "RequestRegulatoryReportingStatusMessage", path, "",
