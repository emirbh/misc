...
public class RegulatoryClassificationMifirRTS24_2015OnlyExistsValidator implements ValidatorWithArg<RegulatoryClassificationMifirRTS24_2015, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RegulatoryClassificationMifirRTS24_2015> ValidationResult<RegulatoryClassificationMifirRTS24_2015> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RegulatoryClassificationMifirRTS24_2015", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryClassificationMifirRTS24_2015", path, "");
		}
		return failure("RegulatoryClassificationMifirRTS24_2015", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryClassificationMifirRTS24_2015", path, "",
