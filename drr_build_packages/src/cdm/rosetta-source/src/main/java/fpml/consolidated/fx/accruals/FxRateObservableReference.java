...
import fpml.consolidated.fx.accruals.meta.FxRateObservableReferenceMeta;
 ...
 *
 */
@RosettaDataType(value="FxRateObservableReference", builder=FxRateObservableReference.FxRateObservableReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxRateObservableReference", model="fpml", builder=FxRateObservableReference.FxRateObservableReferenceBuilderImpl.class, version="2.1.1")
public interface FxRateObservableReference extends Reference {
	...
	class FxRateObservableReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements FxRateObservableReference.FxRateObservableReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public FxRateObservableReference.FxRateObservableReferenceBuilder setHref(String _href) {
