 ...
 * @version 2.1.1
 */
@RosettaDataRule("CommodityReturnLegChoice2")
@ImplementedBy(CommodityReturnLegChoice2.Default.class)
public interface CommodityReturnLegChoice2 extends Validator<CommodityReturnLeg> {
	
	String NAME = "CommodityReturnLegChoice2";
	...
	class Default implements CommodityReturnLegChoice2 {
		...
		private ComparisonResult executeDataRule(CommodityReturnLeg commodityReturnLeg) {
			try {
				return choice(MapperS.of(commodityReturnLeg), Arrays.asList("calculationDates", "calculationPeriods", "calculationPeriodsSchedule", "calculationPeriodsReference", "calculationPeriodsScheduleReference", "calculationPeriodsDatesReference"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements CommodityReturnLegChoice2 {
