...
public class FacilityPrepaymentOnlyExistsValidator implements ValidatorWithArg<FacilityPrepayment, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FacilityPrepayment> ValidationResult<FacilityPrepayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FacilityPrepayment", ValidationResult.ValidationType.ONLY_EXISTS, "FacilityPrepayment", path, "");
		}
		return failure("FacilityPrepayment", ValidationResult.ValidationType.ONLY_EXISTS, "FacilityPrepayment", path, "",
