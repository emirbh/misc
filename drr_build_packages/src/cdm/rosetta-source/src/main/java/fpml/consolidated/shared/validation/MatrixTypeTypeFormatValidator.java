		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MatrixType", ValidationResult.ValidationType.TYPE_FORMAT, "MatrixType", path, "", res.getError());
				}
				return success("MatrixType", ValidationResult.ValidationType.TYPE_FORMAT, "MatrixType", path, "");
			})
			.collect(toList());
	}
