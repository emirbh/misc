 ...
 * @version 2.1.1
 */
@RosettaDataRule("CommodityPricingDatesChoice0")
@ImplementedBy(CommodityPricingDatesChoice0.Default.class)
public interface CommodityPricingDatesChoice0 extends Validator<CommodityPricingDates> {
	
	String NAME = "CommodityPricingDatesChoice0";
	...
	class Default implements CommodityPricingDatesChoice0 {
		...
		private ComparisonResult executeDataRule(CommodityPricingDates commodityPricingDates) {
			try {
				return choice(MapperS.of(commodityPricingDates), Arrays.asList("calculationPeriodsReference", "calculationPeriodsScheduleReference", "calculationPeriodsDatesReference"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements CommodityPricingDatesChoice0 {
