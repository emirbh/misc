		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ServiceProcessingEvent", ValidationResult.ValidationType.CARDINALITY, "ServiceProcessingEvent", path, "", res.getError());
				}
				return success("ServiceProcessingEvent", ValidationResult.ValidationType.CARDINALITY, "ServiceProcessingEvent", path, "");
			})
			.collect(toList());
	}
