...
import fpml.consolidated.riskdef.validation.InstrumentSetTypeFormatValidator;
import fpml.consolidated.riskdef.validation.InstrumentSetValidator;
import fpml.consolidated.riskdef.validation.exists.InstrumentSetOnlyExistsValidator;
...
public class InstrumentSetMeta implements RosettaMetaData<InstrumentSet> {
	...
	@Override
	public Validator<? super InstrumentSet> validator(ValidatorFactory factory) {
		return factory.<InstrumentSet>create(InstrumentSetValidator.class);
	}

	@Override
	public Validator<? super InstrumentSet> typeFormatValidator(ValidatorFactory factory) {
		return factory.<InstrumentSet>create(InstrumentSetTypeFormatValidator.class);
	}
