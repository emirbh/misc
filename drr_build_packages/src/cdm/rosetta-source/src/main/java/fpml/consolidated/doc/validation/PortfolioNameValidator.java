		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PortfolioName", ValidationResult.ValidationType.CARDINALITY, "PortfolioName", path, "", res.getError());
				}
				return success("PortfolioName", ValidationResult.ValidationType.CARDINALITY, "PortfolioName", path, "");
			})
			.collect(toList());
	}
