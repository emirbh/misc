...
import fpml.consolidated.option.shared.meta.WeightedAveragingObservationMeta;
 ...
 *
 */
@RosettaDataType(value="WeightedAveragingObservation", builder=WeightedAveragingObservation.WeightedAveragingObservationBuilderImpl.class, version="2.1.1")
@RuneDataType(value="WeightedAveragingObservation", model="fpml", builder=WeightedAveragingObservation.WeightedAveragingObservationBuilderImpl.class, version="2.1.1")
public interface WeightedAveragingObservation extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Observation date time, which should be used when literal observation dates are required.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Observation number, which should be unique, within a series generated by a date schedule.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Observation weight, which is used as a multiplier for the observation value.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
