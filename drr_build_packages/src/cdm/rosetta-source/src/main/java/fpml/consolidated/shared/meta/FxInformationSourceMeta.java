...
import fpml.consolidated.shared.validation.FxInformationSourceTypeFormatValidator;
import fpml.consolidated.shared.validation.FxInformationSourceValidator;
import fpml.consolidated.shared.validation.exists.FxInformationSourceOnlyExistsValidator;
...
public class FxInformationSourceMeta implements RosettaMetaData<FxInformationSource> {
	...
	@Override
	public Validator<? super FxInformationSource> validator(ValidatorFactory factory) {
		return factory.<FxInformationSource>create(FxInformationSourceValidator.class);
	}

	@Override
	public Validator<? super FxInformationSource> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FxInformationSource>create(FxInformationSourceTypeFormatValidator.class);
	}
