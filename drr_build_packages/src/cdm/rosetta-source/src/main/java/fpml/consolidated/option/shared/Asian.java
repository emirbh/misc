...
import fpml.consolidated.fpmlenum.AveragingInOutEnum;
import fpml.consolidated.option.shared.meta.AsianMeta;
 ...
 *
 * Provision As per ISDA 2002 Definitions.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="Asian", builder=Asian.AsianBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Asian", model="fpml", builder=Asian.AsianBuilderImpl.class, version="2.1.1")
public interface Asian extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The factor of strike.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The averaging in period.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The averaging out period.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class AsianImpl implements Asian {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("averagingPeriodIn")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("averagingPeriodOut")
	...
	class AsianBuilderImpl implements Asian.AsianBuilder {
		...
		@RuneAttribute("averagingInOut")
		@Override
		public Asian.AsianBuilder setAveragingInOut(AveragingInOutEnum _averagingInOut) {
			this.averagingInOut = _averagingInOut == null ? null : _averagingInOut;
			return this;
		}
		...
		@RuneAttribute("strikeFactor")
		@Override
		public Asian.AsianBuilder setStrikeFactor(BigDecimal _strikeFactor) {
			this.strikeFactor = _strikeFactor == null ? null : _strikeFactor;
			return this;
		}
		...
		@RuneAttribute("averagingPeriodIn")
		@Override
		public Asian.AsianBuilder setAveragingPeriodIn(AveragingPeriod _averagingPeriodIn) {
			this.averagingPeriodIn = _averagingPeriodIn == null ? null : _averagingPeriodIn.toBuilder();
			return this;
		}
		...
		@RuneAttribute("averagingPeriodOut")
		@Override
		public Asian.AsianBuilder setAveragingPeriodOut(AveragingPeriod _averagingPeriodOut) {
			this.averagingPeriodOut = _averagingPeriodOut == null ? null : _averagingPeriodOut.toBuilder();
			return this;
		}
