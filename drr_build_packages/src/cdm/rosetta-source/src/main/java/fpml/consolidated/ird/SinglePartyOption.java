...
import fpml.consolidated.ird.meta.SinglePartyOptionMeta;
 ...
 *
 * Provision A type describing the buyer and seller of an option.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="SinglePartyOption", builder=SinglePartyOption.SinglePartyOptionBuilderImpl.class, version="2.1.1")
@RuneDataType(value="SinglePartyOption", model="fpml", builder=SinglePartyOption.SinglePartyOptionBuilderImpl.class, version="2.1.1")
public interface SinglePartyOption extends RosettaModelObject {
	...
	interface SinglePartyOptionBuilder extends SinglePartyOption, RosettaModelObjectBuilder {
		...
		SinglePartyOption.SinglePartyOptionBuilder setBuyerPartyReference(PartyReference buyerPartyReference);
		SinglePartyOption.SinglePartyOptionBuilder setBuyerAccountReference(AccountReference buyerAccountReference);
		SinglePartyOption.SinglePartyOptionBuilder setSellerPartyReference(PartyReference sellerPartyReference);
		SinglePartyOption.SinglePartyOptionBuilder setSellerAccountReference(AccountReference sellerAccountReference);
	...
	class SinglePartyOptionBuilderImpl implements SinglePartyOption.SinglePartyOptionBuilder {
		...
		@RuneAttribute("buyerPartyReference")
		@Override
		public SinglePartyOption.SinglePartyOptionBuilder setBuyerPartyReference(PartyReference _buyerPartyReference) {
		...
		@RuneAttribute("buyerAccountReference")
		@Override
		public SinglePartyOption.SinglePartyOptionBuilder setBuyerAccountReference(AccountReference _buyerAccountReference) {
		...
		@RuneAttribute("sellerPartyReference")
		@Override
		public SinglePartyOption.SinglePartyOptionBuilder setSellerPartyReference(PartyReference _sellerPartyReference) {
		...
		@RuneAttribute("sellerAccountReference")
		@Override
		public SinglePartyOption.SinglePartyOptionBuilder setSellerAccountReference(AccountReference _sellerAccountReference) {
