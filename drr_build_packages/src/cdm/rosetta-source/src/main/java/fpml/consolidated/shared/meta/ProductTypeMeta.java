...
import fpml.consolidated.shared.validation.ProductTypeTypeFormatValidator;
import fpml.consolidated.shared.validation.ProductTypeValidator;
import fpml.consolidated.shared.validation.exists.ProductTypeOnlyExistsValidator;
...
public class ProductTypeMeta implements RosettaMetaData<ProductType> {
	...
	@Override
	public Validator<? super ProductType> validator(ValidatorFactory factory) {
		return factory.<ProductType>create(ProductTypeValidator.class);
	}

	@Override
	public Validator<? super ProductType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ProductType>create(ProductTypeTypeFormatValidator.class);
	}
