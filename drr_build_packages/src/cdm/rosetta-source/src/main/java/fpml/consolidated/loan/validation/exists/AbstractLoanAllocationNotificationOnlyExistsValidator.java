...
public class AbstractLoanAllocationNotificationOnlyExistsValidator implements ValidatorWithArg<AbstractLoanAllocationNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractLoanAllocationNotification> ValidationResult<AbstractLoanAllocationNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanAllocationNotification", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractLoanAllocationNotification", path, "");
		}
		return failure("AbstractLoanAllocationNotification", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractLoanAllocationNotification", path, "",
