...
import fpml.consolidated.shared.validation.ClearanceSystemTypeFormatValidator;
import fpml.consolidated.shared.validation.ClearanceSystemValidator;
import fpml.consolidated.shared.validation.exists.ClearanceSystemOnlyExistsValidator;
...
public class ClearanceSystemMeta implements RosettaMetaData<ClearanceSystem> {
	...
	@Override
	public Validator<? super ClearanceSystem> validator(ValidatorFactory factory) {
		return factory.<ClearanceSystem>create(ClearanceSystemValidator.class);
	}

	@Override
	public Validator<? super ClearanceSystem> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ClearanceSystem>create(ClearanceSystemTypeFormatValidator.class);
	}
