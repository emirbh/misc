		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CollateralProfile", ValidationResult.ValidationType.CARDINALITY, "CollateralProfile", path, "", res.getError());
				}
				return success("CollateralProfile", ValidationResult.ValidationType.CARDINALITY, "CollateralProfile", path, "");
			})
			.collect(toList());
	}
