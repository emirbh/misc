...
import fpml.consolidated.loan.validation.FeeRateOptionBaseTypeFormatValidator;
import fpml.consolidated.loan.validation.FeeRateOptionBaseValidator;
import fpml.consolidated.loan.validation.exists.FeeRateOptionBaseOnlyExistsValidator;
...
public class FeeRateOptionBaseMeta implements RosettaMetaData<FeeRateOptionBase> {
	...
	@Override
	public Validator<? super FeeRateOptionBase> validator(ValidatorFactory factory) {
		return factory.<FeeRateOptionBase>create(FeeRateOptionBaseValidator.class);
	}

	@Override
	public Validator<? super FeeRateOptionBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FeeRateOptionBase>create(FeeRateOptionBaseTypeFormatValidator.class);
	}
