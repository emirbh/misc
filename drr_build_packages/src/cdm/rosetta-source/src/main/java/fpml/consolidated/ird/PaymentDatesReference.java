...
import fpml.consolidated.ird.meta.PaymentDatesReferenceMeta;
 ...
 *
 * Provision Reference to a payment dates structure.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="PaymentDatesReference", builder=PaymentDatesReference.PaymentDatesReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PaymentDatesReference", model="fpml", builder=PaymentDatesReference.PaymentDatesReferenceBuilderImpl.class, version="2.1.1")
public interface PaymentDatesReference extends Reference {
	...
	class PaymentDatesReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements PaymentDatesReference.PaymentDatesReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public PaymentDatesReference.PaymentDatesReferenceBuilder setHref(String _href) {
