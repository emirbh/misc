...
import fpml.consolidated.cd.meta.AdditionalFixedPaymentsMeta;
 ...
 *
 */
@RosettaDataType(value="AdditionalFixedPayments", builder=AdditionalFixedPayments.AdditionalFixedPaymentsBuilderImpl.class, version="2.1.1")
@RuneDataType(value="AdditionalFixedPayments", model="fpml", builder=AdditionalFixedPayments.AdditionalFixedPaymentsBuilderImpl.class, version="2.1.1")
public interface AdditionalFixedPayments extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An additional Fixed Payment Event. Corresponds to the payment by or on behalf of the Issuer of an actual interest amount in respect to the reference obligation that is greater than the expected interest amount. ISDA 2003 Term: Interest Shortfall Reimbursement.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An additional Fixed Payment Event. Corresponds to the payment by or on behalf of the Issuer of an actual principal amount in respect to the reference obligation that is greater than the expected principal amount. ISDA 2003 Term: Principal Shortfall Reimbursement.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An Additional Fixed Payment. Corresponds to the payment by or on behalf of the issuer of an amount in respect to the reference obligation in reduction of the prior writedowns. ISDA 2003 Term: Writedown Reimbursement.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class AdditionalFixedPaymentsImpl implements AdditionalFixedPayments {
		...
		@RuneAttribute("interestShortfallReimbursement")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("principalShortfallReimbursement")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("writedownReimbursement")
	...
	class AdditionalFixedPaymentsBuilderImpl implements AdditionalFixedPayments.AdditionalFixedPaymentsBuilder {
		...
		@RuneAttribute("interestShortfallReimbursement")
		@Override
		public AdditionalFixedPayments.AdditionalFixedPaymentsBuilder setInterestShortfallReimbursement(Boolean _interestShortfallReimbursement) {
			this.interestShortfallReimbursement = _interestShortfallReimbursement == null ? null : _interestShortfallReimbursement;
			return this;
		}
		...
		@RuneAttribute("principalShortfallReimbursement")
		@Override
		public AdditionalFixedPayments.AdditionalFixedPaymentsBuilder setPrincipalShortfallReimbursement(Boolean _principalShortfallReimbursement) {
			this.principalShortfallReimbursement = _principalShortfallReimbursement == null ? null : _principalShortfallReimbursement;
			return this;
		}
		...
		@RuneAttribute("writedownReimbursement")
		@Override
		public AdditionalFixedPayments.AdditionalFixedPaymentsBuilder setWritedownReimbursement(Boolean _writedownReimbursement) {
			this.writedownReimbursement = _writedownReimbursement == null ? null : _writedownReimbursement;
			return this;
		}
