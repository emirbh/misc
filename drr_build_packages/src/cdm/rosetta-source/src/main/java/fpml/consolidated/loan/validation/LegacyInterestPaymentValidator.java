...
public class LegacyInterestPaymentValidator implements Validator<LegacyInterestPayment> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LegacyInterestPayment", ValidationResult.ValidationType.CARDINALITY, "LegacyInterestPayment", path, "", res.getError());
				}
				return success("LegacyInterestPayment", ValidationResult.ValidationType.CARDINALITY, "LegacyInterestPayment", path, "");
			})
			.collect(toList());
	}
