...
import fpml.consolidated.msg.meta.PortfolioReferenceBaseMeta;
 ...
 *
 * Provision A structure used to identify a portfolio in a message.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="PortfolioReferenceBase", builder=PortfolioReferenceBase.PortfolioReferenceBaseBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PortfolioReferenceBase", model="fpml", builder=PortfolioReferenceBase.PortfolioReferenceBaseBuilderImpl.class, version="2.1.1")
public interface PortfolioReferenceBase extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision An identifier that is unique for each portfolio-level request, and which can be used to group together the individual messages in the portfolio request.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class PortfolioReferenceBaseBuilderImpl implements PortfolioReferenceBase.PortfolioReferenceBaseBuilder {
		...
		@RuneAttribute("portfolioName")
		@Override
		public PortfolioReferenceBase.PortfolioReferenceBaseBuilder setPortfolioName(PortfolioName _portfolioName) {
