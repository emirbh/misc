...
import fpml.consolidated.business.events.validation.EventIdTypeFormatValidator;
import fpml.consolidated.business.events.validation.EventIdValidator;
import fpml.consolidated.business.events.validation.exists.EventIdOnlyExistsValidator;
...
public class EventIdMeta implements RosettaMetaData<EventId> {
	...
	@Override
	public Validator<? super EventId> validator(ValidatorFactory factory) {
		return factory.<EventId>create(EventIdValidator.class);
	}

	@Override
	public Validator<? super EventId> typeFormatValidator(ValidatorFactory factory) {
		return factory.<EventId>create(EventIdTypeFormatValidator.class);
	}
