...
import fpml.consolidated.com.meta.CommodityMetalBrandMeta;
 ...
 *
 */
@RosettaDataType(value="CommodityMetalBrand", builder=CommodityMetalBrand.CommodityMetalBrandBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityMetalBrand", model="fpml", builder=CommodityMetalBrand.CommodityMetalBrandBuilderImpl.class, version="2.1.1")
public interface CommodityMetalBrand extends RosettaModelObject {
	...
	class CommodityMetalBrandBuilderImpl implements CommodityMetalBrand.CommodityMetalBrandBuilder {
		...
		@RuneAttribute("name")
		@Override
		public CommodityMetalBrand.CommodityMetalBrandBuilder setName(CommodityMetalBrandName _name) {
		...
		@RuneAttribute("brandManager")
		@Override
		public CommodityMetalBrand.CommodityMetalBrandBuilder setBrandManager(CommodityMetalBrandManager _brandManager) {
			this.brandManager = _brandManager == null ? null : _brandManager.toBuilder();
			return this;
		}
		...
		@RuneAttribute("country")
		@Override
		public CommodityMetalBrand.CommodityMetalBrandBuilder setCountry(CountryCode _country) {
		...
		@RuneAttribute("producer")
		@Override
		public CommodityMetalBrand.CommodityMetalBrandBuilder setProducer(CommodityMetalProducer _producer) {
			this.producer = _producer == null ? null : _producer.toBuilder();
			return this;
		}
