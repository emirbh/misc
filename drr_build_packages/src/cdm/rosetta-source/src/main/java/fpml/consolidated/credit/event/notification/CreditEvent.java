...
import fpml.consolidated.credit.event.notification.meta.CreditEventMeta;
 ...
 *
 */
@RosettaDataType(value="CreditEvent", builder=CreditEvent.CreditEventBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CreditEvent", model="fpml", builder=CreditEvent.CreditEventBuilderImpl.class, version="2.1.1")
