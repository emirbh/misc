 ...
 * @version 2.1.1
 */
@RosettaDataRule("LoanBulkServicingNotificationSequenceChoice0")
@ImplementedBy(LoanBulkServicingNotificationSequenceChoice0.Default.class)
public interface LoanBulkServicingNotificationSequenceChoice0 extends Validator<LoanBulkServicingNotificationSequence> {
	
	String NAME = "LoanBulkServicingNotificationSequenceChoice0";
	String DEFINITION = "optional choice dealIdentifier, dealSummary";
	
	class Default implements LoanBulkServicingNotificationSequenceChoice0 {
		...
		private ComparisonResult executeDataRule(LoanBulkServicingNotificationSequence loanBulkServicingNotificationSequence) {
			try {
				return choice(MapperS.of(loanBulkServicingNotificationSequence), Arrays.asList("dealIdentifier", "dealSummary"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements LoanBulkServicingNotificationSequenceChoice0 {
