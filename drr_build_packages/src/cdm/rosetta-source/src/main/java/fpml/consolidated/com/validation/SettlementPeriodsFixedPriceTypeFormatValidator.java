		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("SettlementPeriodsFixedPrice", ValidationResult.ValidationType.TYPE_FORMAT, "SettlementPeriodsFixedPrice", path, "", res.getError());
				}
				return success("SettlementPeriodsFixedPrice", ValidationResult.ValidationType.TYPE_FORMAT, "SettlementPeriodsFixedPrice", path, "");
			})
			.collect(toList());
	}
