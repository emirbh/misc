...
import fpml.consolidated.ird.meta.CashPriceMethodMeta;
 ...
 *
 * Provision A type defining the parameters necessary for each of the ISDA cash price methods for cash settlement.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CashPriceMethod", builder=CashPriceMethod.CashPriceMethodBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CashPriceMethod", model="fpml", builder=CashPriceMethod.CashPriceMethodBuilderImpl.class, version="2.1.1")
public interface CashPriceMethod extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The currency in which the cash settlement amount will be calculated and settled.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class CashPriceMethodBuilderImpl implements CashPriceMethod.CashPriceMethodBuilder {
		...
		@RuneAttribute("cashSettlementReferenceBanks")
		@Override
		public CashPriceMethod.CashPriceMethodBuilder setCashSettlementReferenceBanks(CashSettlementReferenceBanks _cashSettlementReferenceBanks) {
		...
		@RuneAttribute("cashSettlementCurrency")
		@Override
		public CashPriceMethod.CashPriceMethodBuilder setCashSettlementCurrency(Currency _cashSettlementCurrency) {
		...
		@RuneAttribute("quotationRateType")
		@Override
		public CashPriceMethod.CashPriceMethodBuilder setQuotationRateType(QuotationRateTypeEnum _quotationRateType) {
