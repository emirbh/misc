...
import fpml.consolidated.com.meta.CommodityDeliveryRiskMeta;
 ...
 *
 * Provision A scheme identifying how the parties to the trade aportion responsibility for the delivery of the commodity product (for example Free On Board, Cost, Insurance, Freight)
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CommodityDeliveryRisk", builder=CommodityDeliveryRisk.CommodityDeliveryRiskBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityDeliveryRisk", model="fpml", builder=CommodityDeliveryRisk.CommodityDeliveryRiskBuilderImpl.class, version="2.1.1")
public interface CommodityDeliveryRisk extends RosettaModelObject {
	...
	class CommodityDeliveryRiskImpl implements CommodityDeliveryRisk {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("deliveryRiskScheme")
	...
	class CommodityDeliveryRiskBuilderImpl implements CommodityDeliveryRisk.CommodityDeliveryRiskBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CommodityDeliveryRisk.CommodityDeliveryRiskBuilder setValue(String _value) {
		...
		@RuneAttribute("deliveryRiskScheme")
		@Override
		public CommodityDeliveryRisk.CommodityDeliveryRiskBuilder setDeliveryRiskScheme(String _deliveryRiskScheme) {
			this.deliveryRiskScheme = _deliveryRiskScheme == null ? null : _deliveryRiskScheme;
			return this;
		}
