...
public class AbstractLoanAllocationNotificationValidator implements Validator<AbstractLoanAllocationNotification> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractLoanAllocationNotification", ValidationResult.ValidationType.CARDINALITY, "AbstractLoanAllocationNotification", path, "", res.getError());
				}
				return success("AbstractLoanAllocationNotification", ValidationResult.ValidationType.CARDINALITY, "AbstractLoanAllocationNotification", path, "");
			})
			.collect(toList());
	}
