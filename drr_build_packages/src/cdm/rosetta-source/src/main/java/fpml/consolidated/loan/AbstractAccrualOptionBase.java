 ...
 *
 */
@RosettaDataType(value="AbstractAccrualOptionBase", builder=AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilderImpl.class, version="2.1.1")
@RuneDataType(value="AbstractAccrualOptionBase", model="fpml", builder=AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilderImpl.class, version="2.1.1")
public interface AbstractAccrualOptionBase extends RosettaModelObject {

	AbstractAccrualOptionBaseMeta metaData = new AbstractAccrualOptionBaseMeta();
	...
	/*********************** Build Methods  ***********************/
	AbstractAccrualOptionBase build();
	
	AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder toBuilder();
	
	static AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder builder() {
		return new AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilderImpl();
	}

	/*********************** Utility Methods  ***********************/
	@Override
	default RosettaMetaData<? extends AbstractAccrualOptionBase> metaData() {
		return metaData;
	}
	
	@Override
	@RuneAttribute("@type")
	default Class<? extends AbstractAccrualOptionBase> getType() {
	...
	/*********************** Builder Interface  ***********************/
	interface AbstractAccrualOptionBaseBuilder extends AbstractAccrualOptionBase, RosettaModelObjectBuilder {
		...
		AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder setAccrualOptionId(AccrualTypeId accrualOptionId);
		AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder setDayCountFraction(DayCountFraction dayCountFraction);
		AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder setPaymentFrequency(Period paymentFrequency);
		...
		AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder prune();
	}

	/*********************** Immutable Implementation of AbstractAccrualOptionBase  ***********************/
	class AbstractAccrualOptionBaseImpl implements AbstractAccrualOptionBase {
		...
		protected AbstractAccrualOptionBaseImpl(AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder builder) {
		...
		@Override
		public AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder toBuilder() {
			AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder builder = builder();
			setBuilderFields(builder);
			return builder;
		}
		
		protected void setBuilderFields(AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder builder) {
		...
		public boolean equals(Object o) {
			...
			AbstractAccrualOptionBase _that = getType().cast(o);
		...
		public String toString() {
			return "AbstractAccrualOptionBase {" +
	...
	/*********************** Builder Implementation of AbstractAccrualOptionBase  ***********************/
	class AbstractAccrualOptionBaseBuilderImpl implements AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder {
		...
		@RuneAttribute("accrualOptionId")
		@Override
		public AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder setAccrualOptionId(AccrualTypeId _accrualOptionId) {
		...
		@RuneAttribute("dayCountFraction")
		@Override
		public AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder setDayCountFraction(DayCountFraction _dayCountFraction) {
		...
		@RuneAttribute("paymentFrequency")
		@Override
		public AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder setPaymentFrequency(Period _paymentFrequency) {
		...
		@Override
		public AbstractAccrualOptionBase build() {
			return new AbstractAccrualOptionBase.AbstractAccrualOptionBaseImpl(this);
		}
		...
		@Override
		public AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder prune() {
		...
		@SuppressWarnings("unchecked")
		@Override
		public AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder merge(RosettaModelObjectBuilder other, BuilderMerger merger) {
			AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder o = (AbstractAccrualOptionBase.AbstractAccrualOptionBaseBuilder) other;
		...
		@Override
		public String toString() {
			return "AbstractAccrualOptionBaseBuilder {" +
				"accrualOptionId=" + this.accrualOptionId + ", " +
				"dayCountFraction=" + this.dayCountFraction + ", " +
				"paymentFrequency=" + this.paymentFrequency +
			'}';
