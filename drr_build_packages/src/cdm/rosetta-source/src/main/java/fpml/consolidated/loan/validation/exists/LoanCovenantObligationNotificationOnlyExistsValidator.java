...
public class LoanCovenantObligationNotificationOnlyExistsValidator implements ValidatorWithArg<LoanCovenantObligationNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanCovenantObligationNotification> ValidationResult<LoanCovenantObligationNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("covenantTask", ExistenceChecker.isSet((List<? extends LoanCovenantObligationTask>) o.getCovenantTask()))
				.put("loanCovenantObligationNotificationChoice0", ExistenceChecker.isSet((List<? extends LoanCovenantObligationNotificationChoice0>) o.getLoanCovenantObligationNotificationChoice0()))
				.put("loanCovenantObligationNotificationChoice1", ExistenceChecker.isSet((List<? extends LoanCovenantObligationNotificationChoice1>) o.getLoanCovenantObligationNotificationChoice1()))
				.put("loanCovenantObligationNotificationChoice2", ExistenceChecker.isSet((List<? extends LoanCovenantObligationNotificationChoice2>) o.getLoanCovenantObligationNotificationChoice2()))
		...
		if (setFields.equals(fields)) {
			return success("LoanCovenantObligationNotification", ValidationResult.ValidationType.ONLY_EXISTS, "LoanCovenantObligationNotification", path, "");
		}
		return failure("LoanCovenantObligationNotification", ValidationResult.ValidationType.ONLY_EXISTS, "LoanCovenantObligationNotification", path, "",
