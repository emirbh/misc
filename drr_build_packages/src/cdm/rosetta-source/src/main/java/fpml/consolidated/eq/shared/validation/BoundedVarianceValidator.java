...
public class BoundedVarianceValidator implements Validator<BoundedVariance> {
	...
	private List<ComparisonResult> getComparisonResults(BoundedVariance o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("realisedVarianceMethod", (RealisedVarianceMethodEnum) o.getRealisedVarianceMethod() != null ? 1 : 0, 0, 1), 
				checkCardinality("daysInRangeAdjustment", (Boolean) o.getDaysInRangeAdjustment() != null ? 1 : 0, 0, 1), 
