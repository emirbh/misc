...
public class UnderlyingAssetOnlyExistsValidator implements ValidatorWithArg<UnderlyingAsset, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends UnderlyingAsset> ValidationResult<UnderlyingAsset> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("UnderlyingAsset", ValidationResult.ValidationType.ONLY_EXISTS, "UnderlyingAsset", path, "");
		}
		return failure("UnderlyingAsset", ValidationResult.ValidationType.ONLY_EXISTS, "UnderlyingAsset", path, "",
