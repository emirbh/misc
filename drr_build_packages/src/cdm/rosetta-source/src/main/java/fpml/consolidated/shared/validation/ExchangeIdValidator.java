		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ExchangeId", ValidationResult.ValidationType.CARDINALITY, "ExchangeId", path, "", res.getError());
				}
				return success("ExchangeId", ValidationResult.ValidationType.CARDINALITY, "ExchangeId", path, "");
			})
			.collect(toList());
	}
