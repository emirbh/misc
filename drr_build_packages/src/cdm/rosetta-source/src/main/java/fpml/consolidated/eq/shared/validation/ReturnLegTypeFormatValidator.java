		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ReturnLeg", ValidationResult.ValidationType.TYPE_FORMAT, "ReturnLeg", path, "", res.getError());
				}
				return success("ReturnLeg", ValidationResult.ValidationType.TYPE_FORMAT, "ReturnLeg", path, "");
			})
			.collect(toList());
	}
