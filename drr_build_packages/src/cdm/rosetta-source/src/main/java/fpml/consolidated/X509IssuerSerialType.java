...
import fpml.consolidated.meta.X509IssuerSerialTypeMeta;
 ...
 *
 */
@RosettaDataType(value="X509IssuerSerialType", builder=X509IssuerSerialType.X509IssuerSerialTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="X509IssuerSerialType", model="fpml", builder=X509IssuerSerialType.X509IssuerSerialTypeBuilderImpl.class, version="2.1.1")
public interface X509IssuerSerialType extends RosettaModelObject {
	...
	class X509IssuerSerialTypeImpl implements X509IssuerSerialType {
		...
		@Accessor(AccessorType.GETTER)
		@Required
		@RuneAttribute("x509SerialNumber")
	...
	class X509IssuerSerialTypeBuilderImpl implements X509IssuerSerialType.X509IssuerSerialTypeBuilder {
		...
		@RuneAttribute("x509IssuerName")
		@Override
		public X509IssuerSerialType.X509IssuerSerialTypeBuilder setX509IssuerName(String _x509IssuerName) {
			this.x509IssuerName = _x509IssuerName == null ? null : _x509IssuerName;
			return this;
		}
		...
		@RuneAttribute("x509SerialNumber")
		@Override
		public X509IssuerSerialType.X509IssuerSerialTypeBuilder setX509SerialNumber(Integer _x509SerialNumber) {
			this.x509SerialNumber = _x509SerialNumber == null ? null : _x509SerialNumber;
			return this;
		}
