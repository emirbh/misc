...
public class ClearingConfirmedOnlyExistsValidator implements ValidatorWithArg<ClearingConfirmed, Set<String>> {
	...
	public <T2 extends ClearingConfirmed> ValidationResult<ClearingConfirmed> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("compressionActivity", ExistenceChecker.isSet((CompressionActivity) o.getCompressionActivity()))
		...
		if (setFields.equals(fields)) {
			return success("ClearingConfirmed", ValidationResult.ValidationType.ONLY_EXISTS, "ClearingConfirmed", path, "");
		}
		return failure("ClearingConfirmed", ValidationResult.ValidationType.ONLY_EXISTS, "ClearingConfirmed", path, "",
