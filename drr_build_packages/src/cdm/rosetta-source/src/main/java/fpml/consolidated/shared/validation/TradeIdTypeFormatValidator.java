		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeId", ValidationResult.ValidationType.TYPE_FORMAT, "TradeId", path, "", res.getError());
				}
				return success("TradeId", ValidationResult.ValidationType.TYPE_FORMAT, "TradeId", path, "");
			})
			.collect(toList());
	}
