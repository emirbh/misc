...
import fpml.consolidated.fx.meta.PriceSourceDisruptionMeta;
 ...
 *
 * Provision If present indicates that the event is considered to have occurred if it is impossible to obtain information about the Spot Rate for a Valuation Date from the price source specified in the Settlement Rate Option that hass been agreed by the parties.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="PriceSourceDisruption", builder=PriceSourceDisruption.PriceSourceDisruptionBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PriceSourceDisruption", model="fpml", builder=PriceSourceDisruption.PriceSourceDisruptionBuilderImpl.class, version="2.1.1")
