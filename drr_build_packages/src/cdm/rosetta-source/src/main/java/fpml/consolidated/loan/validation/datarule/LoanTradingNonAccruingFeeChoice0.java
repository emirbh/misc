 ...
 * @version 2.1.1
 */
@RosettaDataRule("LoanTradingNonAccruingFeeChoice0")
@ImplementedBy(LoanTradingNonAccruingFeeChoice0.Default.class)
public interface LoanTradingNonAccruingFeeChoice0 extends Validator<LoanTradingNonAccruingFee> {
	
	String NAME = "LoanTradingNonAccruingFeeChoice0";
	String DEFINITION = "optional choice nonAccruingFeetype, miscFeeType";
	
	class Default implements LoanTradingNonAccruingFeeChoice0 {
		...
		private ComparisonResult executeDataRule(LoanTradingNonAccruingFee loanTradingNonAccruingFee) {
			try {
				return choice(MapperS.of(loanTradingNonAccruingFee), Arrays.asList("nonAccruingFeetype", "miscFeeType"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements LoanTradingNonAccruingFeeChoice0 {
