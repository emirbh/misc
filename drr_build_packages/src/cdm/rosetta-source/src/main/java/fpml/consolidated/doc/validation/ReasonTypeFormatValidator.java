		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("Reason", ValidationResult.ValidationType.TYPE_FORMAT, "Reason", path, "", res.getError());
				}
				return success("Reason", ValidationResult.ValidationType.TYPE_FORMAT, "Reason", path, "");
			})
			.collect(toList());
	}
