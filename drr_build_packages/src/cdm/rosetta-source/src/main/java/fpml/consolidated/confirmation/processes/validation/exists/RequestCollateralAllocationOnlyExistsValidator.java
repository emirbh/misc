...
import fpml.consolidated.confirmation.processes.RequestCollateralAllocation;
...
public class RequestCollateralAllocationOnlyExistsValidator implements ValidatorWithArg<RequestCollateralAllocation, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RequestCollateralAllocation> ValidationResult<RequestCollateralAllocation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("requestedAction", ExistenceChecker.isSet((RequestedCollateralAllocationAction) o.getRequestedAction()))
				.put("collateralGiverPartyReference", ExistenceChecker.isSet((PartyReference) o.getCollateralGiverPartyReference()))
				.put("collateralAllocation", ExistenceChecker.isSet((List<? extends ProposedCollateralAllocation>) o.getCollateralAllocation()))
		...
		if (setFields.equals(fields)) {
			return success("RequestCollateralAllocation", ValidationResult.ValidationType.ONLY_EXISTS, "RequestCollateralAllocation", path, "");
		}
		return failure("RequestCollateralAllocation", ValidationResult.ValidationType.ONLY_EXISTS, "RequestCollateralAllocation", path, "",
