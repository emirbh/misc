		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CreditEventNotification", ValidationResult.ValidationType.CARDINALITY, "CreditEventNotification", path, "", res.getError());
				}
				return success("CreditEventNotification", ValidationResult.ValidationType.CARDINALITY, "CreditEventNotification", path, "");
			})
			.collect(toList());
	}
