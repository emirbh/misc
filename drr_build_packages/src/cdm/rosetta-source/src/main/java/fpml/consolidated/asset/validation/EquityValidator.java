		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("Equity", ValidationResult.ValidationType.CARDINALITY, "Equity", path, "", res.getError());
				}
				return success("Equity", ValidationResult.ValidationType.CARDINALITY, "Equity", path, "");
			})
			.collect(toList());
	}
