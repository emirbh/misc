...
import fpml.consolidated.fx.meta.ExchangeRestrictionsMeta;
 ...
 *
 * Provision If present indicates that the event is considered to have occured if the settlement in either currency is prohibited or materially restricted.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ExchangeRestrictions", builder=ExchangeRestrictions.ExchangeRestrictionsBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ExchangeRestrictions", model="fpml", builder=ExchangeRestrictions.ExchangeRestrictionsBuilderImpl.class, version="2.1.1")
