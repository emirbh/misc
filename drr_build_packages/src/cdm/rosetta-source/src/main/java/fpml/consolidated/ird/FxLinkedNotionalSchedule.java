...
import fpml.consolidated.ird.meta.FxLinkedNotionalScheduleMeta;
 ...
 *
 */
@RosettaDataType(value="FxLinkedNotionalSchedule", builder=FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxLinkedNotionalSchedule", model="fpml", builder=FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilderImpl.class, version="2.1.1")
public interface FxLinkedNotionalSchedule extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A pointer style reference to the associated constant notional schedule defined elsewhere in the document which contains the currency amounts which will be converted into the varying notional currency amounts using the spot currency exchange rate.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The initial currency amount for the varying notional. This may be omitted for a forward starting swap if the FX-linked notional value is not known at deal inception.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The currency of the varying notional amount, i.e. the notional amount being determined periodically based on observation of a spot currency exchange rate.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The dates on which spot currency exchange rates are observed for purposes of determining the varying notional currency amount that will apply to a calculation period.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The information source and time at which the spot currency exchange rate will be observed.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The dates on which interim exchanges of notional are paid. Interim exchanges will arise as a result of changes in the spot currency exchange amount or changes in the constant notional schedule (e.g. amortization).
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class FxLinkedNotionalScheduleImpl implements FxLinkedNotionalSchedule {
		...
		@RuneAttribute("constantNotionalScheduleReference")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("varyingNotionalCurrency")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("varyingNotionalFixingDates")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("varyingNotionalInterimExchangePaymentDates")
	...
	class FxLinkedNotionalScheduleBuilderImpl implements FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilder {
		...
		@RuneAttribute("constantNotionalScheduleReference")
		@Override
		public FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilder setConstantNotionalScheduleReference(NotionalReference _constantNotionalScheduleReference) {
			this.constantNotionalScheduleReference = _constantNotionalScheduleReference == null ? null : _constantNotionalScheduleReference.toBuilder();
			return this;
		}
		...
		@RuneAttribute("initialValue")
		@Override
		public FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilder setInitialValue(BigDecimal _initialValue) {
		...
		@RuneAttribute("varyingNotionalCurrency")
		@Override
		public FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilder setVaryingNotionalCurrency(Currency _varyingNotionalCurrency) {
			this.varyingNotionalCurrency = _varyingNotionalCurrency == null ? null : _varyingNotionalCurrency.toBuilder();
			return this;
		}
		...
		@RuneAttribute("varyingNotionalFixingDates")
		@Override
		public FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilder setVaryingNotionalFixingDates(RelativeDateOffset _varyingNotionalFixingDates) {
			this.varyingNotionalFixingDates = _varyingNotionalFixingDates == null ? null : _varyingNotionalFixingDates.toBuilder();
			return this;
		}
		...
		@RuneAttribute("fxSpotRateSource")
		@Override
		public FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilder setFxSpotRateSource(FxSpotRateSource _fxSpotRateSource) {
		...
		@RuneAttribute("varyingNotionalInterimExchangePaymentDates")
		@Override
		public FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilder setVaryingNotionalInterimExchangePaymentDates(RelativeDateOffset _varyingNotionalInterimExchangePaymentDates) {
			this.varyingNotionalInterimExchangePaymentDates = _varyingNotionalInterimExchangePaymentDates == null ? null : _varyingNotionalInterimExchangePaymentDates.toBuilder();
			return this;
		}
