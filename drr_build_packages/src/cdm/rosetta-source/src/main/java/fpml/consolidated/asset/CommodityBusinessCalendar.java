...
import fpml.consolidated.asset.meta.CommodityBusinessCalendarMeta;
 ...
 *
 * Provision Defines a commodity business day calendar.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CommodityBusinessCalendar", builder=CommodityBusinessCalendar.CommodityBusinessCalendarBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityBusinessCalendar", model="fpml", builder=CommodityBusinessCalendar.CommodityBusinessCalendarBuilderImpl.class, version="2.1.1")
public interface CommodityBusinessCalendar extends RosettaModelObject {
	...
	class CommodityBusinessCalendarImpl implements CommodityBusinessCalendar {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("commodityBusinessCalendarScheme")
	...
	class CommodityBusinessCalendarBuilderImpl implements CommodityBusinessCalendar.CommodityBusinessCalendarBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CommodityBusinessCalendar.CommodityBusinessCalendarBuilder setValue(String _value) {
		...
		@RuneAttribute("commodityBusinessCalendarScheme")
		@Override
		public CommodityBusinessCalendar.CommodityBusinessCalendarBuilder setCommodityBusinessCalendarScheme(String _commodityBusinessCalendarScheme) {
			this.commodityBusinessCalendarScheme = _commodityBusinessCalendarScheme == null ? null : _commodityBusinessCalendarScheme;
			return this;
		}
