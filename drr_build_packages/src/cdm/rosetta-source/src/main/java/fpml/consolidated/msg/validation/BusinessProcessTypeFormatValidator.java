		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("BusinessProcess", ValidationResult.ValidationType.TYPE_FORMAT, "BusinessProcess", path, "", res.getError());
				}
				return success("BusinessProcess", ValidationResult.ValidationType.TYPE_FORMAT, "BusinessProcess", path, "");
			})
			.collect(toList());
	}
