 ...
 *
 */
@RosettaDataType(value="FxTriggerBase", builder=FxTriggerBase.FxTriggerBaseBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxTriggerBase", model="fpml", builder=FxTriggerBase.FxTriggerBaseBuilderImpl.class, version="2.1.1")
public interface FxTriggerBase extends RosettaModelObject {
	...
	class FxTriggerBaseBuilderImpl implements FxTriggerBase.FxTriggerBaseBuilder {
		...
		@RuneAttribute("triggerCondition")
		@Override
		public FxTriggerBase.FxTriggerBaseBuilder setTriggerCondition(TriggerConditionEnum _triggerCondition) {
		...
		@RuneAttribute("quotedCurrencyPair")
		@Override
		public FxTriggerBase.FxTriggerBaseBuilder setQuotedCurrencyPair(QuotedCurrencyPair _quotedCurrencyPair) {
		...
		@RuneAttribute("triggerRate")
		@Override
		public FxTriggerBase.FxTriggerBaseBuilder setTriggerRate(BigDecimal _triggerRate) {
		...
		@RuneAttribute("spotRate")
		@Override
		public FxTriggerBase.FxTriggerBaseBuilder setSpotRate(BigDecimal _spotRate) {
