...
import fpml.consolidated.com.meta.CommodityExercisePeriodsMeta;
 ...
 *
 */
@RosettaDataType(value="CommodityExercisePeriods", builder=CommodityExercisePeriods.CommodityExercisePeriodsBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityExercisePeriods", model="fpml", builder=CommodityExercisePeriods.CommodityExercisePeriodsBuilderImpl.class, version="2.1.1")
public interface CommodityExercisePeriods extends RosettaModelObject {
	...
	class CommodityExercisePeriodsBuilderImpl implements CommodityExercisePeriods.CommodityExercisePeriodsBuilder {
		...
		@RuneAttribute("commencementDate")
		@Override
		public CommodityExercisePeriods.CommodityExercisePeriodsBuilder setCommencementDate(AdjustableOrRelativeDate _commencementDate) {
		...
		@RuneAttribute("expirationDate")
		@Override
		public CommodityExercisePeriods.CommodityExercisePeriodsBuilder setExpirationDate(AdjustableOrRelativeDate _expirationDate) {
