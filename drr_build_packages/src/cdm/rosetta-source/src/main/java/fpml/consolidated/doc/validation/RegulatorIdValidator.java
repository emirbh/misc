		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RegulatorId", ValidationResult.ValidationType.CARDINALITY, "RegulatorId", path, "", res.getError());
				}
				return success("RegulatorId", ValidationResult.ValidationType.CARDINALITY, "RegulatorId", path, "");
			})
			.collect(toList());
	}
