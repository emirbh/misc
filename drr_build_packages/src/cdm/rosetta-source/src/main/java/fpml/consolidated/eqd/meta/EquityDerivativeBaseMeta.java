...
import fpml.consolidated.eqd.validation.EquityDerivativeBaseTypeFormatValidator;
import fpml.consolidated.eqd.validation.EquityDerivativeBaseValidator;
import fpml.consolidated.eqd.validation.exists.EquityDerivativeBaseOnlyExistsValidator;
...
public class EquityDerivativeBaseMeta implements RosettaMetaData<EquityDerivativeBase> {
	...
	@Override
	public Validator<? super EquityDerivativeBase> validator(ValidatorFactory factory) {
		return factory.<EquityDerivativeBase>create(EquityDerivativeBaseValidator.class);
	}

	@Override
	public Validator<? super EquityDerivativeBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<EquityDerivativeBase>create(EquityDerivativeBaseTypeFormatValidator.class);
	}
