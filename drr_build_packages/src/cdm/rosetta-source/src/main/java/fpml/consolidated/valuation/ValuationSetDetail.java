...
import fpml.consolidated.valuation.meta.ValuationSetDetailMeta;
 ...
 *
 * Provision The amount of detail provided in the valuation set, e.g. is market environment data provided, are risk definitions provided, etc.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ValuationSetDetail", builder=ValuationSetDetail.ValuationSetDetailBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ValuationSetDetail", model="fpml", builder=ValuationSetDetail.ValuationSetDetailBuilderImpl.class, version="2.1.1")
public interface ValuationSetDetail extends RosettaModelObject {
	...
	class ValuationSetDetailImpl implements ValuationSetDetail {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("valuationSetDetailScheme")
	...
	class ValuationSetDetailBuilderImpl implements ValuationSetDetail.ValuationSetDetailBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ValuationSetDetail.ValuationSetDetailBuilder setValue(String _value) {
		...
		@RuneAttribute("valuationSetDetailScheme")
		@Override
		public ValuationSetDetail.ValuationSetDetailBuilder setValuationSetDetailScheme(String _valuationSetDetailScheme) {
			this.valuationSetDetailScheme = _valuationSetDetailScheme == null ? null : _valuationSetDetailScheme;
			return this;
		}
