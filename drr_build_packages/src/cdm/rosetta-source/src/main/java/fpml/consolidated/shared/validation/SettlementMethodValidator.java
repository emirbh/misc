		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("SettlementMethod", ValidationResult.ValidationType.CARDINALITY, "SettlementMethod", path, "", res.getError());
				}
				return success("SettlementMethod", ValidationResult.ValidationType.CARDINALITY, "SettlementMethod", path, "");
			})
			.collect(toList());
	}
