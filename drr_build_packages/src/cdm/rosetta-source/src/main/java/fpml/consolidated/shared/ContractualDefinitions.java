...
import fpml.consolidated.shared.meta.ContractualDefinitionsMeta;
 ...
 *
 */
@RosettaDataType(value="ContractualDefinitions", builder=ContractualDefinitions.ContractualDefinitionsBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ContractualDefinitions", model="fpml", builder=ContractualDefinitions.ContractualDefinitionsBuilderImpl.class, version="2.1.1")
public interface ContractualDefinitions extends RosettaModelObject {
	...
	class ContractualDefinitionsImpl implements ContractualDefinitions {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("contractualDefinitionsScheme")
	...
	class ContractualDefinitionsBuilderImpl implements ContractualDefinitions.ContractualDefinitionsBuilder {
		...
		@RuneAttribute("value")
		@Override
		public ContractualDefinitions.ContractualDefinitionsBuilder setValue(String _value) {
		...
		@RuneAttribute("contractualDefinitionsScheme")
		@Override
		public ContractualDefinitions.ContractualDefinitionsBuilder setContractualDefinitionsScheme(String _contractualDefinitionsScheme) {
			this.contractualDefinitionsScheme = _contractualDefinitionsScheme == null ? null : _contractualDefinitionsScheme;
			return this;
		}
