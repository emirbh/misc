...
import fpml.consolidated.cd.meta.ReferenceObligationChoiceMeta;
 ...
 *
 */
@RosettaDataType(value="ReferenceObligationChoice", builder=ReferenceObligationChoice.ReferenceObligationChoiceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ReferenceObligationChoice", model="fpml", builder=ReferenceObligationChoice.ReferenceObligationChoiceBuilderImpl.class, version="2.1.1")
public interface ReferenceObligationChoice extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The party that guarantees by way of a contractual arrangement to pay the debts of an obligor if the obligor is unable to make the required payments itself. ISDA 2003 Term: Guarantor
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A pointer style reference to a reference entity defined elsewhere in the document. Used when the reference entity is the guarantor.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class ReferenceObligationChoiceBuilderImpl implements ReferenceObligationChoice.ReferenceObligationChoiceBuilder {
		...
		@RuneAttribute("guarantor")
		@Override
		public ReferenceObligationChoice.ReferenceObligationChoiceBuilder setGuarantor(LegalEntity _guarantor) {
		...
		@RuneAttribute("guarantorReference")
		@Override
		public ReferenceObligationChoice.ReferenceObligationChoiceBuilder setGuarantorReference(LegalEntityReference _guarantorReference) {
			this.guarantorReference = _guarantorReference == null ? null : _guarantorReference.toBuilder();
			return this;
		}
