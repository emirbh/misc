...
public class IndexOnlyExistsValidator implements ValidatorWithArg<Index, Set<String>> {
	...
	public <T2 extends Index> ValidationResult<Index> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("futureId", ExistenceChecker.isSet((FutureId) o.getFutureId()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Index", ValidationResult.ValidationType.ONLY_EXISTS, "Index", path, "");
		}
		return failure("Index", ValidationResult.ValidationType.ONLY_EXISTS, "Index", path, "",
