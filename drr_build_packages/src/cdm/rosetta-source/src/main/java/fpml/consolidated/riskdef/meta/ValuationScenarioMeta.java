...
import fpml.consolidated.riskdef.validation.ValuationScenarioTypeFormatValidator;
import fpml.consolidated.riskdef.validation.ValuationScenarioValidator;
import fpml.consolidated.riskdef.validation.exists.ValuationScenarioOnlyExistsValidator;
...
public class ValuationScenarioMeta implements RosettaMetaData<ValuationScenario> {
	...
	@Override
	public Validator<? super ValuationScenario> validator(ValidatorFactory factory) {
		return factory.<ValuationScenario>create(ValuationScenarioValidator.class);
	}

	@Override
	public Validator<? super ValuationScenario> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ValuationScenario>create(ValuationScenarioTypeFormatValidator.class);
	}
