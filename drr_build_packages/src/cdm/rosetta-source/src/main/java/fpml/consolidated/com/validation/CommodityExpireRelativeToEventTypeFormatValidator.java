		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityExpireRelativeToEvent", ValidationResult.ValidationType.TYPE_FORMAT, "CommodityExpireRelativeToEvent", path, "", res.getError());
				}
				return success("CommodityExpireRelativeToEvent", ValidationResult.ValidationType.TYPE_FORMAT, "CommodityExpireRelativeToEvent", path, "");
			})
			.collect(toList());
	}
