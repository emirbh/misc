...
public class SettlementRateOptionOnlyExistsValidator implements ValidatorWithArg<SettlementRateOption, Set<String>> {
	...
	public <T2 extends SettlementRateOption> ValidationResult<SettlementRateOption> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("settlementRateOptionScheme", ExistenceChecker.isSet((String) o.getSettlementRateOptionScheme()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("SettlementRateOption", ValidationResult.ValidationType.ONLY_EXISTS, "SettlementRateOption", path, "");
		}
		return failure("SettlementRateOption", ValidationResult.ValidationType.ONLY_EXISTS, "SettlementRateOption", path, "",
