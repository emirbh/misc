...
public class AccruingFeePaymentValidator implements Validator<AccruingFeePayment> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AccruingFeePayment", ValidationResult.ValidationType.CARDINALITY, "AccruingFeePayment", path, "", res.getError());
				}
				return success("AccruingFeePayment", ValidationResult.ValidationType.CARDINALITY, "AccruingFeePayment", path, "");
			})
			.collect(toList());
	}
