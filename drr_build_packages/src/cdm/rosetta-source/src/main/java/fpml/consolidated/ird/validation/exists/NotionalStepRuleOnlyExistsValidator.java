...
public class NotionalStepRuleOnlyExistsValidator implements ValidatorWithArg<NotionalStepRule, Set<String>> {
	...
	public <T2 extends NotionalStepRule> ValidationResult<NotionalStepRule> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("firstNotionalStepDate", ExistenceChecker.isSet((ZonedDateTime) o.getFirstNotionalStepDate()))
				.put("lastNotionalStepDate", ExistenceChecker.isSet((ZonedDateTime) o.getLastNotionalStepDate()))
		...
		if (setFields.equals(fields)) {
			return success("NotionalStepRule", ValidationResult.ValidationType.ONLY_EXISTS, "NotionalStepRule", path, "");
		}
		return failure("NotionalStepRule", ValidationResult.ValidationType.ONLY_EXISTS, "NotionalStepRule", path, "",
