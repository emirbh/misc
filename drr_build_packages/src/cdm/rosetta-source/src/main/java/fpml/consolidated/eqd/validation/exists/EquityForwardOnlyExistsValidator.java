...
public class EquityForwardOnlyExistsValidator implements ValidatorWithArg<EquityForward, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends EquityForward> ValidationResult<EquityForward> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("EquityForward", ValidationResult.ValidationType.ONLY_EXISTS, "EquityForward", path, "");
		}
		return failure("EquityForward", ValidationResult.ValidationType.ONLY_EXISTS, "EquityForward", path, "",
