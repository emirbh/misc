...
import fpml.consolidated.shared.meta.AccountReferenceMeta;
 ...
 *
 */
@RosettaDataType(value="AccountReference", builder=AccountReference.AccountReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="AccountReference", model="fpml", builder=AccountReference.AccountReferenceBuilderImpl.class, version="2.1.1")
public interface AccountReference extends Reference {
	...
	class AccountReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements AccountReference.AccountReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public AccountReference.AccountReferenceBuilder setHref(String _href) {
