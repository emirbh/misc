...
import fpml.consolidated.shared.meta.RateSourcePageMeta;
 ...
 *
 */
@RosettaDataType(value="RateSourcePage", builder=RateSourcePage.RateSourcePageBuilderImpl.class, version="2.1.1")
@RuneDataType(value="RateSourcePage", model="fpml", builder=RateSourcePage.RateSourcePageBuilderImpl.class, version="2.1.1")
public interface RateSourcePage extends RosettaModelObject {
	...
	class RateSourcePageImpl implements RateSourcePage {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("rateSourcePageScheme")
	...
	class RateSourcePageBuilderImpl implements RateSourcePage.RateSourcePageBuilder {
		...
		@RuneAttribute("value")
		@Override
		public RateSourcePage.RateSourcePageBuilder setValue(String _value) {
		...
		@RuneAttribute("rateSourcePageScheme")
		@Override
		public RateSourcePage.RateSourcePageBuilder setRateSourcePageScheme(String _rateSourcePageScheme) {
			this.rateSourcePageScheme = _rateSourcePageScheme == null ? null : _rateSourcePageScheme;
			return this;
		}
