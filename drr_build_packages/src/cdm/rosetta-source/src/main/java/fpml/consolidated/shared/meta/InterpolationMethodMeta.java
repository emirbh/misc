...
import fpml.consolidated.shared.validation.InterpolationMethodTypeFormatValidator;
import fpml.consolidated.shared.validation.InterpolationMethodValidator;
import fpml.consolidated.shared.validation.exists.InterpolationMethodOnlyExistsValidator;
...
public class InterpolationMethodMeta implements RosettaMetaData<InterpolationMethod> {
	...
	@Override
	public Validator<? super InterpolationMethod> validator(ValidatorFactory factory) {
		return factory.<InterpolationMethod>create(InterpolationMethodValidator.class);
	}

	@Override
	public Validator<? super InterpolationMethod> typeFormatValidator(ValidatorFactory factory) {
		return factory.<InterpolationMethod>create(InterpolationMethodTypeFormatValidator.class);
	}
