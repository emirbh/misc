...
import fpml.consolidated.cd.meta.FloatingAmountProvisionsMeta;
 ...
 *
 */
@RosettaDataType(value="FloatingAmountProvisions", builder=FloatingAmountProvisions.FloatingAmountProvisionsBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FloatingAmountProvisions", model="fpml", builder=FloatingAmountProvisions.FloatingAmountProvisionsBuilderImpl.class, version="2.1.1")
public interface FloatingAmountProvisions extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision As specified by the ISDA Standard Terms Supplement for use with trades on mortgage-backed securities. The presence of the element with value set to 'true' signifies that the provision is applicable. If applicable, the applicable step-up terms are specified as part of that ISDA Standard Terms Supplement. From a usage standpoint, this provision is typically applicable in the case of RMBS and not applicable in case of CMBS trades.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class FloatingAmountProvisionsImpl implements FloatingAmountProvisions {
		...
		@RuneAttribute("wacCapInterestProvision")
	...
	class FloatingAmountProvisionsBuilderImpl implements FloatingAmountProvisions.FloatingAmountProvisionsBuilder {
		...
		@RuneAttribute("wacCapInterestProvision")
		@Override
		public FloatingAmountProvisions.FloatingAmountProvisionsBuilder setWacCapInterestProvision(Boolean _wacCapInterestProvision) {
			this.wacCapInterestProvision = _wacCapInterestProvision == null ? null : _wacCapInterestProvision;
			return this;
		}
		...
		@RuneAttribute("stepUpProvision")
		@Override
		public FloatingAmountProvisions.FloatingAmountProvisionsBuilder setStepUpProvision(Boolean _stepUpProvision) {
			this.stepUpProvision = _stepUpProvision == null ? null : _stepUpProvision;
			return this;
		}
