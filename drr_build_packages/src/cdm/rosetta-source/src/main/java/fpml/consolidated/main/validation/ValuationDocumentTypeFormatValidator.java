...
public class ValuationDocumentTypeFormatValidator implements Validator<ValuationDocument> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ValuationDocument", ValidationResult.ValidationType.TYPE_FORMAT, "ValuationDocument", path, "", res.getError());
				}
				return success("ValuationDocument", ValidationResult.ValidationType.TYPE_FORMAT, "ValuationDocument", path, "");
			})
			.collect(toList());
	}
