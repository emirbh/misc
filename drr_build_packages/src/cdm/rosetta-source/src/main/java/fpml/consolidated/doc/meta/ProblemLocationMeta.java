...
import fpml.consolidated.doc.validation.ProblemLocationTypeFormatValidator;
import fpml.consolidated.doc.validation.ProblemLocationValidator;
import fpml.consolidated.doc.validation.exists.ProblemLocationOnlyExistsValidator;
...
public class ProblemLocationMeta implements RosettaMetaData<ProblemLocation> {
	...
	@Override
	public Validator<? super ProblemLocation> validator(ValidatorFactory factory) {
		return factory.<ProblemLocation>create(ProblemLocationValidator.class);
	}

	@Override
	public Validator<? super ProblemLocation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ProblemLocation>create(ProblemLocationTypeFormatValidator.class);
	}
