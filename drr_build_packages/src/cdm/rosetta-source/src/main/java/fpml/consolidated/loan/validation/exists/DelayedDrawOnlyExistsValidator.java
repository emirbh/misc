...
public class DelayedDrawOnlyExistsValidator implements ValidatorWithArg<DelayedDraw, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends DelayedDraw> ValidationResult<DelayedDraw> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("delayedDraw", ExistenceChecker.isSet((Boolean) o.getDelayedDraw()))
				.put("mustDrawByDate", ExistenceChecker.isSet((ZonedDateTime) o.getMustDrawByDate()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("DelayedDraw", ValidationResult.ValidationType.ONLY_EXISTS, "DelayedDraw", path, "");
		}
		return failure("DelayedDraw", ValidationResult.ValidationType.ONLY_EXISTS, "DelayedDraw", path, "",
