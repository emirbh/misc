		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RateReference", ValidationResult.ValidationType.CARDINALITY, "RateReference", path, "", res.getError());
				}
				return success("RateReference", ValidationResult.ValidationType.CARDINALITY, "RateReference", path, "");
			})
			.collect(toList());
	}
