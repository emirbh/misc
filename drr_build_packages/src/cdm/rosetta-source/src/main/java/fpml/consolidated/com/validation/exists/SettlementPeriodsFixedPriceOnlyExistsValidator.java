...
public class SettlementPeriodsFixedPriceOnlyExistsValidator implements ValidatorWithArg<SettlementPeriodsFixedPrice, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends SettlementPeriodsFixedPrice> ValidationResult<SettlementPeriodsFixedPrice> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("SettlementPeriodsFixedPrice", ValidationResult.ValidationType.ONLY_EXISTS, "SettlementPeriodsFixedPrice", path, "");
		}
		return failure("SettlementPeriodsFixedPrice", ValidationResult.ValidationType.ONLY_EXISTS, "SettlementPeriodsFixedPrice", path, "",
