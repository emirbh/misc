...
public class LoanAllocationFeeOwedOnlyExistsValidator implements ValidatorWithArg<LoanAllocationFeeOwed, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationFeeOwed> ValidationResult<LoanAllocationFeeOwed> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationFeeOwed", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationFeeOwed", path, "");
		}
		return failure("LoanAllocationFeeOwed", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationFeeOwed", path, "",
