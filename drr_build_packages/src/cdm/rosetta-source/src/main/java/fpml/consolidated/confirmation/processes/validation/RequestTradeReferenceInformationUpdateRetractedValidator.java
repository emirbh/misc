		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RequestTradeReferenceInformationUpdateRetracted", ValidationResult.ValidationType.CARDINALITY, "RequestTradeReferenceInformationUpdateRetracted", path, "", res.getError());
				}
				return success("RequestTradeReferenceInformationUpdateRetracted", ValidationResult.ValidationType.CARDINALITY, "RequestTradeReferenceInformationUpdateRetracted", path, "");
			})
			.collect(toList());
	}
