...
public class LoanLegalActionNotificationOnlyExistsValidator implements ValidatorWithArg<LoanLegalActionNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanLegalActionNotification> ValidationResult<LoanLegalActionNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("loanLegalActionNotificationChoice0", ExistenceChecker.isSet((List<? extends LoanLegalActionNotificationChoice0>) o.getLoanLegalActionNotificationChoice0()))
				.put("legalActionIdentifier", ExistenceChecker.isSet((LegalActionIdentifier) o.getLegalActionIdentifier()))
				.put("legalActionSummary", ExistenceChecker.isSet((LoanLegalActionSummary) o.getLegalActionSummary()))
				.put("legalAction", ExistenceChecker.isSet((LoanLegalAction) o.getLegalAction()))
				.put("loanLegalActionNotificationChoice1", ExistenceChecker.isSet((List<? extends LoanLegalActionNotificationChoice1>) o.getLoanLegalActionNotificationChoice1()))
		...
		if (setFields.equals(fields)) {
			return success("LoanLegalActionNotification", ValidationResult.ValidationType.ONLY_EXISTS, "LoanLegalActionNotification", path, "");
		}
		return failure("LoanLegalActionNotification", ValidationResult.ValidationType.ONLY_EXISTS, "LoanLegalActionNotification", path, "",
