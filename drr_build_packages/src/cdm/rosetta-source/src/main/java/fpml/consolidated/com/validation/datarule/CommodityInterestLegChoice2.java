 ...
 * @version 2.1.1
 */
@RosettaDataRule("CommodityInterestLegChoice2")
@ImplementedBy(CommodityInterestLegChoice2.Default.class)
public interface CommodityInterestLegChoice2 extends Validator<CommodityInterestLeg> {
	
	String NAME = "CommodityInterestLegChoice2";
	String DEFINITION = "optional choice notionalAmount, notionalAmountReference";
	
	class Default implements CommodityInterestLegChoice2 {
		...
		private ComparisonResult executeDataRule(CommodityInterestLeg commodityInterestLeg) {
			try {
				return choice(MapperS.of(commodityInterestLeg), Arrays.asList("notionalAmount", "notionalAmountReference"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements CommodityInterestLegChoice2 {
