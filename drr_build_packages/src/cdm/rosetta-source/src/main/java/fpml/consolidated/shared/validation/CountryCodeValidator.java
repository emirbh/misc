		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CountryCode", ValidationResult.ValidationType.CARDINALITY, "CountryCode", path, "", res.getError());
				}
				return success("CountryCode", ValidationResult.ValidationType.CARDINALITY, "CountryCode", path, "");
			})
			.collect(toList());
	}
