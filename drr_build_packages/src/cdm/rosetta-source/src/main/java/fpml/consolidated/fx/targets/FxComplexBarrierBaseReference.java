...
import fpml.consolidated.fx.targets.meta.FxComplexBarrierBaseReferenceMeta;
 ...
 *
 * Provision Reference to a barrier structure defined within the parametric representation.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FxComplexBarrierBaseReference", builder=FxComplexBarrierBaseReference.FxComplexBarrierBaseReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxComplexBarrierBaseReference", model="fpml", builder=FxComplexBarrierBaseReference.FxComplexBarrierBaseReferenceBuilderImpl.class, version="2.1.1")
public interface FxComplexBarrierBaseReference extends Reference {
	...
	class FxComplexBarrierBaseReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements FxComplexBarrierBaseReference.FxComplexBarrierBaseReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public FxComplexBarrierBaseReference.FxComplexBarrierBaseReferenceBuilder setHref(String _href) {
