...
public class LoanLegalActionTaskOnlyExistsValidator implements ValidatorWithArg<LoanLegalActionTask, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanLegalActionTask> ValidationResult<LoanLegalActionTask> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("type", ExistenceChecker.isSet((LoanLegalActionTaskType) o._getType()))
		...
		if (setFields.equals(fields)) {
			return success("LoanLegalActionTask", ValidationResult.ValidationType.ONLY_EXISTS, "LoanLegalActionTask", path, "");
		}
		return failure("LoanLegalActionTask", ValidationResult.ValidationType.ONLY_EXISTS, "LoanLegalActionTask", path, "",
