...
public class FxTriggerBaseOnlyExistsValidator implements ValidatorWithArg<FxTriggerBase, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FxTriggerBase> ValidationResult<FxTriggerBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FxTriggerBase", ValidationResult.ValidationType.ONLY_EXISTS, "FxTriggerBase", path, "");
		}
		return failure("FxTriggerBase", ValidationResult.ValidationType.ONLY_EXISTS, "FxTriggerBase", path, "",
