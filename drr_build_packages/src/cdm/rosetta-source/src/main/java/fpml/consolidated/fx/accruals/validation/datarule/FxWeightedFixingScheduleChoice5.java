 ...
 * @version 2.1.1
 */
@RosettaDataRule("FxWeightedFixingScheduleChoice5")
@ImplementedBy(FxWeightedFixingScheduleChoice5.Default.class)
public interface FxWeightedFixingScheduleChoice5 extends Validator<FxWeightedFixingSchedule> {
	
	String NAME = "FxWeightedFixingScheduleChoice5";
	String DEFINITION = "optional choice dateAdjustments, dayType";
	
	class Default implements FxWeightedFixingScheduleChoice5 {
		...
		private ComparisonResult executeDataRule(FxWeightedFixingSchedule fxWeightedFixingSchedule) {
			try {
				return choice(MapperS.of(fxWeightedFixingSchedule), Arrays.asList("dateAdjustments", "dayType"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements FxWeightedFixingScheduleChoice5 {
