		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EquityAsset", ValidationResult.ValidationType.TYPE_FORMAT, "EquityAsset", path, "", res.getError());
				}
				return success("EquityAsset", ValidationResult.ValidationType.TYPE_FORMAT, "EquityAsset", path, "");
			})
			.collect(toList());
	}
