...
public class KnockOutRateObservationOnlyExistsValidator implements ValidatorWithArg<KnockOutRateObservation, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends KnockOutRateObservation> ValidationResult<KnockOutRateObservation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("rebatePayment", ExistenceChecker.isSet((NonNegativePayment) o.getRebatePayment()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("KnockOutRateObservation", ValidationResult.ValidationType.ONLY_EXISTS, "KnockOutRateObservation", path, "");
		}
		return failure("KnockOutRateObservation", ValidationResult.ValidationType.ONLY_EXISTS, "KnockOutRateObservation", path, "",
