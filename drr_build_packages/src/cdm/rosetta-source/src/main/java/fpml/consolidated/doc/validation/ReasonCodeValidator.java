		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ReasonCode", ValidationResult.ValidationType.CARDINALITY, "ReasonCode", path, "", res.getError());
				}
				return success("ReasonCode", ValidationResult.ValidationType.CARDINALITY, "ReasonCode", path, "");
			})
			.collect(toList());
	}
