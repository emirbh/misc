		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("NotionalReportingType", ValidationResult.ValidationType.CARDINALITY, "NotionalReportingType", path, "", res.getError());
				}
				return success("NotionalReportingType", ValidationResult.ValidationType.CARDINALITY, "NotionalReportingType", path, "");
			})
			.collect(toList());
	}
