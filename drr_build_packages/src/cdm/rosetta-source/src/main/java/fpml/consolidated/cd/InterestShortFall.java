...
import fpml.consolidated.cd.meta.InterestShortFallMeta;
import fpml.consolidated.fpmlenum.InterestShortfallCapEnum;
 ...
 *
 */
@RosettaDataType(value="InterestShortFall", builder=InterestShortFall.InterestShortFallBuilderImpl.class, version="2.1.1")
@RuneDataType(value="InterestShortFall", model="fpml", builder=InterestShortFall.InterestShortFallBuilderImpl.class, version="2.1.1")
public interface InterestShortFall extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Specifies the nature of the interest Shortfall cap (i.e. Fixed Cap or Variable Cap) in the case where it is applicable. ISDA 2003 Term: Interest Shortfall Cap.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision The rate source in the case of a variable cap.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class InterestShortFallImpl implements InterestShortFall {
		...
		@RuneAttribute("interestShortfallCap")
	...
	class InterestShortFallBuilderImpl implements InterestShortFall.InterestShortFallBuilder {
		...
		@RuneAttribute("interestShortfallCap")
		@Override
		public InterestShortFall.InterestShortFallBuilder setInterestShortfallCap(InterestShortfallCapEnum _interestShortfallCap) {
			this.interestShortfallCap = _interestShortfallCap == null ? null : _interestShortfallCap;
			return this;
		}
		...
		@RuneAttribute("compounding")
		@Override
		public InterestShortFall.InterestShortFallBuilder setCompounding(Boolean _compounding) {
			this.compounding = _compounding == null ? null : _compounding;
			return this;
		}
		...
		@RuneAttribute("rateSource")
		@Override
		public InterestShortFall.InterestShortFallBuilder setRateSource(FloatingRateIndex _rateSource) {
