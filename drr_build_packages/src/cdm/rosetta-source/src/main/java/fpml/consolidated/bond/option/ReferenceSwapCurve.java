...
import fpml.consolidated.bond.option.meta.ReferenceSwapCurveMeta;
 ...
 *
 * Provision A complex type used to specify the option and convertible bond option strike when expressed in reference to a swap curve.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ReferenceSwapCurve", builder=ReferenceSwapCurve.ReferenceSwapCurveBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ReferenceSwapCurve", model="fpml", builder=ReferenceSwapCurve.ReferenceSwapCurveBuilderImpl.class, version="2.1.1")
public interface ReferenceSwapCurve extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Amount to be paid by the buyer of the option if the option is exercised prior to the Early Call Date. (The market practice in the convertible bond option space being that the buyer should be penalized if he/she exercises the option early on.)
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
