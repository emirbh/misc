...
public class OutstandingContractsStatementOnlyExistsValidator implements ValidatorWithArg<OutstandingContractsStatement, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends OutstandingContractsStatement> ValidationResult<OutstandingContractsStatement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("outstandingContractsStatementChoice", ExistenceChecker.isSet((List<? extends OutstandingContractsStatementChoice>) o.getOutstandingContractsStatementChoice()))
		...
		if (setFields.equals(fields)) {
			return success("OutstandingContractsStatement", ValidationResult.ValidationType.ONLY_EXISTS, "OutstandingContractsStatement", path, "");
		}
		return failure("OutstandingContractsStatement", ValidationResult.ValidationType.ONLY_EXISTS, "OutstandingContractsStatement", path, "",
