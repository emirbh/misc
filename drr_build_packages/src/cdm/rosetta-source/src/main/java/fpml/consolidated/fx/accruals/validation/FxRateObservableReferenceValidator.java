		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxRateObservableReference", ValidationResult.ValidationType.CARDINALITY, "FxRateObservableReference", path, "", res.getError());
				}
				return success("FxRateObservableReference", ValidationResult.ValidationType.CARDINALITY, "FxRateObservableReference", path, "");
			})
			.collect(toList());
	}
