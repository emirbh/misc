...
import fpml.consolidated.com.meta.CommodityBasketBaseMeta;
 ...
 *
 */
@RosettaDataType(value="CommodityBasketBase", builder=CommodityBasketBase.CommodityBasketBaseBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityBasketBase", model="fpml", builder=CommodityBasketBase.CommodityBasketBaseBuilderImpl.class, version="2.1.1")
public interface CommodityBasketBase extends RosettaModelObject {
	...
	class CommodityBasketBaseBuilderImpl implements CommodityBasketBase.CommodityBasketBaseBuilder {
		...
		@RuneAttribute("id")
		@Override
		public CommodityBasketBase.CommodityBasketBaseBuilder setId(String _id) {
