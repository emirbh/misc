...
import fpml.consolidated.ird.meta.CalculationPeriodDatesReferenceMeta;
 ...
 *
 * Provision Reference to a calculation period dates component.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CalculationPeriodDatesReference", builder=CalculationPeriodDatesReference.CalculationPeriodDatesReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CalculationPeriodDatesReference", model="fpml", builder=CalculationPeriodDatesReference.CalculationPeriodDatesReferenceBuilderImpl.class, version="2.1.1")
public interface CalculationPeriodDatesReference extends Reference {
	...
	class CalculationPeriodDatesReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements CalculationPeriodDatesReference.CalculationPeriodDatesReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public CalculationPeriodDatesReference.CalculationPeriodDatesReferenceBuilder setHref(String _href) {
