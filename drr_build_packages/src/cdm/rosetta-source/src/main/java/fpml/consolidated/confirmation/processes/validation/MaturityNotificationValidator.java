		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MaturityNotification", ValidationResult.ValidationType.CARDINALITY, "MaturityNotification", path, "", res.getError());
				}
				return success("MaturityNotification", ValidationResult.ValidationType.CARDINALITY, "MaturityNotification", path, "");
			})
			.collect(toList());
	}
