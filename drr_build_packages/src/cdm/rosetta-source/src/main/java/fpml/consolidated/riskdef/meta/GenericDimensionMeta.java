...
import fpml.consolidated.riskdef.validation.GenericDimensionTypeFormatValidator;
import fpml.consolidated.riskdef.validation.GenericDimensionValidator;
import fpml.consolidated.riskdef.validation.exists.GenericDimensionOnlyExistsValidator;
...
public class GenericDimensionMeta implements RosettaMetaData<GenericDimension> {
	...
	@Override
	public Validator<? super GenericDimension> validator(ValidatorFactory factory) {
		return factory.<GenericDimension>create(GenericDimensionValidator.class);
	}

	@Override
	public Validator<? super GenericDimension> typeFormatValidator(ValidatorFactory factory) {
		return factory.<GenericDimension>create(GenericDimensionTypeFormatValidator.class);
	}
