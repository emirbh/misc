		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RequestClearing", ValidationResult.ValidationType.CARDINALITY, "RequestClearing", path, "", res.getError());
				}
				return success("RequestClearing", ValidationResult.ValidationType.CARDINALITY, "RequestClearing", path, "");
			})
			.collect(toList());
	}
