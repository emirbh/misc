...
import fpml.consolidated.shared.meta.CreditSupportAgreementTypeMeta;
 ...
 *
 */
@RosettaDataType(value="CreditSupportAgreementType", builder=CreditSupportAgreementType.CreditSupportAgreementTypeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CreditSupportAgreementType", model="fpml", builder=CreditSupportAgreementType.CreditSupportAgreementTypeBuilderImpl.class, version="2.1.1")
public interface CreditSupportAgreementType extends RosettaModelObject {
	...
	class CreditSupportAgreementTypeImpl implements CreditSupportAgreementType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("creditSupportAgreementTypeScheme")
	...
	class CreditSupportAgreementTypeBuilderImpl implements CreditSupportAgreementType.CreditSupportAgreementTypeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CreditSupportAgreementType.CreditSupportAgreementTypeBuilder setValue(String _value) {
		...
		@RuneAttribute("creditSupportAgreementTypeScheme")
		@Override
		public CreditSupportAgreementType.CreditSupportAgreementTypeBuilder setCreditSupportAgreementTypeScheme(String _creditSupportAgreementTypeScheme) {
			this.creditSupportAgreementTypeScheme = _creditSupportAgreementTypeScheme == null ? null : _creditSupportAgreementTypeScheme;
			return this;
		}
