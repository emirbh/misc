		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("SinglePartyOption", ValidationResult.ValidationType.CARDINALITY, "SinglePartyOption", path, "", res.getError());
				}
				return success("SinglePartyOption", ValidationResult.ValidationType.CARDINALITY, "SinglePartyOption", path, "");
			})
			.collect(toList());
	}
