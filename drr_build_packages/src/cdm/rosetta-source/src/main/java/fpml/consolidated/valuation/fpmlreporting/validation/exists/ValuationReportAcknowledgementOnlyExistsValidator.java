...
public class ValuationReportAcknowledgementOnlyExistsValidator implements ValidatorWithArg<ValuationReportAcknowledgement, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ValuationReportAcknowledgement> ValidationResult<ValuationReportAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ValuationReportAcknowledgement", ValidationResult.ValidationType.ONLY_EXISTS, "ValuationReportAcknowledgement", path, "");
		}
		return failure("ValuationReportAcknowledgement", ValidationResult.ValidationType.ONLY_EXISTS, "ValuationReportAcknowledgement", path, "",
