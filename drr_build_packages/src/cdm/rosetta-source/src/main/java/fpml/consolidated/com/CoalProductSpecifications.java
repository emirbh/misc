...
import fpml.consolidated.com.meta.CoalProductSpecificationsMeta;
 ...
 *
 * Provision The different options for specifying the quality attributes of the coal to be delivered.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CoalProductSpecifications", builder=CoalProductSpecifications.CoalProductSpecificationsBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CoalProductSpecifications", model="fpml", builder=CoalProductSpecifications.CoalProductSpecificationsBuilderImpl.class, version="2.1.1")
public interface CoalProductSpecifications extends RosettaModelObject {
	...
	class CoalProductSpecificationsImpl implements CoalProductSpecifications {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("standardQualitySchedule")
	...
	class CoalProductSpecificationsBuilderImpl implements CoalProductSpecifications.CoalProductSpecificationsBuilder {
		...
		@RuneAttribute("standardQuality")
		@Override
		public CoalProductSpecifications.CoalProductSpecificationsBuilder setStandardQuality(CoalStandardQuality _standardQuality) {
			this.standardQuality = _standardQuality == null ? null : _standardQuality.toBuilder();
			return this;
		}
		...
		@RuneAttribute("standardQualitySchedule")
		@Override
		public CoalProductSpecifications.CoalProductSpecificationsBuilder setStandardQualitySchedule(CoalStandardQualitySchedule _standardQualitySchedule) {
			this.standardQualitySchedule = _standardQualitySchedule == null ? null : _standardQualitySchedule.toBuilder();
			return this;
		}
