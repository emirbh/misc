...
import fpml.consolidated.shared.meta.LanguageMeta;
 ...
 *
 * Provision The data type used for indicating the language of the resource, described using the ISO 639-2/T Code.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="Language", builder=Language.LanguageBuilderImpl.class, version="2.1.1")
@RuneDataType(value="Language", model="fpml", builder=Language.LanguageBuilderImpl.class, version="2.1.1")
public interface Language extends RosettaModelObject {
	...
	class LanguageBuilderImpl implements Language.LanguageBuilder {
		...
		@RuneAttribute("value")
		@Override
		public Language.LanguageBuilder setValue(String _value) {
		...
		@RuneAttribute("languageScheme")
		@Override
		public Language.LanguageBuilder setLanguageScheme(String _languageScheme) {
			this.languageScheme = _languageScheme == null ? null : _languageScheme;
			return this;
		}
