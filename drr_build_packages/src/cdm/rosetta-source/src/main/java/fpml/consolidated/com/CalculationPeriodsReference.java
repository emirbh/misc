...
import fpml.consolidated.com.meta.CalculationPeriodsReferenceMeta;
 ...
 *
 * Provision A pointer style reference to a calculation periods schedule defined elsewhere - note that this schedule consists of a series of actual dates in a calculationPeriods container.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CalculationPeriodsReference", builder=CalculationPeriodsReference.CalculationPeriodsReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CalculationPeriodsReference", model="fpml", builder=CalculationPeriodsReference.CalculationPeriodsReferenceBuilderImpl.class, version="2.1.1")
public interface CalculationPeriodsReference extends Reference {
	...
	class CalculationPeriodsReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements CalculationPeriodsReference.CalculationPeriodsReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public CalculationPeriodsReference.CalculationPeriodsReferenceBuilder setHref(String _href) {
