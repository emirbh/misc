...
public class FxOnlyExistsValidator implements ValidatorWithArg<Fx, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends Fx> ValidationResult<Fx> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("Fx", ValidationResult.ValidationType.ONLY_EXISTS, "Fx", path, "");
		}
		return failure("Fx", ValidationResult.ValidationType.ONLY_EXISTS, "Fx", path, "",
