...
import fpml.consolidated.cd.meta.FloatingAmountEventsMeta;
 ...
 *
 */
@RosettaDataType(value="FloatingAmountEvents", builder=FloatingAmountEvents.FloatingAmountEventsBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FloatingAmountEvents", model="fpml", builder=FloatingAmountEvents.FloatingAmountEventsBuilderImpl.class, version="2.1.1")
public interface FloatingAmountEvents extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A floating rate payment event. Corresponds to the failure by the Reference Entity to pay an expected principal amount or the payment of an actual principal amount that is less than the expected principal amount. ISDA 2003 Term: Failure to Pay Principal.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A floating rate payment event. With respect to any Reference Obligation Payment Date, either (a) the non-payment of an Expected Interest Amount or (b) the payment of an Actual Interest Amount that is less than the Expected Interest Amount. ISDA 2003 Term: Interest Shortfall.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A floating rate payment event. Results from the fact that the underlyer writes down its outstanding principal amount. ISDA 2003 Term: Writedown.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A floating rate payment event. Results from the fact that losses occur to the underlying instruments that do not result in reductions of the outstanding principal of the reference obligation.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Specifies the floating amount provisions associated with the floatingAmountEvents.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Specifies the events that will give rise to the payment a additional fixed payments.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class FloatingAmountEventsImpl implements FloatingAmountEvents {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("interestShortfall")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("floatingAmountProvisions")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("additionalFixedPayments")
	...
	class FloatingAmountEventsBuilderImpl implements FloatingAmountEvents.FloatingAmountEventsBuilder {
		...
		@RuneAttribute("failureToPayPrincipal")
		@Override
		public FloatingAmountEvents.FloatingAmountEventsBuilder setFailureToPayPrincipal(Boolean _failureToPayPrincipal) {
		...
		@RuneAttribute("interestShortfall")
		@Override
		public FloatingAmountEvents.FloatingAmountEventsBuilder setInterestShortfall(InterestShortFall _interestShortfall) {
			this.interestShortfall = _interestShortfall == null ? null : _interestShortfall.toBuilder();
			return this;
		}
		...
		@RuneAttribute("writedown")
		@Override
		public FloatingAmountEvents.FloatingAmountEventsBuilder setWritedown(Boolean _writedown) {
		...
		@RuneAttribute("impliedWritedown")
		@Override
		public FloatingAmountEvents.FloatingAmountEventsBuilder setImpliedWritedown(Boolean _impliedWritedown) {
		...
		@RuneAttribute("floatingAmountProvisions")
		@Override
		public FloatingAmountEvents.FloatingAmountEventsBuilder setFloatingAmountProvisions(FloatingAmountProvisions _floatingAmountProvisions) {
			this.floatingAmountProvisions = _floatingAmountProvisions == null ? null : _floatingAmountProvisions.toBuilder();
			return this;
		}
		...
		@RuneAttribute("additionalFixedPayments")
		@Override
		public FloatingAmountEvents.FloatingAmountEventsBuilder setAdditionalFixedPayments(AdditionalFixedPayments _additionalFixedPayments) {
			this.additionalFixedPayments = _additionalFixedPayments == null ? null : _additionalFixedPayments.toBuilder();
			return this;
		}
