		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CreditSeniority", ValidationResult.ValidationType.CARDINALITY, "CreditSeniority", path, "", res.getError());
				}
				return success("CreditSeniority", ValidationResult.ValidationType.CARDINALITY, "CreditSeniority", path, "");
			})
			.collect(toList());
	}
