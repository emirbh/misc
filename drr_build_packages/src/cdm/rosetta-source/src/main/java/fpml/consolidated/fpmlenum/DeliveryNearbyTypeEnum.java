...
public enum DeliveryNearbyTypeEnum {
	 ...
	 *
	 */
	@RosettaEnumValue(value = "CalculationPeriod") 
	 ...
	 *
	 */
	@RosettaEnumValue(value = "NearbyMonth") 
	NEARBY_MONTH("NearbyMonth", null),
	 ...
	 *
	 */
	@RosettaEnumValue(value = "NearbyWeek") 
	NEARBY_WEEK("NearbyWeek", null)
;
