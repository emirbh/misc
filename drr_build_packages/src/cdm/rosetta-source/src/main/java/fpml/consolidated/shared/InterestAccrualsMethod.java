...
import fpml.consolidated.shared.meta.InterestAccrualsMethodMeta;
 ...
 *
 * Provision A type describing the method for accruing interests on dividends. Can be either a fixed rate reference or a floating rate reference.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="InterestAccrualsMethod", builder=InterestAccrualsMethod.InterestAccrualsMethodBuilderImpl.class, version="2.1.1")
@RuneDataType(value="InterestAccrualsMethod", model="fpml", builder=InterestAccrualsMethod.InterestAccrualsMethodBuilderImpl.class, version="2.1.1")
public interface InterestAccrualsMethod extends RosettaModelObject {
	...
	class InterestAccrualsMethodBuilderImpl implements InterestAccrualsMethod.InterestAccrualsMethodBuilder {
		...
		@RuneAttribute("floatingRateCalculation")
		@Override
		public InterestAccrualsMethod.InterestAccrualsMethodBuilder setFloatingRateCalculation(FloatingRateCalculation _floatingRateCalculation) {
		...
		@RuneAttribute("fixedRate")
		@Override
		public InterestAccrualsMethod.InterestAccrualsMethodBuilder setFixedRate(BigDecimal _fixedRate) {
