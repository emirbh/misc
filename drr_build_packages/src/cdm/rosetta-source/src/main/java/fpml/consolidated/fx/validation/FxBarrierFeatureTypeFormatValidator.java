...
public class FxBarrierFeatureTypeFormatValidator implements Validator<FxBarrierFeature> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxBarrierFeature", ValidationResult.ValidationType.TYPE_FORMAT, "FxBarrierFeature", path, "", res.getError());
				}
				return success("FxBarrierFeature", ValidationResult.ValidationType.TYPE_FORMAT, "FxBarrierFeature", path, "");
			})
			.collect(toList());
	}
