...
import fpml.consolidated.option.shared.validation.ClassifiablePaymentTypeFormatValidator;
import fpml.consolidated.option.shared.validation.ClassifiablePaymentValidator;
import fpml.consolidated.option.shared.validation.exists.ClassifiablePaymentOnlyExistsValidator;
...
public class ClassifiablePaymentMeta implements RosettaMetaData<ClassifiablePayment> {
	...
	@Override
	public Validator<? super ClassifiablePayment> validator(ValidatorFactory factory) {
		return factory.<ClassifiablePayment>create(ClassifiablePaymentValidator.class);
	}

	@Override
	public Validator<? super ClassifiablePayment> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ClassifiablePayment>create(ClassifiablePaymentTypeFormatValidator.class);
	}
