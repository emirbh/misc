...
public class FxTargetRegionLowerBoundOnlyExistsValidator implements ValidatorWithArg<FxTargetRegionLowerBound, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FxTargetRegionLowerBound> ValidationResult<FxTargetRegionLowerBound> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FxTargetRegionLowerBound", ValidationResult.ValidationType.ONLY_EXISTS, "FxTargetRegionLowerBound", path, "");
		}
		return failure("FxTargetRegionLowerBound", ValidationResult.ValidationType.ONLY_EXISTS, "FxTargetRegionLowerBound", path, "",
