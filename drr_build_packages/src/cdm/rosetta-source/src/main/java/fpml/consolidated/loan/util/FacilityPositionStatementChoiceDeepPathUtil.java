...
public class FacilityPositionStatementChoiceDeepPathUtil {
	public FacilityReference chooseFacilityReference(FacilityPositionStatementChoice facilityPositionStatementChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(facilityPositionStatementChoice).<LoanContractIdentifier>map("getContractIdentifier", _facilityPositionStatementChoice -> _facilityPositionStatementChoice.getContractIdentifier());
		...
		final MapperS<LoanContractSummary> contractSummary = MapperS.of(facilityPositionStatementChoice).<LoanContractSummary>map("getContractSummary", _facilityPositionStatementChoice -> _facilityPositionStatementChoice.getContractSummary());
		...
		final MapperS<LoanContract> contract = MapperS.of(facilityPositionStatementChoice).<LoanContract>map("getContract", _facilityPositionStatementChoice -> _facilityPositionStatementChoice.getContract());
	...
	public List<ContractId> chooseContractId(FacilityPositionStatementChoice facilityPositionStatementChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(facilityPositionStatementChoice).<LoanContractIdentifier>map("getContractIdentifier", _facilityPositionStatementChoice -> _facilityPositionStatementChoice.getContractIdentifier());
		if (exists(contractIdentifier).getOrDefault(false)) {
	...
	public String chooseId(FacilityPositionStatementChoice facilityPositionStatementChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(facilityPositionStatementChoice).<LoanContractIdentifier>map("getContractIdentifier", _facilityPositionStatementChoice -> _facilityPositionStatementChoice.getContractIdentifier());
		if (exists(contractIdentifier).getOrDefault(false)) {
	...
	public PartyReference choosePartyReference(FacilityPositionStatementChoice facilityPositionStatementChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(facilityPositionStatementChoice).<LoanContractIdentifier>map("getContractIdentifier", _facilityPositionStatementChoice -> _facilityPositionStatementChoice.getContractIdentifier());
		if (exists(contractIdentifier).getOrDefault(false)) {
	...
	public List<VersionedContractId> chooseVersionedContractId(FacilityPositionStatementChoice facilityPositionStatementChoice) {
		final MapperS<LoanContractIdentifier> contractIdentifier = MapperS.of(facilityPositionStatementChoice).<LoanContractIdentifier>map("getContractIdentifier", _facilityPositionStatementChoice -> _facilityPositionStatementChoice.getContractIdentifier());
		if (exists(contractIdentifier).getOrDefault(false)) {
