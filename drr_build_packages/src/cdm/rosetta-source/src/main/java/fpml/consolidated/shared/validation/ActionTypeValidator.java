		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ActionType", ValidationResult.ValidationType.CARDINALITY, "ActionType", path, "", res.getError());
				}
				return success("ActionType", ValidationResult.ValidationType.CARDINALITY, "ActionType", path, "");
			})
			.collect(toList());
	}
