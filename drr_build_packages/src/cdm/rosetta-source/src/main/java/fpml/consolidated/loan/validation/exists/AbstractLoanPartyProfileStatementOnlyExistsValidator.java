...
public class AbstractLoanPartyProfileStatementOnlyExistsValidator implements ValidatorWithArg<AbstractLoanPartyProfileStatement, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractLoanPartyProfileStatement> ValidationResult<AbstractLoanPartyProfileStatement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanPartyProfileStatement", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractLoanPartyProfileStatement", path, "");
		}
		return failure("AbstractLoanPartyProfileStatement", ValidationResult.ValidationType.ONLY_EXISTS, "AbstractLoanPartyProfileStatement", path, "",
