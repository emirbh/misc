...
public class LcAccrualOnlyExistsValidator implements ValidatorWithArg<LcAccrual, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LcAccrual> ValidationResult<LcAccrual> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LcAccrual", ValidationResult.ValidationType.ONLY_EXISTS, "LcAccrual", path, "");
		}
		return failure("LcAccrual", ValidationResult.ValidationType.ONLY_EXISTS, "LcAccrual", path, "",
