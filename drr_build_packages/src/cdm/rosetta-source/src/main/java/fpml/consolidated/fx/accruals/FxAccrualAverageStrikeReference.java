...
import fpml.consolidated.fx.accruals.meta.FxAccrualAverageStrikeReferenceMeta;
 ...
 *
 * Provision Reference to an average rate structure in FxAccrualForward or FxAccrualOption products.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="FxAccrualAverageStrikeReference", builder=FxAccrualAverageStrikeReference.FxAccrualAverageStrikeReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="FxAccrualAverageStrikeReference", model="fpml", builder=FxAccrualAverageStrikeReference.FxAccrualAverageStrikeReferenceBuilderImpl.class, version="2.1.1")
public interface FxAccrualAverageStrikeReference extends Reference {
	...
	class FxAccrualAverageStrikeReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements FxAccrualAverageStrikeReference.FxAccrualAverageStrikeReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public FxAccrualAverageStrikeReference.FxAccrualAverageStrikeReferenceBuilder setHref(String _href) {
