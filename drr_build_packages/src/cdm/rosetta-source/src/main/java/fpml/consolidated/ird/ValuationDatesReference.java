...
import fpml.consolidated.ird.meta.ValuationDatesReferenceMeta;
 ...
 *
 * Provision Reference to a Valuation dates node.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ValuationDatesReference", builder=ValuationDatesReference.ValuationDatesReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ValuationDatesReference", model="fpml", builder=ValuationDatesReference.ValuationDatesReferenceBuilderImpl.class, version="2.1.1")
public interface ValuationDatesReference extends Reference {
	...
	class ValuationDatesReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements ValuationDatesReference.ValuationDatesReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public ValuationDatesReference.ValuationDatesReferenceBuilder setHref(String _href) {
