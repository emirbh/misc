 ...
 *
 */
@RosettaDataType(value="InstrumentSetSequence", builder=InstrumentSetSequence.InstrumentSetSequenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="InstrumentSetSequence", model="fpml", builder=InstrumentSetSequence.InstrumentSetSequenceBuilderImpl.class, version="2.1.1")
public interface InstrumentSetSequence extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision A collection of underlying assets (bonds, discount instruments, futures, etc.) that can be used as a basis for benchmark quotes.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class InstrumentSetSequenceBuilderImpl implements InstrumentSetSequence.InstrumentSetSequenceBuilder {
		...
		@RuneAttribute("underlyingAsset")
		@Override
		public InstrumentSetSequence.InstrumentSetSequenceBuilder setUnderlyingAsset(Asset _underlyingAsset) {
		...
		@RuneAttribute("curveInstrument")
		@Override
		public InstrumentSetSequence.InstrumentSetSequenceBuilder setCurveInstrument(Asset _curveInstrument) {
