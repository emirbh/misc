...
import fpml.consolidated.shared.validation.CreditSupportAgreementTypeTypeFormatValidator;
import fpml.consolidated.shared.validation.CreditSupportAgreementTypeValidator;
import fpml.consolidated.shared.validation.exists.CreditSupportAgreementTypeOnlyExistsValidator;
...
public class CreditSupportAgreementTypeMeta implements RosettaMetaData<CreditSupportAgreementType> {
	...
	@Override
	public Validator<? super CreditSupportAgreementType> validator(ValidatorFactory factory) {
		return factory.<CreditSupportAgreementType>create(CreditSupportAgreementTypeValidator.class);
	}

	@Override
	public Validator<? super CreditSupportAgreementType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CreditSupportAgreementType>create(CreditSupportAgreementTypeTypeFormatValidator.class);
	}
