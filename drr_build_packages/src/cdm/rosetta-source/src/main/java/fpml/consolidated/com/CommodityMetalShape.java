...
import fpml.consolidated.com.meta.CommodityMetalShapeMeta;
 ...
 *
 */
@RosettaDataType(value="CommodityMetalShape", builder=CommodityMetalShape.CommodityMetalShapeBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityMetalShape", model="fpml", builder=CommodityMetalShape.CommodityMetalShapeBuilderImpl.class, version="2.1.1")
public interface CommodityMetalShape extends RosettaModelObject {
	...
	class CommodityMetalShapeImpl implements CommodityMetalShape {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("commodityMetalShapeScheme")
	...
	class CommodityMetalShapeBuilderImpl implements CommodityMetalShape.CommodityMetalShapeBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CommodityMetalShape.CommodityMetalShapeBuilder setValue(String _value) {
		...
		@RuneAttribute("commodityMetalShapeScheme")
		@Override
		public CommodityMetalShape.CommodityMetalShapeBuilder setCommodityMetalShapeScheme(String _commodityMetalShapeScheme) {
			this.commodityMetalShapeScheme = _commodityMetalShapeScheme == null ? null : _commodityMetalShapeScheme;
			return this;
		}
