...
import fpml.consolidated.com.meta.CoalTransportationEquipmentMeta;
 ...
 *
 * Provision A scheme identifying the methods by which coal may be transported.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CoalTransportationEquipment", builder=CoalTransportationEquipment.CoalTransportationEquipmentBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CoalTransportationEquipment", model="fpml", builder=CoalTransportationEquipment.CoalTransportationEquipmentBuilderImpl.class, version="2.1.1")
public interface CoalTransportationEquipment extends RosettaModelObject {
	...
	class CoalTransportationEquipmentImpl implements CoalTransportationEquipment {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("commodityCoalTransportationEquipmentScheme")
	...
	class CoalTransportationEquipmentBuilderImpl implements CoalTransportationEquipment.CoalTransportationEquipmentBuilder {
		...
		@RuneAttribute("value")
		@Override
		public CoalTransportationEquipment.CoalTransportationEquipmentBuilder setValue(String _value) {
		...
		@RuneAttribute("commodityCoalTransportationEquipmentScheme")
		@Override
		public CoalTransportationEquipment.CoalTransportationEquipmentBuilder setCommodityCoalTransportationEquipmentScheme(String _commodityCoalTransportationEquipmentScheme) {
			this.commodityCoalTransportationEquipmentScheme = _commodityCoalTransportationEquipmentScheme == null ? null : _commodityCoalTransportationEquipmentScheme;
			return this;
		}
