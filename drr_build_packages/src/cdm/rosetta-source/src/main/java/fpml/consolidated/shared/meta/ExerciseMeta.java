...
import fpml.consolidated.shared.validation.ExerciseTypeFormatValidator;
import fpml.consolidated.shared.validation.ExerciseValidator;
import fpml.consolidated.shared.validation.exists.ExerciseOnlyExistsValidator;
...
public class ExerciseMeta implements RosettaMetaData<Exercise> {
	...
	@Override
	public Validator<? super Exercise> validator(ValidatorFactory factory) {
		return factory.<Exercise>create(ExerciseValidator.class);
	}

	@Override
	public Validator<? super Exercise> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Exercise>create(ExerciseTypeFormatValidator.class);
	}
