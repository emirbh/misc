...
import fpml.consolidated.com.meta.QuantityReferenceMeta;
 ...
 *
 * Provision A pointer tyle reference to a Quantity defined elsewhere.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="QuantityReference", builder=QuantityReference.QuantityReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="QuantityReference", model="fpml", builder=QuantityReference.QuantityReferenceBuilderImpl.class, version="2.1.1")
public interface QuantityReference extends Reference {
	...
	class QuantityReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements QuantityReference.QuantityReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public QuantityReference.QuantityReferenceBuilder setHref(String _href) {
