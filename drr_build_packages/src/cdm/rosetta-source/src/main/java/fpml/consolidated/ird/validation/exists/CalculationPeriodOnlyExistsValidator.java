...
public class CalculationPeriodOnlyExistsValidator implements ValidatorWithArg<CalculationPeriod, Set<String>> {
	...
	public <T2 extends CalculationPeriod> ValidationResult<CalculationPeriod> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("unadjustedStartDate", ExistenceChecker.isSet((ZonedDateTime) o.getUnadjustedStartDate()))
				.put("unadjustedEndDate", ExistenceChecker.isSet((ZonedDateTime) o.getUnadjustedEndDate()))
		...
		if (setFields.equals(fields)) {
			return success("CalculationPeriod", ValidationResult.ValidationType.ONLY_EXISTS, "CalculationPeriod", path, "");
		}
		return failure("CalculationPeriod", ValidationResult.ValidationType.ONLY_EXISTS, "CalculationPeriod", path, "",
