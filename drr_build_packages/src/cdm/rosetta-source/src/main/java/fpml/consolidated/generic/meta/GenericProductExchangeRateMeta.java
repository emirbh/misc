...
import fpml.consolidated.generic.validation.GenericProductExchangeRateTypeFormatValidator;
import fpml.consolidated.generic.validation.GenericProductExchangeRateValidator;
import fpml.consolidated.generic.validation.exists.GenericProductExchangeRateOnlyExistsValidator;
...
public class GenericProductExchangeRateMeta implements RosettaMetaData<GenericProductExchangeRate> {
	...
	@Override
	public Validator<? super GenericProductExchangeRate> validator(ValidatorFactory factory) {
		return factory.<GenericProductExchangeRate>create(GenericProductExchangeRateValidator.class);
	}

	@Override
	public Validator<? super GenericProductExchangeRate> typeFormatValidator(ValidatorFactory factory) {
		return factory.<GenericProductExchangeRate>create(GenericProductExchangeRateTypeFormatValidator.class);
	}
