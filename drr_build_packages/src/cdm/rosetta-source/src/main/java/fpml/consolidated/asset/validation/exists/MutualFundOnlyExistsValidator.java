...
public class MutualFundOnlyExistsValidator implements ValidatorWithArg<MutualFund, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends MutualFund> ValidationResult<MutualFund> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("openEndedFund", ExistenceChecker.isSet((Boolean) o.getOpenEndedFund()))
		...
		if (setFields.equals(fields)) {
			return success("MutualFund", ValidationResult.ValidationType.ONLY_EXISTS, "MutualFund", path, "");
		}
		return failure("MutualFund", ValidationResult.ValidationType.ONLY_EXISTS, "MutualFund", path, "",
