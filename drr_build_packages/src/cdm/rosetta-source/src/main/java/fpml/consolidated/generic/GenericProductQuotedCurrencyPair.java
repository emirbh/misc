...
import fpml.consolidated.generic.meta.GenericProductQuotedCurrencyPairMeta;
 ...
 *
 * Provision A type that describes the composition of a rate that has been quoted or is to be quoted. This includes the two currencies and the quotation relationship between the two currencies and is used as a building block throughout the FX specification.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="GenericProductQuotedCurrencyPair", builder=GenericProductQuotedCurrencyPair.GenericProductQuotedCurrencyPairBuilderImpl.class, version="2.1.1")
@RuneDataType(value="GenericProductQuotedCurrencyPair", model="fpml", builder=GenericProductQuotedCurrencyPair.GenericProductQuotedCurrencyPairBuilderImpl.class, version="2.1.1")
public interface GenericProductQuotedCurrencyPair extends RosettaModelObject {
	...
	class GenericProductQuotedCurrencyPairBuilderImpl implements GenericProductQuotedCurrencyPair.GenericProductQuotedCurrencyPairBuilder {
		...
		@RuneAttribute("currency1")
		@Override
		public GenericProductQuotedCurrencyPair.GenericProductQuotedCurrencyPairBuilder setCurrency1(Currency _currency1) {
		...
		@RuneAttribute("currency2")
		@Override
		public GenericProductQuotedCurrencyPair.GenericProductQuotedCurrencyPairBuilder setCurrency2(Currency _currency2) {
		...
		@RuneAttribute("quoteBasis")
		@Override
		public GenericProductQuotedCurrencyPair.GenericProductQuotedCurrencyPairBuilder setQuoteBasis(QuoteBasisEnum _quoteBasis) {
