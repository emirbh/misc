...
public class LoanAllocationSettlementOnlyExistsValidator implements ValidatorWithArg<LoanAllocationSettlement, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationSettlement> ValidationResult<LoanAllocationSettlement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("allocationAmount", ExistenceChecker.isSet((NonNegativeMoney) o.getAllocationAmount()))
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationSettlement", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationSettlement", path, "");
		}
		return failure("LoanAllocationSettlement", ValidationResult.ValidationType.ONLY_EXISTS, "LoanAllocationSettlement", path, "",
