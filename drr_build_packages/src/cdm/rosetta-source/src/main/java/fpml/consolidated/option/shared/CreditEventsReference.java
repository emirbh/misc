...
import fpml.consolidated.option.shared.meta.CreditEventsReferenceMeta;
 ...
 *
 * Provision Reference to credit events.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CreditEventsReference", builder=CreditEventsReference.CreditEventsReferenceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CreditEventsReference", model="fpml", builder=CreditEventsReference.CreditEventsReferenceBuilderImpl.class, version="2.1.1")
public interface CreditEventsReference extends Reference {
	...
	class CreditEventsReferenceBuilderImpl extends Reference.ReferenceBuilderImpl implements CreditEventsReference.CreditEventsReferenceBuilder {
		...
		@RuneAttribute("href")
		@Override
		public CreditEventsReference.CreditEventsReferenceBuilder setHref(String _href) {
