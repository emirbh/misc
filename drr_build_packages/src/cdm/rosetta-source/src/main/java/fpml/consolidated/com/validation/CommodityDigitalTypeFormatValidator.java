		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityDigital", ValidationResult.ValidationType.TYPE_FORMAT, "CommodityDigital", path, "", res.getError());
				}
				return success("CommodityDigital", ValidationResult.ValidationType.TYPE_FORMAT, "CommodityDigital", path, "");
			})
			.collect(toList());
	}
