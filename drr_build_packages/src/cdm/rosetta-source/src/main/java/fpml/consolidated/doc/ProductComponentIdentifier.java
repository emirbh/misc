 ...
 *
 * Provision Deprecated: A type defining a USI for the a subproduct component of a strategy.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="ProductComponentIdentifier", builder=ProductComponentIdentifier.ProductComponentIdentifierBuilderImpl.class, version="2.1.1")
@RuneDataType(value="ProductComponentIdentifier", model="fpml", builder=ProductComponentIdentifier.ProductComponentIdentifierBuilderImpl.class, version="2.1.1")
public interface ProductComponentIdentifier extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Indicates which product within a strategy this ID is associated with.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class ProductComponentIdentifierBuilderImpl implements ProductComponentIdentifier.ProductComponentIdentifierBuilder {
		...
		@RuneAttribute("premiumProductReference")
		@Override
		public ProductComponentIdentifier.ProductComponentIdentifierBuilder setPremiumProductReference(ProductReference _premiumProductReference) {
		...
		@RuneAttribute("issuer")
		@Override
		public ProductComponentIdentifier.ProductComponentIdentifierBuilder setIssuer(IssuerId _issuer) {
		...
		@RuneAttribute("tradeId")
		@Override
		public ProductComponentIdentifier.ProductComponentIdentifierBuilder setTradeId(TradeId _tradeId) {
