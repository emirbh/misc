...
import fpml.consolidated.confirmation.processes.MaturityAcknowledgement;
import fpml.consolidated.confirmation.processes.validation.MaturityAcknowledgementTypeFormatValidator;
import fpml.consolidated.confirmation.processes.validation.MaturityAcknowledgementValidator;
import fpml.consolidated.confirmation.processes.validation.exists.MaturityAcknowledgementOnlyExistsValidator;
...
public class MaturityAcknowledgementMeta implements RosettaMetaData<MaturityAcknowledgement> {
	...
	@Override
	public Validator<? super MaturityAcknowledgement> validator(ValidatorFactory factory) {
		return factory.<MaturityAcknowledgement>create(MaturityAcknowledgementValidator.class);
	}

	@Override
	public Validator<? super MaturityAcknowledgement> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MaturityAcknowledgement>create(MaturityAcknowledgementTypeFormatValidator.class);
	}
