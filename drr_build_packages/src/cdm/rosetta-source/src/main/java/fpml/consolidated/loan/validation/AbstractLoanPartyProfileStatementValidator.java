...
public class AbstractLoanPartyProfileStatementValidator implements Validator<AbstractLoanPartyProfileStatement> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractLoanPartyProfileStatement", ValidationResult.ValidationType.CARDINALITY, "AbstractLoanPartyProfileStatement", path, "", res.getError());
				}
				return success("AbstractLoanPartyProfileStatement", ValidationResult.ValidationType.CARDINALITY, "AbstractLoanPartyProfileStatement", path, "");
			})
			.collect(toList());
	}
