...
public class EnvironmentalProductComplaincePeriodOnlyExistsValidator implements ValidatorWithArg<EnvironmentalProductComplaincePeriod, Set<String>> {
	...
	public <T2 extends EnvironmentalProductComplaincePeriod> ValidationResult<EnvironmentalProductComplaincePeriod> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("startYear", ExistenceChecker.isSet((String) o.getStartYear()))
				.put("endYear", ExistenceChecker.isSet((String) o.getEndYear()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("EnvironmentalProductComplaincePeriod", ValidationResult.ValidationType.ONLY_EXISTS, "EnvironmentalProductComplaincePeriod", path, "");
		}
		return failure("EnvironmentalProductComplaincePeriod", ValidationResult.ValidationType.ONLY_EXISTS, "EnvironmentalProductComplaincePeriod", path, "",
