		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PartyName", ValidationResult.ValidationType.CARDINALITY, "PartyName", path, "", res.getError());
				}
				return success("PartyName", ValidationResult.ValidationType.CARDINALITY, "PartyName", path, "");
			})
			.collect(toList());
	}
