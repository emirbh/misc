...
import fpml.consolidated.doc.validation.TransactionCharacteristicTypeFormatValidator;
import fpml.consolidated.doc.validation.TransactionCharacteristicValidator;
import fpml.consolidated.doc.validation.exists.TransactionCharacteristicOnlyExistsValidator;
...
public class TransactionCharacteristicMeta implements RosettaMetaData<TransactionCharacteristic> {
	...
	@Override
	public Validator<? super TransactionCharacteristic> validator(ValidatorFactory factory) {
		return factory.<TransactionCharacteristic>create(TransactionCharacteristicValidator.class);
	}

	@Override
	public Validator<? super TransactionCharacteristic> typeFormatValidator(ValidatorFactory factory) {
		return factory.<TransactionCharacteristic>create(TransactionCharacteristicTypeFormatValidator.class);
	}
