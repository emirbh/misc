...
public class NonNegativePaymentOnlyExistsValidator implements ValidatorWithArg<NonNegativePayment, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends NonNegativePayment> ValidationResult<NonNegativePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("NonNegativePayment", ValidationResult.ValidationType.ONLY_EXISTS, "NonNegativePayment", path, "");
		}
		return failure("NonNegativePayment", ValidationResult.ValidationType.ONLY_EXISTS, "NonNegativePayment", path, "",
