...
public class CorporateActionEventOnlyExistsValidator implements ValidatorWithArg<CorporateActionEvent, Set<String>> {
	...
	public <T2 extends CorporateActionEvent> ValidationResult<CorporateActionEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("type", ExistenceChecker.isSet((CorporateActionType) o._getType()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CorporateActionEvent", ValidationResult.ValidationType.ONLY_EXISTS, "CorporateActionEvent", path, "");
		}
		return failure("CorporateActionEvent", ValidationResult.ValidationType.ONLY_EXISTS, "CorporateActionEvent", path, "",
