...
public class QuotationCharacteristicsOnlyExistsValidator implements ValidatorWithArg<QuotationCharacteristics, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends QuotationCharacteristics> ValidationResult<QuotationCharacteristics> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("QuotationCharacteristics", ValidationResult.ValidationType.ONLY_EXISTS, "QuotationCharacteristics", path, "");
		}
		return failure("QuotationCharacteristics", ValidationResult.ValidationType.ONLY_EXISTS, "QuotationCharacteristics", path, "",
