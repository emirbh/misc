 ...
 *
 * Provision A type for defining exercise procedures associated with a Bermuda style exercise of an equity option. The term Bermuda is adopted in FpML for consistency with the ISDA Definitions.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="EquityBermudaExercise", builder=EquityBermudaExercise.EquityBermudaExerciseBuilderImpl.class, version="2.1.1")
@RuneDataType(value="EquityBermudaExercise", model="fpml", builder=EquityBermudaExercise.EquityBermudaExerciseBuilderImpl.class, version="2.1.1")
public interface EquityBermudaExercise extends SharedAmericanExercise {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision List of Exercise Dates for a Bermuda option.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	interface EquityBermudaExerciseBuilder extends EquityBermudaExercise, SharedAmericanExercise.SharedAmericanExerciseBuilder {
		...
		EquityBermudaExercise.EquityBermudaExerciseBuilder setEquityExpirationTimeType(TimeTypeEnum equityExpirationTimeType);
		EquityBermudaExercise.EquityBermudaExerciseBuilder setEquityExpirationTime(BusinessCenterTime equityExpirationTime);
		EquityBermudaExercise.EquityBermudaExerciseBuilder setExpirationTimeDetermination(DeterminationMethod expirationTimeDetermination);
	...
	class EquityBermudaExerciseBuilderImpl extends SharedAmericanExercise.SharedAmericanExerciseBuilderImpl implements EquityBermudaExercise.EquityBermudaExerciseBuilder {
		...
		@RuneAttribute("id")
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setId(String _id) {
		...
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setCommencementDate(AdjustableOrRelativeDate _commencementDate) {
		...
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setExpirationDate(AdjustableOrRelativeDate _expirationDate) {
		...
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setLatestExerciseTime(BusinessCenterTime _latestExerciseTime) {
		...
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setLatestExerciseTimeDetermination(DeterminationMethod _latestExerciseTimeDetermination) {
		...
		@RuneAttribute("bermudaExerciseDates")
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setBermudaExerciseDates(DateList _bermudaExerciseDates) {
		...
		@RuneAttribute("latestExerciseTimeType")
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setLatestExerciseTimeType(TimeTypeEnum _latestExerciseTimeType) {
		...
		@RuneAttribute("equityExpirationTimeType")
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setEquityExpirationTimeType(TimeTypeEnum _equityExpirationTimeType) {
		...
		@RuneAttribute("equityExpirationTime")
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setEquityExpirationTime(BusinessCenterTime _equityExpirationTime) {
		...
		@RuneAttribute("expirationTimeDetermination")
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setExpirationTimeDetermination(DeterminationMethod _expirationTimeDetermination) {
		...
		@RuneAttribute("equityMultipleExercise")
		@Override
		public EquityBermudaExercise.EquityBermudaExerciseBuilder setEquityMultipleExercise(EquityMultipleExercise _equityMultipleExercise) {
