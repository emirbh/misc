...
import fpml.consolidated.loan.meta.PartyProfileChoiceMeta;
 ...
 *
 */
@RosettaDataType(value="PartyProfileChoice", builder=PartyProfileChoice.PartyProfileChoiceBuilderImpl.class, version="2.1.1")
@RuneDataType(value="PartyProfileChoice", model="fpml", builder=PartyProfileChoice.PartyProfileChoiceBuilderImpl.class, version="2.1.1")
public interface PartyProfileChoice extends RosettaModelObject {
	 ...
	 * version "confirmation-5.13"
	 *
	 * Provision Relates an asset, or assets, to an element within a party block (customarily a business unit or person).
	 *
	 */
	 ...
	 * version "confirmation-5.13"
	 *
	 * Provision Relates an asset, or assets, to set of settlement instructions.
	 *
	 */
	...
	class PartyProfileChoiceImpl implements PartyProfileChoice {
		...
		@RuneAttribute("communicationDetails")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("settlementInstructionDetails")
	...
	class PartyProfileChoiceBuilderImpl implements PartyProfileChoice.PartyProfileChoiceBuilder {
		...
		@RuneAttribute("communicationDetails")
		@Override
		public PartyProfileChoice.PartyProfileChoiceBuilder setCommunicationDetails(ApplicableCommunicationDetails _communicationDetails) {
			this.communicationDetails = _communicationDetails == null ? null : _communicationDetails.toBuilder();
			return this;
		}
		...
		@RuneAttribute("settlementInstructionDetails")
		@Override
		public PartyProfileChoice.PartyProfileChoiceBuilder setSettlementInstructionDetails(ApplicableSettlementInstructionDetails _settlementInstructionDetails) {
			this.settlementInstructionDetails = _settlementInstructionDetails == null ? null : _settlementInstructionDetails.toBuilder();
			return this;
		}
