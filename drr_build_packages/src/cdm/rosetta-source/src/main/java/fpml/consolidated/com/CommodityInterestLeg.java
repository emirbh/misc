...
import fpml.consolidated.com.meta.CommodityInterestLegMeta;
 ...
 *
 * Provision A type describing the interest rate leg (a.k.a fee leg) of the commodity performance swap.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="CommodityInterestLeg", builder=CommodityInterestLeg.CommodityInterestLegBuilderImpl.class, version="2.1.1")
@RuneDataType(value="CommodityInterestLeg", model="fpml", builder=CommodityInterestLeg.CommodityInterestLegBuilderImpl.class, version="2.1.1")
public interface CommodityInterestLeg extends CommodityPerformanceSwapLeg {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Specifies the interest payment amount on a return swap. This amount may be referred to as the interest amount or the fee amount. Used when the interest (a.k.a. "Fee") is calculated very simply: notional amount * (rate * (number of days in Calculation Period / number of days assumed in the the year)).
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	interface CommodityInterestLegBuilder extends CommodityInterestLeg, CommodityPerformanceSwapLeg.CommodityPerformanceSwapLegBuilder {
		...
		@Override
		CommodityInterestLeg.CommodityInterestLegBuilder setPayerPartyReference(PartyReference payerPartyReference);
		@Override
		CommodityInterestLeg.CommodityInterestLegBuilder setPayerAccountReference(AccountReference payerAccountReference);
		@Override
		CommodityInterestLeg.CommodityInterestLegBuilder setReceiverPartyReference(PartyReference receiverPartyReference);
		@Override
		CommodityInterestLeg.CommodityInterestLegBuilder setReceiverAccountReference(AccountReference receiverAccountReference);
		CommodityInterestLeg.CommodityInterestLegBuilder setCalculationDates(AdjustableDates calculationDates);
		CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriods(AdjustableDates calculationPeriods);
		CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriodsSchedule(CommodityCalculationPeriodsSchedule calculationPeriodsSchedule);
		CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriodsReference(CalculationPeriodsReference calculationPeriodsReference);
		CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriodsScheduleReference(CalculationPeriodsScheduleReference calculationPeriodsScheduleReference);
		CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriodsDatesReference(CalculationPeriodsDatesReference calculationPeriodsDatesReference);
		CommodityInterestLeg.CommodityInterestLegBuilder setRelativePaymentDates(CommodityRelativePaymentDates relativePaymentDates);
		CommodityInterestLeg.CommodityInterestLegBuilder setPaymentDates(AdjustableDatesOrRelativeDateOffset paymentDates);
		CommodityInterestLeg.CommodityInterestLegBuilder setMasterAgreementPaymentDates(Boolean masterAgreementPaymentDates);
	...
	class CommodityInterestLegImpl extends CommodityPerformanceSwapLeg.CommodityPerformanceSwapLegImpl implements CommodityInterestLeg {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("commodityFixedInterestCalculation")
	...
	class CommodityInterestLegBuilderImpl extends CommodityPerformanceSwapLeg.CommodityPerformanceSwapLegBuilderImpl implements CommodityInterestLeg.CommodityInterestLegBuilder {
		...
		@RuneAttribute("id")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setId(String _id) {
		...
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setPayerPartyReference(PartyReference _payerPartyReference) {
		...
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setPayerAccountReference(AccountReference _payerAccountReference) {
		...
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setReceiverPartyReference(PartyReference _receiverPartyReference) {
		...
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setReceiverAccountReference(AccountReference _receiverAccountReference) {
		...
		@RuneAttribute("calculationDates")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setCalculationDates(AdjustableDates _calculationDates) {
		...
		@RuneAttribute("calculationPeriods")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriods(AdjustableDates _calculationPeriods) {
		...
		@RuneAttribute("calculationPeriodsSchedule")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriodsSchedule(CommodityCalculationPeriodsSchedule _calculationPeriodsSchedule) {
		...
		@RuneAttribute("calculationPeriodsReference")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriodsReference(CalculationPeriodsReference _calculationPeriodsReference) {
		...
		@RuneAttribute("calculationPeriodsScheduleReference")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriodsScheduleReference(CalculationPeriodsScheduleReference _calculationPeriodsScheduleReference) {
		...
		@RuneAttribute("calculationPeriodsDatesReference")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setCalculationPeriodsDatesReference(CalculationPeriodsDatesReference _calculationPeriodsDatesReference) {
		...
		@RuneAttribute("relativePaymentDates")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setRelativePaymentDates(CommodityRelativePaymentDates _relativePaymentDates) {
		...
		@RuneAttribute("paymentDates")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setPaymentDates(AdjustableDatesOrRelativeDateOffset _paymentDates) {
		...
		@RuneAttribute("masterAgreementPaymentDates")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setMasterAgreementPaymentDates(Boolean _masterAgreementPaymentDates) {
		...
		@RuneAttribute("notionalAmount")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setNotionalAmount(CommodityNotionalAmount _notionalAmount) {
		...
		@RuneAttribute("notionalAmountReference")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setNotionalAmountReference(CommodityNotionalAmountReference _notionalAmountReference) {
		...
		@RuneAttribute("commodityFixedInterestCalculation")
		@Override
		public CommodityInterestLeg.CommodityInterestLegBuilder setCommodityFixedInterestCalculation(CommodityFixedInterestCalculation _commodityFixedInterestCalculation) {
			this.commodityFixedInterestCalculation = _commodityFixedInterestCalculation == null ? null : _commodityFixedInterestCalculation.toBuilder();
			return this;
		}
