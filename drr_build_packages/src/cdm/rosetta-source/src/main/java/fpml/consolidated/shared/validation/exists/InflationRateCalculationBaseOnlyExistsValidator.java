...
public class InflationRateCalculationBaseOnlyExistsValidator implements ValidatorWithArg<InflationRateCalculationBase, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends InflationRateCalculationBase> ValidationResult<InflationRateCalculationBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("InflationRateCalculationBase", ValidationResult.ValidationType.ONLY_EXISTS, "InflationRateCalculationBase", path, "");
		}
		return failure("InflationRateCalculationBase", ValidationResult.ValidationType.ONLY_EXISTS, "InflationRateCalculationBase", path, "",
