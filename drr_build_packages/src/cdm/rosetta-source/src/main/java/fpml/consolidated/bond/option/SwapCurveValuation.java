...
import fpml.consolidated.bond.option.meta.SwapCurveValuationMeta;
 ...
 *
 * Provision A complex type to specify a valuation swap curve, which is used as part of the strike construct for the bond and convertible bond options.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="SwapCurveValuation", builder=SwapCurveValuation.SwapCurveValuationBuilderImpl.class, version="2.1.1")
@RuneDataType(value="SwapCurveValuation", model="fpml", builder=SwapCurveValuation.SwapCurveValuationBuilderImpl.class, version="2.1.1")
public interface SwapCurveValuation extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Spread in basis points over the floating rate index.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	interface SwapCurveValuationBuilder extends SwapCurveValuation, RosettaModelObjectBuilder {
		...
		SwapCurveValuation.SwapCurveValuationBuilder setFloatingRateIndex(FloatingRateIndex floatingRateIndex);
	...
	class SwapCurveValuationBuilderImpl implements SwapCurveValuation.SwapCurveValuationBuilder {
		...
		@RuneAttribute("floatingRateIndex")
		@Override
		public SwapCurveValuation.SwapCurveValuationBuilder setFloatingRateIndex(FloatingRateIndex _floatingRateIndex) {
		...
		@RuneAttribute("indexTenor")
		@Override
		public SwapCurveValuation.SwapCurveValuationBuilder setIndexTenor(Period _indexTenor) {
		...
		@RuneAttribute("spread")
		@Override
		public SwapCurveValuation.SwapCurveValuationBuilder setSpread(BigDecimal _spread) {
		...
		@RuneAttribute("side")
		@Override
		public SwapCurveValuation.SwapCurveValuationBuilder setSide(QuotationSideEnum _side) {
