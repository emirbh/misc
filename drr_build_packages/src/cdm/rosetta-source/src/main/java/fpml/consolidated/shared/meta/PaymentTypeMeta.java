...
import fpml.consolidated.shared.validation.PaymentTypeTypeFormatValidator;
import fpml.consolidated.shared.validation.PaymentTypeValidator;
import fpml.consolidated.shared.validation.exists.PaymentTypeOnlyExistsValidator;
...
public class PaymentTypeMeta implements RosettaMetaData<PaymentType> {
	...
	@Override
	public Validator<? super PaymentType> validator(ValidatorFactory factory) {
		return factory.<PaymentType>create(PaymentTypeValidator.class);
	}

	@Override
	public Validator<? super PaymentType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PaymentType>create(PaymentTypeTypeFormatValidator.class);
	}
