		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LcType", ValidationResult.ValidationType.CARDINALITY, "LcType", path, "", res.getError());
				}
				return success("LcType", ValidationResult.ValidationType.CARDINALITY, "LcType", path, "");
			})
			.collect(toList());
	}
