...
public class PartyRoleOnlyExistsValidator implements ValidatorWithArg<PartyRole, Set<String>> {
	...
	public <T2 extends PartyRole> ValidationResult<PartyRole> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("partyRoleScheme", ExistenceChecker.isSet((String) o.getPartyRoleScheme()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("PartyRole", ValidationResult.ValidationType.ONLY_EXISTS, "PartyRole", path, "");
		}
		return failure("PartyRole", ValidationResult.ValidationType.ONLY_EXISTS, "PartyRole", path, "",
