...
public class NonpublicExecutionReportAcknowledgementValidator implements Validator<NonpublicExecutionReportAcknowledgement> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("NonpublicExecutionReportAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "NonpublicExecutionReportAcknowledgement", path, "", res.getError());
				}
				return success("NonpublicExecutionReportAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "NonpublicExecutionReportAcknowledgement", path, "");
			})
			.collect(toList());
	}
