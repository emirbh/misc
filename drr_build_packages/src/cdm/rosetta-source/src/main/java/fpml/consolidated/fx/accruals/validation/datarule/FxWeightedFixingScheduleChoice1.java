 ...
 * @version 2.1.1
 */
@RosettaDataRule("FxWeightedFixingScheduleChoice1")
@ImplementedBy(FxWeightedFixingScheduleChoice1.Default.class)
public interface FxWeightedFixingScheduleChoice1 extends Validator<FxWeightedFixingSchedule> {
	
	String NAME = "FxWeightedFixingScheduleChoice1";
	String DEFINITION = "optional choice observationFrequency, businessCentersReference";
	
	class Default implements FxWeightedFixingScheduleChoice1 {
		...
		private ComparisonResult executeDataRule(FxWeightedFixingSchedule fxWeightedFixingSchedule) {
			try {
				return choice(MapperS.of(fxWeightedFixingSchedule), Arrays.asList("observationFrequency", "businessCentersReference"), ChoiceRuleValidationMethod.OPTIONAL);
			}
			catch (Exception ex) {
	...
	class NoOp implements FxWeightedFixingScheduleChoice1 {
