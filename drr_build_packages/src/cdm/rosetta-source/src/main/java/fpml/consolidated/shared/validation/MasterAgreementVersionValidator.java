		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MasterAgreementVersion", ValidationResult.ValidationType.CARDINALITY, "MasterAgreementVersion", path, "", res.getError());
				}
				return success("MasterAgreementVersion", ValidationResult.ValidationType.CARDINALITY, "MasterAgreementVersion", path, "");
			})
			.collect(toList());
	}
