...
public class LoanInterestPaymentOnlyExistsValidator implements ValidatorWithArg<LoanInterestPayment, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanInterestPayment> ValidationResult<LoanInterestPayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("lenderShareCalculationMethod", ExistenceChecker.isSet((InterestCalculationMethodEnum) o.getLenderShareCalculationMethod()))
		...
		if (setFields.equals(fields)) {
			return success("LoanInterestPayment", ValidationResult.ValidationType.ONLY_EXISTS, "LoanInterestPayment", path, "");
		}
		return failure("LoanInterestPayment", ValidationResult.ValidationType.ONLY_EXISTS, "LoanInterestPayment", path, "",
