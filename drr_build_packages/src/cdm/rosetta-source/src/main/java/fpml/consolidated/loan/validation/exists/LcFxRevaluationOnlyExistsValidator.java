...
public class LcFxRevaluationOnlyExistsValidator implements ValidatorWithArg<LcFxRevaluation, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LcFxRevaluation> ValidationResult<LcFxRevaluation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("lcFxRate", ExistenceChecker.isSet((FxTerms) o.getLcFxRate()))
		...
		if (setFields.equals(fields)) {
			return success("LcFxRevaluation", ValidationResult.ValidationType.ONLY_EXISTS, "LcFxRevaluation", path, "");
		}
		return failure("LcFxRevaluation", ValidationResult.ValidationType.ONLY_EXISTS, "LcFxRevaluation", path, "",
