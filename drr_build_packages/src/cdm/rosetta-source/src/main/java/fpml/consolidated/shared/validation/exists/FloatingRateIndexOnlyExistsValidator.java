...
public class FloatingRateIndexOnlyExistsValidator implements ValidatorWithArg<FloatingRateIndex, Set<String>> {
	...
	public <T2 extends FloatingRateIndex> ValidationResult<FloatingRateIndex> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("floatingRateIndexScheme", ExistenceChecker.isSet((String) o.getFloatingRateIndexScheme()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("FloatingRateIndex", ValidationResult.ValidationType.ONLY_EXISTS, "FloatingRateIndex", path, "");
		}
		return failure("FloatingRateIndex", ValidationResult.ValidationType.ONLY_EXISTS, "FloatingRateIndex", path, "",
