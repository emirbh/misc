...
import fpml.consolidated.com.validation.CommodityFrequencyTypeTypeFormatValidator;
import fpml.consolidated.com.validation.CommodityFrequencyTypeValidator;
import fpml.consolidated.com.validation.exists.CommodityFrequencyTypeOnlyExistsValidator;
...
public class CommodityFrequencyTypeMeta implements RosettaMetaData<CommodityFrequencyType> {
	...
	@Override
	public Validator<? super CommodityFrequencyType> validator(ValidatorFactory factory) {
		return factory.<CommodityFrequencyType>create(CommodityFrequencyTypeValidator.class);
	}

	@Override
	public Validator<? super CommodityFrequencyType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CommodityFrequencyType>create(CommodityFrequencyTypeTypeFormatValidator.class);
	}
