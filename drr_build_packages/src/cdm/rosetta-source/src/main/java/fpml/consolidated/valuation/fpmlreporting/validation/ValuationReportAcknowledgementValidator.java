...
public class ValuationReportAcknowledgementValidator implements Validator<ValuationReportAcknowledgement> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ValuationReportAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "ValuationReportAcknowledgement", path, "", res.getError());
				}
				return success("ValuationReportAcknowledgement", ValidationResult.ValidationType.CARDINALITY, "ValuationReportAcknowledgement", path, "");
			})
			.collect(toList());
	}
