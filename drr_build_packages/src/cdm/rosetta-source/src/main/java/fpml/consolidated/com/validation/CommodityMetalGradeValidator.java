		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityMetalGrade", ValidationResult.ValidationType.CARDINALITY, "CommodityMetalGrade", path, "", res.getError());
				}
				return success("CommodityMetalGrade", ValidationResult.ValidationType.CARDINALITY, "CommodityMetalGrade", path, "");
			})
			.collect(toList());
	}
