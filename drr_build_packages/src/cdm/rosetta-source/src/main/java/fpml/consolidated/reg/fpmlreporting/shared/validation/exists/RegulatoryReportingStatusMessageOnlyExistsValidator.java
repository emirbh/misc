...
public class RegulatoryReportingStatusMessageOnlyExistsValidator implements ValidatorWithArg<RegulatoryReportingStatusMessage, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RegulatoryReportingStatusMessage> ValidationResult<RegulatoryReportingStatusMessage> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RegulatoryReportingStatusMessage", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryReportingStatusMessage", path, "");
		}
		return failure("RegulatoryReportingStatusMessage", ValidationResult.ValidationType.ONLY_EXISTS, "RegulatoryReportingStatusMessage", path, "",
