...
import fpml.consolidated.shared.meta.OriginatingEventMeta;
 ...
 *
 */
@RosettaDataType(value="OriginatingEvent", builder=OriginatingEvent.OriginatingEventBuilderImpl.class, version="2.1.1")
@RuneDataType(value="OriginatingEvent", model="fpml", builder=OriginatingEvent.OriginatingEventBuilderImpl.class, version="2.1.1")
public interface OriginatingEvent extends RosettaModelObject {
	...
	class OriginatingEventImpl implements OriginatingEvent {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("originatingEventScheme")
	...
	class OriginatingEventBuilderImpl implements OriginatingEvent.OriginatingEventBuilder {
		...
		@RuneAttribute("value")
		@Override
		public OriginatingEvent.OriginatingEventBuilder setValue(String _value) {
		...
		@RuneAttribute("originatingEventScheme")
		@Override
		public OriginatingEvent.OriginatingEventBuilder setOriginatingEventScheme(String _originatingEventScheme) {
			this.originatingEventScheme = _originatingEventScheme == null ? null : _originatingEventScheme;
			return this;
		}
