		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EntityClassification", ValidationResult.ValidationType.CARDINALITY, "EntityClassification", path, "", res.getError());
				}
				return success("EntityClassification", ValidationResult.ValidationType.CARDINALITY, "EntityClassification", path, "");
			})
			.collect(toList());
	}
