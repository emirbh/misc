...
public class LoanCovenantObligationNotificationTypeFormatValidator implements Validator<LoanCovenantObligationNotification> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanCovenantObligationNotification", ValidationResult.ValidationType.TYPE_FORMAT, "LoanCovenantObligationNotification", path, "", res.getError());
				}
				return success("LoanCovenantObligationNotification", ValidationResult.ValidationType.TYPE_FORMAT, "LoanCovenantObligationNotification", path, "");
			})
			.collect(toList());
	}
