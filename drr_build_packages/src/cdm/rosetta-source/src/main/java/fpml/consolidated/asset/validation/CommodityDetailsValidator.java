		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityDetails", ValidationResult.ValidationType.CARDINALITY, "CommodityDetails", path, "", res.getError());
				}
				return success("CommodityDetails", ValidationResult.ValidationType.CARDINALITY, "CommodityDetails", path, "");
			})
			.collect(toList());
	}
