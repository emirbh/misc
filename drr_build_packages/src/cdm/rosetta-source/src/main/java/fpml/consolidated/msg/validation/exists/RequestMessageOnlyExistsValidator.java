...
public class RequestMessageOnlyExistsValidator implements ValidatorWithArg<RequestMessage, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RequestMessage> ValidationResult<RequestMessage> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestMessage", ValidationResult.ValidationType.ONLY_EXISTS, "RequestMessage", path, "");
		}
		return failure("RequestMessage", ValidationResult.ValidationType.ONLY_EXISTS, "RequestMessage", path, "",
