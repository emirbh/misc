...
import fpml.consolidated.com.meta.SequencedDisruptionFallbackMeta;
 ...
 *
 * Provision A Disruption Fallback with the sequence in which it should be applied relative to other Disruption Fallbacks.
 *
 *
 * Body ISDA
 * Corpus Schema FPML FPML  
 ...
 *
 */
@RosettaDataType(value="SequencedDisruptionFallback", builder=SequencedDisruptionFallback.SequencedDisruptionFallbackBuilderImpl.class, version="2.1.1")
@RuneDataType(value="SequencedDisruptionFallback", model="fpml", builder=SequencedDisruptionFallback.SequencedDisruptionFallbackBuilderImpl.class, version="2.1.1")
public interface SequencedDisruptionFallback extends RosettaModelObject {
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Disruption fallback that applies to the trade.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	 ...
	 * version "recordkeeping-5.13"
	 *
	 * Provision Sequence in which the reference to the disruption fallback should be applied.
	 *
	 *
	 * Body ISDA
	 * Corpus Schema FPML FPML  
	...
	class SequencedDisruptionFallbackBuilderImpl implements SequencedDisruptionFallback.SequencedDisruptionFallbackBuilder {
		...
		@RuneAttribute("fallback")
		@Override
		public SequencedDisruptionFallback.SequencedDisruptionFallbackBuilder setFallback(DisruptionFallback _fallback) {
		...
		@RuneAttribute("sequence")
		@Override
		public SequencedDisruptionFallback.SequencedDisruptionFallbackBuilder setSequence(Integer _sequence) {
			this.sequence = _sequence == null ? null : _sequence;
			return this;
		}
