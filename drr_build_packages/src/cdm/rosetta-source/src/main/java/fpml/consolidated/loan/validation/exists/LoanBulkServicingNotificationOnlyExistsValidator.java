...
public class LoanBulkServicingNotificationOnlyExistsValidator implements ValidatorWithArg<LoanBulkServicingNotification, Set<String>> {
	...
	public <T2 extends LoanBulkServicingNotification> ValidationResult<LoanBulkServicingNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("loanBulkServicingNotificationChoice", ExistenceChecker.isSet((List<? extends LoanBulkServicingNotificationChoice>) o.getLoanBulkServicingNotificationChoice()))
				.put("loanBulkServicingNotificationSequence", ExistenceChecker.isSet((List<? extends LoanBulkServicingNotificationSequence>) o.getLoanBulkServicingNotificationSequence()))
		...
		if (setFields.equals(fields)) {
			return success("LoanBulkServicingNotification", ValidationResult.ValidationType.ONLY_EXISTS, "LoanBulkServicingNotification", path, "");
		}
		return failure("LoanBulkServicingNotification", ValidationResult.ValidationType.ONLY_EXISTS, "LoanBulkServicingNotification", path, "",
