...
import fpml.consolidated.DigestMethod;
import fpml.consolidated.validation.DigestMethodTypeFormatValidator;
import fpml.consolidated.validation.DigestMethodValidator;
import fpml.consolidated.validation.exists.DigestMethodOnlyExistsValidator;
...
public class DigestMethodMeta implements RosettaMetaData<DigestMethod> {
	...
	@Override
	public Validator<? super DigestMethod> validator(ValidatorFactory factory) {
		return factory.<DigestMethod>create(DigestMethodValidator.class);
	}

	@Override
	public Validator<? super DigestMethod> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DigestMethod>create(DigestMethodTypeFormatValidator.class);
	}
