		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityEuropeanExercise", ValidationResult.ValidationType.TYPE_FORMAT, "CommodityEuropeanExercise", path, "", res.getError());
				}
				return success("CommodityEuropeanExercise", ValidationResult.ValidationType.TYPE_FORMAT, "CommodityEuropeanExercise", path, "");
			})
			.collect(toList());
	}
