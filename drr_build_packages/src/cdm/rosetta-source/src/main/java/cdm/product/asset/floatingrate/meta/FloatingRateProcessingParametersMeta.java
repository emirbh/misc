...
public class FloatingRateProcessingParametersMeta implements RosettaMetaData<FloatingRateProcessingParameters> {
	...
	@Override
	public Validator<? super FloatingRateProcessingParameters> validator(ValidatorFactory factory) {
		return factory.<FloatingRateProcessingParameters>create(FloatingRateProcessingParametersValidator.class);
	}

	@Override
	public Validator<? super FloatingRateProcessingParameters> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FloatingRateProcessingParameters>create(FloatingRateProcessingParametersTypeFormatValidator.class);
	}
