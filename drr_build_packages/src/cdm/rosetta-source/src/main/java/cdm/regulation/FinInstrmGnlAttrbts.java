 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FinInstrmGnlAttrbts", builder=FinInstrmGnlAttrbts.FinInstrmGnlAttrbtsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FinInstrmGnlAttrbts", model="cdm", builder=FinInstrmGnlAttrbts.FinInstrmGnlAttrbtsBuilderImpl.class, version="6.23.0")
