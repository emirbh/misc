 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Swp", builder=Swp.SwpBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Swp", model="cdm", builder=Swp.SwpBuilderImpl.class, version="6.23.0")
