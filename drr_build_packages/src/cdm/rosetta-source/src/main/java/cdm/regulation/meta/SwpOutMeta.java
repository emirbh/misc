...
public class SwpOutMeta implements RosettaMetaData<SwpOut> {
	...
	@Override
	public Validator<? super SwpOut> validator(ValidatorFactory factory) {
		return factory.<SwpOut>create(SwpOutValidator.class);
	}

	@Override
	public Validator<? super SwpOut> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SwpOut>create(SwpOutTypeFormatValidator.class);
	}
