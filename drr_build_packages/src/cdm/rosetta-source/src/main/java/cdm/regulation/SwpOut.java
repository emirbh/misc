 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SwpOut", builder=SwpOut.SwpOutBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SwpOut", model="cdm", builder=SwpOut.SwpOutBuilderImpl.class, version="6.23.0")
public interface SwpOut extends RosettaModelObject {
	...
	class SwpOutBuilderImpl implements SwpOut.SwpOutBuilder {
		...
		@RuneAttribute("sngl")
		@Override
		public SwpOut.SwpOutBuilder setSngl(Sngl _sngl) {
