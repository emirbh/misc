 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AncillaryEntity", builder=AncillaryEntity.AncillaryEntityBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AncillaryEntity", model="cdm", builder=AncillaryEntity.AncillaryEntityBuilderImpl.class, version="6.23.0")
