...
@ImplementedBy(CalculationPeriodDatesFpML_ird_22.Default.class)
public interface CalculationPeriodDatesFpML_ird_22 extends Validator<CalculationPeriodDates> {
	...
	class Default implements CalculationPeriodDatesFpML_ird_22 {
	...
	class NoOp implements CalculationPeriodDatesFpML_ird_22 {
