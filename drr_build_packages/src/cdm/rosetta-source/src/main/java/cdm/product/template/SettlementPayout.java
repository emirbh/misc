 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SettlementPayout", builder=SettlementPayout.SettlementPayoutBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SettlementPayout", model="cdm", builder=SettlementPayout.SettlementPayoutBuilderImpl.class, version="6.23.0")
