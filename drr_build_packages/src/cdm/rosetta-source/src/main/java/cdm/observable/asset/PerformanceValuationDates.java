 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PerformanceValuationDates", builder=PerformanceValuationDates.PerformanceValuationDatesBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PerformanceValuationDates", model="cdm", builder=PerformanceValuationDates.PerformanceValuationDatesBuilderImpl.class, version="6.23.0")
