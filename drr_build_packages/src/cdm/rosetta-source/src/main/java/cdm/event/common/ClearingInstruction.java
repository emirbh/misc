 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ClearingInstruction", builder=ClearingInstruction.ClearingInstructionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ClearingInstruction", model="cdm", builder=ClearingInstruction.ClearingInstructionBuilderImpl.class, version="6.23.0")
