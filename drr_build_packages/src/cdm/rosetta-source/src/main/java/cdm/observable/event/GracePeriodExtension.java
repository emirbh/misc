 ...
 * @version 6.23.0
 */
@RosettaDataType(value="GracePeriodExtension", builder=GracePeriodExtension.GracePeriodExtensionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="GracePeriodExtension", model="cdm", builder=GracePeriodExtension.GracePeriodExtensionBuilderImpl.class, version="6.23.0")
