...
public class ObservationParametersMeta implements RosettaMetaData<ObservationParameters> {
	...
	@Override
	public Validator<? super ObservationParameters> validator(ValidatorFactory factory) {
		return factory.<ObservationParameters>create(ObservationParametersValidator.class);
	}

	@Override
	public Validator<? super ObservationParameters> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ObservationParameters>create(ObservationParametersTypeFormatValidator.class);
	}
