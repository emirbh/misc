 ...
 * @version 6.23.0
 */
@RosettaDataType(value="TelephoneNumber", builder=TelephoneNumber.TelephoneNumberBuilderImpl.class, version="6.23.0")
@RuneDataType(value="TelephoneNumber", model="cdm", builder=TelephoneNumber.TelephoneNumberBuilderImpl.class, version="6.23.0")
