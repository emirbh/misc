 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PartyIdentifier", builder=PartyIdentifier.PartyIdentifierBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PartyIdentifier", model="cdm", builder=PartyIdentifier.PartyIdentifierBuilderImpl.class, version="6.23.0")
public interface PartyIdentifier extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface PartyIdentifierBuilder extends PartyIdentifier, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
		...
		PartyIdentifier.PartyIdentifierBuilder setIdentifier(FieldWithMetaString identifier);
		PartyIdentifier.PartyIdentifierBuilder setIdentifierValue(String identifier);
	...
	class PartyIdentifierBuilderImpl implements PartyIdentifier.PartyIdentifierBuilder {
		...
		@RuneAttribute("identifier")
		@Override
		public PartyIdentifier.PartyIdentifierBuilder setIdentifier(FieldWithMetaString _identifier) {
			this.identifier = _identifier == null ? null : _identifier.toBuilder();
			return this;
		}
		
		@Override
		public PartyIdentifier.PartyIdentifierBuilder setIdentifierValue(String _identifier) {
		...
		@RuneAttribute("identifierType")
		@Override
		public PartyIdentifier.PartyIdentifierBuilder setIdentifierType(PartyIdentifierTypeEnum _identifierType) {
		...
		@RuneMetaType
		@Override
		public PartyIdentifier.PartyIdentifierBuilder setMeta(MetaFields _meta) {
