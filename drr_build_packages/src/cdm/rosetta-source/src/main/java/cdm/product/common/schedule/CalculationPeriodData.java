 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CalculationPeriodData", builder=CalculationPeriodData.CalculationPeriodDataBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CalculationPeriodData", model="cdm", builder=CalculationPeriodData.CalculationPeriodDataBuilderImpl.class, version="6.23.0")
