...
public class MessageInformationMeta implements RosettaMetaData<MessageInformation> {
	...
	@Override
	public Validator<? super MessageInformation> validator(ValidatorFactory factory) {
		return factory.<MessageInformation>create(MessageInformationValidator.class);
	}

	@Override
	public Validator<? super MessageInformation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MessageInformation>create(MessageInformationTypeFormatValidator.class);
	}
