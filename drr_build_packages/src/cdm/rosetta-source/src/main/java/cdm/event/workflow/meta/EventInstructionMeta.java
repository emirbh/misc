...
public class EventInstructionMeta implements RosettaMetaData<EventInstruction> {
	...
	@Override
	public Validator<? super EventInstruction> validator(ValidatorFactory factory) {
		return factory.<EventInstruction>create(EventInstructionValidator.class);
	}

	@Override
	public Validator<? super EventInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<EventInstruction>create(EventInstructionTypeFormatValidator.class);
	}
