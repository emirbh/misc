...
public class AssetDeliveryPeriodsMeta implements RosettaMetaData<AssetDeliveryPeriods> {
	...
	@Override
	public Validator<? super AssetDeliveryPeriods> validator(ValidatorFactory factory) {
		return factory.<AssetDeliveryPeriods>create(AssetDeliveryPeriodsValidator.class);
	}

	@Override
	public Validator<? super AssetDeliveryPeriods> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssetDeliveryPeriods>create(AssetDeliveryPeriodsTypeFormatValidator.class);
	}
