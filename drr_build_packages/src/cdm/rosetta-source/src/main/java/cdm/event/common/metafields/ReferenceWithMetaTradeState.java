...
@RosettaDataType(value="ReferenceWithMetaTradeState", builder=ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilderImpl.class, version="0.0.0")
@RuneDataType(value="ReferenceWithMetaTradeState", model="cdm", builder=ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaTradeState extends RosettaModelObject, ReferenceWithMeta<TradeState> {

	ReferenceWithMetaTradeStateMeta metaData = new ReferenceWithMetaTradeStateMeta();
	...
	/*********************** Builder Interface  ***********************/
	interface ReferenceWithMetaTradeStateBuilder extends ReferenceWithMetaTradeState, RosettaModelObjectBuilder, ReferenceWithMeta.ReferenceWithMetaBuilder<TradeState> {
		...
		ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilder prune();
	}
	...
	class ReferenceWithMetaTradeStateBuilderImpl implements ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilder setValue(TradeState _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilder setReference(Reference _reference) {
