...
@RuneDataType(value="ReferenceWithMetaCollateral", model="cdm", builder=ReferenceWithMetaCollateral.ReferenceWithMetaCollateralBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaCollateral extends RosettaModelObject, ReferenceWithMeta<Collateral> {
	...
	class ReferenceWithMetaCollateralBuilderImpl implements ReferenceWithMetaCollateral.ReferenceWithMetaCollateralBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaCollateral.ReferenceWithMetaCollateralBuilder setValue(Collateral _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaCollateral.ReferenceWithMetaCollateralBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaCollateral.ReferenceWithMetaCollateralBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaCollateral.ReferenceWithMetaCollateralBuilder setReference(Reference _reference) {
