...
public class CalculationScheduleMeta implements RosettaMetaData<CalculationSchedule> {
	...
	@Override
	public Validator<? super CalculationSchedule> validator(ValidatorFactory factory) {
		return factory.<CalculationSchedule>create(CalculationScheduleValidator.class);
	}

	@Override
	public Validator<? super CalculationSchedule> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CalculationSchedule>create(CalculationScheduleTypeFormatValidator.class);
	}
