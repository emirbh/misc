...
public class FloatingRateSettingDetailsMeta implements RosettaMetaData<FloatingRateSettingDetails> {
	...
	@Override
	public Validator<? super FloatingRateSettingDetails> validator(ValidatorFactory factory) {
		return factory.<FloatingRateSettingDetails>create(FloatingRateSettingDetailsValidator.class);
	}

	@Override
	public Validator<? super FloatingRateSettingDetails> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FloatingRateSettingDetails>create(FloatingRateSettingDetailsTypeFormatValidator.class);
	}
