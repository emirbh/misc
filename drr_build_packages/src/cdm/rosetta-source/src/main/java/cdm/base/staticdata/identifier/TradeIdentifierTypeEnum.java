...
public enum TradeIdentifierTypeEnum {
	...
	@RosettaEnumValue(value = "UniqueTransactionIdentifier") 
	UNIQUE_TRANSACTION_IDENTIFIER("UniqueTransactionIdentifier", null),
	
	@RosettaEnumValue(value = "UniqueSwapIdentifier") 
	UNIQUE_SWAP_IDENTIFIER("UniqueSwapIdentifier", null)
;
