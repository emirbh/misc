...
@ImplementedBy(Qualify_EquityOption_ParameterReturnVolatility_SingleName.Qualify_EquityOption_ParameterReturnVolatility_SingleNameDefault.class)
public abstract class Qualify_EquityOption_ParameterReturnVolatility_SingleName implements RosettaFunction,IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static class Qualify_EquityOption_ParameterReturnVolatility_SingleNameDefault extends Qualify_EquityOption_ParameterReturnVolatility_SingleName {
		@Override
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = exists(MapperS.of(MapperS.of(economicTerms).<Payout>mapC("getPayout", _economicTerms -> _economicTerms.getPayout()).get()).<OptionPayout>map("getOptionPayout", payout -> payout.getOptionPayout())).andNullSafe(areEqual(MapperS.of(qualify_EquitySwap_ParameterReturnVolatility_SingleName.evaluate(underlierEconomicTerms(economicTerms).get())), MapperS.of(true), CardinalityOperator.All)).get();
