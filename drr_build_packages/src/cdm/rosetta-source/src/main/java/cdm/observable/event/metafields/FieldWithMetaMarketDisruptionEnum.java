...
@RuneDataType(value="FieldWithMetaMarketDisruptionEnum", model="cdm", builder=FieldWithMetaMarketDisruptionEnum.FieldWithMetaMarketDisruptionEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaMarketDisruptionEnum extends RosettaModelObject, FieldWithMeta<MarketDisruptionEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaMarketDisruptionEnumBuilder extends FieldWithMetaMarketDisruptionEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<MarketDisruptionEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaMarketDisruptionEnumBuilderImpl implements FieldWithMetaMarketDisruptionEnum.FieldWithMetaMarketDisruptionEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaMarketDisruptionEnum.FieldWithMetaMarketDisruptionEnumBuilder setValue(MarketDisruptionEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaMarketDisruptionEnum.FieldWithMetaMarketDisruptionEnumBuilder setMeta(MetaFields _meta) {
