 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Instrument", builder=Instrument.InstrumentBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Instrument", model="cdm", builder=Instrument.InstrumentBuilderImpl.class, version="6.23.0")
@RuneChoiceType
