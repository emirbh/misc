 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FailureToPay", builder=FailureToPay.FailureToPayBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FailureToPay", model="cdm", builder=FailureToPay.FailureToPayBuilderImpl.class, version="6.23.0")
