 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ExerciseFee", builder=ExerciseFee.ExerciseFeeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ExerciseFee", model="cdm", builder=ExerciseFee.ExerciseFeeBuilderImpl.class, version="6.23.0")
