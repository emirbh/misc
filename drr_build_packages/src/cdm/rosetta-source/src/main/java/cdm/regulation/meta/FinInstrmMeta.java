...
public class FinInstrmMeta implements RosettaMetaData<FinInstrm> {
	...
	@Override
	public Validator<? super FinInstrm> validator(ValidatorFactory factory) {
		return factory.<FinInstrm>create(FinInstrmValidator.class);
	}

	@Override
	public Validator<? super FinInstrm> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FinInstrm>create(FinInstrmTypeFormatValidator.class);
	}
