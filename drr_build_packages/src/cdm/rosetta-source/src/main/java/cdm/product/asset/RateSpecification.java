 ...
 * @version 6.23.0
 */
@RosettaDataType(value="RateSpecification", builder=RateSpecification.RateSpecificationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="RateSpecification", model="cdm", builder=RateSpecification.RateSpecificationBuilderImpl.class, version="6.23.0")
@RuneChoiceType
