	...
	*/
	...
	public static class Qualify_InterestRate_InflationSwap_Basis_ZeroCouponDefault extends Qualify_InterestRate_InflationSwap_Basis_ZeroCoupon {
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = areEqual(MapperS.of(qualify_BaseProduct_Inflation.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All).andNullSafe(areEqual(MapperS.of(qualify_BaseProduct_CrossCurrency.evaluate(economicTerms)), MapperS.of(false), CardinalityOperator.All)).andNullSafe(areEqual(MapperS.of(qualify_SubProduct_Basis.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All)).andNullSafe(areEqual(MapperS.of(qualify_Transaction_ZeroCoupon.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All)).get();
