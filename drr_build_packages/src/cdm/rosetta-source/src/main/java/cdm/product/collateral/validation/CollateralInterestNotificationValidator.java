		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CollateralInterestNotification", ValidationResult.ValidationType.CARDINALITY, "CollateralInterestNotification", path, "", res.getError());
				}
				return success("CollateralInterestNotification", ValidationResult.ValidationType.CARDINALITY, "CollateralInterestNotification", path, "");
			})
			.collect(toList());
	}
