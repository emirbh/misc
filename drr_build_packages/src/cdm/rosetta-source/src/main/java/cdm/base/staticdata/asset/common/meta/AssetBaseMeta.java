...
public class AssetBaseMeta implements RosettaMetaData<AssetBase> {
	...
	@Override
	public Validator<? super AssetBase> validator(ValidatorFactory factory) {
		return factory.<AssetBase>create(AssetBaseValidator.class);
	}

	@Override
	public Validator<? super AssetBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssetBase>create(AssetBaseTypeFormatValidator.class);
	}
