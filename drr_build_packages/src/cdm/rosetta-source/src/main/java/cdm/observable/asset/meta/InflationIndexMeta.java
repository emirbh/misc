...
import cdm.observable.asset.validation.datarule.InflationIndexInterestRateAssetClass;
...
public class InflationIndexMeta implements RosettaMetaData<InflationIndex> {
	...
	public List<Validator<? super InflationIndex>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<InflationIndex>create(InflationIndexInterestRateAssetClass.class)
		);
	}
	...
	@Override
	public Validator<? super InflationIndex> validator(ValidatorFactory factory) {
		return factory.<InflationIndex>create(InflationIndexValidator.class);
	}

	@Override
	public Validator<? super InflationIndex> typeFormatValidator(ValidatorFactory factory) {
		return factory.<InflationIndex>create(InflationIndexTypeFormatValidator.class);
	}
