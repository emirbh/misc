 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DividendApplicability", builder=DividendApplicability.DividendApplicabilityBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DividendApplicability", model="cdm", builder=DividendApplicability.DividendApplicabilityBuilderImpl.class, version="6.23.0")
public interface DividendApplicability extends RosettaModelObject {
	...
	class DividendApplicabilityBuilderImpl implements DividendApplicability.DividendApplicabilityBuilder {
		...
		@RuneAttribute("optionsExchangeDividends")
		@Override
		public DividendApplicability.DividendApplicabilityBuilder setOptionsExchangeDividends(Boolean _optionsExchangeDividends) {
		...
		@RuneAttribute("additionalDividends")
		@Override
		public DividendApplicability.DividendApplicabilityBuilder setAdditionalDividends(Boolean _additionalDividends) {
		...
		@RuneAttribute("allDividends")
		@Override
		public DividendApplicability.DividendApplicabilityBuilder setAllDividends(Boolean _allDividends) {
