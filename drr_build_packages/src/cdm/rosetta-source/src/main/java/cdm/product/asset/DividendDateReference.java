 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DividendDateReference", builder=DividendDateReference.DividendDateReferenceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DividendDateReference", model="cdm", builder=DividendDateReference.DividendDateReferenceBuilderImpl.class, version="6.23.0")
public interface DividendDateReference extends RosettaModelObject {
	...
	class DividendDateReferenceBuilderImpl implements DividendDateReference.DividendDateReferenceBuilder {
		...
		@RuneAttribute("dateReference")
		@Override
		public DividendDateReference.DividendDateReferenceBuilder setDateReference(DividendDateReferenceEnum _dateReference) {
			this.dateReference = _dateReference == null ? null : _dateReference;
			return this;
		}
		...
		@RuneAttribute("paymentDateOffset")
		@Override
		public DividendDateReference.DividendDateReferenceBuilder setPaymentDateOffset(Offset _paymentDateOffset) {
