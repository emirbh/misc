 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FloatingRateBase", builder=FloatingRateBase.FloatingRateBaseBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FloatingRateBase", model="cdm", builder=FloatingRateBase.FloatingRateBaseBuilderImpl.class, version="6.23.0")
