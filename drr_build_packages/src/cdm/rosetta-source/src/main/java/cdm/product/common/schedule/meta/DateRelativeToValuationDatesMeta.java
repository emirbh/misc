...
public class DateRelativeToValuationDatesMeta implements RosettaMetaData<DateRelativeToValuationDates> {
	...
	@Override
	public Validator<? super DateRelativeToValuationDates> validator(ValidatorFactory factory) {
		return factory.<DateRelativeToValuationDates>create(DateRelativeToValuationDatesValidator.class);
	}

	@Override
	public Validator<? super DateRelativeToValuationDates> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DateRelativeToValuationDates>create(DateRelativeToValuationDatesTypeFormatValidator.class);
	}
