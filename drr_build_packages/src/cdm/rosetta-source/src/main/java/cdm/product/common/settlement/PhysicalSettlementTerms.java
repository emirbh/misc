 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PhysicalSettlementTerms", builder=PhysicalSettlementTerms.PhysicalSettlementTermsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PhysicalSettlementTerms", model="cdm", builder=PhysicalSettlementTerms.PhysicalSettlementTermsBuilderImpl.class, version="6.23.0")
public interface PhysicalSettlementTerms extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface PhysicalSettlementTermsBuilder extends PhysicalSettlementTerms, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class PhysicalSettlementTermsImpl implements PhysicalSettlementTerms {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("predeterminedClearingOrganizationParty")
	...
	class PhysicalSettlementTermsBuilderImpl implements PhysicalSettlementTerms.PhysicalSettlementTermsBuilder {
		...
		@RuneAttribute("clearedPhysicalSettlement")
		@Override
		public PhysicalSettlementTerms.PhysicalSettlementTermsBuilder setClearedPhysicalSettlement(Boolean _clearedPhysicalSettlement) {
		...
		@RuneAttribute("predeterminedClearingOrganizationParty")
		@Override
		public PhysicalSettlementTerms.PhysicalSettlementTermsBuilder setPredeterminedClearingOrganizationParty(AncillaryRoleEnum _predeterminedClearingOrganizationParty) {
			this.predeterminedClearingOrganizationParty = _predeterminedClearingOrganizationParty == null ? null : _predeterminedClearingOrganizationParty;
			return this;
		}
		...
		@RuneMetaType
		@Override
		public PhysicalSettlementTerms.PhysicalSettlementTermsBuilder setMeta(MetaFields _meta) {
