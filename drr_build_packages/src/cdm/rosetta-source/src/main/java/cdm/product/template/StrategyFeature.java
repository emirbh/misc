 ...
 * @version 6.23.0
 */
@RosettaDataType(value="StrategyFeature", builder=StrategyFeature.StrategyFeatureBuilderImpl.class, version="6.23.0")
@RuneDataType(value="StrategyFeature", model="cdm", builder=StrategyFeature.StrategyFeatureBuilderImpl.class, version="6.23.0")
