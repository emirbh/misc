 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AdjustableOrRelativeDates", builder=AdjustableOrRelativeDates.AdjustableOrRelativeDatesBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AdjustableOrRelativeDates", model="cdm", builder=AdjustableOrRelativeDates.AdjustableOrRelativeDatesBuilderImpl.class, version="6.23.0")
public interface AdjustableOrRelativeDates extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface AdjustableOrRelativeDatesBuilder extends AdjustableOrRelativeDates, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class AdjustableOrRelativeDatesBuilderImpl implements AdjustableOrRelativeDates.AdjustableOrRelativeDatesBuilder {
		...
		@RuneMetaType
		@Override
		public AdjustableOrRelativeDates.AdjustableOrRelativeDatesBuilder setMeta(MetaFields _meta) {
