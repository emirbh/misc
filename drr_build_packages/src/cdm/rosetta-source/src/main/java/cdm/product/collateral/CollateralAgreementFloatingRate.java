 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CollateralAgreementFloatingRate", builder=CollateralAgreementFloatingRate.CollateralAgreementFloatingRateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CollateralAgreementFloatingRate", model="cdm", builder=CollateralAgreementFloatingRate.CollateralAgreementFloatingRateBuilderImpl.class, version="6.23.0")
