 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AssetCountryOfOrigin", builder=AssetCountryOfOrigin.AssetCountryOfOriginBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AssetCountryOfOrigin", model="cdm", builder=AssetCountryOfOrigin.AssetCountryOfOriginBuilderImpl.class, version="6.23.0")
