 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ExtensionEvent", builder=ExtensionEvent.ExtensionEventBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ExtensionEvent", model="cdm", builder=ExtensionEvent.ExtensionEventBuilderImpl.class, version="6.23.0")
