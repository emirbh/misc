 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Velocity", builder=Velocity.VelocityBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Velocity", model="cdm", builder=Velocity.VelocityBuilderImpl.class, version="6.23.0")
