...
import cdm.product.common.settlement.validation.datarule.PrincipalPaymentScheduleInitialPrincipalAmountExists;
...
public class PrincipalPaymentScheduleMeta implements RosettaMetaData<PrincipalPaymentSchedule> {
	...
	public List<Validator<? super PrincipalPaymentSchedule>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<PrincipalPaymentSchedule>create(PrincipalPaymentScheduleInitialPrincipalAmountExists.class)
		);
	}
	...
	@Override
	public Validator<? super PrincipalPaymentSchedule> validator(ValidatorFactory factory) {
		return factory.<PrincipalPaymentSchedule>create(PrincipalPaymentScheduleValidator.class);
	}

	@Override
	public Validator<? super PrincipalPaymentSchedule> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PrincipalPaymentSchedule>create(PrincipalPaymentScheduleTypeFormatValidator.class);
	}
