 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PaymentRule", builder=PaymentRule.PaymentRuleBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PaymentRule", model="cdm", builder=PaymentRule.PaymentRuleBuilderImpl.class, version="6.23.0")
public interface PaymentRule extends RosettaModelObject {
	...
	class PaymentRuleBuilderImpl implements PaymentRule.PaymentRuleBuilder {
		...
		@RuneAttribute("percentageRule")
		@Override
		public PaymentRule.PaymentRuleBuilder setPercentageRule(PercentageRule _percentageRule) {
			this.percentageRule = _percentageRule == null ? null : _percentageRule.toBuilder();
			return this;
		}
