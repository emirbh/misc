 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FxFixingDate", builder=FxFixingDate.FxFixingDateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FxFixingDate", model="cdm", builder=FxFixingDate.FxFixingDateBuilderImpl.class, version="6.23.0")
public interface FxFixingDate extends Offset {
	...
	class FxFixingDateBuilderImpl extends Offset.OffsetBuilderImpl implements FxFixingDate.FxFixingDateBuilder {
		...
		@RuneMetaType
		@Override
		public FxFixingDate.FxFixingDateBuilder setMeta(MetaFields _meta) {
		...
		@RuneAttribute("businessCentersReference")
		@Override
		public FxFixingDate.FxFixingDateBuilder setBusinessCentersReference(ReferenceWithMetaBusinessCenters _businessCentersReference) {
			this.businessCentersReference = _businessCentersReference == null ? null : _businessCentersReference.toBuilder();
			return this;
		}
		
		@Override
		public FxFixingDate.FxFixingDateBuilder setBusinessCentersReferenceValue(BusinessCenters _businessCentersReference) {
		...
		@RuneAttribute("dateRelativeToValuationDates")
		@Override
		public FxFixingDate.FxFixingDateBuilder setDateRelativeToValuationDates(DateRelativeToValuationDates _dateRelativeToValuationDates) {
			this.dateRelativeToValuationDates = _dateRelativeToValuationDates == null ? null : _dateRelativeToValuationDates.toBuilder();
			return this;
		}
		...
		@RuneAttribute("fxFixingDate")
		@Override
		public FxFixingDate.FxFixingDateBuilder setFxFixingDate(AdjustableOrRelativeDate _fxFixingDate) {
