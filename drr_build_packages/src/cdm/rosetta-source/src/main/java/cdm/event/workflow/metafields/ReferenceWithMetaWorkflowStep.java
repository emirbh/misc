...
@RuneDataType(value="ReferenceWithMetaWorkflowStep", model="cdm", builder=ReferenceWithMetaWorkflowStep.ReferenceWithMetaWorkflowStepBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaWorkflowStep extends RosettaModelObject, ReferenceWithMeta<WorkflowStep> {
	...
	class ReferenceWithMetaWorkflowStepBuilderImpl implements ReferenceWithMetaWorkflowStep.ReferenceWithMetaWorkflowStepBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaWorkflowStep.ReferenceWithMetaWorkflowStepBuilder setValue(WorkflowStep _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaWorkflowStep.ReferenceWithMetaWorkflowStepBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaWorkflowStep.ReferenceWithMetaWorkflowStepBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaWorkflowStep.ReferenceWithMetaWorkflowStepBuilder setReference(Reference _reference) {
