...
import cdm.event.common.validation.ClosedStateTypeFormatValidator;
import cdm.event.common.validation.ClosedStateValidator;
import cdm.event.common.validation.exists.ClosedStateOnlyExistsValidator;
...
public class ClosedStateMeta implements RosettaMetaData<ClosedState> {
	...
	@Override
	public Validator<? super ClosedState> validator(ValidatorFactory factory) {
		return factory.<ClosedState>create(ClosedStateValidator.class);
	}

	@Override
	public Validator<? super ClosedState> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ClosedState>create(ClosedStateTypeFormatValidator.class);
	}
