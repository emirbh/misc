...
public class BillingSummaryInstructionMeta implements RosettaMetaData<BillingSummaryInstruction> {
	...
	@Override
	public Validator<? super BillingSummaryInstruction> validator(ValidatorFactory factory) {
		return factory.<BillingSummaryInstruction>create(BillingSummaryInstructionValidator.class);
	}

	@Override
	public Validator<? super BillingSummaryInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<BillingSummaryInstruction>create(BillingSummaryInstructionTypeFormatValidator.class);
	}
