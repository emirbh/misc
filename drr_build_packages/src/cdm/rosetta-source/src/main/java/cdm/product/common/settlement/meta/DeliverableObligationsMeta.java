...
import cdm.product.common.settlement.validation.datarule.DeliverableObligationsDeliverableObligationsChoice;
import cdm.product.common.settlement.validation.datarule.DeliverableObligationsFpML_cd_34;
...
public class DeliverableObligationsMeta implements RosettaMetaData<DeliverableObligations> {
	...
	public List<Validator<? super DeliverableObligations>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<DeliverableObligations>create(DeliverableObligationsDeliverableObligationsChoice.class),
			factory.<DeliverableObligations>create(DeliverableObligationsFpML_cd_34.class)
		);
	}
