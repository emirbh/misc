...
public class OptionalEarlyTerminationMeta implements RosettaMetaData<OptionalEarlyTermination> {
	...
	public List<Validator<? super OptionalEarlyTermination>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<OptionalEarlyTermination>create(OptionalEarlyTerminationOptionalEarlyTerminationExerciseNoticeReceiverParty.class),
			factory.<OptionalEarlyTermination>create(OptionalEarlyTerminationMandatoryEarlyTerminationCalculationAgent.class)
		);
	}
