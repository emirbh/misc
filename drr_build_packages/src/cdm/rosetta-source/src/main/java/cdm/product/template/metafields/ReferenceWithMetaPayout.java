...
@RuneDataType(value="ReferenceWithMetaPayout", model="cdm", builder=ReferenceWithMetaPayout.ReferenceWithMetaPayoutBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaPayout extends RosettaModelObject, ReferenceWithMeta<Payout> {
	...
	class ReferenceWithMetaPayoutBuilderImpl implements ReferenceWithMetaPayout.ReferenceWithMetaPayoutBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPayout.ReferenceWithMetaPayoutBuilder setValue(Payout _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaPayout.ReferenceWithMetaPayoutBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaPayout.ReferenceWithMetaPayoutBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPayout.ReferenceWithMetaPayoutBuilder setReference(Reference _reference) {
