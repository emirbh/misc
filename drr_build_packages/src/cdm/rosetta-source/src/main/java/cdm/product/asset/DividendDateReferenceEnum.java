...
public enum DividendDateReferenceEnum {
	 ...
	 */
	@RosettaEnumValue(value = "AdHocDate") 
	AD_HOC_DATE("AdHocDate", null),
	 ...
	 */
	@RosettaEnumValue(value = "CashSettlementPaymentDate") 
	CASH_SETTLEMENT_PAYMENT_DATE("CashSettlementPaymentDate", null),
	
	/**
	 * If &#39;Dividend Payment Date(s)&#39; is specified in the Transaction Supplement as &#39;Cash Settlement Payment Date – Ex Dividend&#39;&#39;, then the Dividend Payment Date in respect of a Dividend Amount shall be the Cash Settlement Payment Date relating to the end of the Dividend Period during which the Shares commenced trading &#39;ex&#39; the relevant dividend on the Exchange.
	 */
	@RosettaEnumValue(value = "CashSettlePaymentDateExDiv") 
	CASH_SETTLE_PAYMENT_DATE_EX_DIV("CashSettlePaymentDateExDiv", null),
	 ...
	 */
	@RosettaEnumValue(value = "CashSettlePaymentDateIssuerPayment") 
	CASH_SETTLE_PAYMENT_DATE_ISSUER_PAYMENT("CashSettlePaymentDateIssuerPayment", null),
	 ...
	 */
	@RosettaEnumValue(value = "CumulativeEquityExDiv") 
	CUMULATIVE_EQUITY_EX_DIV("CumulativeEquityExDiv", null),
	 ...
	 */
	@RosettaEnumValue(value = "CumulativeEquityPaid") 
	CUMULATIVE_EQUITY_PAID("CumulativeEquityPaid", null),
	 ...
	 */
	@RosettaEnumValue(value = "CumulativeEquityExDivBeforeReset") 
	CUMULATIVE_EQUITY_EX_DIV_BEFORE_RESET("CumulativeEquityExDivBeforeReset", null),
	 ...
	 */
	@RosettaEnumValue(value = "CumulativeEquityPaidBeforeReset") 
	CUMULATIVE_EQUITY_PAID_BEFORE_RESET("CumulativeEquityPaidBeforeReset", null),
	 ...
	 */
	@RosettaEnumValue(value = "CumulativeEquityPaidInclReset") 
	CUMULATIVE_EQUITY_PAID_INCL_RESET("CumulativeEquityPaidInclReset", null),
	 ...
	 */
	@RosettaEnumValue(value = "CumulativeInterestExDiv") 
	CUMULATIVE_INTEREST_EX_DIV("CumulativeInterestExDiv", null),
	 ...
	 */
	@RosettaEnumValue(value = "CumulativeInterestPaid") 
	CUMULATIVE_INTEREST_PAID("CumulativeInterestPaid", null),
	 ...
	 */
	@RosettaEnumValue(value = "CumulativeInterestPaidInclReset") 
	CUMULATIVE_INTEREST_PAID_INCL_RESET("CumulativeInterestPaidInclReset", null),
	 ...
	 */
	@RosettaEnumValue(value = "CumulativeInterestPaidBeforeReset") 
	CUMULATIVE_INTEREST_PAID_BEFORE_RESET("CumulativeInterestPaidBeforeReset", null),
	
	/**
	 * Date on which the dividend will be paid by the issuer.
	 */
	@RosettaEnumValue(value = "DividendPaymentDate") 
	DIVIDEND_PAYMENT_DATE("DividendPaymentDate", null),
	
	/**
	 * In respect of each Dividend Period, the relevant Dividend Valuation Date.
	 */
	@RosettaEnumValue(value = "DividendValuationDate") 
	DIVIDEND_VALUATION_DATE("DividendValuationDate", null),
	
	/**
	 * Equity payment date of the swap.
	 */
	@RosettaEnumValue(value = "EquityPaymentDate") 
	EQUITY_PAYMENT_DATE("EquityPaymentDate", null),
	 ...
	 */
	@RosettaEnumValue(value = "FloatingAmountPaymentDate") 
	FLOATING_AMOUNT_PAYMENT_DATE("FloatingAmountPaymentDate", null),
	
	/**
	 * The next payment date of the swap.
	 */
	@RosettaEnumValue(value = "FollowingPaymentDate") 
	FOLLOWING_PAYMENT_DATE("FollowingPaymentDate", null),
	 ...
	 */
	@RosettaEnumValue(value = "SharePayment") 
	SHARE_PAYMENT("SharePayment", null),
	
	/**
	 * Termination date of the swap.
	 */
	@RosettaEnumValue(value = "TerminationDate") 
	TERMINATION_DATE("TerminationDate", null),
	
	/**
	 * Trade date of the swap
	 */
	@RosettaEnumValue(value = "TradeDate") 
	 ...
	 */
	@RosettaEnumValue(value = "UnwindOrEquityExDiv") 
	UNWIND_OR_EQUITY_EX_DIV("UnwindOrEquityExDiv", null),
	 ...
	 */
	@RosettaEnumValue(value = "UnwindOrEquityPaid") 
	UNWIND_OR_EQUITY_PAID("UnwindOrEquityPaid", null),
	 ...
	 */
	@RosettaEnumValue(value = "UnwindOrInterestExDiv") 
	UNWIND_OR_INTEREST_EX_DIV("UnwindOrInterestExDiv", null),
	 ...
	 */
	@RosettaEnumValue(value = "UnwindOrInterestPaid") 
	UNWIND_OR_INTEREST_PAID("UnwindOrInterestPaid", null),
	 ...
	 */
	@RosettaEnumValue(value = "UnwindExDiv") 
	UNWIND_EX_DIV("UnwindExDiv", null),
	 ...
	 */
	@RosettaEnumValue(value = "UnwindPaid") 
	UNWIND_PAID("UnwindPaid", null)
;
