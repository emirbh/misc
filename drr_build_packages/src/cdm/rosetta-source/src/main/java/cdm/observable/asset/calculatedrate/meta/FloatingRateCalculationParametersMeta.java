...
public class FloatingRateCalculationParametersMeta implements RosettaMetaData<FloatingRateCalculationParameters> {
	...
	@Override
	public Validator<? super FloatingRateCalculationParameters> validator(ValidatorFactory factory) {
		return factory.<FloatingRateCalculationParameters>create(FloatingRateCalculationParametersValidator.class);
	}

	@Override
	public Validator<? super FloatingRateCalculationParameters> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FloatingRateCalculationParameters>create(FloatingRateCalculationParametersTypeFormatValidator.class);
	}
