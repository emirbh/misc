		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AssetCountryOfOrigin", ValidationResult.ValidationType.TYPE_FORMAT, "AssetCountryOfOrigin", path, "", res.getError());
				}
				return success("AssetCountryOfOrigin", ValidationResult.ValidationType.TYPE_FORMAT, "AssetCountryOfOrigin", path, "");
			})
			.collect(toList());
	}
