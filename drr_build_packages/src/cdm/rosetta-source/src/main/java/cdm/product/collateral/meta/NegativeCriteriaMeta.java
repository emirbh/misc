...
public class NegativeCriteriaMeta implements RosettaMetaData<NegativeCriteria> {
	...
	@Override
	public Validator<? super NegativeCriteria> validator(ValidatorFactory factory) {
		return factory.<NegativeCriteria>create(NegativeCriteriaValidator.class);
	}

	@Override
	public Validator<? super NegativeCriteria> typeFormatValidator(ValidatorFactory factory) {
		return factory.<NegativeCriteria>create(NegativeCriteriaTypeFormatValidator.class);
	}
