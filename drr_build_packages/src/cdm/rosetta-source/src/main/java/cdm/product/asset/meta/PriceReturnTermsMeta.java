...
public class PriceReturnTermsMeta implements RosettaMetaData<PriceReturnTerms> {
	...
	@Override
	public Validator<? super PriceReturnTerms> validator(ValidatorFactory factory) {
		return factory.<PriceReturnTerms>create(PriceReturnTermsValidator.class);
	}

	@Override
	public Validator<? super PriceReturnTerms> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PriceReturnTerms>create(PriceReturnTermsTypeFormatValidator.class);
	}
