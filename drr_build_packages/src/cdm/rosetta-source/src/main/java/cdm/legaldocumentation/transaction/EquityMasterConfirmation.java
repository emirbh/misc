...
import cdm.legaldocumentation.transaction.meta.EquityMasterConfirmationMeta;
 ...
 * @version 6.23.0
 */
@RosettaDataType(value="EquityMasterConfirmation", builder=EquityMasterConfirmation.EquityMasterConfirmationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="EquityMasterConfirmation", model="cdm", builder=EquityMasterConfirmation.EquityMasterConfirmationBuilderImpl.class, version="6.23.0")
