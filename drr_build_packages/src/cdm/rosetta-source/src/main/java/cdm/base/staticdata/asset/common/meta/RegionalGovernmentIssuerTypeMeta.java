...
public class RegionalGovernmentIssuerTypeMeta implements RosettaMetaData<RegionalGovernmentIssuerType> {
	...
	@Override
	public Validator<? super RegionalGovernmentIssuerType> validator(ValidatorFactory factory) {
		return factory.<RegionalGovernmentIssuerType>create(RegionalGovernmentIssuerTypeValidator.class);
	}

	@Override
	public Validator<? super RegionalGovernmentIssuerType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<RegionalGovernmentIssuerType>create(RegionalGovernmentIssuerTypeTypeFormatValidator.class);
	}
