...
public class AssetDeliveryInformationOnlyExistsValidator implements ValidatorWithArg<AssetDeliveryInformation, Set<String>> {
	...
	public <T2 extends AssetDeliveryInformation> ValidationResult<AssetDeliveryInformation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("commodityGrade", ExistenceChecker.isSet((List<ProductGradeEnum>) o.getCommodityGrade()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AssetDeliveryInformation", ValidationResult.ValidationType.ONLY_EXISTS, "AssetDeliveryInformation", path, "");
		}
		return failure("AssetDeliveryInformation", ValidationResult.ValidationType.ONLY_EXISTS, "AssetDeliveryInformation", path, "",
