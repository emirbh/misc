...
public enum PartyDeterminationEnum {
	 ...
	 */
	@RosettaEnumValue(value = "ExercisingParty") 
	EXERCISING_PARTY("ExercisingParty", null),
	
	/**
	 * The party that is given notice of exercise. Per 2000 ISDA Definitions, Section 11.1. Parties, paragraph (e).
	 */
	@RosettaEnumValue(value = "NonExercisingParty") 
	NON_EXERCISING_PARTY("NonExercisingParty", null),
	 ...
	 */
	@RosettaEnumValue(value = "AsSpecifiedInStandardTermsSupplement") 
	AS_SPECIFIED_IN_STANDARD_TERMS_SUPPLEMENT("AsSpecifiedInStandardTermsSupplement", null),
