...
public class IssuerNameMeta implements RosettaMetaData<IssuerName> {
	...
	@Override
	public Validator<? super IssuerName> validator(ValidatorFactory factory) {
		return factory.<IssuerName>create(IssuerNameValidator.class);
	}

	@Override
	public Validator<? super IssuerName> typeFormatValidator(ValidatorFactory factory) {
		return factory.<IssuerName>create(IssuerNameTypeFormatValidator.class);
	}
