...
public class DeliveryAmountMeta implements RosettaMetaData<DeliveryAmount> {
	...
	public List<Validator<? super DeliveryAmount>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<DeliveryAmount>create(DeliveryAmountOneOf0.class)
		);
	}
	...
	@Override
	public Validator<? super DeliveryAmount> validator(ValidatorFactory factory) {
		return factory.<DeliveryAmount>create(DeliveryAmountValidator.class);
	}

	@Override
	public Validator<? super DeliveryAmount> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DeliveryAmount>create(DeliveryAmountTypeFormatValidator.class);
	}
