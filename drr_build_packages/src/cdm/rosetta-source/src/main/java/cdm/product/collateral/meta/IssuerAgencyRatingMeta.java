...
public class IssuerAgencyRatingMeta implements RosettaMetaData<IssuerAgencyRating> {
	...
	@Override
	public Validator<? super IssuerAgencyRating> validator(ValidatorFactory factory) {
		return factory.<IssuerAgencyRating>create(IssuerAgencyRatingValidator.class);
	}

	@Override
	public Validator<? super IssuerAgencyRating> typeFormatValidator(ValidatorFactory factory) {
		return factory.<IssuerAgencyRating>create(IssuerAgencyRatingTypeFormatValidator.class);
	}
