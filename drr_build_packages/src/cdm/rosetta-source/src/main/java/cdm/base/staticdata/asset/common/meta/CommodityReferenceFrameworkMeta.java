...
import cdm.base.staticdata.asset.common.validation.datarule.CommodityReferenceFrameworkCommodityReferenceFrameworkChoice;
...
public class CommodityReferenceFrameworkMeta implements RosettaMetaData<CommodityReferenceFramework> {
	...
	public List<Validator<? super CommodityReferenceFramework>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<CommodityReferenceFramework>create(CommodityReferenceFrameworkCommodityReferenceFrameworkChoice.class)
		);
	}
	...
	@Override
	public Validator<? super CommodityReferenceFramework> validator(ValidatorFactory factory) {
		return factory.<CommodityReferenceFramework>create(CommodityReferenceFrameworkValidator.class);
	}

	@Override
	public Validator<? super CommodityReferenceFramework> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CommodityReferenceFramework>create(CommodityReferenceFrameworkTypeFormatValidator.class);
	}
