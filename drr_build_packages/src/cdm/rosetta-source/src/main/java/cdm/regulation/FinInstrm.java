 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FinInstrm", builder=FinInstrm.FinInstrmBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FinInstrm", model="cdm", builder=FinInstrm.FinInstrmBuilderImpl.class, version="6.23.0")
public interface FinInstrm extends RosettaModelObject {
	...
	class FinInstrmBuilderImpl implements FinInstrm.FinInstrmBuilder {
		...
		@RuneAttribute("othr")
		@Override
		public FinInstrm.FinInstrmBuilder setOthr(Othr _othr) {
