 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CalculationPeriodBase", builder=CalculationPeriodBase.CalculationPeriodBaseBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CalculationPeriodBase", model="cdm", builder=CalculationPeriodBase.CalculationPeriodBaseBuilderImpl.class, version="6.23.0")
public interface CalculationPeriodBase extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface CalculationPeriodBaseBuilder extends CalculationPeriodBase, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class CalculationPeriodBaseBuilderImpl implements CalculationPeriodBase.CalculationPeriodBaseBuilder {
		...
		@RuneAttribute("adjustedStartDate")
		@Override
		public CalculationPeriodBase.CalculationPeriodBaseBuilder setAdjustedStartDate(Date _adjustedStartDate) {
		...
		@RuneAttribute("adjustedEndDate")
		@Override
		public CalculationPeriodBase.CalculationPeriodBaseBuilder setAdjustedEndDate(Date _adjustedEndDate) {
		...
		@RuneMetaType
		@Override
		public CalculationPeriodBase.CalculationPeriodBaseBuilder setMeta(MetaFields _meta) {
