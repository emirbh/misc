 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Othr", builder=Othr.OthrBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Othr", model="cdm", builder=Othr.OthrBuilderImpl.class, version="6.23.0")
