...
public class PayoutBaseMeta implements RosettaMetaData<PayoutBase> {
	...
	@Override
	public Validator<? super PayoutBase> validator(ValidatorFactory factory) {
		return factory.<PayoutBase>create(PayoutBaseValidator.class);
	}

	@Override
	public Validator<? super PayoutBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PayoutBase>create(PayoutBaseTypeFormatValidator.class);
	}
