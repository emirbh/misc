...
public class CommodityProductDefinitionMeta implements RosettaMetaData<CommodityProductDefinition> {
	...
	public List<Validator<? super CommodityProductDefinition>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<CommodityProductDefinition>create(CommodityProductDefinitionCommodityProductDefinitionChoice.class)
		);
	}
	...
	@Override
	public Validator<? super CommodityProductDefinition> validator(ValidatorFactory factory) {
		return factory.<CommodityProductDefinition>create(CommodityProductDefinitionValidator.class);
	}

	@Override
	public Validator<? super CommodityProductDefinition> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CommodityProductDefinition>create(CommodityProductDefinitionTypeFormatValidator.class);
	}
