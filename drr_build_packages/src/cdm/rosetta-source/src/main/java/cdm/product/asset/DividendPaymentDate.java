 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DividendPaymentDate", builder=DividendPaymentDate.DividendPaymentDateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DividendPaymentDate", model="cdm", builder=DividendPaymentDate.DividendPaymentDateBuilderImpl.class, version="6.23.0")
public interface DividendPaymentDate extends RosettaModelObject {
	...
	class DividendPaymentDateBuilderImpl implements DividendPaymentDate.DividendPaymentDateBuilder {
		...
		@RuneAttribute("dividendDateReference")
		@Override
		public DividendPaymentDate.DividendPaymentDateBuilder setDividendDateReference(DividendDateReference _dividendDateReference) {
			this.dividendDateReference = _dividendDateReference == null ? null : _dividendDateReference.toBuilder();
			return this;
		}
		...
		@RuneAttribute("dividendDate")
		@Override
		public DividendPaymentDate.DividendPaymentDateBuilder setDividendDate(ReferenceWithMetaAdjustableOrRelativeDate _dividendDate) {
			this.dividendDate = _dividendDate == null ? null : _dividendDate.toBuilder();
			return this;
		}
		
		@Override
		public DividendPaymentDate.DividendPaymentDateBuilder setDividendDateValue(AdjustableOrRelativeDate _dividendDate) {
			this.getOrCreateDividendDate().setValue(_dividendDate);
			return this;
		}
