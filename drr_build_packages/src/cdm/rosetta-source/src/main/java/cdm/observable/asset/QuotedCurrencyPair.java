 ...
 * @version 6.23.0
 */
@RosettaDataType(value="QuotedCurrencyPair", builder=QuotedCurrencyPair.QuotedCurrencyPairBuilderImpl.class, version="6.23.0")
@RuneDataType(value="QuotedCurrencyPair", model="cdm", builder=QuotedCurrencyPair.QuotedCurrencyPairBuilderImpl.class, version="6.23.0")
public interface QuotedCurrencyPair extends RosettaModelObject {
	...
	class QuotedCurrencyPairBuilderImpl implements QuotedCurrencyPair.QuotedCurrencyPairBuilder {
		...
		@RuneAttribute("currency1")
		@Override
		public QuotedCurrencyPair.QuotedCurrencyPairBuilder setCurrency1(FieldWithMetaString _currency1) {
			this.currency1 = _currency1 == null ? null : _currency1.toBuilder();
			return this;
		}
		
		@Override
		public QuotedCurrencyPair.QuotedCurrencyPairBuilder setCurrency1Value(String _currency1) {
			this.getOrCreateCurrency1().setValue(_currency1);
			return this;
		}
		...
		@RuneAttribute("currency2")
		@Override
		public QuotedCurrencyPair.QuotedCurrencyPairBuilder setCurrency2(FieldWithMetaString _currency2) {
			this.currency2 = _currency2 == null ? null : _currency2.toBuilder();
			return this;
		}
		
		@Override
		public QuotedCurrencyPair.QuotedCurrencyPairBuilder setCurrency2Value(String _currency2) {
			this.getOrCreateCurrency2().setValue(_currency2);
			return this;
		}
