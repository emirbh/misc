...
public class ReturnInstructionMeta implements RosettaMetaData<ReturnInstruction> {
	...
	@Override
	public Validator<? super ReturnInstruction> validator(ValidatorFactory factory) {
		return factory.<ReturnInstruction>create(ReturnInstructionValidator.class);
	}

	@Override
	public Validator<? super ReturnInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ReturnInstruction>create(ReturnInstructionTypeFormatValidator.class);
	}
