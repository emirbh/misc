 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CollateralBalance", builder=CollateralBalance.CollateralBalanceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CollateralBalance", model="cdm", builder=CollateralBalance.CollateralBalanceBuilderImpl.class, version="6.23.0")
public interface CollateralBalance extends RosettaModelObject {
	...
	class CollateralBalanceImpl implements CollateralBalance {
		...
		@RuneAttribute("collateralBalanceStatus")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("haircutIndicator")
		...
		@Accessor(AccessorType.GETTER)
		@Required
		@RuneAttribute("amountBaseCurrency")
	...
	class CollateralBalanceBuilderImpl implements CollateralBalance.CollateralBalanceBuilder {
		...
		@RuneAttribute("collateralBalanceStatus")
		@Override
		public CollateralBalance.CollateralBalanceBuilder setCollateralBalanceStatus(CollateralStatusEnum _collateralBalanceStatus) {
		...
		@RuneAttribute("haircutIndicator")
		@Override
		public CollateralBalance.CollateralBalanceBuilder setHaircutIndicator(HaircutIndicatorEnum _haircutIndicator) {
		...
		@RuneAttribute("amountBaseCurrency")
		@Override
		public CollateralBalance.CollateralBalanceBuilder setAmountBaseCurrency(Money _amountBaseCurrency) {
		...
		@RuneAttribute("payerReceiver")
		@Override
		public CollateralBalance.CollateralBalanceBuilder setPayerReceiver(PartyReferencePayerReceiver _payerReceiver) {
