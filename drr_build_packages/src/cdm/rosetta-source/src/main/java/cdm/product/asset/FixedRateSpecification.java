 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FixedRateSpecification", builder=FixedRateSpecification.FixedRateSpecificationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FixedRateSpecification", model="cdm", builder=FixedRateSpecification.FixedRateSpecificationBuilderImpl.class, version="6.23.0")
public interface FixedRateSpecification extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FixedRateSpecificationBuilder extends FixedRateSpecification, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class FixedRateSpecificationBuilderImpl implements FixedRateSpecification.FixedRateSpecificationBuilder {
		...
		@RuneAttribute("rateSchedule")
		@Override
		public FixedRateSpecification.FixedRateSpecificationBuilder setRateSchedule(RateSchedule _rateSchedule) {
			this.rateSchedule = _rateSchedule == null ? null : _rateSchedule.toBuilder();
			return this;
		}
		...
		@RuneMetaType
		@Override
		public FixedRateSpecification.FixedRateSpecificationBuilder setMeta(MetaFields _meta) {
