...
public class PricMeta implements RosettaMetaData<Pric> {
	...
	@Override
	public Validator<? super Pric> validator(ValidatorFactory factory) {
		return factory.<Pric>create(PricValidator.class);
	}

	@Override
	public Validator<? super Pric> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Pric>create(PricTypeFormatValidator.class);
	}
