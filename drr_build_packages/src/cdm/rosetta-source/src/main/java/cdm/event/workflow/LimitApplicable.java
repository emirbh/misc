 ...
 * @version 6.23.0
 */
@RosettaDataType(value="LimitApplicable", builder=LimitApplicable.LimitApplicableBuilderImpl.class, version="6.23.0")
@RuneDataType(value="LimitApplicable", model="cdm", builder=LimitApplicable.LimitApplicableBuilderImpl.class, version="6.23.0")
