...
@RosettaDataType(value="ReferenceWithMetaPortfolioState", builder=ReferenceWithMetaPortfolioState.ReferenceWithMetaPortfolioStateBuilderImpl.class, version="0.0.0")
@RuneDataType(value="ReferenceWithMetaPortfolioState", model="cdm", builder=ReferenceWithMetaPortfolioState.ReferenceWithMetaPortfolioStateBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaPortfolioState extends RosettaModelObject, ReferenceWithMeta<PortfolioState> {

	ReferenceWithMetaPortfolioStateMeta metaData = new ReferenceWithMetaPortfolioStateMeta();
	...
	/*********************** Builder Interface  ***********************/
	interface ReferenceWithMetaPortfolioStateBuilder extends ReferenceWithMetaPortfolioState, RosettaModelObjectBuilder, ReferenceWithMeta.ReferenceWithMetaBuilder<PortfolioState> {
		...
		ReferenceWithMetaPortfolioState.ReferenceWithMetaPortfolioStateBuilder prune();
	}
	...
	class ReferenceWithMetaPortfolioStateBuilderImpl implements ReferenceWithMetaPortfolioState.ReferenceWithMetaPortfolioStateBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPortfolioState.ReferenceWithMetaPortfolioStateBuilder setValue(PortfolioState _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaPortfolioState.ReferenceWithMetaPortfolioStateBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaPortfolioState.ReferenceWithMetaPortfolioStateBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPortfolioState.ReferenceWithMetaPortfolioStateBuilder setReference(Reference _reference) {
