...
import cdm.product.common.schedule.validation.datarule.InitialFixingDateOneOf0;
...
public class InitialFixingDateMeta implements RosettaMetaData<InitialFixingDate> {
	...
	public List<Validator<? super InitialFixingDate>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<InitialFixingDate>create(InitialFixingDateOneOf0.class)
		);
	}
	...
	@Override
	public Validator<? super InitialFixingDate> validator(ValidatorFactory factory) {
		return factory.<InitialFixingDate>create(InitialFixingDateValidator.class);
	}

	@Override
	public Validator<? super InitialFixingDate> typeFormatValidator(ValidatorFactory factory) {
		return factory.<InitialFixingDate>create(InitialFixingDateTypeFormatValidator.class);
	}
