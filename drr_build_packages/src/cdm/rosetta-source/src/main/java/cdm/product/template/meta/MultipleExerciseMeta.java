...
public class MultipleExerciseMeta implements RosettaMetaData<MultipleExercise> {
	...
	public List<Validator<? super MultipleExercise>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<MultipleExercise>create(MultipleExerciseMaximumChoice.class),
			factory.<MultipleExercise>create(MultipleExerciseMaximumNumberOfOptions.class),
			factory.<MultipleExercise>create(MultipleExerciseMinimumNumberOfOptions.class)
		);
	}
