...
import cdm.base.staticdata.asset.common.validation.datarule.DeliveryDateParametersDeliveryDateParametersChoice;
...
public class DeliveryDateParametersMeta implements RosettaMetaData<DeliveryDateParameters> {
	...
	public List<Validator<? super DeliveryDateParameters>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<DeliveryDateParameters>create(DeliveryDateParametersDeliveryDateParametersChoice.class)
		);
	}
	...
	@Override
	public Validator<? super DeliveryDateParameters> validator(ValidatorFactory factory) {
		return factory.<DeliveryDateParameters>create(DeliveryDateParametersValidator.class);
	}

	@Override
	public Validator<? super DeliveryDateParameters> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DeliveryDateParameters>create(DeliveryDateParametersTypeFormatValidator.class);
	}
