...
public class CalculationPeriodDataMeta implements RosettaMetaData<CalculationPeriodData> {
	...
	@Override
	public Validator<? super CalculationPeriodData> validator(ValidatorFactory factory) {
		return factory.<CalculationPeriodData>create(CalculationPeriodDataValidator.class);
	}

	@Override
	public Validator<? super CalculationPeriodData> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CalculationPeriodData>create(CalculationPeriodDataTypeFormatValidator.class);
	}
