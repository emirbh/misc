 ...
 * @version 6.23.0
 */
@RosettaDataType(value="InitialFixingDate", builder=InitialFixingDate.InitialFixingDateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="InitialFixingDate", model="cdm", builder=InitialFixingDate.InitialFixingDateBuilderImpl.class, version="6.23.0")
