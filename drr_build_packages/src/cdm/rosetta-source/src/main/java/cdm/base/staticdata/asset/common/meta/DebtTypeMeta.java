...
public class DebtTypeMeta implements RosettaMetaData<DebtType> {
	...
	@Override
	public Validator<? super DebtType> validator(ValidatorFactory factory) {
		return factory.<DebtType>create(DebtTypeValidator.class);
	}

	@Override
	public Validator<? super DebtType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DebtType>create(DebtTypeTypeFormatValidator.class);
	}
