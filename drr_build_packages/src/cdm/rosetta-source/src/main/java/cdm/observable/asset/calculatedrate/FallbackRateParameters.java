 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FallbackRateParameters", builder=FallbackRateParameters.FallbackRateParametersBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FallbackRateParameters", model="cdm", builder=FallbackRateParameters.FallbackRateParametersBuilderImpl.class, version="6.23.0")
public interface FallbackRateParameters extends RosettaModelObject {
	...
	class FallbackRateParametersBuilderImpl implements FallbackRateParameters.FallbackRateParametersBuilder {
		...
		@RuneAttribute("floatingRateIndex")
		@Override
		public FallbackRateParameters.FallbackRateParametersBuilder setFloatingRateIndex(FloatingRateIndexEnum _floatingRateIndex) {
		...
		@RuneAttribute("effectiveDate")
		@Override
		public FallbackRateParameters.FallbackRateParametersBuilder setEffectiveDate(Date _effectiveDate) {
		...
		@RuneAttribute("calculationParameters")
		@Override
		public FallbackRateParameters.FallbackRateParametersBuilder setCalculationParameters(FloatingRateCalculationParameters _calculationParameters) {
		...
		@RuneAttribute("spreadAdjustment")
		@Override
		public FallbackRateParameters.FallbackRateParametersBuilder setSpreadAdjustment(BigDecimal _spreadAdjustment) {
