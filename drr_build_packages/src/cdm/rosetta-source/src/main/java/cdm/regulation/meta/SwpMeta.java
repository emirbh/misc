...
public class SwpMeta implements RosettaMetaData<Swp> {
	...
	@Override
	public Validator<? super Swp> validator(ValidatorFactory factory) {
		return factory.<Swp>create(SwpValidator.class);
	}

	@Override
	public Validator<? super Swp> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Swp>create(SwpTypeFormatValidator.class);
	}
