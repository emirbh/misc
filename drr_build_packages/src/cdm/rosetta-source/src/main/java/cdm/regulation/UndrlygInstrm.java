 ...
 * @version 6.23.0
 */
@RosettaDataType(value="UndrlygInstrm", builder=UndrlygInstrm.UndrlygInstrmBuilderImpl.class, version="6.23.0")
@RuneDataType(value="UndrlygInstrm", model="cdm", builder=UndrlygInstrm.UndrlygInstrmBuilderImpl.class, version="6.23.0")
public interface UndrlygInstrm extends RosettaModelObject {
	...
	class UndrlygInstrmBuilderImpl implements UndrlygInstrm.UndrlygInstrmBuilder {
		...
		@RuneAttribute("swp")
		@Override
		public UndrlygInstrm.UndrlygInstrmBuilder setSwp(Swp _swp) {
			this.swp = _swp == null ? null : _swp.toBuilder();
			return this;
		}
