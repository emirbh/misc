...
import cdm.event.common.validation.datarule.ResetAveragingMethodologyExists;
...
public class ResetMeta implements RosettaMetaData<Reset> {
	...
	public List<Validator<? super Reset>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<Reset>create(ResetAveragingMethodologyExists.class)
		);
	}
	...
	@Override
	public Validator<? super Reset> validator(ValidatorFactory factory) {
		return factory.<Reset>create(ResetValidator.class);
	}

	@Override
	public Validator<? super Reset> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Reset>create(ResetTypeFormatValidator.class);
	}
