...
public class DatedValueMeta implements RosettaMetaData<DatedValue> {
	...
	@Override
	public Validator<? super DatedValue> validator(ValidatorFactory factory) {
		return factory.<DatedValue>create(DatedValueValidator.class);
	}

	@Override
	public Validator<? super DatedValue> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DatedValue>create(DatedValueTypeFormatValidator.class);
	}
