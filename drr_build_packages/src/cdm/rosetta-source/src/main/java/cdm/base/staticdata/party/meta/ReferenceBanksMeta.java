...
public class ReferenceBanksMeta implements RosettaMetaData<ReferenceBanks> {
	...
	@Override
	public Validator<? super ReferenceBanks> validator(ValidatorFactory factory) {
		return factory.<ReferenceBanks>create(ReferenceBanksValidator.class);
	}

	@Override
	public Validator<? super ReferenceBanks> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ReferenceBanks>create(ReferenceBanksTypeFormatValidator.class);
	}
