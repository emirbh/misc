 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FxInformationSource", builder=FxInformationSource.FxInformationSourceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FxInformationSource", model="cdm", builder=FxInformationSource.FxInformationSourceBuilderImpl.class, version="6.23.0")
