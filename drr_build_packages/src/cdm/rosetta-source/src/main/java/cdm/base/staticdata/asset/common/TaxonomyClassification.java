 ...
 * @version 6.23.0
 */
@RosettaDataType(value="TaxonomyClassification", builder=TaxonomyClassification.TaxonomyClassificationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="TaxonomyClassification", model="cdm", builder=TaxonomyClassification.TaxonomyClassificationBuilderImpl.class, version="6.23.0")
public interface TaxonomyClassification extends RosettaModelObject {
	...
	class TaxonomyClassificationBuilderImpl implements TaxonomyClassification.TaxonomyClassificationBuilder {
		...
		@RuneAttribute("className")
		@Override
		public TaxonomyClassification.TaxonomyClassificationBuilder setClassName(String _className) {
			this.className = _className == null ? null : _className;
			return this;
		}
		...
		@RuneAttribute("value")
		@Override
		public TaxonomyClassification.TaxonomyClassificationBuilder setValue(String _value) {
		...
		@RuneAttribute("description")
		@Override
		public TaxonomyClassification.TaxonomyClassificationBuilder setDescription(String _description) {
		...
		@RuneAttribute("ordinal")
		@Override
		public TaxonomyClassification.TaxonomyClassificationBuilder setOrdinal(Integer _ordinal) {
