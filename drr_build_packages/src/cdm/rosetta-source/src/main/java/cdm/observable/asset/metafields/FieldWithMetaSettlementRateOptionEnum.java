...
@RuneDataType(value="FieldWithMetaSettlementRateOptionEnum", model="cdm", builder=FieldWithMetaSettlementRateOptionEnum.FieldWithMetaSettlementRateOptionEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaSettlementRateOptionEnum extends RosettaModelObject, FieldWithMeta<SettlementRateOptionEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaSettlementRateOptionEnumBuilder extends FieldWithMetaSettlementRateOptionEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<SettlementRateOptionEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaSettlementRateOptionEnumBuilderImpl implements FieldWithMetaSettlementRateOptionEnum.FieldWithMetaSettlementRateOptionEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaSettlementRateOptionEnum.FieldWithMetaSettlementRateOptionEnumBuilder setValue(SettlementRateOptionEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaSettlementRateOptionEnum.FieldWithMetaSettlementRateOptionEnumBuilder setMeta(MetaFields _meta) {
