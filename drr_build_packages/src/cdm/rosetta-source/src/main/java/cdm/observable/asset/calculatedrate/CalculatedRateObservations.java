 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CalculatedRateObservations", builder=CalculatedRateObservations.CalculatedRateObservationsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CalculatedRateObservations", model="cdm", builder=CalculatedRateObservations.CalculatedRateObservationsBuilderImpl.class, version="6.23.0")
public interface CalculatedRateObservations extends RosettaModelObject {
	...
	interface CalculatedRateObservationsBuilder extends CalculatedRateObservations, RosettaModelObjectBuilder {
		...
		CalculatedRateObservations.CalculatedRateObservationsBuilder addObservationDates(Date observationDates, int idx);
		...
		CalculatedRateObservations.CalculatedRateObservationsBuilder addWeights(BigDecimal weights, int idx);
		...
		CalculatedRateObservations.CalculatedRateObservationsBuilder addObservedRates(BigDecimal observedRates, int idx);
		...
		CalculatedRateObservations.CalculatedRateObservationsBuilder addProcessedRates(BigDecimal processedRates, int idx);
	...
	class CalculatedRateObservationsBuilderImpl implements CalculatedRateObservations.CalculatedRateObservationsBuilder {
		...
		@Override
		public CalculatedRateObservations.CalculatedRateObservationsBuilder addObservationDates(Date _observationDates, int idx) {
		...
		@Override
		public CalculatedRateObservations.CalculatedRateObservationsBuilder addWeights(BigDecimal _weights, int idx) {
		...
		@Override
		public CalculatedRateObservations.CalculatedRateObservationsBuilder addObservedRates(BigDecimal _observedRates, int idx) {
			getIndex(this.observedRates, idx, () -> _observedRates);
			return this;
		}
		...
		@Override
		public CalculatedRateObservations.CalculatedRateObservationsBuilder addProcessedRates(BigDecimal _processedRates, int idx) {
			getIndex(this.processedRates, idx, () -> _processedRates);
			return this;
		}
