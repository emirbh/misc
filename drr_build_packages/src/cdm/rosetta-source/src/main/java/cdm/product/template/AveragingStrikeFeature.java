 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AveragingStrikeFeature", builder=AveragingStrikeFeature.AveragingStrikeFeatureBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AveragingStrikeFeature", model="cdm", builder=AveragingStrikeFeature.AveragingStrikeFeatureBuilderImpl.class, version="6.23.0")
public interface AveragingStrikeFeature extends RosettaModelObject {
	...
	class AveragingStrikeFeatureImpl implements AveragingStrikeFeature {
		...
		@Required
		@RuneAttribute("averagingCalculation")
	...
	class AveragingStrikeFeatureBuilderImpl implements AveragingStrikeFeature.AveragingStrikeFeatureBuilder {
		...
		@RuneAttribute("averagingCalculation")
		@Override
		public AveragingStrikeFeature.AveragingStrikeFeatureBuilder setAveragingCalculation(AveragingCalculation _averagingCalculation) {
			this.averagingCalculation = _averagingCalculation == null ? null : _averagingCalculation.toBuilder();
			return this;
		}
		...
		@RuneAttribute("observationTerms")
		@Override
		public AveragingStrikeFeature.AveragingStrikeFeatureBuilder setObservationTerms(ObservationTerms _observationTerms) {
