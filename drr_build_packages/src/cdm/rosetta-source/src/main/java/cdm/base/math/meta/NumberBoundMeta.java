...
public class NumberBoundMeta implements RosettaMetaData<NumberBound> {
	...
	@Override
	public Validator<? super NumberBound> validator(ValidatorFactory factory) {
		return factory.<NumberBound>create(NumberBoundValidator.class);
	}

	@Override
	public Validator<? super NumberBound> typeFormatValidator(ValidatorFactory factory) {
		return factory.<NumberBound>create(NumberBoundTypeFormatValidator.class);
	}
