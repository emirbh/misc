 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Prsn", builder=Prsn.PrsnBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Prsn", model="cdm", builder=Prsn.PrsnBuilderImpl.class, version="6.23.0")
