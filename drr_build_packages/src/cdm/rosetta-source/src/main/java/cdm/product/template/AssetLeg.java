 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AssetLeg", builder=AssetLeg.AssetLegBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AssetLeg", model="cdm", builder=AssetLeg.AssetLegBuilderImpl.class, version="6.23.0")
public interface AssetLeg extends RosettaModelObject {
	...
	class AssetLegBuilderImpl implements AssetLeg.AssetLegBuilder {
		...
		@RuneAttribute("settlementDate")
		@Override
		public AssetLeg.AssetLegBuilder setSettlementDate(AdjustableOrRelativeDate _settlementDate) {
		...
		@RuneAttribute("deliveryMethod")
		@Override
		public AssetLeg.AssetLegBuilder setDeliveryMethod(DeliveryMethodEnum _deliveryMethod) {
