 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PCDeliverableObligationCharac", builder=PCDeliverableObligationCharac.PCDeliverableObligationCharacBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PCDeliverableObligationCharac", model="cdm", builder=PCDeliverableObligationCharac.PCDeliverableObligationCharacBuilderImpl.class, version="6.23.0")
