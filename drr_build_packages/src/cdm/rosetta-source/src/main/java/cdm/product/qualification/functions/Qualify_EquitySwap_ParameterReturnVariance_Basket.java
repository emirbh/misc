...
@ImplementedBy(Qualify_EquitySwap_ParameterReturnVariance_Basket.Qualify_EquitySwap_ParameterReturnVariance_BasketDefault.class)
public abstract class Qualify_EquitySwap_ParameterReturnVariance_Basket implements RosettaFunction,IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static class Qualify_EquitySwap_ParameterReturnVariance_BasketDefault extends Qualify_EquitySwap_ParameterReturnVariance_Basket {
		@Override
