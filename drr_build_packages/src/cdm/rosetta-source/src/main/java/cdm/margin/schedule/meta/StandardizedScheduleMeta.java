...
import cdm.margin.schedule.validation.datarule.StandardizedSchedulePositiveDuration;
import cdm.margin.schedule.validation.datarule.StandardizedSchedulePositiveNotional;
import cdm.margin.schedule.validation.datarule.StandardizedScheduleValidCurrency;
...
public class StandardizedScheduleMeta implements RosettaMetaData<StandardizedSchedule> {
	...
	public List<Validator<? super StandardizedSchedule>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<StandardizedSchedule>create(StandardizedSchedulePositiveNotional.class),
			factory.<StandardizedSchedule>create(StandardizedScheduleValidCurrency.class),
			factory.<StandardizedSchedule>create(StandardizedSchedulePositiveDuration.class)
		);
	}
	...
	@Override
	public Validator<? super StandardizedSchedule> validator(ValidatorFactory factory) {
		return factory.<StandardizedSchedule>create(StandardizedScheduleValidator.class);
	}

	@Override
	public Validator<? super StandardizedSchedule> typeFormatValidator(ValidatorFactory factory) {
		return factory.<StandardizedSchedule>create(StandardizedScheduleTypeFormatValidator.class);
	}
