...
public class DividendPayoutRatioOnlyExistsValidator implements ValidatorWithArg<DividendPayoutRatio, Set<String>> {
	...
	public <T2 extends DividendPayoutRatio> ValidationResult<DividendPayoutRatio> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("basketConstituent", ExistenceChecker.isSet((ReferenceWithMetaBasketConstituent) o.getBasketConstituent()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("DividendPayoutRatio", ValidationResult.ValidationType.ONLY_EXISTS, "DividendPayoutRatio", path, "");
		}
		return failure("DividendPayoutRatio", ValidationResult.ValidationType.ONLY_EXISTS, "DividendPayoutRatio", path, "",
