 ...
 * @version 6.23.0
 */
@RosettaDataType(value="InflationRateSpecification", builder=InflationRateSpecification.InflationRateSpecificationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="InflationRateSpecification", model="cdm", builder=InflationRateSpecification.InflationRateSpecificationBuilderImpl.class, version="6.23.0")
