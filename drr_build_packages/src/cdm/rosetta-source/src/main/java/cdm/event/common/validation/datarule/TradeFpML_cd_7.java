...
@ImplementedBy(TradeFpML_cd_7.Default.class)
public interface TradeFpML_cd_7 extends Validator<Trade> {
	...
	class Default implements TradeFpML_cd_7 {
	...
	class NoOp implements TradeFpML_cd_7 {
