 ...
 * @version 6.23.0
 */
@RosettaDataType(value="TerminationProvision", builder=TerminationProvision.TerminationProvisionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="TerminationProvision", model="cdm", builder=TerminationProvision.TerminationProvisionBuilderImpl.class, version="6.23.0")
public interface TerminationProvision extends RosettaModelObject {
	...
	class TerminationProvisionImpl implements TerminationProvision {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("evergreenProvision")
	...
	class TerminationProvisionBuilderImpl implements TerminationProvision.TerminationProvisionBuilder {
		...
		@RuneAttribute("cancelableProvision")
		@Override
		public TerminationProvision.TerminationProvisionBuilder setCancelableProvision(CancelableProvision _cancelableProvision) {
		...
		@RuneAttribute("earlyTerminationProvision")
		@Override
		public TerminationProvision.TerminationProvisionBuilder setEarlyTerminationProvision(EarlyTerminationProvision _earlyTerminationProvision) {
		...
		@RuneAttribute("evergreenProvision")
		@Override
		public TerminationProvision.TerminationProvisionBuilder setEvergreenProvision(EvergreenProvision _evergreenProvision) {
			this.evergreenProvision = _evergreenProvision == null ? null : _evergreenProvision.toBuilder();
			return this;
		}
		...
		@RuneAttribute("extendibleProvision")
		@Override
		public TerminationProvision.TerminationProvisionBuilder setExtendibleProvision(ExtendibleProvision _extendibleProvision) {
