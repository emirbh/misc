...
public enum SettlementCentreEnum {
	 ...
	 * Euroclear Bank
	 */
	@RosettaEnumValue(value = "EuroclearBank") 
	EUROCLEAR_BANK("EuroclearBank", null),
	
	/**
	 * ClearStream Banking Luxembourg
	 */
	@RosettaEnumValue(value = "ClearstreamBankingLuxembourg") 
	CLEARSTREAM_BANKING_LUXEMBOURG("ClearstreamBankingLuxembourg", null)
;
