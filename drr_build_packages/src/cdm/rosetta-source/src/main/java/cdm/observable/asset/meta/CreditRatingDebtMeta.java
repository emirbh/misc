...
import cdm.observable.asset.validation.datarule.CreditRatingDebtOneOf0;
...
public class CreditRatingDebtMeta implements RosettaMetaData<CreditRatingDebt> {
	...
	public List<Validator<? super CreditRatingDebt>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<CreditRatingDebt>create(CreditRatingDebtOneOf0.class)
		);
	}
	...
	@Override
	public Validator<? super CreditRatingDebt> validator(ValidatorFactory factory) {
		return factory.<CreditRatingDebt>create(CreditRatingDebtValidator.class);
	}

	@Override
	public Validator<? super CreditRatingDebt> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CreditRatingDebt>create(CreditRatingDebtTypeFormatValidator.class);
	}
