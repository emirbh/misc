 ...
 * @version 6.23.0
 */
@RosettaDataType(value="StubPeriod", builder=StubPeriod.StubPeriodBuilderImpl.class, version="6.23.0")
@RuneDataType(value="StubPeriod", model="cdm", builder=StubPeriod.StubPeriodBuilderImpl.class, version="6.23.0")
public interface StubPeriod extends RosettaModelObject {
	...
	class StubPeriodBuilderImpl implements StubPeriod.StubPeriodBuilder {
		...
		@RuneAttribute("calculationPeriodDatesReference")
		@Override
		public StubPeriod.StubPeriodBuilder setCalculationPeriodDatesReference(ReferenceWithMetaCalculationPeriodDates _calculationPeriodDatesReference) {
		...
		@Override
		public StubPeriod.StubPeriodBuilder setCalculationPeriodDatesReferenceValue(CalculationPeriodDates _calculationPeriodDatesReference) {
		...
		@RuneAttribute("initialStub")
		@Override
		public StubPeriod.StubPeriodBuilder setInitialStub(StubValue _initialStub) {
		...
		@RuneAttribute("finalStub")
		@Override
		public StubPeriod.StubPeriodBuilder setFinalStub(StubValue _finalStub) {
