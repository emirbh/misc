...
public class RollFeatureMeta implements RosettaMetaData<RollFeature> {
	...
	@Override
	public Validator<? super RollFeature> validator(ValidatorFactory factory) {
		return factory.<RollFeature>create(RollFeatureValidator.class);
	}

	@Override
	public Validator<? super RollFeature> typeFormatValidator(ValidatorFactory factory) {
		return factory.<RollFeature>create(RollFeatureTypeFormatValidator.class);
	}
