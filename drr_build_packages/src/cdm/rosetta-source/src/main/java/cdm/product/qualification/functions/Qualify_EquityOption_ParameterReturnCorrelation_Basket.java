...
@ImplementedBy(Qualify_EquityOption_ParameterReturnCorrelation_Basket.Qualify_EquityOption_ParameterReturnCorrelation_BasketDefault.class)
public abstract class Qualify_EquityOption_ParameterReturnCorrelation_Basket implements RosettaFunction,IQualifyFunctionExtension<EconomicTerms> {
	...
	@Inject protected Qualify_EquitySwap_ParameterReturnCorrelation_Basket qualify_EquitySwap_ParameterReturnCorrelation_Basket;
