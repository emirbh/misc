...
import cdm.event.common.validation.datarule.InstructionExclusiveSplitPrimitive;
import cdm.event.common.validation.datarule.InstructionNewTrade;
...
public class InstructionMeta implements RosettaMetaData<Instruction> {
	...
	public List<Validator<? super Instruction>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<Instruction>create(InstructionExclusiveSplitPrimitive.class),
			factory.<Instruction>create(InstructionNewTrade.class)
		);
	}
