 ...
 * @version 6.23.0
 */
@RosettaDataType(value="StandardizedSchedule", builder=StandardizedSchedule.StandardizedScheduleBuilderImpl.class, version="6.23.0")
@RuneDataType(value="StandardizedSchedule", model="cdm", builder=StandardizedSchedule.StandardizedScheduleBuilderImpl.class, version="6.23.0")
