 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CalendarSpread", builder=CalendarSpread.CalendarSpreadBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CalendarSpread", model="cdm", builder=CalendarSpread.CalendarSpreadBuilderImpl.class, version="6.23.0")
