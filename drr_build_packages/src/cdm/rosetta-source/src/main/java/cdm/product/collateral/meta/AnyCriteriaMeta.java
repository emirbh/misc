...
public class AnyCriteriaMeta implements RosettaMetaData<AnyCriteria> {
	...
	@Override
	public Validator<? super AnyCriteria> validator(ValidatorFactory factory) {
		return factory.<AnyCriteria>create(AnyCriteriaValidator.class);
	}

	@Override
	public Validator<? super AnyCriteria> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AnyCriteria>create(AnyCriteriaTypeFormatValidator.class);
	}
