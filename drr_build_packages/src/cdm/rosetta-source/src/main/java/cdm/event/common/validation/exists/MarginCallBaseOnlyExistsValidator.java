...
public class MarginCallBaseOnlyExistsValidator implements ValidatorWithArg<MarginCallBase, Set<String>> {
	...
	@Override
	public <T2 extends MarginCallBase> ValidationResult<MarginCallBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("MarginCallBase", ValidationResult.ValidationType.ONLY_EXISTS, "MarginCallBase", path, "");
		}
		return failure("MarginCallBase", ValidationResult.ValidationType.ONLY_EXISTS, "MarginCallBase", path, "",
