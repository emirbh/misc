 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AssetFlowBase", builder=AssetFlowBase.AssetFlowBaseBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AssetFlowBase", model="cdm", builder=AssetFlowBase.AssetFlowBaseBuilderImpl.class, version="6.23.0")
