...
public class PriceScheduleOnlyExistsValidator implements ValidatorWithArg<PriceSchedule, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends PriceSchedule> ValidationResult<PriceSchedule> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("PriceSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "PriceSchedule", path, "");
		}
		return failure("PriceSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "PriceSchedule", path, "",
