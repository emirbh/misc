 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ResourceLength", builder=ResourceLength.ResourceLengthBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ResourceLength", model="cdm", builder=ResourceLength.ResourceLengthBuilderImpl.class, version="6.23.0")
