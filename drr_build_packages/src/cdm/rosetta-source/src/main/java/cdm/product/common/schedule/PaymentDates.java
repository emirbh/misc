 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PaymentDates", builder=PaymentDates.PaymentDatesBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PaymentDates", model="cdm", builder=PaymentDates.PaymentDatesBuilderImpl.class, version="6.23.0")
public interface PaymentDates extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface PaymentDatesBuilder extends PaymentDates, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class PaymentDatesImpl implements PaymentDates {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("paymentDateSchedule")
	...
	class PaymentDatesBuilderImpl implements PaymentDates.PaymentDatesBuilder {
		...
		@RuneAttribute("firstPaymentDate")
		@Override
		public PaymentDates.PaymentDatesBuilder setFirstPaymentDate(Date _firstPaymentDate) {
		...
		@RuneAttribute("lastRegularPaymentDate")
		@Override
		public PaymentDates.PaymentDatesBuilder setLastRegularPaymentDate(Date _lastRegularPaymentDate) {
		...
		@RuneAttribute("paymentDateSchedule")
		@Override
		public PaymentDates.PaymentDatesBuilder setPaymentDateSchedule(PaymentDateSchedule _paymentDateSchedule) {
			this.paymentDateSchedule = _paymentDateSchedule == null ? null : _paymentDateSchedule.toBuilder();
			return this;
		}
		...
		@RuneMetaType
		@Override
		public PaymentDates.PaymentDatesBuilder setMeta(MetaFields _meta) {
