 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Sngl", builder=Sngl.SnglBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Sngl", model="cdm", builder=Sngl.SnglBuilderImpl.class, version="6.23.0")
public interface Sngl extends RosettaModelObject {
	...
	class SnglBuilderImpl implements Sngl.SnglBuilder {
		...
		@RuneAttribute("isin")
		@Override
		public Sngl.SnglBuilder setIsin(String _isin) {
		...
		@RuneAttribute("indx")
		@Override
		public Sngl.SnglBuilder setIndx(Indx _indx) {
