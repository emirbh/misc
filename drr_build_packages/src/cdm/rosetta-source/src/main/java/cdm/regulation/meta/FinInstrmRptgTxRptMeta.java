...
public class FinInstrmRptgTxRptMeta implements RosettaMetaData<FinInstrmRptgTxRpt> {
	...
	@Override
	public Validator<? super FinInstrmRptgTxRpt> validator(ValidatorFactory factory) {
		return factory.<FinInstrmRptgTxRpt>create(FinInstrmRptgTxRptValidator.class);
	}

	@Override
	public Validator<? super FinInstrmRptgTxRpt> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FinInstrmRptgTxRpt>create(FinInstrmRptgTxRptTypeFormatValidator.class);
	}
