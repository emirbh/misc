...
public class EquityIndexOnlyExistsValidator implements ValidatorWithArg<EquityIndex, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends EquityIndex> ValidationResult<EquityIndex> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("EquityIndex", ValidationResult.ValidationType.ONLY_EXISTS, "EquityIndex", path, "");
		}
		return failure("EquityIndex", ValidationResult.ValidationType.ONLY_EXISTS, "EquityIndex", path, "",
