...
@ImplementedBy(CreateQuantityKey.CreateQuantityKeyDefault.class)
public abstract class CreateQuantityKey implements RosettaFunction {
	...
	*/
	...
	public static class CreateQuantityKeyDefault extends CreateQuantityKey {
		@Override
		...
		protected String assignOutput(String keyValueWithIndex, String id, Leg fpmlLeg) {
			keyValueWithIndex = createKey.evaluate("quantity", id, fpmlLeg);
