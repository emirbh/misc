 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Portfolio", builder=Portfolio.PortfolioBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Portfolio", model="cdm", builder=Portfolio.PortfolioBuilderImpl.class, version="6.23.0")
public interface Portfolio extends RosettaModelObject {
	...
	class PortfolioImpl implements Portfolio {
		...
		@Required
		@RuneAttribute("aggregationParameters")
	...
	class PortfolioBuilderImpl implements Portfolio.PortfolioBuilder {
		...
		@RuneAttribute("aggregationParameters")
		@Override
		public Portfolio.PortfolioBuilder setAggregationParameters(AggregationParameters _aggregationParameters) {
			this.aggregationParameters = _aggregationParameters == null ? null : _aggregationParameters.toBuilder();
			return this;
		}
		...
		@RuneAttribute("portfolioState")
		@Override
		public Portfolio.PortfolioBuilder setPortfolioState(PortfolioState _portfolioState) {
			this.portfolioState = _portfolioState == null ? null : _portfolioState.toBuilder();
			return this;
		}
