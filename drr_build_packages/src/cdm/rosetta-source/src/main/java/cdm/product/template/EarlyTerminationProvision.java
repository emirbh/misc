 ...
 * @version 6.23.0
 */
@RosettaDataType(value="EarlyTerminationProvision", builder=EarlyTerminationProvision.EarlyTerminationProvisionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="EarlyTerminationProvision", model="cdm", builder=EarlyTerminationProvision.EarlyTerminationProvisionBuilderImpl.class, version="6.23.0")
public interface EarlyTerminationProvision extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface EarlyTerminationProvisionBuilder extends EarlyTerminationProvision, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class EarlyTerminationProvisionBuilderImpl implements EarlyTerminationProvision.EarlyTerminationProvisionBuilder {
		...
		@RuneMetaType
		@Override
		public EarlyTerminationProvision.EarlyTerminationProvisionBuilder setMeta(MetaFields _meta) {
