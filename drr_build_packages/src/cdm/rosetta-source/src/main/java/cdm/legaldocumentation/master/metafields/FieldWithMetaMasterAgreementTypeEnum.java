...
@RuneDataType(value="FieldWithMetaMasterAgreementTypeEnum", model="cdm", builder=FieldWithMetaMasterAgreementTypeEnum.FieldWithMetaMasterAgreementTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaMasterAgreementTypeEnum extends RosettaModelObject, FieldWithMeta<MasterAgreementTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaMasterAgreementTypeEnumBuilder extends FieldWithMetaMasterAgreementTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<MasterAgreementTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaMasterAgreementTypeEnumBuilderImpl implements FieldWithMetaMasterAgreementTypeEnum.FieldWithMetaMasterAgreementTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaMasterAgreementTypeEnum.FieldWithMetaMasterAgreementTypeEnumBuilder setValue(MasterAgreementTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaMasterAgreementTypeEnum.FieldWithMetaMasterAgreementTypeEnumBuilder setMeta(MetaFields _meta) {
