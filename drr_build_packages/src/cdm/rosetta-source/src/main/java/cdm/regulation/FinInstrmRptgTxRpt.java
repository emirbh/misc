 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FinInstrmRptgTxRpt", builder=FinInstrmRptgTxRpt.FinInstrmRptgTxRptBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FinInstrmRptgTxRpt", model="cdm", builder=FinInstrmRptgTxRpt.FinInstrmRptgTxRptBuilderImpl.class, version="6.23.0")
public interface FinInstrmRptgTxRpt extends RosettaModelObject {
	...
	class FinInstrmRptgTxRptBuilderImpl implements FinInstrmRptgTxRpt.FinInstrmRptgTxRptBuilder {
		...
		@RuneAttribute("tx")
		@Override
		public FinInstrmRptgTxRpt.FinInstrmRptgTxRptBuilder setTx(Tx _tx) {
