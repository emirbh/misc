...
import cdm.product.common.schedule.validation.datarule.AveragingPeriodAveragingPeriodChoice;
...
public class AveragingPeriodMeta implements RosettaMetaData<AveragingPeriod> {
	...
	public List<Validator<? super AveragingPeriod>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<AveragingPeriod>create(AveragingPeriodAveragingPeriodChoice.class)
		);
	}
