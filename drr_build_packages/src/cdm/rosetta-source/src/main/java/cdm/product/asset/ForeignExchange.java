 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ForeignExchange", builder=ForeignExchange.ForeignExchangeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ForeignExchange", model="cdm", builder=ForeignExchange.ForeignExchangeBuilderImpl.class, version="6.23.0")
