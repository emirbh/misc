 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Id", builder=Id.IdBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Id", model="cdm", builder=Id.IdBuilderImpl.class, version="6.23.0")
public interface Id extends RosettaModelObject {
	...
	class IdBuilderImpl implements Id.IdBuilder {
		...
		@RuneAttribute("lei")
		@Override
		public Id.IdBuilder setLei(String _lei) {
