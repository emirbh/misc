...
public class DayCountBasis implements RosettaFunction {
	...
	@ImplementedBy(DayCountBasis.DayCountBasisACT_360.DayCountBasisACT_360Default.class)
	public static abstract class DayCountBasisACT_360 implements RosettaFunction {
		...
		*/
		...
		public static class DayCountBasisACT_360Default extends DayCountBasis.DayCountBasisACT_360 {
			@Override
	...
	@ImplementedBy(DayCountBasis.DayCountBasis_30_360.DayCountBasis_30_360Default.class)
	public static abstract class DayCountBasis_30_360 implements RosettaFunction {
		...
		*/
		...
		public static class DayCountBasis_30_360Default extends DayCountBasis.DayCountBasis_30_360 {
			@Override
			protected Integer doEvaluate(DayCountFractionEnum dcf) {
				Integer basis = null;
				return assignOutput(basis, dcf);
	...
	@ImplementedBy(DayCountBasis.DayCountBasis_30E_360.DayCountBasis_30E_360Default.class)
	public static abstract class DayCountBasis_30E_360 implements RosettaFunction {
		...
		*/
		...
		public static class DayCountBasis_30E_360Default extends DayCountBasis.DayCountBasis_30E_360 {
			@Override
			protected Integer doEvaluate(DayCountFractionEnum dcf) {
				Integer basis = null;
				return assignOutput(basis, dcf);
	...
	@ImplementedBy(DayCountBasis.DayCountBasisACT_365L.DayCountBasisACT_365LDefault.class)
	public static abstract class DayCountBasisACT_365L implements RosettaFunction {
		...
		*/
		...
		public static class DayCountBasisACT_365LDefault extends DayCountBasis.DayCountBasisACT_365L {
			@Override
			protected Integer doEvaluate(DayCountFractionEnum dcf) {
				Integer basis = null;
				return assignOutput(basis, dcf);
	...
	@ImplementedBy(DayCountBasis.DayCountBasisACT_365_FIXED.DayCountBasisACT_365_FIXEDDefault.class)
	public static abstract class DayCountBasisACT_365_FIXED implements RosettaFunction {
		...
		*/
		...
		public static class DayCountBasisACT_365_FIXEDDefault extends DayCountBasis.DayCountBasisACT_365_FIXED {
			@Override
			protected Integer doEvaluate(DayCountFractionEnum dcf) {
				Integer basis = null;
				return assignOutput(basis, dcf);
	...
	@ImplementedBy(DayCountBasis.DayCountBasisACT_ACT_AFB.DayCountBasisACT_ACT_AFBDefault.class)
	public static abstract class DayCountBasisACT_ACT_AFB implements RosettaFunction {
		...
		*/
		...
		public static class DayCountBasisACT_ACT_AFBDefault extends DayCountBasis.DayCountBasisACT_ACT_AFB {
			@Override
			protected Integer doEvaluate(DayCountFractionEnum dcf) {
				Integer basis = null;
				return assignOutput(basis, dcf);
	...
	@ImplementedBy(DayCountBasis.DayCountBasisACT_ACT_ISDA.DayCountBasisACT_ACT_ISDADefault.class)
	public static abstract class DayCountBasisACT_ACT_ISDA implements RosettaFunction {
		...
		*/
		...
		public static class DayCountBasisACT_ACT_ISDADefault extends DayCountBasis.DayCountBasisACT_ACT_ISDA {
			@Override
			protected Integer doEvaluate(DayCountFractionEnum dcf) {
				Integer basis = null;
				return assignOutput(basis, dcf);
	...
	@ImplementedBy(DayCountBasis.DayCountBasisACT_ACT_ICMA.DayCountBasisACT_ACT_ICMADefault.class)
	public static abstract class DayCountBasisACT_ACT_ICMA implements RosettaFunction {
		...
		*/
		...
		public static class DayCountBasisACT_ACT_ICMADefault extends DayCountBasis.DayCountBasisACT_ACT_ICMA {
			@Override
			protected Integer doEvaluate(DayCountFractionEnum dcf) {
				Integer basis = null;
				return assignOutput(basis, dcf);
	...
	@ImplementedBy(DayCountBasis.DayCountBasisCAL_252.DayCountBasisCAL_252Default.class)
	public static abstract class DayCountBasisCAL_252 implements RosettaFunction {
		...
		*/
		...
		public static class DayCountBasisCAL_252Default extends DayCountBasis.DayCountBasisCAL_252 {
			@Override
			protected Integer doEvaluate(DayCountFractionEnum dcf) {
				Integer basis = null;
				return assignOutput(basis, dcf);
