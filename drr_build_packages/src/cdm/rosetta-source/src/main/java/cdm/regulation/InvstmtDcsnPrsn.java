 ...
 * @version 6.23.0
 */
@RosettaDataType(value="InvstmtDcsnPrsn", builder=InvstmtDcsnPrsn.InvstmtDcsnPrsnBuilderImpl.class, version="6.23.0")
@RuneDataType(value="InvstmtDcsnPrsn", model="cdm", builder=InvstmtDcsnPrsn.InvstmtDcsnPrsnBuilderImpl.class, version="6.23.0")
public interface InvstmtDcsnPrsn extends RosettaModelObject {
	...
	class InvstmtDcsnPrsnBuilderImpl implements InvstmtDcsnPrsn.InvstmtDcsnPrsnBuilder {
		...
		@RuneAttribute("prsn")
		@Override
		public InvstmtDcsnPrsn.InvstmtDcsnPrsnBuilder setPrsn(Prsn _prsn) {
