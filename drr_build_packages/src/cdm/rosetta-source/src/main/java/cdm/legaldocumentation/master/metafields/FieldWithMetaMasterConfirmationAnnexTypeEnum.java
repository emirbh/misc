...
@RuneDataType(value="FieldWithMetaMasterConfirmationAnnexTypeEnum", model="cdm", builder=FieldWithMetaMasterConfirmationAnnexTypeEnum.FieldWithMetaMasterConfirmationAnnexTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaMasterConfirmationAnnexTypeEnum extends RosettaModelObject, FieldWithMeta<MasterConfirmationAnnexTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaMasterConfirmationAnnexTypeEnumBuilder extends FieldWithMetaMasterConfirmationAnnexTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<MasterConfirmationAnnexTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaMasterConfirmationAnnexTypeEnumBuilderImpl implements FieldWithMetaMasterConfirmationAnnexTypeEnum.FieldWithMetaMasterConfirmationAnnexTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaMasterConfirmationAnnexTypeEnum.FieldWithMetaMasterConfirmationAnnexTypeEnumBuilder setValue(MasterConfirmationAnnexTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaMasterConfirmationAnnexTypeEnum.FieldWithMetaMasterConfirmationAnnexTypeEnumBuilder setMeta(MetaFields _meta) {
