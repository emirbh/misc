...
@RuneDataType(value="ReferenceWithMetaNonNegativeQuantitySchedule", model="cdm", builder=ReferenceWithMetaNonNegativeQuantitySchedule.ReferenceWithMetaNonNegativeQuantityScheduleBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaNonNegativeQuantitySchedule extends RosettaModelObject, ReferenceWithMeta<NonNegativeQuantitySchedule> {
	...
	class ReferenceWithMetaNonNegativeQuantityScheduleBuilderImpl implements ReferenceWithMetaNonNegativeQuantitySchedule.ReferenceWithMetaNonNegativeQuantityScheduleBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaNonNegativeQuantitySchedule.ReferenceWithMetaNonNegativeQuantityScheduleBuilder setValue(NonNegativeQuantitySchedule _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaNonNegativeQuantitySchedule.ReferenceWithMetaNonNegativeQuantityScheduleBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaNonNegativeQuantitySchedule.ReferenceWithMetaNonNegativeQuantityScheduleBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaNonNegativeQuantitySchedule.ReferenceWithMetaNonNegativeQuantityScheduleBuilder setReference(Reference _reference) {
