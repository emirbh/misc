 ...
 * @version 6.23.0
 */
@RosettaDataType(value="InventoryRecord", builder=InventoryRecord.InventoryRecordBuilderImpl.class, version="6.23.0")
@RuneDataType(value="InventoryRecord", model="cdm", builder=InventoryRecord.InventoryRecordBuilderImpl.class, version="6.23.0")
public interface InventoryRecord extends RosettaModelObject {
	...
	class InventoryRecordBuilderImpl implements InventoryRecord.InventoryRecordBuilder {
		...
		@RuneAttribute("identifer")
		@Override
		public InventoryRecord.InventoryRecordBuilder setIdentifer(AssignedIdentifier _identifer) {
		...
		@RuneAttribute("security")
		@Override
		public InventoryRecord.InventoryRecordBuilder setSecurity(Security _security) {
