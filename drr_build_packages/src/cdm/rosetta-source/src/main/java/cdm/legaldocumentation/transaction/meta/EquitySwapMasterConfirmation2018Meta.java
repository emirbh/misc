...
import cdm.legaldocumentation.transaction.validation.EquitySwapMasterConfirmation2018TypeFormatValidator;
import cdm.legaldocumentation.transaction.validation.EquitySwapMasterConfirmation2018Validator;
import cdm.legaldocumentation.transaction.validation.exists.EquitySwapMasterConfirmation2018OnlyExistsValidator;
...
public class EquitySwapMasterConfirmation2018Meta implements RosettaMetaData<EquitySwapMasterConfirmation2018> {
	...
	@Override
	public Validator<? super EquitySwapMasterConfirmation2018> validator(ValidatorFactory factory) {
		return factory.<EquitySwapMasterConfirmation2018>create(EquitySwapMasterConfirmation2018Validator.class);
	}

	@Override
	public Validator<? super EquitySwapMasterConfirmation2018> typeFormatValidator(ValidatorFactory factory) {
		return factory.<EquitySwapMasterConfirmation2018>create(EquitySwapMasterConfirmation2018TypeFormatValidator.class);
	}
