...
@RuneDataType(value="ReferenceWithMetaContractDetails", model="cdm", builder=ReferenceWithMetaContractDetails.ReferenceWithMetaContractDetailsBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaContractDetails extends RosettaModelObject, ReferenceWithMeta<ContractDetails> {
	...
	class ReferenceWithMetaContractDetailsBuilderImpl implements ReferenceWithMetaContractDetails.ReferenceWithMetaContractDetailsBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaContractDetails.ReferenceWithMetaContractDetailsBuilder setValue(ContractDetails _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaContractDetails.ReferenceWithMetaContractDetailsBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaContractDetails.ReferenceWithMetaContractDetailsBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaContractDetails.ReferenceWithMetaContractDetailsBuilder setReference(Reference _reference) {
