...
public class ObservationIdentifierMeta implements RosettaMetaData<ObservationIdentifier> {
	...
	@Override
	public Validator<? super ObservationIdentifier> validator(ValidatorFactory factory) {
		return factory.<ObservationIdentifier>create(ObservationIdentifierValidator.class);
	}

	@Override
	public Validator<? super ObservationIdentifier> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ObservationIdentifier>create(ObservationIdentifierTypeFormatValidator.class);
	}
