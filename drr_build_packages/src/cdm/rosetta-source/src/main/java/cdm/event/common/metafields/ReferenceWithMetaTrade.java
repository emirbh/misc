...
@RuneDataType(value="ReferenceWithMetaTrade", model="cdm", builder=ReferenceWithMetaTrade.ReferenceWithMetaTradeBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaTrade extends RosettaModelObject, ReferenceWithMeta<Trade> {
	...
	class ReferenceWithMetaTradeBuilderImpl implements ReferenceWithMetaTrade.ReferenceWithMetaTradeBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaTrade.ReferenceWithMetaTradeBuilder setValue(Trade _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaTrade.ReferenceWithMetaTradeBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaTrade.ReferenceWithMetaTradeBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaTrade.ReferenceWithMetaTradeBuilder setReference(Reference _reference) {
