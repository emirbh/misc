...
public class AssetLegMeta implements RosettaMetaData<AssetLeg> {
	...
	@Override
	public Validator<? super AssetLeg> validator(ValidatorFactory factory) {
		return factory.<AssetLeg>create(AssetLegValidator.class);
	}

	@Override
	public Validator<? super AssetLeg> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssetLeg>create(AssetLegTypeFormatValidator.class);
	}
