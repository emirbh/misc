...
import cdm.legaldocumentation.transaction.meta.MasterConfirmationBaseMeta;
 ...
 * @version 6.23.0
 */
@RosettaDataType(value="MasterConfirmationBase", builder=MasterConfirmationBase.MasterConfirmationBaseBuilderImpl.class, version="6.23.0")
@RuneDataType(value="MasterConfirmationBase", model="cdm", builder=MasterConfirmationBase.MasterConfirmationBaseBuilderImpl.class, version="6.23.0")
