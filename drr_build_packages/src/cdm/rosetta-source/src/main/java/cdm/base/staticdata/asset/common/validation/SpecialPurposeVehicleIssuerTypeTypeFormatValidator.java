		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("SpecialPurposeVehicleIssuerType", ValidationResult.ValidationType.TYPE_FORMAT, "SpecialPurposeVehicleIssuerType", path, "", res.getError());
				}
				return success("SpecialPurposeVehicleIssuerType", ValidationResult.ValidationType.TYPE_FORMAT, "SpecialPurposeVehicleIssuerType", path, "");
			})
			.collect(toList());
	}
