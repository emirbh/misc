 ...
 * @version 6.23.0
 */
@RosettaDataType(value="StubCalculationPeriodAmount", builder=StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilderImpl.class, version="6.23.0")
@RuneDataType(value="StubCalculationPeriodAmount", model="cdm", builder=StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilderImpl.class, version="6.23.0")
