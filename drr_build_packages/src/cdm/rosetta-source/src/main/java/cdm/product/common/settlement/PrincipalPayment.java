 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PrincipalPayment", builder=PrincipalPayment.PrincipalPaymentBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PrincipalPayment", model="cdm", builder=PrincipalPayment.PrincipalPaymentBuilderImpl.class, version="6.23.0")
public interface PrincipalPayment extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface PrincipalPaymentBuilder extends PrincipalPayment, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class PrincipalPaymentImpl implements PrincipalPayment {
		...
		@RuneAttribute("principalPaymentDate")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("presentValuePrincipalAmount")
	...
	class PrincipalPaymentBuilderImpl implements PrincipalPayment.PrincipalPaymentBuilder {
		...
		@RuneAttribute("principalPaymentDate")
		@Override
		public PrincipalPayment.PrincipalPaymentBuilder setPrincipalPaymentDate(AdjustableDate _principalPaymentDate) {
		...
		@RuneAttribute("payerReceiver")
		@Override
		public PrincipalPayment.PrincipalPaymentBuilder setPayerReceiver(PayerReceiver _payerReceiver) {
		...
		@RuneAttribute("principalAmount")
		@Override
		public PrincipalPayment.PrincipalPaymentBuilder setPrincipalAmount(Money _principalAmount) {
		...
		@RuneAttribute("discountFactor")
		@Override
		public PrincipalPayment.PrincipalPaymentBuilder setDiscountFactor(BigDecimal _discountFactor) {
		...
		@RuneAttribute("presentValuePrincipalAmount")
		@Override
		public PrincipalPayment.PrincipalPaymentBuilder setPresentValuePrincipalAmount(Money _presentValuePrincipalAmount) {
		...
		@RuneMetaType
		@Override
		public PrincipalPayment.PrincipalPaymentBuilder setMeta(MetaFields _meta) {
