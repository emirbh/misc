 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ObservationParameters", builder=ObservationParameters.ObservationParametersBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ObservationParameters", model="cdm", builder=ObservationParameters.ObservationParametersBuilderImpl.class, version="6.23.0")
public interface ObservationParameters extends RosettaModelObject {
	...
	class ObservationParametersBuilderImpl implements ObservationParameters.ObservationParametersBuilder {
		...
		@RuneAttribute("observationCapRate")
		@Override
		public ObservationParameters.ObservationParametersBuilder setObservationCapRate(BigDecimal _observationCapRate) {
		...
		@RuneAttribute("observationFloorRate")
		@Override
		public ObservationParameters.ObservationParametersBuilder setObservationFloorRate(BigDecimal _observationFloorRate) {
