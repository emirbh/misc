 ...
 * @version 6.23.0
 */
@RosettaDataType(value="MultipleExercise", builder=MultipleExercise.MultipleExerciseBuilderImpl.class, version="6.23.0")
@RuneDataType(value="MultipleExercise", model="cdm", builder=MultipleExercise.MultipleExerciseBuilderImpl.class, version="6.23.0")
