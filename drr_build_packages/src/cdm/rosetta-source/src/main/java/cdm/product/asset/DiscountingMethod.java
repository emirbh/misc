 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DiscountingMethod", builder=DiscountingMethod.DiscountingMethodBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DiscountingMethod", model="cdm", builder=DiscountingMethod.DiscountingMethodBuilderImpl.class, version="6.23.0")
public interface DiscountingMethod extends RosettaModelObject {
	...
	class DiscountingMethodBuilderImpl implements DiscountingMethod.DiscountingMethodBuilder {
		...
		@RuneAttribute("discountingType")
		@Override
		public DiscountingMethod.DiscountingMethodBuilder setDiscountingType(DiscountingTypeEnum _discountingType) {
		...
		@RuneAttribute("discountRate")
		@Override
		public DiscountingMethod.DiscountingMethodBuilder setDiscountRate(BigDecimal _discountRate) {
		...
		@RuneAttribute("discountRateDayCountFraction")
		@Override
		public DiscountingMethod.DiscountingMethodBuilder setDiscountRateDayCountFraction(FieldWithMetaDayCountFractionEnum _discountRateDayCountFraction) {
			this.discountRateDayCountFraction = _discountRateDayCountFraction == null ? null : _discountRateDayCountFraction.toBuilder();
			return this;
		}
		
		@Override
		public DiscountingMethod.DiscountingMethodBuilder setDiscountRateDayCountFractionValue(DayCountFractionEnum _discountRateDayCountFraction) {
			this.getOrCreateDiscountRateDayCountFraction().setValue(_discountRateDayCountFraction);
			return this;
		}
