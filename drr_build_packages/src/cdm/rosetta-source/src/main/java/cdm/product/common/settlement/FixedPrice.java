 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FixedPrice", builder=FixedPrice.FixedPriceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FixedPrice", model="cdm", builder=FixedPrice.FixedPriceBuilderImpl.class, version="6.23.0")
public interface FixedPrice extends RosettaModelObject {
	...
	interface FixedPriceBuilder extends FixedPrice, RosettaModelObjectBuilder {
		...
		FixedPrice.FixedPriceBuilder setPrice(ReferenceWithMetaPriceSchedule price);
		FixedPrice.FixedPriceBuilder setPriceValue(PriceSchedule price);
	...
	class FixedPriceBuilderImpl implements FixedPrice.FixedPriceBuilder {
		...
		@RuneScopedAttributeReference
		@Override
		public FixedPrice.FixedPriceBuilder setPrice(ReferenceWithMetaPriceSchedule _price) {
			this.price = _price == null ? null : _price.toBuilder();
			return this;
		}
		
		@Override
		public FixedPrice.FixedPriceBuilder setPriceValue(PriceSchedule _price) {
