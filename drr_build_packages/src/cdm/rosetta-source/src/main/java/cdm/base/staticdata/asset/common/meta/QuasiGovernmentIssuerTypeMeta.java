...
import cdm.base.staticdata.asset.common.validation.datarule.QuasiGovernmentIssuerTypeNonSovereignEntityRecourse;
...
public class QuasiGovernmentIssuerTypeMeta implements RosettaMetaData<QuasiGovernmentIssuerType> {
	...
	public List<Validator<? super QuasiGovernmentIssuerType>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<QuasiGovernmentIssuerType>create(QuasiGovernmentIssuerTypeNonSovereignEntityRecourse.class)
		);
	}
	...
	@Override
	public Validator<? super QuasiGovernmentIssuerType> validator(ValidatorFactory factory) {
		return factory.<QuasiGovernmentIssuerType>create(QuasiGovernmentIssuerTypeValidator.class);
	}

	@Override
	public Validator<? super QuasiGovernmentIssuerType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<QuasiGovernmentIssuerType>create(QuasiGovernmentIssuerTypeTypeFormatValidator.class);
	}
