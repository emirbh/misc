...
import cdm.observable.asset.validation.datarule.EquityIndexEquityAssetClass;
...
public class EquityIndexMeta implements RosettaMetaData<EquityIndex> {
	...
	public List<Validator<? super EquityIndex>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<EquityIndex>create(EquityIndexEquityAssetClass.class)
		);
	}
	...
	@Override
	public Validator<? super EquityIndex> validator(ValidatorFactory factory) {
		return factory.<EquityIndex>create(EquityIndexValidator.class);
	}

	@Override
	public Validator<? super EquityIndex> typeFormatValidator(ValidatorFactory factory) {
		return factory.<EquityIndex>create(EquityIndexTypeFormatValidator.class);
	}
