 ...
 * @version 6.23.0
 */
@RosettaDataType(value="RelativeDateOffset", builder=RelativeDateOffset.RelativeDateOffsetBuilderImpl.class, version="6.23.0")
@RuneDataType(value="RelativeDateOffset", model="cdm", builder=RelativeDateOffset.RelativeDateOffsetBuilderImpl.class, version="6.23.0")
