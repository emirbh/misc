 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PeriodBound", builder=PeriodBound.PeriodBoundBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PeriodBound", model="cdm", builder=PeriodBound.PeriodBoundBuilderImpl.class, version="6.23.0")
public interface PeriodBound extends RosettaModelObject {
	...
	class PeriodBoundBuilderImpl implements PeriodBound.PeriodBoundBuilder {
		...
		@RuneAttribute("period")
		@Override
		public PeriodBound.PeriodBoundBuilder setPeriod(Period _period) {
		...
		@RuneAttribute("inclusive")
		@Override
		public PeriodBound.PeriodBoundBuilder setInclusive(Boolean _inclusive) {
