 ...
 * @version 6.23.0
 */
@RosettaDataType(value="VarianceReturnTerms", builder=VarianceReturnTerms.VarianceReturnTermsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="VarianceReturnTerms", model="cdm", builder=VarianceReturnTerms.VarianceReturnTermsBuilderImpl.class, version="6.23.0")
