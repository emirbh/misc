...
public class AssetPayoutOnlyExistsValidator implements ValidatorWithArg<AssetPayout, Set<String>> {
	...
	public <T2 extends AssetPayout> ValidationResult<AssetPayout> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("underlier", ExistenceChecker.isSet((Asset) o.getUnderlier()))
				...
				.put("tradeType", ExistenceChecker.isSet((AssetPayoutTradeTypeEnum) o.getTradeType()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AssetPayout", ValidationResult.ValidationType.ONLY_EXISTS, "AssetPayout", path, "");
		}
		return failure("AssetPayout", ValidationResult.ValidationType.ONLY_EXISTS, "AssetPayout", path, "",
