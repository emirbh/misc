...
import cdm.observable.asset.validation.datarule.FallbackReferencePriceFallbackCalculationAgent;
import cdm.observable.asset.validation.datarule.FallbackReferencePriceMaximumDaysOfPostponement;
...
public class FallbackReferencePriceMeta implements RosettaMetaData<FallbackReferencePrice> {
	...
	public List<Validator<? super FallbackReferencePrice>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<FallbackReferencePrice>create(FallbackReferencePriceMaximumDaysOfPostponement.class),
			factory.<FallbackReferencePrice>create(FallbackReferencePriceFallbackCalculationAgent.class)
		);
	}
