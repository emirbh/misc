...
public class CreditNotationMeta implements RosettaMetaData<CreditNotation> {
	...
	@Override
	public Validator<? super CreditNotation> validator(ValidatorFactory factory) {
		return factory.<CreditNotation>create(CreditNotationValidator.class);
	}

	@Override
	public Validator<? super CreditNotation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CreditNotation>create(CreditNotationTypeFormatValidator.class);
	}
