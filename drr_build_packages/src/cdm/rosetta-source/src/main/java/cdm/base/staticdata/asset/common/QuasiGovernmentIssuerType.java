 ...
 * @version 6.23.0
 */
@RosettaDataType(value="QuasiGovernmentIssuerType", builder=QuasiGovernmentIssuerType.QuasiGovernmentIssuerTypeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="QuasiGovernmentIssuerType", model="cdm", builder=QuasiGovernmentIssuerType.QuasiGovernmentIssuerTypeBuilderImpl.class, version="6.23.0")
public interface QuasiGovernmentIssuerType extends RosettaModelObject {
	...
	class QuasiGovernmentIssuerTypeImpl implements QuasiGovernmentIssuerType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("sovereignRecourse")
	...
	class QuasiGovernmentIssuerTypeBuilderImpl implements QuasiGovernmentIssuerType.QuasiGovernmentIssuerTypeBuilder {
		...
		@RuneAttribute("sovereignEntity")
		@Override
		public QuasiGovernmentIssuerType.QuasiGovernmentIssuerTypeBuilder setSovereignEntity(Boolean _sovereignEntity) {
			this.sovereignEntity = _sovereignEntity == null ? null : _sovereignEntity;
			return this;
		}
		...
		@RuneAttribute("sovereignRecourse")
		@Override
		public QuasiGovernmentIssuerType.QuasiGovernmentIssuerTypeBuilder setSovereignRecourse(Boolean _sovereignRecourse) {
			this.sovereignRecourse = _sovereignRecourse == null ? null : _sovereignRecourse;
			return this;
		}
