...
@ImplementedBy(ExecutionLanguageOtherLanguage.Default.class)
public interface ExecutionLanguageOtherLanguage extends Validator<ExecutionLanguage> {
	
	String NAME = "ExecutionLanguageOtherLanguage";
	String DEFINITION = "if standardLanguage = False then otherLanguage exists";
	
	class Default implements ExecutionLanguageOtherLanguage {
	...
	class NoOp implements ExecutionLanguageOtherLanguage {
