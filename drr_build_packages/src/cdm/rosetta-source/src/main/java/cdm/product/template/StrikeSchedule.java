 ...
 * @version 6.23.0
 */
@RosettaDataType(value="StrikeSchedule", builder=StrikeSchedule.StrikeScheduleBuilderImpl.class, version="6.23.0")
@RuneDataType(value="StrikeSchedule", model="cdm", builder=StrikeSchedule.StrikeScheduleBuilderImpl.class, version="6.23.0")
