 ...
 * @version 6.23.0
 */
@RosettaDataRule("FixedPriceNonNegativePrice_datedValue")
@ImplementedBy(FixedPriceNonNegativePrice_datedValue.Default.class)
public interface FixedPriceNonNegativePrice_datedValue extends Validator<FixedPrice> {
	
	String NAME = "FixedPriceNonNegativePrice_datedValue";
	String DEFINITION = "if price -> datedValue exists then price -> datedValue -> value all >= 0.0";
	
	class Default implements FixedPriceNonNegativePrice_datedValue {
	...
	class NoOp implements FixedPriceNonNegativePrice_datedValue {
