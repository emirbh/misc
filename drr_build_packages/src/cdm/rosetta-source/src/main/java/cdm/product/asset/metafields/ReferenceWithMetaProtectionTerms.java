...
@RuneDataType(value="ReferenceWithMetaProtectionTerms", model="cdm", builder=ReferenceWithMetaProtectionTerms.ReferenceWithMetaProtectionTermsBuilderImpl.class, version="0.0.0")
