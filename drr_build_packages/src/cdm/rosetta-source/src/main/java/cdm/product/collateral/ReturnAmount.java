 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ReturnAmount", builder=ReturnAmount.ReturnAmountBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ReturnAmount", model="cdm", builder=ReturnAmount.ReturnAmountBuilderImpl.class, version="6.23.0")
public interface ReturnAmount extends RosettaModelObject {
	...
	class ReturnAmountImpl implements ReturnAmount {
		...
		@RuneAttribute("includesDefaultLanguage")
	...
	class ReturnAmountBuilderImpl implements ReturnAmount.ReturnAmountBuilder {
		...
		@RuneAttribute("includesDefaultLanguage")
		@Override
		public ReturnAmount.ReturnAmountBuilder setIncludesDefaultLanguage(Boolean _includesDefaultLanguage) {
			this.includesDefaultLanguage = _includesDefaultLanguage == null ? null : _includesDefaultLanguage;
			return this;
		}
		...
		@RuneAttribute("customElection")
		@Override
		public ReturnAmount.ReturnAmountBuilder setCustomElection(String _customElection) {
