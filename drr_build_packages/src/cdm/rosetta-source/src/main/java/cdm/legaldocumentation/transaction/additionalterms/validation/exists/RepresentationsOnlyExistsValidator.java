...
public class RepresentationsOnlyExistsValidator implements ValidatorWithArg<Representations, Set<String>> {
	...
	public <T2 extends Representations> ValidationResult<Representations> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("nonReliance", ExistenceChecker.isSet((Boolean) o.getNonReliance()))
				.put("agreementsRegardingHedging", ExistenceChecker.isSet((Boolean) o.getAgreementsRegardingHedging()))
				.put("indexDisclaimer", ExistenceChecker.isSet((Boolean) o.getIndexDisclaimer()))
				.put("additionalAcknowledgements", ExistenceChecker.isSet((Boolean) o.getAdditionalAcknowledgements()))
		...
		if (setFields.equals(fields)) {
			return success("Representations", ValidationResult.ValidationType.ONLY_EXISTS, "Representations", path, "");
		}
		return failure("Representations", ValidationResult.ValidationType.ONLY_EXISTS, "Representations", path, "",
