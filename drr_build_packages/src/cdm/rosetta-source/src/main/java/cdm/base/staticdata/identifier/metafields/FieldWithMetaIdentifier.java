...
@RuneDataType(value="FieldWithMetaIdentifier", model="cdm", builder=FieldWithMetaIdentifier.FieldWithMetaIdentifierBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaIdentifier extends RosettaModelObject, FieldWithMeta<Identifier>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaIdentifierBuilder extends FieldWithMetaIdentifier, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<Identifier>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaIdentifierBuilderImpl implements FieldWithMetaIdentifier.FieldWithMetaIdentifierBuilder {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaIdentifier.FieldWithMetaIdentifierBuilder setValue(Identifier _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaIdentifier.FieldWithMetaIdentifierBuilder setMeta(MetaFields _meta) {
