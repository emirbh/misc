 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DividendPayoutRatio", builder=DividendPayoutRatio.DividendPayoutRatioBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DividendPayoutRatio", model="cdm", builder=DividendPayoutRatio.DividendPayoutRatioBuilderImpl.class, version="6.23.0")
