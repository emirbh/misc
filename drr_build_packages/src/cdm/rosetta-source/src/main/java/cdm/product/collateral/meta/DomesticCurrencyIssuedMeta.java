...
public class DomesticCurrencyIssuedMeta implements RosettaMetaData<DomesticCurrencyIssued> {
	...
	@Override
	public Validator<? super DomesticCurrencyIssued> validator(ValidatorFactory factory) {
		return factory.<DomesticCurrencyIssued>create(DomesticCurrencyIssuedValidator.class);
	}

	@Override
	public Validator<? super DomesticCurrencyIssued> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DomesticCurrencyIssued>create(DomesticCurrencyIssuedTypeFormatValidator.class);
	}
