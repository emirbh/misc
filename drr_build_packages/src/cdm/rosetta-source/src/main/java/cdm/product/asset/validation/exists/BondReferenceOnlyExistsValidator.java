...
public class BondReferenceOnlyExistsValidator implements ValidatorWithArg<BondReference, Set<String>> {
	...
	public <T2 extends BondReference> ValidationResult<BondReference> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("bond", ExistenceChecker.isSet((Security) o.getBond()))
		...
		if (setFields.equals(fields)) {
			return success("BondReference", ValidationResult.ValidationType.ONLY_EXISTS, "BondReference", path, "");
		}
		return failure("BondReference", ValidationResult.ValidationType.ONLY_EXISTS, "BondReference", path, "",
