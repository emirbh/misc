 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SwapCurveValuation", builder=SwapCurveValuation.SwapCurveValuationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SwapCurveValuation", model="cdm", builder=SwapCurveValuation.SwapCurveValuationBuilderImpl.class, version="6.23.0")
public interface SwapCurveValuation extends RosettaModelObject {
	...
	class SwapCurveValuationBuilderImpl implements SwapCurveValuation.SwapCurveValuationBuilder {
		...
		@RuneAttribute("floatingRateIndex")
		@Override
		public SwapCurveValuation.SwapCurveValuationBuilder setFloatingRateIndex(FloatingRateIndexEnum _floatingRateIndex) {
