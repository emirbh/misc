...
public class CommodityPriceReturnTermsMeta implements RosettaMetaData<CommodityPriceReturnTerms> {
	...
	@Override
	public Validator<? super CommodityPriceReturnTerms> validator(ValidatorFactory factory) {
		return factory.<CommodityPriceReturnTerms>create(CommodityPriceReturnTermsValidator.class);
	}

	@Override
	public Validator<? super CommodityPriceReturnTerms> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CommodityPriceReturnTerms>create(CommodityPriceReturnTermsTypeFormatValidator.class);
	}
