 ...
 * @version 6.23.0
 */
@RosettaDataType(value="RegionalGovernmentIssuerType", builder=RegionalGovernmentIssuerType.RegionalGovernmentIssuerTypeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="RegionalGovernmentIssuerType", model="cdm", builder=RegionalGovernmentIssuerType.RegionalGovernmentIssuerTypeBuilderImpl.class, version="6.23.0")
public interface RegionalGovernmentIssuerType extends RosettaModelObject {
	...
	class RegionalGovernmentIssuerTypeBuilderImpl implements RegionalGovernmentIssuerType.RegionalGovernmentIssuerTypeBuilder {
		...
		@RuneAttribute("sovereignRecourse")
		@Override
		public RegionalGovernmentIssuerType.RegionalGovernmentIssuerTypeBuilder setSovereignRecourse(Boolean _sovereignRecourse) {
