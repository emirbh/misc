...
public class AverageTradingVolumeMeta implements RosettaMetaData<AverageTradingVolume> {
	...
	@Override
	public Validator<? super AverageTradingVolume> validator(ValidatorFactory factory) {
		return factory.<AverageTradingVolume>create(AverageTradingVolumeValidator.class);
	}

	@Override
	public Validator<? super AverageTradingVolume> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AverageTradingVolume>create(AverageTradingVolumeTypeFormatValidator.class);
	}
