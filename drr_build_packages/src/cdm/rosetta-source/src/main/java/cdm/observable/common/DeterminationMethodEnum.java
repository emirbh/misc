...
public enum DeterminationMethodEnum {
	 ...
	 * TWAP VE Price.
	 */
	@RosettaEnumValue(value = "TWAPVE") 
	TWAPVE("TWAPVE", null),
	
	/**
	 * TWAP VE Calculated by Excluding Closing price.
	 */
	@RosettaEnumValue(value = "TWAPVEExcludingClose") 
	TWAPVE_EXCLUDING_CLOSE("TWAPVEExcludingClose", null),
	 ...
	 * VWAP VE Price.
	 */
	@RosettaEnumValue(value = "VWAPVE") 
	VWAPVE("VWAPVE", null),
	
	/**
	 * VWAP VE Calculated by Excluding Closing price.
	 */
	@RosettaEnumValue(value = "VWAPVEExcludingClose") 
	VWAPVE_EXCLUDING_CLOSE("VWAPVEExcludingClose", null)
;
