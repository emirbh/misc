...
import cdm.base.staticdata.asset.common.validation.datarule.PriceSourcePriceSourceHeading;
...
public class PriceSourceMeta implements RosettaMetaData<PriceSource> {
	...
	public List<Validator<? super PriceSource>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<PriceSource>create(PriceSourcePriceSourceHeading.class)
		);
	}
	...
	@Override
	public Validator<? super PriceSource> validator(ValidatorFactory factory) {
		return factory.<PriceSource>create(PriceSourceValidator.class);
	}

	@Override
	public Validator<? super PriceSource> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PriceSource>create(PriceSourceTypeFormatValidator.class);
	}
