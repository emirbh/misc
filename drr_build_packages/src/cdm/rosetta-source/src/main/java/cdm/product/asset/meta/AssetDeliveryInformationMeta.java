...
public class AssetDeliveryInformationMeta implements RosettaMetaData<AssetDeliveryInformation> {
	...
	@Override
	public Validator<? super AssetDeliveryInformation> validator(ValidatorFactory factory) {
		return factory.<AssetDeliveryInformation>create(AssetDeliveryInformationValidator.class);
	}

	@Override
	public Validator<? super AssetDeliveryInformation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssetDeliveryInformation>create(AssetDeliveryInformationTypeFormatValidator.class);
	}
