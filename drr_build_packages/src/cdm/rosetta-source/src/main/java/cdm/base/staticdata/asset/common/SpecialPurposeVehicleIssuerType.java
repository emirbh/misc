 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SpecialPurposeVehicleIssuerType", builder=SpecialPurposeVehicleIssuerType.SpecialPurposeVehicleIssuerTypeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SpecialPurposeVehicleIssuerType", model="cdm", builder=SpecialPurposeVehicleIssuerType.SpecialPurposeVehicleIssuerTypeBuilderImpl.class, version="6.23.0")
public interface SpecialPurposeVehicleIssuerType extends RosettaModelObject {
	...
	class SpecialPurposeVehicleIssuerTypeBuilderImpl implements SpecialPurposeVehicleIssuerType.SpecialPurposeVehicleIssuerTypeBuilder {
		...
		@RuneAttribute("creditRisk")
		@Override
		public SpecialPurposeVehicleIssuerType.SpecialPurposeVehicleIssuerTypeBuilder setCreditRisk(CreditRiskEnum _creditRisk) {
			this.creditRisk = _creditRisk == null ? null : _creditRisk;
			return this;
		}
