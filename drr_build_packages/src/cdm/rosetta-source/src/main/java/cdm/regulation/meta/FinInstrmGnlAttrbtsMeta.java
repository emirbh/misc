...
public class FinInstrmGnlAttrbtsMeta implements RosettaMetaData<FinInstrmGnlAttrbts> {
	...
	@Override
	public Validator<? super FinInstrmGnlAttrbts> validator(ValidatorFactory factory) {
		return factory.<FinInstrmGnlAttrbts>create(FinInstrmGnlAttrbtsValidator.class);
	}

	@Override
	public Validator<? super FinInstrmGnlAttrbts> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FinInstrmGnlAttrbts>create(FinInstrmGnlAttrbtsTypeFormatValidator.class);
	}
