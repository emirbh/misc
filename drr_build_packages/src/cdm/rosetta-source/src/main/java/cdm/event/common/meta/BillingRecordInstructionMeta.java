...
public class BillingRecordInstructionMeta implements RosettaMetaData<BillingRecordInstruction> {
	...
	@Override
	public Validator<? super BillingRecordInstruction> validator(ValidatorFactory factory) {
		return factory.<BillingRecordInstruction>create(BillingRecordInstructionValidator.class);
	}

	@Override
	public Validator<? super BillingRecordInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<BillingRecordInstruction>create(BillingRecordInstructionTypeFormatValidator.class);
	}
