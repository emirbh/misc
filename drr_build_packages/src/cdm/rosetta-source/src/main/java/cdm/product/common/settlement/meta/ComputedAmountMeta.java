...
public class ComputedAmountMeta implements RosettaMetaData<ComputedAmount> {
	...
	@Override
	public Validator<? super ComputedAmount> validator(ValidatorFactory factory) {
		return factory.<ComputedAmount>create(ComputedAmountValidator.class);
	}

	@Override
	public Validator<? super ComputedAmount> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ComputedAmount>create(ComputedAmountTypeFormatValidator.class);
	}
