...
public class InventoryMeta implements RosettaMetaData<Inventory> {
	...
	@Override
	public Validator<? super Inventory> validator(ValidatorFactory factory) {
		return factory.<Inventory>create(InventoryValidator.class);
	}

	@Override
	public Validator<? super Inventory> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Inventory>create(InventoryTypeFormatValidator.class);
	}
