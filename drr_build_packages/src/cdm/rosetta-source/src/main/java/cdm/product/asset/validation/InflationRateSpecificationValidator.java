		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("InflationRateSpecification", ValidationResult.ValidationType.CARDINALITY, "InflationRateSpecification", path, "", res.getError());
				}
				return success("InflationRateSpecification", ValidationResult.ValidationType.CARDINALITY, "InflationRateSpecification", path, "");
			})
			.collect(toList());
	}
