...
@ImplementedBy(EarlyTerminationEventFpML_ird_40.Default.class)
public interface EarlyTerminationEventFpML_ird_40 extends Validator<EarlyTerminationEvent> {
	
	String NAME = "EarlyTerminationEventFpML_ird_40";
	String DEFINITION = "adjustedExerciseDate <= adjustedCashSettlementValuationDate";
	
	class Default implements EarlyTerminationEventFpML_ird_40 {
	...
	class NoOp implements EarlyTerminationEventFpML_ird_40 {
