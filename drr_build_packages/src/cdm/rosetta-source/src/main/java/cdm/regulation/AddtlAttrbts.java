 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AddtlAttrbts", builder=AddtlAttrbts.AddtlAttrbtsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AddtlAttrbts", model="cdm", builder=AddtlAttrbts.AddtlAttrbtsBuilderImpl.class, version="6.23.0")
public interface AddtlAttrbts extends RosettaModelObject {
	...
	class AddtlAttrbtsImpl implements AddtlAttrbts {
		...
		@Accessor(AccessorType.GETTER)
		@Required
		@RuneAttribute("sctiesFincgTxInd")
	...
	class AddtlAttrbtsBuilderImpl implements AddtlAttrbts.AddtlAttrbtsBuilder {
		...
		@RuneAttribute("rskRdcgTx")
		@Override
		public AddtlAttrbts.AddtlAttrbtsBuilder setRskRdcgTx(String _rskRdcgTx) {
			this.rskRdcgTx = _rskRdcgTx == null ? null : _rskRdcgTx;
			return this;
		}
		...
		@RuneAttribute("sctiesFincgTxInd")
		@Override
		public AddtlAttrbts.AddtlAttrbtsBuilder setSctiesFincgTxInd(String _sctiesFincgTxInd) {
			this.sctiesFincgTxInd = _sctiesFincgTxInd == null ? null : _sctiesFincgTxInd;
			return this;
		}
