...
public class ElectiveAmountElectionOnlyExistsValidator implements ValidatorWithArg<ElectiveAmountElection, Set<String>> {
	...
	public <T2 extends ElectiveAmountElection> ValidationResult<ElectiveAmountElection> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("electiveAmount", ExistenceChecker.isSet((ElectiveAmountEnum) o.getElectiveAmount()))
		...
		if (setFields.equals(fields)) {
			return success("ElectiveAmountElection", ValidationResult.ValidationType.ONLY_EXISTS, "ElectiveAmountElection", path, "");
		}
		return failure("ElectiveAmountElection", ValidationResult.ValidationType.ONLY_EXISTS, "ElectiveAmountElection", path, "",
