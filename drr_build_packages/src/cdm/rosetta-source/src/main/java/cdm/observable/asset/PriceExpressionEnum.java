...
public enum PriceExpressionEnum {
	 ...
	 */
	@RosettaEnumValue(value = "AbsoluteTerms") 
	ABSOLUTE_TERMS("AbsoluteTerms", null),
	
	/**
	 * The price is expressed in percentage of the notional amount.
	 */
	@RosettaEnumValue(value = "PercentageOfNotional") 
	PERCENTAGE_OF_NOTIONAL("PercentageOfNotional", null),
	 ...
	 */
	@RosettaEnumValue(value = "ParValueFraction") 
	PAR_VALUE_FRACTION("ParValueFraction", null),
	
	/**
	 * Denotes a price expressed per number of options.
	 */
	@RosettaEnumValue(value = "PerOption") 
	PER_OPTION("PerOption", null)
;
