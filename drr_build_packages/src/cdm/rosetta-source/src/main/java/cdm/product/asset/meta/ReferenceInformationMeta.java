...
import cdm.product.asset.validation.datarule.ReferenceInformationReferenceInformationChoice;
...
public class ReferenceInformationMeta implements RosettaMetaData<ReferenceInformation> {
	...
	public List<Validator<? super ReferenceInformation>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<ReferenceInformation>create(ReferenceInformationReferenceInformationChoice.class)
		);
	}
