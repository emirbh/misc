...
@RuneDataType(value="FieldWithMetaFloatingRateIndexEnum", model="cdm", builder=FieldWithMetaFloatingRateIndexEnum.FieldWithMetaFloatingRateIndexEnumBuilderImpl.class, version="0.0.0")
