...
public class MarginCallResponseActionMeta implements RosettaMetaData<MarginCallResponseAction> {
	...
	@Override
	public Validator<? super MarginCallResponseAction> validator(ValidatorFactory factory) {
		return factory.<MarginCallResponseAction>create(MarginCallResponseActionValidator.class);
	}

	@Override
	public Validator<? super MarginCallResponseAction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MarginCallResponseAction>create(MarginCallResponseActionTypeFormatValidator.class);
	}
