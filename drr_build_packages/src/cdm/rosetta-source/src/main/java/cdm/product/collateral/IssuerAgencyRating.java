 ...
 * @version 6.23.0
 */
@RosettaDataType(value="IssuerAgencyRating", builder=IssuerAgencyRating.IssuerAgencyRatingBuilderImpl.class, version="6.23.0")
@RuneDataType(value="IssuerAgencyRating", model="cdm", builder=IssuerAgencyRating.IssuerAgencyRatingBuilderImpl.class, version="6.23.0")
