...
public class CalculateTransferInstructionMeta implements RosettaMetaData<CalculateTransferInstruction> {
	...
	@Override
	public Validator<? super CalculateTransferInstruction> validator(ValidatorFactory factory) {
		return factory.<CalculateTransferInstruction>create(CalculateTransferInstructionValidator.class);
	}

	@Override
	public Validator<? super CalculateTransferInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CalculateTransferInstruction>create(CalculateTransferInstructionTypeFormatValidator.class);
	}
