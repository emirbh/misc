 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PhysicalSettlementPeriod", builder=PhysicalSettlementPeriod.PhysicalSettlementPeriodBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PhysicalSettlementPeriod", model="cdm", builder=PhysicalSettlementPeriod.PhysicalSettlementPeriodBuilderImpl.class, version="6.23.0")
