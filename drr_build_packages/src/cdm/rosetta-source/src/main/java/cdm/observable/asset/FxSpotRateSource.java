 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FxSpotRateSource", builder=FxSpotRateSource.FxSpotRateSourceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FxSpotRateSource", model="cdm", builder=FxSpotRateSource.FxSpotRateSourceBuilderImpl.class, version="6.23.0")
public interface FxSpotRateSource extends RosettaModelObject {
	...
	class FxSpotRateSourceBuilderImpl implements FxSpotRateSource.FxSpotRateSourceBuilder {
		...
		@RuneAttribute("primarySource")
		@Override
		public FxSpotRateSource.FxSpotRateSourceBuilder setPrimarySource(InformationSource _primarySource) {
			this.primarySource = _primarySource == null ? null : _primarySource.toBuilder();
			return this;
		}
		...
		@RuneAttribute("secondarySource")
		@Override
		public FxSpotRateSource.FxSpotRateSourceBuilder setSecondarySource(InformationSource _secondarySource) {
			this.secondarySource = _secondarySource == null ? null : _secondarySource.toBuilder();
			return this;
		}
