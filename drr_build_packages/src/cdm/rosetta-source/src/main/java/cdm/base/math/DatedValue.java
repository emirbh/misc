 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DatedValue", builder=DatedValue.DatedValueBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DatedValue", model="cdm", builder=DatedValue.DatedValueBuilderImpl.class, version="6.23.0")
public interface DatedValue extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface DatedValueBuilder extends DatedValue, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class DatedValueBuilderImpl implements DatedValue.DatedValueBuilder {
		...
		@RuneAttribute("date")
		@Override
		public DatedValue.DatedValueBuilder setDate(Date _date) {
		...
		@RuneAttribute("value")
		@Override
		public DatedValue.DatedValueBuilder setValue(BigDecimal _value) {
		...
		@RuneMetaType
		@Override
		public DatedValue.DatedValueBuilder setMeta(MetaFields _meta) {
