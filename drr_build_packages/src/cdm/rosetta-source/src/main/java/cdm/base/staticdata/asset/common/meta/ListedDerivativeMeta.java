...
import cdm.base.staticdata.asset.common.validation.datarule.ListedDerivativeOptions;
...
public class ListedDerivativeMeta implements RosettaMetaData<ListedDerivative> {
	...
	public List<Validator<? super ListedDerivative>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<ListedDerivative>create(ListedDerivativeOptions.class)
		);
	}
	...
	@Override
	public Validator<? super ListedDerivative> validator(ValidatorFactory factory) {
		return factory.<ListedDerivative>create(ListedDerivativeValidator.class);
	}

	@Override
	public Validator<? super ListedDerivative> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ListedDerivative>create(ListedDerivativeTypeFormatValidator.class);
	}
