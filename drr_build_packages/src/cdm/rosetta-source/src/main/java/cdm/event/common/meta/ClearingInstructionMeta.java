...
public class ClearingInstructionMeta implements RosettaMetaData<ClearingInstruction> {
	...
	@Override
	public Validator<? super ClearingInstruction> validator(ValidatorFactory factory) {
		return factory.<ClearingInstruction>create(ClearingInstructionValidator.class);
	}

	@Override
	public Validator<? super ClearingInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ClearingInstruction>create(ClearingInstructionTypeFormatValidator.class);
	}
