 ...
 * @version 6.23.0
 */
@RosettaDataType(value="BillingRecord", builder=BillingRecord.BillingRecordBuilderImpl.class, version="6.23.0")
@RuneDataType(value="BillingRecord", model="cdm", builder=BillingRecord.BillingRecordBuilderImpl.class, version="6.23.0")
public interface BillingRecord extends RosettaModelObject {
	...
	class BillingRecordBuilderImpl implements BillingRecord.BillingRecordBuilder {
		...
		@RuneAttribute("tradeState")
		@Override
		public BillingRecord.BillingRecordBuilder setTradeState(ReferenceWithMetaTradeState _tradeState) {
			this.tradeState = _tradeState == null ? null : _tradeState.toBuilder();
			return this;
		}
		
		@Override
		public BillingRecord.BillingRecordBuilder setTradeStateValue(TradeState _tradeState) {
		...
		@RuneAttribute("recordTransfer")
		@Override
		public BillingRecord.BillingRecordBuilder setRecordTransfer(Transfer _recordTransfer) {
		...
		@RuneAttribute("recordStartDate")
		@Override
		public BillingRecord.BillingRecordBuilder setRecordStartDate(Date _recordStartDate) {
		...
		@RuneAttribute("recordEndDate")
		@Override
		public BillingRecord.BillingRecordBuilder setRecordEndDate(Date _recordEndDate) {
		...
		@RuneAttribute("minimumFee")
		@Override
		public BillingRecord.BillingRecordBuilder setMinimumFee(Money _minimumFee) {
