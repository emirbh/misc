...
@RuneDataType(value="FieldWithMetaPriceSchedule", model="cdm", builder=FieldWithMetaPriceSchedule.FieldWithMetaPriceScheduleBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaPriceSchedule extends RosettaModelObject, FieldWithMeta<PriceSchedule>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaPriceScheduleBuilder extends FieldWithMetaPriceSchedule, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<PriceSchedule>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaPriceScheduleBuilderImpl implements FieldWithMetaPriceSchedule.FieldWithMetaPriceScheduleBuilder {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaPriceSchedule.FieldWithMetaPriceScheduleBuilder setValue(PriceSchedule _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaPriceSchedule.FieldWithMetaPriceScheduleBuilder setMeta(MetaFields _meta) {
