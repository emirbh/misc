...
public class PaymentDateScheduleMeta implements RosettaMetaData<PaymentDateSchedule> {
	...
	@Override
	public Validator<? super PaymentDateSchedule> validator(ValidatorFactory factory) {
		return factory.<PaymentDateSchedule>create(PaymentDateScheduleValidator.class);
	}

	@Override
	public Validator<? super PaymentDateSchedule> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PaymentDateSchedule>create(PaymentDateScheduleTypeFormatValidator.class);
	}
