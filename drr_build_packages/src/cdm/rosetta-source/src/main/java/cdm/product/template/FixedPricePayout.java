 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FixedPricePayout", builder=FixedPricePayout.FixedPricePayoutBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FixedPricePayout", model="cdm", builder=FixedPricePayout.FixedPricePayoutBuilderImpl.class, version="6.23.0")
