 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CalculationPeriodFrequency", builder=CalculationPeriodFrequency.CalculationPeriodFrequencyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CalculationPeriodFrequency", model="cdm", builder=CalculationPeriodFrequency.CalculationPeriodFrequencyBuilderImpl.class, version="6.23.0")
public interface CalculationPeriodFrequency extends Frequency {
	...
	class CalculationPeriodFrequencyBuilderImpl extends Frequency.FrequencyBuilderImpl implements CalculationPeriodFrequency.CalculationPeriodFrequencyBuilder {
		...
		@RuneMetaType
		@Override
		public CalculationPeriodFrequency.CalculationPeriodFrequencyBuilder setMeta(MetaFields _meta) {
		...
		@RuneAttribute("balanceOfFirstPeriod")
		@Override
		public CalculationPeriodFrequency.CalculationPeriodFrequencyBuilder setBalanceOfFirstPeriod(Boolean _balanceOfFirstPeriod) {
