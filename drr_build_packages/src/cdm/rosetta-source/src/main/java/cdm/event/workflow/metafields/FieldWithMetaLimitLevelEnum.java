...
@RuneDataType(value="FieldWithMetaLimitLevelEnum", model="cdm", builder=FieldWithMetaLimitLevelEnum.FieldWithMetaLimitLevelEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaLimitLevelEnum extends RosettaModelObject, FieldWithMeta<LimitLevelEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaLimitLevelEnumBuilder extends FieldWithMetaLimitLevelEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<LimitLevelEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaLimitLevelEnumBuilderImpl implements FieldWithMetaLimitLevelEnum.FieldWithMetaLimitLevelEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaLimitLevelEnum.FieldWithMetaLimitLevelEnumBuilder setValue(LimitLevelEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaLimitLevelEnum.FieldWithMetaLimitLevelEnumBuilder setMeta(MetaFields _meta) {
