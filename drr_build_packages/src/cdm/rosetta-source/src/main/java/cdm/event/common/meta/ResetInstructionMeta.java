...
public class ResetInstructionMeta implements RosettaMetaData<ResetInstruction> {
	...
	@Override
	public Validator<? super ResetInstruction> validator(ValidatorFactory factory) {
		return factory.<ResetInstruction>create(ResetInstructionValidator.class);
	}

	@Override
	public Validator<? super ResetInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ResetInstruction>create(ResetInstructionTypeFormatValidator.class);
	}
