...
public enum ShareExtraordinaryEventEnum {
	 ...
	 */
	@RosettaEnumValue(value = "AlternativeObligation") 
	ALTERNATIVE_OBLIGATION("AlternativeObligation", null),
	 ...
	 */
	@RosettaEnumValue(value = "OptionsExchange") 
	OPTIONS_EXCHANGE("OptionsExchange", null),
	 ...
	 */
	@RosettaEnumValue(value = "ModifiedCalculationAgent") 
	MODIFIED_CALCULATION_AGENT("ModifiedCalculationAgent", null),
	 ...
	 */
	@RosettaEnumValue(value = "PartialCancellationAndPayment") 
	PARTIAL_CANCELLATION_AND_PAYMENT("PartialCancellationAndPayment", null),
