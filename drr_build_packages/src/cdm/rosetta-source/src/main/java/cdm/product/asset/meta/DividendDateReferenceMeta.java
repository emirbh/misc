...
import cdm.product.asset.validation.datarule.DividendDateReferencePaymentDateOffset;
...
public class DividendDateReferenceMeta implements RosettaMetaData<DividendDateReference> {
	...
	public List<Validator<? super DividendDateReference>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<DividendDateReference>create(DividendDateReferencePaymentDateOffset.class)
		);
	}
	...
	@Override
	public Validator<? super DividendDateReference> validator(ValidatorFactory factory) {
		return factory.<DividendDateReference>create(DividendDateReferenceValidator.class);
	}

	@Override
	public Validator<? super DividendDateReference> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DividendDateReference>create(DividendDateReferenceTypeFormatValidator.class);
	}
