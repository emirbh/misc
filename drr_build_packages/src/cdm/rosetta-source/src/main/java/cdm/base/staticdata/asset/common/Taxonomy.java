 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Taxonomy", builder=Taxonomy.TaxonomyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Taxonomy", model="cdm", builder=Taxonomy.TaxonomyBuilderImpl.class, version="6.23.0")
public interface Taxonomy extends RosettaModelObject {
	...
	class TaxonomyBuilderImpl implements Taxonomy.TaxonomyBuilder {
		...
		@RuneAttribute("source")
		@Override
		public Taxonomy.TaxonomyBuilder setSource(TaxonomySourceEnum _source) {
		...
		@RuneAttribute("value")
		@Override
		public Taxonomy.TaxonomyBuilder setValue(TaxonomyValue _value) {
