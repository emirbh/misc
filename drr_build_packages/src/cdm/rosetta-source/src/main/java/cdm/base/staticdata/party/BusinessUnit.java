 ...
 * @version 6.23.0
 */
@RosettaDataType(value="BusinessUnit", builder=BusinessUnit.BusinessUnitBuilderImpl.class, version="6.23.0")
@RuneDataType(value="BusinessUnit", model="cdm", builder=BusinessUnit.BusinessUnitBuilderImpl.class, version="6.23.0")
public interface BusinessUnit extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface BusinessUnitBuilder extends BusinessUnit, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class BusinessUnitBuilderImpl implements BusinessUnit.BusinessUnitBuilder {
		...
		@RuneAttribute("identifier")
		@Override
		public BusinessUnit.BusinessUnitBuilder setIdentifier(Identifier _identifier) {
		...
		@RuneAttribute("contactInformation")
		@Override
		public BusinessUnit.BusinessUnitBuilder setContactInformation(ContactInformation _contactInformation) {
		...
		@RuneMetaType
		@Override
		public BusinessUnit.BusinessUnitBuilder setMeta(MetaFields _meta) {
