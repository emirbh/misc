...
public class AncillaryPartyMeta implements RosettaMetaData<AncillaryParty> {
	...
	@Override
	public Validator<? super AncillaryParty> validator(ValidatorFactory factory) {
		return factory.<AncillaryParty>create(AncillaryPartyValidator.class);
	}

	@Override
	public Validator<? super AncillaryParty> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AncillaryParty>create(AncillaryPartyTypeFormatValidator.class);
	}
