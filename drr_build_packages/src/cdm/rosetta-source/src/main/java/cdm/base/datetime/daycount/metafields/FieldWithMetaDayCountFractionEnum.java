...
@RuneDataType(value="FieldWithMetaDayCountFractionEnum", model="cdm", builder=FieldWithMetaDayCountFractionEnum.FieldWithMetaDayCountFractionEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaDayCountFractionEnum extends RosettaModelObject, FieldWithMeta<DayCountFractionEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaDayCountFractionEnumBuilder extends FieldWithMetaDayCountFractionEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<DayCountFractionEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaDayCountFractionEnumBuilderImpl implements FieldWithMetaDayCountFractionEnum.FieldWithMetaDayCountFractionEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaDayCountFractionEnum.FieldWithMetaDayCountFractionEnumBuilder setValue(DayCountFractionEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaDayCountFractionEnum.FieldWithMetaDayCountFractionEnumBuilder setMeta(MetaFields _meta) {
