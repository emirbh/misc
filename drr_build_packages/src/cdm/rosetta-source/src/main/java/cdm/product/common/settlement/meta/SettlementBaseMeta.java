...
public class SettlementBaseMeta implements RosettaMetaData<SettlementBase> {
	...
	@Override
	public Validator<? super SettlementBase> validator(ValidatorFactory factory) {
		return factory.<SettlementBase>create(SettlementBaseValidator.class);
	}

	@Override
	public Validator<? super SettlementBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SettlementBase>create(SettlementBaseTypeFormatValidator.class);
	}
