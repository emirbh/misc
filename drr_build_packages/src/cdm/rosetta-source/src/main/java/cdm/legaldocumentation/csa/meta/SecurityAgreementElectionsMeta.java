...
public class SecurityAgreementElectionsMeta implements RosettaMetaData<SecurityAgreementElections> {
	...
	@Override
	public Validator<? super SecurityAgreementElections> validator(ValidatorFactory factory) {
		return factory.<SecurityAgreementElections>create(SecurityAgreementElectionsValidator.class);
	}

	@Override
	public Validator<? super SecurityAgreementElections> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SecurityAgreementElections>create(SecurityAgreementElectionsTypeFormatValidator.class);
	}
