...
public class TradeLotMeta implements RosettaMetaData<TradeLot> {
	...
	@Override
	public Validator<? super TradeLot> validator(ValidatorFactory factory) {
		return factory.<TradeLot>create(TradeLotValidator.class);
	}

	@Override
	public Validator<? super TradeLot> typeFormatValidator(ValidatorFactory factory) {
		return factory.<TradeLot>create(TradeLotTypeFormatValidator.class);
	}
