 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AssetMaturity", builder=AssetMaturity.AssetMaturityBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AssetMaturity", model="cdm", builder=AssetMaturity.AssetMaturityBuilderImpl.class, version="6.23.0")
