...
public class QtyMeta implements RosettaMetaData<Qty> {
	...
	@Override
	public Validator<? super Qty> validator(ValidatorFactory factory) {
		return factory.<Qty>create(QtyValidator.class);
	}

	@Override
	public Validator<? super Qty> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Qty>create(QtyTypeFormatValidator.class);
	}
