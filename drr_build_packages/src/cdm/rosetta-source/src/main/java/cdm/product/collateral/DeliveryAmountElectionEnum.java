...
public enum DeliveryAmountElectionEnum {
	 ...
	 */
	@RosettaEnumValue(value = "LastLocalBusinessDay") 
	LAST_LOCAL_BUSINESS_DAY("LastLocalBusinessDay", null),
	 ...
	 */
	@RosettaEnumValue(value = "LastAndAnyLocalBusinessDay") 
	LAST_AND_ANY_LOCAL_BUSINESS_DAY("LastAndAnyLocalBusinessDay", null)
;
