 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CreditLimitUtilisation", builder=CreditLimitUtilisation.CreditLimitUtilisationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CreditLimitUtilisation", model="cdm", builder=CreditLimitUtilisation.CreditLimitUtilisationBuilderImpl.class, version="6.23.0")
public interface CreditLimitUtilisation extends RosettaModelObject {
	...
	class CreditLimitUtilisationBuilderImpl implements CreditLimitUtilisation.CreditLimitUtilisationBuilder {
		...
		@RuneAttribute("executed")
		@Override
		public CreditLimitUtilisation.CreditLimitUtilisationBuilder setExecuted(CreditLimitUtilisationPosition _executed) {
		...
		@RuneAttribute("pending")
		@Override
		public CreditLimitUtilisation.CreditLimitUtilisationBuilder setPending(CreditLimitUtilisationPosition _pending) {
