 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Observable", builder=Observable.ObservableBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Observable", model="cdm", builder=Observable.ObservableBuilderImpl.class, version="6.23.0")
@RuneChoiceType
