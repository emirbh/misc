...
@ImplementedBy(CalculationPeriodDatesFpML_ird_17.Default.class)
public interface CalculationPeriodDatesFpML_ird_17 extends Validator<CalculationPeriodDates> {
	...
	class Default implements CalculationPeriodDatesFpML_ird_17 {
	...
	class NoOp implements CalculationPeriodDatesFpML_ird_17 {
