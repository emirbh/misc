 ...
 * @version 6.23.0
 */
@RosettaDataType(value="BuyerSeller", builder=BuyerSeller.BuyerSellerBuilderImpl.class, version="6.23.0")
@RuneDataType(value="BuyerSeller", model="cdm", builder=BuyerSeller.BuyerSellerBuilderImpl.class, version="6.23.0")
public interface BuyerSeller extends RosettaModelObject {
	...
	class BuyerSellerBuilderImpl implements BuyerSeller.BuyerSellerBuilder {
		...
		@RuneAttribute("buyer")
		@Override
		public BuyerSeller.BuyerSellerBuilder setBuyer(CounterpartyRoleEnum _buyer) {
		...
		@RuneAttribute("seller")
		@Override
		public BuyerSeller.BuyerSellerBuilder setSeller(CounterpartyRoleEnum _seller) {
