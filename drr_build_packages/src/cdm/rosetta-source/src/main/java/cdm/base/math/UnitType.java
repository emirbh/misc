 ...
 * @version 6.23.0
 */
@RosettaDataType(value="UnitType", builder=UnitType.UnitTypeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="UnitType", model="cdm", builder=UnitType.UnitTypeBuilderImpl.class, version="6.23.0")
