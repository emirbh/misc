 ...
 * @version 6.23.0
 */
@RosettaDataType(value="InterestAmountApplication", builder=InterestAmountApplication.InterestAmountApplicationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="InterestAmountApplication", model="cdm", builder=InterestAmountApplication.InterestAmountApplicationBuilderImpl.class, version="6.23.0")
public interface InterestAmountApplication extends RosettaModelObject {
	...
	class InterestAmountApplicationBuilderImpl implements InterestAmountApplication.InterestAmountApplicationBuilder {
		...
		@RuneAttribute("returnAmount")
		@Override
		public InterestAmountApplication.InterestAmountApplicationBuilder setReturnAmount(ReturnAmount _returnAmount) {
		...
		@RuneAttribute("deliveryAmount")
		@Override
		public InterestAmountApplication.InterestAmountApplicationBuilder setDeliveryAmount(DeliveryAmount _deliveryAmount) {
