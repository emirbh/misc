 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ResetFrequency", builder=ResetFrequency.ResetFrequencyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ResetFrequency", model="cdm", builder=ResetFrequency.ResetFrequencyBuilderImpl.class, version="6.23.0")
