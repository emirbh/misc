 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Cashflow", builder=Cashflow.CashflowBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Cashflow", model="cdm", builder=Cashflow.CashflowBuilderImpl.class, version="6.23.0")
