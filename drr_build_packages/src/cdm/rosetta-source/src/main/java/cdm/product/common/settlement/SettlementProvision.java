 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SettlementProvision", builder=SettlementProvision.SettlementProvisionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SettlementProvision", model="cdm", builder=SettlementProvision.SettlementProvisionBuilderImpl.class, version="6.23.0")
public interface SettlementProvision extends RosettaModelObject {
	...
	class SettlementProvisionImpl implements SettlementProvision {
		...
		@RuneAttribute("shapingProvisions")
	...
	class SettlementProvisionBuilderImpl implements SettlementProvision.SettlementProvisionBuilder {
		...
		@RuneAttribute("shapingProvisions")
		@Override
		public SettlementProvision.SettlementProvisionBuilder setShapingProvisions(ShapingProvision _shapingProvisions) {
			this.shapingProvisions = _shapingProvisions == null ? null : _shapingProvisions.toBuilder();
			return this;
		}
