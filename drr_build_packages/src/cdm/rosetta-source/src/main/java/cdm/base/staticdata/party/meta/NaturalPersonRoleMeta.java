...
public class NaturalPersonRoleMeta implements RosettaMetaData<NaturalPersonRole> {
	...
	@Override
	public Validator<? super NaturalPersonRole> validator(ValidatorFactory factory) {
		return factory.<NaturalPersonRole>create(NaturalPersonRoleValidator.class);
	}

	@Override
	public Validator<? super NaturalPersonRole> typeFormatValidator(ValidatorFactory factory) {
		return factory.<NaturalPersonRole>create(NaturalPersonRoleTypeFormatValidator.class);
	}
