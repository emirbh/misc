...
@RuneDataType(value="FieldWithMetaQuotedCurrencyPair", model="cdm", builder=FieldWithMetaQuotedCurrencyPair.FieldWithMetaQuotedCurrencyPairBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaQuotedCurrencyPair extends RosettaModelObject, FieldWithMeta<QuotedCurrencyPair>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaQuotedCurrencyPairBuilder extends FieldWithMetaQuotedCurrencyPair, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<QuotedCurrencyPair>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaQuotedCurrencyPairBuilderImpl implements FieldWithMetaQuotedCurrencyPair.FieldWithMetaQuotedCurrencyPairBuilder {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaQuotedCurrencyPair.FieldWithMetaQuotedCurrencyPairBuilder setValue(QuotedCurrencyPair _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaQuotedCurrencyPair.FieldWithMetaQuotedCurrencyPairBuilder setMeta(MetaFields _meta) {
