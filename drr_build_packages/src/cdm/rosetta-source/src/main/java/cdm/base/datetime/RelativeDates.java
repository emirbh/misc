 ...
 * @version 6.23.0
 */
@RosettaDataType(value="RelativeDates", builder=RelativeDates.RelativeDatesBuilderImpl.class, version="6.23.0")
@RuneDataType(value="RelativeDates", model="cdm", builder=RelativeDates.RelativeDatesBuilderImpl.class, version="6.23.0")
