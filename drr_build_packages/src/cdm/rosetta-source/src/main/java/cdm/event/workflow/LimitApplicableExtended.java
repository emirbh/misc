 ...
 * @version 6.23.0
 */
@RosettaDataType(value="LimitApplicableExtended", builder=LimitApplicableExtended.LimitApplicableExtendedBuilderImpl.class, version="6.23.0")
@RuneDataType(value="LimitApplicableExtended", model="cdm", builder=LimitApplicableExtended.LimitApplicableExtendedBuilderImpl.class, version="6.23.0")
