 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Curve", builder=Curve.CurveBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Curve", model="cdm", builder=Curve.CurveBuilderImpl.class, version="6.23.0")
public interface Curve extends RosettaModelObject {
	...
	class CurveImpl implements Curve {
		...
		@RuneAttribute("interestRateCurve")
		...
		public int hashCode() {
			...
			_result = 31 * _result + (commodityCurve != null ? commodityCurve.hashCode() : 0);
			return _result;
		}
	...
	class CurveBuilderImpl implements Curve.CurveBuilder {
		...
		@RuneAttribute("interestRateCurve")
		@Override
		public Curve.CurveBuilder setInterestRateCurve(InterestRateCurve _interestRateCurve) {
			this.interestRateCurve = _interestRateCurve == null ? null : _interestRateCurve.toBuilder();
			return this;
		}
		...
		@RuneAttribute("commodityCurve")
		@Override
		public Curve.CurveBuilder setCommodityCurve(FieldWithMetaCommodityReferencePriceEnum _commodityCurve) {
			this.commodityCurve = _commodityCurve == null ? null : _commodityCurve.toBuilder();
			return this;
		}
		
		@Override
		public Curve.CurveBuilder setCommodityCurveValue(CommodityReferencePriceEnum _commodityCurve) {
			this.getOrCreateCommodityCurve().setValue(_commodityCurve);
			return this;
		}
