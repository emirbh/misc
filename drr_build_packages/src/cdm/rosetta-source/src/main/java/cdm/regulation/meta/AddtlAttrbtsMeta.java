...
public class AddtlAttrbtsMeta implements RosettaMetaData<AddtlAttrbts> {
	...
	@Override
	public Validator<? super AddtlAttrbts> validator(ValidatorFactory factory) {
		return factory.<AddtlAttrbts>create(AddtlAttrbtsValidator.class);
	}

	@Override
	public Validator<? super AddtlAttrbts> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AddtlAttrbts>create(AddtlAttrbtsTypeFormatValidator.class);
	}
