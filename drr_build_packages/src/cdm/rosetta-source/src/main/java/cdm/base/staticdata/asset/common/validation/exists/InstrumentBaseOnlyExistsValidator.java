...
public class InstrumentBaseOnlyExistsValidator implements ValidatorWithArg<InstrumentBase, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends InstrumentBase> ValidationResult<InstrumentBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("InstrumentBase", ValidationResult.ValidationType.ONLY_EXISTS, "InstrumentBase", path, "");
		}
		return failure("InstrumentBase", ValidationResult.ValidationType.ONLY_EXISTS, "InstrumentBase", path, "",
