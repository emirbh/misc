 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PartialExercise", builder=PartialExercise.PartialExerciseBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PartialExercise", model="cdm", builder=PartialExercise.PartialExerciseBuilderImpl.class, version="6.23.0")
public interface PartialExercise extends RosettaModelObject {
	...
	class PartialExerciseBuilderImpl implements PartialExercise.PartialExerciseBuilder {
		...
		@RuneAttribute("notionaReference")
		@Override
		public PartialExercise.PartialExerciseBuilder setNotionaReference(ReferenceWithMetaMoney _notionaReference) {
			this.notionaReference = _notionaReference == null ? null : _notionaReference.toBuilder();
			return this;
		}
		
		@Override
		public PartialExercise.PartialExerciseBuilder setNotionaReferenceValue(Money _notionaReference) {
		...
		@RuneAttribute("minimumNumberOfOptions")
		@Override
		public PartialExercise.PartialExerciseBuilder setMinimumNumberOfOptions(Integer _minimumNumberOfOptions) {
