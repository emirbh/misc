...
import cdm.product.common.settlement.validation.datarule.PhysicalSettlementTermsPredeterminedClearingOrganizationParty;
...
public class PhysicalSettlementTermsMeta implements RosettaMetaData<PhysicalSettlementTerms> {
	...
	public List<Validator<? super PhysicalSettlementTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<PhysicalSettlementTerms>create(PhysicalSettlementTermsPredeterminedClearingOrganizationParty.class)
		);
	}
