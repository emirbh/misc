...
@RuneDataType(value="ReferenceWithMetaBusinessCenters", model="cdm", builder=ReferenceWithMetaBusinessCenters.ReferenceWithMetaBusinessCentersBuilderImpl.class, version="0.0.0")
