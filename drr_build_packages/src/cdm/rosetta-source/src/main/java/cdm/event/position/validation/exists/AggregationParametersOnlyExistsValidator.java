...
public class AggregationParametersOnlyExistsValidator implements ValidatorWithArg<AggregationParameters, Set<String>> {
	...
	public <T2 extends AggregationParameters> ValidationResult<AggregationParameters> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("product", ExistenceChecker.isSet((List<? extends NonTransferableProduct>) o.getProduct()))
		...
		if (setFields.equals(fields)) {
			return success("AggregationParameters", ValidationResult.ValidationType.ONLY_EXISTS, "AggregationParameters", path, "");
		}
		return failure("AggregationParameters", ValidationResult.ValidationType.ONLY_EXISTS, "AggregationParameters", path, "",
