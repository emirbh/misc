...
public class AssetAgencyRatingMeta implements RosettaMetaData<AssetAgencyRating> {
	...
	@Override
	public Validator<? super AssetAgencyRating> validator(ValidatorFactory factory) {
		return factory.<AssetAgencyRating>create(AssetAgencyRatingValidator.class);
	}

	@Override
	public Validator<? super AssetAgencyRating> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssetAgencyRating>create(AssetAgencyRatingTypeFormatValidator.class);
	}
