...
import cdm.product.collateral.validation.datarule.AgencyRatingCriteriaReferenceAgency;
...
public class AgencyRatingCriteriaMeta implements RosettaMetaData<AgencyRatingCriteria> {
	...
	public List<Validator<? super AgencyRatingCriteria>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<AgencyRatingCriteria>create(AgencyRatingCriteriaReferenceAgency.class)
		);
	}
	...
	@Override
	public Validator<? super AgencyRatingCriteria> validator(ValidatorFactory factory) {
		return factory.<AgencyRatingCriteria>create(AgencyRatingCriteriaValidator.class);
	}

	@Override
	public Validator<? super AgencyRatingCriteria> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AgencyRatingCriteria>create(AgencyRatingCriteriaTypeFormatValidator.class);
	}
