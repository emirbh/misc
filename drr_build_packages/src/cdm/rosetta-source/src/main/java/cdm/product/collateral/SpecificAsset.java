 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SpecificAsset", builder=SpecificAsset.SpecificAssetBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SpecificAsset", model="cdm", builder=SpecificAsset.SpecificAssetBuilderImpl.class, version="6.23.0")
