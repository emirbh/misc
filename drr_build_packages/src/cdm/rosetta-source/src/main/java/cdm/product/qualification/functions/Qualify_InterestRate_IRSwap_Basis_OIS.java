	...
	*/
	...
	public static class Qualify_InterestRate_IRSwap_Basis_OISDefault extends Qualify_InterestRate_IRSwap_Basis_OIS {
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = areEqual(MapperS.of(qualify_BaseProduct_IRSwap.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All).andNullSafe(areEqual(MapperS.of(qualify_SubProduct_Basis.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All)).andNullSafe(areEqual(MapperS.of(qualify_Transaction_OIS.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All)).get();
