...
public class ExerciseInstructionOnlyExistsValidator implements ValidatorWithArg<ExerciseInstruction, Set<String>> {
	...
	public <T2 extends ExerciseInstruction> ValidationResult<ExerciseInstruction> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("exerciseOption", ExistenceChecker.isSet((ReferenceWithMetaPayout) o.getExerciseOption()))
		...
		if (setFields.equals(fields)) {
			return success("ExerciseInstruction", ValidationResult.ValidationType.ONLY_EXISTS, "ExerciseInstruction", path, "");
		}
		return failure("ExerciseInstruction", ValidationResult.ValidationType.ONLY_EXISTS, "ExerciseInstruction", path, "",
