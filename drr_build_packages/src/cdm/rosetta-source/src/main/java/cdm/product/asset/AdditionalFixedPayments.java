 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AdditionalFixedPayments", builder=AdditionalFixedPayments.AdditionalFixedPaymentsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AdditionalFixedPayments", model="cdm", builder=AdditionalFixedPayments.AdditionalFixedPaymentsBuilderImpl.class, version="6.23.0")
