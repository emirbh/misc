...
public enum EventTimestampQualificationEnum {
	 ...
	 */
	@RosettaEnumValue(value = "clearingDateTime") 
	CLEARING_DATE_TIME("clearingDateTime", null),
	
	/**
	 * The date and time on which trade was confirmed as cleared.
	 */
	@RosettaEnumValue(value = "clearingConfirmationDateTime") 
	CLEARING_CONFIRMATION_DATE_TIME("clearingConfirmationDateTime", null),
	
	/**
	 * The date and time on which trade was received by Clearing Body.
	 */
	@RosettaEnumValue(value = "clearingReceiptDateTime") 
	CLEARING_RECEIPT_DATE_TIME("clearingReceiptDateTime", null),
	
	/**
	 * The date and time on which the event was submitted for clearing.
	 */
	@RosettaEnumValue(value = "clearingSubmissionDateTime") 
	CLEARING_SUBMISSION_DATE_TIME("clearingSubmissionDateTime", null),
	
	/**
	 * The date and time on which the event was confirmed.
	 */
	@RosettaEnumValue(value = "confirmationDateTime") 
	CONFIRMATION_DATE_TIME("confirmationDateTime", null),
	
	/**
	 * The date and time on which the event was created.
	 */
	@RosettaEnumValue(value = "eventCreationDateTime") 
	EVENT_CREATION_DATE_TIME("eventCreationDateTime", null),
	
	/**
	 * The date and time on which the event will be considered expired.
	 */
	@RosettaEnumValue(value = "eventExpirationDateTime") 
	EVENT_EXPIRATION_DATE_TIME("eventExpirationDateTime", null),
	
	/**
	 * The date and time on which the event was processed.
	 */
	@RosettaEnumValue(value = "eventProcessingDateTime") 
	EVENT_PROCESSING_DATE_TIME("eventProcessingDateTime", null),
	
	/**
	 * The date and time on which the event was sent.
	 */
	@RosettaEnumValue(value = "eventSentDateTime") 
	EVENT_SENT_DATE_TIME("eventSentDateTime", null),
	
	/**
	 * The date and time on which the event was submitted.
	 */
	@RosettaEnumValue(value = "eventSubmittedDateTime") 
	EVENT_SUBMITTED_DATE_TIME("eventSubmittedDateTime", null),
	
	/**
	 * The date and time on which the trade execution was performed.
	 */
	@RosettaEnumValue(value = "executionDateTime") 
	EXECUTION_DATE_TIME("executionDateTime", null),
	 ...
	 */
	@RosettaEnumValue(value = "transactionCreationDateTime") 
	TRANSACTION_CREATION_DATE_TIME("transactionCreationDateTime", null)
;
