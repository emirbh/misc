 ...
 * @version 6.23.0
 */
@RosettaDataType(value="InterestRatePayout", builder=InterestRatePayout.InterestRatePayoutBuilderImpl.class, version="6.23.0")
@RuneDataType(value="InterestRatePayout", model="cdm", builder=InterestRatePayout.InterestRatePayoutBuilderImpl.class, version="6.23.0")
