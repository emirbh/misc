...
public enum CollateralStatusEnum {
	 ...
	 */
	@RosettaEnumValue(value = "FullAmount") 
	FULL_AMOUNT("FullAmount", null),
	
	/**
	 * Indicates the collateral is settled and not an in transit pre-agreed collateral amount/s.
	 */
	@RosettaEnumValue(value = "SettledAmount") 
	 ...
	 */
	@RosettaEnumValue(value = "InTransitAmount") 
	IN_TRANSIT_AMOUNT("InTransitAmount", null)
;
