 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FloatingAmountProvisions", builder=FloatingAmountProvisions.FloatingAmountProvisionsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FloatingAmountProvisions", model="cdm", builder=FloatingAmountProvisions.FloatingAmountProvisionsBuilderImpl.class, version="6.23.0")
