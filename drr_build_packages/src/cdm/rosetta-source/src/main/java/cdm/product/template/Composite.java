 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Composite", builder=Composite.CompositeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Composite", model="cdm", builder=Composite.CompositeBuilderImpl.class, version="6.23.0")
public interface Composite extends RosettaModelObject {
	...
	class CompositeBuilderImpl implements Composite.CompositeBuilder {
		...
		@RuneAttribute("determinationMethod")
		@Override
		public Composite.CompositeBuilder setDeterminationMethod(DeterminationMethodEnum _determinationMethod) {
		...
		@RuneAttribute("fixingTime")
		@Override
		public Composite.CompositeBuilder setFixingTime(BusinessCenterTime _fixingTime) {
