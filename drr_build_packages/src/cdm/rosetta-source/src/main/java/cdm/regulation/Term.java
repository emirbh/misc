 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Term", builder=Term.TermBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Term", model="cdm", builder=Term.TermBuilderImpl.class, version="6.23.0")
public interface Term extends RosettaModelObject {
	...
	class TermBuilderImpl implements Term.TermBuilder {
		...
		@RuneAttribute("unit")
		@Override
		public Term.TermBuilder setUnit(String _unit) {
		...
		@RuneAttribute("val")
		@Override
		public Term.TermBuilder setVal(String _val) {
