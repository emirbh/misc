...
@RuneDataType(value="ReferenceWithMetaExecutionDetails", model="cdm", builder=ReferenceWithMetaExecutionDetails.ReferenceWithMetaExecutionDetailsBuilderImpl.class, version="0.0.0")
