...
import cdm.product.collateral.validation.datarule.ConcentrationLimitCriteriaConcentrationLimitTypeChoice;
...
public class ConcentrationLimitCriteriaMeta implements RosettaMetaData<ConcentrationLimitCriteria> {
	...
	public List<Validator<? super ConcentrationLimitCriteria>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<ConcentrationLimitCriteria>create(ConcentrationLimitCriteriaConcentrationLimitTypeChoice.class)
		);
	}
	...
	@Override
	public Validator<? super ConcentrationLimitCriteria> validator(ValidatorFactory factory) {
		return factory.<ConcentrationLimitCriteria>create(ConcentrationLimitCriteriaValidator.class);
	}

	@Override
	public Validator<? super ConcentrationLimitCriteria> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ConcentrationLimitCriteria>create(ConcentrationLimitCriteriaTypeFormatValidator.class);
	}
