...
public class TermsChangeInstructionOnlyExistsValidator implements ValidatorWithArg<TermsChangeInstruction, Set<String>> {
	...
	public <T2 extends TermsChangeInstruction> ValidationResult<TermsChangeInstruction> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("product", ExistenceChecker.isSet((NonTransferableProduct) o.getProduct()))
		...
		if (setFields.equals(fields)) {
			return success("TermsChangeInstruction", ValidationResult.ValidationType.ONLY_EXISTS, "TermsChangeInstruction", path, "");
		}
		return failure("TermsChangeInstruction", ValidationResult.ValidationType.ONLY_EXISTS, "TermsChangeInstruction", path, "",
