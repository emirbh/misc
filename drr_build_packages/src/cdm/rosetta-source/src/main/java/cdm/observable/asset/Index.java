 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Index", builder=Index.IndexBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Index", model="cdm", builder=Index.IndexBuilderImpl.class, version="6.23.0")
@RuneChoiceType
