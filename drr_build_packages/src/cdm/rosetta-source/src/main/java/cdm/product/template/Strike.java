 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Strike", builder=Strike.StrikeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Strike", model="cdm", builder=Strike.StrikeBuilderImpl.class, version="6.23.0")
public interface Strike extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface StrikeBuilder extends Strike, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class StrikeBuilderImpl implements Strike.StrikeBuilder {
		...
		@RuneAttribute("buyer")
		@Override
		public Strike.StrikeBuilder setBuyer(PayerReceiverEnum _buyer) {
		...
		@RuneAttribute("seller")
		@Override
		public Strike.StrikeBuilder setSeller(PayerReceiverEnum _seller) {
		...
		@RuneMetaType
		@Override
		public Strike.StrikeBuilder setMeta(MetaFields _meta) {
