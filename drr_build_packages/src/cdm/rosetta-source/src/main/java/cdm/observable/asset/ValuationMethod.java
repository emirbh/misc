 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ValuationMethod", builder=ValuationMethod.ValuationMethodBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ValuationMethod", model="cdm", builder=ValuationMethod.ValuationMethodBuilderImpl.class, version="6.23.0")
public interface ValuationMethod extends RosettaModelObject {
	...
	class ValuationMethodImpl implements ValuationMethod {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("cashCollateralValuationMethod")
	...
	class ValuationMethodBuilderImpl implements ValuationMethod.ValuationMethodBuilder {
		...
		@RuneAttribute("valuationSource")
		@Override
		public ValuationMethod.ValuationMethodBuilder setValuationSource(ValuationSource _valuationSource) {
			this.valuationSource = _valuationSource == null ? null : _valuationSource.toBuilder();
			return this;
		}
		...
		@RuneAttribute("quotationMethod")
		@Override
		public ValuationMethod.ValuationMethodBuilder setQuotationMethod(QuotationRateTypeEnum _quotationMethod) {
		...
		@RuneAttribute("valuationMethod")
		@Override
		public ValuationMethod.ValuationMethodBuilder setValuationMethod(ValuationMethodEnum _valuationMethod) {
		...
		@RuneAttribute("quotationAmount")
		@Override
		public ValuationMethod.ValuationMethodBuilder setQuotationAmount(Money _quotationAmount) {
		...
		@RuneAttribute("minimumQuotationAmount")
		@Override
		public ValuationMethod.ValuationMethodBuilder setMinimumQuotationAmount(Money _minimumQuotationAmount) {
		...
		@RuneAttribute("cashCollateralValuationMethod")
		@Override
		public ValuationMethod.ValuationMethodBuilder setCashCollateralValuationMethod(CashCollateralValuationMethod _cashCollateralValuationMethod) {
			this.cashCollateralValuationMethod = _cashCollateralValuationMethod == null ? null : _cashCollateralValuationMethod.toBuilder();
			return this;
		}
