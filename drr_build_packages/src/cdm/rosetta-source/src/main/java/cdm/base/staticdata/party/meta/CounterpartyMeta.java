...
public class CounterpartyMeta implements RosettaMetaData<Counterparty> {
	...
	@Override
	public Validator<? super Counterparty> validator(ValidatorFactory factory) {
		return factory.<Counterparty>create(CounterpartyValidator.class);
	}

	@Override
	public Validator<? super Counterparty> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Counterparty>create(CounterpartyTypeFormatValidator.class);
	}
