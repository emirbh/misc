 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Buyr", builder=Buyr.BuyrBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Buyr", model="cdm", builder=Buyr.BuyrBuilderImpl.class, version="6.23.0")
public interface Buyr extends RosettaModelObject {
	...
	class BuyrBuilderImpl implements Buyr.BuyrBuilder {
		...
		@RuneAttribute("acctOwnr")
		@Override
		public Buyr.BuyrBuilder setAcctOwnr(AcctOwnr _acctOwnr) {
