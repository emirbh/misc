...
public class CashflowRepresentationMeta implements RosettaMetaData<CashflowRepresentation> {
	...
	@Override
	public Validator<? super CashflowRepresentation> validator(ValidatorFactory factory) {
		return factory.<CashflowRepresentation>create(CashflowRepresentationValidator.class);
	}

	@Override
	public Validator<? super CashflowRepresentation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CashflowRepresentation>create(CashflowRepresentationTypeFormatValidator.class);
	}
