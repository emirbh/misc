 ...
 * @version 6.23.0
 */
@RosettaDataType(value="RateSchedule", builder=RateSchedule.RateScheduleBuilderImpl.class, version="6.23.0")
@RuneDataType(value="RateSchedule", model="cdm", builder=RateSchedule.RateScheduleBuilderImpl.class, version="6.23.0")
public interface RateSchedule extends RosettaModelObject {
	...
	interface RateScheduleBuilder extends RateSchedule, RosettaModelObjectBuilder {
		...
		RateSchedule.RateScheduleBuilder setPrice(ReferenceWithMetaPriceSchedule price);
		RateSchedule.RateScheduleBuilder setPriceValue(PriceSchedule price);
	...
	class RateScheduleBuilderImpl implements RateSchedule.RateScheduleBuilder {
		...
		@RuneScopedAttributeReference
		@Override
		public RateSchedule.RateScheduleBuilder setPrice(ReferenceWithMetaPriceSchedule _price) {
			this.price = _price == null ? null : _price.toBuilder();
			return this;
		}
		
		@Override
		public RateSchedule.RateScheduleBuilder setPriceValue(PriceSchedule _price) {
