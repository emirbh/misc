 ...
 * @version 6.23.0
 */
@RosettaDataType(value="RelatedParty", builder=RelatedParty.RelatedPartyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="RelatedParty", model="cdm", builder=RelatedParty.RelatedPartyBuilderImpl.class, version="6.23.0")
public interface RelatedParty extends RosettaModelObject {
	...
	class RelatedPartyBuilderImpl implements RelatedParty.RelatedPartyBuilder {
		...
		@RuneAttribute("partyReference")
		@Override
		public RelatedParty.RelatedPartyBuilder setPartyReference(ReferenceWithMetaParty _partyReference) {
			this.partyReference = _partyReference == null ? null : _partyReference.toBuilder();
			return this;
		}
		
		@Override
		public RelatedParty.RelatedPartyBuilder setPartyReferenceValue(Party _partyReference) {
		...
		@RuneAttribute("accountReference")
		@Override
		public RelatedParty.RelatedPartyBuilder setAccountReference(ReferenceWithMetaAccount _accountReference) {
			this.accountReference = _accountReference == null ? null : _accountReference.toBuilder();
			return this;
		}
		
		@Override
		public RelatedParty.RelatedPartyBuilder setAccountReferenceValue(Account _accountReference) {
			this.getOrCreateAccountReference().setValue(_accountReference);
			return this;
		}
		...
		@RuneAttribute("role")
		@Override
		public RelatedParty.RelatedPartyBuilder setRole(PartyRoleEnum _role) {
