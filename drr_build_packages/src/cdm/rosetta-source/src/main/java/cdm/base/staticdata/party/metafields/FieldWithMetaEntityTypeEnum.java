...
@RuneDataType(value="FieldWithMetaEntityTypeEnum", model="cdm", builder=FieldWithMetaEntityTypeEnum.FieldWithMetaEntityTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaEntityTypeEnum extends RosettaModelObject, FieldWithMeta<EntityTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaEntityTypeEnumBuilder extends FieldWithMetaEntityTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<EntityTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaEntityTypeEnumBuilderImpl implements FieldWithMetaEntityTypeEnum.FieldWithMetaEntityTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaEntityTypeEnum.FieldWithMetaEntityTypeEnumBuilder setValue(EntityTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaEntityTypeEnum.FieldWithMetaEntityTypeEnumBuilder setMeta(MetaFields _meta) {
