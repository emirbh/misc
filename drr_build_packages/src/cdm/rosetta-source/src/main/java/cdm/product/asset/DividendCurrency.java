 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DividendCurrency", builder=DividendCurrency.DividendCurrencyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DividendCurrency", model="cdm", builder=DividendCurrency.DividendCurrencyBuilderImpl.class, version="6.23.0")
