 ...
 * @version 6.23.0
 */
@RosettaDataType(value="MandatoryEarlyTerminationAdjustedDates", builder=MandatoryEarlyTerminationAdjustedDates.MandatoryEarlyTerminationAdjustedDatesBuilderImpl.class, version="6.23.0")
@RuneDataType(value="MandatoryEarlyTerminationAdjustedDates", model="cdm", builder=MandatoryEarlyTerminationAdjustedDates.MandatoryEarlyTerminationAdjustedDatesBuilderImpl.class, version="6.23.0")
public interface MandatoryEarlyTerminationAdjustedDates extends RosettaModelObject {
	...
	class MandatoryEarlyTerminationAdjustedDatesBuilderImpl implements MandatoryEarlyTerminationAdjustedDates.MandatoryEarlyTerminationAdjustedDatesBuilder {
		...
		@RuneAttribute("adjustedEarlyTerminationDate")
		@Override
		public MandatoryEarlyTerminationAdjustedDates.MandatoryEarlyTerminationAdjustedDatesBuilder setAdjustedEarlyTerminationDate(Date _adjustedEarlyTerminationDate) {
		...
		@RuneAttribute("adjustedCashSettlementValuationDate")
		@Override
		public MandatoryEarlyTerminationAdjustedDates.MandatoryEarlyTerminationAdjustedDatesBuilder setAdjustedCashSettlementValuationDate(Date _adjustedCashSettlementValuationDate) {
		...
		@RuneAttribute("adjustedCashSettlementPaymentDate")
		@Override
		public MandatoryEarlyTerminationAdjustedDates.MandatoryEarlyTerminationAdjustedDatesBuilder setAdjustedCashSettlementPaymentDate(Date _adjustedCashSettlementPaymentDate) {
