 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SubstitutionProvisions", builder=SubstitutionProvisions.SubstitutionProvisionsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SubstitutionProvisions", model="cdm", builder=SubstitutionProvisions.SubstitutionProvisionsBuilderImpl.class, version="6.23.0")
