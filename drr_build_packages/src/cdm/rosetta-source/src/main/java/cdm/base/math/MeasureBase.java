 ...
 * @version 6.23.0
 */
@RosettaDataType(value="MeasureBase", builder=MeasureBase.MeasureBaseBuilderImpl.class, version="6.23.0")
@RuneDataType(value="MeasureBase", model="cdm", builder=MeasureBase.MeasureBaseBuilderImpl.class, version="6.23.0")
public interface MeasureBase extends RosettaModelObject {
	...
	class MeasureBaseBuilderImpl implements MeasureBase.MeasureBaseBuilder {
		...
		@RuneAttribute("value")
		@Override
		public MeasureBase.MeasureBaseBuilder setValue(BigDecimal _value) {
		...
		@RuneAttribute("unit")
		@Override
		public MeasureBase.MeasureBaseBuilder setUnit(UnitType _unit) {
