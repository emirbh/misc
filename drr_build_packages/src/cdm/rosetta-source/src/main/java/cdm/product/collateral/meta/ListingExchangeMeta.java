...
public class ListingExchangeMeta implements RosettaMetaData<ListingExchange> {
	...
	@Override
	public Validator<? super ListingExchange> validator(ValidatorFactory factory) {
		return factory.<ListingExchange>create(ListingExchangeValidator.class);
	}

	@Override
	public Validator<? super ListingExchange> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ListingExchange>create(ListingExchangeTypeFormatValidator.class);
	}
