 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Period", builder=Period.PeriodBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Period", model="cdm", builder=Period.PeriodBuilderImpl.class, version="6.23.0")
public interface Period extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface PeriodBuilder extends Period, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class PeriodBuilderImpl implements Period.PeriodBuilder {
		...
		@RuneMetaType
		@Override
		public Period.PeriodBuilder setMeta(MetaFields _meta) {
