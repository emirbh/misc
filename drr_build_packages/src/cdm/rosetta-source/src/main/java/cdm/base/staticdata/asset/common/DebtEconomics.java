 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DebtEconomics", builder=DebtEconomics.DebtEconomicsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DebtEconomics", model="cdm", builder=DebtEconomics.DebtEconomicsBuilderImpl.class, version="6.23.0")
