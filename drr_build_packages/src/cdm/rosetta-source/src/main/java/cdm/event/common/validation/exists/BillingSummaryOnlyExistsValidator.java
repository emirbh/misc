...
public class BillingSummaryOnlyExistsValidator implements ValidatorWithArg<BillingSummary, Set<String>> {
	...
	public <T2 extends BillingSummary> ValidationResult<BillingSummary> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("summaryTransfer", ExistenceChecker.isSet((Transfer) o.getSummaryTransfer()))
		...
		if (setFields.equals(fields)) {
			return success("BillingSummary", ValidationResult.ValidationType.ONLY_EXISTS, "BillingSummary", path, "");
		}
		return failure("BillingSummary", ValidationResult.ValidationType.ONLY_EXISTS, "BillingSummary", path, "",
