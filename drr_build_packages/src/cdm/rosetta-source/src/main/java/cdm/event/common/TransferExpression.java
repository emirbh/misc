 ...
 * @version 6.23.0
 */
@RosettaDataType(value="TransferExpression", builder=TransferExpression.TransferExpressionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="TransferExpression", model="cdm", builder=TransferExpression.TransferExpressionBuilderImpl.class, version="6.23.0")
public interface TransferExpression extends RosettaModelObject {
	...
	class TransferExpressionImpl implements TransferExpression {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("scheduledTransfer")
	...
	class TransferExpressionBuilderImpl implements TransferExpression.TransferExpressionBuilder {
		...
		@RuneAttribute("priceTransfer")
		@Override
		public TransferExpression.TransferExpressionBuilder setPriceTransfer(FeeTypeEnum _priceTransfer) {
			this.priceTransfer = _priceTransfer == null ? null : _priceTransfer;
			return this;
		}
		...
		@RuneAttribute("scheduledTransfer")
		@Override
		public TransferExpression.TransferExpressionBuilder setScheduledTransfer(ScheduledTransfer _scheduledTransfer) {
			this.scheduledTransfer = _scheduledTransfer == null ? null : _scheduledTransfer.toBuilder();
			return this;
		}
