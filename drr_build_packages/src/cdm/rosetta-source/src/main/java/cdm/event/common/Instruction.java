 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Instruction", builder=Instruction.InstructionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Instruction", model="cdm", builder=Instruction.InstructionBuilderImpl.class, version="6.23.0")
public interface Instruction extends RosettaModelObject {
	...
	interface InstructionBuilder extends Instruction, RosettaModelObjectBuilder {
		...
		Instruction.InstructionBuilder setBefore(ReferenceWithMetaTradeState before);
		Instruction.InstructionBuilder setBeforeValue(TradeState before);
	...
	class InstructionImpl implements Instruction {
		...
		@RuneAttribute("primitiveInstruction")
	...
	class InstructionBuilderImpl implements Instruction.InstructionBuilder {
		...
		@RuneAttribute("primitiveInstruction")
		@Override
		public Instruction.InstructionBuilder setPrimitiveInstruction(PrimitiveInstruction _primitiveInstruction) {
			this.primitiveInstruction = _primitiveInstruction == null ? null : _primitiveInstruction.toBuilder();
			return this;
		}
		...
		@RuneAttribute("before")
		@Override
		public Instruction.InstructionBuilder setBefore(ReferenceWithMetaTradeState _before) {
			this.before = _before == null ? null : _before.toBuilder();
			return this;
		}
		
		@Override
		public Instruction.InstructionBuilder setBeforeValue(TradeState _before) {
			this.getOrCreateBefore().setValue(_before);
			return this;
		}
