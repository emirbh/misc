		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EquitySwapMasterConfirmation2018", ValidationResult.ValidationType.CARDINALITY, "EquitySwapMasterConfirmation2018", path, "", res.getError());
				}
				return success("EquitySwapMasterConfirmation2018", ValidationResult.ValidationType.CARDINALITY, "EquitySwapMasterConfirmation2018", path, "");
			})
			.collect(toList());
	}
