 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ExtendibleProvision", builder=ExtendibleProvision.ExtendibleProvisionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ExtendibleProvision", model="cdm", builder=ExtendibleProvision.ExtendibleProvisionBuilderImpl.class, version="6.23.0")
