...
import cdm.event.position.validation.datarule.PortfolioStateInitialisation;
import cdm.event.position.validation.datarule.PortfolioStateNonTransferable;
...
public class PortfolioStateMeta implements RosettaMetaData<PortfolioState> {
	...
	public List<Validator<? super PortfolioState>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<PortfolioState>create(PortfolioStateInitialisation.class),
			factory.<PortfolioState>create(PortfolioStateNonTransferable.class)
		);
	}
	...
	@Override
	public Validator<? super PortfolioState> validator(ValidatorFactory factory) {
		return factory.<PortfolioState>create(PortfolioStateValidator.class);
	}

	@Override
	public Validator<? super PortfolioState> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PortfolioState>create(PortfolioStateTypeFormatValidator.class);
	}
