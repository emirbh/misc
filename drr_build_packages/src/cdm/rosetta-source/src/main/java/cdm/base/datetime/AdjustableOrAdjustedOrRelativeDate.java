 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AdjustableOrAdjustedOrRelativeDate", builder=AdjustableOrAdjustedOrRelativeDate.AdjustableOrAdjustedOrRelativeDateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AdjustableOrAdjustedOrRelativeDate", model="cdm", builder=AdjustableOrAdjustedOrRelativeDate.AdjustableOrAdjustedOrRelativeDateBuilderImpl.class, version="6.23.0")
