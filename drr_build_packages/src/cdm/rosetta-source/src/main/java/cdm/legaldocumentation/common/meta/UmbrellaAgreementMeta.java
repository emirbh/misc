...
import cdm.legaldocumentation.common.validation.datarule.UmbrellaAgreementUmbrellaAgreementExists;
...
public class UmbrellaAgreementMeta implements RosettaMetaData<UmbrellaAgreement> {
	...
	public List<Validator<? super UmbrellaAgreement>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<UmbrellaAgreement>create(UmbrellaAgreementUmbrellaAgreementExists.class)
		);
	}
	...
	@Override
	public Validator<? super UmbrellaAgreement> validator(ValidatorFactory factory) {
		return factory.<UmbrellaAgreement>create(UmbrellaAgreementValidator.class);
	}

	@Override
	public Validator<? super UmbrellaAgreement> typeFormatValidator(ValidatorFactory factory) {
		return factory.<UmbrellaAgreement>create(UmbrellaAgreementTypeFormatValidator.class);
	}
