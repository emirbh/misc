...
public class VolatilityReturnTermsOnlyExistsValidator implements ValidatorWithArg<VolatilityReturnTerms, Set<String>> {
	...
	public <T2 extends VolatilityReturnTerms> ValidationResult<VolatilityReturnTerms> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("exchangeTradedContractNearest", ExistenceChecker.isSet((ListedDerivative) o.getExchangeTradedContractNearest()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("VolatilityReturnTerms", ValidationResult.ValidationType.ONLY_EXISTS, "VolatilityReturnTerms", path, "");
		}
		return failure("VolatilityReturnTerms", ValidationResult.ValidationType.ONLY_EXISTS, "VolatilityReturnTerms", path, "",
