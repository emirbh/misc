 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Indx", builder=Indx.IndxBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Indx", model="cdm", builder=Indx.IndxBuilderImpl.class, version="6.23.0")
public interface Indx extends RosettaModelObject {
	...
	class IndxBuilderImpl implements Indx.IndxBuilder {
		...
		@RuneAttribute("nm")
		@Override
		public Indx.IndxBuilder setNm(Nm _nm) {
			this.nm = _nm == null ? null : _nm.toBuilder();
			return this;
		}
