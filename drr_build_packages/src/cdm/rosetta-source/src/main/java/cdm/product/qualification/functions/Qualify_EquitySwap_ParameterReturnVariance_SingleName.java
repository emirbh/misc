...
@ImplementedBy(Qualify_EquitySwap_ParameterReturnVariance_SingleName.Qualify_EquitySwap_ParameterReturnVariance_SingleNameDefault.class)
public abstract class Qualify_EquitySwap_ParameterReturnVariance_SingleName implements RosettaFunction,IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static class Qualify_EquitySwap_ParameterReturnVariance_SingleNameDefault extends Qualify_EquitySwap_ParameterReturnVariance_SingleName {
		@Override
