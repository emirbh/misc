 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ValuationDates", builder=ValuationDates.ValuationDatesBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ValuationDates", model="cdm", builder=ValuationDates.ValuationDatesBuilderImpl.class, version="6.23.0")
