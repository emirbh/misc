...
public class BusinessCentersOnlyExistsValidator implements ValidatorWithArg<BusinessCenters, Set<String>> {
	...
	public <T2 extends BusinessCenters> ValidationResult<BusinessCenters> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("businessCenter", ExistenceChecker.isSet((List<? extends FieldWithMetaBusinessCenterEnum>) o.getBusinessCenter()))
				.put("commodityBusinessCalendar", ExistenceChecker.isSet((List<? extends FieldWithMetaCommodityBusinessCalendarEnum>) o.getCommodityBusinessCalendar()))
		...
		if (setFields.equals(fields)) {
			return success("BusinessCenters", ValidationResult.ValidationType.ONLY_EXISTS, "BusinessCenters", path, "");
		}
		return failure("BusinessCenters", ValidationResult.ValidationType.ONLY_EXISTS, "BusinessCenters", path, "",
