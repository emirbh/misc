...
@RuneDataType(value="FieldWithMetaInformationProviderEnum", model="cdm", builder=FieldWithMetaInformationProviderEnum.FieldWithMetaInformationProviderEnumBuilderImpl.class, version="0.0.0")
