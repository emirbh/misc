...
public class PartyContactInformationMeta implements RosettaMetaData<PartyContactInformation> {
	...
	@Override
	public Validator<? super PartyContactInformation> validator(ValidatorFactory factory) {
		return factory.<PartyContactInformation>create(PartyContactInformationValidator.class);
	}

	@Override
	public Validator<? super PartyContactInformation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PartyContactInformation>create(PartyContactInformationTypeFormatValidator.class);
	}
