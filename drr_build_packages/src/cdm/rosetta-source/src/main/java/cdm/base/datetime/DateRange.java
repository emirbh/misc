 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DateRange", builder=DateRange.DateRangeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DateRange", model="cdm", builder=DateRange.DateRangeBuilderImpl.class, version="6.23.0")
public interface DateRange extends RosettaModelObject {
	...
	class DateRangeBuilderImpl implements DateRange.DateRangeBuilder {
		...
		@RuneAttribute("startDate")
		@Override
		public DateRange.DateRangeBuilder setStartDate(Date _startDate) {
		...
		@RuneAttribute("endDate")
		@Override
		public DateRange.DateRangeBuilder setEndDate(Date _endDate) {
