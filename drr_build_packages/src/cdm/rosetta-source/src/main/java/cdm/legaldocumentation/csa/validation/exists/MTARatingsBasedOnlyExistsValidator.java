...
import cdm.legaldocumentation.csa.MTAZeroEventEnum;
...
public class MTARatingsBasedOnlyExistsValidator implements ValidatorWithArg<MTARatingsBased, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends MTARatingsBased> ValidationResult<MTARatingsBased> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("variableSet", ExistenceChecker.isSet((List<? extends CSAMTAVariableSet>) o.getVariableSet()))
				.put("ratedParty", ExistenceChecker.isSet((MTARatedPartyEnum) o.getRatedParty()))
				...
				.put("event", ExistenceChecker.isSet((List<MTAZeroEventEnum>) o.getEvent()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("MTARatingsBased", ValidationResult.ValidationType.ONLY_EXISTS, "MTARatingsBased", path, "");
		}
		return failure("MTARatingsBased", ValidationResult.ValidationType.ONLY_EXISTS, "MTARatingsBased", path, "",
