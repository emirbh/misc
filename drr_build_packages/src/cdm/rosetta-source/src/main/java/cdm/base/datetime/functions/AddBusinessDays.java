	...
	*/
	...
	public static class AddBusinessDaysDefault extends AddBusinessDays {
		...
		protected MapperS<Boolean> done(Date originalDate, Integer offsetBusinessDays, List<BusinessCenterEnum> businessCenters) {
			return areEqual(MapperS.of(offsetBusinessDays), MapperS.of(0), CardinalityOperator.All).andNullSafe(areEqual(isGoodBusinessDay(originalDate, offsetBusinessDays, businessCenters), MapperS.of(true), CardinalityOperator.All)).asMapper();
		}
