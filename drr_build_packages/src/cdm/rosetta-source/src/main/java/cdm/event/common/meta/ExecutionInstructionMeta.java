...
public class ExecutionInstructionMeta implements RosettaMetaData<ExecutionInstruction> {
	...
	@Override
	public Validator<? super ExecutionInstruction> validator(ValidatorFactory factory) {
		return factory.<ExecutionInstruction>create(ExecutionInstructionValidator.class);
	}

	@Override
	public Validator<? super ExecutionInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ExecutionInstruction>create(ExecutionInstructionTypeFormatValidator.class);
	}
