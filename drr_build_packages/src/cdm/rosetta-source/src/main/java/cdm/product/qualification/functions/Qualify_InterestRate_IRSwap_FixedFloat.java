	...
	*/
	...
	public static class Qualify_InterestRate_IRSwap_FixedFloatDefault extends Qualify_InterestRate_IRSwap_FixedFloat {
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = areEqual(MapperS.of(qualify_BaseProduct_IRSwap.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All).andNullSafe(areEqual(MapperS.of(qualify_SubProduct_FixedFloat.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All)).andNullSafe(areEqual(MapperS.of(qualify_Transaction_ZeroCoupon.evaluate(economicTerms)), MapperS.of(false), CardinalityOperator.All)).andNullSafe(areEqual(MapperS.of(qualify_Transaction_OIS.evaluate(economicTerms)), MapperS.of(false), CardinalityOperator.All)).get();
