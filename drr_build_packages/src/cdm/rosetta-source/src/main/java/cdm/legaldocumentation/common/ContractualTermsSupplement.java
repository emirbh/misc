 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ContractualTermsSupplement", builder=ContractualTermsSupplement.ContractualTermsSupplementBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ContractualTermsSupplement", model="cdm", builder=ContractualTermsSupplement.ContractualTermsSupplementBuilderImpl.class, version="6.23.0")
public interface ContractualTermsSupplement extends RosettaModelObject {
	...
	interface ContractualTermsSupplementBuilder extends ContractualTermsSupplement, RosettaModelObjectBuilder {
		...
		ContractualTermsSupplement.ContractualTermsSupplementBuilder setContractualTermsSupplementType(FieldWithMetaContractualSupplementTypeEnum contractualTermsSupplementType);
		ContractualTermsSupplement.ContractualTermsSupplementBuilder setContractualTermsSupplementTypeValue(ContractualSupplementTypeEnum contractualTermsSupplementType);
	...
	class ContractualTermsSupplementImpl implements ContractualTermsSupplement {
		...
		@Required
		@RuneAttribute("contractualTermsSupplementType")
		...
		public int hashCode() {
			int _result = 0;
			_result = 31 * _result + (contractualTermsSupplementType != null ? contractualTermsSupplementType.hashCode() : 0);
	...
	class ContractualTermsSupplementBuilderImpl implements ContractualTermsSupplement.ContractualTermsSupplementBuilder {
		...
		@RuneAttribute("contractualTermsSupplementType")
		@Override
		public ContractualTermsSupplement.ContractualTermsSupplementBuilder setContractualTermsSupplementType(FieldWithMetaContractualSupplementTypeEnum _contractualTermsSupplementType) {
			this.contractualTermsSupplementType = _contractualTermsSupplementType == null ? null : _contractualTermsSupplementType.toBuilder();
			return this;
		}
		
		@Override
		public ContractualTermsSupplement.ContractualTermsSupplementBuilder setContractualTermsSupplementTypeValue(ContractualSupplementTypeEnum _contractualTermsSupplementType) {
			this.getOrCreateContractualTermsSupplementType().setValue(_contractualTermsSupplementType);
			return this;
		}
		...
		@RuneAttribute("publicationDate")
		@Override
		public ContractualTermsSupplement.ContractualTermsSupplementBuilder setPublicationDate(Date _publicationDate) {
