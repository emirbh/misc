 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CommodityProductDefinition", builder=CommodityProductDefinition.CommodityProductDefinitionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CommodityProductDefinition", model="cdm", builder=CommodityProductDefinition.CommodityProductDefinitionBuilderImpl.class, version="6.23.0")
