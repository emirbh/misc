 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ManualExercise", builder=ManualExercise.ManualExerciseBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ManualExercise", model="cdm", builder=ManualExercise.ManualExerciseBuilderImpl.class, version="6.23.0")
