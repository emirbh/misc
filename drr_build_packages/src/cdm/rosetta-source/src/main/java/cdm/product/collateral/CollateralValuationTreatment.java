 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CollateralValuationTreatment", builder=CollateralValuationTreatment.CollateralValuationTreatmentBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CollateralValuationTreatment", model="cdm", builder=CollateralValuationTreatment.CollateralValuationTreatmentBuilderImpl.class, version="6.23.0")
public interface CollateralValuationTreatment extends RosettaModelObject {
	...
	class CollateralValuationTreatmentImpl implements CollateralValuationTreatment {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("marginPercentage")
	...
	class CollateralValuationTreatmentBuilderImpl implements CollateralValuationTreatment.CollateralValuationTreatmentBuilder {
		...
		@RuneAttribute("haircutPercentage")
		@Override
		public CollateralValuationTreatment.CollateralValuationTreatmentBuilder setHaircutPercentage(BigDecimal _haircutPercentage) {
		...
		@RuneAttribute("marginPercentage")
		@Override
		public CollateralValuationTreatment.CollateralValuationTreatmentBuilder setMarginPercentage(BigDecimal _marginPercentage) {
			this.marginPercentage = _marginPercentage == null ? null : _marginPercentage;
			return this;
		}
		...
		@RuneAttribute("fxHaircutPercentage")
		@Override
		public CollateralValuationTreatment.CollateralValuationTreatmentBuilder setFxHaircutPercentage(BigDecimal _fxHaircutPercentage) {
		...
		@RuneAttribute("additionalHaircutPercentage")
		@Override
		public CollateralValuationTreatment.CollateralValuationTreatmentBuilder setAdditionalHaircutPercentage(BigDecimal _additionalHaircutPercentage) {
