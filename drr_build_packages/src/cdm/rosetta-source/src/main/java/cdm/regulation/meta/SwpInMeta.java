...
public class SwpInMeta implements RosettaMetaData<SwpIn> {
	...
	@Override
	public Validator<? super SwpIn> validator(ValidatorFactory factory) {
		return factory.<SwpIn>create(SwpInValidator.class);
	}

	@Override
	public Validator<? super SwpIn> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SwpIn>create(SwpInTypeFormatValidator.class);
	}
