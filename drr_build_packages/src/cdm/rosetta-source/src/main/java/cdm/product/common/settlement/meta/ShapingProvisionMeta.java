...
public class ShapingProvisionMeta implements RosettaMetaData<ShapingProvision> {
	...
	@Override
	public Validator<? super ShapingProvision> validator(ValidatorFactory factory) {
		return factory.<ShapingProvision>create(ShapingProvisionValidator.class);
	}

	@Override
	public Validator<? super ShapingProvision> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ShapingProvision>create(ShapingProvisionTypeFormatValidator.class);
	}
