...
public class NmMeta implements RosettaMetaData<Nm> {
	...
	@Override
	public Validator<? super Nm> validator(ValidatorFactory factory) {
		return factory.<Nm>create(NmValidator.class);
	}

	@Override
	public Validator<? super Nm> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Nm>create(NmTypeFormatValidator.class);
	}
