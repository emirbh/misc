...
public class ContactElectionMeta implements RosettaMetaData<ContactElection> {
	...
	@Override
	public Validator<? super ContactElection> validator(ValidatorFactory factory) {
		return factory.<ContactElection>create(ContactElectionValidator.class);
	}

	@Override
	public Validator<? super ContactElection> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ContactElection>create(ContactElectionTypeFormatValidator.class);
	}
