...
public class MasterAgreementScheduleMeta implements RosettaMetaData<MasterAgreementSchedule> {
	...
	@Override
	public Validator<? super MasterAgreementSchedule> validator(ValidatorFactory factory) {
		return factory.<MasterAgreementSchedule>create(MasterAgreementScheduleValidator.class);
	}

	@Override
	public Validator<? super MasterAgreementSchedule> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MasterAgreementSchedule>create(MasterAgreementScheduleTypeFormatValidator.class);
	}
