 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FxSettlementRateSource", builder=FxSettlementRateSource.FxSettlementRateSourceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FxSettlementRateSource", model="cdm", builder=FxSettlementRateSource.FxSettlementRateSourceBuilderImpl.class, version="6.23.0")
public interface FxSettlementRateSource extends RosettaModelObject {
	...
	class FxSettlementRateSourceBuilderImpl implements FxSettlementRateSource.FxSettlementRateSourceBuilder {
		...
		@RuneAttribute("settlementRateOption")
		@Override
		public FxSettlementRateSource.FxSettlementRateSourceBuilder setSettlementRateOption(FieldWithMetaString _settlementRateOption) {
			this.settlementRateOption = _settlementRateOption == null ? null : _settlementRateOption.toBuilder();
			return this;
		}
		
		@Override
		public FxSettlementRateSource.FxSettlementRateSourceBuilder setSettlementRateOptionValue(String _settlementRateOption) {
