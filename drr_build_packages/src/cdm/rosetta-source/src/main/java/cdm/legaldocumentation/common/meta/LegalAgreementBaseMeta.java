...
public class LegalAgreementBaseMeta implements RosettaMetaData<LegalAgreementBase> {
	...
	@Override
	public Validator<? super LegalAgreementBase> validator(ValidatorFactory factory) {
		return factory.<LegalAgreementBase>create(LegalAgreementBaseValidator.class);
	}

	@Override
	public Validator<? super LegalAgreementBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<LegalAgreementBase>create(LegalAgreementBaseTypeFormatValidator.class);
	}
