 ...
 * @version 6.23.0
 */
@RosettaDataType(value="New", builder=New.NewBuilderImpl.class, version="6.23.0")
@RuneDataType(value="New", model="cdm", builder=New.NewBuilderImpl.class, version="6.23.0")
public interface New extends RosettaModelObject {
	...
	class NewBuilderImpl implements New.NewBuilder {
		...
		@RuneAttribute("txId")
		@Override
		public New.NewBuilder setTxId(String _txId) {
			this.txId = _txId == null ? null : _txId;
			return this;
		}
		...
		@RuneAttribute("exctgPty")
		@Override
		public New.NewBuilder setExctgPty(String _exctgPty) {
			this.exctgPty = _exctgPty == null ? null : _exctgPty;
			return this;
		}
		...
		@RuneAttribute("invstmtPtyInd")
		@Override
		public New.NewBuilder setInvstmtPtyInd(String _invstmtPtyInd) {
			this.invstmtPtyInd = _invstmtPtyInd == null ? null : _invstmtPtyInd;
			return this;
		}
		...
		@RuneAttribute("submitgPty")
		@Override
		public New.NewBuilder setSubmitgPty(String _submitgPty) {
			this.submitgPty = _submitgPty == null ? null : _submitgPty;
			return this;
		}
		...
		@RuneAttribute("buyr")
		@Override
		public New.NewBuilder setBuyr(Buyr _buyr) {
			this.buyr = _buyr == null ? null : _buyr.toBuilder();
			return this;
		}
		...
		@RuneAttribute("sellr")
		@Override
		public New.NewBuilder setSellr(Sellr _sellr) {
			this.sellr = _sellr == null ? null : _sellr.toBuilder();
			return this;
		}
		...
		@RuneAttribute("ordrTrnsmssn")
		@Override
		public New.NewBuilder setOrdrTrnsmssn(OrdrTrnsmssn _ordrTrnsmssn) {
			this.ordrTrnsmssn = _ordrTrnsmssn == null ? null : _ordrTrnsmssn.toBuilder();
			return this;
		}
		...
		@RuneAttribute("tx")
		@Override
		public New.NewBuilder setTx(Tx _tx) {
			this.tx = _tx == null ? null : _tx.toBuilder();
			return this;
		}
		...
		@RuneAttribute("finInstrm")
		@Override
		public New.NewBuilder setFinInstrm(FinInstrm _finInstrm) {
			this.finInstrm = _finInstrm == null ? null : _finInstrm.toBuilder();
			return this;
		}
		...
		@RuneAttribute("invstmtDcsnPrsn")
		@Override
		public New.NewBuilder setInvstmtDcsnPrsn(InvstmtDcsnPrsn _invstmtDcsnPrsn) {
			this.invstmtDcsnPrsn = _invstmtDcsnPrsn == null ? null : _invstmtDcsnPrsn.toBuilder();
			return this;
		}
		...
		@RuneAttribute("exctgPrsn")
		@Override
		public New.NewBuilder setExctgPrsn(ExctgPrsn _exctgPrsn) {
			this.exctgPrsn = _exctgPrsn == null ? null : _exctgPrsn.toBuilder();
			return this;
		}
		...
		@RuneAttribute("addtlAttrbts")
		@Override
		public New.NewBuilder setAddtlAttrbts(AddtlAttrbts _addtlAttrbts) {
			this.addtlAttrbts = _addtlAttrbts == null ? null : _addtlAttrbts.toBuilder();
			return this;
		}
