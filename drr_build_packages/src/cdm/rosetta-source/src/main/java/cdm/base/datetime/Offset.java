 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Offset", builder=Offset.OffsetBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Offset", model="cdm", builder=Offset.OffsetBuilderImpl.class, version="6.23.0")
public interface Offset extends Period {
	...
	class OffsetBuilderImpl extends Period.PeriodBuilderImpl implements Offset.OffsetBuilder {
		...
		@RuneMetaType
		@Override
		public Offset.OffsetBuilder setMeta(MetaFields _meta) {
