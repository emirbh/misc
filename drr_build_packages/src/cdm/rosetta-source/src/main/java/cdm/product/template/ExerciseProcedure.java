 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ExerciseProcedure", builder=ExerciseProcedure.ExerciseProcedureBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ExerciseProcedure", model="cdm", builder=ExerciseProcedure.ExerciseProcedureBuilderImpl.class, version="6.23.0")
