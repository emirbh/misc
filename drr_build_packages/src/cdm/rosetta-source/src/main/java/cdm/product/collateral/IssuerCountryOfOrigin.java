 ...
 * @version 6.23.0
 */
@RosettaDataType(value="IssuerCountryOfOrigin", builder=IssuerCountryOfOrigin.IssuerCountryOfOriginBuilderImpl.class, version="6.23.0")
@RuneDataType(value="IssuerCountryOfOrigin", model="cdm", builder=IssuerCountryOfOrigin.IssuerCountryOfOriginBuilderImpl.class, version="6.23.0")
