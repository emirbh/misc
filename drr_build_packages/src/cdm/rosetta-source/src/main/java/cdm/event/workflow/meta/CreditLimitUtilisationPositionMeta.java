...
public class CreditLimitUtilisationPositionMeta implements RosettaMetaData<CreditLimitUtilisationPosition> {
	...
	@Override
	public Validator<? super CreditLimitUtilisationPosition> validator(ValidatorFactory factory) {
		return factory.<CreditLimitUtilisationPosition>create(CreditLimitUtilisationPositionValidator.class);
	}

	@Override
	public Validator<? super CreditLimitUtilisationPosition> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CreditLimitUtilisationPosition>create(CreditLimitUtilisationPositionTypeFormatValidator.class);
	}
