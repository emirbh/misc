...
public class WorkflowStateMeta implements RosettaMetaData<WorkflowState> {
	...
	@Override
	public Validator<? super WorkflowState> validator(ValidatorFactory factory) {
		return factory.<WorkflowState>create(WorkflowStateValidator.class);
	}

	@Override
	public Validator<? super WorkflowState> typeFormatValidator(ValidatorFactory factory) {
		return factory.<WorkflowState>create(WorkflowStateTypeFormatValidator.class);
	}
