 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FloatingRate", builder=FloatingRate.FloatingRateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FloatingRate", model="cdm", builder=FloatingRate.FloatingRateBuilderImpl.class, version="6.23.0")
