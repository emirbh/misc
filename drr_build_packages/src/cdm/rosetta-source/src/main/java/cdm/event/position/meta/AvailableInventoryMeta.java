...
public class AvailableInventoryMeta implements RosettaMetaData<AvailableInventory> {
	...
	@Override
	public Validator<? super AvailableInventory> validator(ValidatorFactory factory) {
		return factory.<AvailableInventory>create(AvailableInventoryValidator.class);
	}

	@Override
	public Validator<? super AvailableInventory> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AvailableInventory>create(AvailableInventoryTypeFormatValidator.class);
	}
