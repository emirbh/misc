...
public abstract class CheckEligibilityForProduct implements RosettaFunction {
	...
	*/
	public CheckEligibilityResult evaluate(List<? extends EligibleCollateralSpecification> specifications, TransferableProduct product) {
	...
	protected abstract CheckEligibilityResult.CheckEligibilityResultBuilder doEvaluate(List<? extends EligibleCollateralSpecification> specifications, TransferableProduct product);

	public static class CheckEligibilityForProductDefault extends CheckEligibilityForProduct {
		@Override
		protected CheckEligibilityResult.CheckEligibilityResultBuilder doEvaluate(List<? extends EligibleCollateralSpecification> specifications, TransferableProduct product) {
		...
		protected CheckEligibilityResult.CheckEligibilityResultBuilder assignOutput(CheckEligibilityResult.CheckEligibilityResultBuilder eligibilityResult, List<? extends EligibleCollateralSpecification> specifications, TransferableProduct product) {
