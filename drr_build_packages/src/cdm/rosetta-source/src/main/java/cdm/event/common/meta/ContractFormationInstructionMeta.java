...
import cdm.event.common.validation.datarule.ContractFormationInstructionExecutedAgreements;
...
public class ContractFormationInstructionMeta implements RosettaMetaData<ContractFormationInstruction> {
	...
	public List<Validator<? super ContractFormationInstruction>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<ContractFormationInstruction>create(ContractFormationInstructionExecutedAgreements.class)
		);
	}
	...
	@Override
	public Validator<? super ContractFormationInstruction> validator(ValidatorFactory factory) {
		return factory.<ContractFormationInstruction>create(ContractFormationInstructionValidator.class);
	}

	@Override
	public Validator<? super ContractFormationInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ContractFormationInstruction>create(ContractFormationInstructionTypeFormatValidator.class);
	}
