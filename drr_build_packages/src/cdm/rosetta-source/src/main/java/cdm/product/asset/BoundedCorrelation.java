 ...
 * @version 6.23.0
 */
@RosettaDataType(value="BoundedCorrelation", builder=BoundedCorrelation.BoundedCorrelationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="BoundedCorrelation", model="cdm", builder=BoundedCorrelation.BoundedCorrelationBuilderImpl.class, version="6.23.0")
