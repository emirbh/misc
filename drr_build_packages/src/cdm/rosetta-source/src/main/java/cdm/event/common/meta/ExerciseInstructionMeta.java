...
import cdm.event.common.validation.datarule.ExerciseInstructionIsOptionPayout;
...
public class ExerciseInstructionMeta implements RosettaMetaData<ExerciseInstruction> {
	...
	public List<Validator<? super ExerciseInstruction>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<ExerciseInstruction>create(ExerciseInstructionIsOptionPayout.class)
		);
	}
	...
	@Override
	public Validator<? super ExerciseInstruction> validator(ValidatorFactory factory) {
		return factory.<ExerciseInstruction>create(ExerciseInstructionValidator.class);
	}

	@Override
	public Validator<? super ExerciseInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ExerciseInstruction>create(ExerciseInstructionTypeFormatValidator.class);
	}
