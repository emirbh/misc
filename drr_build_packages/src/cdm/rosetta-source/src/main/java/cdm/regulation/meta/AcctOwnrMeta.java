...
public class AcctOwnrMeta implements RosettaMetaData<AcctOwnr> {
	...
	@Override
	public Validator<? super AcctOwnr> validator(ValidatorFactory factory) {
		return factory.<AcctOwnr>create(AcctOwnrValidator.class);
	}

	@Override
	public Validator<? super AcctOwnr> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AcctOwnr>create(AcctOwnrTypeFormatValidator.class);
	}
