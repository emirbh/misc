 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Tranche", builder=Tranche.TrancheBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Tranche", model="cdm", builder=Tranche.TrancheBuilderImpl.class, version="6.23.0")
