 ...
 * @version 6.23.0
 */
@RosettaDataType(value="NumberBound", builder=NumberBound.NumberBoundBuilderImpl.class, version="6.23.0")
@RuneDataType(value="NumberBound", model="cdm", builder=NumberBound.NumberBoundBuilderImpl.class, version="6.23.0")
public interface NumberBound extends RosettaModelObject {
	...
	class NumberBoundBuilderImpl implements NumberBound.NumberBoundBuilder {
		...
		@RuneAttribute("number")
		@Override
		public NumberBound.NumberBoundBuilder setNumber(BigDecimal _number) {
		...
		@RuneAttribute("inclusive")
		@Override
		public NumberBound.NumberBoundBuilder setInclusive(Boolean _inclusive) {
