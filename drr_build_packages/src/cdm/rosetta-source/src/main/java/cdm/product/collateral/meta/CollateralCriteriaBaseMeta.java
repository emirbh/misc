...
public class CollateralCriteriaBaseMeta implements RosettaMetaData<CollateralCriteriaBase> {
	...
	@Override
	public Validator<? super CollateralCriteriaBase> validator(ValidatorFactory factory) {
		return factory.<CollateralCriteriaBase>create(CollateralCriteriaBaseValidator.class);
	}

	@Override
	public Validator<? super CollateralCriteriaBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralCriteriaBase>create(CollateralCriteriaBaseTypeFormatValidator.class);
	}
