...
public class MeasureBaseMeta implements RosettaMetaData<MeasureBase> {
	...
	@Override
	public Validator<? super MeasureBase> validator(ValidatorFactory factory) {
		return factory.<MeasureBase>create(MeasureBaseValidator.class);
	}

	@Override
	public Validator<? super MeasureBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MeasureBase>create(MeasureBaseTypeFormatValidator.class);
	}
