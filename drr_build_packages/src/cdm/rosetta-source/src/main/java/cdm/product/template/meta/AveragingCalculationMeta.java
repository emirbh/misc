...
public class AveragingCalculationMeta implements RosettaMetaData<AveragingCalculation> {
	...
	@Override
	public Validator<? super AveragingCalculation> validator(ValidatorFactory factory) {
		return factory.<AveragingCalculation>create(AveragingCalculationValidator.class);
	}

	@Override
	public Validator<? super AveragingCalculation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AveragingCalculation>create(AveragingCalculationTypeFormatValidator.class);
	}
