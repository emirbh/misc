...
public class PortfolioReturnTermsMeta implements RosettaMetaData<PortfolioReturnTerms> {
	...
	@Override
	public Validator<? super PortfolioReturnTerms> validator(ValidatorFactory factory) {
		return factory.<PortfolioReturnTerms>create(PortfolioReturnTermsValidator.class);
	}

	@Override
	public Validator<? super PortfolioReturnTerms> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PortfolioReturnTerms>create(PortfolioReturnTermsTypeFormatValidator.class);
	}
