...
@ImplementedBy(CreateObservableKeyForQuotedCurrencyPair.CreateObservableKeyForQuotedCurrencyPairDefault.class)
public abstract class CreateObservableKeyForQuotedCurrencyPair implements RosettaFunction {
	...
	*/
	...
	public static class CreateObservableKeyForQuotedCurrencyPairDefault extends CreateObservableKeyForQuotedCurrencyPair {
		@Override
		...
		protected String assignOutput(String keyValueWithIndex, QuotedCurrencyPair fpmlQuotedCurrencyPair) {
			keyValueWithIndex = createKeyForQuotedCurrencyPair.evaluate("observable", fpmlQuotedCurrencyPair);
