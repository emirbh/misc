...
import cdm.product.collateral.validation.datarule.CollateralCriteriaChoice;
...
public class CollateralCriteriaMeta implements RosettaMetaData<CollateralCriteria> {
	...
	public List<Validator<? super CollateralCriteria>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<CollateralCriteria>create(CollateralCriteriaChoice.class)
		);
	}
	...
	@Override
	public Validator<? super CollateralCriteria> validator(ValidatorFactory factory) {
		return factory.<CollateralCriteria>create(CollateralCriteriaValidator.class);
	}

	@Override
	public Validator<? super CollateralCriteria> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralCriteria>create(CollateralCriteriaTypeFormatValidator.class);
	}
