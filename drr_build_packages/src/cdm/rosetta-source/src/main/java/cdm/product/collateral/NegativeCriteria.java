 ...
 * @version 6.23.0
 */
@RosettaDataType(value="NegativeCriteria", builder=NegativeCriteria.NegativeCriteriaBuilderImpl.class, version="6.23.0")
@RuneDataType(value="NegativeCriteria", model="cdm", builder=NegativeCriteria.NegativeCriteriaBuilderImpl.class, version="6.23.0")
