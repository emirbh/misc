...
import cdm.product.asset.validation.datarule.EquityUnderlierProvisionsComponentSecurityOrMultipleExchange;
...
public class EquityUnderlierProvisionsMeta implements RosettaMetaData<EquityUnderlierProvisions> {
	...
	public List<Validator<? super EquityUnderlierProvisions>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<EquityUnderlierProvisions>create(EquityUnderlierProvisionsComponentSecurityOrMultipleExchange.class)
		);
	}
	...
	@Override
	public Validator<? super EquityUnderlierProvisions> validator(ValidatorFactory factory) {
		return factory.<EquityUnderlierProvisions>create(EquityUnderlierProvisionsValidator.class);
	}

	@Override
	public Validator<? super EquityUnderlierProvisions> typeFormatValidator(ValidatorFactory factory) {
		return factory.<EquityUnderlierProvisions>create(EquityUnderlierProvisionsTypeFormatValidator.class);
	}
