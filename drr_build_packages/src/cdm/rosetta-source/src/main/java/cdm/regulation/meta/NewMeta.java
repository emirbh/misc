...
public class NewMeta implements RosettaMetaData<New> {
	...
	@Override
	public Validator<? super New> validator(ValidatorFactory factory) {
		return factory.<New>create(NewValidator.class);
	}

	@Override
	public Validator<? super New> typeFormatValidator(ValidatorFactory factory) {
		return factory.<New>create(NewTypeFormatValidator.class);
	}
