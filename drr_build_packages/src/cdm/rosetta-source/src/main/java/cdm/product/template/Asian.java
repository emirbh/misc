 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Asian", builder=Asian.AsianBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Asian", model="cdm", builder=Asian.AsianBuilderImpl.class, version="6.23.0")
