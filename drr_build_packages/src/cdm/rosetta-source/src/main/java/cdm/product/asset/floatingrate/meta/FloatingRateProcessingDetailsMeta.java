...
public class FloatingRateProcessingDetailsMeta implements RosettaMetaData<FloatingRateProcessingDetails> {
	...
	@Override
	public Validator<? super FloatingRateProcessingDetails> validator(ValidatorFactory factory) {
		return factory.<FloatingRateProcessingDetails>create(FloatingRateProcessingDetailsValidator.class);
	}

	@Override
	public Validator<? super FloatingRateProcessingDetails> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FloatingRateProcessingDetails>create(FloatingRateProcessingDetailsTypeFormatValidator.class);
	}
