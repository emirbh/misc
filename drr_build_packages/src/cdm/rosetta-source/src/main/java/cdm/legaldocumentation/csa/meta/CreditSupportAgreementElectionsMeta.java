...
public class CreditSupportAgreementElectionsMeta implements RosettaMetaData<CreditSupportAgreementElections> {
	...
	@Override
	public Validator<? super CreditSupportAgreementElections> validator(ValidatorFactory factory) {
		return factory.<CreditSupportAgreementElections>create(CreditSupportAgreementElectionsValidator.class);
	}

	@Override
	public Validator<? super CreditSupportAgreementElections> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CreditSupportAgreementElections>create(CreditSupportAgreementElectionsTypeFormatValidator.class);
	}
