 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Document", builder=Document.DocumentBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Document", model="cdm", builder=Document.DocumentBuilderImpl.class, version="6.23.0")
public interface Document extends RosettaModelObject {
	...
	class DocumentImpl implements Document {
		...
		@Required
		@RuneAttribute("finInstrmRptgTxRpt")
	...
	class DocumentBuilderImpl implements Document.DocumentBuilder {
		...
		@RuneAttribute("finInstrmRptgTxRpt")
		@Override
		public Document.DocumentBuilder setFinInstrmRptgTxRpt(FinInstrmRptgTxRpt _finInstrmRptgTxRpt) {
			this.finInstrmRptgTxRpt = _finInstrmRptgTxRpt == null ? null : _finInstrmRptgTxRpt.toBuilder();
			return this;
		}
