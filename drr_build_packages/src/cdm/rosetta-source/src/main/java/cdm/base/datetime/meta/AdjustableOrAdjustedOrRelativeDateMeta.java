...
import cdm.base.datetime.validation.datarule.AdjustableOrAdjustedOrRelativeDateAdjustedDate;
...
public class AdjustableOrAdjustedOrRelativeDateMeta implements RosettaMetaData<AdjustableOrAdjustedOrRelativeDate> {
	...
	public List<Validator<? super AdjustableOrAdjustedOrRelativeDate>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<AdjustableOrAdjustedOrRelativeDate>create(AdjustableOrAdjustedOrRelativeDateAdjustedDate.class)
		);
	}
	...
	@Override
	public Validator<? super AdjustableOrAdjustedOrRelativeDate> validator(ValidatorFactory factory) {
		return factory.<AdjustableOrAdjustedOrRelativeDate>create(AdjustableOrAdjustedOrRelativeDateValidator.class);
	}

	@Override
	public Validator<? super AdjustableOrAdjustedOrRelativeDate> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AdjustableOrAdjustedOrRelativeDate>create(AdjustableOrAdjustedOrRelativeDateTypeFormatValidator.class);
	}
