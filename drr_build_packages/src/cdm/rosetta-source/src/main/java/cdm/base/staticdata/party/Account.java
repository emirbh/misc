 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Account", builder=Account.AccountBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Account", model="cdm", builder=Account.AccountBuilderImpl.class, version="6.23.0")
