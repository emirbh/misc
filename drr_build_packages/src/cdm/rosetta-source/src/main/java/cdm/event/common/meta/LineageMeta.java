...
public class LineageMeta implements RosettaMetaData<Lineage> {
	...
	@Override
	public Validator<? super Lineage> validator(ValidatorFactory factory) {
		return factory.<Lineage>create(LineageValidator.class);
	}

	@Override
	public Validator<? super Lineage> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Lineage>create(LineageTypeFormatValidator.class);
	}
