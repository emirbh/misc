...
public class SpecificAssetOnlyExistsValidator implements ValidatorWithArg<SpecificAsset, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends SpecificAsset> ValidationResult<SpecificAsset> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("SpecificAsset", ValidationResult.ValidationType.ONLY_EXISTS, "SpecificAsset", path, "");
		}
		return failure("SpecificAsset", ValidationResult.ValidationType.ONLY_EXISTS, "SpecificAsset", path, "",
