 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Valuation", builder=Valuation.ValuationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Valuation", model="cdm", builder=Valuation.ValuationBuilderImpl.class, version="6.23.0")
public interface Valuation extends RosettaModelObject {
	...
	class ValuationBuilderImpl implements Valuation.ValuationBuilder {
		...
		@RuneAttribute("amount")
		@Override
		public Valuation.ValuationBuilder setAmount(Money _amount) {
		...
		@RuneAttribute("timestamp")
		@Override
		public Valuation.ValuationBuilder setTimestamp(ZonedDateTime _timestamp) {
		...
		@RuneAttribute("method")
		@Override
		public Valuation.ValuationBuilder setMethod(ValuationTypeEnum _method) {
		...
		@RuneAttribute("source")
		@Override
		public Valuation.ValuationBuilder setSource(ValuationSourceEnum _source) {
		...
		@RuneAttribute("delta")
		@Override
		public Valuation.ValuationBuilder setDelta(BigDecimal _delta) {
		...
		@RuneAttribute("valuationTiming")
		@Override
		public Valuation.ValuationBuilder setValuationTiming(PriceTimingEnum _valuationTiming) {
		...
		@RuneAttribute("priceComponent")
		@Override
		public Valuation.ValuationBuilder setPriceComponent(Price _priceComponent) {
