...
import cdm.product.asset.validation.datarule.BasketReferenceInformationBasketReferenceInformationChoice;
import cdm.product.asset.validation.datarule.BasketReferenceInformationMthToDefault;
import cdm.product.asset.validation.datarule.BasketReferenceInformationNthToDefault;
...
public class BasketReferenceInformationMeta implements RosettaMetaData<BasketReferenceInformation> {
	...
	public List<Validator<? super BasketReferenceInformation>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<BasketReferenceInformation>create(BasketReferenceInformationBasketReferenceInformationChoice.class),
			factory.<BasketReferenceInformation>create(BasketReferenceInformationNthToDefault.class),
			factory.<BasketReferenceInformation>create(BasketReferenceInformationMthToDefault.class)
		);
	}
