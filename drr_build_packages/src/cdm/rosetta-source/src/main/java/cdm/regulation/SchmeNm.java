 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SchmeNm", builder=SchmeNm.SchmeNmBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SchmeNm", model="cdm", builder=SchmeNm.SchmeNmBuilderImpl.class, version="6.23.0")
