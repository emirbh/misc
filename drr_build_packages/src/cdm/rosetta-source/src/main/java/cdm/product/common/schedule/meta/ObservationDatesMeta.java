...
public class ObservationDatesMeta implements RosettaMetaData<ObservationDates> {
	...
	@Override
	public Validator<? super ObservationDates> validator(ValidatorFactory factory) {
		return factory.<ObservationDates>create(ObservationDatesValidator.class);
	}

	@Override
	public Validator<? super ObservationDates> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ObservationDates>create(ObservationDatesTypeFormatValidator.class);
	}
