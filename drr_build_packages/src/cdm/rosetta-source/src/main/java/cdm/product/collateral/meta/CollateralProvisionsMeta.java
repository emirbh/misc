...
public class CollateralProvisionsMeta implements RosettaMetaData<CollateralProvisions> {
	...
	@Override
	public Validator<? super CollateralProvisions> validator(ValidatorFactory factory) {
		return factory.<CollateralProvisions>create(CollateralProvisionsValidator.class);
	}

	@Override
	public Validator<? super CollateralProvisions> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralProvisions>create(CollateralProvisionsTypeFormatValidator.class);
	}
