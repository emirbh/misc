 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PriceSourceDisruption", builder=PriceSourceDisruption.PriceSourceDisruptionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PriceSourceDisruption", model="cdm", builder=PriceSourceDisruption.PriceSourceDisruptionBuilderImpl.class, version="6.23.0")
