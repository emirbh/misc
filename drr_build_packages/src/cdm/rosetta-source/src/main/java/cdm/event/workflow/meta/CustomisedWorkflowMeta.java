...
public class CustomisedWorkflowMeta implements RosettaMetaData<CustomisedWorkflow> {
	...
	@Override
	public Validator<? super CustomisedWorkflow> validator(ValidatorFactory factory) {
		return factory.<CustomisedWorkflow>create(CustomisedWorkflowValidator.class);
	}

	@Override
	public Validator<? super CustomisedWorkflow> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CustomisedWorkflow>create(CustomisedWorkflowTypeFormatValidator.class);
	}
