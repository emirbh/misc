...
@RosettaDataType(value="FieldWithMetaResourceTypeEnum", builder=FieldWithMetaResourceTypeEnum.FieldWithMetaResourceTypeEnumBuilderImpl.class, version="0.0.0")
@RuneDataType(value="FieldWithMetaResourceTypeEnum", model="cdm", builder=FieldWithMetaResourceTypeEnum.FieldWithMetaResourceTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaResourceTypeEnum extends RosettaModelObject, FieldWithMeta<ResourceTypeEnum>, GlobalKey {

	FieldWithMetaResourceTypeEnumMeta metaData = new FieldWithMetaResourceTypeEnumMeta();
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaResourceTypeEnumBuilder extends FieldWithMetaResourceTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<ResourceTypeEnum>, GlobalKey.GlobalKeyBuilder {
		...
		FieldWithMetaResourceTypeEnum.FieldWithMetaResourceTypeEnumBuilder prune();
	}
	...
	class FieldWithMetaResourceTypeEnumBuilderImpl implements FieldWithMetaResourceTypeEnum.FieldWithMetaResourceTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaResourceTypeEnum.FieldWithMetaResourceTypeEnumBuilder setValue(ResourceTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaResourceTypeEnum.FieldWithMetaResourceTypeEnumBuilder setMeta(MetaFields _meta) {
