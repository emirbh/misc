...
public class CollateralTransferAgreementElectionsMeta implements RosettaMetaData<CollateralTransferAgreementElections> {
	...
	@Override
	public Validator<? super CollateralTransferAgreementElections> validator(ValidatorFactory factory) {
		return factory.<CollateralTransferAgreementElections>create(CollateralTransferAgreementElectionsValidator.class);
	}

	@Override
	public Validator<? super CollateralTransferAgreementElections> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralTransferAgreementElections>create(CollateralTransferAgreementElectionsTypeFormatValidator.class);
	}
