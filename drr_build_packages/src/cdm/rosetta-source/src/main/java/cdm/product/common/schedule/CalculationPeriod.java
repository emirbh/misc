 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CalculationPeriod", builder=CalculationPeriod.CalculationPeriodBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CalculationPeriod", model="cdm", builder=CalculationPeriod.CalculationPeriodBuilderImpl.class, version="6.23.0")
