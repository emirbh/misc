...
public enum EventIntentEnum {
	 ...
	 */
	@RosettaEnumValue(value = "Allocation") 
	 ...
	 */
	@RosettaEnumValue(value = "CashFlow") 
	CASH_FLOW("CashFlow", null),
	
	/**
	 * The intent is to clear the contract.
	 */
	@RosettaEnumValue(value = "Clearing") 
	 ...
	 */
	@RosettaEnumValue(value = "ContractTermsAmendment") 
	 ...
	 */
	@RosettaEnumValue(value = "EarlyTerminationProvision") 
	 ...
	 */
	@RosettaEnumValue(value = "IndexTransition") 
	 ...
	 */
	@RosettaEnumValue(value = "NotionalReset") 
	 ...
	 */
	@RosettaEnumValue(value = "NotionalStep") 
	 ...
	 */
	@RosettaEnumValue(value = "ObservationRecord") 
	 ...
	 */
	@RosettaEnumValue(value = "OptionalExtension") 
	 ...
	 */
	@RosettaEnumValue(value = "OptionalCancellation") 
	 ...
	 */
	@RosettaEnumValue(value = "PrincipalExchange") 
