 ...
 * @version 6.23.0
 */
@RosettaDataType(value="OtherAgreementTerms", builder=OtherAgreementTerms.OtherAgreementTermsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="OtherAgreementTerms", model="cdm", builder=OtherAgreementTerms.OtherAgreementTermsBuilderImpl.class, version="6.23.0")
public interface OtherAgreementTerms extends RosettaModelObject {
	...
	class OtherAgreementTermsBuilderImpl implements OtherAgreementTerms.OtherAgreementTermsBuilder {
		...
		@RuneAttribute("isSpecified")
		@Override
		public OtherAgreementTerms.OtherAgreementTermsBuilder setIsSpecified(Boolean _isSpecified) {
		...
		@RuneAttribute("legalDocument")
		@Override
		public OtherAgreementTerms.OtherAgreementTermsBuilder setLegalDocument(String _legalDocument) {
			this.legalDocument = _legalDocument == null ? null : _legalDocument;
			return this;
		}
