 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AdjustableDate", builder=AdjustableDate.AdjustableDateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AdjustableDate", model="cdm", builder=AdjustableDate.AdjustableDateBuilderImpl.class, version="6.23.0")
