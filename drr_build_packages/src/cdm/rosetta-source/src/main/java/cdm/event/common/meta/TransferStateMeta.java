...
public class TransferStateMeta implements RosettaMetaData<TransferState> {
	...
	@Override
	public Validator<? super TransferState> validator(ValidatorFactory factory) {
		return factory.<TransferState>create(TransferStateValidator.class);
	}

	@Override
	public Validator<? super TransferState> typeFormatValidator(ValidatorFactory factory) {
		return factory.<TransferState>create(TransferStateTypeFormatValidator.class);
	}
