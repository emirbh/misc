...
@ImplementedBy(Qualify_EquityOption_ParameterReturnVolatility_Index.Qualify_EquityOption_ParameterReturnVolatility_IndexDefault.class)
public abstract class Qualify_EquityOption_ParameterReturnVolatility_Index implements RosettaFunction,IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static class Qualify_EquityOption_ParameterReturnVolatility_IndexDefault extends Qualify_EquityOption_ParameterReturnVolatility_Index {
		@Override
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = exists(MapperS.of(MapperS.of(economicTerms).<Payout>mapC("getPayout", _economicTerms -> _economicTerms.getPayout()).get()).<OptionPayout>map("getOptionPayout", payout -> payout.getOptionPayout())).andNullSafe(areEqual(MapperS.of(qualify_EquitySwap_ParameterReturnVolatility_Index.evaluate(underlierEconomicTerms(economicTerms).get())), MapperS.of(true), CardinalityOperator.All)).get();
