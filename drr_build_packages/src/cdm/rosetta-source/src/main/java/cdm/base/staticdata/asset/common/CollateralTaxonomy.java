 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CollateralTaxonomy", builder=CollateralTaxonomy.CollateralTaxonomyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CollateralTaxonomy", model="cdm", builder=CollateralTaxonomy.CollateralTaxonomyBuilderImpl.class, version="6.23.0")
public interface CollateralTaxonomy extends RosettaModelObject {
	...
	class CollateralTaxonomyBuilderImpl implements CollateralTaxonomy.CollateralTaxonomyBuilder {
		...
		@RuneAttribute("taxonomyValue")
		@Override
		public CollateralTaxonomy.CollateralTaxonomyBuilder setTaxonomyValue(CollateralTaxonomyValue _taxonomyValue) {
			this.taxonomyValue = _taxonomyValue == null ? null : _taxonomyValue.toBuilder();
			return this;
		}
		...
		@RuneAttribute("taxonomySource")
		@Override
		public CollateralTaxonomy.CollateralTaxonomyBuilder setTaxonomySource(TaxonomySourceEnum _taxonomySource) {
			this.taxonomySource = _taxonomySource == null ? null : _taxonomySource;
			return this;
		}
