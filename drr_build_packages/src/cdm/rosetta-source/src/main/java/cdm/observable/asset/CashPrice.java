 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CashPrice", builder=CashPrice.CashPriceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CashPrice", model="cdm", builder=CashPrice.CashPriceBuilderImpl.class, version="6.23.0")
public interface CashPrice extends RosettaModelObject {
	...
	class CashPriceImpl implements CashPrice {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("premiumExpression")
	...
	class CashPriceBuilderImpl implements CashPrice.CashPriceBuilder {
		...
		@RuneAttribute("cashPriceType")
		@Override
		public CashPrice.CashPriceBuilder setCashPriceType(CashPriceTypeEnum _cashPriceType) {
		...
		@RuneAttribute("premiumExpression")
		@Override
		public CashPrice.CashPriceBuilder setPremiumExpression(PremiumExpression _premiumExpression) {
		...
		@RuneAttribute("feeType")
		@Override
		public CashPrice.CashPriceBuilder setFeeType(FeeTypeEnum _feeType) {
