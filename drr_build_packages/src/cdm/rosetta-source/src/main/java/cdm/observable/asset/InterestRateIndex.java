 ...
 * @version 6.23.0
 */
@RosettaDataType(value="InterestRateIndex", builder=InterestRateIndex.InterestRateIndexBuilderImpl.class, version="6.23.0")
@RuneDataType(value="InterestRateIndex", model="cdm", builder=InterestRateIndex.InterestRateIndexBuilderImpl.class, version="6.23.0")
@RuneChoiceType
