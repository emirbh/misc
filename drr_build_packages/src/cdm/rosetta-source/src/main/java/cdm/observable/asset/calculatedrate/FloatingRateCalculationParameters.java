 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FloatingRateCalculationParameters", builder=FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FloatingRateCalculationParameters", model="cdm", builder=FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilderImpl.class, version="6.23.0")
public interface FloatingRateCalculationParameters extends RosettaModelObject {
	...
	class FloatingRateCalculationParametersImpl implements FloatingRateCalculationParameters {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("observationShiftCalculation")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("lookbackCalculation")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("lockoutCalculation")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("observationParameters")
	...
	class FloatingRateCalculationParametersBuilderImpl implements FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilder {
		...
		@RuneAttribute("calculationMethod")
		@Override
		public FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilder setCalculationMethod(CalculationMethodEnum _calculationMethod) {
		...
		@RuneAttribute("observationShiftCalculation")
		@Override
		public FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilder setObservationShiftCalculation(ObservationShiftCalculation _observationShiftCalculation) {
			this.observationShiftCalculation = _observationShiftCalculation == null ? null : _observationShiftCalculation.toBuilder();
			return this;
		}
		...
		@RuneAttribute("lookbackCalculation")
		@Override
		public FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilder setLookbackCalculation(OffsetCalculation _lookbackCalculation) {
			this.lookbackCalculation = _lookbackCalculation == null ? null : _lookbackCalculation.toBuilder();
			return this;
		}
		...
		@RuneAttribute("lockoutCalculation")
		@Override
		public FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilder setLockoutCalculation(OffsetCalculation _lockoutCalculation) {
			this.lockoutCalculation = _lockoutCalculation == null ? null : _lockoutCalculation.toBuilder();
			return this;
		}
		...
		@RuneAttribute("applicableBusinessDays")
		@Override
		public FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilder setApplicableBusinessDays(BusinessCenters _applicableBusinessDays) {
		...
		@RuneAttribute("observationParameters")
		@Override
		public FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilder setObservationParameters(ObservationParameters _observationParameters) {
			this.observationParameters = _observationParameters == null ? null : _observationParameters.toBuilder();
			return this;
		}
