...
public class AggregationParametersMeta implements RosettaMetaData<AggregationParameters> {
	...
	@Override
	public Validator<? super AggregationParameters> validator(ValidatorFactory factory) {
		return factory.<AggregationParameters>create(AggregationParametersValidator.class);
	}

	@Override
	public Validator<? super AggregationParameters> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AggregationParameters>create(AggregationParametersTypeFormatValidator.class);
	}
