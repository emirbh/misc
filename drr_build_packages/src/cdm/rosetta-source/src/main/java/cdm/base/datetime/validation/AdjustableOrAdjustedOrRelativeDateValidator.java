		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AdjustableOrAdjustedOrRelativeDate", ValidationResult.ValidationType.CARDINALITY, "AdjustableOrAdjustedOrRelativeDate", path, "", res.getError());
				}
				return success("AdjustableOrAdjustedOrRelativeDate", ValidationResult.ValidationType.CARDINALITY, "AdjustableOrAdjustedOrRelativeDate", path, "");
			})
			.collect(toList());
	}
