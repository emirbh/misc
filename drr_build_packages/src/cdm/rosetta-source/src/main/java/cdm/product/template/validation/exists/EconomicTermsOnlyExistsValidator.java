...
public class EconomicTermsOnlyExistsValidator implements ValidatorWithArg<EconomicTerms, Set<String>> {
	...
	public <T2 extends EconomicTerms> ValidationResult<EconomicTerms> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("payout", ExistenceChecker.isSet((List<? extends Payout>) o.getPayout()))
		...
		if (setFields.equals(fields)) {
			return success("EconomicTerms", ValidationResult.ValidationType.ONLY_EXISTS, "EconomicTerms", path, "");
		}
		return failure("EconomicTerms", ValidationResult.ValidationType.ONLY_EXISTS, "EconomicTerms", path, "",
