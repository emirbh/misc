...
public class FloatingRateBaseMeta implements RosettaMetaData<FloatingRateBase> {
	...
	@Override
	public Validator<? super FloatingRateBase> validator(ValidatorFactory factory) {
		return factory.<FloatingRateBase>create(FloatingRateBaseValidator.class);
	}

	@Override
	public Validator<? super FloatingRateBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FloatingRateBase>create(FloatingRateBaseTypeFormatValidator.class);
	}
