 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CommodityPayout", builder=CommodityPayout.CommodityPayoutBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CommodityPayout", model="cdm", builder=CommodityPayout.CommodityPayoutBuilderImpl.class, version="6.23.0")
public interface CommodityPayout extends PayoutBase, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface CommodityPayoutBuilder extends CommodityPayout, PayoutBase.PayoutBaseBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class CommodityPayoutBuilderImpl extends PayoutBase.PayoutBaseBuilderImpl implements CommodityPayout.CommodityPayoutBuilder {
		...
		@RuneMetaType
		@Override
		public CommodityPayout.CommodityPayoutBuilder setMeta(MetaFields _meta) {
