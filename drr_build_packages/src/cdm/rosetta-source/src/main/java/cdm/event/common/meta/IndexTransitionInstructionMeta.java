...
import cdm.event.common.validation.datarule.IndexTransitionInstructionPriceQuantity;
...
public class IndexTransitionInstructionMeta implements RosettaMetaData<IndexTransitionInstruction> {
	...
	public List<Validator<? super IndexTransitionInstruction>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<IndexTransitionInstruction>create(IndexTransitionInstructionPriceQuantity.class)
		);
	}
	...
	@Override
	public Validator<? super IndexTransitionInstruction> validator(ValidatorFactory factory) {
		return factory.<IndexTransitionInstruction>create(IndexTransitionInstructionValidator.class);
	}

	@Override
	public Validator<? super IndexTransitionInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<IndexTransitionInstruction>create(IndexTransitionInstructionTypeFormatValidator.class);
	}
