 ...
 * @version 6.23.0
 */
@RosettaDataType(value="MandatoryEarlyTermination", builder=MandatoryEarlyTermination.MandatoryEarlyTerminationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="MandatoryEarlyTermination", model="cdm", builder=MandatoryEarlyTermination.MandatoryEarlyTerminationBuilderImpl.class, version="6.23.0")
public interface MandatoryEarlyTermination extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface MandatoryEarlyTerminationBuilder extends MandatoryEarlyTermination, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class MandatoryEarlyTerminationBuilderImpl implements MandatoryEarlyTermination.MandatoryEarlyTerminationBuilder {
		...
		@RuneAttribute("cashSettlement")
		@Override
		public MandatoryEarlyTermination.MandatoryEarlyTerminationBuilder setCashSettlement(SettlementTerms _cashSettlement) {
		...
		@RuneMetaType
		@Override
		public MandatoryEarlyTermination.MandatoryEarlyTerminationBuilder setMeta(MetaFields _meta) {
