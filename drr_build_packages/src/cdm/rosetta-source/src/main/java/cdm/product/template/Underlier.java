 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Underlier", builder=Underlier.UnderlierBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Underlier", model="cdm", builder=Underlier.UnderlierBuilderImpl.class, version="6.23.0")
@RuneChoiceType
