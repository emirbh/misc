 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Rounding", builder=Rounding.RoundingBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Rounding", model="cdm", builder=Rounding.RoundingBuilderImpl.class, version="6.23.0")
