...
@RuneDataType(value="ReferenceWithMetaObservation", model="cdm", builder=ReferenceWithMetaObservation.ReferenceWithMetaObservationBuilderImpl.class, version="0.0.0")
