 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FloatingAmountEvents", builder=FloatingAmountEvents.FloatingAmountEventsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FloatingAmountEvents", model="cdm", builder=FloatingAmountEvents.FloatingAmountEventsBuilderImpl.class, version="6.23.0")
