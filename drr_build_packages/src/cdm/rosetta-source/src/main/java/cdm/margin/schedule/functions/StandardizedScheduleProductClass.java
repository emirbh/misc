																				...
																				if ((boolean17 == null ? false : boolean17)) {
																					...
																					if ((boolean18 == null ? false : boolean18)) {
																						...
																						if ((boolean19 == null ? false : boolean19)) {
																							...
																							if ((boolean20 == null ? false : boolean20)) {
																							...
																							} else if (ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_PriceReturnBasicPerformance_Basket.evaluate(economicTerms(trade).get()))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_PriceReturnBasicPerformance_Index.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_PriceReturnBasicPerformance_SingleName.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnVolatility_Basket.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnVolatility_Index.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnVolatility_SingleName.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnVariance_Basket.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnVariance_Index.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnVariance_SingleName.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnCorrelation_Basket.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnDividend_Basket.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnDividend_Index.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquityOption_ParameterReturnDividend_SingleName.evaluate(economicTerms(trade).get())))).getOrDefault(false)) {
																								productClass = StandardizedScheduleProductClassEnum.OPTION;
																							} else {
																								...
																								} else if (ComparisonResult.ofNullSafe(MapperS.of(qualify_EquitySwap_ParameterReturnDividend_Basket.evaluate(economicTerms(trade).get()))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquitySwap_ParameterReturnDividend_Index.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquitySwap_ParameterReturnDividend_SingleName.evaluate(economicTerms(trade).get())))).getOrDefault(false)) {
																									productClass = StandardizedScheduleProductClassEnum.DIVIDEND_SWAP;
																								} else if (ComparisonResult.ofNullSafe(MapperS.of(qualify_EquitySwap_ParameterReturnVariance_Basket.evaluate(economicTerms(trade).get()))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquitySwap_ParameterReturnVariance_Index.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquitySwap_ParameterReturnVariance_SingleName.evaluate(economicTerms(trade).get())))).getOrDefault(false)) {
																									productClass = StandardizedScheduleProductClassEnum.VARIANCE_SWAP;
																								} else if (ComparisonResult.ofNullSafe(MapperS.of(qualify_EquitySwap_ParameterReturnVolatility_Basket.evaluate(economicTerms(trade).get()))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquitySwap_ParameterReturnVolatility_Index.evaluate(economicTerms(trade).get())))).orNullSafe(ComparisonResult.ofNullSafe(MapperS.of(qualify_EquitySwap_ParameterReturnVolatility_SingleName.evaluate(economicTerms(trade).get())))).getOrDefault(false)) {
																									productClass = StandardizedScheduleProductClassEnum.VOLATILITY_SWAP;
																								} else {
