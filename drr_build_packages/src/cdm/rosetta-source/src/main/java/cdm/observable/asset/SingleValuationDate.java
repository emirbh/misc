 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SingleValuationDate", builder=SingleValuationDate.SingleValuationDateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SingleValuationDate", model="cdm", builder=SingleValuationDate.SingleValuationDateBuilderImpl.class, version="6.23.0")
