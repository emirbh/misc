...
public enum ThresholdZeroEventEnum {
	...
	OTHER("Other", null)
;
	private static Map<String, ThresholdZeroEventEnum> values;
	static {
        Map<String, ThresholdZeroEventEnum> map = new ConcurrentHashMap<>();
		for (ThresholdZeroEventEnum instance : ThresholdZeroEventEnum.values()) {
	...
	ThresholdZeroEventEnum(String rosettaName, String displayName) {
		this.rosettaName = rosettaName;
		this.displayName = displayName;
	}

	public static ThresholdZeroEventEnum fromDisplayName(String name) {
		ThresholdZeroEventEnum value = values.get(name);
		if (value == null) {
