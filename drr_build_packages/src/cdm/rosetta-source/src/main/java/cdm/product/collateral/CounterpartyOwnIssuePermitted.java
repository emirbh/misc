 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CounterpartyOwnIssuePermitted", builder=CounterpartyOwnIssuePermitted.CounterpartyOwnIssuePermittedBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CounterpartyOwnIssuePermitted", model="cdm", builder=CounterpartyOwnIssuePermitted.CounterpartyOwnIssuePermittedBuilderImpl.class, version="6.23.0")
