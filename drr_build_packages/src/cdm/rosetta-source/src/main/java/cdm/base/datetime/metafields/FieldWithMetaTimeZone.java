...
@RuneDataType(value="FieldWithMetaTimeZone", model="cdm", builder=FieldWithMetaTimeZone.FieldWithMetaTimeZoneBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaTimeZone extends RosettaModelObject, FieldWithMeta<TimeZone>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaTimeZoneBuilder extends FieldWithMetaTimeZone, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<TimeZone>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaTimeZoneBuilderImpl implements FieldWithMetaTimeZone.FieldWithMetaTimeZoneBuilder {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaTimeZone.FieldWithMetaTimeZoneBuilder setValue(TimeZone _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaTimeZone.FieldWithMetaTimeZoneBuilder setMeta(MetaFields _meta) {
