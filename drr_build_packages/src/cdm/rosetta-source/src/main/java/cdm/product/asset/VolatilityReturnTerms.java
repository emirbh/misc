 ...
 * @version 6.23.0
 */
@RosettaDataType(value="VolatilityReturnTerms", builder=VolatilityReturnTerms.VolatilityReturnTermsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="VolatilityReturnTerms", model="cdm", builder=VolatilityReturnTerms.VolatilityReturnTermsBuilderImpl.class, version="6.23.0")
