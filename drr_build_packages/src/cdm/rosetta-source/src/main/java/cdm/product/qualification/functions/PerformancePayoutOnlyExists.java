...
@ImplementedBy(PerformancePayoutOnlyExists.PerformancePayoutOnlyExistsDefault.class)
public abstract class PerformancePayoutOnlyExists implements RosettaFunction {
	...
	*/
	...
	public static class PerformancePayoutOnlyExistsDefault extends PerformancePayoutOnlyExists {
		@Override
