 ...
 * @version 6.23.0
 */
@RosettaDataType(value="EarlyTerminationEvent", builder=EarlyTerminationEvent.EarlyTerminationEventBuilderImpl.class, version="6.23.0")
@RuneDataType(value="EarlyTerminationEvent", model="cdm", builder=EarlyTerminationEvent.EarlyTerminationEventBuilderImpl.class, version="6.23.0")
public interface EarlyTerminationEvent extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface EarlyTerminationEventBuilder extends EarlyTerminationEvent, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class EarlyTerminationEventBuilderImpl implements EarlyTerminationEvent.EarlyTerminationEventBuilder {
		...
		@RuneAttribute("adjustedExerciseDate")
		@Override
		public EarlyTerminationEvent.EarlyTerminationEventBuilder setAdjustedExerciseDate(Date _adjustedExerciseDate) {
		...
		@RuneAttribute("adjustedEarlyTerminationDate")
		@Override
		public EarlyTerminationEvent.EarlyTerminationEventBuilder setAdjustedEarlyTerminationDate(Date _adjustedEarlyTerminationDate) {
		...
		@RuneAttribute("adjustedCashSettlementValuationDate")
		@Override
		public EarlyTerminationEvent.EarlyTerminationEventBuilder setAdjustedCashSettlementValuationDate(Date _adjustedCashSettlementValuationDate) {
		...
		@RuneAttribute("adjustedCashSettlementPaymentDate")
		@Override
		public EarlyTerminationEvent.EarlyTerminationEventBuilder setAdjustedCashSettlementPaymentDate(Date _adjustedCashSettlementPaymentDate) {
		...
		@RuneAttribute("adjustedExerciseFeePaymentDate")
		@Override
		public EarlyTerminationEvent.EarlyTerminationEventBuilder setAdjustedExerciseFeePaymentDate(Date _adjustedExerciseFeePaymentDate) {
		...
		@RuneMetaType
		@Override
		public EarlyTerminationEvent.EarlyTerminationEventBuilder setMeta(MetaFields _meta) {
