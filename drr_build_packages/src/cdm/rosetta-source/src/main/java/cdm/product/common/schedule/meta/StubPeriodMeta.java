...
public class StubPeriodMeta implements RosettaMetaData<StubPeriod> {
	...
	@Override
	public Validator<? super StubPeriod> validator(ValidatorFactory factory) {
		return factory.<StubPeriod>create(StubPeriodValidator.class);
	}

	@Override
	public Validator<? super StubPeriod> typeFormatValidator(ValidatorFactory factory) {
		return factory.<StubPeriod>create(StubPeriodTypeFormatValidator.class);
	}
