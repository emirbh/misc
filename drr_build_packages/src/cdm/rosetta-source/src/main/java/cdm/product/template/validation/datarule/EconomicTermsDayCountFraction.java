 ...
 * @version 6.23.0
 */
@RosettaDataRule("EconomicTermsDayCountFraction")
@ImplementedBy(EconomicTermsDayCountFraction.Default.class)
public interface EconomicTermsDayCountFraction extends Validator<EconomicTerms> {
	
	String NAME = "EconomicTermsDayCountFraction";
	String DEFINITION = "if payout -> InterestRatePayout count = 2 then payout -> InterestRatePayout -> dayCountFraction exists";
	
	class Default implements EconomicTermsDayCountFraction {
	...
	class NoOp implements EconomicTermsDayCountFraction {
