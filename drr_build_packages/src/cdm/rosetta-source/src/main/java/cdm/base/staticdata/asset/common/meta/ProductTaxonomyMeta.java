...
public class ProductTaxonomyMeta implements RosettaMetaData<ProductTaxonomy> {
	...
	public List<Validator<? super ProductTaxonomy>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<ProductTaxonomy>create(ProductTaxonomyTaxonomyType.class),
			factory.<ProductTaxonomy>create(ProductTaxonomyTaxonomySource.class),
			factory.<ProductTaxonomy>create(ProductTaxonomyTaxonomyValue.class)
		);
	}
	...
	@Override
	public Validator<? super ProductTaxonomy> validator(ValidatorFactory factory) {
		return factory.<ProductTaxonomy>create(ProductTaxonomyValidator.class);
	}

	@Override
	public Validator<? super ProductTaxonomy> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ProductTaxonomy>create(ProductTaxonomyTypeFormatValidator.class);
	}
