...
@ImplementedBy(TradeFpML_cd_32.Default.class)
public interface TradeFpML_cd_32 extends Validator<Trade> {
	...
	class Default implements TradeFpML_cd_32 {
	...
	class NoOp implements TradeFpML_cd_32 {
