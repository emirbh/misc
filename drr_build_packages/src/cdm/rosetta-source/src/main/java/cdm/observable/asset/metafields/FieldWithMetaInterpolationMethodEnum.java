...
@RuneDataType(value="FieldWithMetaInterpolationMethodEnum", model="cdm", builder=FieldWithMetaInterpolationMethodEnum.FieldWithMetaInterpolationMethodEnumBuilderImpl.class, version="0.0.0")
