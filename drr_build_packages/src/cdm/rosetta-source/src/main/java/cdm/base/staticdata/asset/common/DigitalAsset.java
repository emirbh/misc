 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DigitalAsset", builder=DigitalAsset.DigitalAssetBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DigitalAsset", model="cdm", builder=DigitalAsset.DigitalAssetBuilderImpl.class, version="6.23.0")
public interface DigitalAsset extends AssetBase {
	...
	interface DigitalAssetBuilder extends DigitalAsset, AssetBase.AssetBaseBuilder {
		...
		@Override
		DigitalAsset.DigitalAssetBuilder addIdentifier(AssetIdentifier identifier, int idx);
		@Override
		...
		@Override
		DigitalAsset.DigitalAssetBuilder addTaxonomy(Taxonomy taxonomy, int idx);
		@Override
		...
		@Override
		DigitalAsset.DigitalAssetBuilder addRelatedExchange(LegalEntity relatedExchange, int idx);
		@Override
	...
	class DigitalAssetBuilderImpl extends AssetBase.AssetBaseBuilderImpl implements DigitalAsset.DigitalAssetBuilder {
		...
		@Override
		public DigitalAsset.DigitalAssetBuilder addIdentifier(AssetIdentifier _identifier, int idx) {
		...
		@Override
		public DigitalAsset.DigitalAssetBuilder addTaxonomy(Taxonomy _taxonomy, int idx) {
		...
		@Override
		public DigitalAsset.DigitalAssetBuilder addRelatedExchange(LegalEntity _relatedExchange, int idx) {
