	...
	*/
	...
	public static class Qualify_InterestRate_IRSwap_FixedFixedDefault extends Qualify_InterestRate_IRSwap_FixedFixed {
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = areEqual(MapperS.of(qualify_BaseProduct_IRSwap.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All).andNullSafe(areEqual(MapperS.of(qualify_SubProduct_FixedFixed.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All)).get();
