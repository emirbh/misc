 ...
 * @version 6.23.0
 */
@RosettaDataType(value="BoundedVariance", builder=BoundedVariance.BoundedVarianceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="BoundedVariance", model="cdm", builder=BoundedVariance.BoundedVarianceBuilderImpl.class, version="6.23.0")
