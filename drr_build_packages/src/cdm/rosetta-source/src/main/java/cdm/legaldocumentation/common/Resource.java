 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Resource", builder=Resource.ResourceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Resource", model="cdm", builder=Resource.ResourceBuilderImpl.class, version="6.23.0")
