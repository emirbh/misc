 ...
 * @version 6.23.0
 */
@RosettaDataType(value="MultipleValuationDates", builder=MultipleValuationDates.MultipleValuationDatesBuilderImpl.class, version="6.23.0")
@RuneDataType(value="MultipleValuationDates", model="cdm", builder=MultipleValuationDates.MultipleValuationDatesBuilderImpl.class, version="6.23.0")
