...
public class CollateralValuationTreatmentMeta implements RosettaMetaData<CollateralValuationTreatment> {
	...
	public List<Validator<? super CollateralValuationTreatment>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<CollateralValuationTreatment>create(CollateralValuationTreatmentHaircutPercentage.class),
			factory.<CollateralValuationTreatment>create(CollateralValuationTreatmentMarginPercentage.class),
			factory.<CollateralValuationTreatment>create(CollateralValuationTreatmentFxHaircutPercentage.class),
			factory.<CollateralValuationTreatment>create(CollateralValuationTreatmentAdditionalHaircutPercentage.class),
			factory.<CollateralValuationTreatment>create(CollateralValuationTreatmentHaircutPercentageOrMarginPercentage.class)
		);
	}
	...
	@Override
	public Validator<? super CollateralValuationTreatment> validator(ValidatorFactory factory) {
		return factory.<CollateralValuationTreatment>create(CollateralValuationTreatmentValidator.class);
	}

	@Override
	public Validator<? super CollateralValuationTreatment> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralValuationTreatment>create(CollateralValuationTreatmentTypeFormatValidator.class);
	}
