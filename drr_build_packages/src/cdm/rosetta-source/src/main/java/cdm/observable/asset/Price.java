 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Price", builder=Price.PriceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Price", model="cdm", builder=Price.PriceBuilderImpl.class, version="6.23.0")
public interface Price extends PriceSchedule {
	...
	interface PriceBuilder extends Price, PriceSchedule.PriceScheduleBuilder {
		...
		@Override
		Price.PriceBuilder addDatedValue(DatedValue datedValue, int idx);
		@Override
	...
	class PriceBuilderImpl extends PriceSchedule.PriceScheduleBuilderImpl implements Price.PriceBuilder {
		...
		@Override
		public Price.PriceBuilder addDatedValue(DatedValue _datedValue, int idx) {
