 ...
 * @version 6.23.0
 */
@RosettaDataType(value="InformationSource", builder=InformationSource.InformationSourceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="InformationSource", model="cdm", builder=InformationSource.InformationSourceBuilderImpl.class, version="6.23.0")
public interface InformationSource extends RosettaModelObject {
	...
	class InformationSourceImpl implements InformationSource {
		...
		public int hashCode() {
			int _result = 0;
			_result = 31 * _result + (sourceProvider != null ? sourceProvider.hashCode() : 0);
	...
	class InformationSourceBuilderImpl implements InformationSource.InformationSourceBuilder {
		...
		@RuneAttribute("sourceProvider")
		@Override
		public InformationSource.InformationSourceBuilder setSourceProvider(FieldWithMetaInformationProviderEnum _sourceProvider) {
			this.sourceProvider = _sourceProvider == null ? null : _sourceProvider.toBuilder();
			return this;
		}
		
		@Override
		public InformationSource.InformationSourceBuilder setSourceProviderValue(InformationProviderEnum _sourceProvider) {
		...
		@RuneAttribute("sourcePage")
		@Override
		public InformationSource.InformationSourceBuilder setSourcePage(FieldWithMetaString _sourcePage) {
			this.sourcePage = _sourcePage == null ? null : _sourcePage.toBuilder();
			return this;
		}
		
		@Override
		public InformationSource.InformationSourceBuilder setSourcePageValue(String _sourcePage) {
		...
		@RuneAttribute("sourcePageHeading")
		@Override
		public InformationSource.InformationSourceBuilder setSourcePageHeading(String _sourcePageHeading) {
