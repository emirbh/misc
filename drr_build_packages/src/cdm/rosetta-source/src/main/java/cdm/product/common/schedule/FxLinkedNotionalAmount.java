 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FxLinkedNotionalAmount", builder=FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FxLinkedNotionalAmount", model="cdm", builder=FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilderImpl.class, version="6.23.0")
public interface FxLinkedNotionalAmount extends RosettaModelObject {
	...
	class FxLinkedNotionalAmountBuilderImpl implements FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder {
		...
		@RuneAttribute("resetDate")
		@Override
		public FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder setResetDate(Date _resetDate) {
		...
		@RuneAttribute("adjustedFxSpotFixingDate")
		@Override
		public FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilder setAdjustedFxSpotFixingDate(Date _adjustedFxSpotFixingDate) {
