...
public class PayerReceiverMeta implements RosettaMetaData<PayerReceiver> {
	...
	@Override
	public Validator<? super PayerReceiver> validator(ValidatorFactory factory) {
		return factory.<PayerReceiver>create(PayerReceiverValidator.class);
	}

	@Override
	public Validator<? super PayerReceiver> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PayerReceiver>create(PayerReceiverTypeFormatValidator.class);
	}
