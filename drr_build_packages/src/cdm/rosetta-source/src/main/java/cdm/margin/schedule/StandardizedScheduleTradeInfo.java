 ...
 * @version 6.23.0
 */
@RosettaDataType(value="StandardizedScheduleTradeInfo", builder=StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilderImpl.class, version="6.23.0")
@RuneDataType(value="StandardizedScheduleTradeInfo", model="cdm", builder=StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilderImpl.class, version="6.23.0")
