 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CollateralIssuerType", builder=CollateralIssuerType.CollateralIssuerTypeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CollateralIssuerType", model="cdm", builder=CollateralIssuerType.CollateralIssuerTypeBuilderImpl.class, version="6.23.0")
public interface CollateralIssuerType extends RosettaModelObject {
	...
	class CollateralIssuerTypeImpl implements CollateralIssuerType {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("supraNationalType")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("quasiGovernmentType")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("regionalGovernmentType")
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("specialPurposeVehicleType")
	...
	class CollateralIssuerTypeBuilderImpl implements CollateralIssuerType.CollateralIssuerTypeBuilder {
		...
		@RuneAttribute("issuerType")
		@Override
		public CollateralIssuerType.CollateralIssuerTypeBuilder setIssuerType(IssuerTypeEnum _issuerType) {
			this.issuerType = _issuerType == null ? null : _issuerType;
			return this;
		}
		...
		@RuneAttribute("supraNationalType")
		@Override
		public CollateralIssuerType.CollateralIssuerTypeBuilder setSupraNationalType(SupraNationalIssuerTypeEnum _supraNationalType) {
			this.supraNationalType = _supraNationalType == null ? null : _supraNationalType;
			return this;
		}
		...
		@RuneAttribute("quasiGovernmentType")
		@Override
		public CollateralIssuerType.CollateralIssuerTypeBuilder setQuasiGovernmentType(QuasiGovernmentIssuerType _quasiGovernmentType) {
			this.quasiGovernmentType = _quasiGovernmentType == null ? null : _quasiGovernmentType.toBuilder();
			return this;
		}
		...
		@RuneAttribute("regionalGovernmentType")
		@Override
		public CollateralIssuerType.CollateralIssuerTypeBuilder setRegionalGovernmentType(RegionalGovernmentIssuerType _regionalGovernmentType) {
			this.regionalGovernmentType = _regionalGovernmentType == null ? null : _regionalGovernmentType.toBuilder();
			return this;
		}
		...
		@RuneAttribute("specialPurposeVehicleType")
		@Override
		public CollateralIssuerType.CollateralIssuerTypeBuilder setSpecialPurposeVehicleType(SpecialPurposeVehicleIssuerType _specialPurposeVehicleType) {
			this.specialPurposeVehicleType = _specialPurposeVehicleType == null ? null : _specialPurposeVehicleType.toBuilder();
			return this;
		}
