 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ConstituentWeight", builder=ConstituentWeight.ConstituentWeightBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ConstituentWeight", model="cdm", builder=ConstituentWeight.ConstituentWeightBuilderImpl.class, version="6.23.0")
