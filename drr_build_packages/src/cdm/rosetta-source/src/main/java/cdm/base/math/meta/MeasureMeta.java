...
import cdm.base.math.validation.datarule.MeasureValueExists;
...
public class MeasureMeta implements RosettaMetaData<Measure> {
	...
	public List<Validator<? super Measure>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<Measure>create(MeasureValueExists.class)
		);
	}
	...
	@Override
	public Validator<? super Measure> validator(ValidatorFactory factory) {
		return factory.<Measure>create(MeasureValidator.class);
	}

	@Override
	public Validator<? super Measure> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Measure>create(MeasureTypeFormatValidator.class);
	}
