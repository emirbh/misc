...
public class TransactedPriceMeta implements RosettaMetaData<TransactedPrice> {
	...
	@Override
	public Validator<? super TransactedPrice> validator(ValidatorFactory factory) {
		return factory.<TransactedPrice>create(TransactedPriceValidator.class);
	}

	@Override
	public Validator<? super TransactedPrice> typeFormatValidator(ValidatorFactory factory) {
		return factory.<TransactedPrice>create(TransactedPriceTypeFormatValidator.class);
	}
