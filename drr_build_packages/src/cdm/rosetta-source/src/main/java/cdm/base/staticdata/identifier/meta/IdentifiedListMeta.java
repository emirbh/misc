...
public class IdentifiedListMeta implements RosettaMetaData<IdentifiedList> {
	...
	@Override
	public Validator<? super IdentifiedList> validator(ValidatorFactory factory) {
		return factory.<IdentifiedList>create(IdentifiedListValidator.class);
	}

	@Override
	public Validator<? super IdentifiedList> typeFormatValidator(ValidatorFactory factory) {
		return factory.<IdentifiedList>create(IdentifiedListTypeFormatValidator.class);
	}
