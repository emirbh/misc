 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ObservationShiftCalculation", builder=ObservationShiftCalculation.ObservationShiftCalculationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ObservationShiftCalculation", model="cdm", builder=ObservationShiftCalculation.ObservationShiftCalculationBuilderImpl.class, version="6.23.0")
public interface ObservationShiftCalculation extends RosettaModelObject {
	...
	class ObservationShiftCalculationBuilderImpl implements ObservationShiftCalculation.ObservationShiftCalculationBuilder {
		...
		@RuneAttribute("offsetDays")
		@Override
		public ObservationShiftCalculation.ObservationShiftCalculationBuilder setOffsetDays(Integer _offsetDays) {
		...
		@RuneAttribute("calculationBase")
		@Override
		public ObservationShiftCalculation.ObservationShiftCalculationBuilder setCalculationBase(ObservationPeriodDatesEnum _calculationBase) {
			this.calculationBase = _calculationBase == null ? null : _calculationBase;
			return this;
		}
		...
		@RuneAttribute("additionalBusinessDays")
		@Override
		public ObservationShiftCalculation.ObservationShiftCalculationBuilder setAdditionalBusinessDays(BusinessCenters _additionalBusinessDays) {
