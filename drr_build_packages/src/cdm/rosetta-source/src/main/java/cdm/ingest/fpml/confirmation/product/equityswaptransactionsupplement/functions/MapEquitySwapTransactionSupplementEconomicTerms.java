	...
	public static class MapEquitySwapTransactionSupplementEconomicTermsDefault extends MapEquitySwapTransactionSupplementEconomicTerms {
		...
		protected EconomicTerms.EconomicTermsBuilder assignOutput(EconomicTerms.EconomicTermsBuilder economicTerms, EquitySwapTransactionSupplement fpmlEquitySwapTransactionSupplement, List<? extends Counterparty> cdmCounterpartyList) {
			economicTerms = toBuilder(EconomicTerms.builder()
				.setEffectiveDate(mapAdjustableOrRelativeDate.evaluate(distinct(MapperS.of(fpmlEquitySwapTransactionSupplement).<DirectionalLeg>mapC("getReturnSwapLeg", equitySwapTransactionSupplement -> equitySwapTransactionSupplement.getReturnSwapLeg()).<AdjustableOrRelativeDate>map("getEffectiveDate", directionalLeg -> directionalLeg.getEffectiveDate())).get()))
				.setTerminationDate(mapAdjustableOrRelativeDate.evaluate(distinct(MapperS.of(fpmlEquitySwapTransactionSupplement).<DirectionalLeg>mapC("getReturnSwapLeg", equitySwapTransactionSupplement -> equitySwapTransactionSupplement.getReturnSwapLeg()).<AdjustableOrRelativeDate>map("getTerminationDate", directionalLeg -> directionalLeg.getTerminationDate())).get()))
