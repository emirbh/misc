...
public class FloatingAmountCalculationDetailsMeta implements RosettaMetaData<FloatingAmountCalculationDetails> {
	...
	@Override
	public Validator<? super FloatingAmountCalculationDetails> validator(ValidatorFactory factory) {
		return factory.<FloatingAmountCalculationDetails>create(FloatingAmountCalculationDetailsValidator.class);
	}

	@Override
	public Validator<? super FloatingAmountCalculationDetails> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FloatingAmountCalculationDetails>create(FloatingAmountCalculationDetailsTypeFormatValidator.class);
	}
