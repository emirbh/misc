...
public class CheckEligibilityResultMeta implements RosettaMetaData<CheckEligibilityResult> {
	...
	@Override
	public Validator<? super CheckEligibilityResult> validator(ValidatorFactory factory) {
		return factory.<CheckEligibilityResult>create(CheckEligibilityResultValidator.class);
	}

	@Override
	public Validator<? super CheckEligibilityResult> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CheckEligibilityResult>create(CheckEligibilityResultTypeFormatValidator.class);
	}
