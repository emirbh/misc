...
public class CounterpartyPositionStateMeta implements RosettaMetaData<CounterpartyPositionState> {
	...
	@Override
	public Validator<? super CounterpartyPositionState> validator(ValidatorFactory factory) {
		return factory.<CounterpartyPositionState>create(CounterpartyPositionStateValidator.class);
	}

	@Override
	public Validator<? super CounterpartyPositionState> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CounterpartyPositionState>create(CounterpartyPositionStateTypeFormatValidator.class);
	}
