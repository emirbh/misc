...
public class CollateralAgreementFloatingRateOnlyExistsValidator implements ValidatorWithArg<CollateralAgreementFloatingRate, Set<String>> {
	...
	public <T2 extends CollateralAgreementFloatingRate> ValidationResult<CollateralAgreementFloatingRate> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("rateOption", ExistenceChecker.isSet((ReferenceWithMetaInterestRateIndex) o.getRateOption()))
		...
		if (setFields.equals(fields)) {
			return success("CollateralAgreementFloatingRate", ValidationResult.ValidationType.ONLY_EXISTS, "CollateralAgreementFloatingRate", path, "");
		}
		return failure("CollateralAgreementFloatingRate", ValidationResult.ValidationType.ONLY_EXISTS, "CollateralAgreementFloatingRate", path, "",
