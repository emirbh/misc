 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PrincipalPaymentSchedule", builder=PrincipalPaymentSchedule.PrincipalPaymentScheduleBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PrincipalPaymentSchedule", model="cdm", builder=PrincipalPaymentSchedule.PrincipalPaymentScheduleBuilderImpl.class, version="6.23.0")
