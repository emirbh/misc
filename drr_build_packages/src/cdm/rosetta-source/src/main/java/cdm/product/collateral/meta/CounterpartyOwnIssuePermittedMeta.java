...
public class CounterpartyOwnIssuePermittedMeta implements RosettaMetaData<CounterpartyOwnIssuePermitted> {
	...
	@Override
	public Validator<? super CounterpartyOwnIssuePermitted> validator(ValidatorFactory factory) {
		return factory.<CounterpartyOwnIssuePermitted>create(CounterpartyOwnIssuePermittedValidator.class);
	}

	@Override
	public Validator<? super CounterpartyOwnIssuePermitted> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CounterpartyOwnIssuePermitted>create(CounterpartyOwnIssuePermittedTypeFormatValidator.class);
	}
