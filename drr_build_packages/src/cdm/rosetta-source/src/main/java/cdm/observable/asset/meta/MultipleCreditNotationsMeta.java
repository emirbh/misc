...
import cdm.observable.asset.validation.datarule.MultipleCreditNotationsReferenceAgency;
...
public class MultipleCreditNotationsMeta implements RosettaMetaData<MultipleCreditNotations> {
	...
	public List<Validator<? super MultipleCreditNotations>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<MultipleCreditNotations>create(MultipleCreditNotationsReferenceAgency.class)
		);
	}
	...
	@Override
	public Validator<? super MultipleCreditNotations> validator(ValidatorFactory factory) {
		return factory.<MultipleCreditNotations>create(MultipleCreditNotationsValidator.class);
	}

	@Override
	public Validator<? super MultipleCreditNotations> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MultipleCreditNotations>create(MultipleCreditNotationsTypeFormatValidator.class);
	}
