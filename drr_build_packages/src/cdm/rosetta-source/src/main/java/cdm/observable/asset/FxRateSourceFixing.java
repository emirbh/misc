 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FxRateSourceFixing", builder=FxRateSourceFixing.FxRateSourceFixingBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FxRateSourceFixing", model="cdm", builder=FxRateSourceFixing.FxRateSourceFixingBuilderImpl.class, version="6.23.0")
