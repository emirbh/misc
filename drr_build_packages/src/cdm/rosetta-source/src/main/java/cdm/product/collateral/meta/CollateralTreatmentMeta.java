...
public class CollateralTreatmentMeta implements RosettaMetaData<CollateralTreatment> {
	...
	@Override
	public Validator<? super CollateralTreatment> validator(ValidatorFactory factory) {
		return factory.<CollateralTreatment>create(CollateralTreatmentValidator.class);
	}

	@Override
	public Validator<? super CollateralTreatment> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralTreatment>create(CollateralTreatmentTypeFormatValidator.class);
	}
