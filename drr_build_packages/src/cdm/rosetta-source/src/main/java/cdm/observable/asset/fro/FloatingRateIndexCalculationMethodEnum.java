...
public enum FloatingRateIndexCalculationMethodEnum {
	 ...
	 */
	@RosettaEnumValue(value = "OISCompound", displayName = "OIS Compounding") 
	OIS_COMPOUND("OISCompound", "OIS Compounding"),
	
	/**
	 * A calculation methodology using the arithmetic mean.
	 */
	@RosettaEnumValue(value = "Average", displayName = "Overnight Averaging") 
	AVERAGE("Average", "Overnight Averaging"),
	
	@RosettaEnumValue(value = "Compounded", displayName = "Compounded Index") 
	COMPOUNDED("Compounded", "Compounded Index"),
	
	@RosettaEnumValue(value = "AllInCompounded", displayName = "All-In Compounded Index") 
	ALL_IN_COMPOUNDED("AllInCompounded", "All-In Compounded Index")
;
