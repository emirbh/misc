...
public class FloatingRateIndexIdentificationMeta implements RosettaMetaData<FloatingRateIndexIdentification> {
	...
	@Override
	public Validator<? super FloatingRateIndexIdentification> validator(ValidatorFactory factory) {
		return factory.<FloatingRateIndexIdentification>create(FloatingRateIndexIdentificationValidator.class);
	}

	@Override
	public Validator<? super FloatingRateIndexIdentification> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FloatingRateIndexIdentification>create(FloatingRateIndexIdentificationTypeFormatValidator.class);
	}
