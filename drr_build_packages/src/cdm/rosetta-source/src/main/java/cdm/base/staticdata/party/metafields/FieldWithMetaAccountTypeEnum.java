...
@RuneDataType(value="FieldWithMetaAccountTypeEnum", model="cdm", builder=FieldWithMetaAccountTypeEnum.FieldWithMetaAccountTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaAccountTypeEnum extends RosettaModelObject, FieldWithMeta<AccountTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaAccountTypeEnumBuilder extends FieldWithMetaAccountTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<AccountTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaAccountTypeEnumBuilderImpl implements FieldWithMetaAccountTypeEnum.FieldWithMetaAccountTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaAccountTypeEnum.FieldWithMetaAccountTypeEnumBuilder setValue(AccountTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaAccountTypeEnum.FieldWithMetaAccountTypeEnumBuilder setMeta(MetaFields _meta) {
