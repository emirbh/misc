 ...
 * @version 6.23.0
 */
@RosettaDataType(value="MakeWholeAmount", builder=MakeWholeAmount.MakeWholeAmountBuilderImpl.class, version="6.23.0")
@RuneDataType(value="MakeWholeAmount", model="cdm", builder=MakeWholeAmount.MakeWholeAmountBuilderImpl.class, version="6.23.0")
