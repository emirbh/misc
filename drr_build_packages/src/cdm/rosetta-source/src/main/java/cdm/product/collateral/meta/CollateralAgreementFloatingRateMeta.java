...
public class CollateralAgreementFloatingRateMeta implements RosettaMetaData<CollateralAgreementFloatingRate> {
	...
	@Override
	public Validator<? super CollateralAgreementFloatingRate> validator(ValidatorFactory factory) {
		return factory.<CollateralAgreementFloatingRate>create(CollateralAgreementFloatingRateValidator.class);
	}

	@Override
	public Validator<? super CollateralAgreementFloatingRate> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralAgreementFloatingRate>create(CollateralAgreementFloatingRateTypeFormatValidator.class);
	}
