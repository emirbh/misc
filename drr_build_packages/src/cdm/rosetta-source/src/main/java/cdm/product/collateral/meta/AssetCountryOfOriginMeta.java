...
public class AssetCountryOfOriginMeta implements RosettaMetaData<AssetCountryOfOrigin> {
	...
	@Override
	public Validator<? super AssetCountryOfOrigin> validator(ValidatorFactory factory) {
		return factory.<AssetCountryOfOrigin>create(AssetCountryOfOriginValidator.class);
	}

	@Override
	public Validator<? super AssetCountryOfOrigin> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssetCountryOfOrigin>create(AssetCountryOfOriginTypeFormatValidator.class);
	}
