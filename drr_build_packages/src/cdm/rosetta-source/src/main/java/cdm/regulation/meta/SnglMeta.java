...
public class SnglMeta implements RosettaMetaData<Sngl> {
	...
	@Override
	public Validator<? super Sngl> validator(ValidatorFactory factory) {
		return factory.<Sngl>create(SnglValidator.class);
	}

	@Override
	public Validator<? super Sngl> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Sngl>create(SnglTypeFormatValidator.class);
	}
