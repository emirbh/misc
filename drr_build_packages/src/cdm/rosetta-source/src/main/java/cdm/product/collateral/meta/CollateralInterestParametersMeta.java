...
public class CollateralInterestParametersMeta implements RosettaMetaData<CollateralInterestParameters> {
	...
	@Override
	public Validator<? super CollateralInterestParameters> validator(ValidatorFactory factory) {
		return factory.<CollateralInterestParameters>create(CollateralInterestParametersValidator.class);
	}

	@Override
	public Validator<? super CollateralInterestParameters> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralInterestParameters>create(CollateralInterestParametersTypeFormatValidator.class);
	}
