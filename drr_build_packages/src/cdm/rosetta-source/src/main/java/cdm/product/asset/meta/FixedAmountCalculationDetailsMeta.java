...
public class FixedAmountCalculationDetailsMeta implements RosettaMetaData<FixedAmountCalculationDetails> {
	...
	@Override
	public Validator<? super FixedAmountCalculationDetails> validator(ValidatorFactory factory) {
		return factory.<FixedAmountCalculationDetails>create(FixedAmountCalculationDetailsValidator.class);
	}

	@Override
	public Validator<? super FixedAmountCalculationDetails> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FixedAmountCalculationDetails>create(FixedAmountCalculationDetailsTypeFormatValidator.class);
	}
