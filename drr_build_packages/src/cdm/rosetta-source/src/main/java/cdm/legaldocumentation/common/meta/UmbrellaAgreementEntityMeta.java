...
public class UmbrellaAgreementEntityMeta implements RosettaMetaData<UmbrellaAgreementEntity> {
	...
	@Override
	public Validator<? super UmbrellaAgreementEntity> validator(ValidatorFactory factory) {
		return factory.<UmbrellaAgreementEntity>create(UmbrellaAgreementEntityValidator.class);
	}

	@Override
	public Validator<? super UmbrellaAgreementEntity> typeFormatValidator(ValidatorFactory factory) {
		return factory.<UmbrellaAgreementEntity>create(UmbrellaAgreementEntityTypeFormatValidator.class);
	}
