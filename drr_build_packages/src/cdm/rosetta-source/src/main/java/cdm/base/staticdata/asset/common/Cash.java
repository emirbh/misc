 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Cash", builder=Cash.CashBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Cash", model="cdm", builder=Cash.CashBuilderImpl.class, version="6.23.0")
public interface Cash extends AssetBase {
	...
	interface CashBuilder extends Cash, AssetBase.AssetBaseBuilder {
		...
		@Override
		Cash.CashBuilder addIdentifier(AssetIdentifier identifier, int idx);
		@Override
		...
		@Override
		Cash.CashBuilder addTaxonomy(Taxonomy taxonomy, int idx);
		@Override
		...
		@Override
		Cash.CashBuilder addRelatedExchange(LegalEntity relatedExchange, int idx);
		@Override
	...
	class CashBuilderImpl extends AssetBase.AssetBaseBuilderImpl implements Cash.CashBuilder {
		...
		@Override
		public Cash.CashBuilder addIdentifier(AssetIdentifier _identifier, int idx) {
		...
		@Override
		public Cash.CashBuilder addTaxonomy(Taxonomy _taxonomy, int idx) {
		...
		@Override
		public Cash.CashBuilder addRelatedExchange(LegalEntity _relatedExchange, int idx) {
