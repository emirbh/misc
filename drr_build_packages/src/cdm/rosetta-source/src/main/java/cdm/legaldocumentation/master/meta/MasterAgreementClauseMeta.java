...
public class MasterAgreementClauseMeta implements RosettaMetaData<MasterAgreementClause> {
	...
	@Override
	public Validator<? super MasterAgreementClause> validator(ValidatorFactory factory) {
		return factory.<MasterAgreementClause>create(MasterAgreementClauseValidator.class);
	}

	@Override
	public Validator<? super MasterAgreementClause> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MasterAgreementClause>create(MasterAgreementClauseTypeFormatValidator.class);
	}
