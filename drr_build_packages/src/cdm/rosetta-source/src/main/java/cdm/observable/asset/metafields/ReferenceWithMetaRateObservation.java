...
@RuneDataType(value="ReferenceWithMetaRateObservation", model="cdm", builder=ReferenceWithMetaRateObservation.ReferenceWithMetaRateObservationBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaRateObservation extends RosettaModelObject, ReferenceWithMeta<RateObservation> {
	...
	class ReferenceWithMetaRateObservationBuilderImpl implements ReferenceWithMetaRateObservation.ReferenceWithMetaRateObservationBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaRateObservation.ReferenceWithMetaRateObservationBuilder setValue(RateObservation _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaRateObservation.ReferenceWithMetaRateObservationBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaRateObservation.ReferenceWithMetaRateObservationBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaRateObservation.ReferenceWithMetaRateObservationBuilder setReference(Reference _reference) {
