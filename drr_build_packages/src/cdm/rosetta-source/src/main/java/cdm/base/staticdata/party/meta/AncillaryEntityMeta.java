...
import cdm.base.staticdata.party.validation.datarule.AncillaryEntityOneOf0;
...
public class AncillaryEntityMeta implements RosettaMetaData<AncillaryEntity> {
	...
	public List<Validator<? super AncillaryEntity>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<AncillaryEntity>create(AncillaryEntityOneOf0.class)
		);
	}
	...
	@Override
	public Validator<? super AncillaryEntity> validator(ValidatorFactory factory) {
		return factory.<AncillaryEntity>create(AncillaryEntityValidator.class);
	}

	@Override
	public Validator<? super AncillaryEntity> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AncillaryEntity>create(AncillaryEntityTypeFormatValidator.class);
	}
