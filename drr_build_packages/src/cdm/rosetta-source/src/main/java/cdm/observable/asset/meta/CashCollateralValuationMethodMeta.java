...
public class CashCollateralValuationMethodMeta implements RosettaMetaData<CashCollateralValuationMethod> {
	...
	@Override
	public Validator<? super CashCollateralValuationMethod> validator(ValidatorFactory factory) {
		return factory.<CashCollateralValuationMethod>create(CashCollateralValuationMethodValidator.class);
	}

	@Override
	public Validator<? super CashCollateralValuationMethod> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CashCollateralValuationMethod>create(CashCollateralValuationMethodTypeFormatValidator.class);
	}
