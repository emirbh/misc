...
public class FloatingRateIndexFixingOffsetOnlyExistsValidator implements ValidatorWithArg<FloatingRateIndexFixingOffset, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FloatingRateIndexFixingOffset> ValidationResult<FloatingRateIndexFixingOffset> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FloatingRateIndexFixingOffset", ValidationResult.ValidationType.ONLY_EXISTS, "FloatingRateIndexFixingOffset", path, "");
		}
		return failure("FloatingRateIndexFixingOffset", ValidationResult.ValidationType.ONLY_EXISTS, "FloatingRateIndexFixingOffset", path, "",
