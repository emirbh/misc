...
public class CustomisableOffsetMeta implements RosettaMetaData<CustomisableOffset> {
	...
	@Override
	public Validator<? super CustomisableOffset> validator(ValidatorFactory factory) {
		return factory.<CustomisableOffset>create(CustomisableOffsetValidator.class);
	}

	@Override
	public Validator<? super CustomisableOffset> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CustomisableOffset>create(CustomisableOffsetTypeFormatValidator.class);
	}
