...
public class WorkflowStepApprovalMeta implements RosettaMetaData<WorkflowStepApproval> {
	...
	@Override
	public Validator<? super WorkflowStepApproval> validator(ValidatorFactory factory) {
		return factory.<WorkflowStepApproval>create(WorkflowStepApprovalValidator.class);
	}

	@Override
	public Validator<? super WorkflowStepApproval> typeFormatValidator(ValidatorFactory factory) {
		return factory.<WorkflowStepApproval>create(WorkflowStepApprovalTypeFormatValidator.class);
	}
