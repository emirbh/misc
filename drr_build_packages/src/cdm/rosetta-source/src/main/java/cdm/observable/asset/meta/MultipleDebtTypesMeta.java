...
public class MultipleDebtTypesMeta implements RosettaMetaData<MultipleDebtTypes> {
	...
	@Override
	public Validator<? super MultipleDebtTypes> validator(ValidatorFactory factory) {
		return factory.<MultipleDebtTypes>create(MultipleDebtTypesValidator.class);
	}

	@Override
	public Validator<? super MultipleDebtTypes> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MultipleDebtTypes>create(MultipleDebtTypesTypeFormatValidator.class);
	}
