...
import cdm.base.datetime.validation.datarule.BusinessCentersBusinessCentersChoice;
...
public class BusinessCentersMeta implements RosettaMetaData<BusinessCenters> {
	...
	public List<Validator<? super BusinessCenters>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<BusinessCenters>create(BusinessCentersBusinessCentersChoice.class)
		);
	}
