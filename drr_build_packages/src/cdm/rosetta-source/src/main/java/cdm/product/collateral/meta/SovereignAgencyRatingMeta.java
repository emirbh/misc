...
public class SovereignAgencyRatingMeta implements RosettaMetaData<SovereignAgencyRating> {
	...
	@Override
	public Validator<? super SovereignAgencyRating> validator(ValidatorFactory factory) {
		return factory.<SovereignAgencyRating>create(SovereignAgencyRatingValidator.class);
	}

	@Override
	public Validator<? super SovereignAgencyRating> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SovereignAgencyRating>create(SovereignAgencyRatingTypeFormatValidator.class);
	}
