...
public class ObservationTermsOnlyExistsValidator implements ValidatorWithArg<ObservationTerms, Set<String>> {
	...
	public <T2 extends ObservationTerms> ValidationResult<ObservationTerms> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("observationTimeType", ExistenceChecker.isSet((TimeTypeEnum) o.getObservationTimeType()))
		...
		if (setFields.equals(fields)) {
			return success("ObservationTerms", ValidationResult.ValidationType.ONLY_EXISTS, "ObservationTerms", path, "");
		}
		return failure("ObservationTerms", ValidationResult.ValidationType.ONLY_EXISTS, "ObservationTerms", path, "",
