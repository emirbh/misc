 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AcctOwnr", builder=AcctOwnr.AcctOwnrBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AcctOwnr", model="cdm", builder=AcctOwnr.AcctOwnrBuilderImpl.class, version="6.23.0")
public interface AcctOwnr extends RosettaModelObject {
	...
	class AcctOwnrBuilderImpl implements AcctOwnr.AcctOwnrBuilder {
		...
		@RuneAttribute("id")
		@Override
		public AcctOwnr.AcctOwnrBuilder setId(Id _id) {
