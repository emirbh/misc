 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AssetIdentifier", builder=AssetIdentifier.AssetIdentifierBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AssetIdentifier", model="cdm", builder=AssetIdentifier.AssetIdentifierBuilderImpl.class, version="6.23.0")
