 ...
 * @version 6.23.0
 */
@RosettaDataType(value="StrikeSpread", builder=StrikeSpread.StrikeSpreadBuilderImpl.class, version="6.23.0")
@RuneDataType(value="StrikeSpread", model="cdm", builder=StrikeSpread.StrikeSpreadBuilderImpl.class, version="6.23.0")
