...
@RuneDataType(value="ReferenceWithMetaQuotedCurrencyPair", model="cdm", builder=ReferenceWithMetaQuotedCurrencyPair.ReferenceWithMetaQuotedCurrencyPairBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaQuotedCurrencyPair extends RosettaModelObject, ReferenceWithMeta<QuotedCurrencyPair> {
	...
	class ReferenceWithMetaQuotedCurrencyPairBuilderImpl implements ReferenceWithMetaQuotedCurrencyPair.ReferenceWithMetaQuotedCurrencyPairBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaQuotedCurrencyPair.ReferenceWithMetaQuotedCurrencyPairBuilder setValue(QuotedCurrencyPair _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaQuotedCurrencyPair.ReferenceWithMetaQuotedCurrencyPairBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaQuotedCurrencyPair.ReferenceWithMetaQuotedCurrencyPairBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaQuotedCurrencyPair.ReferenceWithMetaQuotedCurrencyPairBuilder setReference(Reference _reference) {
