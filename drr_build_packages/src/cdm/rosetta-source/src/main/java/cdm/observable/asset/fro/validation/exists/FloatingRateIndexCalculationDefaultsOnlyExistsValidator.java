...
public class FloatingRateIndexCalculationDefaultsOnlyExistsValidator implements ValidatorWithArg<FloatingRateIndexCalculationDefaults, Set<String>> {
	...
	public <T2 extends FloatingRateIndexCalculationDefaults> ValidationResult<FloatingRateIndexCalculationDefaults> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("fixing", ExistenceChecker.isSet((List<? extends FloatingRateIndexFixingDetails>) o.getFixing()))
				...
				.put("publicationCalendar", ExistenceChecker.isSet((BusinessCenterEnum) o.getPublicationCalendar()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("FloatingRateIndexCalculationDefaults", ValidationResult.ValidationType.ONLY_EXISTS, "FloatingRateIndexCalculationDefaults", path, "");
		}
		return failure("FloatingRateIndexCalculationDefaults", ValidationResult.ValidationType.ONLY_EXISTS, "FloatingRateIndexCalculationDefaults", path, "",
