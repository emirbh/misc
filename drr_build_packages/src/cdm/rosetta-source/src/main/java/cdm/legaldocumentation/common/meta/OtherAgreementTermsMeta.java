...
public class OtherAgreementTermsMeta implements RosettaMetaData<OtherAgreementTerms> {
	...
	public List<Validator<? super OtherAgreementTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<OtherAgreementTerms>create(OtherAgreementTermsLegalDocumentNotSpecified.class),
			factory.<OtherAgreementTerms>create(OtherAgreementTermsLegalDocumentSpecified.class)
		);
	}
	...
	@Override
	public Validator<? super OtherAgreementTerms> validator(ValidatorFactory factory) {
		return factory.<OtherAgreementTerms>create(OtherAgreementTermsValidator.class);
	}

	@Override
	public Validator<? super OtherAgreementTerms> typeFormatValidator(ValidatorFactory factory) {
		return factory.<OtherAgreementTerms>create(OtherAgreementTermsTypeFormatValidator.class);
	}
