...
public class AddressForNoticesMeta implements RosettaMetaData<AddressForNotices> {
	...
	@Override
	public Validator<? super AddressForNotices> validator(ValidatorFactory factory) {
		return factory.<AddressForNotices>create(AddressForNoticesValidator.class);
	}

	@Override
	public Validator<? super AddressForNotices> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AddressForNotices>create(AddressForNoticesTypeFormatValidator.class);
	}
