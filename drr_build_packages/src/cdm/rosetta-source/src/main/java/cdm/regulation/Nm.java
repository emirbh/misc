 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Nm", builder=Nm.NmBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Nm", model="cdm", builder=Nm.NmBuilderImpl.class, version="6.23.0")
public interface Nm extends RosettaModelObject {
	...
	class NmBuilderImpl implements Nm.NmBuilder {
		...
		@RuneAttribute("refRate")
		@Override
		public Nm.NmBuilder setRefRate(RefRate _refRate) {
			this.refRate = _refRate == null ? null : _refRate.toBuilder();
			return this;
		}
		...
		@RuneAttribute("term")
		@Override
		public Nm.NmBuilder setTerm(Term _term) {
