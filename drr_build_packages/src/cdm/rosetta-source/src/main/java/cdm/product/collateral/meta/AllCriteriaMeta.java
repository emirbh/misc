...
public class AllCriteriaMeta implements RosettaMetaData<AllCriteria> {
	...
	@Override
	public Validator<? super AllCriteria> validator(ValidatorFactory factory) {
		return factory.<AllCriteria>create(AllCriteriaValidator.class);
	}

	@Override
	public Validator<? super AllCriteria> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AllCriteria>create(AllCriteriaTypeFormatValidator.class);
	}
