 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CollateralCriteria", builder=CollateralCriteria.CollateralCriteriaBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CollateralCriteria", model="cdm", builder=CollateralCriteria.CollateralCriteriaBuilderImpl.class, version="6.23.0")
@RuneChoiceType
