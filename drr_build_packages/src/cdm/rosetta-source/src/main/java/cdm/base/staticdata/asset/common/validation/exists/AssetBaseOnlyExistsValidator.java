...
public class AssetBaseOnlyExistsValidator implements ValidatorWithArg<AssetBase, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AssetBase> ValidationResult<AssetBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AssetBase", ValidationResult.ValidationType.ONLY_EXISTS, "AssetBase", path, "");
		}
		return failure("AssetBase", ValidationResult.ValidationType.ONLY_EXISTS, "AssetBase", path, "",
