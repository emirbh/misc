...
public enum PriceOperandEnum {
	...
	@RosettaEnumValue(value = "AccruedInterest") 
	ACCRUED_INTEREST("AccruedInterest", null),
	
	@RosettaEnumValue(value = "Commission") 
	COMMISSION("Commission", null),
	
	@RosettaEnumValue(value = "ForwardPoint") 
	FORWARD_POINT("ForwardPoint", null)
;
