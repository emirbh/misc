	...
	*/
	...
	public static class Qualify_AdjustmentDefault extends Qualify_Adjustment {
		...
		protected Boolean assignOutput(Boolean is_event, BusinessEvent businessEvent) {
			is_event = exists(MapperS.of(businessEvent).<TradeState>mapC("getAfter", _businessEvent -> _businessEvent.getAfter()).<Trade>map("getTrade", tradeState -> tradeState.getTrade()).<NonTransferableProduct>map("getProduct", trade -> trade.getProduct()).<EconomicTerms>map("getEconomicTerms", nonTransferableProduct -> nonTransferableProduct.getEconomicTerms()).<Payout>mapC("getPayout", economicTerms -> economicTerms.getPayout()).<InterestRatePayout>map("getInterestRatePayout", payout -> payout.getInterestRatePayout())).andNullSafe(areEqual(openEconomicTerms(businessEvent).<Payout>mapC("getPayout", economicTerms -> economicTerms.getPayout()), beforeEconomicterms(businessEvent).<Payout>mapC("getPayout", economicTerms -> economicTerms.getPayout()), CardinalityOperator.All)).andNullSafe(exists(beforeTradePurchasePrice(businessEvent))).andNullSafe(exists(afterTradePurchasePrice(businessEvent))).andNullSafe(areEqual(afterTradePurchasePrice(businessEvent), beforeTradePurchasePrice(businessEvent), CardinalityOperator.All)).andNullSafe(notEqual(beforeTradeCollateralQuantity(businessEvent), afterTradeCollateralQuantity(businessEvent), CardinalityOperator.Any)).andNullSafe(notEqual(beforeTradeCollateralPrice(businessEvent), afterTradeCollateralPrice(businessEvent), CardinalityOperator.Any)).andNullSafe(exists(beforeEconomicterms(businessEvent))).andNullSafe(exists(openEconomicTerms(businessEvent))).andNullSafe(areEqual(openEconomicTerms(businessEvent).<AdjustableOrRelativeDate>map("getTerminationDate", economicTerms -> economicTerms.getTerminationDate()), beforeEconomicterms(businessEvent).<AdjustableOrRelativeDate>map("getTerminationDate", economicTerms -> economicTerms.getTerminationDate()), CardinalityOperator.All)).andNullSafe(notEqual(openEconomicTerms(businessEvent).<AdjustableOrRelativeDate>map("getEffectiveDate", economicTerms -> economicTerms.getEffectiveDate()), beforeEconomicterms(businessEvent).<AdjustableOrRelativeDate>map("getEffectiveDate", economicTerms -> economicTerms.getEffectiveDate()), CardinalityOperator.Any)).get();
