...
public class AveragingCalculationMethodMeta implements RosettaMetaData<AveragingCalculationMethod> {
	...
	@Override
	public Validator<? super AveragingCalculationMethod> validator(ValidatorFactory factory) {
		return factory.<AveragingCalculationMethod>create(AveragingCalculationMethodValidator.class);
	}

	@Override
	public Validator<? super AveragingCalculationMethod> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AveragingCalculationMethod>create(AveragingCalculationMethodTypeFormatValidator.class);
	}
