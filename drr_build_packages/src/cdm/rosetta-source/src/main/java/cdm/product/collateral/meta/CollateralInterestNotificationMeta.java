...
public class CollateralInterestNotificationMeta implements RosettaMetaData<CollateralInterestNotification> {
	...
	@Override
	public Validator<? super CollateralInterestNotification> validator(ValidatorFactory factory) {
		return factory.<CollateralInterestNotification>create(CollateralInterestNotificationValidator.class);
	}

	@Override
	public Validator<? super CollateralInterestNotification> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralInterestNotification>create(CollateralInterestNotificationTypeFormatValidator.class);
	}
