 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PriceReturnTerms", builder=PriceReturnTerms.PriceReturnTermsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PriceReturnTerms", model="cdm", builder=PriceReturnTerms.PriceReturnTermsBuilderImpl.class, version="6.23.0")
