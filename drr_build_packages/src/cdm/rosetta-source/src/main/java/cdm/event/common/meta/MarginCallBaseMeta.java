...
public class MarginCallBaseMeta implements RosettaMetaData<MarginCallBase> {
	...
	@Override
	public Validator<? super MarginCallBase> validator(ValidatorFactory factory) {
		return factory.<MarginCallBase>create(MarginCallBaseValidator.class);
	}

	@Override
	public Validator<? super MarginCallBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MarginCallBase>create(MarginCallBaseTypeFormatValidator.class);
	}
