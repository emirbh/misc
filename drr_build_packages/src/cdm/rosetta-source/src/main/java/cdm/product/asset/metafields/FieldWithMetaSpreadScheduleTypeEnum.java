...
@RuneDataType(value="FieldWithMetaSpreadScheduleTypeEnum", model="cdm", builder=FieldWithMetaSpreadScheduleTypeEnum.FieldWithMetaSpreadScheduleTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaSpreadScheduleTypeEnum extends RosettaModelObject, FieldWithMeta<SpreadScheduleTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaSpreadScheduleTypeEnumBuilder extends FieldWithMetaSpreadScheduleTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<SpreadScheduleTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaSpreadScheduleTypeEnumBuilderImpl implements FieldWithMetaSpreadScheduleTypeEnum.FieldWithMetaSpreadScheduleTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaSpreadScheduleTypeEnum.FieldWithMetaSpreadScheduleTypeEnumBuilder setValue(SpreadScheduleTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaSpreadScheduleTypeEnum.FieldWithMetaSpreadScheduleTypeEnumBuilder setMeta(MetaFields _meta) {
