...
import cdm.legaldocumentation.transaction.additionalterms.meta.IndexAdjustmentEventsMeta;
 ...
 *
 */
@RosettaDataType(value="IndexAdjustmentEvents", builder=IndexAdjustmentEvents.IndexAdjustmentEventsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="IndexAdjustmentEvents", model="cdm", builder=IndexAdjustmentEvents.IndexAdjustmentEventsBuilderImpl.class, version="6.23.0")
