	...
	*/
	...
	public static class NewTradeInstructionOnlyExistsDefault extends NewTradeInstructionOnlyExists {
		...
		protected Boolean assignOutput(Boolean result, PrimitiveInstruction primitiveInstruction) {
			result = onlyExists(MapperS.of(primitiveInstruction), Arrays.asList("contractFormation", "execution", "exercise", "partyChange", "quantityChange", "reset", "split", "termsChange", "transfer", "indexTransition", "stockSplit", "observation", "valuation"), Arrays.asList("execution")).orNullSafe(onlyExists(MapperS.of(primitiveInstruction), Arrays.asList("contractFormation", "execution", "exercise", "partyChange", "quantityChange", "reset", "split", "termsChange", "transfer", "indexTransition", "stockSplit", "observation", "valuation"), Arrays.asList("execution", "contractFormation"))).get();
