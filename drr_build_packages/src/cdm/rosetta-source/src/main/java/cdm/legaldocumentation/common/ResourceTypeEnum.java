...
public enum ResourceTypeEnum {
	 ...
	 */
	@RosettaEnumValue(value = "SupplementalMaterialEconomicTerms") 
	SUPPLEMENTAL_MATERIAL_ECONOMIC_TERMS("SupplementalMaterialEconomicTerms", null),
	
	/**
	 * Document describing the economic characteristics of a transaction.
	 */
	@RosettaEnumValue(value = "TermSheet") 
