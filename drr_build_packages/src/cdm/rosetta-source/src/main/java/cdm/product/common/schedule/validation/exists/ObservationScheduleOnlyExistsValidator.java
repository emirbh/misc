...
public class ObservationScheduleOnlyExistsValidator implements ValidatorWithArg<ObservationSchedule, Set<String>> {
	...
	public <T2 extends ObservationSchedule> ValidationResult<ObservationSchedule> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("observationDate", ExistenceChecker.isSet((List<? extends ObservationDate>) o.getObservationDate()))
		...
		if (setFields.equals(fields)) {
			return success("ObservationSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "ObservationSchedule", path, "");
		}
		return failure("ObservationSchedule", ValidationResult.ValidationType.ONLY_EXISTS, "ObservationSchedule", path, "",
