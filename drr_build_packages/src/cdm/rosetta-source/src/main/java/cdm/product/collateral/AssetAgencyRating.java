 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AssetAgencyRating", builder=AssetAgencyRating.AssetAgencyRatingBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AssetAgencyRating", model="cdm", builder=AssetAgencyRating.AssetAgencyRatingBuilderImpl.class, version="6.23.0")
