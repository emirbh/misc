...
public class ListingSectorMeta implements RosettaMetaData<ListingSector> {
	...
	@Override
	public Validator<? super ListingSector> validator(ValidatorFactory factory) {
		return factory.<ListingSector>create(ListingSectorValidator.class);
	}

	@Override
	public Validator<? super ListingSector> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ListingSector>create(ListingSectorTypeFormatValidator.class);
	}
