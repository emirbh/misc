...
@RuneDataType(value="FieldWithMetaGoverningLawEnum", model="cdm", builder=FieldWithMetaGoverningLawEnum.FieldWithMetaGoverningLawEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaGoverningLawEnum extends RosettaModelObject, FieldWithMeta<GoverningLawEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaGoverningLawEnumBuilder extends FieldWithMetaGoverningLawEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<GoverningLawEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaGoverningLawEnumBuilderImpl implements FieldWithMetaGoverningLawEnum.FieldWithMetaGoverningLawEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaGoverningLawEnum.FieldWithMetaGoverningLawEnumBuilder setValue(GoverningLawEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaGoverningLawEnum.FieldWithMetaGoverningLawEnumBuilder setMeta(MetaFields _meta) {
