...
public abstract class Qualify_InterestRate_CrossCurrency_Basis implements RosettaFunction,IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static class Qualify_InterestRate_CrossCurrency_BasisDefault extends Qualify_InterestRate_CrossCurrency_Basis {
		@Override
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = areEqual(MapperS.of(qualify_BaseProduct_CrossCurrency.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All).andNullSafe(areEqual(MapperS.of(qualify_SubProduct_Basis.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All)).get();
