 ...
 * @version 6.23.0
 */
@RosettaDataType(value="IssuerName", builder=IssuerName.IssuerNameBuilderImpl.class, version="6.23.0")
@RuneDataType(value="IssuerName", model="cdm", builder=IssuerName.IssuerNameBuilderImpl.class, version="6.23.0")
