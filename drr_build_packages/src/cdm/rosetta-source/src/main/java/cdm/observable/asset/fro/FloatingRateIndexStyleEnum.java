...
public enum FloatingRateIndexStyleEnum {
	 ...
	 */
	@RosettaEnumValue(value = "AverageFRO", displayName = "Average FRO") 
	AVERAGE_FRO("AverageFRO", "Average FRO"),
	
	/**
	 * An ISDA-defined calculated rate done using arithmetic averaging.
	 */
	@RosettaEnumValue(value = "CompoundedFRO", displayName = "Compounded FRO") 
	COMPOUNDED_FRO("CompoundedFRO", "Compounded FRO"),
	
	/**
	 * A published index calculated using compounding.
	 */
	@RosettaEnumValue(value = "CompoundedIndex", displayName = "Compounded Index") 
