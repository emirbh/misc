		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FixedPricePayout", ValidationResult.ValidationType.CARDINALITY, "FixedPricePayout", path, "", res.getError());
				}
				return success("FixedPricePayout", ValidationResult.ValidationType.CARDINALITY, "FixedPricePayout", path, "");
			})
			.collect(toList());
	}
