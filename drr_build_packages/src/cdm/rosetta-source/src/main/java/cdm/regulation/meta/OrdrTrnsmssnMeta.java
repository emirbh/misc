...
public class OrdrTrnsmssnMeta implements RosettaMetaData<OrdrTrnsmssn> {
	...
	@Override
	public Validator<? super OrdrTrnsmssn> validator(ValidatorFactory factory) {
		return factory.<OrdrTrnsmssn>create(OrdrTrnsmssnValidator.class);
	}

	@Override
	public Validator<? super OrdrTrnsmssn> typeFormatValidator(ValidatorFactory factory) {
		return factory.<OrdrTrnsmssn>create(OrdrTrnsmssnTypeFormatValidator.class);
	}
