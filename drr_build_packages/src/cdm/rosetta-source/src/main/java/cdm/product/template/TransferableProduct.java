 ...
 * @version 6.23.0
 */
@RosettaDataType(value="TransferableProduct", builder=TransferableProduct.TransferableProductBuilderImpl.class, version="6.23.0")
@RuneDataType(value="TransferableProduct", model="cdm", builder=TransferableProduct.TransferableProductBuilderImpl.class, version="6.23.0")
