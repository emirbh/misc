...
import cdm.product.asset.validation.datarule.CreditDefaultPayoutFpML_cd_12;
...
public class CreditDefaultPayoutMeta implements RosettaMetaData<CreditDefaultPayout> {
	...
	public List<Validator<? super CreditDefaultPayout>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<CreditDefaultPayout>create(CreditDefaultPayoutFpML_cd_12.class),
			factory.<CreditDefaultPayout>create(CreditDefaultPayoutQuantity.class)
		);
	}
	...
	@Override
	public Validator<? super CreditDefaultPayout> validator(ValidatorFactory factory) {
		return factory.<CreditDefaultPayout>create(CreditDefaultPayoutValidator.class);
	}

	@Override
	public Validator<? super CreditDefaultPayout> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CreditDefaultPayout>create(CreditDefaultPayoutTypeFormatValidator.class);
	}
