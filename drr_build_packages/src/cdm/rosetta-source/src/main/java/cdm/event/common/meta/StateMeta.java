...
import cdm.event.common.validation.datarule.StateClosedStateExists;
...
public class StateMeta implements RosettaMetaData<State> {
	...
	public List<Validator<? super State>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<State>create(StateClosedStateExists.class)
		);
	}
	...
	@Override
	public Validator<? super State> validator(ValidatorFactory factory) {
		return factory.<State>create(StateValidator.class);
	}

	@Override
	public Validator<? super State> typeFormatValidator(ValidatorFactory factory) {
		return factory.<State>create(StateTypeFormatValidator.class);
	}
