...
@ImplementedBy(TradeFpML_cd_11.Default.class)
public interface TradeFpML_cd_11 extends Validator<Trade> {
	...
	class Default implements TradeFpML_cd_11 {
	...
	class NoOp implements TradeFpML_cd_11 {
