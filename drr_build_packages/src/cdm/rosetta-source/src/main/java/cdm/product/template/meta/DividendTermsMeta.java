...
public class DividendTermsMeta implements RosettaMetaData<DividendTerms> {
	...
	@Override
	public Validator<? super DividendTerms> validator(ValidatorFactory factory) {
		return factory.<DividendTerms>create(DividendTermsValidator.class);
	}

	@Override
	public Validator<? super DividendTerms> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DividendTerms>create(DividendTermsTypeFormatValidator.class);
	}
