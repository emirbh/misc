...
@ImplementedBy(Qualify_ForeignExchange_NDS.Qualify_ForeignExchange_NDSDefault.class)
public abstract class Qualify_ForeignExchange_NDS implements RosettaFunction,IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static class Qualify_ForeignExchange_NDSDefault extends Qualify_ForeignExchange_NDS {
		@Override
