 ...
 * @version 6.23.0
 */
@RosettaDataType(value="TimeZone", builder=TimeZone.TimeZoneBuilderImpl.class, version="6.23.0")
@RuneDataType(value="TimeZone", model="cdm", builder=TimeZone.TimeZoneBuilderImpl.class, version="6.23.0")
public interface TimeZone extends RosettaModelObject {
	...
	class TimeZoneBuilderImpl implements TimeZone.TimeZoneBuilder {
		...
		@RuneAttribute("location")
		@Override
		public TimeZone.TimeZoneBuilder setLocation(FieldWithMetaString _location) {
			this.location = _location == null ? null : _location.toBuilder();
			return this;
		}
		
		@Override
		public TimeZone.TimeZoneBuilder setLocationValue(String _location) {
			this.getOrCreateLocation().setValue(_location);
			return this;
		}
