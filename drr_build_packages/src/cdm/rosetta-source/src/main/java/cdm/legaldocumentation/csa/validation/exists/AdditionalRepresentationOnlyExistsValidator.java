...
public class AdditionalRepresentationOnlyExistsValidator implements ValidatorWithArg<AdditionalRepresentation, Set<String>> {
	...
	public <T2 extends AdditionalRepresentation> ValidationResult<AdditionalRepresentation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("partyElection", ExistenceChecker.isSet((List<? extends AdditionalRepresentationElection>) o.getPartyElection()))
		...
		if (setFields.equals(fields)) {
			return success("AdditionalRepresentation", ValidationResult.ValidationType.ONLY_EXISTS, "AdditionalRepresentation", path, "");
		}
		return failure("AdditionalRepresentation", ValidationResult.ValidationType.ONLY_EXISTS, "AdditionalRepresentation", path, "",
