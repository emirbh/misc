 ...
 * @version 6.23.0
 */
@RosettaDataType(value="VolatilityCapFloor", builder=VolatilityCapFloor.VolatilityCapFloorBuilderImpl.class, version="6.23.0")
@RuneDataType(value="VolatilityCapFloor", model="cdm", builder=VolatilityCapFloor.VolatilityCapFloorBuilderImpl.class, version="6.23.0")
public interface VolatilityCapFloor extends RosettaModelObject {
	...
	class VolatilityCapFloorBuilderImpl implements VolatilityCapFloor.VolatilityCapFloorBuilder {
		...
		@RuneAttribute("applicable")
		@Override
		public VolatilityCapFloor.VolatilityCapFloorBuilder setApplicable(Boolean _applicable) {
		...
		@RuneAttribute("totalVolatilityCap")
		@Override
		public VolatilityCapFloor.VolatilityCapFloorBuilder setTotalVolatilityCap(BigDecimal _totalVolatilityCap) {
		...
		@RuneAttribute("volatilityCapFactor")
		@Override
		public VolatilityCapFloor.VolatilityCapFloorBuilder setVolatilityCapFactor(BigDecimal _volatilityCapFactor) {
