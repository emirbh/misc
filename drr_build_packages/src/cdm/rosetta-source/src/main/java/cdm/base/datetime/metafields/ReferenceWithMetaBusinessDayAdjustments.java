...
@RuneDataType(value="ReferenceWithMetaBusinessDayAdjustments", model="cdm", builder=ReferenceWithMetaBusinessDayAdjustments.ReferenceWithMetaBusinessDayAdjustmentsBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaBusinessDayAdjustments extends RosettaModelObject, ReferenceWithMeta<BusinessDayAdjustments> {
	...
	class ReferenceWithMetaBusinessDayAdjustmentsBuilderImpl implements ReferenceWithMetaBusinessDayAdjustments.ReferenceWithMetaBusinessDayAdjustmentsBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaBusinessDayAdjustments.ReferenceWithMetaBusinessDayAdjustmentsBuilder setValue(BusinessDayAdjustments _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaBusinessDayAdjustments.ReferenceWithMetaBusinessDayAdjustmentsBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaBusinessDayAdjustments.ReferenceWithMetaBusinessDayAdjustmentsBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaBusinessDayAdjustments.ReferenceWithMetaBusinessDayAdjustmentsBuilder setReference(Reference _reference) {
