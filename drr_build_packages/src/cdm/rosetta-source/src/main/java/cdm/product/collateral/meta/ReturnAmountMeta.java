...
import cdm.product.collateral.validation.datarule.ReturnAmountCustomElection;
...
public class ReturnAmountMeta implements RosettaMetaData<ReturnAmount> {
	...
	public List<Validator<? super ReturnAmount>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<ReturnAmount>create(ReturnAmountCustomElection.class)
		);
	}
	...
	@Override
	public Validator<? super ReturnAmount> validator(ValidatorFactory factory) {
		return factory.<ReturnAmount>create(ReturnAmountValidator.class);
	}

	@Override
	public Validator<? super ReturnAmount> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ReturnAmount>create(ReturnAmountTypeFormatValidator.class);
	}
