...
import cdm.event.common.validation.datarule.TermsChangeInstructionAtLeastOneOf;
...
public class TermsChangeInstructionMeta implements RosettaMetaData<TermsChangeInstruction> {
	...
	public List<Validator<? super TermsChangeInstruction>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<TermsChangeInstruction>create(TermsChangeInstructionAtLeastOneOf.class)
		);
	}
	...
	@Override
	public Validator<? super TermsChangeInstruction> validator(ValidatorFactory factory) {
		return factory.<TermsChangeInstruction>create(TermsChangeInstructionValidator.class);
	}

	@Override
	public Validator<? super TermsChangeInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<TermsChangeInstruction>create(TermsChangeInstructionTypeFormatValidator.class);
	}
