...
public class PrimitiveInstructionMeta implements RosettaMetaData<PrimitiveInstruction> {
	...
	@Override
	public Validator<? super PrimitiveInstruction> validator(ValidatorFactory factory) {
		return factory.<PrimitiveInstruction>create(PrimitiveInstructionValidator.class);
	}

	@Override
	public Validator<? super PrimitiveInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PrimitiveInstruction>create(PrimitiveInstructionTypeFormatValidator.class);
	}
