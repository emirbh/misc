...
import cdm.base.staticdata.asset.common.validation.datarule.InstrumentChoice;
...
public class InstrumentMeta implements RosettaMetaData<Instrument> {
	...
	public List<Validator<? super Instrument>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<Instrument>create(InstrumentChoice.class)
		);
	}
	...
	@Override
	public Validator<? super Instrument> validator(ValidatorFactory factory) {
		return factory.<Instrument>create(InstrumentValidator.class);
	}

	@Override
	public Validator<? super Instrument> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Instrument>create(InstrumentTypeFormatValidator.class);
	}
