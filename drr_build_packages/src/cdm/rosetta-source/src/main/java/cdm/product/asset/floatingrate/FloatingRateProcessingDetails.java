 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FloatingRateProcessingDetails", builder=FloatingRateProcessingDetails.FloatingRateProcessingDetailsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FloatingRateProcessingDetails", model="cdm", builder=FloatingRateProcessingDetails.FloatingRateProcessingDetailsBuilderImpl.class, version="6.23.0")
public interface FloatingRateProcessingDetails extends RosettaModelObject {
	...
	class FloatingRateProcessingDetailsImpl implements FloatingRateProcessingDetails {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("processingParameters")
		...
		@Accessor(AccessorType.GETTER)
		@Required
		@RuneAttribute("spreadExclusiveRate")
	...
	class FloatingRateProcessingDetailsBuilderImpl implements FloatingRateProcessingDetails.FloatingRateProcessingDetailsBuilder {
		...
		@RuneAttribute("rawRate")
		@Override
		public FloatingRateProcessingDetails.FloatingRateProcessingDetailsBuilder setRawRate(BigDecimal _rawRate) {
		...
		@RuneAttribute("processingParameters")
		@Override
		public FloatingRateProcessingDetails.FloatingRateProcessingDetailsBuilder setProcessingParameters(FloatingRateProcessingParameters _processingParameters) {
		...
		@RuneAttribute("processedRate")
		@Override
		public FloatingRateProcessingDetails.FloatingRateProcessingDetailsBuilder setProcessedRate(BigDecimal _processedRate) {
		...
		@RuneAttribute("spreadExclusiveRate")
		@Override
		public FloatingRateProcessingDetails.FloatingRateProcessingDetailsBuilder setSpreadExclusiveRate(BigDecimal _spreadExclusiveRate) {
