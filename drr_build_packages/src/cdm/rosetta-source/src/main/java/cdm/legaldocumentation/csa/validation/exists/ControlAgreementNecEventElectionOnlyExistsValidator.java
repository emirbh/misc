...
public class ControlAgreementNecEventElectionOnlyExistsValidator implements ValidatorWithArg<ControlAgreementNecEventElection, Set<String>> {
	...
	public <T2 extends ControlAgreementNecEventElection> ValidationResult<ControlAgreementNecEventElection> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("necEvent", ExistenceChecker.isSet((Boolean) o.getNecEvent()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ControlAgreementNecEventElection", ValidationResult.ValidationType.ONLY_EXISTS, "ControlAgreementNecEventElection", path, "");
		}
		return failure("ControlAgreementNecEventElection", ValidationResult.ValidationType.ONLY_EXISTS, "ControlAgreementNecEventElection", path, "",
