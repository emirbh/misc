...
public class FinalCalculationPeriodDateAdjustmentOnlyExistsValidator implements ValidatorWithArg<FinalCalculationPeriodDateAdjustment, Set<String>> {
	...
	public <T2 extends FinalCalculationPeriodDateAdjustment> ValidationResult<FinalCalculationPeriodDateAdjustment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("swapStreamReference", ExistenceChecker.isSet((ReferenceWithMetaPayout) o.getSwapStreamReference()))
		...
		if (setFields.equals(fields)) {
			return success("FinalCalculationPeriodDateAdjustment", ValidationResult.ValidationType.ONLY_EXISTS, "FinalCalculationPeriodDateAdjustment", path, "");
		}
		return failure("FinalCalculationPeriodDateAdjustment", ValidationResult.ValidationType.ONLY_EXISTS, "FinalCalculationPeriodDateAdjustment", path, "",
