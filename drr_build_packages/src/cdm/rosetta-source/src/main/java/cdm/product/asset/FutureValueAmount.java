 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FutureValueAmount", builder=FutureValueAmount.FutureValueAmountBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FutureValueAmount", model="cdm", builder=FutureValueAmount.FutureValueAmountBuilderImpl.class, version="6.23.0")
public interface FutureValueAmount extends RosettaModelObject {
	...
	interface FutureValueAmountBuilder extends FutureValueAmount, RosettaModelObjectBuilder {
		...
		FutureValueAmount.FutureValueAmountBuilder setQuantity(ReferenceWithMetaNonNegativeQuantitySchedule quantity);
		FutureValueAmount.FutureValueAmountBuilder setQuantityValue(NonNegativeQuantitySchedule quantity);
	...
	class FutureValueAmountBuilderImpl implements FutureValueAmount.FutureValueAmountBuilder {
		...
		@RuneScopedAttributeReference
		@Override
		public FutureValueAmount.FutureValueAmountBuilder setQuantity(ReferenceWithMetaNonNegativeQuantitySchedule _quantity) {
			this.quantity = _quantity == null ? null : _quantity.toBuilder();
			return this;
		}
		
		@Override
		public FutureValueAmount.FutureValueAmountBuilder setQuantityValue(NonNegativeQuantitySchedule _quantity) {
		...
		@RuneAttribute("currency")
		@Override
		public FutureValueAmount.FutureValueAmountBuilder setCurrency(FieldWithMetaString _currency) {
			this.currency = _currency == null ? null : _currency.toBuilder();
			return this;
		}
		
		@Override
		public FutureValueAmount.FutureValueAmountBuilder setCurrencyValue(String _currency) {
		...
		@RuneAttribute("valueDate")
		@Override
		public FutureValueAmount.FutureValueAmountBuilder setValueDate(Date _valueDate) {
