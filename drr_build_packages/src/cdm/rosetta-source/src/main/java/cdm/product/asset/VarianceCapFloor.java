 ...
 * @version 6.23.0
 */
@RosettaDataType(value="VarianceCapFloor", builder=VarianceCapFloor.VarianceCapFloorBuilderImpl.class, version="6.23.0")
@RuneDataType(value="VarianceCapFloor", model="cdm", builder=VarianceCapFloor.VarianceCapFloorBuilderImpl.class, version="6.23.0")
public interface VarianceCapFloor extends RosettaModelObject {
	...
	class VarianceCapFloorBuilderImpl implements VarianceCapFloor.VarianceCapFloorBuilder {
		...
		@RuneAttribute("varianceCap")
		@Override
		public VarianceCapFloor.VarianceCapFloorBuilder setVarianceCap(Boolean _varianceCap) {
		...
		@RuneAttribute("unadjustedVarianceCap")
		@Override
		public VarianceCapFloor.VarianceCapFloorBuilder setUnadjustedVarianceCap(BigDecimal _unadjustedVarianceCap) {
		...
		@RuneAttribute("boundedVariance")
		@Override
		public VarianceCapFloor.VarianceCapFloorBuilder setBoundedVariance(BoundedVariance _boundedVariance) {
