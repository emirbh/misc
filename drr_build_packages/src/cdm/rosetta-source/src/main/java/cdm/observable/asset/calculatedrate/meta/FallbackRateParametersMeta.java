...
public class FallbackRateParametersMeta implements RosettaMetaData<FallbackRateParameters> {
	...
	@Override
	public Validator<? super FallbackRateParameters> validator(ValidatorFactory factory) {
		return factory.<FallbackRateParameters>create(FallbackRateParametersValidator.class);
	}

	@Override
	public Validator<? super FallbackRateParameters> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FallbackRateParameters>create(FallbackRateParametersTypeFormatValidator.class);
	}
