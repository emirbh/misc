...
import cdm.base.datetime.validation.datarule.AdjustableRelativeOrPeriodicDatesAdjustableRelativeOrPeriodicDatesChoice;
...
public class AdjustableRelativeOrPeriodicDatesMeta implements RosettaMetaData<AdjustableRelativeOrPeriodicDates> {
	...
	public List<Validator<? super AdjustableRelativeOrPeriodicDates>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<AdjustableRelativeOrPeriodicDates>create(AdjustableRelativeOrPeriodicDatesAdjustableRelativeOrPeriodicDatesChoice.class)
		);
	}
