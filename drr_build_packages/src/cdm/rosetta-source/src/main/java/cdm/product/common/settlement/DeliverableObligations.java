 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DeliverableObligations", builder=DeliverableObligations.DeliverableObligationsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DeliverableObligations", model="cdm", builder=DeliverableObligations.DeliverableObligationsBuilderImpl.class, version="6.23.0")
