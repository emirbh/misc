...
public class PremiumExpressionMeta implements RosettaMetaData<PremiumExpression> {
	...
	@Override
	public Validator<? super PremiumExpression> validator(ValidatorFactory factory) {
		return factory.<PremiumExpression>create(PremiumExpressionValidator.class);
	}

	@Override
	public Validator<? super PremiumExpression> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PremiumExpression>create(PremiumExpressionTypeFormatValidator.class);
	}
