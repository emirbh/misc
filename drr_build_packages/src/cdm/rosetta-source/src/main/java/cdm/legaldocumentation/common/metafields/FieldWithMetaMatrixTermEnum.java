...
@RosettaDataType(value="FieldWithMetaMatrixTermEnum", builder=FieldWithMetaMatrixTermEnum.FieldWithMetaMatrixTermEnumBuilderImpl.class, version="0.0.0")
@RuneDataType(value="FieldWithMetaMatrixTermEnum", model="cdm", builder=FieldWithMetaMatrixTermEnum.FieldWithMetaMatrixTermEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaMatrixTermEnum extends RosettaModelObject, FieldWithMeta<MatrixTermEnum>, GlobalKey {

	FieldWithMetaMatrixTermEnumMeta metaData = new FieldWithMetaMatrixTermEnumMeta();
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaMatrixTermEnumBuilder extends FieldWithMetaMatrixTermEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<MatrixTermEnum>, GlobalKey.GlobalKeyBuilder {
		...
		FieldWithMetaMatrixTermEnum.FieldWithMetaMatrixTermEnumBuilder prune();
	}
	...
	class FieldWithMetaMatrixTermEnumBuilderImpl implements FieldWithMetaMatrixTermEnum.FieldWithMetaMatrixTermEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaMatrixTermEnum.FieldWithMetaMatrixTermEnumBuilder setValue(MatrixTermEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaMatrixTermEnum.FieldWithMetaMatrixTermEnumBuilder setMeta(MetaFields _meta) {
