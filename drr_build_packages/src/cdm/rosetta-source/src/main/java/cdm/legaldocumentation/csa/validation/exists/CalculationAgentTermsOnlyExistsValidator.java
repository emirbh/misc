...
public class CalculationAgentTermsOnlyExistsValidator implements ValidatorWithArg<CalculationAgentTerms, Set<String>> {
	...
	public <T2 extends CalculationAgentTerms> ValidationResult<CalculationAgentTerms> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("bespokeCalculationAgentTerms", ExistenceChecker.isSet((String) o.getBespokeCalculationAgentTerms()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CalculationAgentTerms", ValidationResult.ValidationType.ONLY_EXISTS, "CalculationAgentTerms", path, "");
		}
		return failure("CalculationAgentTerms", ValidationResult.ValidationType.ONLY_EXISTS, "CalculationAgentTerms", path, "",
