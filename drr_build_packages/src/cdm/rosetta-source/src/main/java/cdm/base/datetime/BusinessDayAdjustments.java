 ...
 * @version 6.23.0
 */
@RosettaDataType(value="BusinessDayAdjustments", builder=BusinessDayAdjustments.BusinessDayAdjustmentsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="BusinessDayAdjustments", model="cdm", builder=BusinessDayAdjustments.BusinessDayAdjustmentsBuilderImpl.class, version="6.23.0")
