		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("InflationRateSpecification", ValidationResult.ValidationType.TYPE_FORMAT, "InflationRateSpecification", path, "", res.getError());
				}
				return success("InflationRateSpecification", ValidationResult.ValidationType.TYPE_FORMAT, "InflationRateSpecification", path, "");
			})
			.collect(toList());
	}
