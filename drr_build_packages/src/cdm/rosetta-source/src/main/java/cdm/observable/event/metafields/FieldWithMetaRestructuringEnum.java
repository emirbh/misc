...
@RuneDataType(value="FieldWithMetaRestructuringEnum", model="cdm", builder=FieldWithMetaRestructuringEnum.FieldWithMetaRestructuringEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaRestructuringEnum extends RosettaModelObject, FieldWithMeta<RestructuringEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaRestructuringEnumBuilder extends FieldWithMetaRestructuringEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<RestructuringEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaRestructuringEnumBuilderImpl implements FieldWithMetaRestructuringEnum.FieldWithMetaRestructuringEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaRestructuringEnum.FieldWithMetaRestructuringEnumBuilder setValue(RestructuringEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaRestructuringEnum.FieldWithMetaRestructuringEnumBuilder setMeta(MetaFields _meta) {
