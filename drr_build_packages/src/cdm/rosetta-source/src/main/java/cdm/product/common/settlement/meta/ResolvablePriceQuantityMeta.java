...
import cdm.product.common.settlement.validation.datarule.ResolvablePriceQuantityQuantityMultiplier;
...
public class ResolvablePriceQuantityMeta implements RosettaMetaData<ResolvablePriceQuantity> {
	...
	public List<Validator<? super ResolvablePriceQuantity>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<ResolvablePriceQuantity>create(ResolvablePriceQuantityQuantityMultiplier.class)
		);
	}
	...
	@Override
	public Validator<? super ResolvablePriceQuantity> validator(ValidatorFactory factory) {
		return factory.<ResolvablePriceQuantity>create(ResolvablePriceQuantityValidator.class);
	}

	@Override
	public Validator<? super ResolvablePriceQuantity> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ResolvablePriceQuantity>create(ResolvablePriceQuantityTypeFormatValidator.class);
	}
