 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ValuationTerms", builder=ValuationTerms.ValuationTermsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ValuationTerms", model="cdm", builder=ValuationTerms.ValuationTermsBuilderImpl.class, version="6.23.0")
