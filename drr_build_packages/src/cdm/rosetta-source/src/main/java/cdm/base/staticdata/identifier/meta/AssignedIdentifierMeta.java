...
public class AssignedIdentifierMeta implements RosettaMetaData<AssignedIdentifier> {
	...
	@Override
	public Validator<? super AssignedIdentifier> validator(ValidatorFactory factory) {
		return factory.<AssignedIdentifier>create(AssignedIdentifierValidator.class);
	}

	@Override
	public Validator<? super AssignedIdentifier> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssignedIdentifier>create(AssignedIdentifierTypeFormatValidator.class);
	}
