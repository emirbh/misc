...
public class SpecialPurposeVehicleIssuerTypeMeta implements RosettaMetaData<SpecialPurposeVehicleIssuerType> {
	...
	@Override
	public Validator<? super SpecialPurposeVehicleIssuerType> validator(ValidatorFactory factory) {
		return factory.<SpecialPurposeVehicleIssuerType>create(SpecialPurposeVehicleIssuerTypeValidator.class);
	}

	@Override
	public Validator<? super SpecialPurposeVehicleIssuerType> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SpecialPurposeVehicleIssuerType>create(SpecialPurposeVehicleIssuerTypeTypeFormatValidator.class);
	}
