...
public class IssuerCountryOfOriginMeta implements RosettaMetaData<IssuerCountryOfOrigin> {
	...
	@Override
	public Validator<? super IssuerCountryOfOrigin> validator(ValidatorFactory factory) {
		return factory.<IssuerCountryOfOrigin>create(IssuerCountryOfOriginValidator.class);
	}

	@Override
	public Validator<? super IssuerCountryOfOrigin> typeFormatValidator(ValidatorFactory factory) {
		return factory.<IssuerCountryOfOrigin>create(IssuerCountryOfOriginTypeFormatValidator.class);
	}
