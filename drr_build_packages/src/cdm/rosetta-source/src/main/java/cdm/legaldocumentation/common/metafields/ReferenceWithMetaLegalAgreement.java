...
@RosettaDataType(value="ReferenceWithMetaLegalAgreement", builder=ReferenceWithMetaLegalAgreement.ReferenceWithMetaLegalAgreementBuilderImpl.class, version="0.0.0")
@RuneDataType(value="ReferenceWithMetaLegalAgreement", model="cdm", builder=ReferenceWithMetaLegalAgreement.ReferenceWithMetaLegalAgreementBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaLegalAgreement extends RosettaModelObject, ReferenceWithMeta<LegalAgreement> {

	ReferenceWithMetaLegalAgreementMeta metaData = new ReferenceWithMetaLegalAgreementMeta();
	...
	/*********************** Builder Interface  ***********************/
	interface ReferenceWithMetaLegalAgreementBuilder extends ReferenceWithMetaLegalAgreement, RosettaModelObjectBuilder, ReferenceWithMeta.ReferenceWithMetaBuilder<LegalAgreement> {
		...
		ReferenceWithMetaLegalAgreement.ReferenceWithMetaLegalAgreementBuilder prune();
	}
	...
	class ReferenceWithMetaLegalAgreementBuilderImpl implements ReferenceWithMetaLegalAgreement.ReferenceWithMetaLegalAgreementBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaLegalAgreement.ReferenceWithMetaLegalAgreementBuilder setValue(LegalAgreement _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaLegalAgreement.ReferenceWithMetaLegalAgreementBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaLegalAgreement.ReferenceWithMetaLegalAgreementBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaLegalAgreement.ReferenceWithMetaLegalAgreementBuilder setReference(Reference _reference) {
