...
public class UndrlygInstrmMeta implements RosettaMetaData<UndrlygInstrm> {
	...
	@Override
	public Validator<? super UndrlygInstrm> validator(ValidatorFactory factory) {
		return factory.<UndrlygInstrm>create(UndrlygInstrmValidator.class);
	}

	@Override
	public Validator<? super UndrlygInstrm> typeFormatValidator(ValidatorFactory factory) {
		return factory.<UndrlygInstrm>create(UndrlygInstrmTypeFormatValidator.class);
	}
