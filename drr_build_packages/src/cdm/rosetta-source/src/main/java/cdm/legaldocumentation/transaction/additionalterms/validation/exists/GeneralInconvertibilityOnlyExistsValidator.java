...
public class GeneralInconvertibilityOnlyExistsValidator implements ValidatorWithArg<GeneralInconvertibility, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends GeneralInconvertibility> ValidationResult<GeneralInconvertibility> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("generalInconvertibilityIsApplicable", ExistenceChecker.isSet((Boolean) o.getGeneralInconvertibilityIsApplicable()))
		...
		if (setFields.equals(fields)) {
			return success("GeneralInconvertibility", ValidationResult.ValidationType.ONLY_EXISTS, "GeneralInconvertibility", path, "");
		}
		return failure("GeneralInconvertibility", ValidationResult.ValidationType.ONLY_EXISTS, "GeneralInconvertibility", path, "",
