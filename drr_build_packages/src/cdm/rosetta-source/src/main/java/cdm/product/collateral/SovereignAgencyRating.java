 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SovereignAgencyRating", builder=SovereignAgencyRating.SovereignAgencyRatingBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SovereignAgencyRating", model="cdm", builder=SovereignAgencyRating.SovereignAgencyRatingBuilderImpl.class, version="6.23.0")
