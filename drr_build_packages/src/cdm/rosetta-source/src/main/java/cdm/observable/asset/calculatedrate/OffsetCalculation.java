 ...
 * @version 6.23.0
 */
@RosettaDataType(value="OffsetCalculation", builder=OffsetCalculation.OffsetCalculationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="OffsetCalculation", model="cdm", builder=OffsetCalculation.OffsetCalculationBuilderImpl.class, version="6.23.0")
public interface OffsetCalculation extends RosettaModelObject {
	...
	class OffsetCalculationBuilderImpl implements OffsetCalculation.OffsetCalculationBuilder {
		...
		@RuneAttribute("offsetDays")
		@Override
		public OffsetCalculation.OffsetCalculationBuilder setOffsetDays(Integer _offsetDays) {
