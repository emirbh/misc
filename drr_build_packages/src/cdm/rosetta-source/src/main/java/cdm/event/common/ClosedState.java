...
import cdm.event.common.meta.ClosedStateMeta;
 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ClosedState", builder=ClosedState.ClosedStateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ClosedState", model="cdm", builder=ClosedState.ClosedStateBuilderImpl.class, version="6.23.0")
public interface ClosedState extends RosettaModelObject {
	...
	class ClosedStateBuilderImpl implements ClosedState.ClosedStateBuilder {
		...
		@RuneAttribute("state")
		@Override
		public ClosedState.ClosedStateBuilder setState(ClosedStateEnum _state) {
		...
		@RuneAttribute("activityDate")
		@Override
		public ClosedState.ClosedStateBuilder setActivityDate(Date _activityDate) {
			this.activityDate = _activityDate == null ? null : _activityDate;
			return this;
		}
		...
		@RuneAttribute("effectiveDate")
		@Override
		public ClosedState.ClosedStateBuilder setEffectiveDate(Date _effectiveDate) {
		...
		@RuneAttribute("lastPaymentDate")
		@Override
		public ClosedState.ClosedStateBuilder setLastPaymentDate(Date _lastPaymentDate) {
			this.lastPaymentDate = _lastPaymentDate == null ? null : _lastPaymentDate;
			return this;
		}
