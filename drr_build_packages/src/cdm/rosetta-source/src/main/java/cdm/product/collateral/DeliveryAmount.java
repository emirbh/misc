 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DeliveryAmount", builder=DeliveryAmount.DeliveryAmountBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DeliveryAmount", model="cdm", builder=DeliveryAmount.DeliveryAmountBuilderImpl.class, version="6.23.0")
public interface DeliveryAmount extends RosettaModelObject {
	...
	class DeliveryAmountBuilderImpl implements DeliveryAmount.DeliveryAmountBuilder {
		...
		@RuneAttribute("standardElection")
		@Override
		public DeliveryAmount.DeliveryAmountBuilder setStandardElection(DeliveryAmountElectionEnum _standardElection) {
		...
		@RuneAttribute("customElection")
		@Override
		public DeliveryAmount.DeliveryAmountBuilder setCustomElection(String _customElection) {
