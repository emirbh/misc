 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FxRate", builder=FxRate.FxRateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FxRate", model="cdm", builder=FxRate.FxRateBuilderImpl.class, version="6.23.0")
