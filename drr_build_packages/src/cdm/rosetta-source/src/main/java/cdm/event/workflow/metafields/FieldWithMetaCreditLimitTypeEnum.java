...
@RuneDataType(value="FieldWithMetaCreditLimitTypeEnum", model="cdm", builder=FieldWithMetaCreditLimitTypeEnum.FieldWithMetaCreditLimitTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaCreditLimitTypeEnum extends RosettaModelObject, FieldWithMeta<CreditLimitTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaCreditLimitTypeEnumBuilder extends FieldWithMetaCreditLimitTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<CreditLimitTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaCreditLimitTypeEnumBuilderImpl implements FieldWithMetaCreditLimitTypeEnum.FieldWithMetaCreditLimitTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaCreditLimitTypeEnum.FieldWithMetaCreditLimitTypeEnumBuilder setValue(CreditLimitTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaCreditLimitTypeEnum.FieldWithMetaCreditLimitTypeEnumBuilder setMeta(MetaFields _meta) {
