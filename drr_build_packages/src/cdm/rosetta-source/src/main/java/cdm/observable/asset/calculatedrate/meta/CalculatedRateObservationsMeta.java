...
public class CalculatedRateObservationsMeta implements RosettaMetaData<CalculatedRateObservations> {
	...
	@Override
	public Validator<? super CalculatedRateObservations> validator(ValidatorFactory factory) {
		return factory.<CalculatedRateObservations>create(CalculatedRateObservationsValidator.class);
	}

	@Override
	public Validator<? super CalculatedRateObservations> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CalculatedRateObservations>create(CalculatedRateObservationsTypeFormatValidator.class);
	}
