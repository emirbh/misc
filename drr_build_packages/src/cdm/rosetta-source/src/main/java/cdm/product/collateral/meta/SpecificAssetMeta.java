...
public class SpecificAssetMeta implements RosettaMetaData<SpecificAsset> {
	...
	@Override
	public Validator<? super SpecificAsset> validator(ValidatorFactory factory) {
		return factory.<SpecificAsset>create(SpecificAssetValidator.class);
	}

	@Override
	public Validator<? super SpecificAsset> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SpecificAsset>create(SpecificAssetTypeFormatValidator.class);
	}
