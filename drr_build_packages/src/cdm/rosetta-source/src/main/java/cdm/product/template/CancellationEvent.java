 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CancellationEvent", builder=CancellationEvent.CancellationEventBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CancellationEvent", model="cdm", builder=CancellationEvent.CancellationEventBuilderImpl.class, version="6.23.0")
