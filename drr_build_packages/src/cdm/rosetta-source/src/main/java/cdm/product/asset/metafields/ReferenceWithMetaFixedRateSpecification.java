...
@RuneDataType(value="ReferenceWithMetaFixedRateSpecification", model="cdm", builder=ReferenceWithMetaFixedRateSpecification.ReferenceWithMetaFixedRateSpecificationBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaFixedRateSpecification extends RosettaModelObject, ReferenceWithMeta<FixedRateSpecification> {
	...
	class ReferenceWithMetaFixedRateSpecificationBuilderImpl implements ReferenceWithMetaFixedRateSpecification.ReferenceWithMetaFixedRateSpecificationBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaFixedRateSpecification.ReferenceWithMetaFixedRateSpecificationBuilder setValue(FixedRateSpecification _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaFixedRateSpecification.ReferenceWithMetaFixedRateSpecificationBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaFixedRateSpecification.ReferenceWithMetaFixedRateSpecificationBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaFixedRateSpecification.ReferenceWithMetaFixedRateSpecificationBuilder setReference(Reference _reference) {
