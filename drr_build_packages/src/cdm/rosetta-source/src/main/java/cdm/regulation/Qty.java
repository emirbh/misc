 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Qty", builder=Qty.QtyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Qty", model="cdm", builder=Qty.QtyBuilderImpl.class, version="6.23.0")
public interface Qty extends RosettaModelObject {
	...
	class QtyBuilderImpl implements Qty.QtyBuilder {
		...
		@RuneAttribute("unit")
		@Override
		public Qty.QtyBuilder setUnit(String _unit) {
