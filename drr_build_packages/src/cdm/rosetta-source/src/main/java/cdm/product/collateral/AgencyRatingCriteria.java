 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AgencyRatingCriteria", builder=AgencyRatingCriteria.AgencyRatingCriteriaBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AgencyRatingCriteria", model="cdm", builder=AgencyRatingCriteria.AgencyRatingCriteriaBuilderImpl.class, version="6.23.0")
