 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DividendTerms", builder=DividendTerms.DividendTermsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DividendTerms", model="cdm", builder=DividendTerms.DividendTermsBuilderImpl.class, version="6.23.0")
public interface DividendTerms extends RosettaModelObject {
	...
	class DividendTermsImpl implements DividendTerms {
		...
		@Required
		@RuneAttribute("manufacturedIncomeRequirement")
	...
	class DividendTermsBuilderImpl implements DividendTerms.DividendTermsBuilder {
		...
		@RuneAttribute("manufacturedIncomeRequirement")
		@Override
		public DividendTerms.DividendTermsBuilder setManufacturedIncomeRequirement(DividendPayoutRatio _manufacturedIncomeRequirement) {
			this.manufacturedIncomeRequirement = _manufacturedIncomeRequirement == null ? null : _manufacturedIncomeRequirement.toBuilder();
			return this;
		}
		...
		@RuneAttribute("dividendEntitlement")
		@Override
		public DividendTerms.DividendTermsBuilder setDividendEntitlement(DividendEntitlementEnum _dividendEntitlement) {
		...
		@RuneAttribute("minimumBillingAmount")
		@Override
		public DividendTerms.DividendTermsBuilder setMinimumBillingAmount(Money _minimumBillingAmount) {
