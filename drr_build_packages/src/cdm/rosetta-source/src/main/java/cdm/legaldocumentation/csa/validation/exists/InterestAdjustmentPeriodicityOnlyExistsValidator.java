...
public class InterestAdjustmentPeriodicityOnlyExistsValidator implements ValidatorWithArg<InterestAdjustmentPeriodicity, Set<String>> {
	...
	public <T2 extends InterestAdjustmentPeriodicity> ValidationResult<InterestAdjustmentPeriodicity> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("standardElection", ExistenceChecker.isSet((InterestAdjustmentPeriodicityEnum) o.getStandardElection()))
		...
		if (setFields.equals(fields)) {
			return success("InterestAdjustmentPeriodicity", ValidationResult.ValidationType.ONLY_EXISTS, "InterestAdjustmentPeriodicity", path, "");
		}
		return failure("InterestAdjustmentPeriodicity", ValidationResult.ValidationType.ONLY_EXISTS, "InterestAdjustmentPeriodicity", path, "",
