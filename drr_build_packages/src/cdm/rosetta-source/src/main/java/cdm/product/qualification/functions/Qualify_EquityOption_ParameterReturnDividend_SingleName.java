...
@ImplementedBy(Qualify_EquityOption_ParameterReturnDividend_SingleName.Qualify_EquityOption_ParameterReturnDividend_SingleNameDefault.class)
public abstract class Qualify_EquityOption_ParameterReturnDividend_SingleName implements RosettaFunction,IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static class Qualify_EquityOption_ParameterReturnDividend_SingleNameDefault extends Qualify_EquityOption_ParameterReturnDividend_SingleName {
		@Override
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = exists(MapperS.of(MapperS.of(economicTerms).<Payout>mapC("getPayout", _economicTerms -> _economicTerms.getPayout()).get()).<OptionPayout>map("getOptionPayout", payout -> payout.getOptionPayout())).andNullSafe(areEqual(MapperS.of(qualify_EquitySwap_ParameterReturnDividend_SingleName.evaluate(underlierEconomicTerms(economicTerms).get())), MapperS.of(true), CardinalityOperator.All)).get();
