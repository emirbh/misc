 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FloatingRateIndexIdentification", builder=FloatingRateIndexIdentification.FloatingRateIndexIdentificationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FloatingRateIndexIdentification", model="cdm", builder=FloatingRateIndexIdentification.FloatingRateIndexIdentificationBuilderImpl.class, version="6.23.0")
