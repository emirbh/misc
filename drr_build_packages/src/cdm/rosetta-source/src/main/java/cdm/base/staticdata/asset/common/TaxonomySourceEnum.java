...
public enum TaxonomySourceEnum {
	 ...
	 */
	@RosettaEnumValue(value = "EU_EMIR_EligibleCollateralAssetClass") 
	EU_EMIR_ELIGIBLE_COLLATERAL_ASSET_CLASS("EU_EMIR_EligibleCollateralAssetClass", null),
	 ...
	 */
	@RosettaEnumValue(value = "UK_EMIR_EligibleCollateralAssetClass") 
	UK_EMIR_ELIGIBLE_COLLATERAL_ASSET_CLASS("UK_EMIR_EligibleCollateralAssetClass", null),
	 ...
	 */
	@RosettaEnumValue(value = "US_CFTC_PR_EligibleCollateralAssetClass") 
	US_CFTC_PR_ELIGIBLE_COLLATERAL_ASSET_CLASS("US_CFTC_PR_EligibleCollateralAssetClass", null),
