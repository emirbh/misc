 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AdjustableOrAdjustedDate", builder=AdjustableOrAdjustedDate.AdjustableOrAdjustedDateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AdjustableOrAdjustedDate", model="cdm", builder=AdjustableOrAdjustedDate.AdjustableOrAdjustedDateBuilderImpl.class, version="6.23.0")
public interface AdjustableOrAdjustedDate extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface AdjustableOrAdjustedDateBuilder extends AdjustableOrAdjustedDate, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class AdjustableOrAdjustedDateBuilderImpl implements AdjustableOrAdjustedDate.AdjustableOrAdjustedDateBuilder {
		...
		@RuneAttribute("unadjustedDate")
		@Override
		public AdjustableOrAdjustedDate.AdjustableOrAdjustedDateBuilder setUnadjustedDate(Date _unadjustedDate) {
		...
		@RuneAttribute("adjustedDate")
		@Override
		public AdjustableOrAdjustedDate.AdjustableOrAdjustedDateBuilder setAdjustedDate(FieldWithMetaDate _adjustedDate) {
			this.adjustedDate = _adjustedDate == null ? null : _adjustedDate.toBuilder();
			return this;
		}
		
		@Override
		public AdjustableOrAdjustedDate.AdjustableOrAdjustedDateBuilder setAdjustedDateValue(Date _adjustedDate) {
		...
		@RuneMetaType
		@Override
		public AdjustableOrAdjustedDate.AdjustableOrAdjustedDateBuilder setMeta(MetaFields _meta) {
