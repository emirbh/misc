 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PeriodicDates", builder=PeriodicDates.PeriodicDatesBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PeriodicDates", model="cdm", builder=PeriodicDates.PeriodicDatesBuilderImpl.class, version="6.23.0")
public interface PeriodicDates extends RosettaModelObject {
	...
	class PeriodicDatesImpl implements PeriodicDates {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("periodDatesAdjustments")
	...
	class PeriodicDatesBuilderImpl implements PeriodicDates.PeriodicDatesBuilder {
		...
		@RuneAttribute("startDate")
		@Override
		public PeriodicDates.PeriodicDatesBuilder setStartDate(AdjustableOrRelativeDate _startDate) {
		...
		@RuneAttribute("endDate")
		@Override
		public PeriodicDates.PeriodicDatesBuilder setEndDate(AdjustableOrRelativeDate _endDate) {
		...
		@RuneAttribute("periodFrequency")
		@Override
		public PeriodicDates.PeriodicDatesBuilder setPeriodFrequency(CalculationPeriodFrequency _periodFrequency) {
			this.periodFrequency = _periodFrequency == null ? null : _periodFrequency.toBuilder();
			return this;
		}
		...
		@RuneAttribute("periodDatesAdjustments")
		@Override
		public PeriodicDates.PeriodicDatesBuilder setPeriodDatesAdjustments(BusinessDayAdjustments _periodDatesAdjustments) {
			this.periodDatesAdjustments = _periodDatesAdjustments == null ? null : _periodDatesAdjustments.toBuilder();
			return this;
		}
		...
		@RuneAttribute("dayType")
		@Override
		public PeriodicDates.PeriodicDatesBuilder setDayType(DayTypeEnum _dayType) {
