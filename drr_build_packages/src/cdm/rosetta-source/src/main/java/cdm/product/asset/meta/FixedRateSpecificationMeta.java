...
public class FixedRateSpecificationMeta implements RosettaMetaData<FixedRateSpecification> {
	...
	@Override
	public Validator<? super FixedRateSpecification> validator(ValidatorFactory factory) {
		return factory.<FixedRateSpecification>create(FixedRateSpecificationValidator.class);
	}

	@Override
	public Validator<? super FixedRateSpecification> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FixedRateSpecification>create(FixedRateSpecificationTypeFormatValidator.class);
	}
