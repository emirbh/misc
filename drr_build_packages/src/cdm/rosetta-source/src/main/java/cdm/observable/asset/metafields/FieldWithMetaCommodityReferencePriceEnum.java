...
@RuneDataType(value="FieldWithMetaCommodityReferencePriceEnum", model="cdm", builder=FieldWithMetaCommodityReferencePriceEnum.FieldWithMetaCommodityReferencePriceEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaCommodityReferencePriceEnum extends RosettaModelObject, FieldWithMeta<CommodityReferencePriceEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaCommodityReferencePriceEnumBuilder extends FieldWithMetaCommodityReferencePriceEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<CommodityReferencePriceEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaCommodityReferencePriceEnumBuilderImpl implements FieldWithMetaCommodityReferencePriceEnum.FieldWithMetaCommodityReferencePriceEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaCommodityReferencePriceEnum.FieldWithMetaCommodityReferencePriceEnumBuilder setValue(CommodityReferencePriceEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaCommodityReferencePriceEnum.FieldWithMetaCommodityReferencePriceEnumBuilder setMeta(MetaFields _meta) {
