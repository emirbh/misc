...
public class IdMeta implements RosettaMetaData<Id> {
	...
	@Override
	public Validator<? super Id> validator(ValidatorFactory factory) {
		return factory.<Id>create(IdValidator.class);
	}

	@Override
	public Validator<? super Id> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Id>create(IdTypeFormatValidator.class);
	}
