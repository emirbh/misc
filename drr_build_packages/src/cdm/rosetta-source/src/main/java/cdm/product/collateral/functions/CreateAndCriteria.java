...
@ImplementedBy(CreateAndCriteria.CreateAndCriteriaDefault.class)
public abstract class CreateAndCriteria implements RosettaFunction {
	...
	*/
	...
	public static class CreateAndCriteriaDefault extends CreateAndCriteria {
		@Override
