...
public class AssetIdentifierMeta implements RosettaMetaData<AssetIdentifier> {
	...
	@Override
	public Validator<? super AssetIdentifier> validator(ValidatorFactory factory) {
		return factory.<AssetIdentifier>create(AssetIdentifierValidator.class);
	}

	@Override
	public Validator<? super AssetIdentifier> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssetIdentifier>create(AssetIdentifierTypeFormatValidator.class);
	}
