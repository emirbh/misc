...
public class ConcentrationLimitOnlyExistsValidator implements ValidatorWithArg<ConcentrationLimit, Set<String>> {
	...
	public <T2 extends ConcentrationLimit> ValidationResult<ConcentrationLimit> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("concentrationLimitCriteria", ExistenceChecker.isSet((ConcentrationLimitCriteria) o.getConcentrationLimitCriteria()))
		...
		if (setFields.equals(fields)) {
			return success("ConcentrationLimit", ValidationResult.ValidationType.ONLY_EXISTS, "ConcentrationLimit", path, "");
		}
		return failure("ConcentrationLimit", ValidationResult.ValidationType.ONLY_EXISTS, "ConcentrationLimit", path, "",
