 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ReferencePair", builder=ReferencePair.ReferencePairBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ReferencePair", model="cdm", builder=ReferencePair.ReferencePairBuilderImpl.class, version="6.23.0")
