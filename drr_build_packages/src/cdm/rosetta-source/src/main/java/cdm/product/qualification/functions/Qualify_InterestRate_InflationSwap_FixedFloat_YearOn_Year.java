	...
	*/
	...
	public static class Qualify_InterestRate_InflationSwap_FixedFloat_YearOn_YearDefault extends Qualify_InterestRate_InflationSwap_FixedFloat_YearOn_Year {
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = areEqual(MapperS.of(qualify_BaseProduct_Inflation.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All).andNullSafe(areEqual(MapperS.of(qualify_BaseProduct_CrossCurrency.evaluate(economicTerms)), MapperS.of(false), CardinalityOperator.All)).andNullSafe(areEqual(MapperS.of(qualify_SubProduct_FixedFloat.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All)).andNullSafe(areEqual(MapperS.of(qualify_Transaction_YoY.evaluate(economicTerms)), MapperS.of(true), CardinalityOperator.All)).get();
