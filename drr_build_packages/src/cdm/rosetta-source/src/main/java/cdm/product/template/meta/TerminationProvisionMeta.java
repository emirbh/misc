...
import cdm.product.template.validation.datarule.TerminationProvisionTerminationProvisionChoice;
...
public class TerminationProvisionMeta implements RosettaMetaData<TerminationProvision> {
	...
	public List<Validator<? super TerminationProvision>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<TerminationProvision>create(TerminationProvisionTerminationProvisionChoice.class)
		);
	}
	...
	@Override
	public Validator<? super TerminationProvision> validator(ValidatorFactory factory) {
		return factory.<TerminationProvision>create(TerminationProvisionValidator.class);
	}

	@Override
	public Validator<? super TerminationProvision> typeFormatValidator(ValidatorFactory factory) {
		return factory.<TerminationProvision>create(TerminationProvisionTypeFormatValidator.class);
	}
