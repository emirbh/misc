 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CalculationPeriodDates", builder=CalculationPeriodDates.CalculationPeriodDatesBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CalculationPeriodDates", model="cdm", builder=CalculationPeriodDates.CalculationPeriodDatesBuilderImpl.class, version="6.23.0")
public interface CalculationPeriodDates extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface CalculationPeriodDatesBuilder extends CalculationPeriodDates, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class CalculationPeriodDatesBuilderImpl implements CalculationPeriodDates.CalculationPeriodDatesBuilder {
		...
		@RuneAttribute("effectiveDate")
		@Override
		public CalculationPeriodDates.CalculationPeriodDatesBuilder setEffectiveDate(AdjustableOrRelativeDate _effectiveDate) {
		...
		@RuneAttribute("terminationDate")
		@Override
		public CalculationPeriodDates.CalculationPeriodDatesBuilder setTerminationDate(AdjustableOrRelativeDate _terminationDate) {
		...
		@RuneAttribute("firstPeriodStartDate")
		@Override
		public CalculationPeriodDates.CalculationPeriodDatesBuilder setFirstPeriodStartDate(AdjustableOrRelativeDate _firstPeriodStartDate) {
		...
		@RuneAttribute("firstRegularPeriodStartDate")
		@Override
		public CalculationPeriodDates.CalculationPeriodDatesBuilder setFirstRegularPeriodStartDate(Date _firstRegularPeriodStartDate) {
		...
		@RuneAttribute("firstCompoundingPeriodEndDate")
		@Override
		public CalculationPeriodDates.CalculationPeriodDatesBuilder setFirstCompoundingPeriodEndDate(Date _firstCompoundingPeriodEndDate) {
		...
		@RuneAttribute("lastRegularPeriodEndDate")
		@Override
		public CalculationPeriodDates.CalculationPeriodDatesBuilder setLastRegularPeriodEndDate(Date _lastRegularPeriodEndDate) {
		...
		@RuneMetaType
		@Override
		public CalculationPeriodDates.CalculationPeriodDatesBuilder setMeta(MetaFields _meta) {
