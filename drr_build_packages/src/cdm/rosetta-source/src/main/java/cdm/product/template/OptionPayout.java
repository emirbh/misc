 ...
 * @version 6.23.0
 */
@RosettaDataType(value="OptionPayout", builder=OptionPayout.OptionPayoutBuilderImpl.class, version="6.23.0")
@RuneDataType(value="OptionPayout", model="cdm", builder=OptionPayout.OptionPayoutBuilderImpl.class, version="6.23.0")
