...
import cdm.event.workflow.validation.datarule.LimitApplicableLimitApplicableChoice;
...
public class LimitApplicableExtendedMeta implements RosettaMetaData<LimitApplicableExtended> {
	...
	public List<Validator<? super LimitApplicableExtended>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<LimitApplicable>create(LimitApplicableLimitApplicableChoice.class)
		);
	}
	...
	@Override
	public Validator<? super LimitApplicableExtended> validator(ValidatorFactory factory) {
		return factory.<LimitApplicableExtended>create(LimitApplicableExtendedValidator.class);
	}

	@Override
	public Validator<? super LimitApplicableExtended> typeFormatValidator(ValidatorFactory factory) {
		return factory.<LimitApplicableExtended>create(LimitApplicableExtendedTypeFormatValidator.class);
	}
