...
public class AgreementOnlyExistsValidator implements ValidatorWithArg<Agreement, Set<String>> {
	...
	public <T2 extends Agreement> ValidationResult<Agreement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("masterAgreementElections", ExistenceChecker.isSet((MasterAgreementElections) o.getMasterAgreementElections()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Agreement", ValidationResult.ValidationType.ONLY_EXISTS, "Agreement", path, "");
		}
		return failure("Agreement", ValidationResult.ValidationType.ONLY_EXISTS, "Agreement", path, "",
