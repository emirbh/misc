...
@ImplementedBy(SpecifiedEntitySpecifiedEntity.Default.class)
public interface SpecifiedEntitySpecifiedEntity extends Validator<SpecifiedEntity> {
	
	String NAME = "SpecifiedEntitySpecifiedEntity";
	String DEFINITION = "if specifiedEntityTerms = SpecifiedEntityTermsEnum -> NamedSpecifiedEntity then specifiedEntity exists";
	
	class Default implements SpecifiedEntitySpecifiedEntity {
		...
		private ComparisonResult executeDataRule(SpecifiedEntity specifiedEntity) {
			try {
				if (areEqual(MapperS.of(specifiedEntity).<SpecifiedEntityTermsEnum>map("getSpecifiedEntityTerms", _specifiedEntity -> _specifiedEntity.getSpecifiedEntityTerms()), MapperS.of(SpecifiedEntityTermsEnum.NAMED_SPECIFIED_ENTITY), CardinalityOperator.All).getOrDefault(false)) {
	...
	class NoOp implements SpecifiedEntitySpecifiedEntity {
