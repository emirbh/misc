 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PersonIdentifier", builder=PersonIdentifier.PersonIdentifierBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PersonIdentifier", model="cdm", builder=PersonIdentifier.PersonIdentifierBuilderImpl.class, version="6.23.0")
