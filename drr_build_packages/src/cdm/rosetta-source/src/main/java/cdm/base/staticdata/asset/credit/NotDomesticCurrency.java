 ...
 * @version 6.23.0
 */
@RosettaDataType(value="NotDomesticCurrency", builder=NotDomesticCurrency.NotDomesticCurrencyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="NotDomesticCurrency", model="cdm", builder=NotDomesticCurrency.NotDomesticCurrencyBuilderImpl.class, version="6.23.0")
public interface NotDomesticCurrency extends RosettaModelObject {
	...
	class NotDomesticCurrencyBuilderImpl implements NotDomesticCurrency.NotDomesticCurrencyBuilder {
		...
		@RuneAttribute("currency")
		@Override
		public NotDomesticCurrency.NotDomesticCurrencyBuilder setCurrency(FieldWithMetaString _currency) {
			this.currency = _currency == null ? null : _currency.toBuilder();
			return this;
		}
		
		@Override
		public NotDomesticCurrency.NotDomesticCurrencyBuilder setCurrencyValue(String _currency) {
