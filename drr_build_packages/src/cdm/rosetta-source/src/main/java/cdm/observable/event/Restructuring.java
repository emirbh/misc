 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Restructuring", builder=Restructuring.RestructuringBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Restructuring", model="cdm", builder=Restructuring.RestructuringBuilderImpl.class, version="6.23.0")
