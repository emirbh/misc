		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MandatoryEarlyTerminationAdjustedDates", ValidationResult.ValidationType.TYPE_FORMAT, "MandatoryEarlyTerminationAdjustedDates", path, "", res.getError());
				}
				return success("MandatoryEarlyTerminationAdjustedDates", ValidationResult.ValidationType.TYPE_FORMAT, "MandatoryEarlyTerminationAdjustedDates", path, "");
			})
			.collect(toList());
	}
