...
@ImplementedBy(AppropriatedCollateralValuationNotSpecified.Default.class)
public interface AppropriatedCollateralValuationNotSpecified extends Validator<AppropriatedCollateralValuation> {
	
	String NAME = "AppropriatedCollateralValuationNotSpecified";
	String DEFINITION = "if isSpecified = False then election is absent";
	
	class Default implements AppropriatedCollateralValuationNotSpecified {
		...
		private ComparisonResult executeDataRule(AppropriatedCollateralValuation appropriatedCollateralValuation) {
			try {
				if (areEqual(MapperS.of(appropriatedCollateralValuation).<Boolean>map("getIsSpecified", _appropriatedCollateralValuation -> _appropriatedCollateralValuation.getIsSpecified()), MapperS.of(false), CardinalityOperator.All).getOrDefault(false)) {
	...
	class NoOp implements AppropriatedCollateralValuationNotSpecified {
