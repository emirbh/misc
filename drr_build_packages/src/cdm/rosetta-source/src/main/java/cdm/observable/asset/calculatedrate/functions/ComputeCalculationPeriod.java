...
public class ComputeCalculationPeriod implements RosettaFunction {
	...
	@ImplementedBy(ComputeCalculationPeriod.ComputeCalculationPeriodSET_IN_ADVANCE.ComputeCalculationPeriodSET_IN_ADVANCEDefault.class)
	public static abstract class ComputeCalculationPeriodSET_IN_ADVANCE implements RosettaFunction {
		...
		*/
		...
		public static class ComputeCalculationPeriodSET_IN_ADVANCEDefault extends ComputeCalculationPeriod.ComputeCalculationPeriodSET_IN_ADVANCE {
			@Override
	...
	@ImplementedBy(ComputeCalculationPeriod.ComputeCalculationPeriodSTANDARD.ComputeCalculationPeriodSTANDARDDefault.class)
	public static abstract class ComputeCalculationPeriodSTANDARD implements RosettaFunction {
		...
		*/
		...
		public static class ComputeCalculationPeriodSTANDARDDefault extends ComputeCalculationPeriod.ComputeCalculationPeriodSTANDARD {
			@Override
			protected CalculationPeriodBase.CalculationPeriodBaseBuilder doEvaluate(CalculationPeriodBase calculationPeriod, CalculationPeriodBase priorCalculationPeriod, ObservationPeriodDatesEnum calculateRelativeTo, ResetDates resetDates) {
				CalculationPeriodBase.CalculationPeriodBaseBuilder result = CalculationPeriodBase.builder();
				return assignOutput(result, calculationPeriod, priorCalculationPeriod, calculateRelativeTo, resetDates);
	...
	@ImplementedBy(ComputeCalculationPeriod.ComputeCalculationPeriodFIXING_DATE.ComputeCalculationPeriodFIXING_DATEDefault.class)
	public static abstract class ComputeCalculationPeriodFIXING_DATE implements RosettaFunction {
		...
		*/
		...
		public static class ComputeCalculationPeriodFIXING_DATEDefault extends ComputeCalculationPeriod.ComputeCalculationPeriodFIXING_DATE {
			@Override
			protected CalculationPeriodBase.CalculationPeriodBaseBuilder doEvaluate(CalculationPeriodBase calculationPeriod, CalculationPeriodBase priorCalculationPeriod, ObservationPeriodDatesEnum calculateRelativeTo, ResetDates resetDates) {
				CalculationPeriodBase.CalculationPeriodBaseBuilder result = CalculationPeriodBase.builder();
				return assignOutput(result, calculationPeriod, priorCalculationPeriod, calculateRelativeTo, resetDates);
			...
			protected MapperS<Integer> fixingOffsetDays(CalculationPeriodBase calculationPeriod, CalculationPeriodBase priorCalculationPeriod, ObservationPeriodDatesEnum calculateRelativeTo, ResetDates resetDates) {
				return MapperS.of(resetDates).<RelativeDateOffset>map("getFixingDates", _resetDates -> _resetDates.getFixingDates()).<Integer>map("getPeriodMultiplier", relativeDateOffset -> relativeDateOffset.getPeriodMultiplier());
			}
