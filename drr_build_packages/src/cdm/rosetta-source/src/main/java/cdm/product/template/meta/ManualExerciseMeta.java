...
import cdm.product.template.validation.datarule.ManualExerciseManualExerciseNoticeReceiverParty;
...
public class ManualExerciseMeta implements RosettaMetaData<ManualExercise> {
	...
	public List<Validator<? super ManualExercise>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<ManualExercise>create(ManualExerciseManualExerciseNoticeReceiverParty.class)
		);
	}
