...
public class EligibleCollateralSpecificationMeta implements RosettaMetaData<EligibleCollateralSpecification> {
	...
	@Override
	public Validator<? super EligibleCollateralSpecification> validator(ValidatorFactory factory) {
		return factory.<EligibleCollateralSpecification>create(EligibleCollateralSpecificationValidator.class);
	}

	@Override
	public Validator<? super EligibleCollateralSpecification> typeFormatValidator(ValidatorFactory factory) {
		return factory.<EligibleCollateralSpecification>create(EligibleCollateralSpecificationTypeFormatValidator.class);
	}
