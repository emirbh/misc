...
public class AgreementTermsMeta implements RosettaMetaData<AgreementTerms> {
	...
	@Override
	public Validator<? super AgreementTerms> validator(ValidatorFactory factory) {
		return factory.<AgreementTerms>create(AgreementTermsValidator.class);
	}

	@Override
	public Validator<? super AgreementTerms> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AgreementTerms>create(AgreementTermsTypeFormatValidator.class);
	}
