...
public class CashflowMeta implements RosettaMetaData<Cashflow> {
	...
	@Override
	public Validator<? super Cashflow> validator(ValidatorFactory factory) {
		return factory.<Cashflow>create(CashflowValidator.class);
	}

	@Override
	public Validator<? super Cashflow> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Cashflow>create(CashflowTypeFormatValidator.class);
	}
