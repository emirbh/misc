...
public class TradeStateMeta implements RosettaMetaData<TradeState> {
	...
	@Override
	public Validator<? super TradeState> validator(ValidatorFactory factory) {
		return factory.<TradeState>create(TradeStateValidator.class);
	}

	@Override
	public Validator<? super TradeState> typeFormatValidator(ValidatorFactory factory) {
		return factory.<TradeState>create(TradeStateTypeFormatValidator.class);
	}
