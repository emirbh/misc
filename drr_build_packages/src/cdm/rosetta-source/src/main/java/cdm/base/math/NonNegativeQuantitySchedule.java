 ...
 * @version 6.23.0
 */
@RosettaDataType(value="NonNegativeQuantitySchedule", builder=NonNegativeQuantitySchedule.NonNegativeQuantityScheduleBuilderImpl.class, version="6.23.0")
@RuneDataType(value="NonNegativeQuantitySchedule", model="cdm", builder=NonNegativeQuantitySchedule.NonNegativeQuantityScheduleBuilderImpl.class, version="6.23.0")
public interface NonNegativeQuantitySchedule extends QuantitySchedule {
	...
	interface NonNegativeQuantityScheduleBuilder extends NonNegativeQuantitySchedule, QuantitySchedule.QuantityScheduleBuilder {
		...
		@Override
		NonNegativeQuantitySchedule.NonNegativeQuantityScheduleBuilder addDatedValue(DatedValue datedValue, int idx);
		@Override
	...
	class NonNegativeQuantityScheduleBuilderImpl extends QuantitySchedule.QuantityScheduleBuilderImpl implements NonNegativeQuantitySchedule.NonNegativeQuantityScheduleBuilder {
		...
		@Override
		public NonNegativeQuantitySchedule.NonNegativeQuantityScheduleBuilder addDatedValue(DatedValue _datedValue, int idx) {
