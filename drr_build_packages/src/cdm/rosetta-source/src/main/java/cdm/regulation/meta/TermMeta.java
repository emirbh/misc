...
public class TermMeta implements RosettaMetaData<Term> {
	...
	@Override
	public Validator<? super Term> validator(ValidatorFactory factory) {
		return factory.<Term>create(TermValidator.class);
	}

	@Override
	public Validator<? super Term> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Term>create(TermTypeFormatValidator.class);
	}
