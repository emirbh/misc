...
@RuneDataType(value="FieldWithMetaIndexAnnexSourceEnum", model="cdm", builder=FieldWithMetaIndexAnnexSourceEnum.FieldWithMetaIndexAnnexSourceEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaIndexAnnexSourceEnum extends RosettaModelObject, FieldWithMeta<IndexAnnexSourceEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaIndexAnnexSourceEnumBuilder extends FieldWithMetaIndexAnnexSourceEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<IndexAnnexSourceEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaIndexAnnexSourceEnumBuilderImpl implements FieldWithMetaIndexAnnexSourceEnum.FieldWithMetaIndexAnnexSourceEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaIndexAnnexSourceEnum.FieldWithMetaIndexAnnexSourceEnumBuilder setValue(IndexAnnexSourceEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaIndexAnnexSourceEnum.FieldWithMetaIndexAnnexSourceEnumBuilder setMeta(MetaFields _meta) {
