...
public enum AncillaryRoleEnum {
	 ...
	 */
	@RosettaEnumValue(value = "DisruptionEventsDeterminingParty") 
	DISRUPTION_EVENTS_DETERMINING_PARTY("DisruptionEventsDeterminingParty", null),
	
	/**
	 * Specifies the party which determines if dividends are extraordinary in relation to normal levels.
	 */
	@RosettaEnumValue(value = "ExtraordinaryDividendsParty") 
	EXTRAORDINARY_DIVIDENDS_PARTY("ExtraordinaryDividendsParty", null),
	
	/**
	 * Specifies the clearing organization (CCP, DCO) which the trade should be cleared.
	 */
	@RosettaEnumValue(value = "PredeterminedClearingOrganizationParty") 
	PREDETERMINED_CLEARING_ORGANIZATION_PARTY("PredeterminedClearingOrganizationParty", null),
	
	/**
	 * Specifies the party to which notice of a manual exercise should be given.
	 */
	@RosettaEnumValue(value = "ExerciseNoticeReceiverPartyManual") 
	EXERCISE_NOTICE_RECEIVER_PARTY_MANUAL("ExerciseNoticeReceiverPartyManual", null),
	
	/**
	 * Specifies the party to which notice of a optional early termination exercise should be given.
	 */
	@RosettaEnumValue(value = "ExerciseNoticeReceiverPartyOptionalEarlyTermination") 
	EXERCISE_NOTICE_RECEIVER_PARTY_OPTIONAL_EARLY_TERMINATION("ExerciseNoticeReceiverPartyOptionalEarlyTermination", null),
	
	/**
	 * Specifies the party to which notice of a cancelable provision exercise should be given.
	 */
	@RosettaEnumValue(value = "ExerciseNoticeReceiverPartyCancelableProvision") 
	EXERCISE_NOTICE_RECEIVER_PARTY_CANCELABLE_PROVISION("ExerciseNoticeReceiverPartyCancelableProvision", null),
	
	/**
	 * Specifies the party to which notice of a extendible provision exercise should be given.
	 */
	@RosettaEnumValue(value = "ExerciseNoticeReceiverPartyExtendibleProvision") 
	EXERCISE_NOTICE_RECEIVER_PARTY_EXTENDIBLE_PROVISION("ExerciseNoticeReceiverPartyExtendibleProvision", null),
	
	/**
	 * Specifies the party responsible for performing calculation agent duties as defined in the applicable product definition.
	 */
	@RosettaEnumValue(value = "CalculationAgentIndependent") 
	CALCULATION_AGENT_INDEPENDENT("CalculationAgentIndependent", null),
	
	/**
	 * Specifies the party responsible for performing calculation agent duties associated with an optional early termination.
	 */
	@RosettaEnumValue(value = "CalculationAgentOptionalEarlyTermination") 
	CALCULATION_AGENT_OPTIONAL_EARLY_TERMINATION("CalculationAgentOptionalEarlyTermination", null),
	
	/**
	 * Specifies the party responsible for performing calculation agent duties associated with an mandatory early termination.
	 */
	@RosettaEnumValue(value = "CalculationAgentMandatoryEarlyTermination") 
	CALCULATION_AGENT_MANDATORY_EARLY_TERMINATION("CalculationAgentMandatoryEarlyTermination", null),
	
	/**
	 * Specifies the party responsible for deciding the fallback rate.
	 */
	@RosettaEnumValue(value = "CalculationAgentFallback") 
	CALCULATION_AGENT_FALLBACK("CalculationAgentFallback", null)
;
