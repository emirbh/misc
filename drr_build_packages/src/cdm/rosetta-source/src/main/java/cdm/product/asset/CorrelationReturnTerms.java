 ...
 * @version 6.23.0
 */
@RosettaDataType(value="CorrelationReturnTerms", builder=CorrelationReturnTerms.CorrelationReturnTermsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="CorrelationReturnTerms", model="cdm", builder=CorrelationReturnTerms.CorrelationReturnTermsBuilderImpl.class, version="6.23.0")
