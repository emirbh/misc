 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Counterparty", builder=Counterparty.CounterpartyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Counterparty", model="cdm", builder=Counterparty.CounterpartyBuilderImpl.class, version="6.23.0")
