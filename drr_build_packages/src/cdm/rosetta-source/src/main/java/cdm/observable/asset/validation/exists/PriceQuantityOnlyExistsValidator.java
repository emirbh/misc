...
public class PriceQuantityOnlyExistsValidator implements ValidatorWithArg<PriceQuantity, Set<String>> {
	...
	public <T2 extends PriceQuantity> ValidationResult<PriceQuantity> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("observable", ExistenceChecker.isSet((FieldWithMetaObservable) o.getObservable()))
		...
		if (setFields.equals(fields)) {
			return success("PriceQuantity", ValidationResult.ValidationType.ONLY_EXISTS, "PriceQuantity", path, "");
		}
		return failure("PriceQuantity", ValidationResult.ValidationType.ONLY_EXISTS, "PriceQuantity", path, "",
