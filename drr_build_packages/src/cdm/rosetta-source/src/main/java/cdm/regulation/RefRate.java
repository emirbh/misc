 ...
 * @version 6.23.0
 */
@RosettaDataType(value="RefRate", builder=RefRate.RefRateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="RefRate", model="cdm", builder=RefRate.RefRateBuilderImpl.class, version="6.23.0")
public interface RefRate extends RosettaModelObject {
	...
	class RefRateBuilderImpl implements RefRate.RefRateBuilder {
		...
		@RuneAttribute("indx")
		@Override
		public RefRate.RefRateBuilder setIndx(String _indx) {
		...
		@RuneAttribute("nm")
		@Override
		public RefRate.RefRateBuilder setNm(String _nm) {
