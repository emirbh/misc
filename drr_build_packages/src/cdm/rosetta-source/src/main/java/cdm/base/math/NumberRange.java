 ...
 * @version 6.23.0
 */
@RosettaDataType(value="NumberRange", builder=NumberRange.NumberRangeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="NumberRange", model="cdm", builder=NumberRange.NumberRangeBuilderImpl.class, version="6.23.0")
public interface NumberRange extends RosettaModelObject {
	...
	class NumberRangeBuilderImpl implements NumberRange.NumberRangeBuilder {
		...
		@RuneAttribute("lowerBound")
		@Override
		public NumberRange.NumberRangeBuilder setLowerBound(NumberBound _lowerBound) {
		...
		@RuneAttribute("upperBound")
		@Override
		public NumberRange.NumberRangeBuilder setUpperBound(NumberBound _upperBound) {
