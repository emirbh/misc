...
public class LegalAgreementMeta implements RosettaMetaData<LegalAgreement> {
	...
	public List<Validator<? super LegalAgreement>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<LegalAgreement>create(LegalAgreementConsistentlyExecutedAgreements.class),
			factory.<LegalAgreement>create(LegalAgreementAgreementVerification.class)
		);
	}
	...
	@Override
	public Validator<? super LegalAgreement> validator(ValidatorFactory factory) {
		return factory.<LegalAgreement>create(LegalAgreementValidator.class);
	}

	@Override
	public Validator<? super LegalAgreement> typeFormatValidator(ValidatorFactory factory) {
		return factory.<LegalAgreement>create(LegalAgreementTypeFormatValidator.class);
	}
