		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CollateralInterestHandlingParameters", ValidationResult.ValidationType.CARDINALITY, "CollateralInterestHandlingParameters", path, "", res.getError());
				}
				return success("CollateralInterestHandlingParameters", ValidationResult.ValidationType.CARDINALITY, "CollateralInterestHandlingParameters", path, "");
			})
			.collect(toList());
	}
