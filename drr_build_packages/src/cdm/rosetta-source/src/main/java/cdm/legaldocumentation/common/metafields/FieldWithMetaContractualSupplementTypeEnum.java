...
@RuneDataType(value="FieldWithMetaContractualSupplementTypeEnum", model="cdm", builder=FieldWithMetaContractualSupplementTypeEnum.FieldWithMetaContractualSupplementTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaContractualSupplementTypeEnum extends RosettaModelObject, FieldWithMeta<ContractualSupplementTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaContractualSupplementTypeEnumBuilder extends FieldWithMetaContractualSupplementTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<ContractualSupplementTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaContractualSupplementTypeEnumBuilderImpl implements FieldWithMetaContractualSupplementTypeEnum.FieldWithMetaContractualSupplementTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaContractualSupplementTypeEnum.FieldWithMetaContractualSupplementTypeEnumBuilder setValue(ContractualSupplementTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaContractualSupplementTypeEnum.FieldWithMetaContractualSupplementTypeEnumBuilder setMeta(MetaFields _meta) {
