...
public class OtherIndexOnlyExistsValidator implements ValidatorWithArg<OtherIndex, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends OtherIndex> ValidationResult<OtherIndex> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("OtherIndex", ValidationResult.ValidationType.ONLY_EXISTS, "OtherIndex", path, "");
		}
		return failure("OtherIndex", ValidationResult.ValidationType.ONLY_EXISTS, "OtherIndex", path, "",
