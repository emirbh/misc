...
public class SecurityProviderRightsEventElectionOnlyExistsValidator implements ValidatorWithArg<SecurityProviderRightsEventElection, Set<String>> {
	...
	public <T2 extends SecurityProviderRightsEventElection> ValidationResult<SecurityProviderRightsEventElection> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("rightsEvent", ExistenceChecker.isSet((Boolean) o.getRightsEvent()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("SecurityProviderRightsEventElection", ValidationResult.ValidationType.ONLY_EXISTS, "SecurityProviderRightsEventElection", path, "");
		}
		return failure("SecurityProviderRightsEventElection", ValidationResult.ValidationType.ONLY_EXISTS, "SecurityProviderRightsEventElection", path, "",
