...
public class IndexBaseMeta implements RosettaMetaData<IndexBase> {
	...
	@Override
	public Validator<? super IndexBase> validator(ValidatorFactory factory) {
		return factory.<IndexBase>create(IndexBaseValidator.class);
	}

	@Override
	public Validator<? super IndexBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<IndexBase>create(IndexBaseTypeFormatValidator.class);
	}
