...
@RuneDataType(value="FieldWithMetaBasketConstituent", model="cdm", builder=FieldWithMetaBasketConstituent.FieldWithMetaBasketConstituentBuilderImpl.class, version="0.0.0")
