 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DividendPeriod", builder=DividendPeriod.DividendPeriodBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DividendPeriod", model="cdm", builder=DividendPeriod.DividendPeriodBuilderImpl.class, version="6.23.0")
