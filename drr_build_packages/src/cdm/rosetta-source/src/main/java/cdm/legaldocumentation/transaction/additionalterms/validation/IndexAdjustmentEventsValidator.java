...
public class IndexAdjustmentEventsValidator implements Validator<IndexAdjustmentEvents> {
	...
	private List<ComparisonResult> getComparisonResults(IndexAdjustmentEvents o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("indexModification", (IndexEventConsequenceEnum) o.getIndexModification() != null ? 1 : 0, 1, 1), 
				checkCardinality("indexCancellation", (IndexEventConsequenceEnum) o.getIndexCancellation() != null ? 1 : 0, 1, 1), 
				checkCardinality("indexDisruption", (IndexEventConsequenceEnum) o.getIndexDisruption() != null ? 1 : 0, 1, 1)
			);
	}
