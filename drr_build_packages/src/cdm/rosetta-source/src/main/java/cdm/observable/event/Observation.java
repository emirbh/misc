 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Observation", builder=Observation.ObservationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Observation", model="cdm", builder=Observation.ObservationBuilderImpl.class, version="6.23.0")
public interface Observation extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface ObservationBuilder extends Observation, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class ObservationImpl implements Observation {
		...
		@Accessor(AccessorType.GETTER)
		@Required
		@RuneAttribute("observationIdentifier")
	...
	class ObservationBuilderImpl implements Observation.ObservationBuilder {
		...
		@RuneAttribute("observedValue")
		@Override
		public Observation.ObservationBuilder setObservedValue(Price _observedValue) {
		...
		@RuneAttribute("observationIdentifier")
		@Override
		public Observation.ObservationBuilder setObservationIdentifier(ObservationIdentifier _observationIdentifier) {
		...
		@RuneMetaType
		@Override
		public Observation.ObservationBuilder setMeta(MetaFields _meta) {
