...
public class ObservationInstructionMeta implements RosettaMetaData<ObservationInstruction> {
	...
	@Override
	public Validator<? super ObservationInstruction> validator(ValidatorFactory factory) {
		return factory.<ObservationInstruction>create(ObservationInstructionValidator.class);
	}

	@Override
	public Validator<? super ObservationInstruction> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ObservationInstruction>create(ObservationInstructionTypeFormatValidator.class);
	}
