...
@ImplementedBy(MapIdentifiedAssetToAssetLoan.MapIdentifiedAssetToAssetLoanDefault.class)
public abstract class MapIdentifiedAssetToAssetLoan implements RosettaFunction {
	...
	*/
	...
	public static class MapIdentifiedAssetToAssetLoanDefault extends MapIdentifiedAssetToAssetLoan {
		@Override
