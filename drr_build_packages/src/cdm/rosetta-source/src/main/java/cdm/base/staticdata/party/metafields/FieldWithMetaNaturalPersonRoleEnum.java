...
@RosettaDataType(value="FieldWithMetaNaturalPersonRoleEnum", builder=FieldWithMetaNaturalPersonRoleEnum.FieldWithMetaNaturalPersonRoleEnumBuilderImpl.class, version="0.0.0")
@RuneDataType(value="FieldWithMetaNaturalPersonRoleEnum", model="cdm", builder=FieldWithMetaNaturalPersonRoleEnum.FieldWithMetaNaturalPersonRoleEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaNaturalPersonRoleEnum extends RosettaModelObject, FieldWithMeta<NaturalPersonRoleEnum>, GlobalKey {
	...
	FieldWithMetaNaturalPersonRoleEnumMeta metaData = new FieldWithMetaNaturalPersonRoleEnumMeta();
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaNaturalPersonRoleEnumBuilder extends FieldWithMetaNaturalPersonRoleEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<NaturalPersonRoleEnum>, GlobalKey.GlobalKeyBuilder {
		...
		FieldWithMetaNaturalPersonRoleEnum.FieldWithMetaNaturalPersonRoleEnumBuilder prune();
	}
	...
	class FieldWithMetaNaturalPersonRoleEnumBuilderImpl implements FieldWithMetaNaturalPersonRoleEnum.FieldWithMetaNaturalPersonRoleEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaNaturalPersonRoleEnum.FieldWithMetaNaturalPersonRoleEnumBuilder setValue(NaturalPersonRoleEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaNaturalPersonRoleEnum.FieldWithMetaNaturalPersonRoleEnumBuilder setMeta(MetaFields _meta) {
