...
@ImplementedBy(CalculationPeriodDatesFpML_ird_21.Default.class)
public interface CalculationPeriodDatesFpML_ird_21 extends Validator<CalculationPeriodDates> {
	...
	class Default implements CalculationPeriodDatesFpML_ird_21 {
	...
	class NoOp implements CalculationPeriodDatesFpML_ird_21 {
