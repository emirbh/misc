...
import cdm.product.common.settlement.validation.datarule.QuantityMultiplierOneOf0;
...
public class QuantityMultiplierMeta implements RosettaMetaData<QuantityMultiplier> {
	...
	public List<Validator<? super QuantityMultiplier>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<QuantityMultiplier>create(QuantityMultiplierOneOf0.class)
		);
	}
	...
	@Override
	public Validator<? super QuantityMultiplier> validator(ValidatorFactory factory) {
		return factory.<QuantityMultiplier>create(QuantityMultiplierValidator.class);
	}

	@Override
	public Validator<? super QuantityMultiplier> typeFormatValidator(ValidatorFactory factory) {
		return factory.<QuantityMultiplier>create(QuantityMultiplierTypeFormatValidator.class);
	}
