 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Frequency", builder=Frequency.FrequencyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Frequency", model="cdm", builder=Frequency.FrequencyBuilderImpl.class, version="6.23.0")
public interface Frequency extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FrequencyBuilder extends Frequency, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class FrequencyBuilderImpl implements Frequency.FrequencyBuilder {
		...
		@RuneMetaType
		@Override
		public Frequency.FrequencyBuilder setMeta(MetaFields _meta) {
