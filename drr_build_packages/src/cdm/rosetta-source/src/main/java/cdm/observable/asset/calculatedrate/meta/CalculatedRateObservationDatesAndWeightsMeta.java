...
public class CalculatedRateObservationDatesAndWeightsMeta implements RosettaMetaData<CalculatedRateObservationDatesAndWeights> {
	...
	@Override
	public Validator<? super CalculatedRateObservationDatesAndWeights> validator(ValidatorFactory factory) {
		return factory.<CalculatedRateObservationDatesAndWeights>create(CalculatedRateObservationDatesAndWeightsValidator.class);
	}

	@Override
	public Validator<? super CalculatedRateObservationDatesAndWeights> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CalculatedRateObservationDatesAndWeights>create(CalculatedRateObservationDatesAndWeightsTypeFormatValidator.class);
	}
