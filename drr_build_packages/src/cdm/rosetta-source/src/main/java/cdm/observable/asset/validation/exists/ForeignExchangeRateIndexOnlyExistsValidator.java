...
public class ForeignExchangeRateIndexOnlyExistsValidator implements ValidatorWithArg<ForeignExchangeRateIndex, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ForeignExchangeRateIndex> ValidationResult<ForeignExchangeRateIndex> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("quotedCurrencyPair", ExistenceChecker.isSet((FieldWithMetaQuotedCurrencyPair) o.getQuotedCurrencyPair()))
		...
		if (setFields.equals(fields)) {
			return success("ForeignExchangeRateIndex", ValidationResult.ValidationType.ONLY_EXISTS, "ForeignExchangeRateIndex", path, "");
		}
		return failure("ForeignExchangeRateIndex", ValidationResult.ValidationType.ONLY_EXISTS, "ForeignExchangeRateIndex", path, "",
