...
@RuneDataType(value="FieldWithMetaPersonIdentifier", model="cdm", builder=FieldWithMetaPersonIdentifier.FieldWithMetaPersonIdentifierBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaPersonIdentifier extends RosettaModelObject, FieldWithMeta<PersonIdentifier>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaPersonIdentifierBuilder extends FieldWithMetaPersonIdentifier, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<PersonIdentifier>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaPersonIdentifierBuilderImpl implements FieldWithMetaPersonIdentifier.FieldWithMetaPersonIdentifierBuilder {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaPersonIdentifier.FieldWithMetaPersonIdentifierBuilder setValue(PersonIdentifier _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaPersonIdentifier.FieldWithMetaPersonIdentifierBuilder setMeta(MetaFields _meta) {
