 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SpreadSchedule", builder=SpreadSchedule.SpreadScheduleBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SpreadSchedule", model="cdm", builder=SpreadSchedule.SpreadScheduleBuilderImpl.class, version="6.23.0")
