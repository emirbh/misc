 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ExerciseFeeSchedule", builder=ExerciseFeeSchedule.ExerciseFeeScheduleBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ExerciseFeeSchedule", model="cdm", builder=ExerciseFeeSchedule.ExerciseFeeScheduleBuilderImpl.class, version="6.23.0")
public interface ExerciseFeeSchedule extends PayerReceiver {
	...
	/*********************** Builder Interface  ***********************/
	interface ExerciseFeeScheduleBuilder extends ExerciseFeeSchedule, PayerReceiver.PayerReceiverBuilder {
	...
	class ExerciseFeeScheduleBuilderImpl extends PayerReceiver.PayerReceiverBuilderImpl implements ExerciseFeeSchedule.ExerciseFeeScheduleBuilder {
		...
		@RuneAttribute("payer")
		@Override
		public ExerciseFeeSchedule.ExerciseFeeScheduleBuilder setPayer(CounterpartyRoleEnum _payer) {
		...
		@Override
		public ExerciseFeeSchedule.ExerciseFeeScheduleBuilder setReceiver(CounterpartyRoleEnum _receiver) {
		...
		@RuneAttribute("notionalReference")
		@Override
		public ExerciseFeeSchedule.ExerciseFeeScheduleBuilder setNotionalReference(ReferenceWithMetaMoney _notionalReference) {
			this.notionalReference = _notionalReference == null ? null : _notionalReference.toBuilder();
			return this;
		}
		
		@Override
		public ExerciseFeeSchedule.ExerciseFeeScheduleBuilder setNotionalReferenceValue(Money _notionalReference) {
