...
@RuneDataType(value="FieldWithMetaCreditNotation", model="cdm", builder=FieldWithMetaCreditNotation.FieldWithMetaCreditNotationBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaCreditNotation extends RosettaModelObject, FieldWithMeta<CreditNotation>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaCreditNotationBuilder extends FieldWithMetaCreditNotation, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<CreditNotation>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaCreditNotationBuilderImpl implements FieldWithMetaCreditNotation.FieldWithMetaCreditNotationBuilder {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaCreditNotation.FieldWithMetaCreditNotationBuilder setValue(CreditNotation _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaCreditNotation.FieldWithMetaCreditNotationBuilder setMeta(MetaFields _meta) {
