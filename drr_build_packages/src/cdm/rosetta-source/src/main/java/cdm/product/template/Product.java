 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Product", builder=Product.ProductBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Product", model="cdm", builder=Product.ProductBuilderImpl.class, version="6.23.0")
@RuneChoiceType
