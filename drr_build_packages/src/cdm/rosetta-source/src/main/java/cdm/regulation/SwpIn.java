 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SwpIn", builder=SwpIn.SwpInBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SwpIn", model="cdm", builder=SwpIn.SwpInBuilderImpl.class, version="6.23.0")
public interface SwpIn extends RosettaModelObject {
	...
	class SwpInBuilderImpl implements SwpIn.SwpInBuilder {
		...
		@RuneAttribute("sngl")
		@Override
		public SwpIn.SwpInBuilder setSngl(Sngl _sngl) {
