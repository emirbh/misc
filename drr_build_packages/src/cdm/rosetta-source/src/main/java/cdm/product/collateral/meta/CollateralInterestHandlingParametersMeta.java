...
import cdm.product.collateral.validation.datarule.CollateralInterestHandlingParametersAlternative;
import cdm.product.collateral.validation.datarule.CollateralInterestHandlingParametersAlternative2;
...
public class CollateralInterestHandlingParametersMeta implements RosettaMetaData<CollateralInterestHandlingParameters> {
	...
	public List<Validator<? super CollateralInterestHandlingParameters>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<CollateralInterestHandlingParameters>create(CollateralInterestHandlingParametersAlternative.class),
			factory.<CollateralInterestHandlingParameters>create(CollateralInterestHandlingParametersAlternative2.class)
		);
	}
	...
	@Override
	public Validator<? super CollateralInterestHandlingParameters> validator(ValidatorFactory factory) {
		return factory.<CollateralInterestHandlingParameters>create(CollateralInterestHandlingParametersValidator.class);
	}

	@Override
	public Validator<? super CollateralInterestHandlingParameters> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralInterestHandlingParameters>create(CollateralInterestHandlingParametersTypeFormatValidator.class);
	}
