...
import cdm.product.asset.validation.datarule.VolatilityCapFloorCapFloorApplicability;
import cdm.product.asset.validation.datarule.VolatilityCapFloorPositiveCaps;
...
public class VolatilityCapFloorMeta implements RosettaMetaData<VolatilityCapFloor> {
	...
	public List<Validator<? super VolatilityCapFloor>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<VolatilityCapFloor>create(VolatilityCapFloorCapFloorApplicability.class),
			factory.<VolatilityCapFloor>create(VolatilityCapFloorPositiveCaps.class)
		);
	}
	...
	@Override
	public Validator<? super VolatilityCapFloor> validator(ValidatorFactory factory) {
		return factory.<VolatilityCapFloor>create(VolatilityCapFloorValidator.class);
	}

	@Override
	public Validator<? super VolatilityCapFloor> typeFormatValidator(ValidatorFactory factory) {
		return factory.<VolatilityCapFloor>create(VolatilityCapFloorTypeFormatValidator.class);
	}
