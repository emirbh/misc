...
@ImplementedBy(MapCorrelationSwapEconomicTerms.MapCorrelationSwapEconomicTermsDefault.class)
public abstract class MapCorrelationSwapEconomicTerms implements RosettaFunction {
	
	@Inject protected ModelObjectValidator objectValidator;
	
	// RosettaFunction dependencies
	//
	@Inject protected MapCorrelationSwapPayout mapCorrelationSwapPayout;
	...
	*/
	public EconomicTerms evaluate(CorrelationSwap fpmlCorrelationSwap, List<? extends Counterparty> cdmCounterpartyList) {
		EconomicTerms.EconomicTermsBuilder economicTermsBuilder = doEvaluate(fpmlCorrelationSwap, cdmCounterpartyList);
	...
	protected abstract EconomicTerms.EconomicTermsBuilder doEvaluate(CorrelationSwap fpmlCorrelationSwap, List<? extends Counterparty> cdmCounterpartyList);

	public static class MapCorrelationSwapEconomicTermsDefault extends MapCorrelationSwapEconomicTerms {
		@Override
		protected EconomicTerms.EconomicTermsBuilder doEvaluate(CorrelationSwap fpmlCorrelationSwap, List<? extends Counterparty> cdmCounterpartyList) {
			...
			return assignOutput(economicTerms, fpmlCorrelationSwap, cdmCounterpartyList);
		}
		...
		protected EconomicTerms.EconomicTermsBuilder assignOutput(EconomicTerms.EconomicTermsBuilder economicTerms, CorrelationSwap fpmlCorrelationSwap, List<? extends Counterparty> cdmCounterpartyList) {
			final Payout payout = mapCorrelationSwapPayout.evaluate(fpmlCorrelationSwap, cdmCounterpartyList);
