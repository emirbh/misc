...
public class SecurityLendingInvoiceMeta implements RosettaMetaData<SecurityLendingInvoice> {
	...
	@Override
	public Validator<? super SecurityLendingInvoice> validator(ValidatorFactory factory) {
		return factory.<SecurityLendingInvoice>create(SecurityLendingInvoiceValidator.class);
	}

	@Override
	public Validator<? super SecurityLendingInvoice> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SecurityLendingInvoice>create(SecurityLendingInvoiceTypeFormatValidator.class);
	}
