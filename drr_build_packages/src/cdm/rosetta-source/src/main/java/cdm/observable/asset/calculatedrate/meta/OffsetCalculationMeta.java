...
public class OffsetCalculationMeta implements RosettaMetaData<OffsetCalculation> {
	...
	@Override
	public Validator<? super OffsetCalculation> validator(ValidatorFactory factory) {
		return factory.<OffsetCalculation>create(OffsetCalculationValidator.class);
	}

	@Override
	public Validator<? super OffsetCalculation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<OffsetCalculation>create(OffsetCalculationTypeFormatValidator.class);
	}
