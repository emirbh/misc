 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FloatingRateSettingDetails", builder=FloatingRateSettingDetails.FloatingRateSettingDetailsBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FloatingRateSettingDetails", model="cdm", builder=FloatingRateSettingDetails.FloatingRateSettingDetailsBuilderImpl.class, version="6.23.0")
