 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DeliveryDateParameters", builder=DeliveryDateParameters.DeliveryDateParametersBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DeliveryDateParameters", model="cdm", builder=DeliveryDateParameters.DeliveryDateParametersBuilderImpl.class, version="6.23.0")
public interface DeliveryDateParameters extends RosettaModelObject {
	...
	class DeliveryDateParametersBuilderImpl implements DeliveryDateParameters.DeliveryDateParametersBuilder {
		...
		@RuneAttribute("deliveryNearby")
		@Override
		public DeliveryDateParameters.DeliveryDateParametersBuilder setDeliveryNearby(Offset _deliveryNearby) {
		...
		@RuneAttribute("deliveryDate")
		@Override
		public DeliveryDateParameters.DeliveryDateParametersBuilder setDeliveryDate(AdjustableDate _deliveryDate) {
		...
		@RuneAttribute("deliveryDateRollConvention")
		@Override
		public DeliveryDateParameters.DeliveryDateParametersBuilder setDeliveryDateRollConvention(Offset _deliveryDateRollConvention) {
		...
		@RuneAttribute("deliveryDateExpirationConvention")
		@Override
		public DeliveryDateParameters.DeliveryDateParametersBuilder setDeliveryDateExpirationConvention(Offset _deliveryDateExpirationConvention) {
