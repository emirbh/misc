...
public class CalculatedRateDetailsMeta implements RosettaMetaData<CalculatedRateDetails> {
	...
	@Override
	public Validator<? super CalculatedRateDetails> validator(ValidatorFactory factory) {
		return factory.<CalculatedRateDetails>create(CalculatedRateDetailsValidator.class);
	}

	@Override
	public Validator<? super CalculatedRateDetails> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CalculatedRateDetails>create(CalculatedRateDetailsTypeFormatValidator.class);
	}
