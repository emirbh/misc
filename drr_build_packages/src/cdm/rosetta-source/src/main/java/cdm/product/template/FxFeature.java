 ...
 * @version 6.23.0
 */
@RosettaDataType(value="FxFeature", builder=FxFeature.FxFeatureBuilderImpl.class, version="6.23.0")
@RuneDataType(value="FxFeature", model="cdm", builder=FxFeature.FxFeatureBuilderImpl.class, version="6.23.0")
public interface FxFeature extends RosettaModelObject {
	...
	class FxFeatureBuilderImpl implements FxFeature.FxFeatureBuilder {
		...
		@RuneAttribute("referenceCurrency")
		@Override
		public FxFeature.FxFeatureBuilder setReferenceCurrency(FieldWithMetaString _referenceCurrency) {
			this.referenceCurrency = _referenceCurrency == null ? null : _referenceCurrency.toBuilder();
			return this;
		}
		
		@Override
		public FxFeature.FxFeatureBuilder setReferenceCurrencyValue(String _referenceCurrency) {
			this.getOrCreateReferenceCurrency().setValue(_referenceCurrency);
			return this;
		}
