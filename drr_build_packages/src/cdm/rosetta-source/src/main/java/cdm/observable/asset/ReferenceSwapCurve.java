 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ReferenceSwapCurve", builder=ReferenceSwapCurve.ReferenceSwapCurveBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ReferenceSwapCurve", model="cdm", builder=ReferenceSwapCurve.ReferenceSwapCurveBuilderImpl.class, version="6.23.0")
