...
public class AssetTypeOnlyExistsValidator implements ValidatorWithArg<AssetType, Set<String>> {
	...
	public <T2 extends AssetType> ValidationResult<AssetType> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("securityType", ExistenceChecker.isSet((InstrumentTypeEnum) o.getSecurityType()))
		...
		if (setFields.equals(fields)) {
			return success("AssetType", ValidationResult.ValidationType.ONLY_EXISTS, "AssetType", path, "");
		}
		return failure("AssetType", ValidationResult.ValidationType.ONLY_EXISTS, "AssetType", path, "",
