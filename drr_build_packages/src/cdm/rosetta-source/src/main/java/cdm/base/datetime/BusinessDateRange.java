 ...
 * @version 6.23.0
 */
@RosettaDataType(value="BusinessDateRange", builder=BusinessDateRange.BusinessDateRangeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="BusinessDateRange", model="cdm", builder=BusinessDateRange.BusinessDateRangeBuilderImpl.class, version="6.23.0")
public interface BusinessDateRange extends DateRange {
	...
	class BusinessDateRangeBuilderImpl extends DateRange.DateRangeBuilderImpl implements BusinessDateRange.BusinessDateRangeBuilder {
		...
		@Override
		public BusinessDateRange.BusinessDateRangeBuilder setStartDate(Date _startDate) {
		...
		@Override
		public BusinessDateRange.BusinessDateRangeBuilder setEndDate(Date _endDate) {
