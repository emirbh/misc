 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SchedulePeriod", builder=SchedulePeriod.SchedulePeriodBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SchedulePeriod", model="cdm", builder=SchedulePeriod.SchedulePeriodBuilderImpl.class, version="6.23.0")
