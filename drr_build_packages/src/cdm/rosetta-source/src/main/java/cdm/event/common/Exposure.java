 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Exposure", builder=Exposure.ExposureBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Exposure", model="cdm", builder=Exposure.ExposureBuilderImpl.class, version="6.23.0")
public interface Exposure extends RosettaModelObject {
	...
	interface ExposureBuilder extends Exposure, RosettaModelObjectBuilder {
		...
		Exposure.ExposureBuilder setTradePortfolio(ReferenceWithMetaPortfolioState tradePortfolio);
		Exposure.ExposureBuilder setTradePortfolioValue(PortfolioState tradePortfolio);
	...
	class ExposureImpl implements Exposure {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("calculationDateTime")
		...
		@Accessor(AccessorType.GETTER)
		@Required
		@RuneAttribute("valuationDateTime")
	...
	class ExposureBuilderImpl implements Exposure.ExposureBuilder {
		...
		@RuneAttribute("tradePortfolio")
		@Override
		public Exposure.ExposureBuilder setTradePortfolio(ReferenceWithMetaPortfolioState _tradePortfolio) {
			this.tradePortfolio = _tradePortfolio == null ? null : _tradePortfolio.toBuilder();
			return this;
		}
		
		@Override
		public Exposure.ExposureBuilder setTradePortfolioValue(PortfolioState _tradePortfolio) {
		...
		@RuneAttribute("aggregateValue")
		@Override
		public Exposure.ExposureBuilder setAggregateValue(Money _aggregateValue) {
		...
		@RuneAttribute("calculationDateTime")
		@Override
		public Exposure.ExposureBuilder setCalculationDateTime(ZonedDateTime _calculationDateTime) {
		...
		@RuneAttribute("valuationDateTime")
		@Override
		public Exposure.ExposureBuilder setValuationDateTime(ZonedDateTime _valuationDateTime) {
