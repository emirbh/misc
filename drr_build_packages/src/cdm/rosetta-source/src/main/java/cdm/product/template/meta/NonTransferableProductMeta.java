...
import cdm.product.template.validation.datarule.NonTransferableProductPrimaryAssetClass;
...
public class NonTransferableProductMeta implements RosettaMetaData<NonTransferableProduct> {
	...
	public List<Validator<? super NonTransferableProduct>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<NonTransferableProduct>create(NonTransferableProductPrimaryAssetClass.class)
		);
	}
	...
	@Override
	public Validator<? super NonTransferableProduct> validator(ValidatorFactory factory) {
		return factory.<NonTransferableProduct>create(NonTransferableProductValidator.class);
	}

	@Override
	public Validator<? super NonTransferableProduct> typeFormatValidator(ValidatorFactory factory) {
		return factory.<NonTransferableProduct>create(NonTransferableProductTypeFormatValidator.class);
	}
