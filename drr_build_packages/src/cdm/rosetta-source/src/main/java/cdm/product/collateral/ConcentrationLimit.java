 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ConcentrationLimit", builder=ConcentrationLimit.ConcentrationLimitBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ConcentrationLimit", model="cdm", builder=ConcentrationLimit.ConcentrationLimitBuilderImpl.class, version="6.23.0")
