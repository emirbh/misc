 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SpecifiedCurrency", builder=SpecifiedCurrency.SpecifiedCurrencyBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SpecifiedCurrency", model="cdm", builder=SpecifiedCurrency.SpecifiedCurrencyBuilderImpl.class, version="6.23.0")
public interface SpecifiedCurrency extends RosettaModelObject {
	...
	class SpecifiedCurrencyBuilderImpl implements SpecifiedCurrency.SpecifiedCurrencyBuilder {
		...
		@RuneAttribute("currency")
		@Override
		public SpecifiedCurrency.SpecifiedCurrencyBuilder setCurrency(FieldWithMetaString _currency) {
			this.currency = _currency == null ? null : _currency.toBuilder();
			return this;
		}
		
		@Override
		public SpecifiedCurrency.SpecifiedCurrencyBuilder setCurrencyValue(String _currency) {
