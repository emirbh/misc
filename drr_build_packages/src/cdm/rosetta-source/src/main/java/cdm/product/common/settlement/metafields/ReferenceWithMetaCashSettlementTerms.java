...
@RosettaDataType(value="ReferenceWithMetaCashSettlementTerms", builder=ReferenceWithMetaCashSettlementTerms.ReferenceWithMetaCashSettlementTermsBuilderImpl.class, version="0.0.0")
@RuneDataType(value="ReferenceWithMetaCashSettlementTerms", model="cdm", builder=ReferenceWithMetaCashSettlementTerms.ReferenceWithMetaCashSettlementTermsBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaCashSettlementTerms extends RosettaModelObject, ReferenceWithMeta<CashSettlementTerms> {

	ReferenceWithMetaCashSettlementTermsMeta metaData = new ReferenceWithMetaCashSettlementTermsMeta();
	...
	/*********************** Builder Interface  ***********************/
	interface ReferenceWithMetaCashSettlementTermsBuilder extends ReferenceWithMetaCashSettlementTerms, RosettaModelObjectBuilder, ReferenceWithMeta.ReferenceWithMetaBuilder<CashSettlementTerms> {
		...
		ReferenceWithMetaCashSettlementTerms.ReferenceWithMetaCashSettlementTermsBuilder prune();
	}
	...
	class ReferenceWithMetaCashSettlementTermsBuilderImpl implements ReferenceWithMetaCashSettlementTerms.ReferenceWithMetaCashSettlementTermsBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaCashSettlementTerms.ReferenceWithMetaCashSettlementTermsBuilder setValue(CashSettlementTerms _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaCashSettlementTerms.ReferenceWithMetaCashSettlementTermsBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaCashSettlementTerms.ReferenceWithMetaCashSettlementTermsBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaCashSettlementTerms.ReferenceWithMetaCashSettlementTermsBuilder setReference(Reference _reference) {
