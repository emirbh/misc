...
import cdm.product.asset.validation.datarule.DividendReturnTermsDividendPeriod;
import cdm.product.asset.validation.datarule.DividendReturnTermsExtraordinaryDividendsParty;
...
public class DividendReturnTermsMeta implements RosettaMetaData<DividendReturnTerms> {
	...
	public List<Validator<? super DividendReturnTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<DividendReturnTerms>create(DividendReturnTermsDividendPeriod.class),
			factory.<DividendReturnTerms>create(DividendReturnTermsExtraordinaryDividendsParty.class)
		);
	}
	...
	@Override
	public Validator<? super DividendReturnTerms> validator(ValidatorFactory factory) {
		return factory.<DividendReturnTerms>create(DividendReturnTermsValidator.class);
	}

	@Override
	public Validator<? super DividendReturnTerms> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DividendReturnTerms>create(DividendReturnTermsTypeFormatValidator.class);
	}
