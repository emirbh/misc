		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AssetIdentifier", ValidationResult.ValidationType.TYPE_FORMAT, "AssetIdentifier", path, "", res.getError());
				}
				return success("AssetIdentifier", ValidationResult.ValidationType.TYPE_FORMAT, "AssetIdentifier", path, "");
			})
			.collect(toList());
	}
