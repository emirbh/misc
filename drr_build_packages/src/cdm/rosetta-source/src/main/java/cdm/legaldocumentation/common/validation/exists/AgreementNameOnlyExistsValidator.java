...
public class AgreementNameOnlyExistsValidator implements ValidatorWithArg<AgreementName, Set<String>> {
	...
	public <T2 extends AgreementName> ValidationResult<AgreementName> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("brokerConfirmationType", ExistenceChecker.isSet((BrokerConfirmationTypeEnum) o.getBrokerConfirmationType()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AgreementName", ValidationResult.ValidationType.ONLY_EXISTS, "AgreementName", path, "");
		}
		return failure("AgreementName", ValidationResult.ValidationType.ONLY_EXISTS, "AgreementName", path, "",
