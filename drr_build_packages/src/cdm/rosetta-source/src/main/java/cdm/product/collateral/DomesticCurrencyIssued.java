 ...
 * @version 6.23.0
 */
@RosettaDataType(value="DomesticCurrencyIssued", builder=DomesticCurrencyIssued.DomesticCurrencyIssuedBuilderImpl.class, version="6.23.0")
@RuneDataType(value="DomesticCurrencyIssued", model="cdm", builder=DomesticCurrencyIssued.DomesticCurrencyIssuedBuilderImpl.class, version="6.23.0")
