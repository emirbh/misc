...
import cdm.product.common.settlement.validation.datarule.SettlementTermsCashSettlementTerms;
import cdm.product.common.settlement.validation.datarule.SettlementTermsOptionSettlementChoice;
import cdm.product.common.settlement.validation.datarule.SettlementTermsPhysicalSettlementTerms;
...
public class SettlementTermsMeta implements RosettaMetaData<SettlementTerms> {
	...
	public List<Validator<? super SettlementTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<SettlementTerms>create(SettlementTermsOptionSettlementChoice.class),
			factory.<SettlementTerms>create(SettlementTermsCashSettlementTerms.class),
			factory.<SettlementTerms>create(SettlementTermsPhysicalSettlementTerms.class)
		);
	}
