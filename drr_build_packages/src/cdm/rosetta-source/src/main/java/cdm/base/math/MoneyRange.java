 ...
 * @version 6.23.0
 */
@RosettaDataType(value="MoneyRange", builder=MoneyRange.MoneyRangeBuilderImpl.class, version="6.23.0")
@RuneDataType(value="MoneyRange", model="cdm", builder=MoneyRange.MoneyRangeBuilderImpl.class, version="6.23.0")
