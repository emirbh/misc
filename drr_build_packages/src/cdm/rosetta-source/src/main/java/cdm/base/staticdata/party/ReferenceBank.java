 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ReferenceBank", builder=ReferenceBank.ReferenceBankBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ReferenceBank", model="cdm", builder=ReferenceBank.ReferenceBankBuilderImpl.class, version="6.23.0")
public interface ReferenceBank extends RosettaModelObject {
	...
	class ReferenceBankBuilderImpl implements ReferenceBank.ReferenceBankBuilder {
		...
		@RuneAttribute("referenceBankId")
		@Override
		public ReferenceBank.ReferenceBankBuilder setReferenceBankId(FieldWithMetaString _referenceBankId) {
			this.referenceBankId = _referenceBankId == null ? null : _referenceBankId.toBuilder();
			return this;
		}
		
		@Override
		public ReferenceBank.ReferenceBankBuilder setReferenceBankIdValue(String _referenceBankId) {
			this.getOrCreateReferenceBankId().setValue(_referenceBankId);
			return this;
		}
