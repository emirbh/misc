...
@RuneDataType(value="ReferenceWithMetaPhysicalSettlementTerms", model="cdm", builder=ReferenceWithMetaPhysicalSettlementTerms.ReferenceWithMetaPhysicalSettlementTermsBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaPhysicalSettlementTerms extends RosettaModelObject, ReferenceWithMeta<PhysicalSettlementTerms> {
	...
	class ReferenceWithMetaPhysicalSettlementTermsBuilderImpl implements ReferenceWithMetaPhysicalSettlementTerms.ReferenceWithMetaPhysicalSettlementTermsBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPhysicalSettlementTerms.ReferenceWithMetaPhysicalSettlementTermsBuilder setValue(PhysicalSettlementTerms _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaPhysicalSettlementTerms.ReferenceWithMetaPhysicalSettlementTermsBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaPhysicalSettlementTerms.ReferenceWithMetaPhysicalSettlementTermsBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPhysicalSettlementTerms.ReferenceWithMetaPhysicalSettlementTermsBuilder setReference(Reference _reference) {
