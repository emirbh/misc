...
public class PaymentDiscountingMeta implements RosettaMetaData<PaymentDiscounting> {
	...
	@Override
	public Validator<? super PaymentDiscounting> validator(ValidatorFactory factory) {
		return factory.<PaymentDiscounting>create(PaymentDiscountingValidator.class);
	}

	@Override
	public Validator<? super PaymentDiscounting> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PaymentDiscounting>create(PaymentDiscountingTypeFormatValidator.class);
	}
