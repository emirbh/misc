...
public class SchmeNmMeta implements RosettaMetaData<SchmeNm> {
	...
	@Override
	public Validator<? super SchmeNm> validator(ValidatorFactory factory) {
		return factory.<SchmeNm>create(SchmeNmValidator.class);
	}

	@Override
	public Validator<? super SchmeNm> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SchmeNm>create(SchmeNmTypeFormatValidator.class);
	}
