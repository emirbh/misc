...
public class ObservationShiftCalculationMeta implements RosettaMetaData<ObservationShiftCalculation> {
	...
	@Override
	public Validator<? super ObservationShiftCalculation> validator(ValidatorFactory factory) {
		return factory.<ObservationShiftCalculation>create(ObservationShiftCalculationValidator.class);
	}

	@Override
	public Validator<? super ObservationShiftCalculation> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ObservationShiftCalculation>create(ObservationShiftCalculationTypeFormatValidator.class);
	}
