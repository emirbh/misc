 ...
 * @version 6.23.0
 */
@RosettaDataType(value="BondReference", builder=BondReference.BondReferenceBuilderImpl.class, version="6.23.0")
@RuneDataType(value="BondReference", model="cdm", builder=BondReference.BondReferenceBuilderImpl.class, version="6.23.0")
