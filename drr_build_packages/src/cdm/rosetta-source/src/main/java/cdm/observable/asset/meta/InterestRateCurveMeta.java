...
public class InterestRateCurveMeta implements RosettaMetaData<InterestRateCurve> {
	...
	@Override
	public Validator<? super InterestRateCurve> validator(ValidatorFactory factory) {
		return factory.<InterestRateCurve>create(InterestRateCurveValidator.class);
	}

	@Override
	public Validator<? super InterestRateCurve> typeFormatValidator(ValidatorFactory factory) {
		return factory.<InterestRateCurve>create(InterestRateCurveTypeFormatValidator.class);
	}
