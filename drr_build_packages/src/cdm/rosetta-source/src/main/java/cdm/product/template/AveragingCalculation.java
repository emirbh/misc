 ...
 * @version 6.23.0
 */
@RosettaDataType(value="AveragingCalculation", builder=AveragingCalculation.AveragingCalculationBuilderImpl.class, version="6.23.0")
@RuneDataType(value="AveragingCalculation", model="cdm", builder=AveragingCalculation.AveragingCalculationBuilderImpl.class, version="6.23.0")
