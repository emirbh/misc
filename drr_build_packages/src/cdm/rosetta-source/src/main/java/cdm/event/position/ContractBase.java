 ...
 * @version 6.23.0
 */
@RosettaDataType(value="ContractBase", builder=ContractBase.ContractBaseBuilderImpl.class, version="6.23.0")
@RuneDataType(value="ContractBase", model="cdm", builder=ContractBase.ContractBaseBuilderImpl.class, version="6.23.0")
