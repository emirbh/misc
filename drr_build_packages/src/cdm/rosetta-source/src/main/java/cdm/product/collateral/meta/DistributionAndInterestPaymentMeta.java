...
public class DistributionAndInterestPaymentMeta implements RosettaMetaData<DistributionAndInterestPayment> {
	...
	@Override
	public Validator<? super DistributionAndInterestPayment> validator(ValidatorFactory factory) {
		return factory.<DistributionAndInterestPayment>create(DistributionAndInterestPaymentValidator.class);
	}

	@Override
	public Validator<? super DistributionAndInterestPayment> typeFormatValidator(ValidatorFactory factory) {
		return factory.<DistributionAndInterestPayment>create(DistributionAndInterestPaymentTypeFormatValidator.class);
	}
