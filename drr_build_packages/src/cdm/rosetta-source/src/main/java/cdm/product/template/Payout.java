 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Payout", builder=Payout.PayoutBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Payout", model="cdm", builder=Payout.PayoutBuilderImpl.class, version="6.23.0")
@RuneChoiceType
