 ...
 * @version 6.23.0
 */
@RosettaDataType(value="SettlementDate", builder=SettlementDate.SettlementDateBuilderImpl.class, version="6.23.0")
@RuneDataType(value="SettlementDate", model="cdm", builder=SettlementDate.SettlementDateBuilderImpl.class, version="6.23.0")
public interface SettlementDate extends RosettaModelObject, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface SettlementDateBuilder extends SettlementDate, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder {
	...
	class SettlementDateImpl implements SettlementDate {
		...
		@RuneAttribute("adjustableOrRelativeDate")
	...
	class SettlementDateBuilderImpl implements SettlementDate.SettlementDateBuilder {
		...
		@RuneAttribute("adjustableOrRelativeDate")
		@Override
		public SettlementDate.SettlementDateBuilder setAdjustableOrRelativeDate(AdjustableOrAdjustedOrRelativeDate _adjustableOrRelativeDate) {
			this.adjustableOrRelativeDate = _adjustableOrRelativeDate == null ? null : _adjustableOrRelativeDate.toBuilder();
			return this;
		}
		...
		@RuneAttribute("valueDate")
		@Override
		public SettlementDate.SettlementDateBuilder setValueDate(Date _valueDate) {
		...
		@RuneAttribute("adjustableDates")
		@Override
		public SettlementDate.SettlementDateBuilder setAdjustableDates(AdjustableDates _adjustableDates) {
		...
		@RuneAttribute("businessDateRange")
		@Override
		public SettlementDate.SettlementDateBuilder setBusinessDateRange(BusinessDateRange _businessDateRange) {
		...
		@RuneAttribute("cashSettlementBusinessDays")
		@Override
		public SettlementDate.SettlementDateBuilder setCashSettlementBusinessDays(Integer _cashSettlementBusinessDays) {
		...
		@RuneAttribute("paymentDelay")
		@Override
		public SettlementDate.SettlementDateBuilder setPaymentDelay(Boolean _paymentDelay) {
		...
		@RuneMetaType
		@Override
		public SettlementDate.SettlementDateBuilder setMeta(MetaFields _meta) {
