...
public class PrsnMeta implements RosettaMetaData<Prsn> {
	...
	@Override
	public Validator<? super Prsn> validator(ValidatorFactory factory) {
		return factory.<Prsn>create(PrsnValidator.class);
	}

	@Override
	public Validator<? super Prsn> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Prsn>create(PrsnTypeFormatValidator.class);
	}
