 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PartyRole", builder=PartyRole.PartyRoleBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PartyRole", model="cdm", builder=PartyRole.PartyRoleBuilderImpl.class, version="6.23.0")
public interface PartyRole extends RosettaModelObject {
	...
	class PartyRoleImpl implements PartyRole {
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("ownershipPartyReference")
	...
	class PartyRoleBuilderImpl implements PartyRole.PartyRoleBuilder {
		...
		@RuneAttribute("partyReference")
		@Override
		public PartyRole.PartyRoleBuilder setPartyReference(ReferenceWithMetaParty _partyReference) {
			this.partyReference = _partyReference == null ? null : _partyReference.toBuilder();
			return this;
		}
		
		@Override
		public PartyRole.PartyRoleBuilder setPartyReferenceValue(Party _partyReference) {
		...
		@RuneAttribute("role")
		@Override
		public PartyRole.PartyRoleBuilder setRole(PartyRoleEnum _role) {
		...
		@RuneAttribute("ownershipPartyReference")
		@Override
		public PartyRole.PartyRoleBuilder setOwnershipPartyReference(ReferenceWithMetaParty _ownershipPartyReference) {
			this.ownershipPartyReference = _ownershipPartyReference == null ? null : _ownershipPartyReference.toBuilder();
			return this;
		}
		
		@Override
		public PartyRole.PartyRoleBuilder setOwnershipPartyReferenceValue(Party _ownershipPartyReference) {
			this.getOrCreateOwnershipPartyReference().setValue(_ownershipPartyReference);
			return this;
		}
