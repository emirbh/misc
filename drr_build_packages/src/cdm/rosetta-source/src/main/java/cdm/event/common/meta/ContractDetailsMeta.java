...
import cdm.event.common.validation.datarule.ContractDetailsExecutedAgreement;
...
public class ContractDetailsMeta implements RosettaMetaData<ContractDetails> {
	...
	public List<Validator<? super ContractDetails>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<ContractDetails>create(ContractDetailsExecutedAgreement.class)
		);
	}
	...
	@Override
	public Validator<? super ContractDetails> validator(ValidatorFactory factory) {
		return factory.<ContractDetails>create(ContractDetailsValidator.class);
	}

	@Override
	public Validator<? super ContractDetails> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ContractDetails>create(ContractDetailsTypeFormatValidator.class);
	}
