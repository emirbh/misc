...
public class RateScheduleMeta implements RosettaMetaData<RateSchedule> {
	...
	@Override
	public Validator<? super RateSchedule> validator(ValidatorFactory factory) {
		return factory.<RateSchedule>create(RateScheduleValidator.class);
	}

	@Override
	public Validator<? super RateSchedule> typeFormatValidator(ValidatorFactory factory) {
		return factory.<RateSchedule>create(RateScheduleTypeFormatValidator.class);
	}
