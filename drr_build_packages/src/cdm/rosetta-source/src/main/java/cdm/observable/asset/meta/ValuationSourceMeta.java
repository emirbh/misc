...
import cdm.observable.asset.validation.datarule.ValuationSourceInformationSource;
...
public class ValuationSourceMeta implements RosettaMetaData<ValuationSource> {
	...
	public List<Validator<? super ValuationSource>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<ValuationSource>create(ValuationSourceInformationSource.class)
		);
	}
	...
	@Override
	public Validator<? super ValuationSource> validator(ValidatorFactory factory) {
		return factory.<ValuationSource>create(ValuationSourceValidator.class);
	}

	@Override
	public Validator<? super ValuationSource> typeFormatValidator(ValidatorFactory factory) {
		return factory.<ValuationSource>create(ValuationSourceTypeFormatValidator.class);
	}
