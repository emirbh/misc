...
@RuneDataType(value="FieldWithMetaInflationRateIndexEnum", model="cdm", builder=FieldWithMetaInflationRateIndexEnum.FieldWithMetaInflationRateIndexEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaInflationRateIndexEnum extends RosettaModelObject, FieldWithMeta<InflationRateIndexEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaInflationRateIndexEnumBuilder extends FieldWithMetaInflationRateIndexEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<InflationRateIndexEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaInflationRateIndexEnumBuilderImpl implements FieldWithMetaInflationRateIndexEnum.FieldWithMetaInflationRateIndexEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaInflationRateIndexEnum.FieldWithMetaInflationRateIndexEnumBuilder setValue(InflationRateIndexEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaInflationRateIndexEnum.FieldWithMetaInflationRateIndexEnumBuilder setMeta(MetaFields _meta) {
