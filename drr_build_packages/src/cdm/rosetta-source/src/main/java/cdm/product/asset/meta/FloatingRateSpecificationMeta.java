...
public class FloatingRateSpecificationMeta implements RosettaMetaData<FloatingRateSpecification> {
	...
	@Override
	public Validator<? super FloatingRateSpecification> validator(ValidatorFactory factory) {
		return factory.<FloatingRateSpecification>create(FloatingRateSpecificationValidator.class);
	}

	@Override
	public Validator<? super FloatingRateSpecification> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FloatingRateSpecification>create(FloatingRateSpecificationTypeFormatValidator.class);
	}
