...
@ImplementedBy(EconomicTermsFpML_cd_26_28.Default.class)
public interface EconomicTermsFpML_cd_26_28 extends Validator<EconomicTerms> {
	
	String NAME = "EconomicTermsFpML_cd_26_28";
	String DEFINITION = "True";
	
	class Default implements EconomicTermsFpML_cd_26_28 {
	...
	class NoOp implements EconomicTermsFpML_cd_26_28 {
