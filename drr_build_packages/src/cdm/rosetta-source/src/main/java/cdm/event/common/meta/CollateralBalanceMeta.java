...
public class CollateralBalanceMeta implements RosettaMetaData<CollateralBalance> {
	...
	@Override
	public Validator<? super CollateralBalance> validator(ValidatorFactory factory) {
		return factory.<CollateralBalance>create(CollateralBalanceValidator.class);
	}

	@Override
	public Validator<? super CollateralBalance> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralBalance>create(CollateralBalanceTypeFormatValidator.class);
	}
