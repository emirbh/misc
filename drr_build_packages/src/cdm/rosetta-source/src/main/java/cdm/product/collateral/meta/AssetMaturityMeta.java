...
public class AssetMaturityMeta implements RosettaMetaData<AssetMaturity> {
	...
	@Override
	public Validator<? super AssetMaturity> validator(ValidatorFactory factory) {
		return factory.<AssetMaturity>create(AssetMaturityValidator.class);
	}

	@Override
	public Validator<? super AssetMaturity> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AssetMaturity>create(AssetMaturityTypeFormatValidator.class);
	}
