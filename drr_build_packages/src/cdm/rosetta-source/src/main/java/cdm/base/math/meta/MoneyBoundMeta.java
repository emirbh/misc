...
public class MoneyBoundMeta implements RosettaMetaData<MoneyBound> {
	...
	@Override
	public Validator<? super MoneyBound> validator(ValidatorFactory factory) {
		return factory.<MoneyBound>create(MoneyBoundValidator.class);
	}

	@Override
	public Validator<? super MoneyBound> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MoneyBound>create(MoneyBoundTypeFormatValidator.class);
	}
