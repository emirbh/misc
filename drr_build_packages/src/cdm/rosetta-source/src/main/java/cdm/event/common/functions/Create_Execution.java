	...
	*/
	...
	public static class Create_ExecutionDefault extends Create_Execution {
		...
		protected TradeState.TradeStateBuilder assignOutput(TradeState.TradeStateBuilder execution, ExecutionInstruction instruction) {
			execution
				.getOrCreateTrade()
				.setProduct(MapperS.of(instruction).<NonTransferableProduct>map("getProduct", executionInstruction -> executionInstruction.getProduct()).get());
			...
			execution
				.getOrCreateTrade()
				.setTradeDate(MapperS.of(instruction).<FieldWithMetaDate>map("getTradeDate", executionInstruction -> executionInstruction.getTradeDate()).get());
