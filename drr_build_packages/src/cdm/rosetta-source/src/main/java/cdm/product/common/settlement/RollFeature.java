 ...
 * @version 6.23.0
 */
@RosettaDataType(value="RollFeature", builder=RollFeature.RollFeatureBuilderImpl.class, version="6.23.0")
@RuneDataType(value="RollFeature", model="cdm", builder=RollFeature.RollFeatureBuilderImpl.class, version="6.23.0")
public interface RollFeature extends RosettaModelObject {
	...
	class RollFeatureImpl implements RollFeature {
		...
		@RuneAttribute("rollSourceCalendar")
	...
	class RollFeatureBuilderImpl implements RollFeature.RollFeatureBuilder {
		...
		@RuneAttribute("rollSourceCalendar")
		@Override
		public RollFeature.RollFeatureBuilder setRollSourceCalendar(RollSourceCalendarEnum _rollSourceCalendar) {
		...
		@RuneAttribute("deliveryDateRollConvention")
		@Override
		public RollFeature.RollFeatureBuilder setDeliveryDateRollConvention(Offset _deliveryDateRollConvention) {
