...
public class PerformanceValuationDatesMeta implements RosettaMetaData<PerformanceValuationDates> {
	...
	@Override
	public Validator<? super PerformanceValuationDates> validator(ValidatorFactory factory) {
		return factory.<PerformanceValuationDates>create(PerformanceValuationDatesValidator.class);
	}

	@Override
	public Validator<? super PerformanceValuationDates> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PerformanceValuationDates>create(PerformanceValuationDatesTypeFormatValidator.class);
	}
