...
public class InvstmtDcsnPrsnMeta implements RosettaMetaData<InvstmtDcsnPrsn> {
	...
	@Override
	public Validator<? super InvstmtDcsnPrsn> validator(ValidatorFactory factory) {
		return factory.<InvstmtDcsnPrsn>create(InvstmtDcsnPrsnValidator.class);
	}

	@Override
	public Validator<? super InvstmtDcsnPrsn> typeFormatValidator(ValidatorFactory factory) {
		return factory.<InvstmtDcsnPrsn>create(InvstmtDcsnPrsnTypeFormatValidator.class);
	}
