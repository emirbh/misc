...
public class CalculationPeriodBaseMeta implements RosettaMetaData<CalculationPeriodBase> {
	...
	@Override
	public Validator<? super CalculationPeriodBase> validator(ValidatorFactory factory) {
		return factory.<CalculationPeriodBase>create(CalculationPeriodBaseValidator.class);
	}

	@Override
	public Validator<? super CalculationPeriodBase> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CalculationPeriodBase>create(CalculationPeriodBaseTypeFormatValidator.class);
	}
