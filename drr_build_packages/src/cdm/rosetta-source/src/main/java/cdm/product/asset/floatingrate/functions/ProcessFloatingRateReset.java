...
public class ProcessFloatingRateReset implements RosettaFunction {
	...
	@ImplementedBy(ProcessFloatingRateReset.ProcessFloatingRateResetSCREEN.ProcessFloatingRateResetSCREENDefault.class)
	public static abstract class ProcessFloatingRateResetSCREEN implements RosettaFunction {
		...
		*/
		...
		public static class ProcessFloatingRateResetSCREENDefault extends ProcessFloatingRateReset.ProcessFloatingRateResetSCREEN {
			@Override
			...
			protected MapperS<? extends FloatingRateSpecification> rateDef(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				return MapperS.of(interestRatePayout).<RateSpecification>map("getRateSpecification", _interestRatePayout -> _interestRatePayout.getRateSpecification()).<FloatingRateSpecification>map("getFloatingRateSpecification", rateSpecification -> rateSpecification.getFloatingRateSpecification());
			}
		}
	}
	@ImplementedBy(ProcessFloatingRateReset.ProcessFloatingRateResetMODULAR.ProcessFloatingRateResetMODULARDefault.class)
	public static abstract class ProcessFloatingRateResetMODULAR implements RosettaFunction {
		...
		*/
		...
		protected abstract MapperS<? extends FieldWithMetaDayCountFractionEnum> dayCount(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType);
	
		protected abstract MapperS<? extends ReferenceWithMetaInterestRateIndex> fro(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType);
		...
		public static class ProcessFloatingRateResetMODULARDefault extends ProcessFloatingRateReset.ProcessFloatingRateResetMODULAR {
			@Override
			protected FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder doEvaluate(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder floatingRate = FloatingRateSettingDetails.builder();
				return assignOutput(floatingRate, interestRatePayout, calcPeriod, processingType);
			...
			protected FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder assignOutput(FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder floatingRate, InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				final ReferenceWithMetaInterestRateIndex referenceWithMetaInterestRateIndex = fro(interestRatePayout, calcPeriod, processingType).get();
				final FieldWithMetaDayCountFractionEnum fieldWithMetaDayCountFractionEnum = dayCount(interestRatePayout, calcPeriod, processingType).get();
				floatingRate = toBuilder(evaluateCalculatedRate.evaluate((referenceWithMetaInterestRateIndex == null ? null : referenceWithMetaInterestRateIndex.getValue()), calcParams(interestRatePayout, calcPeriod, processingType).get(), resetDates(interestRatePayout, calcPeriod, processingType).get(), calcPeriod, priorCalculationPeriod(interestRatePayout, calcPeriod, processingType).get(), (fieldWithMetaDayCountFractionEnum == null ? null : fieldWithMetaDayCountFractionEnum.getValue())));
			...
			@Override
			protected MapperS<? extends FieldWithMetaDayCountFractionEnum> dayCount(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				return MapperS.of(interestRatePayout).<FieldWithMetaDayCountFractionEnum>map("getDayCountFraction", _interestRatePayout -> _interestRatePayout.getDayCountFraction());
			}
			
			@Override
			protected MapperS<? extends ReferenceWithMetaInterestRateIndex> fro(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				return rateDef(interestRatePayout, calcPeriod, processingType).<ReferenceWithMetaInterestRateIndex>map("getRateOption", floatingRateSpecification -> floatingRateSpecification.getRateOption());
			}
			...
			protected MapperS<? extends FloatingRateCalculationParameters> calcParams(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				return rateDef(interestRatePayout, calcPeriod, processingType).<FloatingRateCalculationParameters>map("getCalculationParameters", floatingRateSpecification -> floatingRateSpecification.getCalculationParameters());
			}
	...
	@ImplementedBy(ProcessFloatingRateReset.ProcessFloatingRateResetOIS.ProcessFloatingRateResetOISDefault.class)
	public static abstract class ProcessFloatingRateResetOIS implements RosettaFunction {
		...
		*/
		...
		public static class ProcessFloatingRateResetOISDefault extends ProcessFloatingRateReset.ProcessFloatingRateResetOIS {
			@Override
			protected FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder doEvaluate(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder floatingRate = FloatingRateSettingDetails.builder();
				return assignOutput(floatingRate, interestRatePayout, calcPeriod, processingType);
			...
			protected FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder assignOutput(FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder floatingRate, InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				final ReferenceWithMetaInterestRateIndex referenceWithMetaInterestRateIndex = fro(interestRatePayout, calcPeriod, processingType).get();
				final FieldWithMetaDayCountFractionEnum fieldWithMetaDayCountFractionEnum = dayCount(interestRatePayout, calcPeriod, processingType).get();
				floatingRate = toBuilder(evaluateCalculatedRate.evaluate((referenceWithMetaInterestRateIndex == null ? null : referenceWithMetaInterestRateIndex.getValue()), calcParams(interestRatePayout, calcPeriod, processingType).get(), resetDates(interestRatePayout, calcPeriod, processingType).get(), calcPeriod, calcPeriod, (fieldWithMetaDayCountFractionEnum == null ? null : fieldWithMetaDayCountFractionEnum.getValue())));
	...
	@ImplementedBy(ProcessFloatingRateReset.ProcessFloatingRateResetOVERNIGHT_AVG.ProcessFloatingRateResetOVERNIGHT_AVGDefault.class)
	public static abstract class ProcessFloatingRateResetOVERNIGHT_AVG implements RosettaFunction {
		...
		*/
		...
		protected abstract MapperS<? extends ReferenceWithMetaInterestRateIndex> rateOption(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType);
	
		protected abstract MapperS<? extends FloatingRateCalculationParameters> calcParams(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType);
	
		public static class ProcessFloatingRateResetOVERNIGHT_AVGDefault extends ProcessFloatingRateReset.ProcessFloatingRateResetOVERNIGHT_AVG {
			@Override
			protected FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder doEvaluate(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder floatingRate = FloatingRateSettingDetails.builder();
				return assignOutput(floatingRate, interestRatePayout, calcPeriod, processingType);
			...
			protected FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder assignOutput(FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder floatingRate, InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				final ReferenceWithMetaInterestRateIndex referenceWithMetaInterestRateIndex = rateOption(interestRatePayout, calcPeriod, processingType).get();
				final FieldWithMetaDayCountFractionEnum fieldWithMetaDayCountFractionEnum = dayCount(interestRatePayout, calcPeriod, processingType).get();
				floatingRate = toBuilder(evaluateCalculatedRate.evaluate((referenceWithMetaInterestRateIndex == null ? null : referenceWithMetaInterestRateIndex.getValue()), calcParams(interestRatePayout, calcPeriod, processingType).get(), resetDates(interestRatePayout, calcPeriod, processingType).get(), calcPeriod, calcPeriod, (fieldWithMetaDayCountFractionEnum == null ? null : fieldWithMetaDayCountFractionEnum.getValue())));
			...
			@Override
			protected MapperS<? extends ReferenceWithMetaInterestRateIndex> rateOption(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				return rateDef(interestRatePayout, calcPeriod, processingType).<ReferenceWithMetaInterestRateIndex>map("getRateOption", floatingRateSpecification -> floatingRateSpecification.getRateOption());
			}
	...
	@ImplementedBy(ProcessFloatingRateReset.ProcessFloatingRateResetCOMPOUND_INDEX.ProcessFloatingRateResetCOMPOUND_INDEXDefault.class)
	public static abstract class ProcessFloatingRateResetCOMPOUND_INDEX implements RosettaFunction {
		...
		*/
		...
		public static class ProcessFloatingRateResetCOMPOUND_INDEXDefault extends ProcessFloatingRateReset.ProcessFloatingRateResetCOMPOUND_INDEX {
			@Override
			protected FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder doEvaluate(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				FloatingRateSettingDetails.FloatingRateSettingDetailsBuilder floatingRate = FloatingRateSettingDetails.builder();
				return assignOutput(floatingRate, interestRatePayout, calcPeriod, processingType);
