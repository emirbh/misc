 ...
 * @version 6.23.0
 */
@RosettaDataType(value="OtherAgreement", builder=OtherAgreement.OtherAgreementBuilderImpl.class, version="6.23.0")
@RuneDataType(value="OtherAgreement", model="cdm", builder=OtherAgreement.OtherAgreementBuilderImpl.class, version="6.23.0")
public interface OtherAgreement extends RosettaModelObject {
	...
	class OtherAgreementImpl implements OtherAgreement {
		...
		@Accessor(AccessorType.GETTER)
		@Required
		@RuneAttribute("otherAgreementType")
	...
	class OtherAgreementBuilderImpl implements OtherAgreement.OtherAgreementBuilder {
		...
		@RuneAttribute("identifier")
		@Override
		public OtherAgreement.OtherAgreementBuilder setIdentifier(FieldWithMetaString _identifier) {
			this.identifier = _identifier == null ? null : _identifier.toBuilder();
			return this;
		}
		
		@Override
		public OtherAgreement.OtherAgreementBuilder setIdentifierValue(String _identifier) {
		...
		@RuneAttribute("otherAgreementType")
		@Override
		public OtherAgreement.OtherAgreementBuilder setOtherAgreementType(FieldWithMetaString _otherAgreementType) {
			this.otherAgreementType = _otherAgreementType == null ? null : _otherAgreementType.toBuilder();
			return this;
		}
		
		@Override
		public OtherAgreement.OtherAgreementBuilder setOtherAgreementTypeValue(String _otherAgreementType) {
			this.getOrCreateOtherAgreementType().setValue(_otherAgreementType);
			return this;
		}
		...
		@RuneAttribute("version")
		@Override
		public OtherAgreement.OtherAgreementBuilder setVersion(FieldWithMetaString _version) {
			this.version = _version == null ? null : _version.toBuilder();
			return this;
		}
		
		@Override
		public OtherAgreement.OtherAgreementBuilder setVersionValue(String _version) {
			this.getOrCreateVersion().setValue(_version);
			return this;
		}
		...
		@RuneAttribute("date")
		@Override
		public OtherAgreement.OtherAgreementBuilder setDate(Date _date) {
