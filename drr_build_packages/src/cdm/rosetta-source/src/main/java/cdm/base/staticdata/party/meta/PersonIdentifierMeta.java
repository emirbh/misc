...
public class PersonIdentifierMeta implements RosettaMetaData<PersonIdentifier> {
	...
	@Override
	public Validator<? super PersonIdentifier> validator(ValidatorFactory factory) {
		return factory.<PersonIdentifier>create(PersonIdentifierValidator.class);
	}

	@Override
	public Validator<? super PersonIdentifier> typeFormatValidator(ValidatorFactory factory) {
		return factory.<PersonIdentifier>create(PersonIdentifierTypeFormatValidator.class);
	}
