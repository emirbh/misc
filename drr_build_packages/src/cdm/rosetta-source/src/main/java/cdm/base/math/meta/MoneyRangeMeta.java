...
import cdm.base.math.validation.datarule.MoneyRangeAtLeastOneOf;
...
public class MoneyRangeMeta implements RosettaMetaData<MoneyRange> {
	...
	public List<Validator<? super MoneyRange>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<MoneyRange>create(MoneyRangeAtLeastOneOf.class)
		);
	}
	...
	@Override
	public Validator<? super MoneyRange> validator(ValidatorFactory factory) {
		return factory.<MoneyRange>create(MoneyRangeValidator.class);
	}

	@Override
	public Validator<? super MoneyRange> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MoneyRange>create(MoneyRangeTypeFormatValidator.class);
	}
