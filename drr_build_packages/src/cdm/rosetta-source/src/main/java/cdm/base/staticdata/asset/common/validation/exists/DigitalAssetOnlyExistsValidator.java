...
public class DigitalAssetOnlyExistsValidator implements ValidatorWithArg<DigitalAsset, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends DigitalAsset> ValidationResult<DigitalAsset> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("DigitalAsset", ValidationResult.ValidationType.ONLY_EXISTS, "DigitalAsset", path, "");
		}
		return failure("DigitalAsset", ValidationResult.ValidationType.ONLY_EXISTS, "DigitalAsset", path, "",
