 ...
 * @version 6.23.0
 */
@RosettaDataType(value="Asset", builder=Asset.AssetBuilderImpl.class, version="6.23.0")
@RuneDataType(value="Asset", model="cdm", builder=Asset.AssetBuilderImpl.class, version="6.23.0")
@RuneChoiceType
