...
public class CollateralTaxonomyValueMeta implements RosettaMetaData<CollateralTaxonomyValue> {
	...
	public List<Validator<? super CollateralTaxonomyValue>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<CollateralTaxonomyValue>create(CollateralTaxonomyValueOneOf0.class)
		);
	}
	...
	@Override
	public Validator<? super CollateralTaxonomyValue> validator(ValidatorFactory factory) {
		return factory.<CollateralTaxonomyValue>create(CollateralTaxonomyValueValidator.class);
	}

	@Override
	public Validator<? super CollateralTaxonomyValue> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CollateralTaxonomyValue>create(CollateralTaxonomyValueTypeFormatValidator.class);
	}
