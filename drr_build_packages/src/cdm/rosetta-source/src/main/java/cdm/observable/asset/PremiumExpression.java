 ...
 * @version 6.23.0
 */
@RosettaDataType(value="PremiumExpression", builder=PremiumExpression.PremiumExpressionBuilderImpl.class, version="6.23.0")
@RuneDataType(value="PremiumExpression", model="cdm", builder=PremiumExpression.PremiumExpressionBuilderImpl.class, version="6.23.0")
public interface PremiumExpression extends RosettaModelObject {
	...
	class PremiumExpressionBuilderImpl implements PremiumExpression.PremiumExpressionBuilder {
		...
		@RuneAttribute("premiumType")
		@Override
		public PremiumExpression.PremiumExpressionBuilder setPremiumType(PremiumTypeEnum _premiumType) {
		...
		@RuneAttribute("pricePerOption")
		@Override
		public PremiumExpression.PremiumExpressionBuilder setPricePerOption(Money _pricePerOption) {
		...
		@RuneAttribute("percentageOfNotional")
		@Override
		public PremiumExpression.PremiumExpressionBuilder setPercentageOfNotional(BigDecimal _percentageOfNotional) {
