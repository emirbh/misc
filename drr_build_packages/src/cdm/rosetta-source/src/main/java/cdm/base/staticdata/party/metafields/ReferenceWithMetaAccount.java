...
@RuneDataType(value="ReferenceWithMetaAccount", model="cdm", builder=ReferenceWithMetaAccount.ReferenceWithMetaAccountBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaAccount extends RosettaModelObject, ReferenceWithMeta<Account> {
	...
	class ReferenceWithMetaAccountBuilderImpl implements ReferenceWithMetaAccount.ReferenceWithMetaAccountBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaAccount.ReferenceWithMetaAccountBuilder setValue(Account _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaAccount.ReferenceWithMetaAccountBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaAccount.ReferenceWithMetaAccountBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaAccount.ReferenceWithMetaAccountBuilder setReference(Reference _reference) {
