...
public class SellrMeta implements RosettaMetaData<Sellr> {
	...
	@Override
	public Validator<? super Sellr> validator(ValidatorFactory factory) {
		return factory.<Sellr>create(SellrValidator.class);
	}

	@Override
	public Validator<? super Sellr> typeFormatValidator(ValidatorFactory factory) {
		return factory.<Sellr>create(SellrTypeFormatValidator.class);
	}
