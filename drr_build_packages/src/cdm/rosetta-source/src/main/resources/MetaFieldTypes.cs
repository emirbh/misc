...
public class Reference
{
    ...
    public class BasicReferenceWithMetaPayout : IReferenceWithMeta<Payout>
    {
        [JsonConstructor]
        public BasicReferenceWithMetaPayout(Payout? value, string? globalReference, string? externalReference, Reference? address)
        {
            Value = value;
            GlobalReference = globalReference;
            ExternalReference = externalReference;
    ...
    public class BasicReferenceWithMetaInterestRateIndex : IReferenceWithMeta<InterestRateIndex>
    {
        [JsonConstructor]
        public BasicReferenceWithMetaInterestRateIndex(InterestRateIndex? value, string? globalReference, string? externalReference, Reference? address)
        {
            Value = value;
            GlobalReference = globalReference;
            ExternalReference = externalReference;
    ...
    public class BasicReferenceWithMetaObservable : IReferenceWithMeta<Observable>
    {
        [JsonConstructor]
        public BasicReferenceWithMetaObservable(Observable? value, string? globalReference, string? externalReference, Reference? address)
        {
            Value = value;
            GlobalReference = globalReference;
            ExternalReference = externalReference;
    ...
    public class FieldWithMetaBrokerConfirmationTypeEnum : IEnumFieldWithMeta<Enums.BrokerConfirmationType>
    {
        [JsonConstructor]
        public FieldWithMetaBrokerConfirmationTypeEnum(Enums.BrokerConfirmationType value, MetaFields? meta)
        {
            Value = value;
            Meta = meta;
        }
        ...
        [JsonConverter(typeof(StringEnumConverter))]
        public Enums.BrokerConfirmationType Value { get; }
