...
case class ReferenceWithMetaString(value: Option[String],
    globalReference: Option[String],
    externalReference: Option[String],
    address: Option[Reference]) {}
...
case class ReferenceWithMetaLocalDate(value: Option[java.time.LocalDate],
    globalReference: Option[String],
    externalReference: Option[String],
    address: Option[Reference]) {}
...
case class FieldWithMetaBrokerConfirmationTypeEnum(@JsonDeserialize(contentAs = classOf[BrokerConfirmationTypeEnum.Value])
    @JsonScalaEnumeration(classOf[BrokerConfirmationTypeEnum.Class])
    value: Option[BrokerConfirmationTypeEnum.Value],
    meta: Option[MetaFields]) {}
