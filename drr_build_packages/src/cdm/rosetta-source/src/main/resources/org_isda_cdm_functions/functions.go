...
func Create_CashflowFromPayout(payout Payout ) []Cashflow {    
/**
 * Function definition for Create_CashflowFromPayout
 */
return []Cashflow{}
}
...
func Create_TerminationInstruction(tradeState TradeState, effectiveDate *AdjustableOrRelativeDate ) PrimitiveInstruction {    
/**
...
func CreditDefaultPayoutOnlyExists(payouts *Payout ) bool {    
/**
 * Function definition for CreditDefaultPayoutOnlyExists
 */
return false
}

func CreditSupportAmount(marginAmount Money, threshold Money, marginApproach MarginApproachEnum, marginAmountIA *Money, baseCurrency string ) Money {    
/**
...
func DeliveryAmount(postedCreditSupportItems *PostedCreditSupportItem, priorDeliveryAmountAdjustment Money, priorReturnAmountAdjustment Money, disputedTransferredPostedCreditSupportAmount Money, marginAmount Money, threshold Money, marginApproach MarginApproachEnum, marginAmountIA *Money, minimumTransferAmount Money, rounding CollateralRounding, disputedDeliveryAmount Money, baseCurrency string ) Money {    
/**
...
func FilterChangePriceQuantity(priceQuantity *PriceQuantity, change *PriceQuantity ) *PriceQuantity {    
/**
...
func FilterInvalidFloatingRateIndexTradeDate(tradeState TradeState ) *FloatingRateIndexEnum {    
/**
...
func OptionPayoutOnlyExists(payouts *Payout ) bool {    
/**
...
func PostedCreditSupportItemAmount(postedItem PostedCreditSupportItem, baseCurrency string ) Money {    
/**
...
func PriceUnitEquals(p1 *PriceSchedule, p2 *PriceSchedule ) bool {    
/**
...
func Qualify_Commodity_Option_NonStandard(economicTerms EconomicTerms ) bool {    
/**
...
func Qualify_Credit_Option_NonStandard(economicTerms EconomicTerms ) bool {    
/**
...
func Qualify_EquityForward_PriceReturnBasicPerformance_Basket(economicTerms EconomicTerms ) bool {    
/**
 * Function definition for Qualify_EquityForward_PriceReturnBasicPerformance_Basket
 */
return false
}

func Qualify_EquityForward_PriceReturnBasicPerformance_SingleIndex(economicTerms EconomicTerms ) bool {    
/**
 * Function definition for Qualify_EquityForward_PriceReturnBasicPerformance_SingleIndex
 */
return false
}

func Qualify_EquityForward_PriceReturnBasicPerformance_SingleName(economicTerms EconomicTerms ) bool {    
/**
 * Function definition for Qualify_EquityForward_PriceReturnBasicPerformance_SingleName
 */
return false
}
...
func Qualify_Equity_OtherForward(economicTerms EconomicTerms ) bool {    
/**
...
func Qualify_Equity_Swap_NonStandard(economicTerms EconomicTerms ) bool {    
/**
...
func Qualify_TotalReturnSwap_Index(economicTerms EconomicTerms ) bool {    
/**
...
func ReturnAmount(postedCreditSupportItems *PostedCreditSupportItem, priorDeliveryAmountAdjustment Money, priorReturnAmountAdjustment Money, disputedTransferredPostedCreditSupportAmount Money, marginAmount Money, threshold Money, marginApproach MarginApproachEnum, marginAmountIA *Money, minimumTransferAmount Money, rounding CollateralRounding, disputedReturnAmount Money, baseCurrency string ) Money {    
/**
...
func UndisputedAdjustedPostedCreditSupportAmount(postedCreditSupportItems *PostedCreditSupportItem, priorDeliveryAmountAdjustment Money, priorReturnAmountAdjustment Money, disputedTransferredPostedCreditSupportAmount Money, baseCurrency string ) Money {    
/**
...
func UnitEquals(u1 *UnitType, u2 *UnitType ) bool {    
/**
...
func UpdateAmount(oldAmount *float64, changeAmount *float64, direction QuantityChangeDirectionEnum ) *float64 {    
/**
...
func UpdateAmountForEachMatchingQuantity(priceQuantityList PriceQuantity, change PriceQuantity, direction QuantityChangeDirectionEnum ) PriceQuantity {    
/**
...
func UpdatePriceAmountForEachMatchingQuantity(price *PriceSchedule, change *PriceSchedule, direction QuantityChangeDirectionEnum ) *PriceSchedule {    
/**
...
func UpdateQuantityAmountForEachMatchingQuantity(quantity *NonNegativeQuantitySchedule, change *NonNegativeQuantitySchedule, direction QuantityChangeDirectionEnum ) *NonNegativeQuantitySchedule {    
/**
...
func ValidateFloatingRateIndexName(floatingRateIndexName FloatingRateIndexEnum, contractualDefs *ContractualDefinitionsEnum ) bool {    
/**
