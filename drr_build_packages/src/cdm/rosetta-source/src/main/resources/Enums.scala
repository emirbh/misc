...
/**
  ...
  */
object AdditionalTypeEnum extends Enumeration {
    ...
    /**
      ...
      */
    val EQUITY_OPTION_OR_INDEX_OPTION = Value
...
/**
  ...
  */
object AmendmentEffectiveDateEnum extends Enumeration {
...
/**
  ...
  */
object BrokerConfirmationTypeEnum extends Enumeration {
    ...
    /**
      ...
      */
    val DJ_CDX_EM_ = Value("DJ.CDX.EM ")
...
/**
  ...
  */
object CashCTSTimeEnum extends Enumeration {
    ...
    /**
      ...
      */
    val FIRST_LBD = Value("First Local Business Day")
    ...
    /**
      ...
      */
    val SECOND_LBD = Value("Second Local Business Day")
}
...
object CollateralAssetDefinitionsEnum extends Enumeration {
    ...
    /**
      ...
      */
    val DE_ERBLAST = Value("DE-ERBLAST")
    
    /**
      * Kommunalschuldverschreib  ungen (Municipal Bonds).
      */
    val DE_MUNI = Value("DE-MUNI")
    
    /**
      * Bundesschatzanweisungen (Notes).
      */
    val DE_NOTE2 = Value("DE-NOTE2")
    
    /**
      * Bundesobligationen (Notes).
      */
    val DE_NOTE5_5 = Value("DE-NOTE5.5")
    
    /**
      * Hypothekenpfandbriefe (Mortgage Bonds).
      */
    val DE_PFAND = Value("DE-PFAND")
    
    /**
      * Skatkammerbeviser (Treasury Bills).
      */
    val DK_BILL = Value("DK-BILL")
    
    /**
      * BoligX obligationer.
      */
    val DK_BOLIGX = Value("DK-BOLIGX")
    
    /**
      * Statsobligationer (Government Bonds).
      */
    val DK_BOND = Value("DK-BOND")
    
    /**
      * Callable Mortgage Bonds.
      */
    val DK_CALLMORT = Value("DK-CALLMORT")
    
    /**
      * Danish Krone (DKK) Cash.
      */
    val DK_CASH = Value("DK-CASH")
    
    /**
      * KFX Equity Securities.
      */
    val DK_KFX = Value("DK-KFX")
    
    /**
      * Non-callable Mortgage Bonds.
      */
    val DK_MORT = Value("DK-MORT")
    
    /**
      * Statsgaeldsbeviser (Treasury Notes).
      */
    val DK_NOTE = Value("DK-NOTE")
    
    /**
      * Treasury Bills - Letras del Tesoro.
      */
    val ES_BILL = Value("ES-BILL")
    
    /**
      * Public Government Debt.
      */
    val ES_BOND = Value("ES-BOND")
    
    /**
      * Cedulas.
      */
    val ES_CEDULAS = Value("ES-CEDULAS")
    
    /**
      * Corporate Bonds.
      */
    val ES_CORP = Value("ES-CORP")
    ...
    /**
      ...
      */
    val IT_CCT = Value("IT-CCT")
    
    /**
      * Corporate bonds.
      */
    val IT_CORP = Value("IT-CORP")
    ...
    /**
      ...
      */
    val US_S_P400 = Value("US-S&P400")
    
    /**
      * Standard & Poors 500 Index Equity Securities.
      */
    val US_S_P500 = Value("US-S&P500")
    
    /**
      * Standard & Poors Smallcap 600 Index Equity Securities.
      */
    val US_S_P600 = Value("US-S&P600")
    
    /**
      * US Treasury Bills.
      */
    val US_TBILL = Value("US-TBILL")
    
    /**
      * US Treasury Bonds.
      */
    val US_TBOND = Value("US-TBOND")
    
    /**
      * US Treasury Inflation Protected Issues (TIPS).
      */
    val US_TIPS = Value("US-TIPS")
    
    /**
      * US Treasury Notes.
      */
    val US_TNOTE = Value("US-TNOTE")
    
    /**
      * Tennessee Valley Authority (TVA) Bonds.
      */
    val US_TVA = Value("US-TVA")
}
...
/**
  ...
  */
object CreditSupportAmountEnum extends Enumeration {
    
    class Class extends TypeReference[this.type]
    
    val IA_FLOOR_GIA = Value("Non-Standard - IA Floor (Less GiverIA)")
    
    val IA_FLOOR_GIATIA = Value("Non-Standard - IA Floor (Less GiverIA and TakerIA)")
    
    val NON_STANDARD_OTHER = Value("Non-Standard - Other")
    
    val NON_STANDARD_RATINGS = Value("Non-Standard - Ratings")
...
object DeterminationMethodEnum extends Enumeration {
    ...
    /**
      * TWAP VE Calculated by Excluding Closing price.
      */
    val TWAPVE_EXCLUDING_CLOSE = Value
    ...
    /**
      * VWAP VE Calculated by Excluding Closing price.
      */
    val VWAPVE_EXCLUDING_CLOSE = Value
...
/**
  ...
  */
object DeterminationRoleEnum extends Enumeration {
...
/**
  ...
  */
object ElectiveAmountEnum extends Enumeration {
...
/**
  ...
  */
object EntityIdentifierTypeEnum extends Enumeration {
...
/**
  ...
  */
object ExposureScopeProductEnum extends Enumeration {
    ...
    /**
      ...
      */
    val CURRENCY_OPTION_TRANSACTIONS = Value("Currency Option Transactions")
    
    /**
      * FX Transactions with Settlement date.
      */
    val FX_SETTLEMENT_DATE = Value("FX Transaction with Settlement Date")
    
    /**
      * FX Transactions.
      */
    val FX_TRANSACTIONS = Value("FX Transactions")
}
...
object FloatingRateIndexEnum extends Enumeration {
    ...
    /**
      * Per 2021 ISDA Interest Rate Derivatives Definitions Floating Rate Matrix and 2006 ISDA Definitions, Section 7.1 Rate Options, as amended and supplemented through the date on which parties enter into the relevant transaction.
      */
    val INR_SORR = Value("INR-SORR")
    
    /**
      * Per 2021 ISDA Interest Rate Derivatives Definitions Floating Rate Matrix and 2006 ISDA Definitions, Section 7.1 Rate Options, as amended and supplemented through the date on which parties enter into the relevant transaction.
      */
    val INR_SORR_OIS_COMPOUND = Value("INR-SORR-OIS Compound")
    ...
    /**
      * Per 2021 ISDA Interest Rate Derivatives Definitions Floating Rate Matrix, as amended through the date on which parties enter into the relevant transaction.
      */
    val PLN_POLSTR = Value("PLN-POLSTR")
    
    /**
      * Per 2021 ISDA Interest Rate Derivatives Definitions Floating Rate Matrix, as amended through the date on which parties enter into the relevant transaction.
      */
    val PLN_POLSTR_OIS_COMPOUND = Value("PLN-POLSTR-OIS Compound")
...
/**
  ...
  */
object FxForceMajeureOrActOfSStateEnum extends Enumeration {
    
    class Class extends TypeReference[this.type]
    
    val TO_BE_TREATED_AS_DISRUPTION_EVENT = Value
    
    val TO_BE_TREATED_AS_FORCE_MAJEURE_OR_ACT_OF_S_STATE = Value
}
...
/**
  ...
  */
object FxIllegalityOrImpossibilityEnum extends Enumeration {
    
    class Class extends TypeReference[this.type]
    
    val TO_BE_TREATED_AS_DISRUPTION_EVENT = Value
    
    val TO_BE_TREATED_AS_ILLEGALITY_OR_IMPOSSIBILITY = Value
}

object FxSubstitutionProvisionTypeEnum extends Enumeration {
    
    class Class extends TypeReference[this.type]
    
    val LOCAL_ASSET_SUBSTITUTE_GROSS = Value
    
    val LOCAL_ASSET_SUBSTITUTE_NET = Value
    
    val LOCAL_CURRENCY_SUBSTITUTE = Value
}
...
/**
  ...
  */
object HoldingPostedCollateralEnum extends Enumeration {
    ...
    /**
      ...
      */
    val ACCEPTABLE_CUSTODIAN = Value
}
...
/**
  ...
  */
object IndependentAmountEligibilityEnum extends Enumeration {
    ...
    /**
      ...
      */
    val NONE_UNLESS_SPECIFIED_IN_CONFIRMATION = Value
}
...
/**
  ...
  */
object InterestAdjustmentPeriodicityEnum extends Enumeration {
    ...
    /**
      ...
      */
    val LAST_LOCAL_BUSINESS_DAY_OF_MONTH = Value
}
...
/**
  ...
  */
object LegacyConsentEnum extends Enumeration {
...
/**
  ...
  */
object LegacyDeliveryReturnAmountEnum extends Enumeration {
    ...
    /**
      ...
      */
    val NON_STANDARD_OTHER = Value
    
    /**
      * Election includes non-standard ratings-based langauge.
      */
    val NON_STANDARD_RATINGS = Value
...
/**
  ...
  */
object LegacyResolutionAlternativeEnum extends Enumeration {
...
object LegacyVMCustodianEnum extends Enumeration {
    ...
    /**
      ...
      */
    val AS_ADVISED_1_TO_2 = Value("As advised by Party 1 to Party 2")
    
    /**
      * The Custodian as advised by Party 2 to Party 1.
      */
    val AS_ADVISED_2_TO_1 = Value("As advised by Party 2 to Party 1")
    
    /**
      * A named entity is specified as the Custodian.
      */
    val NAMED_ENTITY = Value
    ...
    /**
      ...
      */
    val PARTY_1_TO_PARTY_2 = Value("Party 1 will notify Party 2")
    
    /**
      * Party 2 will notify Party 1 of the custodian.
      */
    val PARTY_2_TO_PARTY_1 = Value("Party 2 will notify Party 1")
}

/**
  * Specifies how the Valuation Agent is determined.
  */
object LegacyValuationAgentEnum extends Enumeration {
...
/**
  ...
  */
object MTARatedPartyEnum extends Enumeration {
    ...
    /**
      ...
      */
    val ALL_AFFILIATES = Value("All Affiliates to the Party")
...
object MTAZeroEventEnum extends Enumeration {
    ...
    /**
      ...
      */
    val ADDITIONAL_TERMINATION_EVENT = Value
    
    /**
      * An Event of Default.
      */
    val EVENT_OF_DEFAULT = Value
    ...
    /**
      ...
      */
    val POTENTIAL_EVENT_OF_DEFAULT = Value
    
    /**
      * A Termination Event.
      */
    val TERMINATION_EVENT = Value
    
    /**
      * A Termination Event in respect of which all Transactions are Affected Transactions.
      */
    val TERMINATION_EVENT_ALL_AFFECTED_TRANSACTIONS = Value("A Termination Event in respect of which all Transactions are Affected Transactions")
}

/**
  * Values to specify the margin approach specific to Initial Margin agreements.
  */
object MarginApproachEnum extends Enumeration {
...
/**
  ...
  */
object NotRatedByEnum extends Enumeration {
...
/**
  ...
  */
object NumberOfRatingAgenciesEnum extends Enumeration {
...
/**
  ...
  */
object ProductGradeEnum extends Enumeration {
    ...
    /**
      ...
      */
    val ARABIAN_LIGHT = Value("Arabian-Light")
    
    /**
      * Applies to Oil Product Type Oil.
      */
    val BRASS_BLEND = Value("Brass-Blend")
    ...
    /**
      * Applies to Oil Product Type Oil.
      */
    val EDMONTON_HIGH_SULPHUR_SOUR = Value("Edmonton-High-Sulphur-Sour")
    
    /**
      * Applies to Oil Product Type Diesel Fuel.
      */
    val GERMAN_10_PPM = Value("German-10PPM")
    
    /**
      * Applies to Oil Product Type Oil.
      */
    val GULF_COAST_SWEET = Value("Gulf-Coast-Sweet")
    
    /**
      * Applies to Oil Product Type Oil.
      */
    val HARDISTY_LIGHT = Value("Hardisty-Light")
    
    /**
      * Applies to Oil Product Type Oil.
      */
    val IRANIAN_LIGHT = Value("Iranian-Light")
    
    /**
      * Applies to Oil Product Type Oil.
      */
    val IRANIAN_LIGHT_1 = Value("Iranian-Light")
    ...
    /**
      * Applies to Oil Product Type Oil.
      */
    val KIRKUK_LIGHT = Value("Kirkuk-Light")
    ...
    /**
      * Applies to Oil Product Type Oil.
      */
    val LIGHT_LOUISIANA_SWEET = Value("Light-Louisiana-Sweet")
    
    /**
      * Applies to Oil Product Type Diesel Fuel.
      */
    val LOW_SULPHUR = Value("Low-Sulphur")
    
    /**
      * Applies to Oil Product Type Jet Fuel.
      */
    val LOW_SULPHUR_JET = Value("Low-Sulphur-Jet")
    ...
    /**
      * Applies to Oil Product Type Oil.
      */
    val MIXED_SOUR_BLEND = Value("Mixed-Sour-Blend")
    
    /**
      * Applies to Oil Product Type Oil.
      */
    val MIXED_SWEET_BLEND = Value("Mixed-Sweet-Blend")
    ...
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val NATURAL_GASOLINE = Value("Natural-Gasoline")
    ...
    /**
      ...
      */
    val NO_6_0_3_PERCENT = Value("No.-6-0.3-Percent")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val NO_6_0_3_PERCENT_HP = Value("No.-6-0.3-Percent-HP")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val NO_6_0_3_PERCENT_LP = Value("No.-6-0.3-Percent-LP")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val NO_6_0_7_PERCENT = Value("No.-6-0.7-Percent")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val NO_6_1_0_PERCENT = Value("No.-6-1.0-Percent")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val NO_6_2_2_PERCENT = Value("No.-6-2.2-Percent")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val NO_6_3_PERCENT = Value("No.-6-3-Percent")
    
    /**
      * Applies to Oil Product Type Butane.
      */
    val NORMAL_BUTANE = Value("Normal-Butane")
    
    /**
      * Applies to Oil Product Type Oil.
      */
    val NORTH_DAKOTA_LIGHT = Value("North-Dakota-Light")
    ...
    /**
      ...
      */
    val POLYMER_GRADE = Value("Polymer-Grade")
    ...
    /**
      * Applies to Oil Product Type Oil.
      */
    val SOUTHERN_GREEN_CANYON = Value("Southern-Green-Canyon")
    ...
    /**
      * Applies to Oil Product Type Oil.
      */
    val THUNDER_HORSE = Value("Thunder-Horse")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val US_REGULAR_UNLEADED = Value("US-Regular-Unleaded")
    
    /**
      * Applies to Oil Product Type Diesel Fuel.
      */
    val ULTRA_LOW_SULPHUR = Value("Ultra-Low-Sulphur")
    ...
    /**
      * Applies to Oil Product Type Oil.
      */
    val URALS_SOUR = Value("Urals-Sour")
    ...
    /**
      * Applies to Oil Product Type Oil.
      */
    val WESTERN_CANADIAN_SELECT = Value("Western-Canadian-Select")
    ...
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val _0_1_PERCENT = Value("0.1-Percent")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val _0_5_PERCENT = Value("0.5-Percent")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _10_PPM = Value("10-PPM")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _10_PPM_95_R = Value("10-PPM-95-R")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _10_PPM_PREMIUM_UNLEADED = Value("10-PPM-Premium-Unleaded")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _10_PPM_REGULAR_UNLEADED = Value("10-PPM-Regular-Unleaded")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val _180_CST = Value("180-CST")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val _1_0_PERCENT = Value("1.0-Percent")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val _380_CST = Value("380-CST")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val _3_5_PERCENT = Value("3.5-Percent")
    
    /**
      * Applies to Oil Product Type Fuel Oil.
      */
    val _50_PPM = Value("50-PPM")
    ...
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _87_M = Value("87-M")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _87_UNLEADED = Value("87-Unleaded")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _87_UNLEADED_ULS_30 = Value("87-Unleaded-ULS-30")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _92_UNLEADED = Value("92-Unleaded")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _93_UNLEADED = Value("93-Unleaded")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _95_UNLEADED = Value("95-Unleaded")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _97_UNLEADED = Value("97-Unleaded")
    
    /**
      * Applies to Oil Product Type Gasoline.
      */
    val _98_UNLEADED = Value("98-Unleaded")
}
...
/**
  ...
  */
object RatingTypeEnum extends Enumeration {
...
/**
  ...
  */
object RecalculationOfValueElectionEnum extends Enumeration {
    ...
    /**
      ...
      */
    val CONSULATION_PROCEDURE = Value
    ...
    /**
      ...
      */
    val OTHER_REGULATORY_CSA_PROCEDURE = Value
...
/**
  ...
  */
object RegulatoryRegimeEnum extends Enumeration {
    ...
    /**
      ...
      */
    val AUSTRALIA_MARGIN_RULES = Value("Australia")
    ...
    /**
      ...
      */
    val CANADA_MARGIN_RULES = Value("Canada")
    ...
    /**
      ...
      */
    val EMIR_MARGIN_RULES = Value("EMIR")
    ...
    /**
      ...
      */
    val HONG_KONG_MARGIN_RULES = Value("Hong Kong")
    ...
    /**
      ...
      */
    val HONG_KONG_SFC_MARGIN_RULES = Value("Hong Kong SFC")
    ...
    /**
      ...
      */
    val SINGAPORE_MARGIN_RULES = Value("Singapore")
    ...
    /**
      ...
      */
    val SOUTH_AFRICA_MARGIN_RULES = Value("South Africa")
    ...
    /**
      ...
      */
    val SOUTH_KOREA_MARGIN_RULES = Value("South Korea")
    ...
    /**
      ...
      */
    val SWITZERLAND_MARGIN_RULES = Value("Switzerland")
    ...
    /**
      ...
      */
    val US_PRUDENTIAL_MARGIN_RULES = Value("Prudential")
    ...
    /**
      ...
      */
    val UNITED_KINGDOM_MARGIN_RULES = Value("United Kingdom")
}
...
/**
  ...
  */
object SecuritiesCTSTimeEnum extends Enumeration {
    ...
    /**
      ...
      */
    val FIRST_DAY = Value("First Local Business Day")
...
object SecurityInterestObligationsEnum extends Enumeration {
    ...
    /**
      ...
      */
    val ALL_OBLIGATIONS_OF_PARTY_A = Value("All Obligations of Party A")
    
    /**
      * All Obligations of Party B.
      */
    val ALL_OBLIGATIONS_OF_PARTY_B = Value("All Obligations of Party B")
...
/**
  ...
  */
object SecurityInterestObligeeEnum extends Enumeration {
    ...
    /**
      ...
      */
    val PARTY_A_OR_AFFILIATE = Value("Party A or any Affiliate of Party A")
    ...
    /**
      ...
      */
    val PARTY_B_OR_AFFILIATE = Value("Party B or any Affiliate of Party B")
}
...
/**
  ...
  */
object SensitivitiesEnum extends Enumeration {
...
/**
  ...
  */
object SimmExceptionApplicableEnum extends Enumeration {
...
object SpecifiedValueEnum extends Enumeration {
    
    class Class extends TypeReference[this.type]
    
    val FACE_VALUE = Value
    
    val MARKET_VALUE = Value
    
    val OUTSTANDING_PRINCIPAL_BALANCE = Value
    
    val STATED_PRINCIPAL_BALANCE = Value
}
...
/**
  ...
  */
object ThresholdRatedPartyEnum extends Enumeration {
...
/**
  ...
  */
object ThresholdZeroEventEnum extends Enumeration {
...
/**
  ...
  */
object ValuationAgentPartyEnum extends Enumeration {
...
object ValuationDateDateEnum extends Enumeration {
    ...
    /**
      * As Selected.
      */
    val AS_SELECTED = Value("As Selected")
    
    /**
      * A specific day of the calendar, defined.
      */
    val CALENDAR_DAY = Value
    ...
    /**
      * Specific Valuation date frequency.
      */
    val SECONDLAST = Value("2nd Last")
    
    /**
      * Specific Valuation date frequency.
      */
    val THIRDLAST = Value("3rd Last")
}

/**
  * Defines the conditions for the day for a Valuation Date.
  */
object ValuationDateDayEnum extends Enumeration {
    ...
    /**
      ...
      */
    val NEW_YORK_BANKING_DAY = Value("New York Banking Day")
...
/**
  ...
  */
object ValuationDateFrequencyEnum extends Enumeration {
    
    class Class extends TypeReference[this.type]
    
    val AS_AGREED = Value
    
    val AS_SELECTED = Value
    
    val DAILY = Value
    
    val FORTNIGHTLY = Value
...
/**
  ...
  */
object ValuationTimeDayEnum extends Enumeration {
    ...
    /**
      ...
      */
    val PREVIOUS_LOCAL_BUSINESS_DAY = Value("Previous Local Business Day")
    
    /**
      * Should be calculated relative to the previous local business day in the city of the Valuation Agent.
      */
    val PREVIOUS_LOCAL_BUSINESS_DAY_CITY_OF_AGENT = Value("Previous Local Business Day (City of Valuation Agent)")
    
    /**
      * Should be calculated relative to the previous local business day in the Relevant Market).
      */
    val PREVIOUS_LOCAL_BUSINESS_DAY_MARKET = Value("Previous Local Business Day (Relevant Market)")
    
    /**
      * Should be calculated on the Valuation Date.
      */
    val VALUATION_DATE = Value("Valuation Date")
}

/**
  * The type of time specified for the Valuation Time.
  */
object ValuationTimeEnum extends Enumeration {
...
/**
  ...
  */
object ValueCashEnum extends Enumeration {
    ...
    /**
      * Cash - Amount thereof.
      */
    val CASH_AMOUNT = Value("Cash - Amount Thereof")
    
    /**
      * Cash - amount thereof multiplied by Valuation Percentage.
      */
    val CASH_PERCENTAGE = Value("Cash - Amount Thereof multiplied by Valuation Percentage")
    
    /**
      * Cash - Amount Thereof multiplied by (Valuation Percentage - FX Haircut).
      */
    val CASH_PERCENTAGE_LESS_HAIRCUT = Value("Cash - Amount Thereof multiplied by (Valuation Percentage - FX Haircut)")
...
/**
  ...
  */
object ValueSecuritiesEnum extends Enumeration {
    ...
    /**
      ...
      */
    val BID_PRICE_PERCENTAGE = Value("Securities - Bid Price multiplied by Valuation Percentage")
    
    /**
      * Securities collateral is valued using the bid price multiplied by the valuation percentage less the FX haircut.
      */
    val BID_PRICE_PERCENTAGE_LESS_HAIRCUT = Value("Securities - Bid Price multiplied by (Valuation Percentage - FX Haircut)")
    
    /**
      * Securities collateral is valued using the mid price multiplied by the valuation percentage.
      */
    val MID_PRICE_PERCENTAGE = Value("Securities - Mid Price multiplied by Valuation Percentage")
    
    /**
      * Securities collateral is valued using the mid price multiplied by the valuation percentage less the FX haircut.
      */
    val MID_PRICE_PERCENTAGE_LESS_HAIRCUT = Value("Securities - Mid Price multiplied by (Valuation Percentage - FX Haircut)")
