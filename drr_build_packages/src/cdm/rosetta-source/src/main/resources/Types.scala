...
/**
  ...
  *
  * @param partyElection The parties' Access Condition (Initial Margin CSA) or a Specified Condition (Variation Margin CSA) election.
  * @param additionalTerminationEvent Additional Termination Events applicable to the agreement.
  */
case class AccessConditions(partyElection: List[AccessConditionsElections],
    additionalTerminationEvent: List[AdditionalTerminationEvent]) {
}

/**
  * A class to specify the Termination Events that will be deemed an Access Condition or a Specified Condition.
  *
  * @param party The elective party.
  * @param illegality Represents an illegality Termination Event.
  * @param forceMajeure Represents a force Majeure Termination Event.
  * @param taxEvent Represents a Tax Termination Event.
  * @param taxEventUponMerger Represents a Tax Event Upon Merger Termination Event.
  * @param creditEventUponMerger Represents a Credit Event Upon Merger Termination Event.
  */
case class AccessConditionsElections(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    illegality: Boolean,
...
/**
  ...
  *
  * @param changeInLaw 
  * @param failureToDeliver 
  * @param insolvencyFiling 
  * @param hedgingDisruption 
  * @param increasedCostOfHedging 
  * @param foreignOwnershipEvent 
  * @param lossOfStockBorrow 
  ...
  * @param increasedCostOfStockBorrow 
...
/**
  ...
  *
  * @param party The party that the additional obligations apply to.
  * @param additionalObligations The party specific additional obligations applicable to the agreement.
  */
case class AdditionalObligations(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
...
/**
  ...
  *
  * @param partyElection A qualification as to whether the Additional Representation is applicable.
  * @param customElection A supplemental custom election that might be specified by the parties for the purpose of specifying the Additional Representation.
  */
case class AdditionalRepresentation(partyElection: List[AdditionalRepresentationElection],
...
/**
  ...
  *
  * @param party The elective party.
  * @param isApplicable The Additional Representation is applicable when True, and not applicable when False.
  */
case class AdditionalRepresentationElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
...
/**
  ...
  *
  * @param additionalRepresentation The specification of the Additional Representation that may be applicable to the agreement.
  * @param regulatoryComplianceRepresentation The qualification of whether Additional Information related to Regulatory Compliance and Concentration Limits is applicable or not.
  */
case class AdditionalRepresentations(additionalRepresentation: Option[AdditionalRepresentation],
    regulatoryComplianceRepresentation: Option[Boolean]) {
}

/**
  * A class to specify the Pledgor/Obligor/Chargor Additional Rights Event election.
  *
  * @param isApplicable The Pledgor Additional Rights Event election is applicable when True, and not applicable when False.
  * @param qualification The qualification of the Pledgor Additional Rights Event election, when specified.
  */
case class AdditionalRightsEvent(isApplicable: Boolean,
...
/**
  ...
  *
  * @param name The name of the additional termination event.
  * @param applicableParty Whether the additional termination event is applicable for the relevant party.
  */
case class AdditionalTerminationEvent(name: String,
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    applicableParty: List[CounterpartyRoleEnum.Value]) {
}
...
/**
  ...
  *
  * @param standardValue The qualification of the Additional Type of transaction that can require the collection or delivery of initial margin when specified as a standard value.
  * @param customValue The qualification of the Additional Type of transaction that can require the collection or delivery of initial margin when specified as a custom value by the parties to the legal agreement.
  */
case class AdditionalType(@JsonScalaEnumeration(classOf[AdditionalTypeEnum.Class])
    standardValue: AdditionalTypeEnum.Value,
...
/**
  ...
  */
case class AdjustedRelativeDateOffset(periodMultiplier: Int,
    ...
    dateRelativeTo: Option[ReferenceWithMetaLocalDate],
    adjustedDate: Option[java.time.LocalDate],
    relativeDateAdjustments: Option[BusinessDayAdjustments],
    meta: Option[MetaFields])
...
/**
  ...
  * @param masterAgreementElections A legal representation of the different possible master agreements
  */
case class Agreement(creditSupportAgreementElections: Option[CreditSupportAgreementElections],
    ...
    masterAgreementElections: Option[MasterAgreementElections]) {
}
...
case class AgreementName(@JsonScalaEnumeration(classOf[LegalAgreementTypeEnum.Class])
    ...
    @JsonDeserialize(contentAs = classOf[BrokerConfirmationTypeEnum.Value])
    @JsonScalaEnumeration(classOf[BrokerConfirmationTypeEnum.Class])
    brokerConfirmationType: Option[BrokerConfirmationTypeEnum.Value]) {
}
...
/**
  ...
  *
  * @param date The effective date of the Amendment to Termination Currency when specified as an actual date.
  * @param specificDate The effective date of the Amendment to Termination Currency when specified as relative to another date (e.g. the annex date).
  * @param customProvision The effective date of the Amendment to Termination Currency when specified as a non normalized custom provision.
  */
case class AmendmentEffectiveDate(date: Option[java.time.LocalDate],
    @JsonDeserialize(contentAs = classOf[AmendmentEffectiveDateEnum.Value])
    @JsonScalaEnumeration(classOf[AmendmentEffectiveDateEnum.Class])
    specificDate: Option[AmendmentEffectiveDateEnum.Value],
...
/**
  ...
  */
case class AmountSchedule(value: scala.math.BigDecimal,
    datedValue: List[DatedValue],
    currency: List[FieldWithMetaString])
...
/**
  ...
  *
  * @param regime The applicable regulatory regime, as specified through an enumeration.
  * @param additionalRegime The additional regulatory regime as specified by the parties.
  * @param regimeTerms A class that is used by the ApplicableRegime and the AdditionalRegime classes to specify the terms that are specific to each party and regime which are referred to in the Regime Table as part of certain legal agreements, such as the ISDA 2016 and 2018 CSA for Initial Margin.
  * @param additionalType 
  * @param additionalTerms The bespoke Additional Type for the purposes of Covered Transactions (IM).
  */
case class ApplicableRegime(@JsonDeserialize(contentAs = classOf[RegulatoryRegimeEnum.Value])
    @JsonScalaEnumeration(classOf[RegulatoryRegimeEnum.Class])
    regime: Option[RegulatoryRegimeEnum.Value],
    additionalRegime: Option[String],
    regimeTerms: List[RegimeTerms],
    @JsonDeserialize(contentAs = classOf[AdditionalTypeEnum.Value])
    @JsonScalaEnumeration(classOf[AdditionalTypeEnum.Class])
    additionalType: Option[AdditionalTypeEnum.Value],
    additionalTerms: Option[String]) {
}

/**
  * A class to specify the Valuation of Appropriated Collateral.
  *
  * @param isSpecified The qualification of whether the Valuation of Appropriate Collateral provision is applicable (True) or not applicable (False).
  * @param election The parties' election that qualify the Valuation of Appropriate Collateral in the case where it is deemed applicable.
  */
case class AppropriatedCollateralValuation(isSpecified: Boolean,
...
/**
  ...
  * @param commodityGrade Grade of product being delivered (e.g., grade of oil).
  */
case class AssetDeliveryInformation(periods: Option[AssetDeliveryPeriods],
    ...
    @JsonScalaEnumeration(classOf[ProductGradeEnum.Class])
    commodityGrade: List[ProductGradeEnum.Value]) {
}
...
/**
  ...
  */
case class AssetPayout(payerReceiver: PayerReceiver,
...
/**
  ...
  *
  * @param fallbackAET Specifies whether automatic termination applies in the event of certain bankruptcy events.
  * @param indemnity Specifies whether indemnity applies in the event AET is applicable to one or both of the parties.
  * @param partyElection The party election specific to the Automatic Early Termination Clause.
  */
case class AutomaticEarlyTermination(fallbackAET: Boolean,
    indemnity: Boolean,
    partyElection: List[AutomaticEarlyTerminationElection]) {
}

/**
  * A class to specify the party elections specific to the Automatic Early Termination Clause.
  *
  * @param party The party for which the Automatic Early Termination provisions are being specified.
  * @param isApplicable A boolean election to specify whether the Automatic Early Termination provisions of Section 6(a) are applicable (True) or not applicable (False).
  */
case class AutomaticEarlyTerminationElection(party: Party,
    isApplicable: Boolean) {
}
...
/**
  ...
  */
case class AvailableInventoryRecord(identifer: AssignedIdentifier,
    security: Security,
    expirationDateTime: Option[java.time.ZonedDateTime],
...
/**
  ...
  */
case class Barrier(barrierCap: List[TriggerEvent],
    barrierFloor: List[TriggerEvent]) {
}

/**
  * The base and eligible currency(ies) for the document as specified by the parties to the agreement.
  *
  * @param baseCurrency The common agreed currency into which relevant amounts of all collateral arrangements between the parties are converted, or if not an actual currency, the process through which this is determined. Where hardcoded (e.g. under the 1994 ISDA Credit Support Annex (Security Interest  NY Law)), the currency that effectively performs this function.
  * @param baseCurrencyTerminationCurrency A flag detailing whether the Base Currency is set to  the Termination Currency as defined in the related  Master Agreement.
  * @param baseCurrencyOther Utilised where the clause data structure is not able to capture a material aspect of the clause.
  * @param eligibleCurrency A definition of a currency agreed by the parties, typically to indicate the currencies of eligible cash collateral.
  * @param eligibleCurrencyInclBaseCurrency A flag detailing whether the Base Currency is included as an Eligible Currency.
  * @param eligibleCurrencyOther Utilised where the clause data structure is not able to capture a material aspect of the clause.
  */
case class BaseAndEligibleCurrency(@JsonScalaEnumeration(classOf[ISOCurrencyCodeEnum.Class])
    baseCurrency: ISOCurrencyCodeEnum.Value,
    baseCurrencyTerminationCurrency: Boolean,
    baseCurrencyOther: Option[FieldWithMetaString],
    @JsonScalaEnumeration(classOf[ISOCurrencyCodeEnum.Class])
    eligibleCurrency: List[ISOCurrencyCodeEnum.Value],
    eligibleCurrencyInclBaseCurrency: Boolean,
    eligibleCurrencyOther: Option[FieldWithMetaString]) {
}
...
/**
  ...
  */
case class Basket(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
    basketConstituent: List[FieldWithMetaBasketConstituent])
  extends AssetBaseTrait {
}
...
/**
  ...
  */
case class BasketConstituent(asset: Option[Asset],
    basket: Option[Basket],
    index: Option[Index],
    quantity: List[ReferenceWithMetaNonNegativeQuantitySchedule],
...
/**
  ...
  *
  * @param isApplicable Additional Calculation Date terms are applicable when True and not applicable when False.
  * @param calculationDateImTerms The Additional Calculation Date terms for the purposes of Initial Margin.
  */
case class BespokeCalculationDate(isApplicable: Boolean,
    calculationDateImTerms: Option[String]) {
}

/**
  * A class to specify additional Calculation Time terms for the purposes of Initial Margin.
  *
  * @param asCalculationAgent If set to True, the Calculation Time for Initial Margin is the time as of which the Calculation Agent (IM) computes its end of day valuations of derivatives transactions.
  * @param bespokeCalculationTimeTerms Additional Terms applicable to Calculation Time for Initial Margin.
  */
case class BespokeCalculationTime(asCalculationAgent: Boolean,
    bespokeCalculationTimeTerms: Option[String]) {
}

/**
  * A class to specify any bespoke Transfer Timing language by each party to the agreement.
  *
  * @param isApplicable A boolean flag to specify whether bespoke transfer terms are applicable or not.
  * @param bespokeTransferTimingTerms The bespoke transfer timing terms applicable to the agreement.
  */
case class BespokeTransferTiming(isApplicable: Boolean,
    bespokeTransferTimingTerms: Option[String]) {
}
...
/**
  ...
  *
  * @param brokerConfirmationType The type of broker confirmation executed between the parties.
  */
case class BrokerConfirmation(brokerConfirmationType: FieldWithMetaBrokerConfirmationTypeEnum) {
}
...
case class BusinessCenterTime(hourMinuteTime: java.time.LocalTime,
  ...
  extends BusinessCenterTimeTrait {
}
...
/**
  ...
  */
case class BusinessDateRange(startDate: java.time.LocalDate,
    endDate: java.time.LocalDate,
    @JsonScalaEnumeration(classOf[BusinessDayConventionEnum.Class])
    businessDayConvention: BusinessDayConventionEnum.Value,
    businessCenters: Option[BusinessCenters])
...
/**
  ...
  * @param periodMultiplier A time period multiplier, e.g. 1, 2 or 3 etc. A negative value can be used when specifying an offset relative to another date, e.g. -2 days.
  * @param period A time period, e.g. a day, week, month or year of the stream. If the periodMultiplier value is 0 (zero) then period must contain the value D (day).
  * @param businessCenters The business centers for the offset.
  * @param fixingOffsetDefinition Legal text that underlies the Fixing Offset. ISDA Fixing Offset Definition. (e.g. One day that is either a Sydney Business Day or a Melbourne Business Day following the Reset Date)
  * @param fixingOffsetReason Fixing Offset Reason
  */
case class BusinessDayOffset(periodMultiplier: Int,
    @JsonScalaEnumeration(classOf[PeriodEnum.Class])
    period: PeriodEnum.Value,
    businessCenters: Option[BusinessCenters],
    fixingOffsetDefinition: Option[String],
    fixingOffsetReason: Option[String],
    meta: Option[MetaFields])
  extends BusinessDayOffsetTrait with PeriodTrait {
}
...
/**
  ...
  */
case class BusinessEvent(@JsonDeserialize(contentAs = classOf[EventIntentEnum.Value])
...
/**
  ...
  *
  * @param name The name of the Rating Agency.
  * @param value The value assigned to the rating.
  * @param amount The Minimum Transfer Amount (MTA) applicable to the Rating.
  * @param amountIsInfinity A flag that defines the Minimum Transfer Amount (MTA) as Infinity.
  */
case class CSAMTAVariableSet(@JsonDeserialize(contentAs = classOf[CreditRatingAgencyEnum.Value])
    @JsonScalaEnumeration(classOf[CreditRatingAgencyEnum.Class])
    name: Option[CreditRatingAgencyEnum.Value],
    value: Option[String],
    amount: Option[Int],
    amountIsInfinity: Option[Boolean]) {
}

case class CSAMinimumTransferAmount(mtaType: MTAType) {
}

case class CSAThreshold(thresholdType: ThresholdType) {
}

/**
  * Defines a combination of Rating Agency, Rating Value, Threshold amount and Currency code.
  *
  * @param name The relevant rating agency.
  * @param value Rating applicable to the party from a given rating agency.
  * @param amount The amount value applicable to the Threshold.
  */
case class CSAThresholdVariableSet(@JsonDeserialize(contentAs = classOf[CreditRatingAgencyEnum.Value])
    @JsonScalaEnumeration(classOf[CreditRatingAgencyEnum.Class])
    name: Option[CreditRatingAgencyEnum.Value],
    value: Option[String],
    amount: Option[Int]) {
...
/**
  ...
  *
  * @param party The party which is specified as Calculation Agent for Initial Margin.
  * @param bespokeCalculationAgentTerms The Calculation Agent (IM) terms when specified.
  */
case class CalculationAgentTerms(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: List[CounterpartyRoleEnum.Value],
    bespokeCalculationAgentTerms: Option[String]) {
}

/**
  * A class to specify the Calculation, Valuation and Timing terms specific to the agreement.
  *
  * @param calculationAgentTerms The calculation agent terms applicable to the agreement.
  * @param bespokeCalculationDate The specification of bespoke Calculation Date terms for the purposes of Initial or Variation Margin by the parties to the agreement.
  * @param bespokeCalculationTime Bespoke terms to describe the time as of which such party (or the Calculation Agent (IM) (if applicale)) computes its end of day valuations of derivatives transactions.
  * @param calculationDateLocation The specified location where the credit exposure will be calculated by the respective parties.
  * @param notificationTime The time by which a demand for the Transfer of Eligible Credit Support (IM) or Posted Credit Support (IM) needs to be made in order for the transfer to take place in accordance with the Transfer Timing provisions.
  * @param collateralValuationAgent The bespoke Collateral Valuation Agent terms applicable to the agreement.
  * @param cashSettlementDay 
  * @param securitiesSettlementDay 
  * @param legacyValuationDate Details of the days on which calculations are to be made to determine the Delivery Amount and/or Return Amount.
  * @param legacyValuationTime The time by which the value of the collateral and obligations to transfer or return collateral are to be calculated relative to the Valuation Date.
  * @param legacyValuationAgent Details of the party calculating the value of collateral to be delivered or returned.
  */
case class CalculationAndTiming(calculationAgentTerms: Option[CalculationAgentTerms],
    bespokeCalculationDate: Option[BespokeCalculationDate],
    bespokeCalculationTime: Option[BespokeCalculationTime],
    calculationDateLocation: Option[CalculationDateLocation],
    notificationTime: NotificationTime,
    collateralValuationAgent: Option[CollateralValuationAgent],
    cashSettlementDay: Option[String],
    securitiesSettlementDay: Option[String],
    legacyValuationDate: Option[LegacyValuationDate],
    legacyValuationTime: Option[LegacyValuationTime],
    legacyValuationAgent: Option[LegacyValuationAgent]) {
}

/**
  * A class to specify the ISDA SIMM Calculation Currency.
  *
  * @param party The party which the SIMM Calculation Currency qualification applies to.
  * @param isBaseCurrency The SIMM Calculation Currency (also known as SIMM Reporting Currency) means the Base Currency when True. It means a different currency when False. In that latter case, the SIMM Calculation Currency is specified as part of the currency attribute.
  * @param currency The currency in which the ISDA SIMM Calculation is denominated, when different from the Base Currency. The list of valid currencies is not presently positioned as an enumeration as part of the CDM because that scope is limited to the values specified by ISDA and FpML. As a result, implementers have to make reference to the relevant standard, such as the ISO 4217 standard for currency codes.
  */
case class CalculationCurrencyElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
...
/**
  ...
  *
  * @param partyElection The parties' calculation date location election.
  */
case class CalculationDateLocation(partyElection: List[CalculationDateLocationElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param businessCenter The Calculation Date Location when specified as a business center which corresponds to the FpML list of business centers or can be mapped to it.
  * @param customLocation The Calculation Date Location when specified a location which doesn't correspond to the FpML list of business centers or cannot be mapped to it.
  */
case class CalculationDateLocationElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    businessCenter: Option[FieldWithMetaBusinessCenterEnum],
...
/**
  ...
  */
case class CalculationPeriod(adjustedStartDate: Option[java.time.LocalDate],
    adjustedEndDate: Option[java.time.LocalDate],
    unadjustedStartDate: Option[java.time.LocalDate],
...
/**
  ...
  */
case class CalculationPeriodFrequency(periodMultiplier: Int,
    @JsonScalaEnumeration(classOf[PeriodExtendedEnum.Class])
    period: PeriodExtendedEnum.Value,
    @JsonScalaEnumeration(classOf[RollConventionEnum.Class])
...
/**
  ...
  * @param priceTimeIntervalQuantity Price per quantity per delivery time interval.
  */
case class CalculationScheduleDeliveryPeriods(profile: List[AssetDeliveryProfile],
    startDate: Option[java.time.LocalDate],
    endDate: Option[java.time.LocalDate],
    deliveryCapacity: Option[Quantity],
    priceTimeIntervalQuantity: Option[Price])
...
/**
  ...
  */
case class CancelableProvision(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    buyer: CounterpartyRoleEnum.Value,
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    seller: CounterpartyRoleEnum.Value,
    exerciseNotice: Option[ExerciseNotice],
...
/**
  ...
  */
case class Cashflow(quantity: NonNegativeQuantity,
    asset: Asset,
    settlementDate: AdjustableOrAdjustedOrRelativeDate,
...
/**
  ...
  * @param subcomponents Additional hierarchical components of the clause if relevant.
  */
...
/**
  ...
  *
  * @param isApplicable Collateral Access Breach terms are applicable when True and not applicable when False.
  * @param cabEndDateElection Determination of whether the Collateral Access Breach end date is a number of days (True) or specified (False).
  * @param cabEndDate The business days following the related Collateral Access Breach when the additional terms end.
  * @param cabEndDateTerms Specific terms for when Collateral Access Breach terms end.
  */
case class CollateralAccessBreach(isApplicable: Boolean,
    cabEndDateElection: Option[Boolean],
    cabEndDate: Option[scala.math.BigDecimal],
    cabEndDateTerms: Option[String]) {
}
...
/**
  ...
  */
case class CollateralAgreementFloatingRate(rateOption: Option[ReferenceWithMetaInterestRateIndex],
...
/**
  ...
  */
case class CollateralCriteriaBase(collateralCriteria: Option[CollateralCriteria],
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
...
/**
  ...
  *
  * @param partyElection The parties' Collateral Management Agreement election.
  */
case class CollateralManagementAgreement(partyElection: List[CollateralManagementAgreementElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param collateralManagementAgreement The designated Collateral Management Agreement with respect to the elective party as the Obligee.
  */
case class CollateralManagementAgreementElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
...
/**
  ...
  */
case class CollateralPosition(priceQuantity: List[PriceQuantity],
    product: Product,
    cashBalance: Option[Money],
    tradeReference: Option[ReferenceWithMetaTradeState],
    treatment: Option[CollateralTreatment],
...
/**
  ...
  *
  * @param deliveryAmount The nearest integral multiple of Base Currency units to which the Delivery Amount will be rounded in accordance with the specified rounding direction.
  * @param deliveryDirection The rounding rule applicable to the Delivery Amount (which can be (i) up to nearest; (ii) down to nearest).
  * @param returnAmount The nearest integral multiple of Base Currency units to which the Return Amount will be rounded in accordance with the specified rounding direction.
  * @param returnDirection The rounding rule applicable to the Return Amount (which can be (i) up to nearest; (ii) down to nearest).
  * @param currency The currency in which the Delivery Amount and Return Amount rounding amounts are specified.
  * @param other Utilised where the clause data structure is not able to capture a material aspect of the clause.
  */
case class CollateralRounding(deliveryAmount: scala.math.BigDecimal,
    @JsonScalaEnumeration(classOf[RoundingModeEnum.Class])
    deliveryDirection: RoundingModeEnum.Value,
    returnAmount: scala.math.BigDecimal,
    @JsonScalaEnumeration(classOf[RoundingModeEnum.Class])
    returnDirection: RoundingModeEnum.Value,
    @JsonScalaEnumeration(classOf[ISOCurrencyCodeEnum.Class])
    currency: ISOCurrencyCodeEnum.Value,
    other: Option[String]) {
}
...
/**
  ...
  *
  * @param regime The Regime Table provision , which determines the regulatory regime(s) applicable to each of the parties to the agreement.
  * @param oneWayProvisions The determination of whether the One Way Provisions are applicable (true) or not applicable (false).
  * @param generalSimmElections The specification of the ISDA SIMM Method for all Covered Transactions with respect to all Regimes.
  * @param identifiedCrossCurrencySwap The qualification of whether cross-currency swaps need to be identified in the Confirmation so that the obligations to exchange principal be disregarded for the purpose of determining the Delivery Amount or Return Amount.
  * @param sensitivityMethodologies The specification of methodologies to compute sensitivities specific to the agreement.
  * @param fxHaircutCurrency The reference currency for the purpose of specifying the FX Haircut relating to a posting obligation, as being either the Termination Currency or an FX Designated Currency.
  * @param postingObligations The security providers posting obligations.
  * @param substitutedRegime The specification of Additional regimes for purposes of determining whether a Regulatory Event has occurred.
  * @param baseAndEligibleCurrency The base and eligible currency(ies) for the document as specified by the parties to the agreement.
  * @param creditSupportObligations The Credit Support Obligations applicable to the agreement.
  * @param calculationAndTiming The set of elections for determining Valuation and Timing terms specific to the agreement.
  * @param conditionsPrecedent The set of elections that may overwrite the default Condition Precedent provision, and the set of provisions that are deemed Access Condition.
  * @param substitution The conditions under which the Security Provider can substitute posted collateral.
  * @param disputeResolution The election terms under which a party disputes (i) the Calculation Agents calculation of a Delivery Amount or a Return Amount, or (ii) the Value of any Transfer of Eligible Credit Support or Posted Credit Support.
  * @param rightsEvents The bespoke provisions that might be specified by the parties to the agreement to specify the rights of Security Taker and/or Security Provider when an Early Termination or Access Condition event has occurred.
  * @param custodyArrangements The Custodian and Segregated Account details in respect of each party to the agreement.
  * @param additionalRepresentations The specification Additional Representations that may be applicable to the agreement.
  * @param demandsAndNotices The optional specification of address where the demands, specifications and notices will be communicated to for each of the parties to the agreement.
  * @param addressesForTransfer The optional specification of address for transfer as specified by the respective parties to the agreement.
  * @param otherCsa The bespoke definition of Other CSA as specified by the parties to the agreement.
  * @param terminationCurrencyAmendment The bespoke provision that might be specified by the parties to the agreement applicable to Termination Currency.  Unless specified the definition of Termination Currency has the meaning specified in the Schedule to the ISDA Master Agreement.
  * @param minimumTransferAmountAmendment The bespoke provision that might be specified by the parties to the agreement applicable to Minimum Transfer Amount.  Unless specified the definition of Minimum Transfer Amount in any Other Regulatory CSA has the meaning specified in such Other Regulatory CSA.
  * @param interpretationTerms The bespoke provision that might be specified by the parties to the agreement applicable to Interpretations.
  * @param processAgent The Process Agent that might be appointed by the parties to the agreement.
  * @param jurisdictionRelatedTerms The jurisdiction specific terms relevant to the agreement.
  * @param additionalAmendments Any additional amendments that might be specified by the parties to the agreement.
  * @param additionalBespokeTerms Any additional terms that might be specified applicable.
  * @param pledgeeRepresentativeRider The terms of the Rider for the ISDA Euroclear 2019 Collateral Transfer Agreement with respect to the use of a Pledgee Representative attached to this Agreement.
  * @param finalReturns A clause providing that final return collateral is to be provided without consideration of any Minimum Transfer Amount and collateral haircut.
  */
case class CollateralTransferAgreementElections(regime: Regime,
    oneWayProvisions: OneWayProvisions,
    generalSimmElections: GeneralSimmElections,
    identifiedCrossCurrencySwap: Option[Boolean],
    sensitivityMethodologies: SensitivityMethodologies,
    fxHaircutCurrency: Option[FxHaircutCurrency],
    postingObligations: PostingObligations,
    substitutedRegime: List[SubstitutedRegime],
    ...
    rightsEvents: Option[RightsEvents],
    custodyArrangements: CustodyArrangements,
    additionalRepresentations: AdditionalRepresentations,
    demandsAndNotices: Option[ContactElection],
    addressesForTransfer: Option[ContactElection],
    otherCsa: Option[String],
    terminationCurrencyAmendment: TerminationCurrencyAmendment,
    minimumTransferAmountAmendment: Option[MinimumTransferAmountAmendment],
    interpretationTerms: Option[String],
    processAgent: Option[ProcessAgent],
    jurisdictionRelatedTerms: Option[JurisdictionRelatedTerms],
    additionalAmendments: Option[String],
    additionalBespokeTerms: Option[String],
    pledgeeRepresentativeRider: Option[PledgeeRepresentativeRider],
...
/**
  ...
  *
  * @param transferSettlementTiming Specification of transfer / settlement timing for cash and securities collateral assuming that the notice is provided before the Notification Time (and with a 1LBD lag introduced if the notice is delivered after the Notification Time), and that securities allow for a further Local Business Day for transfer / settlement.
  * @param legacyDefinition Bespoke language removing the pre-print requirement to transfer legal title of securities collateral through written instructions to the relevant depository institution or other securities intermediaries solely for the purposes of the 1994 New York Law Credit Support Annex.
  */
case class CollateralTransferTiming(transferSettlementTiming: Option[LegacyTransferSettlementTiming],
    legacyDefinition: Option[LegacyDefinition]) {
}
...
/**
  ...
  *
  * @param partyElection The parties Collateral Valuation Agent Elections.
  */
case class CollateralValuationAgent(partyElection: List[CollateralValuationAgentElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class CollateralValuationAgentElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param cashCollateral Details of how cash collateral is valued.
  * @param securitiesCollateral Details of how securities collateral is valued.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class CollateralValueMethod(@JsonDeserialize(contentAs = classOf[ValueCashEnum.Value])
    @JsonScalaEnumeration(classOf[ValueCashEnum.Class])
    cashCollateral: Option[ValueCashEnum.Value],
    @JsonDeserialize(contentAs = classOf[ValueSecuritiesEnum.Value])
    @JsonScalaEnumeration(classOf[ValueSecuritiesEnum.Class])
    securitiesCollateral: Option[ValueSecuritiesEnum.Value],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  */
case class Commodity(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
    commodityProductDefinition: Option[CommodityProductDefinition],
...
/**
  ...
  */
case class CommodityPayout(payerReceiver: PayerReceiver,
    priceQuantity: Option[ResolvablePriceQuantity],
    principalPayment: Option[PrincipalPayments],
    settlementTerms: Option[SettlementTerms],
...
/**
  ...
  */
case class ConcentrationLimitCriteria(collateralCriteria: Option[CollateralCriteria],
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    appliesTo: List[CounterpartyRoleEnum.Value],
    @JsonDeserialize(contentAs = classOf[CollateralMarginTypeEnum.Value])
    @JsonScalaEnumeration(classOf[CollateralMarginTypeEnum.Class])
    ...
    @JsonScalaEnumeration(classOf[RatingPriorityResolutionEnum.Class])
    ratingPriorityResolution: Option[RatingPriorityResolutionEnum.Value],
    @JsonDeserialize(contentAs = classOf[ConcentrationLimitTypeEnum.Value])
...
/**
  ...
  *
  * @param conditionsPrecedentElection The election to specify whether the standard Conditions Precedent apply.
  * @param customProvision The custom provisions that might be specified by the parties to the agreement for the purpose of overwriting the default Condition Precedent provision specified in the CSA.
  * @param accessConditions The parties' election with respect to the Termination Events that will be deemed an Access Condition (Initial Margin CSA) or a Specified Condition (Variation Margin CSA).
  */
case class ConditionsPrecedent(@JsonDeserialize(contentAs = classOf[ExceptionEnum.Value])
    @JsonScalaEnumeration(classOf[ExceptionEnum.Class])
    conditionsPrecedentElection: Option[ExceptionEnum.Value],
    customProvision: Option[String],
...
case class ContractualDefinition(identifier: Option[Identifier],
    contractualDefinitionIdentifier: Option[ContractualDefinitionIdentifier],
    publicationDate: Option[java.time.LocalDate]) {
}

case class ContractualDefinitionIdentifier(@JsonScalaEnumeration(classOf[ContractualDefinitionsEnum.Class])
    contractualDefinitionType: ContractualDefinitionsEnum.Value,
    contractualDefinitionVersion: Option[String]) {
}
...
/**
  ...
  *
  * @param partyElection The party specific elections.
  */
case class ControlAgreement(partyElection: List[ControlAgreementElections]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param controlAgreementAsCsd The identification of whether the Control Agreement is a Credit Support Document with respect to each party.
  * @param consistencyWithControlAgreement Unless specified as inapplicable in the event of any inconsistency between this Deed and the Control Agreement, this Deed will prevail over the Control Agreement.
  * @param relationshipWithControlAgreement Unless specified as inapplicable the parties recognise that the Control Agreement is a means by which the parties can perform their obligations.
  */
case class ControlAgreementElections(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    controlAgreementAsCsd: Boolean,
    consistencyWithControlAgreement: Option[Boolean],
    relationshipWithControlAgreement: Option[Boolean]) {
}

/**
  * A class to specify Control Agreement language related to delivery of a Notice of Exclusive Control.
  *
  * @param controlAgreementNecEventElection Indicates party specific Control Agreement language related to delivery of a Notice of Exclusive Control.
  */
case class ControlAgreementNecEvent(controlAgreementNecEventElection: List[ControlAgreementNecEventElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param necEvent Indicates Control Agreement language related to delivery of a Notice of Exclusive Control.
  */
case class ControlAgreementNecEventElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    necEvent: Boolean) {
}
...
case class CorrelationReturnTerms(valuationTerms: ValuationTerms,
...
/**
  ...
  */
case class CounterpartyPosition(contractDetails: Option[ReferenceWithMetaContractDetails],
    executionDetails: Option[ReferenceWithMetaExecutionDetails],
    collateral: Option[ReferenceWithMetaCollateral],
    positionIdentifier: List[PositionIdentifier],
...
/**
  ...
  *
  * @param inclusionDate Includes any Transaction specified below that is entered into on or after the specified date.
  * @param coveredTransactions Covered Transactions when expressed using the ISDA taxonomy.
  * @param bespokeCoveredTransactions Covered Transactions when not expressed using the ISDA taxonomy.
  * @param additionalObligations The party specific additional obligations applicable to the document.
  * @param exposure The bespoke definition of exposure for Covered Transactions as part of the agreement.
  * @param legacyExposure Specification of amendments to the calculation of Exposure in terms of the Transactions covered.
  */
case class CoveredTransactions(inclusionDate: java.time.LocalDate,
    coveredTransactions: List[ProductTaxonomy],
    bespokeCoveredTransactions: List[String],
    additionalObligations: List[AdditionalObligations],
    exposure: Option[String],
    legacyExposure: List[ExposureScope]) {
}
...
/**
  ...
  */
case class CreditDefaultPayout(payerReceiver: PayerReceiver,
    priceQuantity: Option[ResolvablePriceQuantity],
    principalPayment: Option[PrincipalPayments],
    settlementTerms: Option[SettlementTerms],
...
/**
  ...
  */
case class CreditIndex(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
...
/**
  ...
  * @param substitutedRegime The specification of Additional regimes for purposes of determining whether a Regulatory Event has occurred.
  * @param baseAndEligibleCurrency The base and eligible currency(ies) for the document as specified by the parties to the agreement.
  * @param additionalObligations The additional obligations that might be specified by the parties to a Credit Support Agreement.
  * @param coveredTransactions The specification of transactions covered by the terms of the agreement.
  * @param creditSupportObligations The Credit Support Obligations applicable to the agreement.
  * @param exchangeDate The bespoke exchange date terms that might be specified by the parties to the agreement.
  * @param calculationAndTiming The set of elections for determining Valuation and Timing terms specific to the agreement.
  * @param conditionsPrecedent The set of elections that may overwrite the default Condition Precedent provision, and the set of provisions that are deemed Access Condition.
  * @param substitution The conditions under which the Security Provider can substitute posted collateral.
  * @param disputeResolution The election terms under which a party disputes (i) the Calculation Agents calculation of a Delivery Amount or a Return Amount, or (ii) the Value of any Transfer of Eligible Credit Support or Posted Credit Support.
  * @param holdingAndUsingPostedCollateral The elections for the holding and using of posted collateral by the respective parties to the Credit Support Annex for Variation Margin.
  * @param rightsEvents The bespoke provisions that might be specified by the parties to the agreement to specify the rights of Security Taker and/or Security Provider when an Early Termination or Access Condition event has occurred.
  * @param custodyArrangements The Custodian and Segregated Account details in respect of each party to the agreement.
  * @param distributionAndInterestPayment The Distributions and Interest Payment terms specified as part of the agreement.
  * @param creditSupportOffsets The specification of whether the standard Credit Support Offset provisions are applicable (true) or not applicable (false).
  * @param additionalRepresentations The specification Additional Representations that may be applicable to the agreement.
  * @param otherEligibleAndPostedSupport The Other Eligible Support elections associated with margin agreements.
  * @param demandsAndNotices The optional specification of address where the demands, specifications and notices will be communicated to for each of the parties to the agreement.
  * @param addressesForTransfer The optional specification of address for transfer as specified by the respective parties to the agreement.
  * @param otherAgreements The bespoke definition of other agreement terms as specified by the parties to the agreement.
  * @param terminationCurrencyAmendment The bespoke provision that might be specified by the parties to the agreement applicable to Termination Currency.  Unless specified the definition of Termination Currency has the meaning specified in the Schedule to the ISDA Master Agreement.
  * @param minimumTransferAmountAmendment The bespoke provision that might be specified by the parties to the agreement applicable to Minimum Transfer Amount.  Unless specified the definition of Minimum Transfer Amount in any Other Regulatory CSA has the meaning specified in such Other Regulatory CSA.
  * @param interpretationTerms The bespoke provision that might be specified by the parties to the agreement applicable to Interpretations.
  * @param processAgent The Process Agent that might be appointed by the parties to the agreement.
  * @param appropriatedCollateralValuation The election for the Valuation of Appropriate Collateral.
  * @param jurisdictionRelatedTerms The jurisdiction specific terms relevant to the agreement.
  * @param additionalAmendments Any additional amendments that might be specified by the parties to the agreement.
  * @param additionalBespokeTerms Any additional terms that might be specified applicable.
  * @param trustSchemeAddendum The qualification of whether Trust Scheme Addendum is applicable (True) or not applicable (False).
  * @param securityInterestForObligations The party to whom obligations under the Master Agreement are owed and secured by the credit support arrangements. Applicable to 1994 NY CSA, 1995 English Law CSD and 2016 New York Law VM CSA.
  * @param singlePostingParty Where only a single  party is explicitly designated to post collateral, the party which is specified as the sole poster of collateral.
  * @param datedAsOfDate Defines the dates agreed by the parties as the date of the Credit Support Annex or Credit Support Deed.
  * @param cass Details of language relating to Client Asset and Money Rules.
  * @param otherCSA A clause detailing the prescence of another collateralisation arrangement within the Master Agreement between the parties to this Collateral Arrangement.
  * @param legacyAdditionalRepresentations Details of any Additional Representations given by the relevant parties in relation to the collateral arrangement.
  * @param value Details how particular types of collateral are valued (other than in respect of a default).
  */
case class CreditSupportAgreementElections(regime: Regime,
    oneWayProvisions: OneWayProvisions,
    generalSimmElections: Option[GeneralSimmElections],
    identifiedCrossCurrencySwap: Option[Boolean],
    sensitivityMethodologies: SensitivityMethodologies,
    fxHaircutCurrency: Option[FxHaircutCurrency],
    postingObligations: PostingObligations,
    substitutedRegime: List[SubstitutedRegime],
    baseAndEligibleCurrency: BaseAndEligibleCurrency,
    additionalObligations: Option[String],
    coveredTransactions: CoveredTransactions,
    creditSupportObligations: CreditSupportObligations,
    exchangeDate: Option[String],
    calculationAndTiming: CalculationAndTiming,
    conditionsPrecedent: Option[ConditionsPrecedent],
    substitution: Substitution,
    disputeResolution: DisputeResolution,
    holdingAndUsingPostedCollateral: HoldingAndUsingPostedCollateral,
    rightsEvents: RightsEvents,
    custodyArrangements: Option[CustodyArrangements],
    distributionAndInterestPayment: Option[DistributionAndInterestPayment],
    creditSupportOffsets: Boolean,
    additionalRepresentations: AdditionalRepresentations,
    otherEligibleAndPostedSupport: OtherEligibleAndPostedSupport,
    demandsAndNotices: Option[ContactElection],
    addressesForTransfer: Option[ContactElection],
    otherAgreements: Option[OtherAgreements],
    terminationCurrencyAmendment: TerminationCurrencyAmendment,
    minimumTransferAmountAmendment: MinimumTransferAmountAmendment,
    interpretationTerms: Option[String],
    processAgent: Option[ProcessAgent],
    appropriatedCollateralValuation: Option[AppropriatedCollateralValuation],
    jurisdictionRelatedTerms: Option[JurisdictionRelatedTerms],
    additionalAmendments: Option[String],
    additionalBespokeTerms: Option[String],
    trustSchemeAddendum: Boolean,
    securityInterestForObligations: SecurityInterestForObligations,
    singlePostingParty: Option[SinglePostingParty],
    datedAsOfDate: Option[DatedAsOfDate],
    cass: Option[String],
    otherCSA: Option[String],
    legacyAdditionalRepresentations: Option[String],
    value: Option[CollateralValueMethod]) {
}
...
/**
  ...
  *
  * @param creditSupportAmount Specifies whether the meaning of credit support amount follows the pre-print definition or deviates from the standard (either based on a rating or some other methodology).
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class CreditSupportAmount(@JsonScalaEnumeration(classOf[CreditSupportAmountEnum.Class])
    creditSupportAmount: CreditSupportAmountEnum.Value,
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param creditSupportDocumentElection The party election of Credit Support Document(s), if any.
  */
case class CreditSupportDocument(creditSupportDocumentElection: List[CreditSupportDocumentElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param creditSupportDocumentTerms Specification of the Credit Support Document terms.
  * @param creditSupportDocumentTypes If a Credit Support Document is specified but not yet in CDM representation, it can still be captured. This argument should be used if the creditSupportDocument argument cannot be used due to not being able to represent the document fully in CDM format.
  * @param creditSupportDocument The specified Credit Support Document(s), if any.
  * @param bespokeCreditSuppportDocument Specification of a document when not captured under RelatedAgreement.
  */
case class CreditSupportDocumentElection(party: Party,
    @JsonScalaEnumeration(classOf[CreditSupportDocumentTermsEnum.Class])
    creditSupportDocumentTerms: CreditSupportDocumentTermsEnum.Value,
    creditSupportDocumentTypes: List[LegalAgreementIdentification],
    creditSupportDocument: List[LegalAgreement],
    bespokeCreditSuppportDocument: Option[String]) {
}

/**
  * A class to specify the Credit Support Obligations applicable to the Initial Margin Credit Support Annex.
  *
  * @param deliveryAmount Delivery Amount (VM) has the meaning specified in Paragraph 3(a), unless otherwise specified here.
  * @param returnAmount Return Amount (VM) has the meaning specified in Paragraph 3(a), unless otherwise specified here.
  * @param marginApproach The selection of Margin Approach applicable to the agreement.
  * @param otherEligibleSupport The Other Eligible Support election. If not specified, this election is deemed as not applicable.
  * @param threshold The amount of net exposure that a party is willing to bear in relation to the other party before it requires asking for collateral.
  * @param minimumTransferAmount The net amount of exposure reached before collateral has to be posted or returned.
  * @param rounding The rounding methodology applicable to the Delivery Amount and the Return Amount in terms of nearest integral multiple of Base Currency units.
  * @param bespokeTransferTiming The time by which the transfer of collateral must take place when different from the Regular Settlement Day as a result of parties' election.
  * @param creditSupportObligationsVariationMargin The specification of Credit Support Obligations applicable to Variation Margin agreements.
  * @param legacyThreshold 
  * @param legacyMinimumTransferAmount 
  * @param legacyDeliveryAmount In respect of a Valuation Date, the amount of collateral which a party is entitled to demand to be transferred to it as a Delivery Amount.
  * @param legacyReturnAmount In respect of a Valuation Date, the amount of collateral which a party is entitled to demand to be recalled to it as a Return Amount.
  * @param creditSupportAmount The total amount one counterparty must deliver to the other at any time: the combination of the Exposure to that party and the net Independent Amounts it must post, minus any agreed Threshold.
  * @param collateralTransferTiming Specification of transfer / settlement timing for cash and securities collateral assuming that the notice is provided before the Notification Time (and with a 1LBD lag introduced if the notice is delivered after the Notification Time), and that securities allow for a further Local Business Day for transfer / settlement.
  */
case class CreditSupportObligations(deliveryAmount: Option[String],
    returnAmount: Option[String],
    marginApproach: Option[MarginApproach],
    otherEligibleSupport: Option[String],
    threshold: Threshold,
    minimumTransferAmount: MinimumTransferAmount,
    rounding: Option[CollateralRounding],
    bespokeTransferTiming: Option[BespokeTransferTiming],
    creditSupportObligationsVariationMargin: Option[CreditSupportObligationsVariationMargin],
    legacyThreshold: List[CSAThreshold],
    legacyMinimumTransferAmount: List[CSAMinimumTransferAmount],
    legacyDeliveryAmount: LegacyDeliveryAmount,
    legacyReturnAmount: LegacyReturnAmount,
    creditSupportAmount: CreditSupportAmount,
    collateralTransferTiming: Option[CollateralTransferTiming]) {
}

/**
  * A class to specify the Credit Support Obligations applicable to the Variation Margin Credit Support Annex.
  *
  * @param ineligibleCreditSupport The parties to which the provisions of the Credit Support Annex for Variation Margin will apply to.
  * @param majorCurrency The additional currencies that are specified as Major Currency for the purpose of applying the FX Haircut Percentage.
  * @param fxHaircut The alternative definition for FX haircut percentage that applies to each party and item of Eligible Collateral unless this item is denominated in a Major Currency or in the Base Currency.
  */
case class CreditSupportObligationsVariationMargin(ineligibleCreditSupport: Option[IneligibleCreditSupport],
    majorCurrency: List[FieldWithMetaString],
    fxHaircut: Option[String]) {
}

/**
  * Identification of party specific Credit Support Providers applicable to the document.
  *
  * @param creditSupportProviderElection The party election of Credit Support Provider(s), if any.
  */
case class CreditSupportProvider(creditSupportProviderElection: List[CreditSupportProviderElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param creditSupportProviderTerms Specification of the Credit Support Provider terms.
  * @param creditSupportProvider The specified Credit Support Provider(s), if any.
  * @param bespokeCreditSuppportProvider ...
  */
case class CreditSupportProviderElection(party: Party,
    @JsonScalaEnumeration(classOf[CreditSupportProviderTermsEnum.Class])
    creditSupportProviderTerms: CreditSupportProviderTermsEnum.Value,
    creditSupportProvider: List[LegalEntity],
    bespokeCreditSuppportProvider: Option[String]) {
}
...
/**
  ...
  * @param partyElection The party specific elections.
  */
case class Custodian(partyElection: List[CustodianElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param custodian The custody agent. While CreateiQ only specifies the custodian's name, specifying the legal entity as part of the CDM is deemed more appropriate, while this will still provide the ability to accommodate situations where only the entity name is available, as the entityId attribute is optional as part of the LegalEntity class.
  * @param segregatedCashAccount The identification of the segregated cash account for the purpose of holding cash collateral.
  * @param segregatedSecurityAccount The identification of the segregated security account for the purpose of holding security collateral.
  * @param legacyVMCustodian Details how the Custodian is determined.
  * @param legacyNamedEntity The identity of the relevant custodian where Named Entity is elected.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class CustodianElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    custodian: Option[LegalEntity],
    segregatedCashAccount: Option[Account],
    segregatedSecurityAccount: Option[Account],
    @JsonDeserialize(contentAs = classOf[LegacyVMCustodianEnum.Value])
    @JsonScalaEnumeration(classOf[LegacyVMCustodianEnum.Class])
    legacyVMCustodian: Option[LegacyVMCustodianEnum.Value],
    legacyNamedEntity: Option[LegalEntity],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param isApplicable The qualification as to whether the Custodian Event (English Law & New York Law ISDA CSA) or the Collateral Manager Event (Japanese Law ISDA CSA) is applicable.
  * @param endDate The qualification of the Custodian Event (English Law & New York Law ISDA CSA) or Collateral Manager Event (Japanese Law ISDA CSA) End Date.
  */
case class CustodianEvent(isApplicable: Boolean,
    endDate: Option[CustodianEventEndDate]) {
}

/**
  * A class to specify the Custodian Event.
  *
  * @param daysAfterCustodianEvent Election to specify the number of days after the occurrence of the Custodian Event/Collateral Management Event for the purpose of qualifying the CE/CME End Date.
  * @param releaseDate Election to specify the number of days prior to the termination of the Control Agreement /Collateral Management Event for the purpose of qualifying the CE/CME End Date, in the case where advance notice is given.
  * @param safekeepingPeriodExpiry The parties' election to specify the number of days prior to the end of the safekeeping period (Clearstream CTA) purpose of qualifying the CE/CME End Date, in the case where advance notice is given.
  * @param dateOfTimelyStatement The parties' election to specify the number of days one party has effectively provided the Timely Statement to the other party.
  */
case class CustodianEventEndDate(daysAfterCustodianEvent: CustomisableOffset,
    releaseDate: CustomisableOffset,
    safekeepingPeriodExpiry: Option[CustomisableOffset],
...
/**
  ...
  * @param partyElection The party specific elections.
  */
case class CustodianRisk(partyElection: List[CustodianRiskElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param isSpecified The qualification as to whether the risk is deemed as Specified.
  * @param qualification The Custodian Risk or Collateral Manager Risk qualification.
  */
case class CustodianRiskElection(@JsonDeserialize(contentAs = classOf[CounterpartyRoleEnum.Value])
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: Option[CounterpartyRoleEnum.Value],
    isSpecified: Boolean,
    qualification: Option[String]) {
}
...
/**
  ...
  *
  * @param minimumAssets The minimal level of assets requirement with respect to the custody agent.
  * @param minimumRating The minimal rating requirement with respect to the custody agent.
  * @param initialDesignation Election to specify the initial custodian.
  */
case class CustodianTerms(minimumAssets: Option[Money],
    minimumRating: Option[CreditNotation],
    initialDesignation: Option[LegalEntity]) {
}

/**
  * A class to specify the Custody Arrangements for the agreement.
  *
  * @param isCreditSupportDocument Unless specified as True, the Control Agreement is not a Credit Support Document under the agreement with respect to a party.
  * @param hasControlAgreementLanguage Control Agreement language is specified when True.
  * @param otherProvisions Other Custom Provisions of Custody Arrangements.
  * @param collateralAccessBreach The elections specific to Collateral Access Breach language.
  * @param custodianRisk The qualification of the Custodian Risk.
  * @param controlAgreement The party-specific election with respect to the control agreement.
  * @param custodianEvent Specifies if and until when a Custodian Event clause applies.
  * @param custodian The custodian and segregated account details for each party to the agreement.
  * @param collateralManagementAgreement 
  */
case class CustodyArrangements(isCreditSupportDocument: Option[Boolean],
    hasControlAgreementLanguage: Option[Boolean],
    otherProvisions: Option[String],
    collateralAccessBreach: Option[CollateralAccessBreach],
    custodianRisk: Option[CustodianRisk],
    controlAgreement: Option[ControlAgreement],
    custodianEvent: CustodianEvent,
    custodian: Option[Custodian],
    collateralManagementAgreement: Option[CollateralManagementAgreement]) {
}
...
/**
  ...
  *
  * @param csaDatedAsOfDate The date agreed by the parties as the Dated as of Date for the Credit Support Annex.
  * @param masterAgreementDatedAsOfDate The date agreed by the parties as the Dated as of Date for the Master Agreement.
  * @param csaMadeOn The date agreed by the parties as the Made On date of the Credit Support Deed.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class DatedAsOfDate(csaDatedAsOfDate: Option[java.time.LocalDate],
    masterAgreementDatedAsOfDate: Option[java.time.LocalDate],
    csaMadeOn: Option[java.time.LocalDate],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param resolutionTime The time by which the dispute needs to be resolved, failure of which would trigger a recalculation alongside a process that is specified as part of the agreement.
  * @param otherTerms The custom Resolution Time election that might be specified by the parties.
  * @param valueTerms The method of calculation for determining value for the purposes of a Variation Margin agreement.
  * @param alternativeTerms The alternative dispute resolution procedure if specified.
  * @param recalculationOfValue The elections to specify terms for recalculation of the market value of posted collateral.
  * @param legacyResolutionTime Definition of a point of time un the following LBD to the date of notice in the resolution process at which the recalculation of the disputed amount(s) begins if the consultation process has not resolved the dispute.
  * @param legacyAlternative Alternative procedures to those in the pre-print for resolving collateral related disputes.
  * @param legacyValue Methodology for resolving disputes in respect of the determination of the value of collateral.
  */
case class DisputeResolution(resolutionTime: Option[BusinessCenterTime],
    otherTerms: Option[String],
    valueTerms: String,
    alternativeTerms: Option[String],
    recalculationOfValue: Option[RecalculationOfValue],
    legacyResolutionTime: Option[BusinessCenterTime],
    legacyAlternative: Option[LegacyResolutionAlternative],
    legacyValue: Option[LegacyResolutionValue]) {
}
...
case class DividendCurrency(currency: Option[FieldWithMetaString],
    ...
    @JsonScalaEnumeration(classOf[DeterminationMethodEnum.Class])
    determinationMethod: Option[DeterminationMethodEnum.Value],
    currencyReference: Option[ReferenceWithMetaString]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param electiveAmount Specifies an enumerated election to express the elective amount.
  * @param amount The elective amount when expressed as a currency amount. The associated PartyElectiveAmount_amount data rule enforces that the currency amount is actually greater than 0.
  * @param customElection The elective amount when expressed as a custom election by the party.
  */
case class ElectiveAmountElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    @JsonDeserialize(contentAs = classOf[ElectiveAmountEnum.Value])
    @JsonScalaEnumeration(classOf[ElectiveAmountEnum.Class])
    electiveAmount: Option[ElectiveAmountEnum.Value],
    amount: Option[Money],
    customElection: Option[String]) {
}
...
/**
  ...
  *
  * @param partyTerms The condition(s) required by a party from the other party to hold its posted collateral.
  * @param custodianTerms The restrictions that might be required by a party from the other party's custodian agent to hold its posted collateral.
  * @param eligibleCountry The restrictions that might be required by a party from the other party in terms of country(ies) where collateral can be held.
  */
case class EligibilityToHoldCollateral(@JsonScalaEnumeration(classOf[HoldingPostedCollateralEnum.Class])
    partyTerms: List[HoldingPostedCollateralEnum.Value],
    custodianTerms: Option[CustodianTerms],
    eligibleCountry: List[FieldWithMetaString]) {
}

/**
  * Represents a set of criteria used to specify eligible collateral.
  *
  * @param collateralCriteria The specific criteria in an Eligible Collateral Schedule. This is a mandatory attribute of an ECS so an override is required to enforce the cardinality.
  * @param appliesTo Specifies which of the two counterparties the criteria applies to (either one or both counterparties). This attribute is optional, in case the applicable party is already specified elsewhere within a party election.
  * @param restrictTo Restrict the criteria to only apply to a specific type of margin, ie IM or VM.
  * @param ratingPriorityResolution Denotes which Criteria has priority if more than one agency rating applies.
  * @param treatment Identifies the treatment of specified collateral, e.g., haircuts,holding limits or exclusions.
  */
case class EligibleCollateralCriteria(collateralCriteria: Option[CollateralCriteria],
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    appliesTo: List[CounterpartyRoleEnum.Value],
    @JsonDeserialize(contentAs = classOf[CollateralMarginTypeEnum.Value])
    @JsonScalaEnumeration(classOf[CollateralMarginTypeEnum.Class])
...
/**
  ...
  *
  * @param earlyTerminationDate The early termination election.
  * @param failureToPay The failure to pay election.
  */
case class EnforcementEvent(earlyTerminationDate: Boolean,
    failureToPay: Option[Boolean]) {
}
...
/**
  ...
  *
  * @param identifier Provides an identifier associated with a legal entity.
  * @param identifierType Defines the source of the identifier.
  */
case class EntityIdentifier(identifier: FieldWithMetaString,
    @JsonDeserialize(contentAs = classOf[EntityIdentifierTypeEnum.Value])
    @JsonScalaEnumeration(classOf[EntityIdentifierTypeEnum.Class])
    identifierType: Option[EntityIdentifierTypeEnum.Value],
    meta: Option[MetaFields]) {
}
...
/**
  ...
  *
  * @param shareForShare Shall occur if a Merger Event occurs and the consideration for the relevant Security consists solely of Combined Consideration.
  * @param shareForOther Shall occur if a Merger Event occurs and the consideration for the relevant Security consists solely of Other Consideration.
  * @param shareForCombined Shall occur if a Merger Event occurs and the consideration for the relevant Security consists solely of Combined Consideration.
  */
case class EquityCorporateEvents(@JsonScalaEnumeration(classOf[ShareExtraordinaryEventEnum.Class])
    shareForShare: ShareExtraordinaryEventEnum.Value,
    @JsonScalaEnumeration(classOf[ShareExtraordinaryEventEnum.Class])
    shareForOther: ShareExtraordinaryEventEnum.Value,
    @JsonScalaEnumeration(classOf[ShareExtraordinaryEventEnum.Class])
    shareForCombined: ShareExtraordinaryEventEnum.Value) {
}
...
/**
  ...
  * @param assetClass The Asset Class of the Index.
  */
case class EquityIndex(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
...
/**
  ...
  *
  * @param escrowArrangementIsApplicable 
  * @param maximumDaysOfDisruption 
  * @param bespokeEscrowArrangements 
  */
case class EscrowArrangement(escrowArrangementIsApplicable: Boolean,
    maximumDaysOfDisruption: Option[ValuationPostponement],
    bespokeEscrowArrangements: Option[Clause]) {
}

/**
  * Defines the currency referenced as such in any terms related to FX Disruption Events
  *
  * @param eventCurrency Defines the currency referenced as such in any terms related to FX Disruption Events
  * @param eventCurrentAmount Defines the Event Currency Amount to be exchanged on the Settlement Date.
  * @param eventCurrencyBuyerSeller Unless otherwised specified, the Buyer is the party to which the Event Currency Amount is owed on the Settlement Date and the Seller is the party which owes the Event Currency Amount on the Settlement Date.
  */
case class EventCurrency(eventCurrency: FieldWithMetaString,
    eventCurrentAmount: Option[Quantity],
    eventCurrencyBuyerSeller: List[BuyerSeller]) {
}
...
/**
  ...
  *
  * @param product Description of the relevant derivative transactions excluded from the calculation of exposure.
  * @param branch Description of the specific branch entered into by the relevant party.
  * @param excluded A flag to indicate whether transactions entered into by a specific branch with respect to the relevant party are excluded; set to True if excluded, false if included.
  */
case class ExcludedProducts(@JsonScalaEnumeration(classOf[ExposureScopeProductEnum.Class])
    product: List[ExposureScopeProductEnum.Value],
    @JsonScalaEnumeration(classOf[BusinessCenterEnum.Class])
    branch: List[BusinessCenterEnum.Value],
    excluded: Boolean) {
}
...
/**
  ...
  *
  * @param standardLanguage A boolean attribute to determine if standard language is applicable or not.
  * @param numberOfOriginals The number of original documents.
  * @param otherLanguage Bespoke execution language to be included when specified.
  */
case class ExecutionLanguage(standardLanguage: Boolean,
    numberOfOriginals: Option[String],
    otherLanguage: Option[String]) {
}

/**
  * A class to specify execution location terms of a Security Agreement.
  *
  * @param executionLocation The execution location of the agreement.
  * @param otherLanguage Bespoke execution location language to be included when specified.
  * @param dutyPayer The payer of documentary duty.
  * @param dutyPayerLanguage Bespoke terms specific to the payment of documentary duty.
  * @param dutyPaymentDate The date that documentary duty will be paid.
  * @param dutyPaymentLanguage Bespoke terms specific to the date that documentary duty will be paid.
  */
case class ExecutionLocation(@JsonScalaEnumeration(classOf[ExecutionLocationEnum.Class])
    executionLocation: ExecutionLocationEnum.Value,
    otherLanguage: Option[String],
    dutyPayer: Option[String],
    dutyPayerLanguage: Option[String],
    dutyPaymentDate: Option[java.time.LocalDate],
    dutyPaymentLanguage: Option[String]) {
}

/**
  * A class to specify execution location and language of execution to determine duty to be paid.
  *
  * @param executionLanguage The bespoke execution language election.
  * @param executionLocation The bespoke execution location election.
  */
case class ExecutionTerms(executionLanguage: ExecutionLanguage,
...
/**
  ...
  */
case class ExerciseFee(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    payer: CounterpartyRoleEnum.Value,
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    receiver: CounterpartyRoleEnum.Value,
    notionalReference: ReferenceWithMetaMoney,
...
/**
  ...
  * @param feePaymentDate The date on which exercise fee(s) will be paid. It is specified as a relative date.
  */
case class ExerciseFeeSchedule(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    payer: CounterpartyRoleEnum.Value,
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    receiver: CounterpartyRoleEnum.Value,
    notionalReference: ReferenceWithMetaMoney,
...
case class ExerciseInstruction(exerciseQuantity: PrimitiveInstruction,
    exerciseOption: Option[ReferenceWithMetaPayout],
...
/**
  ...
  *
  * @param partyElection Defines the electice scope for a specific party.
  */
case class ExposureScope(partyElection: List[LegacyExposureScopeElection]) {
}
...
/**
  ...
  */
case class ExtendibleProvision(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    buyer: CounterpartyRoleEnum.Value,
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    seller: CounterpartyRoleEnum.Value,
    exerciseNotice: Option[ExerciseNotice],
...
/**
  ...
  * @param additionalBespokeTerms Where parties may optionnaly describe any extra bespoke agreements, in regards of the standardized Extraordinary Events.
  * @param mergerEvents 
  * @param tenderOfferEvents 
  * @param compositionOfCombinedConsideration 
  * @param indexAdjustmentEvents 
  * @param additionalDisruptionEvents 
  * @param failureToDeliver If true, failure to deliver is applicable.
  * @param representations 
  * @param nationalizationOrInsolvency 
  * @param delisting 
  */
...
case class FinalCalculationPeriodDateAdjustment(relevantUnderlyingDateReference: ReferenceWithMetaAdjustableOrRelativeDates,
    swapStreamReference: ReferenceWithMetaPayout,
    @JsonScalaEnumeration(classOf[BusinessDayConventionEnum.Class])
    businessDayConvention: BusinessDayConventionEnum.Value) {
}
...
/**
  ...
  *
  * @param applicable Defines if the clause is applicable to this agreement or any other exceptions.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class FinalReturns(applicable: Option[Boolean],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  * @param schedule Allows the full representation of a payout by defining a set of schedule periods. It supports standard schedule customization by expressing all the dates, quantities, and pricing data in a non-parametric way.
  */
case class FixedPricePayout(payerReceiver: PayerReceiver,
    priceQuantity: Option[ResolvablePriceQuantity],
    principalPayment: Option[PrincipalPayments],
    settlementTerms: Option[SettlementTerms],
    paymentDates: PaymentDates,
...
case class FloatingRate(rateOption: Option[ReferenceWithMetaInterestRateIndex],
    spreadSchedule: Option[SpreadSchedule],
    capRateSchedule: Option[StrikeSchedule],
    floorRateSchedule: Option[StrikeSchedule],
...
/**
  ...
  */
case class FloatingRateIndex(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
    ...
    @JsonScalaEnumeration(classOf[AssetClassEnum.Class])
    assetClass: Option[AssetClassEnum.Value],
    floatingRateIndex: FieldWithMetaFloatingRateIndexEnum,
...
/**
  ...
  * @param fixing The default fixing details.
  * @param dayCountFraction The default day count fraction.
  * @param applicableBusinessDays The default applicable business days.
  * @param publicationCalendar Publication Calendar (e.g. EUR-ICESWAP)
  */
case class FloatingRateIndexCalculationDefaults(@JsonDeserialize(contentAs = classOf[FloatingRateIndexCategoryEnum.Value])
    ...
    fixing: List[FloatingRateIndexFixingDetails],
    @JsonDeserialize(contentAs = classOf[DayCountFractionEnum.Value])
    @JsonScalaEnumeration(classOf[DayCountFractionEnum.Class])
    dayCountFraction: Option[DayCountFractionEnum.Value],
    applicableBusinessDays: Option[BusinessCenters],
    @JsonDeserialize(contentAs = classOf[BusinessCenterEnum.Value])
    @JsonScalaEnumeration(classOf[BusinessCenterEnum.Class])
    publicationCalendar: Option[BusinessCenterEnum.Value]) {
}
...
case class FloatingRateIndexDefinition(fro: FloatingRateIndexIdentification,
    ...
    supportedDefinition: List[ContractualDefinition],
    definitionalSource: Option[String],
    designatedMaturityApplicable: Option[Boolean],
    mappings: Option[FloatingRateIndexMappings],
    externalMappings: Option[FloatingRateIndexExternalMappings],
    inLoan: Option[Boolean],
    history: Option[FroHistory],
    deprecationReason: Option[String],
    fpmlDescription: Option[String]) {
}

/**
  * A map for a single FRO to or from an equivalent or similar codes in a different standard such as ISO.
  *
  * @param externalId  The FRO name that is being mapped to/from.
  * @param externalStandard The standard/version to which the map applies.
  */
case class FloatingRateIndexExternalMap(externalId: String,
    externalStandard: Option[String]) {
}
...
/**
  ...
  * @param isoCode 
  */
case class FloatingRateIndexExternalMappings(isoCode: Option[FloatingRateIndexExternalMap]) {
}

/**
  * This type holds parameters defining the fixingt time and offset for a floating rate index.
  *
  * @param fixingTime Parameters defining the normal fixing time (can vary by index tenor / designated maturity).
  * @param fixingOffset Parameters defining the normal fixing offset (can vary by index tenor / designated maturity).
  */
case class FloatingRateIndexFixingDetails(fixingTime: Option[FloatingRateIndexFixingTime],
    fixingOffset: Option[BusinessDayOffset]) {
}
...
/**
  ...
  * @param fixingOffsetDefinition Legal text that underlies the Fixing Offset. ISDA Fixing Offset Definition. (e.g. One day that is either a Sydney Business Day or a Melbourne Business Day following the Reset Date)
  * @param fixingOffsetReason Fixing Offset Reason
  * @param designatedMaturity Allows a reason to be specified for using the alternative fixing offset.
  */
case class FloatingRateIndexFixingOffset(periodMultiplier: Int,
    @JsonScalaEnumeration(classOf[PeriodEnum.Class])
    period: PeriodEnum.Value,
    businessCenters: Option[BusinessCenters],
    fixingOffsetDefinition: Option[String],
    fixingOffsetReason: Option[String],
    designatedMaturity: Option[String],
    meta: Option[MetaFields])
  extends BusinessDayOffsetTrait {
}
...
/**
  ...
  * @param hourMinuteTime A time specified in hh:mm:ss format where the second component must be '00', e.g. 11am would be represented as 11:00:00.
  * @param businessCenter A code identifying a business day calendar location. A business day calendar location is drawn from the list identified by the business day calendar location enumeration.
  * @param designatedMaturity Allows a designed maturity to be specified for the fixing time.
  * @param fixingTimeDefinition Legal text that underlies the Fixing Time. ISDA Fixing Time Definition. (e.g. 09:30, Sydney time).
  * @param fixingReason Fixing Reason
  */
case class FloatingRateIndexFixingTime(hourMinuteTime: java.time.LocalTime,
    businessCenter: FieldWithMetaBusinessCenterEnum,
    designatedMaturity: Option[String],
    fixingTimeDefinition: Option[String],
    fixingReason: Option[String])
  extends BusinessCenterTimeTrait {
}
...
/**
  ...
  *
  * @param index  The FRO name that is being mapped to/from.
  * @param contractualDefinitionIdentifier Contractual Definition to which the map applies. Includes Document Type and Document Version
  * @param identifier Corresponds to the unique identifier of the Contractual Definition to which the map applies
  */
case class FloatingRateIndexMap(@JsonScalaEnumeration(classOf[FloatingRateIndexEnum.Class])
    index: List[FloatingRateIndexEnum.Value],
    contractualDefinitionIdentifier: Option[ContractualDefinitionIdentifier],
    identifier: Option[Identifier]) {
}
...
/**
  ...
  *
  * @param mapsTo The successor FRO that this index maps to.
  * @param mapsFrom The predecessor FRO(s) that this index maps to.
  */
case class FloatingRateIndexMappings(mapsTo: Option[FloatingRateIndexMap],
    mapsFrom: List[FloatingRateIndexMap]) {
}
...
/**
  ...
  */
case class FloatingRateSpecification(rateOption: Option[ReferenceWithMetaInterestRateIndex],
    spreadSchedule: Option[SpreadSchedule],
    capRateSchedule: Option[StrikeSchedule],
    floorRateSchedule: Option[StrikeSchedule],
    floatingRateMultiplierSchedule: Option[RateSchedule],
...
/**
  ...
  */
case class ForeignExchangeRateIndex(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
    ...
    @JsonScalaEnumeration(classOf[AssetClassEnum.Class])
    assetClass: Option[AssetClassEnum.Value],
    quotedCurrencyPair: FieldWithMetaQuotedCurrencyPair,
...
/**
  ...
  *
  * @param isApplicable The qualification of whether the French Law Addendum is deemed applicable by the parties (True) or not (False).
  * @param partyElection The parties French Law Addendum Elections.
  */
case class FrenchLawAddendum(isApplicable: Boolean,
    partyElection: List[FrenchLawAddendumElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param isApplicable The qualification of whether the party elects specific language.
  * @param addendumLanguage The party specific language to be included in the agreement.
  */
case class FrenchLawAddendumElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    isApplicable: Boolean,
    addendumLanguage: Option[String]) {
}
...
/**
  * FRO History
  *
  * @param startDate The date the Floating Rate Option was added to the 2006 Definitions or 2021 Floating Rate Matrix. (e.g. 2017/04/06)
  * @param firstDefinedIn The supplement or version the FRO was first added to the 2006 Definitions or 2021 Floating Rate Matrix. (e.g. S52)
  * @param updateDate The date the Floating Rate Option was last updated in the 2006 Definitions or 2021 Floating Rate Matrix. (e.g. 2021/06/11)
  * @param lastUpdatedIn The supplement or version the FRO was last updated in the 2006 Definitions or 2021 Floating Rate Matrix. (e.g. FRO-M-V1)
  * @param endDate The date the Floating Rate Option was removed from the 2006 Definitions or 2021 Floating Rate Matrix. (e.g. 2014/01/01)
  */
case class FroHistory(startDate: Option[java.time.LocalDate],
    firstDefinedIn: Option[ContractualDefinition],
    updateDate: Option[java.time.LocalDate],
    lastUpdatedIn: Option[ContractualDefinition],
    endDate: Option[java.time.LocalDate]) {
}
...
/**
  ...
  *
  * @param disruptionEvents 
  * @param determinationTerms 
  * @param noFaultTermination 
  */
case class FxAdditionalTerms(disruptionEvents: Option[FxDisruptionEvents],
    determinationTerms: Option[DeterminationRolesAndTerms],
    noFaultTermination: Option[Boolean]) {
}

case class FxBenchmarkObligationDefault(benchmarkObligationDefaultIsApplicable: Boolean,
    @JsonDeserialize(contentAs = classOf[FxSubstitutionProvisionTypeEnum.Value])
    @JsonScalaEnumeration(classOf[FxSubstitutionProvisionTypeEnum.Class])
    localSubstituteProvisionType: Option[FxSubstitutionProvisionTypeEnum.Value],
    @JsonDeserialize(contentAs = classOf[SpecifiedValueEnum.Value])
    @JsonScalaEnumeration(classOf[SpecifiedValueEnum.Class])
    specifiedValue: Option[SpecifiedValueEnum.Value],
    escrowArrangement: Option[EscrowArrangement]) {
}

/**
  * Additional Provisions for a Confirmation of an FX or Currency Option Transaction
  *
  * @param illegalityOrImpossibility 
  * @param forceMajeureOrActOfSState 
  * @param eventCurrency Additional Provisions for a Confirmation of an FX or Currency Option Transaction.
  * @param priceSourceDisruption 
  * @param benchmarkObligationDefault 
  * @param dualExchangeRate 
  * @param inconvertibilityOrNonTransferability 
  * @param governmentalAuthorityDefault 
  * @param illiquidity 
  * @param materialChangeInCircumstance 
  * @param nationalization 
  * @param priceMateriality 
  * @param fallbackLanguageBespokeTerms Where parties may optionaly describe any extra bespoke agreements about fallback procedure attached to a particular determination role.
  */
case class FxDisruptionEvents(@JsonDeserialize(contentAs = classOf[FxIllegalityOrImpossibilityEnum.Value])
    @JsonScalaEnumeration(classOf[FxIllegalityOrImpossibilityEnum.Class])
    illegalityOrImpossibility: Option[FxIllegalityOrImpossibilityEnum.Value],
    @JsonDeserialize(contentAs = classOf[FxForceMajeureOrActOfSStateEnum.Value])
    @JsonScalaEnumeration(classOf[FxForceMajeureOrActOfSStateEnum.Class])
    forceMajeureOrActOfSState: Option[FxForceMajeureOrActOfSStateEnum.Value],
    eventCurrency: Option[EventCurrency],
    priceSourceDisruption: Option[FxPriceSourceDisruption],
    benchmarkObligationDefault: Option[FxBenchmarkObligationDefault],
    dualExchangeRate: Option[FxDualExchangeRate],
    inconvertibilityOrNonTransferability: Option[FxInconvertibilityOrNonTransferability],
    governmentalAuthorityDefault: Option[GovernmentalAuthorityDefault],
    illiquidity: Option[Illiquidity],
    materialChangeInCircumstance: Option[MaterialChangeInCircumstance],
    nationalization: Option[Nationalization],
    priceMateriality: Option[PriceMateriality],
    fallbackLanguageBespokeTerms: Option[Clause]) {
}

case class FxDualExchangeRate(dualExchangeRateIsApplicable: Boolean,
    fallbackReferencePrice: Option[FallbackReferencePrice],
    escrowArrangement: Option[EscrowArrangement]) {
}
...
/**
  ...
  */
case class FxFixingDate(periodMultiplier: Int,
    @JsonScalaEnumeration(classOf[PeriodEnum.Class])
    period: PeriodEnum.Value,
    @JsonDeserialize(contentAs = classOf[DayTypeEnum.Value])
    @JsonScalaEnumeration(classOf[DayTypeEnum.Class])
    dayType: Option[DayTypeEnum.Value],
    @JsonDeserialize(contentAs = classOf[BusinessDayConventionEnum.Value])
    @JsonScalaEnumeration(classOf[BusinessDayConventionEnum.Class])
...
/**
  ...
  *
  * @param isTerminationCurrency The reference currency for the purpose of specifying the FX Haircut relating to a posting obligation is the Termination Currency when the Boolean value is set to True.
  * @param fxDesignatedCurrency When specified, the reference currency for the purpose of specifying the FX Haircut relating to a posting obligation. The list of valid currencies is not presently positioned as an enumeration as part of the CDM because that scope is limited to the values specified by ISDA and FpML. As a result, implementers have to make reference to the relevant standard, such as the ISO 4217 standard for currency codes.
  */
case class FxHaircutCurrency(isTerminationCurrency: Boolean,
    fxDesignatedCurrency: Option[FieldWithMetaString]) {
}

case class FxInconvertibilityOrNonTransferability(generalInconvertibility: Option[GeneralInconvertibility],
    generalNonTransferability: Option[GeneralNonTransferability],
    specificInconvertibility: Option[SpecificInconvertibility],
    specificNonTransferability: Option[SpecificNonTransferability]) {
}
...
/**
  ...
  */
case class FxInformationSource(sourceProvider: FieldWithMetaInformationProviderEnum,
...
case class FxPriceSourceDisruption(priceSourceDisruptionIsApplicable: Boolean,
    fallbackReferencePrice: Option[SettlementRateOption],
    escrowArrangement: Option[EscrowArrangement]) {
}
...
case class GeneralInconvertibility(generalInconvertibilityIsApplicable: Boolean,
    @JsonDeserialize(contentAs = classOf[FxSubstitutionProvisionTypeEnum.Value])
    @JsonScalaEnumeration(classOf[FxSubstitutionProvisionTypeEnum.Class])
    localSubstituteProvisionType: Option[FxSubstitutionProvisionTypeEnum.Value],
    maximumDaysOfDisruption: Option[ValuationPostponement],
    nonDeliverableSubstitute: Option[NonDeliverableSubstitute],
    escrowArrangement: Option[EscrowArrangement]) {
}

case class GeneralNonTransferability(generalNonTransferabilityIsApplicable: Boolean,
    @JsonDeserialize(contentAs = classOf[FxSubstitutionProvisionTypeEnum.Value])
    @JsonScalaEnumeration(classOf[FxSubstitutionProvisionTypeEnum.Class])
    localSubstituteProvisionType: Option[FxSubstitutionProvisionTypeEnum.Value],
    maximumDaysOfDisruption: Option[ValuationPostponement],
...
/**
  ...
  *
  * @param simmVersion The qualification of the ISDA SIMM version that is specified for all Covered Transactions.
  * @param simmCalculationCurrency The SIMM Calculation Currency, as specified for each of the parties to the CSA Initial Margin.
  */
case class GeneralSimmElections(simmVersion: Option[SimmVersion],
...
/**
  ...
  *
  */
case class GlobalMasterRepoAgreement()
  extends MasterAgreementBaseTrait {
}
...
/**
  ...
  *
  */
case class GlobalMasterSecuritiesLendingAgreement()
  extends MasterAgreementBaseTrait {
}

case class GovernmentalAuthorityDefault(governmentalAuthorityDefaultIsApplicable: Boolean,
    escrowArrangement: Option[EscrowArrangement],
    @JsonDeserialize(contentAs = classOf[FxSubstitutionProvisionTypeEnum.Value])
    @JsonScalaEnumeration(classOf[FxSubstitutionProvisionTypeEnum.Class])
    localSubstituteProvisionType: Option[FxSubstitutionProvisionTypeEnum.Value],
...
/**
  ...
  *
  * @param partyElection The parties' elections for the holding and using of posted collateral.
  */
case class HoldingAndUsingPostedCollateral(partyElection: List[HoldingAndUsingPostedCollateralElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param eligibilityToHoldCollateral The specification of the conditions under which a party and its custodian(s) are entitled to hold posted collateral.
  * @param useOfPostedCollateral Specifies whether the party to the agreement has the right to rehypothecate the collateral held (True).
  */
case class HoldingAndUsingPostedCollateralElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
...
case class Illiquidity(illiquidityIsApplicable: Boolean,
    escrowArrangement: Option[EscrowArrangement],
    minimumAmount: Option[Quantity],
    fallbackReferencePrice: Option[SettlementRateOption],
    illiquidityValuationDate: Option[AdjustedRelativeDateOffset]) {
}
...
/**
  ...
  */
case class IndependentAmount(payerPartyReference: ReferenceWithMetaParty,
    ...
    paymentDetail: List[PaymentDetail])
...
/**
  ...
  *
  * @param indexModification Consequence of index modification.
  * @param indexCancellation Consequence of index cancellation.
  * @param indexDisruption Consequence of index disruption.
  */
case class IndexAdjustmentEvents(@JsonScalaEnumeration(classOf[IndexEventConsequenceEnum.Class])
    indexModification: IndexEventConsequenceEnum.Value,
    @JsonScalaEnumeration(classOf[IndexEventConsequenceEnum.Class])
    indexCancellation: IndexEventConsequenceEnum.Value,
    @JsonScalaEnumeration(classOf[IndexEventConsequenceEnum.Class])
    indexDisruption: IndexEventConsequenceEnum.Value) {
}
...
/**
  ...
  * @param assetClass The Asset Class of the Index.
  */
case class IndexBase(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
...
/**
  ...
  *
  * @param totalIneligibilityDate Total Ineligibility Date has the meaning specified in Paragraph 11(g), unless otherwise specified here.
  * @param transferIneligibilityDate Transfer Ineligibility Date has the meaning specified in Paragraph 11(g), unless otherwise specified here.
  * @param specifiedParty The parties to which the provisions of the CSA will apply to, as the Secured Party.
  */
case class IneligibleCreditSupport(totalIneligibilityDate: Option[String],
    transferIneligibilityDate: Option[String],
    specifiedParty: List[ReferenceWithMetaParty]) {
}

/**
  * Defines that the Threshold is Infinity.
  *
  * @param party Elective Party to which the condition applies.
  */
case class Infinity(@JsonDeserialize(contentAs = classOf[CounterpartyRoleEnum.Value])
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: Option[CounterpartyRoleEnum.Value]) {
}
...
/**
  ...
  * @param indexTenor The ISDA Designated Maturity, i.e. the floating rate tenor.
  */
case class InflationIndex(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
    ...
    @JsonScalaEnumeration(classOf[AssetClassEnum.Class])
    assetClass: Option[AssetClassEnum.Value],
    inflationRateIndex: FieldWithMetaInflationRateIndexEnum,
    indexTenor: Option[Period])
  extends IndexBaseTrait {
}
...
/**
  ...
  */
case class InflationRateSpecification(rateOption: Option[ReferenceWithMetaInterestRateIndex],
    spreadSchedule: Option[SpreadSchedule],
    capRateSchedule: Option[StrikeSchedule],
    floorRateSchedule: Option[StrikeSchedule],
    floatingRateMultiplierSchedule: Option[RateSchedule],
...
/**
  ...
  */
case class InstrumentBase(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
...
/**
  ...
  *
  * @param isApplicable The Interest Adjustment is applicable when True and not applicable when False.
  * @param periodicity The qualification of the Interest Adjustment periodicity.
  */
case class InterestAdjustment(isApplicable: Boolean,
...
/**
  ...
  *
  * @param standardElection The Interest Adjustment periodicity when specified through a standardized election.
  * @param customElection The Interest Adjustment periodicity when specified through a custom election.
  */
case class InterestAdjustmentPeriodicity(@JsonDeserialize(contentAs = classOf[InterestAdjustmentPeriodicityEnum.Value])
    @JsonScalaEnumeration(classOf[InterestAdjustmentPeriodicityEnum.Class])
    standardElection: Option[InterestAdjustmentPeriodicityEnum.Value],
    customElection: Option[String]) {
}
...
/**
  ...
  */
case class InterestAmount(returnAmount: ReturnAmount,
...
/**
  ...
  */
case class InterestRatePayout(payerReceiver: PayerReceiver,
    priceQuantity: Option[ResolvablePriceQuantity],
    principalPayment: Option[PrincipalPayments],
    settlementTerms: Option[SettlementTerms],
    rateSpecification: Option[RateSpecification],
...
/**
  ...
  *
  * @param isApplicable Japanese Securities Provisions are applicable when True and Not Applicable when False.
  * @param relevantProvisionsElection Recommended Japanese Securities Provisions are applicable when True, additional Provisions are specified when False.
  * @param relevantProvisionsTerms Specific terms applicable to Recommended Japanese Securities Provisions.
  * @param amendmentsToJapaneseProvisions Additional Amendments to Japanese Securities Provisions are specified when True, and not specified when False.
  * @param amendmentsToJapaneseProvisionsTerms Specific terms applicable to Additional Amendments to Japanese Securities Provisions.
  * @param clearstreamAmendmentToJapaneseProvisions Specification of whether Clearstream Event amendment language is included (true) or excluded (false).
  */
case class JapaneseSecuritiesProvisions(isApplicable: Boolean,
    relevantProvisionsElection: Option[Boolean],
    relevantProvisionsTerms: Option[String],
    amendmentsToJapaneseProvisions: Option[Boolean],
    amendmentsToJapaneseProvisionsTerms: Option[String],
    clearstreamAmendmentToJapaneseProvisions: Option[Boolean]) {
}

/**
  * A class to specify terms jurisdiction related terms.
  *
  * @param japaneseSecuritiesProvisions The Japanese Securities Provisions election.
  * @param exclusiveJurisdiction Classification of optional exclusive jurisdiction terms.
  * @param juryWaiver The Jury Waiver conditions specific to the agreement.
  * @param frenchLawAddendum The French Law Addendum Provisions specific to the agreement.
  * @param belgianLawSecurityAgreement The qualification of whether the Belgian Law Security Agreement Addendum is deemed applicable by the parties (True) or not (False).
  */
case class JurisdictionRelatedTerms(japaneseSecuritiesProvisions: Option[JapaneseSecuritiesProvisions],
    exclusiveJurisdiction: Option[Boolean],
    juryWaiver: Option[Boolean],
    frenchLawAddendum: Option[FrenchLawAddendum],
    belgianLawSecurityAgreement: Option[Boolean]) {
}
...
/**
  ...
  */
case class Knock(knockIn: List[TriggerEvent],
    knockOut: List[TriggerEvent]) {
}
...
/**
  ...
  *
  * @param isApplicable A boolean flag to represent bespoke amendment to the pre-print definition of Transfer.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyDefinition(isApplicable: Option[Boolean],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param legacyDeliveryAmount Specifies whether the meaning of Delivery Amount follows the pre-print definition or deviates from this (either based on a rating or some other methodology).
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyDeliveryAmount(@JsonScalaEnumeration(classOf[LegacyDeliveryReturnAmountEnum.Class])
    legacyDeliveryAmount: LegacyDeliveryReturnAmountEnum.Value,
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param excludedTransactions A boolean flag to represent whether any transactions are excluded (ie True) or not (ie False).
  * @param excludedProducts Description of the relevant derivative transactions excluded from the calculation of exposure.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyExposureScopeElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    excludedTransactions: Boolean,
    excludedProducts: List[ExcludedProducts],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param resolutionAlternative Details of the alternative dispute resolution procedure (if any).
  * @param amount The maximum amount to which the difference between the calculations by the valuation agent and disputing party can be split, where Split the Difference is elected.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyResolutionAlternative(@JsonDeserialize(contentAs = classOf[LegacyResolutionAlternativeEnum.Value])
    @JsonScalaEnumeration(classOf[LegacyResolutionAlternativeEnum.Class])
    resolutionAlternative: Option[LegacyResolutionAlternativeEnum.Value],
    amount: Option[Money],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param cash Details of how cash collateral is valued when resolving disputes.
  * @param securities Details of how securities collateral is valued when resolving disputes.
  * @param fallback A boolean flag to represent whether a fallback calculation method is applicable.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyResolutionValue(@JsonDeserialize(contentAs = classOf[ValueCashEnum.Value])
    @JsonScalaEnumeration(classOf[ValueCashEnum.Class])
    cash: Option[ValueCashEnum.Value],
    @JsonDeserialize(contentAs = classOf[ValueSecuritiesEnum.Value])
    @JsonScalaEnumeration(classOf[ValueSecuritiesEnum.Class])
    securities: Option[ValueSecuritiesEnum.Value],
...
/**
  ...
  *
  * @param legacyReturnAmount Specifies whether the meaning of Return Amount follows the pre-print definition or deviates from this (either based on a rating or some other methodology).
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyReturnAmount(@JsonScalaEnumeration(classOf[LegacyDeliveryReturnAmountEnum.Class])
    legacyReturnAmount: LegacyDeliveryReturnAmountEnum.Value,
    additionalLanguage: Option[String]) {
}
...
/**
  * Specification of transfer / settlement timing for cash and securities collateral assuming that the notice is provided before the Notification Time (and with a 1LBD lag introduced if the notice is delivered after the Notification Time), and that securities allow for a further Local Business Day for transfer / settlement.
  *
  * @param cashCollateralTransferSettlementTime Details the day on which collateral is required to be transferred relative to the Notification Time.
  * @param securititesCollateralTransferSettlementTime Details the day on which collateral is required to be transferred relative to the Notification Time.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyTransferSettlementTiming(@JsonDeserialize(contentAs = classOf[CashCTSTimeEnum.Value])
    @JsonScalaEnumeration(classOf[CashCTSTimeEnum.Class])
    cashCollateralTransferSettlementTime: Option[CashCTSTimeEnum.Value],
    @JsonDeserialize(contentAs = classOf[SecuritiesCTSTimeEnum.Value])
    @JsonScalaEnumeration(classOf[SecuritiesCTSTimeEnum.Class])
    securititesCollateralTransferSettlementTime: Option[SecuritiesCTSTimeEnum.Value],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param valuationAgent Specifies how the Valuation Agent is determined.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyValuationAgent(@JsonDeserialize(contentAs = classOf[ValuationAgentPartyEnum.Value])
    @JsonScalaEnumeration(classOf[ValuationAgentPartyEnum.Class])
    party: Option[ValuationAgentPartyEnum.Value],
    @JsonDeserialize(contentAs = classOf[LegacyValuationAgentEnum.Value])
    @JsonScalaEnumeration(classOf[LegacyValuationAgentEnum.Class])
    valuationAgent: Option[LegacyValuationAgentEnum.Value],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param date Defines whether a date is defined by a certain day of the week or a particular date in the month. If not specified here, then additional language must be used.
  * @param day Specific day(s) or day of the week, if any, specified for Valuation Time.
  * @param calendarDay Defines the day of the calendar if this is specified for in the ValuationDateDateEnum.
  * @param frequency Defines the regularity of the date specified for the Valuation Date.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyValuationDate(@JsonDeserialize(contentAs = classOf[ValuationDateDateEnum.Value])
    @JsonScalaEnumeration(classOf[ValuationDateDateEnum.Class])
    date: Option[ValuationDateDateEnum.Value],
    @JsonDeserialize(contentAs = classOf[ValuationDateDayEnum.Value])
    @JsonScalaEnumeration(classOf[ValuationDateDayEnum.Class])
    day: Option[ValuationDateDayEnum.Value],
    calendarDay: Option[scala.math.BigDecimal],
    @JsonDeserialize(contentAs = classOf[ValuationDateFrequencyEnum.Value])
    @JsonScalaEnumeration(classOf[ValuationDateFrequencyEnum.Class])
    frequency: Option[ValuationDateFrequencyEnum.Value],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  *
  * @param day The day in respect of which the Valuation Time is being specified. If not specified, addional language must be used to define the methodology.
  * @param location The location relevant to the timezone for the Valuation Time.
  * @param time The type of time specified for the Valuation Time.
  * @param hourminutetime A time specified in a 24-hour notation, e.g. 3pm would be represented as 15:00.
  * @param timezone Any relevant time zone where specified.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class LegacyValuationTime(@JsonDeserialize(contentAs = classOf[ValuationTimeDayEnum.Value])
    @JsonScalaEnumeration(classOf[ValuationTimeDayEnum.Class])
    day: Option[ValuationTimeDayEnum.Value],
    @JsonScalaEnumeration(classOf[BusinessCenterEnum.Class])
    location: List[BusinessCenterEnum.Value],
    @JsonDeserialize(contentAs = classOf[ValuationTimeEnum.Value])
    @JsonScalaEnumeration(classOf[ValuationTimeEnum.Class])
    time: Option[ValuationTimeEnum.Value],
    hourminutetime: Option[java.time.LocalTime],
    @JsonDeserialize(contentAs = classOf[BusinessCenterEnum.Value])
    @JsonScalaEnumeration(classOf[BusinessCenterEnum.Class])
    timezone: Option[BusinessCenterEnum.Value],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  */
case class LegalAgreement(agreementDate: Option[java.time.LocalDate],
    effectiveDate: Option[java.time.LocalDate],
    ...
    agreementTerms: Option[AgreementTerms],
...
/**
  ...
  *
  * @param entityId A legal entity identifier (e.g. RED entity code). This type is deprecated. It is recommended to use entityIdentifier.
  * @param name The legal entity name.
  * @param entityIdentifier A legal entity identifier with a source (e.g. RED entity code).
  */
case class LegalEntity(entityId: List[FieldWithMetaString],
    name: FieldWithMetaString,
    entityIdentifier: List[EntityIdentifier],
    meta: Option[MetaFields])
...
/**
  ...
  */
case class LimitApplicableExtended(limitType: Option[FieldWithMetaCreditLimitTypeEnum],
    clipSize: Option[Int],
    amountUtilized: Option[scala.math.BigDecimal],
    utilization: Option[CreditLimitUtilisation],
    amountRemaining: Option[scala.math.BigDecimal],
    currency: Option[FieldWithMetaString],
    velocity: Option[Velocity],
    limitLevel: Option[FieldWithMetaLimitLevelEnum],
...
/**
  ...
  */
case class ListedDerivative(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
...
/**
  ...
  */
case class Loan(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
...
/**
  ...
  */
case class LoanParticipation(applicable: Boolean,
    partialCashSettlement: Option[Boolean],
    qualifyingParticipationSeller: Option[String])
...
/**
  ...
  */
case class LocationIdentifier(issuerReference: Option[ReferenceWithMetaParty],
    issuer: Option[FieldWithMetaString],
    assignedIdentifier: List[AssignedIdentifier],
    @JsonDeserialize(contentAs = classOf[CommodityLocationIdentifierTypeEnum.Value])
...
/**
  ...
  *
  * @param party The party to which the Minimum Transfer Amount (MTA) applies.
  * @param amount The amount value applicable to the Minimum Transfer Amount (MTA).
  * @param currency The minimum transfer amount currency code.
  */
case class MTAFixedAmount(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    amount: Int,
    @JsonScalaEnumeration(classOf[ISOCurrencyCodeEnum.Class])
    currency: ISOCurrencyCodeEnum.Value) {
...
/**
  ...
  * @param party The party to which the Minimum Transfer Amount (MTA) applies.
  * @param currency The minimum transfer amount currency code.
  * @param ratingType The relevant rating type.
  * @param variableSet Defines a combination of Rating Agency, Rating Value, amount and Currency code.
  * @param ratedParty The party to which a rating applies.
  * @param namedEntity Details the Named Entity where the Rated Party is Named Entity.
  * @param namedAffiliate Details the Named Affiliate where the Rated Party is Named Affiliate.
  * @param compare Where two ratings are specified whether the higher or lower rating prevails.
  * @param noRating What conditions apply where a party has no rating.
  * @param notRatedBy Defines where conditions apply if no Rating where ratings may not exist.
  * @param numberOfRatingAgencies Defines the number of Rating Agencies that the Party must be rated by.
  * @param zeroEvent Whether a trigger applies for the threshold to fall to zero.
  * @param event The relevant trigger for the to fall to zero.
  */
case class MTARatingsBased(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    @JsonScalaEnumeration(classOf[ISOCurrencyCodeEnum.Class])
    currency: ISOCurrencyCodeEnum.Value,
    @JsonScalaEnumeration(classOf[RatingTypeEnum.Class])
    ratingType: RatingTypeEnum.Value,
    variableSet: List[CSAMTAVariableSet],
    @JsonDeserialize(contentAs = classOf[MTARatedPartyEnum.Value])
    @JsonScalaEnumeration(classOf[MTARatedPartyEnum.Class])
    ratedParty: Option[MTARatedPartyEnum.Value],
    namedEntity: Option[String],
    namedAffiliate: Option[String],
    @JsonDeserialize(contentAs = classOf[CreditNotationMismatchResolutionEnum.Value])
    @JsonScalaEnumeration(classOf[CreditNotationMismatchResolutionEnum.Class])
    compare: Option[CreditNotationMismatchResolutionEnum.Value],
    noRating: Boolean,
    @JsonDeserialize(contentAs = classOf[NotRatedByEnum.Value])
    @JsonScalaEnumeration(classOf[NotRatedByEnum.Class])
    notRatedBy: Option[NotRatedByEnum.Value],
    @JsonDeserialize(contentAs = classOf[NumberOfRatingAgenciesEnum.Value])
    @JsonScalaEnumeration(classOf[NumberOfRatingAgenciesEnum.Class])
    numberOfRatingAgencies: Option[NumberOfRatingAgenciesEnum.Value],
    zeroEvent: Boolean,
    @JsonScalaEnumeration(classOf[MTAZeroEventEnum.Class])
    event: List[MTAZeroEventEnum.Value]) {
}

/**
  * Details whether the Minimum Transfer Amount is rating based, a fixed amount, or infinity.
  *
  * @param fixedAmount Defines that the Minimum Transfer Amount (MTA) is a Fixed Amount.
  * @param ratingsBased Defines that the Minimum Transfer Amount (MTA) is based on a Ratings condition(s).
  * @param other Utilised where the clause data structure is not able to capture a material aspect of the clause.
  */
case class MTAType(fixedAmount: Option[MTAFixedAmount],
    ratingsBased: Option[MTARatingsBased],
    other: Option[String]) {
}
...
/**
  ...
  */
case class MakeWholeAmount(@JsonScalaEnumeration(classOf[FloatingRateIndexEnum.Class])
    floatingRateIndex: FloatingRateIndexEnum.Value,
    indexTenor: Option[Period],
    ...
    @JsonDeserialize(contentAs = classOf[InterpolationMethodEnum.Value])
    @JsonScalaEnumeration(classOf[InterpolationMethodEnum.Class])
...
/**
  ...
  */
case class MarginApproach(@JsonScalaEnumeration(classOf[MarginApproachEnum.Class])
    marginApproach: MarginApproachEnum.Value) {
}
...
/**
  ...
  */
case class MarginCallExposure(instructionType: MarginCallInstructionType,
    party: List[Party],
    partyRole: List[PartyRole],
    clearingBroker: Option[Party],
    callIdentifier: Option[Identifier],
...
/**
  ...
  */
case class MarginCallIssuance(instructionType: MarginCallInstructionType,
    party: List[Party],
    partyRole: List[PartyRole],
    clearingBroker: Option[Party],
    callIdentifier: Option[Identifier],
...
/**
  ...
  */
case class MarginCallResponse(instructionType: MarginCallInstructionType,
    party: List[Party],
    partyRole: List[PartyRole],
    clearingBroker: Option[Party],
    callIdentifier: Option[Identifier],
    ...
    collateralPortfolio: Option[ReferenceWithMetaCollateralPortfolio],
    independentAmountBalance: Option[CollateralBalance],
    marginCallResponseAction: List[MarginCallResponseAction],
...
/**
  ...
  *
  * @param automaticEarlyTermination The specification of whether there is an automatic occurrence of an Early Termination Date in respect of Transactions upon the occurrence of certain bankruptcy / insolvency related events.
  * @param terminationCurrency Specification of the currency in which the termination payment is made (including the process by which such currency is determined).
  * @param addressForNotices Specification of the address and other details for notices.
  * @param nonContractualObligations Specification of whether the Governing Law clause extends to Non-Contractual Obligations (True) or does not extend to Non-Contractual Obligations (False).
  * @param creditSupportDocument Identification of party specific Credit Support Documents applicable to the document.
  * @param creditSupportProvider Identification of party specific Credit Support Providers applicable to the document.
  * @param specifiedEntities A provision that allows each party to specify its Specified Entities for certain Events of Default and Termination Events.
  */
case class MasterAgreement(automaticEarlyTermination: AutomaticEarlyTermination,
    terminationCurrency: TerminationCurrency,
    addressForNotices: AddressForNotices,
    nonContractualObligations: Boolean,
    creditSupportDocument: CreditSupportDocument,
    creditSupportProvider: CreditSupportProvider,
    specifiedEntities: List[SpecifiedEntities])
  extends MasterAgreementBaseTrait {
}
...
/**
  ...
  *
  */
case class MasterAgreementBase()
  extends MasterAgreementBaseTrait {
}
...
/**
  ...
  *
  * @param islaGmsla The set of elections that define a GMSLA.
  * @param icmaGmra The set of elections that define a GMRA.
  * @param isdaMaster The set of elections that define an ISDA Master Agreement.
  */
case class MasterAgreementElections(islaGmsla: Option[GlobalMasterSecuritiesLendingAgreement],
    icmaGmra: Option[GlobalMasterRepoAgreement],
    isdaMaster: Option[MasterAgreement]) {
}
...
case class MaterialChangeInCircumstance(materialChangeInCircumstanceIsApplicable: Boolean,
    escrowArrangement: Option[EscrowArrangement],
    maximumDaysOfDisruption: Option[ValuationPostponement]) {
}
...
/**
  ...
  */
case class MeasureSchedule(value: Option[scala.math.BigDecimal],
    unit: Option[UnitType],
    datedValue: List[DatedValue])
...
/**
  ...
  *
  * @param partyElection The parties' minimum transfer amount elections.
  */
case class MinimumTransferAmount(partyElection: List[ElectiveAmountElection]) {
}

/**
  *  A class to specify whether Amendment to Minimum Transfer Amount language is applicable or not.
  *
  * @param isApplicable The definition of Minimum Transfer Amount in any Other Regulatory CSA will be amended when applicable.
  * @param effectiveDate The effective date of the Amendment to Termination Currency.
  * @param partyElections The party elective amounts.
  */
case class MinimumTransferAmountAmendment(isApplicable: Boolean,
    effectiveDate: Option[AmendmentEffectiveDate],
    partyElections: List[ElectiveAmountElection]) {
}
...
/**
  ...
  */
case class Money(value: Option[scala.math.BigDecimal],
    unit: Option[UnitType],
    datedValue: List[DatedValue],
...
/**
  ...
  */
case class MultipleExercise(notionaReference: ReferenceWithMetaMoney,
    ...
    maximumNotionalAmount: Option[scala.math.BigDecimal],
    maximumNumberOfOptions: Option[Int])
  extends PartialExerciseTrait {
}

case class MultipleValuationDates(businessDays: Option[Int],
    businessDaysThereafter: Option[Int],
    numberValuationDates: Option[Int])
  extends SingleValuationDateTrait {
}

case class Nationalization(nationalizationIsApplicable: Boolean,
    relevantAffiliate: List[AncillaryEntity],
    escrowArrangement: Option[EscrowArrangement],
    assignmentOfClaim: Option[Boolean],
    maximumDaysOfDisruption: Option[ValuationPostponement]) {
}
...
case class NonDeliverableSubstitute(nonDeliverableSubstituteIsApplicable: Boolean,
    valuationDate: Option[AdjustedRelativeDateOffset],
    settlementDate: Option[AdjustedRelativeDateOffset],
...
/**
  ...
  * @param frequency Defines the frequency to be used when defining a quantity. For example a quantity may be specified as a number of barrels of oil per day, which needs multiplying by the number of days in the relevant period to get the total quantity as a number of barrels.
  */
case class NonNegativeQuantity(value: Option[scala.math.BigDecimal],
    unit: Option[UnitType],
    datedValue: List[DatedValue],
    multiplier: Option[Measure],
    frequency: Option[Frequency])
...
case class NonNegativeQuantitySchedule(value: Option[scala.math.BigDecimal],
    unit: Option[UnitType],
    datedValue: List[DatedValue],
    multiplier: Option[Measure],
    frequency: Option[Frequency])
...
/**
  ...
  *
  * @param partyElections The parties' Notification Time election.
  * @param disputeNotificationReference The determination of whether reference is made to dispute resolution notification timing in the agreement.
  * @param transferTimingProviso The determination of whether transfer timing language is applicable or not.
  */
case class NotificationTime(partyElections: List[NotificationTimeElection],
    disputeNotificationReference: Option[Boolean],
    transferTimingProviso: Option[Boolean]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param notificationTime The Notification Time as a time that is qualified as a standard business center.
  * @param customNotification The Notification Time as a bespoke election.
  * @param localBusinessDay Whether the Notification Time is precluded on the day being a local business day.
  */
case class NotificationTimeElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    notificationTime: Option[BusinessCenterTime],
    customNotification: Option[String],
    localBusinessDay: Option[Boolean]) {
}
...
/**
  ...
  * @param dayType In the case of an offset specified as a number of days, this element defines whether consideration is given as to whether a day is a good business day or not. If a day type of business days is specified then non-business days are ignored when calculating the offset. The financial business centers to use for determination of business days are implied by the context in which this element is used. This element must only be included when the offset is specified as a number of days. If the offset is zero days then the dayType element should not be included.
  */
case class Offset(periodMultiplier: Int,
    @JsonScalaEnumeration(classOf[PeriodEnum.Class])
    period: PeriodEnum.Value,
    @JsonDeserialize(contentAs = classOf[DayTypeEnum.Value])
    @JsonScalaEnumeration(classOf[DayTypeEnum.Class])
...
/**
  ...
  *
  * @param isApplicable The determination of whether the One Way Provisions are applicable (true) or not applicable (false).
  * @param postingParty The Posting Party for the purposes of One Way Provisions. It is specified in the case where the One Way Provision is deemed applicable.
  */
case class OneWayProvisions(isApplicable: Boolean,
    @JsonDeserialize(contentAs = classOf[CounterpartyRoleEnum.Value])
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    postingParty: Option[CounterpartyRoleEnum.Value]) {
}
...
/**
  ...
  * @param strike Specifies the strike of the option
  */
case class OptionPayout(payerReceiver: PayerReceiver,
    priceQuantity: Option[ResolvablePriceQuantity],
    principalPayment: Option[PrincipalPayments],
    settlementTerms: Option[SettlementTerms],
...
/**
  ...
  *
  * @param otherCsa The bespoke definition of Other CSA as specified by the parties to the agreement.
  * @param japaneseLawCsa The bespoke definition of whether Japanese Law CSA (VM) are specified by the parties to the agreement.
  */
case class OtherAgreements(otherCsa: Option[OtherAgreementTerms],
    japaneseLawCsa: Option[OtherAgreementTerms]) {
}

/**
  * A class to specify the Other Eligible Support elections associated Initial and Variation margin agreements.
  *
  * @param applicableValue The definition of 'Value' with respect to Other Eligible Support (IM) and Other Posted Support (IM).
  * @param applicableTransfer The definition of 'Transfer' with respect to Other Eligible Support (IM) and Other Posted Support (IM).
  */
case class OtherEligibleAndPostedSupport(applicableValue: Boolean,
    applicableTransfer: Option[Boolean]) {
}
...
/**
  ...
  */
case class OtherIndex(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
...
/**
  ...
  *
  * @param partyReference Party that issued the document identifier.
  * @param documentIdentifier While FpML specifies the document identifier with a value and an associated scheme, the CDM makes use of the Identifier, which has an explicit issuer. The issuer of this identifier is not necessarily the same as the party reference.
  */
case class PartyAgreementIdentifier(partyReference: ReferenceWithMetaParty,
    documentIdentifier: List[FieldWithMetaIdentifier],
    meta: Option[MetaFields]) {
}
...
/**
  ...
  *
  * @param bothAffectedTermCurrencyOption Specifies termination currency where there are two Affected Parties and they cannot agree on the termination currency.
  * @param terminationCurrencySpecifiedCondition Specifies alternative conditions for selection of the termination currency.
  * @param terminationCurrencyCondition Specifies the enumerated conditions for selection of the termination currency.
  */
case class PartyOptionTerminationCurrency(bothAffectedTermCurrencyOption: Option[String],
    terminationCurrencySpecifiedCondition: Option[String],
    @JsonScalaEnumeration(classOf[TerminationCurrencyConditionEnum.Class])
    terminationCurrencyCondition: TerminationCurrencyConditionEnum.Value) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param statedPartyCurrency Specifies termination Currency.
  */
case class PartyTerminationCurrencySelection(party: Party,
    statedPartyCurrency: String) {
}
...
/**
  ...
  */
case class PerformancePayout(payerReceiver: PayerReceiver,
    priceQuantity: Option[ResolvablePriceQuantity],
    principalPayment: Option[PrincipalPayments],
    settlementTerms: Option[SettlementTerms],
    observationTerms: Option[ObservationTerms],
...
/**
  ...
  *
  * @param isApplicable Identification of whether the representative CTA provisions are applicable (True) or not applicable (False).
  * @param party Identification of the represented party.
  * @param representativeTerms The specific representative terms applicable when specified.
  * @param representativeEvent The specification of whether the representative event terms are applicable.
  * @param representativeEventTerms The specific representative event terms applicable when specified.
  * @param representativeEndDate The definition of representative end date in relation to a representative event.
  */
case class PledgeeRepresentativeRider(isApplicable: Boolean,
    @JsonDeserialize(contentAs = classOf[CounterpartyRoleEnum.Value])
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: Option[CounterpartyRoleEnum.Value],
    representativeTerms: Option[String],
    @JsonDeserialize(contentAs = classOf[ExceptionEnum.Value])
    @JsonScalaEnumeration(classOf[ExceptionEnum.Class])
    representativeEvent: Option[ExceptionEnum.Value],
    representativeEventTerms: Option[String],
    representativeEndDate: Option[CustomisableOffset]) {
}
...
/**
  ...
  */
case class PortfolioReturnTerms(priceReturnTerms: Option[PriceReturnTerms],
...
/**
  ...
  */
case class PositionIdentifier(issuerReference: Option[ReferenceWithMetaParty],
    issuer: Option[FieldWithMetaString],
    assignedIdentifier: List[AssignedIdentifier],
    @JsonDeserialize(contentAs = classOf[TradeIdentifierTypeEnum.Value])
...
/**
  ...
  *
  * @param cashOrSecurityValue The Base Currency Equivalent of Cash or Security.
  * @param haircutPercentage Valuation Percentage means, for any item of Eligible Collateral (IM), the percentage specified in accordance with Paragraph 13.
  * @param fxHaircutPercentage FX Haircut Percentage means, for any item of Eligible Collateral (IM), the percentage specified in accordance with Paragraph 13.
  * @param additionalHaircutPercentage Percentage value of any additional haircut to be applied to a collateral asset,the percentage value is expressed as the discount haircut to the value of the collateral- as an example a 5% haircut would be expressed as 0.05.
  * @param disputedCashOrSecurityValue Paragraph 5. If a party (a 'Disputing Party') disputes the Value of any Posted Credit Support (IM).
  */
case class PostedCreditSupportItem(cashOrSecurityValue: Money,
    haircutPercentage: scala.math.BigDecimal,
    fxHaircutPercentage: Option[scala.math.BigDecimal],
    additionalHaircutPercentage: Option[scala.math.BigDecimal],
...
/**
  ...
  *
  * @param securityProvider The security provider party(ies) to which the posting obligations apply to, which can be either one of the parties to the legal agreement, or both of those.
  * @param partyElection The specification of the collateral posting obligations for the security provider party(ies).
  */
case class PostingObligations(securityProvider: String,
    partyElection: List[PostingObligationsElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param asPermitted If set to True, the Control Agreement is a Credit Support Document with respect to the party(ies).
  * @param eligibleCollateral The eligible collateral as specified in relation to the pledgor/chargor/obligor(s) posting obligation.
  * @param excludedCollateral The excluded collateral as specified in relation to the pledgor/chargor/obligor(s) posting obligation.
  * @param additionalLanguage The additional language that might be specified by the parties to the legal agreement.
  */
case class PostingObligationsElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    asPermitted: Boolean,
    eligibleCollateral: List[EligibleCollateralCriteria],
    excludedCollateral: Option[String],
    additionalLanguage: Option[String]) {
}
...
/**
  ...
  */
case class Price(value: Option[scala.math.BigDecimal],
    unit: Option[UnitType],
    datedValue: List[DatedValue],
    perUnitOf: Option[UnitType],
...
case class PriceMateriality(priceMaterialityIsApplicable: Boolean,
    escrowArrangement: Option[EscrowArrangement],
    fallbackReferencePrice: Option[SettlementRateOption]) {
}
...
/**
  ...
  * @param cashPrice (Optionally when the price type is cash) Additional attributes that further define a cash price, e.g. what type of fee it is.
  */
case class PriceSchedule(value: Option[scala.math.BigDecimal],
    unit: Option[UnitType],
    datedValue: List[DatedValue],
    perUnitOf: Option[UnitType],
    @JsonScalaEnumeration(classOf[PriceTypeEnum.Class])
...
/**
  ...
  *
  * @param partyElection The parties' Process Agent election.
  */
case class ProcessAgent(partyElection: List[ProcessAgentElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param isApplicable The qualification of whether the Process Agent is applicable (True) or not applicable (False).
  * @param processAgent The Process Agent specification, when applicable.
  */
case class ProcessAgentElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    isApplicable: Boolean,
    processAgent: Option[PartyContactInformation]) {
}
...
/**
  ...
  */
case class ProductTaxonomy(@JsonDeserialize(contentAs = classOf[TaxonomySourceEnum.Value])
    @JsonScalaEnumeration(classOf[TaxonomySourceEnum.Class])
    source: Option[TaxonomySourceEnum.Value],
    value: Option[TaxonomyValue],
    primaryAssetClass: Option[FieldWithMetaAssetClassEnum],
...
/**
  ...
  * @param frequency Defines the frequency to be used when defining a quantity. For example a quantity may be specified as a number of barrels of oil per day, which needs multiplying by the number of days in the relevant period to get the total quantity as a number of barrels.
  */
case class Quantity(value: Option[scala.math.BigDecimal],
    unit: Option[UnitType],
    datedValue: List[DatedValue],
    multiplier: Option[Measure],
    frequency: Option[Frequency])
...
/**
  ...
  * @param frequency Defines the frequency to be used when defining a quantity. For example a quantity may be specified as a number of barrels of oil per day, which needs multiplying by the number of days in the relevant period to get the total quantity as a number of barrels.
  */
case class QuantitySchedule(value: Option[scala.math.BigDecimal],
    unit: Option[UnitType],
    datedValue: List[DatedValue],
    multiplier: Option[Measure],
    frequency: Option[Frequency])
...
/**
  ...
  *
  * @param partyElection The parties' Recalculation of Value terms.
  */
case class RecalculationOfValue(partyElection: List[RecalculationOfValueElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param recalculationOfValueElection The procedure for Recalculation of Value.
  * @param recalculationOfValueTerms Additional Recalculation of Value terms when specified.
  */
case class RecalculationOfValueElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    @JsonScalaEnumeration(classOf[RecalculationOfValueElectionEnum.Class])
    recalculationOfValueElection: RecalculationOfValueElectionEnum.Value,
    recalculationOfValueTerms: Option[String]) {
}
...
/**
  ...
  *
  * @param applicableRegime A class to specify the regime(s) that parties to a legal agreement, such as the ISDA 2016 and 2018 CSA for Initial Margin, might agree to apply to one or both parties when acting as collateral taker, and specific terms associated with that application.
  * @param fallbackToMandatoryMethodDays The specification of the number of days after effective delivery of notice that Mandatory method fallback applies. Specification is only required when one or more Regimes have Fall Back to Mandatory Method elected as a SIMM exception.
  */
case class Regime(applicableRegime: List[ApplicableRegime],
    fallbackToMandatoryMethodDays: Option[scala.math.BigDecimal]) {
}

/**
  * A class that is used by the ApplicableRegime and the AdditionalRegime classes to specify the regulatory regime terms.
  *
  * @param party The party for which the regime terms are being specified when acting as collateral taker.
  * @param isApplicable The specification of whether the regime is elected as applicable to the party when acting as collateral taker.
  * @param asSpecified The bespoke party specific Regime term elections applicable when specified.
  * @param simmException The election for SIMM exception to the regulatory regime clause.
  * @param retrospectiveEffect Specifies the retrospective effect exception to the regulatory regime clause of Initial Margin documents as either a normalized value specified as part of an enumeration or a customized value specified of type string.
  */
case class RegimeTerms(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    @JsonDeserialize(contentAs = classOf[ExceptionEnum.Value])
    @JsonScalaEnumeration(classOf[ExceptionEnum.Class])
    isApplicable: Option[ExceptionEnum.Value],
    asSpecified: Option[String],
    simmException: Option[SimmException],
    retrospectiveEffect: Option[RetrospectiveEffect]) {
}
...
/**
  ...
  * @param adjustedDate The date once the adjustment has been performed. (Note that this date may change if the business center holidays change).
  */
case class RelativeDateOffset(periodMultiplier: Int,
    @JsonScalaEnumeration(classOf[PeriodEnum.Class])
    period: PeriodEnum.Value,
    @JsonDeserialize(contentAs = classOf[DayTypeEnum.Value])
    @JsonScalaEnumeration(classOf[DayTypeEnum.Class])
...
/**
  ...
  */
case class RelativeDates(periodMultiplier: Int,
    @JsonScalaEnumeration(classOf[PeriodEnum.Class])
    period: PeriodEnum.Value,
    @JsonDeserialize(contentAs = classOf[DayTypeEnum.Value])
    @JsonScalaEnumeration(classOf[DayTypeEnum.Class])
    ...
    dateRelativeTo: Option[ReferenceWithMetaLocalDate],
    adjustedDate: Option[java.time.LocalDate],
    periodSkip: Option[Int],
    scheduleBounds: Option[DateRange],
    meta: Option[MetaFields])
  extends RelativeDateOffsetTrait {
}

case class Representations(nonReliance: Boolean,
    agreementsRegardingHedging: Boolean,
    indexDisclaimer: Option[Boolean],
    additionalAcknowledgements: Option[Boolean],
    additionalBespokeTerms: List[Clause]) {
}
...
/**
  ...
  */
case class ResetFrequency(periodMultiplier: Int,
    @JsonScalaEnumeration(classOf[PeriodExtendedEnum.Class])
    period: PeriodExtendedEnum.Value,
    @JsonDeserialize(contentAs = classOf[WeeklyRollConventionEnum.Value])
...
/**
  ...
  *
  * @param standardisedException The Standard Initial Margin Model exception when specified by the party according to one of the enumerated values.
  * @param asSpecified The Standard Initial Margin Model exception when specified as a customized approach by the party.
  */
case class RetrospectiveEffect(@JsonDeserialize(contentAs = classOf[ExceptionEnum.Value])
    @JsonScalaEnumeration(classOf[ExceptionEnum.Class])
    standardisedException: Option[ExceptionEnum.Value],
    asSpecified: Option[String]) {
}
...
/**
  ...
  *
  * @param securityTakerRightsEvent The bespoke provisions that might be specified by the parties to the agreement applicable to a Security Taker Rights Event.
  * @param controlAgreementNecEvent The bespoke provisions that might be specified by the parties to the agreement applicable to a Notice of Exclusive Control Event.
  * @param securityProviderRightsEvent The bespoke provisions that might be specified by the parties to the agreement applicable to a Security Provider Rights Event.
  * @param deliveryInLieuRight The specification of whether Delivery In Lieu language is applicable to the agreement (true) or not (false).
  * @param additionalRightsEvent The Additional Rights Event election.
  */
case class RightsEvents(securityTakerRightsEvent: SecuredPartyRightsEvent,
    controlAgreementNecEvent: Option[ControlAgreementNecEvent],
    securityProviderRightsEvent: SecurityProviderRightsEvent,
    deliveryInLieuRight: Option[Boolean],
    additionalRightsEvent: Option[AdditionalRightsEvent]) {
}
...
/**
  ...
  *
  * @param securedPartyRightsEventElection 
  * @param earlyTerminationDateOptionalLanguage A boolean attribute to specify whether Failure to Pay Early Termination language is included (True) or excluded (False) from the agreement.
  * @param failureToPayEarlyTermination A boolean attribute to specify whether Failure to Pay Early Termination language in the agreement is deemed applicable or not.
  */
case class SecuredPartyRightsEvent(securedPartyRightsEventElection: List[SecuredPartyRightsEventElection],
    earlyTerminationDateOptionalLanguage: Boolean,
    failureToPayEarlyTermination: Option[Boolean]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param rightsEvent A boolean attribute to specify whether a Secured Party Rights Event will only occur upon the occurrence of one or more of the event specified in a Control Agreement.
  */
case class SecuredPartyRightsEventElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    rightsEvent: Boolean) {
}
...
/**
  ...
  */
case class Security(identifier: List[AssetIdentifier],
    taxonomy: List[Taxonomy],
    isExchangeListed: Option[Boolean],
    exchange: Option[LegalEntity],
    relatedExchange: List[LegalEntity],
...
/**
  ...
  *
  * @param pledgedAccount The pledged account associated with the agreement.
  * @param enforcementEvent Enforcement Events specific to the agreement.
  * @param deliveryInLieuRight Delivery In Lieu rights.
  * @param fullDischarge Full Discharge condition.
  * @param appropriatedCollateralValuation The election for the Valuation of Appropriate Collateral.
  * @param processAgent The Process Agent that might be appointed by the parties to the agreement.
  * @param jurisdictionRelatedTerms The jurisdiction specific terms.
  * @param additionalAmendments Any additional amendments that might be specified by the parties to the agreement.
  * @param additionalBespokeTerms Any additional terms that might be specified applicable.
  * @param executionTerms The location and language of execution to determine duty to be paid.
  */
case class SecurityAgreementElections(pledgedAccount: Option[Account],
    enforcementEvent: Option[EnforcementEvent],
    deliveryInLieuRight: Option[Boolean],
    fullDischarge: Option[Boolean],
    appropriatedCollateralValuation: Option[AppropriatedCollateralValuation],
    processAgent: Option[ProcessAgent],
    jurisdictionRelatedTerms: Option[JurisdictionRelatedTerms],
    additionalAmendments: Option[String],
    additionalBespokeTerms: Option[String],
    executionTerms: Option[ExecutionTerms]) {
}
...
/**
  ...
  *
  * @param party The elective party to which the Security Interest for Obligations is applicable.
  * @param obligations A description of any additional obligations secured by the credit support arrangements.
  * @param obligee The party to whom obligations under the Master Agreement are owed and secured by the credit support arrangements.
  * @param other Exception value.
  */
case class SecurityInterestForObligations(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: List[CounterpartyRoleEnum.Value],
    @JsonScalaEnumeration(classOf[SecurityInterestObligationsEnum.Class])
    obligations: SecurityInterestObligationsEnum.Value,
    @JsonScalaEnumeration(classOf[SecurityInterestObligeeEnum.Class])
    obligee: SecurityInterestObligeeEnum.Value,
    other: Option[String]) {
}
...
/**
  ...
  *
  * @param partyElection 
  * @param includeCoolingOffLanguage The Pledgor/Obligor/Chargor Rights Event election includes cooling off language when the attribute is set of True.
  * @param fullDischarge If specified as applicable here, a Pledgor/Obligor/Chargor Rights Event will not occur unless the Pledgor/Obligor/Chargor (A) has provided a statement to the Secured Party in respect of such Early Termination Date.
  * @param automaticSetOff The Automatic Set-Off provision applies when the value is set to True.
  * @param customElection A custom Pledgor/Obligor/Chargor Rights Event election might be specified by the parties.
  */
case class SecurityProviderRightsEvent(partyElection: List[SecurityProviderRightsEventElection],
    includeCoolingOffLanguage: Boolean,
    fullDischarge: Option[Boolean],
    automaticSetOff: Option[Boolean],
    customElection: Option[String]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param rightsEvent If True, the Rights Event language applies for the specified Party.
  */
case class SecurityProviderRightsEventElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    rightsEvent: Boolean) {
}
...
/**
  ...
  *
  * @param sensitivityToEquity The methodology to compute sensitivities to equity indices, funds and ETFs for the purpose of Initial Margin agreements.
  * @param sensitivityToCommodity The methodology to compute sensitivities to commodity indices for the purpose of Initial Margin agreements.
  */
case class SensitivityMethodologies(sensitivityToEquity: SensitivityMethodology,
...
/**
  ...
  *
  * @param specifiedMethodology The methodology according to which sensitivities will be computed, when specified through a normalized election.
  * @param customMethodology The methodology according to which sensitivities will be computed, when specified through a custom election.
  */
case class SensitivityMethodology(@JsonDeserialize(contentAs = classOf[SensitivitiesEnum.Value])
    @JsonScalaEnumeration(classOf[SensitivitiesEnum.Class])
    specifiedMethodology: Option[SensitivitiesEnum.Value],
    customMethodology: Option[String]) {
}
...
/**
  ...
  * @param schedule Allows the full representation of a payout by defining a set of schedule periods. It supports standard schedule customization by expressing all the dates, quantities, and pricing data in a non-parametric way.
  */
case class SettlementPayout(payerReceiver: PayerReceiver,
    priceQuantity: Option[ResolvablePriceQuantity],
    principalPayment: Option[PrincipalPayments],
    settlementTerms: Option[SettlementTerms],
    underlier: Underlier,
...
/**
  ...
  */
case class SettlementTerms(@JsonScalaEnumeration(classOf[SettlementTypeEnum.Class])
    settlementType: SettlementTypeEnum.Value,
    @JsonDeserialize(contentAs = classOf[TransferSettlementEnum.Value])
    @JsonScalaEnumeration(classOf[TransferSettlementEnum.Class])
    transferSettlementType: Option[TransferSettlementEnum.Value],
    ...
    @JsonScalaEnumeration(classOf[StandardSettlementStyleEnum.Class])
    standardSettlementStyle: Option[StandardSettlementStyleEnum.Value],
    cashSettlementTerms: List[CashSettlementTerms],
...
/**
  ...
  *
  * @param partyElection The parties' SIMM Calculation Currency election.
  */
case class SimmCalculationCurrency(partyElection: List[CalculationCurrencyElection]) {
}
...
/**
  ...
  *
  * @param standardisedException The Standard Initial Margin Model exception when specified by the party according to one of the enumerated values.
  * @param simmExceptionApplicable The Standard Initial Margin model exception approach applicable when specified by the party according to one of the enumerated values.
  * @param asSpecified The Standard Initial Margin Model exception when specified as a customized approach by the party.
  */
case class SimmException(@JsonDeserialize(contentAs = classOf[ExceptionEnum.Value])
    @JsonScalaEnumeration(classOf[ExceptionEnum.Class])
    standardisedException: Option[ExceptionEnum.Value],
    @JsonDeserialize(contentAs = classOf[SimmExceptionApplicableEnum.Value])
    @JsonScalaEnumeration(classOf[SimmExceptionApplicableEnum.Class])
    simmExceptionApplicable: Option[SimmExceptionApplicableEnum.Value],
    asSpecified: Option[String]) {
}
...
/**
  ...
  *
  * @param isSpecified A boolean attribute to determine whether the SIMM version is specified for the purpose of the legal agreement.
  * @param partyVersion The party which the specified SIMM version applies to.
  * @param asSpecified The SIMM version exception when specified as a customized approach by the party.
  */
case class SimmVersion(isSpecified: Option[Boolean],
    @JsonDeserialize(contentAs = classOf[CounterpartyRoleEnum.Value])
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    partyVersion: Option[CounterpartyRoleEnum.Value],
    asSpecified: Option[String]) {
}
...
/**
  ...
  *
  * @param party The party acting as the Single Posting Party.
  * @param other Utilised where the clause data structure is not able to capture a material aspect of the clause.
  */
case class SinglePostingParty(@JsonDeserialize(contentAs = classOf[CounterpartyRoleEnum.Value])
    @JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: Option[CounterpartyRoleEnum.Value],
    other: Option[String]) {
}
...
case class SpecificInconvertibility(specificInconvertibilityIsApplicable: Boolean,
    minimumAmount: Option[Quantity],
    relevantClass: List[String],
    @JsonDeserialize(contentAs = classOf[FxSubstitutionProvisionTypeEnum.Value])
    @JsonScalaEnumeration(classOf[FxSubstitutionProvisionTypeEnum.Class])
    localSubstituteProvisionType: Option[FxSubstitutionProvisionTypeEnum.Value],
    maximumDaysOfDisruption: Option[ValuationPostponement],
...
case class SpecificNonTransferability(specificNonTransferabilityIsApplicable: Boolean,
    relevantClass: List[String],
    @JsonDeserialize(contentAs = classOf[FxSubstitutionProvisionTypeEnum.Value])
    @JsonScalaEnumeration(classOf[FxSubstitutionProvisionTypeEnum.Class])
    localSubstituteProvisionType: Option[FxSubstitutionProvisionTypeEnum.Value],
...
/**
  ...
  *
  * @param specifiedEntityClause The Event of Default or Termination event for which Specified Entities terms are being defined.
  * @param specifiedEntity The party specific election of Specified Entities for the Event of Default or Termination Event specified.
  */
case class SpecifiedEntities(@JsonScalaEnumeration(classOf[SpecifiedEntityClauseEnum.Class])
    specifiedEntityClause: SpecifiedEntityClauseEnum.Value,
    specifiedEntity: List[SpecifiedEntity]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param specifiedEntityTerms The specified entity terms for the Event of Default or Termination Event specified.
  * @param specifiedEntity The specified entities for the Event of Default or Termination Event specified.
  * @param materialSubsidiaryTerms The meaning of Material Subsidiary for the Event of Default or Termination Event specified.
  * @param otherSpecifiedEntityTerms The non standard terms for the Event of Default or Termination Event specified.
  */
case class SpecifiedEntity(party: Party,
    @JsonScalaEnumeration(classOf[SpecifiedEntityTermsEnum.Class])
    specifiedEntityTerms: SpecifiedEntityTermsEnum.Value,
    specifiedEntity: List[LegalEntity],
    materialSubsidiaryTerms: Option[String],
    otherSpecifiedEntityTerms: Option[String]) {
}
...
/**
  ...
  */
case class SpreadSchedule(price: ReferenceWithMetaPriceSchedule,
    spreadScheduleType: Option[FieldWithMetaSpreadScheduleTypeEnum])
  extends RateScheduleTrait {
}
...
/**
  ...
  * @param seller The party that has sold.
  */
case class StrikeSchedule(price: ReferenceWithMetaPriceSchedule,
    @JsonDeserialize(contentAs = classOf[PayerReceiverEnum.Value])
    @JsonScalaEnumeration(classOf[PayerReceiverEnum.Class])
    buyer: Option[PayerReceiverEnum.Value],
    @JsonDeserialize(contentAs = classOf[PayerReceiverEnum.Value])
...
/**
  ...
  * @param regime The applicable regulatory regime, as specified through an enumeration.
  * @param additionalRegime The additional regulatory regime as specified by the parties.
  * @param regimeTerms Specifies the applicability of the Substituted Regime as denoted in the Substituted Regime Table as part of certain legal agreements, such as the ISDA 2016 and 2018 CSA for Initial Margin.
  */
case class SubstitutedRegime(@JsonDeserialize(contentAs = classOf[RegulatoryRegimeEnum.Value])
    @JsonScalaEnumeration(classOf[RegulatoryRegimeEnum.Class])
    regime: Option[RegulatoryRegimeEnum.Value],
    additionalRegime: Option[String],
    regimeTerms: List[SubstitutedRegimeTerms]) {
}
...
/**
  ...
  * @param isApplicable The specification of whether the regime is elected as applicable to the party when acting as collateral taker.
  */
case class SubstitutedRegimeTerms(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    isApplicable: Boolean) {
}
...
/**
  ...
  *
  * @param needsConsent The election as to whether the Pledgor/Obligor/Chargor must obtain the Secured Partys consent for any collateral substitution.
  * @param substitutionDateLanguage Substitution Date has the meaning specified in Paragraph4(d)(ii), unless otherwise specified.
  * @param specificConsentLanguage Specific consent language might be specified by the parties.
  * @param legacyConsent The process for substituting/exchanging one form of collateral held by a party for a different form of collateral, used with legacy agreements.
  */
case class Substitution(needsConsent: Boolean,
    substitutionDateLanguage: Option[String],
    specificConsentLanguage: Option[String],
    @JsonDeserialize(contentAs = classOf[LegacyConsentEnum.Value])
    @JsonScalaEnumeration(classOf[LegacyConsentEnum.Class])
    legacyConsent: Option[LegacyConsentEnum.Value]) {
}
...
/**
  ...
  *
  * @param statedTerminationCurrency Allows for specific Termination Currency(ies) and a fallback Termination Currency to be selected.
  * @param partyOptionTerminationCurrency Provides that the Termination Currency will be determined by reference to a contractual mechanism when closing out the Agreement.
  */
case class TerminationCurrency(statedTerminationCurrency: Option[TerminationCurrencySelection],
    partyOptionTerminationCurrency: Option[PartyOptionTerminationCurrency]) {
}

/**
  * A class to specify the Amendment to Termination Currency elections by the parties to the agreement.
  *
  * @param isApplicable The qualification of whether the Amendment to Termination Currency is deemed applicable by the parties (True) or not (False).
  * @param effectiveDate The effective date of the Amendment to Termination Currency. This date can be specified as either an actual date, a specific date (e.g. the annex date) or as a custom provision.
  * @param partyElection The parties' Amendment Currency election.
  */
case class TerminationCurrencyAmendment(isApplicable: Boolean,
    effectiveDate: Option[AmendmentEffectiveDate],
    partyElection: List[TerminationCurrencyElection]) {
}
...
/**
  ...
  *
  * @param party The elective party.
  * @param isSpecified The qualification of whether the Termination Currency is specified in this document (True) or in an Eligible Support Credit Support (IM) Schedule (False).
  * @param currency The Termination Currency associated with the party that referenced as part of this class. The list of valid currencies is not presently positioned as an enumeration as part of the CDM because that scope is limited to the values specified by ISDA and FpML. As a result, implementers have to make reference to the relevant standard, such as the ISO 4217 standard for currency codes.
  */
case class TerminationCurrencyElection(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: List[CounterpartyRoleEnum.Value],
    isSpecified: Boolean,
    currency: Option[FieldWithMetaString]) {
}
...
/**
  ...
  *
  * @param statedCurrency Specifies a single Termination Currency for the agreement.
  * @param fallbackCurrency Specifies a single fallback Termination Currency should the stated currency not be freely available.
  * @param partyElection Specifies different termination currencies to apply depending on which party or parties are the Defaulting Party Affected Party(ies).
  * @param bothAffected Specifies fallback Termination Currency where both parties are Affected Parties.
  */
case class TerminationCurrencySelection(statedCurrency: Option[String],
    fallbackCurrency: Option[String],
    partyElection: List[PartyTerminationCurrencySelection],
    bothAffected: Option[String]) {
}
...
/**
  ...
  *
  * @param partyElection The parties' Threshold election.
  */
case class Threshold(partyElection: List[ElectiveAmountElection]) {
}

/**
  * Defines that the Threshold is based on a Fixed Amount.
  *
  * @param party The party to which the threshold applies.
  * @param amount The amount value applicable to the Threshold.
  * @param currency The Threshold currency code.
  * @param amountIsInfinity Flag detailing whether the collateral Threshold Amount is set to infinity for a particular party.
  */
case class ThresholdFixedAmount(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    amount: Int,
    @JsonScalaEnumeration(classOf[ISOCurrencyCodeEnum.Class])
    currency: ISOCurrencyCodeEnum.Value,
...
/**
  ...
  * @param currency The threshold currency code.
  * @param ratingType The relevant rating type.
  * @param variableSet Defines a combination of Rating Agency, Rating Value, Threshold amount and Currency code.
  * @param ratedParty The party to which a rating applies.
  * @param namedEntity Details the Named Entity where the Rated Party is Named Entity.
  * @param namedAffiliate Details the Named Affiliate where the Rated Party is Named Affiliate.
  * @param compare Where two ratings are specified whether the higher or lower rating prevails.
  ...
  * @param numberOfRatingAgencies Defines the number of Rating Agencies that the Party must be rated by.
  * @param zeroEvent Whether a trigger applies for the threshold to fall to zero.
  * @param event The relevant trigger for the threshold to fall to zero.
  */
case class ThresholdRatingsBased(@JsonScalaEnumeration(classOf[CounterpartyRoleEnum.Class])
    party: CounterpartyRoleEnum.Value,
    @JsonScalaEnumeration(classOf[ISOCurrencyCodeEnum.Class])
    currency: ISOCurrencyCodeEnum.Value,
    @JsonScalaEnumeration(classOf[RatingTypeEnum.Class])
    ratingType: RatingTypeEnum.Value,
    variableSet: List[CSAThresholdVariableSet],
    @JsonDeserialize(contentAs = classOf[ThresholdRatedPartyEnum.Value])
    @JsonScalaEnumeration(classOf[ThresholdRatedPartyEnum.Class])
    ratedParty: Option[ThresholdRatedPartyEnum.Value],
    namedEntity: Option[String],
    namedAffiliate: Option[String],
    @JsonDeserialize(contentAs = classOf[CreditNotationMismatchResolutionEnum.Value])
    @JsonScalaEnumeration(classOf[CreditNotationMismatchResolutionEnum.Class])
    ...
    numberOfRatingAgencies: Option[NumberOfRatingAgenciesEnum.Value],
    zeroEvent: Boolean,
    @JsonScalaEnumeration(classOf[ThresholdZeroEventEnum.Class])
    event: List[ThresholdZeroEventEnum.Value]) {
}

/**
  * Details whether the threshold is rating based, a fixed amount, or infinity.
  *
  * @param fixedAmount Defines that the Threshold is a Fixed Amount.
  * @param ratingsBased Defines that the Threshold is based on a Ratings condition(s).
  * @param infinity Defines that the Threshold is Infinity.
  * @param other Utilised where the clause data structure is not able to capture a material aspect of the clause.
  */
case class ThresholdType(fixedAmount: Option[ThresholdFixedAmount],
    ratingsBased: Option[ThresholdRatingsBased],
    infinity: Option[Infinity],
    other: Option[String]) {
}
...
/**
  ...
  */
case class Trade(product: NonTransferableProduct,
    tradeLot: List[TradeLot],
    counterparty: List[Counterparty],
    ancillaryParty: List[AncillaryParty],
    @JsonDeserialize(contentAs = classOf[NotionalAdjustmentEnum.Value])
...
/**
  ...
  */
case class TradeIdentifier(issuerReference: Option[ReferenceWithMetaParty],
    issuer: Option[FieldWithMetaString],
    assignedIdentifier: List[AssignedIdentifier],
    @JsonDeserialize(contentAs = classOf[TradeIdentifierTypeEnum.Value])
    @JsonScalaEnumeration(classOf[TradeIdentifierTypeEnum.Class])
...
/**
  ...
  */
case class Transfer(quantity: NonNegativeQuantity,
    asset: Asset,
    settlementDate: AdjustableOrAdjustedOrRelativeDate,
    identifier: List[FieldWithMetaIdentifier],
    payerReceiver: PartyReferencePayerReceiver,
...
/**
  ...
  * @param economicTerms The price forming features, including payouts and provisions.
  */
case class TransferableProduct(cash: Option[Cash],
    commodity: Option[Commodity],
    digitalAsset: Option[DigitalAsset],
    instrument: Option[Instrument],
    economicTerms: EconomicTerms)
...
/**
  ...
  */
case class UmbrellaAgreementEntity(entityId: List[FieldWithMetaString],
    name: FieldWithMetaString,
    entityIdentifier: List[EntityIdentifier],
    terms: Option[String],
    meta: Option[MetaFields])
...
case class VarianceReturnTerms(valuationTerms: ValuationTerms,
    annualizationFactor: Option[Int],
    dividendApplicability: Option[DividendApplicability],
    equityUnderlierProvisions: Option[EquityUnderlierProvisions],
    sharePriceDividendAdjustment: Option[Boolean],
    ...
    meanAdjustment: Option[Boolean],
    performance: Option[String],
    varianceStrikePrice: Option[Price],
...
case class VolatilityReturnTerms(valuationTerms: ValuationTerms,
    annualizationFactor: Option[Int],
    dividendApplicability: Option[DividendApplicability],
    equityUnderlierProvisions: Option[EquityUnderlierProvisions],
    sharePriceDividendAdjustment: Option[Boolean],
