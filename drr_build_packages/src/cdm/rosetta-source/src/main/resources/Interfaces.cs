...
namespace Org.Isda.Cdm
{
    ...
    interface IBusinessDayOffset : IPeriod
    {
        ...
        /// </summary>
        string? FixingOffsetDefinition { get; }
        
        /// <summary>
        /// Fixing Offset Reason
        /// </summary>
        string? FixingOffsetReason { get; }
    ...
    {
        BasicReferenceWithMetaInterestRateIndex? RateOption { get; }
    ...
    interface ILegalEntity
    {
        ...
        /// </summary>
        IEnumerable<EntityIdentifier> EntityIdentifier { get; }
    ...
    /// </summary>
    interface IMasterAgreementBase
    {
    }
