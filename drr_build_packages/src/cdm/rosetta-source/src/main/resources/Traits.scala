...
trait BusinessDayOffsetTrait extends PeriodTrait {
  ...
  /**
    ...
    */
  val fixingOffsetDefinition: Option[String]
  /**
    * Fixing Offset Reason
    */
  val fixingOffsetReason: Option[String]
...
trait CollateralCriteriaBaseTrait {
  /**
    ...
    */
  val collateralCriteria: Option[CollateralCriteria]
  /**
...
trait LegalEntityTrait {
  ...
  /**
    ...
    */
  val entityIdentifier: List[EntityIdentifier]
  val meta: Option[MetaFields]
}
...
/**
  ...
  */
trait MasterAgreementBaseTrait {
}
...
trait RelativeDateOffsetTrait extends OffsetTrait {
  ...
  /**
    ...
    */
  val dateRelativeTo: Option[ReferenceWithMetaLocalDate]
  /**
