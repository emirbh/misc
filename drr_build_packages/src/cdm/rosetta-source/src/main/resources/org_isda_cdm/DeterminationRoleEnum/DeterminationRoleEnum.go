 ...
 */
   ...
   */
  CALCULATION_AGENT DeterminationRoleEnum = iota + 1
  /**
   ...
   */
  DETERMINING_PARTY DeterminationRoleEnum = iota + 1
  /**
   ...
   */
  HEDGING_PARTY DeterminationRoleEnum = iota + 1
  )    
