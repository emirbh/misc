 ...
 */
   ...
   */
  AUSTRALIA_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  CANADA_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  EMIR_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  HONG_KONG_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  HONG_KONG_SFC_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  SINGAPORE_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  SOUTH_AFRICA_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  SOUTH_KOREA_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  SWITZERLAND_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  US_PRUDENTIAL_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  /**
   ...
   */
  UNITED_KINGDOM_MARGIN_RULES RegulatoryRegimeEnum = iota + 1
  )    
