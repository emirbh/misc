 ...
 */
   ...
   */
  ASIAN EntityTypeEnum = iota + 1
  /**
   * Entity Type of Australian and New Zealand.
   */
  AUSTRALIAN_AND_NEW_ZEALAND EntityTypeEnum = iota + 1
  /**
   * Entity Type of European Emerging Markets.
   */
  EUROPEAN_EMERGING_MARKETS EntityTypeEnum = iota + 1
  /**
   * Entity Type of Japanese.
   */
  JAPANESE EntityTypeEnum = iota + 1
  /**
   * Entity Type of North American High Yield.
   */
  NORTH_AMERICAN_HIGH_YIELD EntityTypeEnum = iota + 1
  /**
   * Entity Type of North American Insurance.
   */
  NORTH_AMERICAN_INSURANCE EntityTypeEnum = iota + 1
  /**
   * Entity Type of North American Investment Grade.
   */
  NORTH_AMERICAN_INVESTMENT_GRADE EntityTypeEnum = iota + 1
  /**
   * Entity Type of Singaporean.
   */
  SINGAPOREAN EntityTypeEnum = iota + 1
  /**
   * Entity Type of Western European.
   */
  WESTERN_EUROPEAN EntityTypeEnum = iota + 1
  /**
   * Entity Type of Western European Insurance.
   */
  WESTERN_EUROPEAN_INSURANCE EntityTypeEnum = iota + 1
  )    
