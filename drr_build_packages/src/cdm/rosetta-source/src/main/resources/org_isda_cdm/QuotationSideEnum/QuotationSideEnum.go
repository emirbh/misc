 ...
 */
   ...
   */
  MARGINAL_HOURLY QuotationSideEnum = iota + 1
  /**
   ...
   */
  MARKET_CLEARING QuotationSideEnum = iota + 1
  /**
   ...
   */
  MEAN_OF_BID_AND_ASK QuotationSideEnum = iota + 1
  /**
   ...
   */
  MEAN_OF_HIGH_AND_LOW QuotationSideEnum = iota + 1
  /**
   ...
   */
  MORNING QuotationSideEnum = iota + 1
  /**
   ...
   */
  NATIONAL_SINGLE QuotationSideEnum = iota + 1
  /**
   ...
   */
  OFFICIAL QuotationSideEnum = iota + 1
  /**
   ...
   */
  OPENING QuotationSideEnum = iota + 1
  /**
