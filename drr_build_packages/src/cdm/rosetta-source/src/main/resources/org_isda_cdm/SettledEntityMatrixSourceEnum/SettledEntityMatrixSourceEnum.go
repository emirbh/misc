 ...
 * Version: 6.23.0
 */
  package SettledEntityMatrixSourceEnum
  import . "org_isda_cdm"
  /**
   ...
   */
  CONFIRMATION_ANNEX SettledEntityMatrixSourceEnum = iota + 1
  /**
   * The term is not applicable.
   */
  NOT_APPLICABLE SettledEntityMatrixSourceEnum = iota + 1
  /**
   * The Settled Entity Matrix published by the Index Publisher.
   */
  PUBLISHER SettledEntityMatrixSourceEnum = iota + 1
  )    
