 ...
 */
   ...
   */
  ACT_360 DayCountFractionEnum = iota + 1
  /**
   * Per CFTC definitions.
   */
  ACT_364 DayCountFractionEnum = iota + 1
  /**
   ...
   */
  ACT_365L DayCountFractionEnum = iota + 1
  /**
   ...
   */
  ACT_365_FIXED DayCountFractionEnum = iota + 1
  /**
   ...
   */
  ACT_ACT_AFB DayCountFractionEnum = iota + 1
  /**
   ...
   */
  ACT_ACT_ICMA DayCountFractionEnum = iota + 1
  /**
   ...
   */
  ACT_ACT_ISDA DayCountFractionEnum = iota + 1
  /**
   ...
   */
  ACT_ACT_ISMA DayCountFractionEnum = iota + 1
  /**
   ...
   */
  CAL_252 DayCountFractionEnum = iota + 1
  /**
   ...
   */
  RBA_BOND_BASIS DayCountFractionEnum = iota + 1
  /**
   ...
   */
  _1_1 DayCountFractionEnum = iota + 1
  /**
   ...
   */
  _30E_360 DayCountFractionEnum = iota + 1
  /**
   ...
   */
  _30E_360_ISDA DayCountFractionEnum = iota + 1
  /**
   ...
   */
  _30_360 DayCountFractionEnum = iota + 1
  )    
