 ...
 * Version: 6.23.0
 */
  package CorporateActionTypeEnum
  import . "org_isda_cdm"
  /**
   ...
   */
  BONUS_ISSUE CorporateActionTypeEnum = iota + 1
  /**
   * Corporate action triggered by the distribution of a cash dividend.
   */
  CASH_DIVIDEND CorporateActionTypeEnum = iota + 1
  /**
   ...
   */
  CLASS_ACTION CorporateActionTypeEnum = iota + 1
  /**
   * Corporate action triggered by the removal of a security from a stock exchange.
   */
  DELISTING CorporateActionTypeEnum = iota + 1
  /**
   ...
   */
  EARLY_REDEMPTION CorporateActionTypeEnum = iota + 1
  /**
   ...
   */
  LIQUIDATION CorporateActionTypeEnum = iota + 1
  /**
   ...
   */
  MERGER CorporateActionTypeEnum = iota + 1
  /**
   ...
   */
  STOCK_SPLIT CorporateActionTypeEnum = iota + 1
  /**
   ...
   */
  TAKEOVER CorporateActionTypeEnum = iota + 1
  )    
