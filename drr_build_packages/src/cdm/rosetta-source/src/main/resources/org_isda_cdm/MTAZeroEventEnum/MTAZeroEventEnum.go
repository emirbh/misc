 ...
 */
   ...
   */
  ADDITIONAL_TERMINATION_EVENT MTAZeroEventEnum = iota + 1
  /**
   * An Event of Default.
   */
  EVENT_OF_DEFAULT MTAZeroEventEnum = iota + 1
  /**
   * Utilised where the clause data structure is not able to capture a material aspect of the clause.
   */
  OTHER MTAZeroEventEnum = iota + 1
  /**
   * A Potential Event of Default.
   */
  POTENTIAL_EVENT_OF_DEFAULT MTAZeroEventEnum = iota + 1
  /**
   * A Termination Event.
   */
  TERMINATION_EVENT MTAZeroEventEnum = iota + 1
  /**
   * A Termination Event in respect of which all Transactions are Affected Transactions.
   */
  TERMINATION_EVENT_ALL_AFFECTED_TRANSACTIONS MTAZeroEventEnum = iota + 1
  )    
