 ...
 * Version: 6.23.0
 */
  package UK_EMIR_EligibleCollateralEnum
  import . "org_isda_cdm"
  /**
   ...
   */
  UK_EMIR_TYPE_D UK_EMIR_EligibleCollateralEnum = iota + 1
  /**
   ...
   */
  UK_EMIR_TYPE_E UK_EMIR_EligibleCollateralEnum = iota + 1
  /**
   ...
   */
  UK_EMIR_TYPE_K UK_EMIR_EligibleCollateralEnum = iota + 1
  /**
   ...
   */
  UK_EMIR_TYPE_L UK_EMIR_EligibleCollateralEnum = iota + 1
  /**
   ...
   */
  UK_EMIR_TYPE_M UK_EMIR_EligibleCollateralEnum = iota + 1
  /**
   * Denotes corporate bonds.
   */
  UK_EMIR_TYPE_N UK_EMIR_EligibleCollateralEnum = iota + 1
  /**
   ...
   */
  UK_EMIR_TYPE_O UK_EMIR_EligibleCollateralEnum = iota + 1
  /**
   ...
   */
  UK_EMIR_TYPE_R UK_EMIR_EligibleCollateralEnum = iota + 1
  )    
