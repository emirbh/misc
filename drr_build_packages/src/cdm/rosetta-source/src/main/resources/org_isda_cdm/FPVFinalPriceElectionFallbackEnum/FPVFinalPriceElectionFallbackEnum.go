 ...
 * Version: 6.23.0
 */
  package FPVFinalPriceElectionFallbackEnum
  import . "org_isda_cdm"
  /**
   ...
   */
  FPV_CLOSE FPVFinalPriceElectionFallbackEnum = iota + 1
  /**
   * In respect of the Early Final Valuation Date, the provisions for FPV Hedge Execution shall apply.
   */
  FPV_HEDGE_EXECUTION FPVFinalPriceElectionFallbackEnum = iota + 1
  )    
