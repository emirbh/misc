 ...
 * Version: 6.23.0
 */
  package ContractualSupplementTypeEnum
  import . "org_isda_cdm"
  /**
   ...
   */
  ISDA_1999_CREDIT_CONVERTIBLE_EXCHANGEABLE_ACCRETING_OBLIGATIONS ContractualSupplementTypeEnum = iota + 1
  /**
   * Restructuring Supplement to the 1999 ISDA Credit Derivatives Definitions dated May 11, 2001.
   */
  ISDA_1999_CREDIT_RESTRUCTURING ContractualSupplementTypeEnum = iota + 1
  /**
   ...
   */
  ISDA_1999_CREDIT_SUCCESSOR_AND_CREDIT_EVENTS ContractualSupplementTypeEnum = iota + 1
  /**
   * Additional Provisions for LPN dated December 6, 2007.
   */
  ISDA_2003_ADDITIONAL_PROVISIONS_LPN ContractualSupplementTypeEnum = iota + 1
  /**
   * Additional Provisions for Contingent Credit Spread Transactions dated August 15, 2008.
   */
  ISDA_2003_CONTINGENT_CREDIT_SPREAD_TRANSACTION ContractualSupplementTypeEnum = iota + 1
  /**
   * 2005 Matrix Supplement to the 2003 ISDA Credit Derivatives.
   */
  ISDA_2003_CREDIT_2005_MATRIX_SUPPLEMENT ContractualSupplementTypeEnum = iota + 1
  /**
   ...
   */
  ISDA_2003_CREDIT_ARGENTINE_REPUBLIC ContractualSupplementTypeEnum = iota + 1
  /**
   ...
   */
  ISDA_2003_CREDIT_REPUBLIC_OF_HUNGARY ContractualSupplementTypeEnum = iota + 1
  /**
   ...
   */
  ISDA_2003_CREDIT_REPUBLIC_OF_HUNGARY_2005 ContractualSupplementTypeEnum = iota + 1
  /**
   ...
   */
  ISDA_2003_CREDIT_RUSSIAN_FEDERATION ContractualSupplementTypeEnum = iota + 1
  /**
   ...
   */
  ISDA_2003_CREDIT_US_MUNICIPALS ContractualSupplementTypeEnum = iota + 1
  /**
   * Additional Provisions for STMicroelectronics NV dated December 6, 2007.
   */
  ISDA_2003_ST_MICROELECTRONICS_NV ContractualSupplementTypeEnum = iota + 1
  /**
   * 2007 Full Lookthrough Depository Receipt Supplement to the 2002 Equity Derivatives Definitions.
   */
  ISDA_2007_FULL_LOOKTHROUGH_DEPOSITORY_RECEIPT_SUPPLEMENT ContractualSupplementTypeEnum = iota + 1
  /**
   * 2007 Partial Lookthrough Depository Receipt Supplement to the 2002 ISDA Equity Derivatives Definitions.
   */
  ISDA_2007_PARTIAL_LOOKTHROUGH_DEPOSITORY_RECEIPT_SUPPLEMENT ContractualSupplementTypeEnum = iota + 1
  /**
   * Additional Provisions for Physically Settled Default Swaps Monoline Insurer.
   */
  ISDA_CREDIT_MONOLINE_INSURERS ContractualSupplementTypeEnum = iota + 1
  /**
   * Additional Provisions for Fixed Recovery Credit Default Swap Transactions
   */
  ISDA_DELIVERY_RESTRICTIONS ContractualSupplementTypeEnum = iota + 1
  /**
   * Additional Provisions for Fixed Recovery Credit Default Swap Transactions.
   */
  ISDA_FIXED_RECOVERY ContractualSupplementTypeEnum = iota + 1
  /**
   * Additional Provisions for LPN Reference Entities.
   */
  ISDALPN_REFERENCE_ENTITIES ContractualSupplementTypeEnum = iota + 1
  /**
