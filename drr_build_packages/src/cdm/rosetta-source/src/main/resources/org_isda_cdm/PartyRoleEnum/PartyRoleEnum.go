 ...
 */
   ...
   */
  ALLOCATION_AGENT PartyRoleEnum = iota + 1
  /**
   ...
   */
  BENEFICIARY PartyRoleEnum = iota + 1
  /**
   ...
   */
  BUYER_DECISION_MAKER PartyRoleEnum = iota + 1
  /**
   * The party that provides credit support under English Law.
   */
  CHARGOR PartyRoleEnum = iota + 1
  /**
   ...
   */
  CLEARING_FIRM PartyRoleEnum = iota + 1
  /**
   ...
   */
  CLEARING_ORGANIZATION PartyRoleEnum = iota + 1
  /**
   ...
   */
  CLIENT_DECISION_MAKER PartyRoleEnum = iota + 1
  /**
   ...
   */
  CONFIRMATION_PLATFORM PartyRoleEnum = iota + 1
  /**
   ...
   */
  EXECUTING_ENTITY PartyRoleEnum = iota + 1
  /**
   ...
   */
  EXECUTION_AGENT PartyRoleEnum = iota + 1
  /**
   ...
   */
  EXECUTION_FACILITY PartyRoleEnum = iota + 1
  /**
   * Organization that backs (guarantees) the credit risk of the trade.
   */
  GUARANTOR PartyRoleEnum = iota + 1
  /**
   ...
   */
  PTRR_SERVICE_PROVIDER PartyRoleEnum = iota + 1
  /**
   * The party that provides credit support under New York Law.
   */
  PLEDGOR PartyRoleEnum = iota + 1
  /**
   ...
   */
  TRADE_SOURCE PartyRoleEnum = iota + 1
  /**
   ...
   */
  TRADING_MANAGER PartyRoleEnum = iota + 1
  /**
   ...
   */
  TRADING_PARTNER PartyRoleEnum = iota + 1
  /**
   ...
   */
  TRIPARTY_AGENT PartyRoleEnum = iota + 1
  )    
