 ...
 * Version: 6.23.0
 */
  package CreditSupportDocumentTermsEnum
  import . "org_isda_cdm"
  /**
   ...
   */
  ANY CreditSupportDocumentTermsEnum = iota + 1
  /**
   * No Credit Support Document is specified.
   */
  NONE CreditSupportDocumentTermsEnum = iota + 1
  /**
   * A specified Credit Support Document is provided
   */
  SPECIFIED CreditSupportDocumentTermsEnum = iota + 1
  )    
