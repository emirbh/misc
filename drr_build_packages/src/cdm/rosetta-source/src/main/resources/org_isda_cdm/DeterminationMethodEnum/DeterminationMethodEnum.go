 ...
 */
   ...
   * TWAP VE Price.
   */
  TWAPVE DeterminationMethodEnum = iota + 1
  /**
   * TWAP VE Calculated by Excluding Closing price.
   */
  TWAPVE_EXCLUDING_CLOSE DeterminationMethodEnum = iota + 1
  /**
   * Official VWAP Price.
   */
   ...
   * VWAP VE Price.
   */
  VWAPVE DeterminationMethodEnum = iota + 1
  /**
   * VWAP VE Calculated by Excluding Closing price.
   */
  VWAPVE_EXCLUDING_CLOSE DeterminationMethodEnum = iota + 1
  /**
