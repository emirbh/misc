 ...
 */
   ...
   */
  CUSIP ProductIdTypeEnum = iota + 1
  /**
   ...
   */
  ISDACRP ProductIdTypeEnum = iota + 1
  /**
   ...
   */
  ISIN ProductIdTypeEnum = iota + 1
  /**
   * The name of the product.
   */
  NAME ProductIdTypeEnum = iota + 1
  /**
   ...
   */
  OTHER ProductIdTypeEnum = iota + 1
  /**
   ...
   */
  REDID ProductIdTypeEnum = iota + 1
  /**
   ...
   */
  SEDOL ProductIdTypeEnum = iota + 1
  /**
   ...
   */
  SICOVAM ProductIdTypeEnum = iota + 1
  /**
   ...
   */
  VALOREN ProductIdTypeEnum = iota + 1
  /**
   ...
   */
  WERTPAPIER ProductIdTypeEnum = iota + 1
  )    
