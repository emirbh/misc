...
@RuneDataType(value="FieldWithMetaCreditSupportAgreementTypeEnum", model="cdm", builder=FieldWithMetaCreditSupportAgreementTypeEnum.FieldWithMetaCreditSupportAgreementTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaCreditSupportAgreementTypeEnum extends RosettaModelObject, FieldWithMeta<CreditSupportAgreementTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaCreditSupportAgreementTypeEnumBuilder extends FieldWithMetaCreditSupportAgreementTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<CreditSupportAgreementTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaCreditSupportAgreementTypeEnumBuilderImpl implements FieldWithMetaCreditSupportAgreementTypeEnum.FieldWithMetaCreditSupportAgreementTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaCreditSupportAgreementTypeEnum.FieldWithMetaCreditSupportAgreementTypeEnumBuilder setValue(CreditSupportAgreementTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaCreditSupportAgreementTypeEnum.FieldWithMetaCreditSupportAgreementTypeEnumBuilder setMeta(MetaFields _meta) {
