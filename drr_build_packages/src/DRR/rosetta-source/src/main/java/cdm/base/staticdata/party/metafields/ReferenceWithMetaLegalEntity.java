...
@RuneDataType(value="ReferenceWithMetaLegalEntity", model="cdm", builder=ReferenceWithMetaLegalEntity.ReferenceWithMetaLegalEntityBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaLegalEntity extends RosettaModelObject, ReferenceWithMeta<LegalEntity> {
	...
	class ReferenceWithMetaLegalEntityBuilderImpl implements ReferenceWithMetaLegalEntity.ReferenceWithMetaLegalEntityBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaLegalEntity.ReferenceWithMetaLegalEntityBuilder setValue(LegalEntity _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaLegalEntity.ReferenceWithMetaLegalEntityBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaLegalEntity.ReferenceWithMetaLegalEntityBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaLegalEntity.ReferenceWithMetaLegalEntityBuilder setReference(Reference _reference) {
