...
@RuneDataType(value="FieldWithMetaAssetClassEnum", model="cdm", builder=FieldWithMetaAssetClassEnum.FieldWithMetaAssetClassEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaAssetClassEnum extends RosettaModelObject, FieldWithMeta<AssetClassEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaAssetClassEnumBuilder extends FieldWithMetaAssetClassEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<AssetClassEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaAssetClassEnumBuilderImpl implements FieldWithMetaAssetClassEnum.FieldWithMetaAssetClassEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaAssetClassEnum.FieldWithMetaAssetClassEnumBuilder setValue(AssetClassEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaAssetClassEnum.FieldWithMetaAssetClassEnumBuilder setMeta(MetaFields _meta) {
