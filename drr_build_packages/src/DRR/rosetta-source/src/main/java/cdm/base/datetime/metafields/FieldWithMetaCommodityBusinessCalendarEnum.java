...
@RuneDataType(value="FieldWithMetaCommodityBusinessCalendarEnum", model="cdm", builder=FieldWithMetaCommodityBusinessCalendarEnum.FieldWithMetaCommodityBusinessCalendarEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaCommodityBusinessCalendarEnum extends RosettaModelObject, FieldWithMeta<CommodityBusinessCalendarEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaCommodityBusinessCalendarEnumBuilder extends FieldWithMetaCommodityBusinessCalendarEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<CommodityBusinessCalendarEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaCommodityBusinessCalendarEnumBuilderImpl implements FieldWithMetaCommodityBusinessCalendarEnum.FieldWithMetaCommodityBusinessCalendarEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaCommodityBusinessCalendarEnum.FieldWithMetaCommodityBusinessCalendarEnumBuilder setValue(CommodityBusinessCalendarEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaCommodityBusinessCalendarEnum.FieldWithMetaCommodityBusinessCalendarEnumBuilder setMeta(MetaFields _meta) {
