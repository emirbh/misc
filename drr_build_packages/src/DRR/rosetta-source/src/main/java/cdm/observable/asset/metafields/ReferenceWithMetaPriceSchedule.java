...
@RuneDataType(value="ReferenceWithMetaPriceSchedule", model="cdm", builder=ReferenceWithMetaPriceSchedule.ReferenceWithMetaPriceScheduleBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaPriceSchedule extends RosettaModelObject, ReferenceWithMeta<PriceSchedule> {
	...
	class ReferenceWithMetaPriceScheduleBuilderImpl implements ReferenceWithMetaPriceSchedule.ReferenceWithMetaPriceScheduleBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPriceSchedule.ReferenceWithMetaPriceScheduleBuilder setValue(PriceSchedule _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaPriceSchedule.ReferenceWithMetaPriceScheduleBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaPriceSchedule.ReferenceWithMetaPriceScheduleBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPriceSchedule.ReferenceWithMetaPriceScheduleBuilder setReference(Reference _reference) {
