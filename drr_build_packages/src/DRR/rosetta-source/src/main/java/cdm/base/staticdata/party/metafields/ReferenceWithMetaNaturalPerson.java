...
@RuneDataType(value="ReferenceWithMetaNaturalPerson", model="cdm", builder=ReferenceWithMetaNaturalPerson.ReferenceWithMetaNaturalPersonBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaNaturalPerson extends RosettaModelObject, ReferenceWithMeta<NaturalPerson> {
	...
	class ReferenceWithMetaNaturalPersonBuilderImpl implements ReferenceWithMetaNaturalPerson.ReferenceWithMetaNaturalPersonBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaNaturalPerson.ReferenceWithMetaNaturalPersonBuilder setValue(NaturalPerson _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaNaturalPerson.ReferenceWithMetaNaturalPersonBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaNaturalPerson.ReferenceWithMetaNaturalPersonBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaNaturalPerson.ReferenceWithMetaNaturalPersonBuilder setReference(Reference _reference) {
