...
@RuneDataType(value="FieldWithMetaContractualDefinitionsEnum", model="cdm", builder=FieldWithMetaContractualDefinitionsEnum.FieldWithMetaContractualDefinitionsEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaContractualDefinitionsEnum extends RosettaModelObject, FieldWithMeta<ContractualDefinitionsEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaContractualDefinitionsEnumBuilder extends FieldWithMetaContractualDefinitionsEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<ContractualDefinitionsEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaContractualDefinitionsEnumBuilderImpl implements FieldWithMetaContractualDefinitionsEnum.FieldWithMetaContractualDefinitionsEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaContractualDefinitionsEnum.FieldWithMetaContractualDefinitionsEnumBuilder setValue(ContractualDefinitionsEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaContractualDefinitionsEnum.FieldWithMetaContractualDefinitionsEnumBuilder setMeta(MetaFields _meta) {
