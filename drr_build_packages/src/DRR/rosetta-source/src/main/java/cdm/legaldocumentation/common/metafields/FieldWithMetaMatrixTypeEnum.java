...
@RuneDataType(value="FieldWithMetaMatrixTypeEnum", model="cdm", builder=FieldWithMetaMatrixTypeEnum.FieldWithMetaMatrixTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaMatrixTypeEnum extends RosettaModelObject, FieldWithMeta<MatrixTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaMatrixTypeEnumBuilder extends FieldWithMetaMatrixTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<MatrixTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaMatrixTypeEnumBuilderImpl implements FieldWithMetaMatrixTypeEnum.FieldWithMetaMatrixTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaMatrixTypeEnum.FieldWithMetaMatrixTypeEnumBuilder setValue(MatrixTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaMatrixTypeEnum.FieldWithMetaMatrixTypeEnumBuilder setMeta(MetaFields _meta) {
