	...
	*/
	...
	public static class MapFeeTypeEnumDefault extends MapFeeTypeEnum {
		...
		protected FeeTypeEnum assignOutput(FeeTypeEnum result, String value) {
			...
			if (switchArgument.get() == null) {
			...
			} else if (areEqual(switchArgument, MapperS.of("AMENDMENT_FEE"), CardinalityOperator.All).get()) {
				result = FeeTypeEnum.RENEGOTIATION;
			...
			} else if (areEqual(switchArgument, MapperS.of("TERMINATION_FEE"), CardinalityOperator.All).get()) {
				...
				result = FeeTypeEnum.UPFRONT;
			} else if (areEqual(switchArgument, MapperS.of("PrincipalExchange"), CardinalityOperator.All).get()) {
				result = FeeTypeEnum.UPFRONT;
			} else {
				result = null;
			}
