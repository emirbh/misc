...
@RuneDataType(value="FieldWithMetaBusinessCenterEnum", model="cdm", builder=FieldWithMetaBusinessCenterEnum.FieldWithMetaBusinessCenterEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaBusinessCenterEnum extends RosettaModelObject, FieldWithMeta<BusinessCenterEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaBusinessCenterEnumBuilder extends FieldWithMetaBusinessCenterEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<BusinessCenterEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaBusinessCenterEnumBuilderImpl implements FieldWithMetaBusinessCenterEnum.FieldWithMetaBusinessCenterEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaBusinessCenterEnum.FieldWithMetaBusinessCenterEnumBuilder setValue(BusinessCenterEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaBusinessCenterEnum.FieldWithMetaBusinessCenterEnumBuilder setMeta(MetaFields _meta) {
