...
@RuneDataType(value="FieldWithMetaInterestRateIndex", model="cdm", builder=FieldWithMetaInterestRateIndex.FieldWithMetaInterestRateIndexBuilderImpl.class, version="0.0.0")
