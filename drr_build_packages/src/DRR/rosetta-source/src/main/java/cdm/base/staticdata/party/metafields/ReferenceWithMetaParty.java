...
@RuneDataType(value="ReferenceWithMetaParty", model="cdm", builder=ReferenceWithMetaParty.ReferenceWithMetaPartyBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaParty extends RosettaModelObject, ReferenceWithMeta<Party> {
	...
	class ReferenceWithMetaPartyBuilderImpl implements ReferenceWithMetaParty.ReferenceWithMetaPartyBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaParty.ReferenceWithMetaPartyBuilder setValue(Party _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaParty.ReferenceWithMetaPartyBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaParty.ReferenceWithMetaPartyBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaParty.ReferenceWithMetaPartyBuilder setReference(Reference _reference) {
