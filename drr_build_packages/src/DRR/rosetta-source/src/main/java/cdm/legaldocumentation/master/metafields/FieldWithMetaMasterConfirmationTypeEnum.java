...
@RuneDataType(value="FieldWithMetaMasterConfirmationTypeEnum", model="cdm", builder=FieldWithMetaMasterConfirmationTypeEnum.FieldWithMetaMasterConfirmationTypeEnumBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaMasterConfirmationTypeEnum extends RosettaModelObject, FieldWithMeta<MasterConfirmationTypeEnum>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaMasterConfirmationTypeEnumBuilder extends FieldWithMetaMasterConfirmationTypeEnum, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<MasterConfirmationTypeEnum>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaMasterConfirmationTypeEnumBuilderImpl implements FieldWithMetaMasterConfirmationTypeEnum.FieldWithMetaMasterConfirmationTypeEnumBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaMasterConfirmationTypeEnum.FieldWithMetaMasterConfirmationTypeEnumBuilder setValue(MasterConfirmationTypeEnum _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaMasterConfirmationTypeEnum.FieldWithMetaMasterConfirmationTypeEnumBuilder setMeta(MetaFields _meta) {
