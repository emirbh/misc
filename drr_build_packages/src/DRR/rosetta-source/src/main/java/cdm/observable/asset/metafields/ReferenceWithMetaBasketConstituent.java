...
@RuneDataType(value="ReferenceWithMetaBasketConstituent", model="cdm", builder=ReferenceWithMetaBasketConstituent.ReferenceWithMetaBasketConstituentBuilderImpl.class, version="0.0.0")
