...
@RuneDataType(value="FieldWithMetaNonNegativeQuantitySchedule", model="cdm", builder=FieldWithMetaNonNegativeQuantitySchedule.FieldWithMetaNonNegativeQuantityScheduleBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaNonNegativeQuantitySchedule extends RosettaModelObject, FieldWithMeta<NonNegativeQuantitySchedule>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaNonNegativeQuantityScheduleBuilder extends FieldWithMetaNonNegativeQuantitySchedule, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<NonNegativeQuantitySchedule>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaNonNegativeQuantityScheduleBuilderImpl implements FieldWithMetaNonNegativeQuantitySchedule.FieldWithMetaNonNegativeQuantityScheduleBuilder {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaNonNegativeQuantitySchedule.FieldWithMetaNonNegativeQuantityScheduleBuilder setValue(NonNegativeQuantitySchedule _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaNonNegativeQuantitySchedule.FieldWithMetaNonNegativeQuantityScheduleBuilder setMeta(MetaFields _meta) {
