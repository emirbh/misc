...
@RuneDataType(value="ReferenceWithMetaCreditEvents", model="cdm", builder=ReferenceWithMetaCreditEvents.ReferenceWithMetaCreditEventsBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaCreditEvents extends RosettaModelObject, ReferenceWithMeta<CreditEvents> {
	...
	class ReferenceWithMetaCreditEventsBuilderImpl implements ReferenceWithMetaCreditEvents.ReferenceWithMetaCreditEventsBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaCreditEvents.ReferenceWithMetaCreditEventsBuilder setValue(CreditEvents _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaCreditEvents.ReferenceWithMetaCreditEventsBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaCreditEvents.ReferenceWithMetaCreditEventsBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaCreditEvents.ReferenceWithMetaCreditEventsBuilder setReference(Reference _reference) {
