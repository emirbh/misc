...
@RuneDataType(value="ReferenceWithMetaPaymentDates", model="cdm", builder=ReferenceWithMetaPaymentDates.ReferenceWithMetaPaymentDatesBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaPaymentDates extends RosettaModelObject, ReferenceWithMeta<PaymentDates> {
	...
	class ReferenceWithMetaPaymentDatesBuilderImpl implements ReferenceWithMetaPaymentDates.ReferenceWithMetaPaymentDatesBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPaymentDates.ReferenceWithMetaPaymentDatesBuilder setValue(PaymentDates _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaPaymentDates.ReferenceWithMetaPaymentDatesBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaPaymentDates.ReferenceWithMetaPaymentDatesBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaPaymentDates.ReferenceWithMetaPaymentDatesBuilder setReference(Reference _reference) {
