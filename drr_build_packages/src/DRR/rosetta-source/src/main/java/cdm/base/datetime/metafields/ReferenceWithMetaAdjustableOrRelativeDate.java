...
@RuneDataType(value="ReferenceWithMetaAdjustableOrRelativeDate", model="cdm", builder=ReferenceWithMetaAdjustableOrRelativeDate.ReferenceWithMetaAdjustableOrRelativeDateBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaAdjustableOrRelativeDate extends RosettaModelObject, ReferenceWithMeta<AdjustableOrRelativeDate> {
	...
	class ReferenceWithMetaAdjustableOrRelativeDateBuilderImpl implements ReferenceWithMetaAdjustableOrRelativeDate.ReferenceWithMetaAdjustableOrRelativeDateBuilder {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaAdjustableOrRelativeDate.ReferenceWithMetaAdjustableOrRelativeDateBuilder setValue(AdjustableOrRelativeDate _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaAdjustableOrRelativeDate.ReferenceWithMetaAdjustableOrRelativeDateBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaAdjustableOrRelativeDate.ReferenceWithMetaAdjustableOrRelativeDateBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaAdjustableOrRelativeDate.ReferenceWithMetaAdjustableOrRelativeDateBuilder setReference(Reference _reference) {
