...
@RuneDataType(value="FieldWithMetaDate", model="com", builder=FieldWithMetaDate.FieldWithMetaDateBuilderImpl.class, version="0.0.0")
public interface FieldWithMetaDate extends RosettaModelObject, FieldWithMeta<Date>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaDateBuilder extends FieldWithMetaDate, RosettaModelObjectBuilder, FieldWithMeta.FieldWithMetaBuilder<Date>, GlobalKey.GlobalKeyBuilder {
	...
	class FieldWithMetaDateBuilderImpl implements FieldWithMetaDate.FieldWithMetaDateBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public FieldWithMetaDate.FieldWithMetaDateBuilder setValue(Date _value) {
		...
		@RuneMetaType
		@Override
		public FieldWithMetaDate.FieldWithMetaDateBuilder setMeta(MetaFields _meta) {
