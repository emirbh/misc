...
@RuneDataType(value="ReferenceWithMetaDate", model="com", builder=ReferenceWithMetaDate.ReferenceWithMetaDateBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaDate extends RosettaModelObject, ReferenceWithMeta<Date> {
	...
	class ReferenceWithMetaDateBuilderImpl implements ReferenceWithMetaDate.ReferenceWithMetaDateBuilder {
		...
		@RuneAttribute("@data")
		@Override
		public ReferenceWithMetaDate.ReferenceWithMetaDateBuilder setValue(Date _value) {
		...
		@RuneAttribute("@ref")
		@Override
		public ReferenceWithMetaDate.ReferenceWithMetaDateBuilder setGlobalReference(String _globalReference) {
		...
		@RuneAttribute("@ref:external")
		@Override
		public ReferenceWithMetaDate.ReferenceWithMetaDateBuilder setExternalReference(String _externalReference) {
		...
		@RuneMetaType
		@Override
		public ReferenceWithMetaDate.ReferenceWithMetaDateBuilder setReference(Reference _reference) {
