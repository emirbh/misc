 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0127")
@ImplementedBy(HKMAMarginReportDOC0127.Default.class)
public interface HKMAMarginReportDOC0127 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0127";
	String DEFINITION = "True";
	
	class Default implements HKMAMarginReportDOC0127 {
	...
	class NoOp implements HKMAMarginReportDOC0127 {
