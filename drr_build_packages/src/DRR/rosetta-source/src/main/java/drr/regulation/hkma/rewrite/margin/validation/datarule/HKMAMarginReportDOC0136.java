 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0136")
@ImplementedBy(HKMAMarginReportDOC0136.Default.class)
public interface HKMAMarginReportDOC0136 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0136";
	String DEFINITION = "True";
	
	class Default implements HKMAMarginReportDOC0136 {
	...
	class NoOp implements HKMAMarginReportDOC0136 {
