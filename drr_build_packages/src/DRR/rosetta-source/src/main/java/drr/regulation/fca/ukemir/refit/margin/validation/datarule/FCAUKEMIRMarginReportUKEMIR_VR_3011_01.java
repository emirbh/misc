 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3011_01")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3011_01.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3011_01 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3011_01";
	String DEFINITION = "if collateralisationCategory exists then True";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3011_01 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRMarginReport fCAUKEMIRMarginReport) {
			try {
				if (exists(MapperS.of(fCAUKEMIRMarginReport).<CollateralisationType3Code>map("getCollateralisationCategory", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getCollateralisationCategory())).getOrDefault(false)) {
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3011_01 {
