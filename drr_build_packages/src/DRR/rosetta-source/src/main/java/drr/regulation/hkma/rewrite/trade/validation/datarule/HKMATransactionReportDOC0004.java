 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0004")
@ImplementedBy(HKMATransactionReportDOC0004.Default.class)
public interface HKMATransactionReportDOC0004 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0004";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0004 {
	...
	class NoOp implements HKMATransactionReportDOC0004 {
