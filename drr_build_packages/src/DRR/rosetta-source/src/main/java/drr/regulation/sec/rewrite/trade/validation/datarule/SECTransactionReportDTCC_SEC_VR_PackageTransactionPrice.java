 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportDTCC_SEC_VR_PackageTransactionPrice")
@ImplementedBy(SECTransactionReportDTCC_SEC_VR_PackageTransactionPrice.Default.class)
public interface SECTransactionReportDTCC_SEC_VR_PackageTransactionPrice extends Validator<SECTransactionReport> {
	
	String NAME = "SECTransactionReportDTCC_SEC_VR_PackageTransactionPrice";
	...
	class Default implements SECTransactionReportDTCC_SEC_VR_PackageTransactionPrice {
	...
	class NoOp implements SECTransactionReportDTCC_SEC_VR_PackageTransactionPrice {
