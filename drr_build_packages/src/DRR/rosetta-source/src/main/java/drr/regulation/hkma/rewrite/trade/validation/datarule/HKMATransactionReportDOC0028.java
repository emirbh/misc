 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0028")
@ImplementedBy(HKMATransactionReportDOC0028.Default.class)
public interface HKMATransactionReportDOC0028 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0028";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then if leg2 -> periodicPayment -> fixedRatePaymentFrequencyPeriodMultiplier exists then leg2 -> periodicPayment -> fixedRatePaymentFrequencyPeriod exists";
	
	class Default implements HKMATransactionReportDOC0028 {
	...
	class NoOp implements HKMATransactionReportDOC0028 {
