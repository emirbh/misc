 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0115")
@ImplementedBy(HKMAMarginReportDOC0115.Default.class)
public interface HKMAMarginReportDOC0115 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0115";
	String DEFINITION = "True";
	
	class Default implements HKMAMarginReportDOC0115 {
	...
	class NoOp implements HKMAMarginReportDOC0115 {
