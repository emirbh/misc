			...
			try {
				...
				if ((_boolean == null ? false : _boolean)) {
					if (notExists(MapperS.of(fCAUKEMIRTransactionReport).<String>map("getPackageIdentifier", _fCAUKEMIRTransactionReport -> _fCAUKEMIRTransactionReport.getPackageIdentifier())).orNullSafe(exists(MapperS.of(fCAUKEMIRTransactionReport).<PriceFormat>map("getPackageTransactionPrice", _fCAUKEMIRTransactionReport -> _fCAUKEMIRTransactionReport.getPackageTransactionPrice()))).getOrDefault(false)) {
						return notExists(MapperS.of(fCAUKEMIRTransactionReport).<PriceFormat>map("getPackageTransactionSpread", _fCAUKEMIRTransactionReport -> _fCAUKEMIRTransactionReport.getPackageTransactionSpread()));
					}
