 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICTransactionReportDTCC_ASIC_BR_1047_02")
@ImplementedBy(ASICTransactionReportDTCC_ASIC_BR_1047_02.Default.class)
public interface ASICTransactionReportDTCC_ASIC_BR_1047_02 extends Validator<ASICTransactionReport> {
	
	String NAME = "ASICTransactionReportDTCC_ASIC_BR_1047_02";
	String DEFINITION = "if ((CommonAssetClass -> INTR = assetClass and [CommonContractType -> FRAS, CommonContractType -> FORW, CommonContractType -> OPTN, CommonContractType -> SWAP, CommonContractType -> SWPT, CommonContractType -> OTHR] any = contractType) or [CommonAssetClass -> EQUI, CommonAssetClass -> COMM] any = assetClass and [CommonContractType -> FRAS, CommonContractType -> OPTN, CommonContractType -> SWPT, CommonContractType -> OTHR] any = contractType) then common.price.Price_Validation_02( actionType, leg1, leg2, strikePrice, optionPremiumAmount, price, priceSchedule )";
	
	class Default implements ASICTransactionReportDTCC_ASIC_BR_1047_02 {
	...
	class NoOp implements ASICTransactionReportDTCC_ASIC_BR_1047_02 {
