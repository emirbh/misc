 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICTransactionReportDTCC_ASIC_BR_1066_02")
@ImplementedBy(ASICTransactionReportDTCC_ASIC_BR_1066_02.Default.class)
public interface ASICTransactionReportDTCC_ASIC_BR_1066_02 extends Validator<ASICTransactionReport> {
	
	String NAME = "ASICTransactionReportDTCC_ASIC_BR_1066_02";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and [CommonAssetClass -> INTR, CommonAssetClass -> CRDT, CommonAssetClass -> EQUI, CommonAssetClass -> COMM] any = assetClass then True";
	
	class Default implements ASICTransactionReportDTCC_ASIC_BR_1066_02 {
	...
	class NoOp implements ASICTransactionReportDTCC_ASIC_BR_1066_02 {
