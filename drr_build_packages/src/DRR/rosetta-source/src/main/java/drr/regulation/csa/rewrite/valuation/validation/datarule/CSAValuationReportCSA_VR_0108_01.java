 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSAValuationReportCSA_VR_0108_01")
@ImplementedBy(CSAValuationReportCSA_VR_0108_01.Default.class)
public interface CSAValuationReportCSA_VR_0108_01 extends Validator<CSAValuationReport> {
	
	String NAME = "CSAValuationReportCSA_VR_0108_01";
	String DEFINITION = "True";
	
	class Default implements CSAValuationReportCSA_VR_0108_01 {
	...
	class NoOp implements CSAValuationReportCSA_VR_0108_01 {
