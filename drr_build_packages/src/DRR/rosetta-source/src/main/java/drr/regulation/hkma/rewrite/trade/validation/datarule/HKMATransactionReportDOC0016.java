 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0016")
@ImplementedBy(HKMATransactionReportDOC0016.Default.class)
public interface HKMATransactionReportDOC0016 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0016";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0016 {
	...
	class NoOp implements HKMATransactionReportDOC0016 {
