 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAValuationReportEMIR_VR_2151_04")
@ImplementedBy(ESMAValuationReportEMIR_VR_2151_04.Default.class)
public interface ESMAValuationReportEMIR_VR_2151_04 extends Validator<ESMAValuationReport> {
	
	String NAME = "ESMAValuationReportEMIR_VR_2151_04";
	String DEFINITION = "True";
	
	class Default implements ESMAValuationReportEMIR_VR_2151_04 {
	...
	class NoOp implements ESMAValuationReportEMIR_VR_2151_04 {
