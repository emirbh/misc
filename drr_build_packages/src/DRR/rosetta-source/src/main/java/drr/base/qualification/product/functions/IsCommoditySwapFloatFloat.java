...
@ImplementedBy(IsCommoditySwapFloatFloat.IsCommoditySwapFloatFloatDefault.class)
public abstract class IsCommoditySwapFloatFloat implements RosettaFunction {
	...
	*/
	...
	public static class IsCommoditySwapFloatFloatDefault extends IsCommoditySwapFloatFloat {
		@Override
		...
		protected Boolean assignOutput(Boolean result, NonTransferableProduct product) {
			result = areEqual(MapperS.of(qualify_Commodity_Swap_Basis.evaluate(economicTermsForProduct.evaluate(product))), MapperS.of(true), CardinalityOperator.All).get();
