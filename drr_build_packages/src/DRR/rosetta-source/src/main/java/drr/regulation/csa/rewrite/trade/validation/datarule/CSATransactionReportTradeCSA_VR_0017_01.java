 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportTradeCSA_VR_0017_01")
@ImplementedBy(CSATransactionReportTradeCSA_VR_0017_01.Default.class)
public interface CSATransactionReportTradeCSA_VR_0017_01 extends Validator<CSATransactionReportTrade> {
	
	String NAME = "CSATransactionReportTradeCSA_VR_0017_01";
	String DEFINITION = "if actionType = NEWT and [EventTypeEnum -> NOVA, EventTypeEnum -> CLRG, EventTypeEnum -> EXER, EventTypeEnum -> ALOC, EventTypeEnum -> CLAL] any = eventType and priorUSI is absent then priorUTI exists else priorUTI is absent";
	
	class Default implements CSATransactionReportTradeCSA_VR_0017_01 {
	...
	class NoOp implements CSATransactionReportTradeCSA_VR_0017_01 {
