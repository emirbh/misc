...
@ImplementedBy(IsCredit.IsCreditDefault.class)
public abstract class IsCredit implements RosettaFunction {
	...
	*/
	...
	public static class IsCreditDefault extends IsCredit {
		@Override
		...
		protected Boolean assignOutput(Boolean result, NonTransferableProduct product) {
			result = areEqual(MapperS.of(qualify_AssetClass_Credit.evaluate(economicTermsForProduct.evaluate(product))), MapperS.of(true), CardinalityOperator.All).get();
