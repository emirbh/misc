 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0130_01")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0130_01.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0130_01 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0130_01";
	String DEFINITION = "if otherPayment exists and [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI, ActionTypeEnum -> TERM] any = actionType then common.payment.OtherPaymentPayer_Validation(otherPayment) default True and otherPayment -> payer <> otherPayment -> receiver";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0130_01 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0130_01 {
