...
public class JFSAMarginReportOnlyExistsValidator implements ValidatorWithArg<JFSAMarginReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends JFSAMarginReport> ValidationResult<JFSAMarginReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("JFSAMarginReport", ValidationResult.ValidationType.ONLY_EXISTS, "JFSAMarginReport", path, "");
		}
		return failure("JFSAMarginReport", ValidationResult.ValidationType.ONLY_EXISTS, "JFSAMarginReport", path, "",
