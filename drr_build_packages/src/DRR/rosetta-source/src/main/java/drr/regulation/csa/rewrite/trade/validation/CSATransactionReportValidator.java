...
public class CSATransactionReportValidator implements Validator<CSATransactionReport> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CSATransactionReport", ValidationResult.ValidationType.CARDINALITY, "CSATransactionReport", path, "", res.getError());
				}
				return success("CSATransactionReport", ValidationResult.ValidationType.CARDINALITY, "CSATransactionReport", path, "");
			})
			.collect(toList());
	}
