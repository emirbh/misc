...
import iso20022.auth030.hkma.dtcc.NaturalPersonIdentification2__1;
...
public abstract class Create_PartyIdentification248Choice__5 implements RosettaFunction {
	...
	* @return id 
	*/
	public PartyIdentification248Choice__5 evaluate(HKMATransactionReport drrReport) {
	...
	protected abstract PartyIdentification248Choice__5.PartyIdentification248Choice__5Builder doEvaluate(HKMATransactionReport drrReport);

	public static class Create_PartyIdentification248Choice__5Default extends Create_PartyIdentification248Choice__5 {
		@Override
		protected PartyIdentification248Choice__5.PartyIdentification248Choice__5Builder doEvaluate(HKMATransactionReport drrReport) {
		...
		protected PartyIdentification248Choice__5.PartyIdentification248Choice__5Builder assignOutput(PartyIdentification248Choice__5.PartyIdentification248Choice__5Builder id, HKMATransactionReport drrReport) {
			OrganisationIdentification15Choice__2 ifThenElseResult0 = null;
			if (notEqual(MapperS.of(drrReport).<HKTRPartyScheme>map("getCounterparty2SchemeName", hKMATransactionReport -> hKMATransactionReport.getCounterparty2SchemeName()), MapperS.of(HKTRPartyScheme.TRID), CardinalityOperator.Any).getOrDefault(false)) {
				ifThenElseResult0 = create_OrganisationIdentification15Choice__2.evaluate(drrReport, MapperS.of(drrReport).<PartyIdentifierFormat2Enum>map("getCounterparty2IdentifierFormat", hKMATransactionReport -> hKMATransactionReport.getCounterparty2IdentifierFormat()).get(), MapperS.of(drrReport).<String>map("getCounterparty2", hKMATransactionReport -> hKMATransactionReport.getCounterparty2()).get(), MapperS.of(drrReport).<HKTRPartyScheme>map("getCounterparty2SchemeName", hKMATransactionReport -> hKMATransactionReport.getCounterparty2SchemeName()).get());
			}
