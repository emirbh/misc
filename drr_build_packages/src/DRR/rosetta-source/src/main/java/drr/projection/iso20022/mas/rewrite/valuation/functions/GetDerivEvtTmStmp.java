...
public abstract class GetDerivEvtTmStmp implements RosettaFunction {
	...
	* @return tmStmp 
	*/
	public DateAndDateTime2Choice__1 evaluate(MASValuationReport drrReport) {
	...
	protected abstract DateAndDateTime2Choice__1.DateAndDateTime2Choice__1Builder doEvaluate(MASValuationReport drrReport);

	public static class GetDerivEvtTmStmpDefault extends GetDerivEvtTmStmp {
		@Override
		protected DateAndDateTime2Choice__1.DateAndDateTime2Choice__1Builder doEvaluate(MASValuationReport drrReport) {
		...
		protected DateAndDateTime2Choice__1.DateAndDateTime2Choice__1Builder assignOutput(DateAndDateTime2Choice__1.DateAndDateTime2Choice__1Builder tmStmp, MASValuationReport drrReport) {
