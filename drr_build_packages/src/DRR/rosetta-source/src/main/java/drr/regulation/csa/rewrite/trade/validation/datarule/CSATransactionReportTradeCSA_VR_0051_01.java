 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportTradeCSA_VR_0051_01")
@ImplementedBy(CSATransactionReportTradeCSA_VR_0051_01.Default.class)
public interface CSATransactionReportTradeCSA_VR_0051_01 extends Validator<CSATransactionReportTrade> {
	
	String NAME = "CSATransactionReportTradeCSA_VR_0051_01";
	String DEFINITION = "if ([AnnaDsbAssetClassEnum -> Equity, AnnaDsbAssetClassEnum -> Commodities] any = nonReportable -> postUpiData -> Header -> AssetClass or [AssetClassEnum -> Equity, AssetClassEnum -> Commodity] any = dtccAdditionalFields -> primaryAssetClass) and (priceSchedule -> price exists) then (priceSchedule -> endDate exists and if priceSchedule -> endDate count >= 1 then (priceSchedule -> endDate count = priceSchedule -> price count) else True) else priceSchedule -> endDate is absent";
	
	class Default implements CSATransactionReportTradeCSA_VR_0051_01 {
	...
	class NoOp implements CSATransactionReportTradeCSA_VR_0051_01 {
