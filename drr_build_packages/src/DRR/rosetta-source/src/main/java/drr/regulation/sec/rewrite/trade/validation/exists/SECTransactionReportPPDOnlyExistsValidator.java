...
public class SECTransactionReportPPDOnlyExistsValidator implements ValidatorWithArg<SECTransactionReportPPD, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends SECTransactionReportPPD> ValidationResult<SECTransactionReportPPD> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("SECTransactionReportPPD", ValidationResult.ValidationType.ONLY_EXISTS, "SECTransactionReportPPD", path, "");
		}
		return failure("SECTransactionReportPPD", ValidationResult.ValidationType.ONLY_EXISTS, "SECTransactionReportPPD", path, "",
