 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRTransactionReportUKEMIR_VR_2088_01")
@ImplementedBy(FCAUKEMIRTransactionReportUKEMIR_VR_2088_01.Default.class)
public interface FCAUKEMIRTransactionReportUKEMIR_VR_2088_01 extends Validator<FCAUKEMIRTransactionReport> {
	
	String NAME = "FCAUKEMIRTransactionReportUKEMIR_VR_2088_01";
	String DEFINITION = "if IsVRAllowedForActionType(actionType) then if [FrequencyPeriodEnum -> EXPI, FrequencyPeriodEnum -> YEAR, FrequencyPeriodEnum -> MNTH, FrequencyPeriodEnum -> WEEK, FrequencyPeriodEnum -> DAIL] any = leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriod then leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier exists and leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier >= 0 else leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier is absent";
	
	class Default implements FCAUKEMIRTransactionReportUKEMIR_VR_2088_01 {
	...
	class NoOp implements FCAUKEMIRTransactionReportUKEMIR_VR_2088_01 {
