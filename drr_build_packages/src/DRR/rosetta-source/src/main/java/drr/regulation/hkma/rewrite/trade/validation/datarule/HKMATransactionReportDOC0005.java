 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0005")
@ImplementedBy(HKMATransactionReportDOC0005.Default.class)
public interface HKMATransactionReportDOC0005 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0005";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0005 {
	...
	class NoOp implements HKMATransactionReportDOC0005 {
