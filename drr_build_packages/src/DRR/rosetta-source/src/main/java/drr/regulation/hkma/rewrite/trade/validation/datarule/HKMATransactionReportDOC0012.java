 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0012")
@ImplementedBy(HKMATransactionReportDOC0012.Default.class)
public interface HKMATransactionReportDOC0012 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0012";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0012 {
	...
	class NoOp implements HKMATransactionReportDOC0012 {
