 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportTradeDTCC_SEC_VR_ReceiverIdentifierLeg2")
@ImplementedBy(SECTransactionReportTradeDTCC_SEC_VR_ReceiverIdentifierLeg2.Default.class)
public interface SECTransactionReportTradeDTCC_SEC_VR_ReceiverIdentifierLeg2 extends Validator<SECTransactionReportTrade> {
	
	String NAME = "SECTransactionReportTradeDTCC_SEC_VR_ReceiverIdentifierLeg2";
	String DEFINITION = "if leg2 -> receiverIdentifier exists then (leg2 -> receiverIdentifier = counterparty1 or leg2 -> receiverIdentifier = counterparty2)";
	
	class Default implements SECTransactionReportTradeDTCC_SEC_VR_ReceiverIdentifierLeg2 {
	...
	class NoOp implements SECTransactionReportTradeDTCC_SEC_VR_ReceiverIdentifierLeg2 {
