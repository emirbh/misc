 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0118_02")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0118_02.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0118_02 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0118_02";
	String DEFINITION = "ReferencePeriodMultiplier_Validation( actionType, leg2 -> periodicPayment -> floatingRateReferencePeriod, leg2 -> periodicPayment -> floatingRateReferencePeriodMultiplier )";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0118_02 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0118_02 {
