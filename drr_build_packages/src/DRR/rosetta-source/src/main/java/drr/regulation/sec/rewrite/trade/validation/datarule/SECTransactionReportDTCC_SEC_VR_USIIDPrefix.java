 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportDTCC_SEC_VR_USIIDPrefix")
@ImplementedBy(SECTransactionReportDTCC_SEC_VR_USIIDPrefix.Default.class)
public interface SECTransactionReportDTCC_SEC_VR_USIIDPrefix extends Validator<SECTransactionReport> {
	
	String NAME = "SECTransactionReportDTCC_SEC_VR_USIIDPrefix";
	String DEFINITION = "True";
	
	class Default implements SECTransactionReportDTCC_SEC_VR_USIIDPrefix {
	...
	class NoOp implements SECTransactionReportDTCC_SEC_VR_USIIDPrefix {
