...
public class CommonValuationReportOnlyExistsValidator implements ValidatorWithArg<CommonValuationReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CommonValuationReport> ValidationResult<CommonValuationReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CommonValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "CommonValuationReport", path, "");
		}
		return failure("CommonValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "CommonValuationReport", path, "",
