...
public class CFTCValuationReportTypeFormatValidator implements Validator<CFTCValuationReport> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CFTCValuationReport", ValidationResult.ValidationType.TYPE_FORMAT, "CFTCValuationReport", path, "", res.getError());
				}
				return success("CFTCValuationReport", ValidationResult.ValidationType.TYPE_FORMAT, "CFTCValuationReport", path, "");
			})
			.collect(toList());
	}
