 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0098_01")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0098_01.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0098_01 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0098_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and [CommonAssetClass -> EQUI, CommonAssetClass -> COMM] any = assetClass then (if leg1 -> notionalQuantitySchedule -> value exists then leg1 -> notionalQuantitySchedule -> effectiveDate exists else if leg1 -> notionalQuantitySchedule -> value count <> leg1 -> notionalQuantitySchedule -> effectiveDate count then False)";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0098_01 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0098_01 {
