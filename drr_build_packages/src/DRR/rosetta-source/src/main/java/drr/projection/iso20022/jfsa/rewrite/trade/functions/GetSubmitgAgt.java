...
public abstract class GetSubmitgAgt implements RosettaFunction {
	...
	*/
	...
	public static class GetSubmitgAgtDefault extends GetSubmitgAgt {
		...
		protected OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder assignOutput(OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder submitgAgt, JFSATransactionReport drrReport) {
			submitgAgt = toBuilder(create_OrganisationIdentification15Choice__1.evaluate(MapperS.of(drrReport).<String>map("getReportSubmittingEntityID", jFSATransactionReport -> jFSATransactionReport.getReportSubmittingEntityID()).get()));
