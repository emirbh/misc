 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRMarginReportEMIR_VR_3008_01")
@ImplementedBy(ESMAEMIRMarginReportEMIR_VR_3008_01.Default.class)
public interface ESMAEMIRMarginReportEMIR_VR_3008_01 extends Validator<ESMAEMIRMarginReport> {
	
	String NAME = "ESMAEMIRMarginReportEMIR_VR_3008_01";
	String DEFINITION = "if collateralPortfolioIndicator exists then True";
	
	class Default implements ESMAEMIRMarginReportEMIR_VR_3008_01 {
		...
		private ComparisonResult executeDataRule(ESMAEMIRMarginReport eSMAEMIRMarginReport) {
			try {
				if (exists(MapperS.of(eSMAEMIRMarginReport).<Boolean>map("getCollateralPortfolioIndicator", _eSMAEMIRMarginReport -> _eSMAEMIRMarginReport.getCollateralPortfolioIndicator())).getOrDefault(false)) {
	...
	class NoOp implements ESMAEMIRMarginReportEMIR_VR_3008_01 {
