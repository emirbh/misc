 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportCSA_VR_0098_01")
@ImplementedBy(CSATransactionReportCSA_VR_0098_01.Default.class)
public interface CSATransactionReportCSA_VR_0098_01 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportCSA_VR_0098_01";
	String DEFINITION = "True";
	
	class Default implements CSATransactionReportCSA_VR_0098_01 {
	...
	class NoOp implements CSATransactionReportCSA_VR_0098_01 {
