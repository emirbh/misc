 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASMarginReportDTCC_MAS_BR_0050_03")
@ImplementedBy(MASMarginReportDTCC_MAS_BR_0050_03.Default.class)
public interface MASMarginReportDTCC_MAS_BR_0050_03 extends Validator<MASMarginReport> {
	
	String NAME = "MASMarginReportDTCC_MAS_BR_0050_03";
	String DEFINITION = "if [MarginActionEnum -> MARU, MarginActionEnum -> CORR] any = actionType then True";
	
	class Default implements MASMarginReportDTCC_MAS_BR_0050_03 {
	...
	class NoOp implements MASMarginReportDTCC_MAS_BR_0050_03 {
