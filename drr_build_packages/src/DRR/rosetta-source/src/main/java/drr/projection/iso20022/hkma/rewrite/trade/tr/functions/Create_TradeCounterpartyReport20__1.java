...
import iso20022.auth030.hkma.tr.Direction2__1;
...
import iso20022.auth030.hkma.tr.OptionParty1Code;
import iso20022.auth030.hkma.tr.OptionParty3Code;
			...
			if (areEqual(MapperS.of(drrReport).<NatureOfCounterpartyEnum>map("getNatureOfCounterparty1", hKMATransactionReport -> hKMATransactionReport.getNatureOfCounterparty1()), MapperS.of(NatureOfCounterpartyEnum.N), CardinalityOperator.All).getOrDefault(false)) {
				ifThenElseResult1 = NonFinancialInstitutionSector10__1.builder()
					.setSctr(GenericIdentification175__1.builder()
						.setId(MapperS.of(drrReport).<String>map("getCounterparty1", hKMATransactionReport -> hKMATransactionReport.getCounterparty1()).get())
						.build())
					.build();
			}
			...
			ctrPty = toBuilder(TradeCounterpartyReport20__1.builder()
				.setRptgCtrPty(Counterparty45__1.builder()
					...
					.setNtr(CounterpartyTradeNature15Choice__1.builder()
						...
						.build())
					.setTradgCpcty(MapperS.of(drrReport).<TradingCapacity7Code>map("getTradingCapacity", hKMATransactionReport -> hKMATransactionReport.getTradingCapacity()).checkedMap("to-enum", e -> iso20022.auth030.hkma.tr.TradingCapacity7Code.valueOf(e.name()), IllegalArgumentException.class).get())
