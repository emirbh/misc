 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportTradeDTCC_SEC_VR_ClearingSwapUTIs")
@ImplementedBy(SECTransactionReportTradeDTCC_SEC_VR_ClearingSwapUTIs.Default.class)
public interface SECTransactionReportTradeDTCC_SEC_VR_ClearingSwapUTIs extends Validator<SECTransactionReportTrade> {
	
	String NAME = "SECTransactionReportTradeDTCC_SEC_VR_ClearingSwapUTIs";
	String DEFINITION = "if (cleared = Y or (cleared = I and actionType = TERM)) and [EventTypeEnum -> CLRG, EventTypeEnum -> CLAL] any = eventType and clearingSwapUSIs is absent then clearingSwapUTIs exists else clearingSwapUTIs is absent";
	
	class Default implements SECTransactionReportTradeDTCC_SEC_VR_ClearingSwapUTIs {
	...
	class NoOp implements SECTransactionReportTradeDTCC_SEC_VR_ClearingSwapUTIs {
