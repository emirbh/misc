 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRMarginReportEMIR_VR_3013_02")
@ImplementedBy(ESMAEMIRMarginReportEMIR_VR_3013_02.Default.class)
public interface ESMAEMIRMarginReportEMIR_VR_3013_02 extends Validator<ESMAEMIRMarginReport> {
	
	String NAME = "ESMAEMIRMarginReportEMIR_VR_3013_02";
	String DEFINITION = "if initialMarginPostedByTheCounterparty1PostHaircut exists then True";
	
	class Default implements ESMAEMIRMarginReportEMIR_VR_3013_02 {
	...
	class NoOp implements ESMAEMIRMarginReportEMIR_VR_3013_02 {
