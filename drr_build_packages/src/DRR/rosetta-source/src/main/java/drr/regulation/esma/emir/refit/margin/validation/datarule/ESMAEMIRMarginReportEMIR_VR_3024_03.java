 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRMarginReportEMIR_VR_3024_03")
@ImplementedBy(ESMAEMIRMarginReportEMIR_VR_3024_03.Default.class)
public interface ESMAEMIRMarginReportEMIR_VR_3024_03 extends Validator<ESMAEMIRMarginReport> {
	
	String NAME = "ESMAEMIRMarginReportEMIR_VR_3024_03";
	String DEFINITION = "if variationMarginCollectedByTheCounterparty1PostHaircut exists then True";
	
	class Default implements ESMAEMIRMarginReportEMIR_VR_3024_03 {
		...
		private ComparisonResult executeDataRule(ESMAEMIRMarginReport eSMAEMIRMarginReport) {
			try {
				if (exists(MapperS.of(eSMAEMIRMarginReport).<BigDecimal>map("getVariationMarginCollectedByTheCounterparty1PostHaircut", _eSMAEMIRMarginReport -> _eSMAEMIRMarginReport.getVariationMarginCollectedByTheCounterparty1PostHaircut())).getOrDefault(false)) {
	...
	class NoOp implements ESMAEMIRMarginReportEMIR_VR_3024_03 {
