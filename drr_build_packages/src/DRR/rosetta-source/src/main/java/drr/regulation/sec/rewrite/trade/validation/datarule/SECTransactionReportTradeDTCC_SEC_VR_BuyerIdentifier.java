 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportTradeDTCC_SEC_VR_BuyerIdentifier")
@ImplementedBy(SECTransactionReportTradeDTCC_SEC_VR_BuyerIdentifier.Default.class)
public interface SECTransactionReportTradeDTCC_SEC_VR_BuyerIdentifier extends Validator<SECTransactionReportTrade> {
	
	String NAME = "SECTransactionReportTradeDTCC_SEC_VR_BuyerIdentifier";
	String DEFINITION = "if sellerIdentifier exists or (leg1 -> payerIdentifier is absent and leg1 -> receiverIdentifier is absent) then (buyerIdentifier exists and (buyerIdentifier = counterparty1 or buyerIdentifier = counterparty2)) else buyerIdentifier is absent";
	
	class Default implements SECTransactionReportTradeDTCC_SEC_VR_BuyerIdentifier {
	...
	class NoOp implements SECTransactionReportTradeDTCC_SEC_VR_BuyerIdentifier {
