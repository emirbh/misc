...
import drr.projection.iso20022.fca.ukemir.refit.valuation.labels.Project_FcaUkEmirValuationReportToIso20022LabelProvider;
...
@RuneLabelProvider(labelProvider=Project_FcaUkEmirValuationReportToIso20022LabelProvider.class)
@Projection(format = SerializationFormat.XML)
@ImplementedBy(Project_FcaUkEmirValuationReportToIso20022.Project_FcaUkEmirValuationReportToIso20022Default.class)
public abstract class Project_FcaUkEmirValuationReportToIso20022 implements RosettaFunction {
	...
	*/
	public Document evaluate(FCAValuationReport drrReport) {
	...
	protected abstract Document.DocumentBuilder doEvaluate(FCAValuationReport drrReport);

	public static class Project_FcaUkEmirValuationReportToIso20022Default extends Project_FcaUkEmirValuationReportToIso20022 {
		@Override
		protected Document.DocumentBuilder doEvaluate(FCAValuationReport drrReport) {
			Document.DocumentBuilder iso20022Report = Document.builder();
			return assignOutput(iso20022Report, drrReport);
		}
		
		protected Document.DocumentBuilder assignOutput(Document.DocumentBuilder iso20022Report, FCAValuationReport drrReport) {
			iso20022Report
