 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAValuationReportEMIR_VR_1009_08")
@ImplementedBy(ESMAValuationReportEMIR_VR_1009_08.Default.class)
public interface ESMAValuationReportEMIR_VR_1009_08 extends Validator<ESMAValuationReport> {
	
	String NAME = "ESMAValuationReportEMIR_VR_1009_08";
	String DEFINITION = "True";
	
	class Default implements ESMAValuationReportEMIR_VR_1009_08 {
	...
	class NoOp implements ESMAValuationReportEMIR_VR_1009_08 {
