 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICTransactionReportDTCC_ASIC_BR_1097_02")
@ImplementedBy(ASICTransactionReportDTCC_ASIC_BR_1097_02.Default.class)
public interface ASICTransactionReportDTCC_ASIC_BR_1097_02 extends Validator<ASICTransactionReport> {
	
	String NAME = "ASICTransactionReportDTCC_ASIC_BR_1097_02";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then if (packageIdentifier exists or swapLinkID exists) and packageTransactionPrice is absent and assetClass = CURR and (contractType = SWAP or contractType = FORW) then packageTransactionSpread exists";
	
	class Default implements ASICTransactionReportDTCC_ASIC_BR_1097_02 {
	...
	class NoOp implements ASICTransactionReportDTCC_ASIC_BR_1097_02 {
