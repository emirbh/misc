 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_0033_01")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_0033_01.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_0033_01 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_0033_01";
	String DEFINITION = "if (nonReportable -> postUpiData -> Header -> AssetClass = Commodities or dtccAdditionalFields -> primaryAssetClass = Commodity) and leg1 -> notionalQuantity exists then leg1 -> quantityFrequency exists else leg1 -> quantityFrequency is absent";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_0033_01 {
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_0033_01 {
