...
public abstract class OriginalSwapUSIRule implements ReportFunction<TransactionReportInstruction, String> {
	...
	@Inject protected drr.regulation.common.trade.link.reports.OriginalSwapUSIRule originalSwapUSIRule;
		...
		protected String assignOutput(String output, TransactionReportInstruction input) {
			...
			final FieldWithMetaString fieldWithMetaString = thenArg
				.mapSingleToItem(item -> {
					final String string = originalSwapUSIRule.evaluate(item.get());
