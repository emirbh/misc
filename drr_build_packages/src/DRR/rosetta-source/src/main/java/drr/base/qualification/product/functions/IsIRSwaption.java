...
@ImplementedBy(IsIRSwaption.IsIRSwaptionDefault.class)
public abstract class IsIRSwaption implements RosettaFunction {
	...
	*/
	...
	public static class IsIRSwaptionDefault extends IsIRSwaption {
		@Override
		...
		protected Boolean assignOutput(Boolean result, NonTransferableProduct product) {
			result = areEqual(MapperS.of(qualify_InterestRate_Option_Swaption.evaluate(economicTermsForProduct.evaluate(product))), MapperS.of(true), CardinalityOperator.All).get();
