...
public abstract class Project_CSATradeReportToDtccRdsHarmonized implements RosettaFunction {
	...
	*/
	public Document evaluate(CSATransactionReportTrade drrReport) {
	...
	protected abstract Document.DocumentBuilder doEvaluate(CSATransactionReportTrade drrReport);

	public static class Project_CSATradeReportToDtccRdsHarmonizedDefault extends Project_CSATradeReportToDtccRdsHarmonized {
		@Override
		protected Document.DocumentBuilder doEvaluate(CSATransactionReportTrade drrReport) {
			Document.DocumentBuilder harmonizedReport = Document.builder();
			return assignOutput(harmonizedReport, drrReport);
		}
		
		protected Document.DocumentBuilder assignOutput(Document.DocumentBuilder harmonizedReport, CSATransactionReportTrade drrReport) {
			harmonizedReport
