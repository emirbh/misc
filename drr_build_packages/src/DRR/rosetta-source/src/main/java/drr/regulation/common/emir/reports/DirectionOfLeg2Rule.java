...
@ImplementedBy(DirectionOfLeg2Rule.DirectionOfLeg2RuleDefault.class)
public abstract class DirectionOfLeg2Rule implements ReportFunction<TransactionReportInstruction, Direction2Enum> {
	...
	*/
	...
	public static class DirectionOfLeg2RuleDefault extends DirectionOfLeg2Rule {
		@Override
