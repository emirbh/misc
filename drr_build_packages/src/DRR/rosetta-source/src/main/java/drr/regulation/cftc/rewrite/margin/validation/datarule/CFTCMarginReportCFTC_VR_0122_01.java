 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCMarginReportCFTC_VR_0122_01")
@ImplementedBy(CFTCMarginReportCFTC_VR_0122_01.Default.class)
public interface CFTCMarginReportCFTC_VR_0122_01 extends Validator<CFTCMarginReport> {
	
	String NAME = "CFTCMarginReportCFTC_VR_0122_01";
	String DEFINITION = "if [\"OWC2\", \"OWP2\", \"FLCL\"] any = collateralisationCategory to-string then initialMarginCollectedByCounterparty1PreHaircut exists else initialMarginCollectedByCounterparty1PreHaircut is absent";
	
	class Default implements CFTCMarginReportCFTC_VR_0122_01 {
	...
	class NoOp implements CFTCMarginReportCFTC_VR_0122_01 {
