...
public abstract class Create_TradeReport32Choice__1 implements RosettaFunction {
	...
	* @return rpt 
	*/
	public TradeReport32Choice__1 evaluate(FCAValuationReport drrReport) {
	...
	protected abstract TradeReport32Choice__1.TradeReport32Choice__1Builder doEvaluate(FCAValuationReport drrReport);

	protected abstract MapperS<ActionTypeEnum> actionType(FCAValuationReport drrReport);

	protected abstract MapperS<ReportLevelEnum> lvl(FCAValuationReport drrReport);

	public static class Create_TradeReport32Choice__1Default extends Create_TradeReport32Choice__1 {
		@Override
		protected TradeReport32Choice__1.TradeReport32Choice__1Builder doEvaluate(FCAValuationReport drrReport) {
			TradeReport32Choice__1.TradeReport32Choice__1Builder rpt = TradeReport32Choice__1.builder();
			return assignOutput(rpt, drrReport);
		}
		
		protected TradeReport32Choice__1.TradeReport32Choice__1Builder assignOutput(TradeReport32Choice__1.TradeReport32Choice__1Builder rpt, FCAValuationReport drrReport) {
		...
		@Override
		protected MapperS<ActionTypeEnum> actionType(FCAValuationReport drrReport) {
			return MapperS.of(drrReport).<ActionTypeEnum>map("getActionType", fCAValuationReport -> fCAValuationReport.getActionType());
		}
		
		@Override
		protected MapperS<ReportLevelEnum> lvl(FCAValuationReport drrReport) {
			return MapperS.of(drrReport).<ReportLevelEnum>map("getLevel", fCAValuationReport -> fCAValuationReport.getLevel());
		}
	}
}
