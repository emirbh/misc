...
public abstract class Create_CounterpartySpecificData36__2 implements RosettaFunction {
	...
	*/
	public CounterpartySpecificData36__2 evaluate(MASTransactionReport drrReport) {
	...
	protected abstract CounterpartySpecificData36__2.CounterpartySpecificData36__2Builder doEvaluate(MASTransactionReport drrReport);

	public static class Create_CounterpartySpecificData36__2Default extends Create_CounterpartySpecificData36__2 {
		@Override
		protected CounterpartySpecificData36__2.CounterpartySpecificData36__2Builder doEvaluate(MASTransactionReport drrReport) {
		...
		protected CounterpartySpecificData36__2.CounterpartySpecificData36__2Builder assignOutput(CounterpartySpecificData36__2.CounterpartySpecificData36__2Builder ctrPtySpcfcData, MASTransactionReport drrReport) {
			ctrPtySpcfcData = toBuilder(CounterpartySpecificData36__2.builder()
				...
				.setRptgTmStmp(MapperS.of(drrReport).<ZonedDateTime>map("getReportingTimestamp", mASTransactionReport -> mASTransactionReport.getReportingTimestamp()).get())
				.build());
