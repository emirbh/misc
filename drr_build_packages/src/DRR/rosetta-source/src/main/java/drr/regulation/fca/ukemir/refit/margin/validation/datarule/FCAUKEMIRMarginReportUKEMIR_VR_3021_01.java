 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3021_01")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3021_01.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3021_01 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3021_01";
	String DEFINITION = "if [CollateralisationType3Code -> OWC2, CollateralisationType3Code -> OWP2, CollateralisationType3Code -> FLCL] any = collateralisationCategory then initialMarginCollectedByCounterparty1PostHaircut exists";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3021_01 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRMarginReport fCAUKEMIRMarginReport) {
			try {
				if (areEqual(MapperC.<CollateralisationType3Code>of(MapperS.of(CollateralisationType3Code.OWC2), MapperS.of(CollateralisationType3Code.OWP2), MapperS.of(CollateralisationType3Code.FLCL)), MapperS.of(fCAUKEMIRMarginReport).<CollateralisationType3Code>map("getCollateralisationCategory", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getCollateralisationCategory()), CardinalityOperator.Any).getOrDefault(false)) {
					return exists(MapperS.of(fCAUKEMIRMarginReport).<BigDecimal>map("getInitialMarginCollectedByCounterparty1PostHaircut", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getInitialMarginCollectedByCounterparty1PostHaircut()));
				}
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3021_01 {
