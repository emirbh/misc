 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAValuationReportEMIR_VR_1002_02")
@ImplementedBy(ESMAValuationReportEMIR_VR_1002_02.Default.class)
public interface ESMAValuationReportEMIR_VR_1002_02 extends Validator<ESMAValuationReport> {
	
	String NAME = "ESMAValuationReportEMIR_VR_1002_02";
	String DEFINITION = "ReportSubmittingEntityID_02_Validation( nonReportable -> enrichment, reportSubmittingEntityID )";
	
	class Default implements ESMAValuationReportEMIR_VR_1002_02 {
	...
	class NoOp implements ESMAValuationReportEMIR_VR_1002_02 {
