...
public class ASICTransactionReportTypeFormatValidator implements Validator<ASICTransactionReport> {
	...
	private List<ComparisonResult> getComparisonResults(ASICTransactionReport o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkString("customBasketCode", o.getCustomBasketCode(), 1, of(72), of(Pattern.compile("[a-zA-Z0-9]{1,72}"))), 
				...
				checkString("underlyingIdentification", o.getUnderlyingIdentification(), 1, of(350), of(Pattern.compile(".{1,350}"))), 
