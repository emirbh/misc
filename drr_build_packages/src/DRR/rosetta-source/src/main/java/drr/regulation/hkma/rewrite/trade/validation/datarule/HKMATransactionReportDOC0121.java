 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0121")
@ImplementedBy(HKMATransactionReportDOC0121.Default.class)
public interface HKMATransactionReportDOC0121 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0121";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then if leg2 -> periodicPayment -> floatingRateReferencePeriodMultiplier exists then leg2 -> periodicPayment -> floatingRateReferencePeriod exists";
	
	class Default implements HKMATransactionReportDOC0121 {
	...
	class NoOp implements HKMATransactionReportDOC0121 {
