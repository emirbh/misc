 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3004_01")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3004_01.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3004_01 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3004_01";
	String DEFINITION = "API_GetLeiData(counterparty1) exists";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3004_01 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRMarginReport fCAUKEMIRMarginReport) {
			try {
				return exists(MapperS.of(aPI_GetLeiData.evaluate(MapperS.of(fCAUKEMIRMarginReport).<String>map("getCounterparty1", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getCounterparty1()).get())));
			}
			catch (Exception ex) {
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3004_01 {
