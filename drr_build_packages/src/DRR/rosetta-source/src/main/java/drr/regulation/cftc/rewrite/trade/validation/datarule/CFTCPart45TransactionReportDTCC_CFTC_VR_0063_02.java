 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart45TransactionReportDTCC_CFTC_VR_0063_02")
@ImplementedBy(CFTCPart45TransactionReportDTCC_CFTC_VR_0063_02.Default.class)
public interface CFTCPart45TransactionReportDTCC_CFTC_VR_0063_02 extends Validator<CFTCPart45TransactionReport> {
	
	String NAME = "CFTCPart45TransactionReportDTCC_CFTC_VR_0063_02";
	String DEFINITION = "if [upi.AnnaDsbAssetClassEnum -> Credit, upi.AnnaDsbAssetClassEnum -> Rates, upi.AnnaDsbAssetClassEnum -> Equity, upi.AnnaDsbAssetClassEnum -> Commodities] any = nonReportable -> postUpiData -> Header -> AssetClass or [AssetClassEnum -> Credit, AssetClassEnum -> InterestRate, AssetClassEnum -> Equity, AssetClassEnum -> Commodity] any = dtccAdditionalFields -> primaryAssetClass then (if leg2 -> periodicPayment -> fixedRatePaymentFrequencyPeriod = EXPI then leg2 -> periodicPayment -> fixedRatePaymentFrequencyPeriodMultiplier = 1)";
	
	class Default implements CFTCPart45TransactionReportDTCC_CFTC_VR_0063_02 {
	...
	class NoOp implements CFTCPart45TransactionReportDTCC_CFTC_VR_0063_02 {
