 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRMarginReportEMIR_VR_3004_01")
@ImplementedBy(ESMAEMIRMarginReportEMIR_VR_3004_01.Default.class)
public interface ESMAEMIRMarginReportEMIR_VR_3004_01 extends Validator<ESMAEMIRMarginReport> {
	
	String NAME = "ESMAEMIRMarginReportEMIR_VR_3004_01";
	String DEFINITION = "API_GetLeiData(counterparty1) exists";
	
	class Default implements ESMAEMIRMarginReportEMIR_VR_3004_01 {
		...
		private ComparisonResult executeDataRule(ESMAEMIRMarginReport eSMAEMIRMarginReport) {
			try {
				return exists(MapperS.of(aPI_GetLeiData.evaluate(MapperS.of(eSMAEMIRMarginReport).<String>map("getCounterparty1", _eSMAEMIRMarginReport -> _eSMAEMIRMarginReport.getCounterparty1()).get())));
			}
			catch (Exception ex) {
	...
	class NoOp implements ESMAEMIRMarginReportEMIR_VR_3004_01 {
