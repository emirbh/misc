...
import iso20022.auth030.mas.OrganisationIdentification38__1;
...
public abstract class Create_OrganisationIdentification15Choice__2 implements RosettaFunction {
	...
	* @return id 
	*/
	public OrganisationIdentification15Choice__2 evaluate(MASTransactionReport drrReport) {
	...
	protected abstract OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder doEvaluate(MASTransactionReport drrReport);
	...
	public static class Create_OrganisationIdentification15Choice__2Default extends Create_OrganisationIdentification15Choice__2 {
		@Override
		protected OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder doEvaluate(MASTransactionReport drrReport) {
		...
		protected OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder assignOutput(OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder id, MASTransactionReport drrReport) {
			...
			if (areEqual(MapperS.of(drrReport).<Boolean>map("getCounterparty2IdentifierType", mASTransactionReport -> mASTransactionReport.getCounterparty2IdentifierType()), MapperS.of(true), CardinalityOperator.All).getOrDefault(false)) {
				ifThenElseResult0 = MapperS.of(drrReport).<String>map("getCounterparty2", mASTransactionReport -> mASTransactionReport.getCounterparty2()).get();
			}
