 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0016")
@ImplementedBy(HKMAMarginReportDOC0016.Default.class)
public interface HKMAMarginReportDOC0016 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0016";
	String DEFINITION = "True";
	
	class Default implements HKMAMarginReportDOC0016 {
	...
	class NoOp implements HKMAMarginReportDOC0016 {
