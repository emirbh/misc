 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_18")
@ImplementedBy(CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_18.Default.class)
public interface CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_18 extends Validator<CFTCPart43TransactionReport> {
	
	String NAME = "CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_18";
	...
	class Default implements CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_18 {
	...
	class NoOp implements CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_18 {
