...
public class HKMATransactionReportValidator implements Validator<HKMATransactionReport> {
	...
	private List<ComparisonResult> getComparisonResults(HKMATransactionReport o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("cleared", (ClearedEnum) o.getCleared() != null ? 1 : 0, 1, 1), 
				...
				checkCardinality("assetClass", (CommonAssetClass) o.getAssetClass() != null ? 1 : 0, 1, 1), 
				...
				checkCardinality("productDescription", (String) o.getProductDescription() != null ? 1 : 0, 0, 1), 
				checkCardinality("beneficiary", (String) o.getBeneficiary() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks", (String) o.getRemarks() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks1", (String) o.getRemarks1() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks2", (String) o.getRemarks2() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks3", (String) o.getRemarks3() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks4", (String) o.getRemarks4() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks5", (String) o.getRemarks5() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks6", (String) o.getRemarks6() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks7", (String) o.getRemarks7() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks8", (String) o.getRemarks8() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks9", (String) o.getRemarks9() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks10", (String) o.getRemarks10() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks11", (String) o.getRemarks11() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks12", (String) o.getRemarks12() != null ? 1 : 0, 0, 1), 
				checkCardinality("remarks13", (String) o.getRemarks13() != null ? 1 : 0, 0, 1), 
				checkCardinality("uniqueProductIdentifierProprietary", (String) o.getUniqueProductIdentifierProprietary() != null ? 1 : 0, 0, 1), 
				...
				checkCardinality("centralCounterpartyIdentifierFormat", (PartyIdentifierFormat2Enum) o.getCentralCounterpartyIdentifierFormat() != null ? 1 : 0, 0, 1), 
				checkCardinality("centralCounterpartySchemeName", (HKTRPartyScheme) o.getCentralCounterpartySchemeName() != null ? 1 : 0, 0, 1), 
				checkCardinality("brokerIdentifierFormat", (PartyIdentifierFormat2Enum) o.getBrokerIdentifierFormat() != null ? 1 : 0, 0, 1), 
				checkCardinality("brokerSchemeName", (HKTRPartyScheme) o.getBrokerSchemeName() != null ? 1 : 0, 0, 1), 
				checkCardinality("referenceEntityFormat", (ReferenceEntityFormatEnum) o.getReferenceEntityFormat() != null ? 1 : 0, 0, 1), 
				checkCardinality("clearingMemberIdentifierFormat", (PartyIdentifierFormat2Enum) o.getClearingMemberIdentifierFormat() != null ? 1 : 0, 0, 1), 
				checkCardinality("clearingMemberSchemeName", (HKTRPartyScheme) o.getClearingMemberSchemeName() != null ? 1 : 0, 0, 1), 
				checkCardinality("priorUTIProprietarySchemeName", (UTIProprietarySchemeNameEnum) o.getPriorUTIProprietarySchemeName() != null ? 1 : 0, 0, 1), 
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("HKMATransactionReport", ValidationResult.ValidationType.CARDINALITY, "HKMATransactionReport", path, "", res.getError());
				}
				return success("HKMATransactionReport", ValidationResult.ValidationType.CARDINALITY, "HKMATransactionReport", path, "");
			})
			.collect(toList());
	}
