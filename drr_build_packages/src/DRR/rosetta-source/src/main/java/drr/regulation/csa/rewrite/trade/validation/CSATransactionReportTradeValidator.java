...
public class CSATransactionReportTradeValidator implements Validator<CSATransactionReportTrade> {

	private List<ComparisonResult> getComparisonResults(CSATransactionReportTrade o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("leg1", (CSALeg) o.getLeg1() != null ? 1 : 0, 0, 1), 
				checkCardinality("leg2", (CSALeg) o.getLeg2() != null ? 1 : 0, 0, 1), 
				...
				checkCardinality("clearingExceptionsAndExemptionsCounterparty1", (List<ClearingExceptionsAndExemptionsEnum>) o.getClearingExceptionsAndExemptionsCounterparty1() == null ? 0 : o.getClearingExceptionsAndExemptionsCounterparty1().size(), 0, 6), 
				checkCardinality("clearingExceptionsAndExemptionsCounterparty2", (List<ClearingExceptionsAndExemptionsEnum>) o.getClearingExceptionsAndExemptionsCounterparty2() == null ? 0 : o.getClearingExceptionsAndExemptionsCounterparty2().size(), 0, 6), 
				...
				checkCardinality("counterparty2IdentifierSource", (Counterparty2IdentifierEnum) o.getCounterparty2IdentifierSource() != null ? 1 : 0, 1, 1), 
				...
				checkCardinality("nonReportable", (CSANonReportable) o.getNonReportable() != null ? 1 : 0, 0, 1), 
				checkCardinality("countryAndProvinceOrTerritoryOfIndividual", (String) o.getCountryAndProvinceOrTerritoryOfIndividual() != null ? 1 : 0, 0, 1), 
				checkCardinality("jurisdictionOfCounterparty1", (List<String>) o.getJurisdictionOfCounterparty1() == null ? 0 : o.getJurisdictionOfCounterparty1().size(), 0, 13), 
				checkCardinality("jurisdictionOfCounterparty2", (List<String>) o.getJurisdictionOfCounterparty2() == null ? 0 : o.getJurisdictionOfCounterparty2().size(), 0, 13), 
				checkCardinality("interAffiliateIndicator", (Boolean) o.getInterAffiliateIndicator() != null ? 1 : 0, 0, 1), 
				checkCardinality("platformAnonymousExecutionIndicator", (Boolean) o.getPlatformAnonymousExecutionIndicator() != null ? 1 : 0, 0, 1), 
				checkCardinality("dtccAdditionalFields", (DTCCAdditionalFields) o.getDtccAdditionalFields() != null ? 1 : 0, 0, 1)
			);
	}

	@Override
	public List<ValidationResult<?>> getValidationResults(RosettaPath path, CSATransactionReportTrade o) {
		return getComparisonResults(o)
			.stream()
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CSATransactionReportTrade", ValidationResult.ValidationType.CARDINALITY, "CSATransactionReportTrade", path, "", res.getError());
				}
				return success("CSATransactionReportTrade", ValidationResult.ValidationType.CARDINALITY, "CSATransactionReportTrade", path, "");
			})
			.collect(toList());
	}
