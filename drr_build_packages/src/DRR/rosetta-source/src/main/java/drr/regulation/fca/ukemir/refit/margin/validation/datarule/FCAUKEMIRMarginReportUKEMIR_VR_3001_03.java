 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3001_03")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3001_03.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3001_03 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3001_03";
	String DEFINITION = "True";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3001_03 {
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3001_03 {
