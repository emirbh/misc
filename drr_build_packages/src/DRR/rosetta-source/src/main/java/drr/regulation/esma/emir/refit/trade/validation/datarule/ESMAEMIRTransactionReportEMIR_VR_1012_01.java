 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRTransactionReportEMIR_VR_1012_01")
@ImplementedBy(ESMAEMIRTransactionReportEMIR_VR_1012_01.Default.class)
public interface ESMAEMIRTransactionReportEMIR_VR_1012_01 extends Validator<ESMAEMIRTransactionReport> {
	
	String NAME = "ESMAEMIRTransactionReportEMIR_VR_1012_01";
	...
	class Default implements ESMAEMIRTransactionReportEMIR_VR_1012_01 {
		...
		private ComparisonResult executeDataRule(ESMAEMIRTransactionReport eSMAEMIRTransactionReport) {
			try {
				...
				if ((_boolean == null ? false : _boolean)) {
					if (areEqual(MapperS.of(eSMAEMIRTransactionReport).<NatureOfCounterpartyEnum>map("getNatureOfCounterparty2", _eSMAEMIRTransactionReport -> _eSMAEMIRTransactionReport.getNatureOfCounterparty2()), MapperS.of(NatureOfCounterpartyEnum.F), CardinalityOperator.All).andNullSafe(exists(MapperS.of(eSMAEMIRTransactionReport).<String>mapC("getCorporateSectorOfTheCounterparty2", _eSMAEMIRTransactionReport -> _eSMAEMIRTransactionReport.getCorporateSectorOfTheCounterparty2()))).getOrDefault(false)) {
	...
	class NoOp implements ESMAEMIRTransactionReportEMIR_VR_1012_01 {
