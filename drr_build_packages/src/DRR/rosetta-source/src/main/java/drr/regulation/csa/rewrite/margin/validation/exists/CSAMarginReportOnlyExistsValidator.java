package drr.regulation.csa.rewrite.margin.validation.exists;
...
public class CSAMarginReportOnlyExistsValidator implements ValidatorWithArg<CSAMarginReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CSAMarginReport> ValidationResult<CSAMarginReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CSAMarginReport", ValidationResult.ValidationType.ONLY_EXISTS, "CSAMarginReport", path, "");
		}
		return failure("CSAMarginReport", ValidationResult.ValidationType.ONLY_EXISTS, "CSAMarginReport", path, "",
