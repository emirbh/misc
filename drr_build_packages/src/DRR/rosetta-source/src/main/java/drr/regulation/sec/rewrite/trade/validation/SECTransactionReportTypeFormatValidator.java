...
public class SECTransactionReportTypeFormatValidator implements Validator<SECTransactionReport> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("SECTransactionReport", ValidationResult.ValidationType.TYPE_FORMAT, "SECTransactionReport", path, "", res.getError());
				}
				return success("SECTransactionReport", ValidationResult.ValidationType.TYPE_FORMAT, "SECTransactionReport", path, "");
			})
			.collect(toList());
	}
