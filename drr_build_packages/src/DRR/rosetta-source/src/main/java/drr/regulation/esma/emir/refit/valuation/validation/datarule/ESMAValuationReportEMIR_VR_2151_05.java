 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAValuationReportEMIR_VR_2151_05")
@ImplementedBy(ESMAValuationReportEMIR_VR_2151_05.Default.class)
public interface ESMAValuationReportEMIR_VR_2151_05 extends Validator<ESMAValuationReport> {
	
	String NAME = "ESMAValuationReportEMIR_VR_2151_05";
	String DEFINITION = "True";
	
	class Default implements ESMAValuationReportEMIR_VR_2151_05 {
	...
	class NoOp implements ESMAValuationReportEMIR_VR_2151_05 {
