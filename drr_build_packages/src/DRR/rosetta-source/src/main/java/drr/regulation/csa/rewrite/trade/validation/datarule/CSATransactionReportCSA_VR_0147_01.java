 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportCSA_VR_0147_01")
@ImplementedBy(CSATransactionReportCSA_VR_0147_01.Default.class)
public interface CSATransactionReportCSA_VR_0147_01 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportCSA_VR_0147_01";
	String DEFINITION = "if nonReportable -> postUpiData -> Header -> InstrumentType = Option or nonReportable -> instrumentType = Option then firstExerciseDate exists else firstExerciseDate is absent";
	
	class Default implements CSATransactionReportCSA_VR_0147_01 {
	...
	class NoOp implements CSATransactionReportCSA_VR_0147_01 {
