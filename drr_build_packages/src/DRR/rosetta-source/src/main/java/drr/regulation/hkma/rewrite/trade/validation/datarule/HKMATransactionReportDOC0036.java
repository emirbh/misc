 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0036")
@ImplementedBy(HKMATransactionReportDOC0036.Default.class)
public interface HKMATransactionReportDOC0036 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0036";
	...
	class Default implements HKMATransactionReportDOC0036 {
	...
	class NoOp implements HKMATransactionReportDOC0036 {
