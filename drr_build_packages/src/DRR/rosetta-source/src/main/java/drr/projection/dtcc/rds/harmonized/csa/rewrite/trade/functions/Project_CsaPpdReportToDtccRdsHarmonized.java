...
import drr.projection.dtcc.rds.harmonized.csa.rewrite.trade.labels.Project_CsaPpdReportToDtccRdsHarmonizedLabelProvider;
...
@RuneLabelProvider(labelProvider=Project_CsaPpdReportToDtccRdsHarmonizedLabelProvider.class)
@Projection(format = SerializationFormat.XML)
@ImplementedBy(Project_CsaPpdReportToDtccRdsHarmonized.Project_CsaPpdReportToDtccRdsHarmonizedDefault.class)
public abstract class Project_CsaPpdReportToDtccRdsHarmonized implements RosettaFunction {
	...
	*/
	public Document evaluate(CSATransactionReportPPD drrReport) {
	...
	protected abstract Document.DocumentBuilder doEvaluate(CSATransactionReportPPD drrReport);

	public static class Project_CsaPpdReportToDtccRdsHarmonizedDefault extends Project_CsaPpdReportToDtccRdsHarmonized {
		@Override
		protected Document.DocumentBuilder doEvaluate(CSATransactionReportPPD drrReport) {
			Document.DocumentBuilder harmonizedReport = Document.builder();
			return assignOutput(harmonizedReport, drrReport);
		}
		
		protected Document.DocumentBuilder assignOutput(Document.DocumentBuilder harmonizedReport, CSATransactionReportPPD drrReport) {
			harmonizedReport
