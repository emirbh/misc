 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_0017_02")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_0017_02.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_0017_02 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_0017_02";
	String DEFINITION = "if actionType = NEWT then priorUTI <> uniqueTransactionIdentifier";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_0017_02 {
		...
		private ComparisonResult executeDataRule(CSATransactionReport cSATransactionReport) {
			try {
				if (areEqual(MapperS.of(cSATransactionReport).<ActionTypeEnum>map("getActionType", _cSATransactionReport -> _cSATransactionReport.getActionType()), MapperS.of(ActionTypeEnum.NEWT), CardinalityOperator.All).getOrDefault(false)) {
					return notEqual(MapperS.of(cSATransactionReport).<String>map("getPriorUTI", _cSATransactionReport -> _cSATransactionReport.getPriorUTI()), MapperS.of(cSATransactionReport).<String>map("getUniqueTransactionIdentifier", _cSATransactionReport -> _cSATransactionReport.getUniqueTransactionIdentifier()), CardinalityOperator.Any);
				}
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_0017_02 {
