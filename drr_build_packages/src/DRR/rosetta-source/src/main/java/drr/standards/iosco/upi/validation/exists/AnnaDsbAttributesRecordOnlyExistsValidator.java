...
public class AnnaDsbAttributesRecordOnlyExistsValidator implements ValidatorWithArg<AnnaDsbAttributesRecord, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AnnaDsbAttributesRecord> ValidationResult<AnnaDsbAttributesRecord> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("OtherBaseProduct", ExistenceChecker.isSet((String) o.getOtherBaseProduct()))
		...
		if (setFields.equals(fields)) {
			return success("AnnaDsbAttributesRecord", ValidationResult.ValidationType.ONLY_EXISTS, "AnnaDsbAttributesRecord", path, "");
		}
		return failure("AnnaDsbAttributesRecord", ValidationResult.ValidationType.ONLY_EXISTS, "AnnaDsbAttributesRecord", path, "",
