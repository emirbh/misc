 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0028_04")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0028_04.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0028_04 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0028_04";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and assetClass <> CURR then (if (leg2 -> periodicPayment -> floatingRateIndicator exists or leg2 -> periodicPayment -> nameOfTheFloatingRate exists) and leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier exists then leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriod exists)";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0028_04 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0028_04 {
