 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3022_02")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3022_02.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3022_02 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3022_02";
	String DEFINITION = "[ISOCurrencyCodeEnum -> XAG, ISOCurrencyCodeEnum -> XAU, ISOCurrencyCodeEnum -> XBA, ISOCurrencyCodeEnum -> XBB, ISOCurrencyCodeEnum -> XBC, ISOCurrencyCodeEnum -> XBD, ISOCurrencyCodeEnum -> XDR, ISOCurrencyCodeEnum -> XPD, ISOCurrencyCodeEnum -> XPT, ISOCurrencyCodeEnum -> XXX] all <> initialMarginCollectedByCounterparty1Currency";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3022_02 {
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3022_02 {
