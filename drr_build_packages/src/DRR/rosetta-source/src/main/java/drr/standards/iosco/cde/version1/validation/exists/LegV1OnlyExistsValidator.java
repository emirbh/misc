...
public class LegV1OnlyExistsValidator implements ValidatorWithArg<LegV1, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LegV1> ValidationResult<LegV1> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LegV1", ValidationResult.ValidationType.ONLY_EXISTS, "LegV1", path, "");
		}
		return failure("LegV1", ValidationResult.ValidationType.ONLY_EXISTS, "LegV1", path, "",
