...
public abstract class Create_TradeTransaction50__5 implements RosettaFunction {
	...
	* @return txData 
	*/
	public TradeTransaction50__5 evaluate(MASValuationReport drrReport) {
	...
	protected abstract TradeTransaction50__5.TradeTransaction50__5Builder doEvaluate(MASValuationReport drrReport);

	public static class Create_TradeTransaction50__5Default extends Create_TradeTransaction50__5 {
		@Override
		protected TradeTransaction50__5.TradeTransaction50__5Builder doEvaluate(MASValuationReport drrReport) {
		...
		protected TradeTransaction50__5.TradeTransaction50__5Builder assignOutput(TradeTransaction50__5.TradeTransaction50__5Builder txData, MASValuationReport drrReport) {
			String ifThenElseResult = null;
			if (exists(MapperS.of(drrReport).<String>map("getUniqueTransactionIdentifierProprietary", mASValuationReport -> mASValuationReport.getUniqueTransactionIdentifierProprietary())).getOrDefault(false)) {
				ifThenElseResult = MapperS.of(drrReport).<String>map("getUniqueTransactionIdentifierProprietary", mASValuationReport -> mASValuationReport.getUniqueTransactionIdentifierProprietary()).get();
			}
