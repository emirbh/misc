 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0035")
@ImplementedBy(HKMATransactionReportDOC0035.Default.class)
public interface HKMATransactionReportDOC0035 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0035";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then if leg2 -> periodicPayment -> fixedRatePaymentFrequencyPeriod exists and leg2 -> periodicPayment -> fixedRatePaymentFrequencyPeriod = FrequencyPeriodEnum -> EXPI then leg2 -> periodicPayment -> fixedRatePaymentFrequencyPeriodMultiplier = 1";
	
	class Default implements HKMATransactionReportDOC0035 {
	...
	class NoOp implements HKMATransactionReportDOC0035 {
