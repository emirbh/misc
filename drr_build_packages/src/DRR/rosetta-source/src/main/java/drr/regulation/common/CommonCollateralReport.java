 ...
 * @version 7.7.0
 */
@RosettaDataType(value="CommonCollateralReport", builder=CommonCollateralReport.CommonCollateralReportBuilderImpl.class, version="7.7.0")
@RuneDataType(value="CommonCollateralReport", model="drr", builder=CommonCollateralReport.CommonCollateralReportBuilderImpl.class, version="7.7.0")
public interface CommonCollateralReport extends RosettaModelObject {
	...
	interface CommonCollateralReportBuilder extends CommonCollateralReport, RosettaModelObjectBuilder {
		...
		CommonCollateralReport.CommonCollateralReportBuilder setCollateralisationCategory(CollateralisationType3Code collateralisationCategory);
	...
	class CommonCollateralReportBuilderImpl implements CommonCollateralReport.CommonCollateralReportBuilder {
		...
		@RuneAttribute("collateralisationCategory")
		@Override
		public CommonCollateralReport.CommonCollateralReportBuilder setCollateralisationCategory(CollateralisationType3Code _collateralisationCategory) {
