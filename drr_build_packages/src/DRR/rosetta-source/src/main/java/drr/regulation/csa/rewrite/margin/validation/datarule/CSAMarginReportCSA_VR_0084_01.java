 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSAMarginReportCSA_VR_0084_01")
@ImplementedBy(CSAMarginReportCSA_VR_0084_01.Default.class)
public interface CSAMarginReportCSA_VR_0084_01 extends Validator<CSAMarginReport> {
	
	String NAME = "CSAMarginReportCSA_VR_0084_01";
	...
	class Default implements CSAMarginReportCSA_VR_0084_01 {
		...
		private ComparisonResult executeDataRule(CSAMarginReport cSAMarginReport) {
			try {
				if (areEqual(MapperC.<String>of(MapperS.of("OWC2"), MapperS.of("OWP2"), MapperS.of("FLCL")), MapperS.of(cSAMarginReport).<CollateralisationType3Code>map("getCollateralisationCategory", _cSAMarginReport -> _cSAMarginReport.getCollateralisationCategory()).map("to-string", CollateralisationType3Code::toDisplayString), CardinalityOperator.Any).getOrDefault(false)) {
					return exists(MapperS.of(cSAMarginReport).<BigDecimal>map("getInitialMarginCollectedByCounterparty1PreHaircut", _cSAMarginReport -> _cSAMarginReport.getInitialMarginCollectedByCounterparty1PreHaircut()));
				}
				return notExists(MapperS.of(cSAMarginReport).<BigDecimal>map("getInitialMarginCollectedByCounterparty1PreHaircut", _cSAMarginReport -> _cSAMarginReport.getInitialMarginCollectedByCounterparty1PreHaircut()));
			}
			catch (Exception ex) {
	...
	class NoOp implements CSAMarginReportCSA_VR_0084_01 {
