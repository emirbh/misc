...
import drr.projection.iso20022.jfsa.rewrite.trade.labels.Project_JFSARewriteTradeReportToIso20022LabelProvider;
...
@RuneLabelProvider(labelProvider=Project_JFSARewriteTradeReportToIso20022LabelProvider.class)
@Projection(format = SerializationFormat.XML)
@ImplementedBy(Project_JFSARewriteTradeReportToIso20022.Project_JFSARewriteTradeReportToIso20022Default.class)
public abstract class Project_JFSARewriteTradeReportToIso20022 implements RosettaFunction {
	...
	*/
	public Document evaluate(JFSATransactionReport drrReport) {
	...
	protected abstract Document.DocumentBuilder doEvaluate(JFSATransactionReport drrReport);

	public static class Project_JFSARewriteTradeReportToIso20022Default extends Project_JFSARewriteTradeReportToIso20022 {
		@Override
		protected Document.DocumentBuilder doEvaluate(JFSATransactionReport drrReport) {
			Document.DocumentBuilder iso20022Report = Document.builder();
			return assignOutput(iso20022Report, drrReport);
		}
		
		protected Document.DocumentBuilder assignOutput(Document.DocumentBuilder iso20022Report, JFSATransactionReport drrReport) {
			iso20022Report
