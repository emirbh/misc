...
public abstract class Create_TradeReport33Choice__1 implements RosettaFunction {
	...
	* @return rpt 
	*/
	public TradeReport33Choice__1 evaluate(ASICTransactionReport drrReport) {
	...
	protected abstract TradeReport33Choice__1.TradeReport33Choice__1Builder doEvaluate(ASICTransactionReport drrReport);

	protected abstract MapperS<ActionTypeEnum> actionType(ASICTransactionReport drrReport);

	public static class Create_TradeReport33Choice__1Default extends Create_TradeReport33Choice__1 {
		@Override
		protected TradeReport33Choice__1.TradeReport33Choice__1Builder doEvaluate(ASICTransactionReport drrReport) {
			TradeReport33Choice__1.TradeReport33Choice__1Builder rpt = TradeReport33Choice__1.builder();
			return assignOutput(rpt, drrReport);
		}
		
		protected TradeReport33Choice__1.TradeReport33Choice__1Builder assignOutput(TradeReport33Choice__1.TradeReport33Choice__1Builder rpt, ASICTransactionReport drrReport) {
		...
		@Override
		protected MapperS<ActionTypeEnum> actionType(ASICTransactionReport drrReport) {
			return MapperS.of(drrReport).<ActionTypeEnum>map("getActionType", aSICTransactionReport -> aSICTransactionReport.getActionType());
		}
	}
}
