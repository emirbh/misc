 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCValuationReportDTCC_CFTC_VR_DTCC_03")
@ImplementedBy(CFTCValuationReportDTCC_CFTC_VR_DTCC_03.Default.class)
public interface CFTCValuationReportDTCC_CFTC_VR_DTCC_03 extends Validator<CFTCValuationReport> {
	
	String NAME = "CFTCValuationReportDTCC_CFTC_VR_DTCC_03";
	...
	class Default implements CFTCValuationReportDTCC_CFTC_VR_DTCC_03 {
		...
		private ComparisonResult executeDataRule(CFTCValuationReport cFTCValuationReport) {
			try {
				if (exists(MapperS.of(cFTCValuationReport).<DTCCAdditionalValuationFields>map("getDtccValuationFields", _cFTCValuationReport -> _cFTCValuationReport.getDtccValuationFields()).<PartyIdentifierTypeEnum>map("getTradeParty2ExecutionAgentIDType", dTCCAdditionalValuationFields -> dTCCAdditionalValuationFields.getTradeParty2ExecutionAgentIDType())).getOrDefault(false)) {
					return exists(MapperS.of(cFTCValuationReport).<DTCCAdditionalValuationFields>map("getDtccValuationFields", _cFTCValuationReport -> _cFTCValuationReport.getDtccValuationFields()).<String>map("getTradeParty2ExecutionAgentID", dTCCAdditionalValuationFields -> dTCCAdditionalValuationFields.getTradeParty2ExecutionAgentID()));
				}
	...
	class NoOp implements CFTCValuationReportDTCC_CFTC_VR_DTCC_03 {
