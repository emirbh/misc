 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRTransactionReportEMIR_VR_2126_01")
@ImplementedBy(ESMAEMIRTransactionReportEMIR_VR_2126_01.Default.class)
public interface ESMAEMIRTransactionReportEMIR_VR_2126_01 extends Validator<ESMAEMIRTransactionReport> {
	
	String NAME = "ESMAEMIRTransactionReportEMIR_VR_2126_01";
	...
	class Default implements ESMAEMIRTransactionReportEMIR_VR_2126_01 {
	...
	class NoOp implements ESMAEMIRTransactionReportEMIR_VR_2126_01 {
