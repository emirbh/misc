...
@ImplementedBy(IsInterestRateCrossCurrencyBasis.IsInterestRateCrossCurrencyBasisDefault.class)
public abstract class IsInterestRateCrossCurrencyBasis implements RosettaFunction {
	...
	*/
	...
	public static class IsInterestRateCrossCurrencyBasisDefault extends IsInterestRateCrossCurrencyBasis {
		@Override
