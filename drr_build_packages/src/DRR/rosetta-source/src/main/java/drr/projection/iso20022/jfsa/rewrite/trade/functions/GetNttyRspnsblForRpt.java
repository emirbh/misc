...
public abstract class GetNttyRspnsblForRpt implements RosettaFunction {
	...
	*/
	public OrganisationIdentification15Choice__1 evaluate(JFSATransactionReport drrReport) {
	...
	protected abstract OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder doEvaluate(JFSATransactionReport drrReport);

	public static class GetNttyRspnsblForRptDefault extends GetNttyRspnsblForRpt {
		@Override
		protected OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder doEvaluate(JFSATransactionReport drrReport) {
		...
		protected OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder assignOutput(OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder nttyRspnsblForRpt, JFSATransactionReport drrReport) {
			nttyRspnsblForRpt = toBuilder(create_OrganisationIdentification15Choice__1.evaluate(MapperS.of(drrReport).<String>map("getEntityResponsibleForReporting", jFSATransactionReport -> jFSATransactionReport.getEntityResponsibleForReporting()).get()));
