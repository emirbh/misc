...
import iso20022.auth108.hkma.dtcc.Counterparty45__1;
import iso20022.auth108.hkma.dtcc.Counterparty46__1;
import iso20022.auth108.hkma.dtcc.GenericIdentification175__1;
...
import iso20022.auth108.hkma.dtcc.LegalPersonIdentification1__2;
import iso20022.auth108.hkma.dtcc.NaturalPersonIdentification2__1;
import iso20022.auth108.hkma.dtcc.NaturalPersonIdentification3__1;
import iso20022.auth108.hkma.dtcc.OrganisationIdentification15Choice__1;
...
import iso20022.auth108.hkma.dtcc.PartyIdentification248Choice__2;
		...
		protected TradeCounterpartyReport20__1.TradeCounterpartyReport20__1Builder assignOutput(TradeCounterpartyReport20__1.TradeCounterpartyReport20__1Builder ctrPtySpcfcData, HKMAMarginReport marginReport) {
			...
			ctrPtySpcfcData = toBuilder(TradeCounterpartyReport20__1.builder()
				...
				.setNttyRspnsblForRpt(OrganisationIdentification15Choice__1.builder()
					...
					.build())
				.setExctnAgt(Collections.<OrganisationIdentification15Choice__1>emptyList())
				.build());
