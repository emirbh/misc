...
public class FCAUKEMIRTransactionReportValidator implements Validator<FCAUKEMIRTransactionReport> {
	...
	private List<ComparisonResult> getComparisonResults(FCAUKEMIRTransactionReport o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("cryptoAssetUnderlyingIndicator", (Boolean) o.getCryptoAssetUnderlyingIndicator() != null ? 1 : 0, 1, 1), 
				...
				checkCardinality("natureOfCounterparty1", (NatureOfCounterpartyEnum) o.getNatureOfCounterparty1() != null ? 1 : 0, 1, 1), 
				...
				checkCardinality("contractType", (CommonContractType) o.getContractType() != null ? 1 : 0, 1, 1), 
				...
				checkCardinality("masterAgreementType", (MasterAgreementEnum) o.getMasterAgreementType() != null ? 1 : 0, 1, 1), 
				...
				checkCardinality("nonReportable", (FCAUKEMIRNonReportable) o.getNonReportable() != null ? 1 : 0, 0, 1), 
				...
				checkCardinality("clearingObligation", (ClearingObligationEnum) o.getClearingObligation() != null ? 1 : 0, 0, 1), 
				checkCardinality("ptrr", (Boolean) o.getPtrr() != null ? 1 : 0, 0, 1), 
				checkCardinality("typeOfPTRRTechnique", (RiskReductionTechniqueEnum) o.getTypeOfPTRRTechnique() != null ? 1 : 0, 0, 1), 
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FCAUKEMIRTransactionReport", ValidationResult.ValidationType.CARDINALITY, "FCAUKEMIRTransactionReport", path, "", res.getError());
				}
				return success("FCAUKEMIRTransactionReport", ValidationResult.ValidationType.CARDINALITY, "FCAUKEMIRTransactionReport", path, "");
			})
			.collect(toList());
	}
