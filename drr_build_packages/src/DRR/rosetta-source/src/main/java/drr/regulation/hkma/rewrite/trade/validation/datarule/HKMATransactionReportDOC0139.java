 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0139")
@ImplementedBy(HKMATransactionReportDOC0139.Default.class)
public interface HKMATransactionReportDOC0139 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0139";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0139 {
	...
	class NoOp implements HKMATransactionReportDOC0139 {
