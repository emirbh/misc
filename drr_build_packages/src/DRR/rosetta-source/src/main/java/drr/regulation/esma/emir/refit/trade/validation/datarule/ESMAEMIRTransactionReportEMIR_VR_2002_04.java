 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRTransactionReportEMIR_VR_2002_04")
@ImplementedBy(ESMAEMIRTransactionReportEMIR_VR_2002_04.Default.class)
public interface ESMAEMIRTransactionReportEMIR_VR_2002_04 extends Validator<ESMAEMIRTransactionReport> {
	
	String NAME = "ESMAEMIRTransactionReportEMIR_VR_2002_04";
	String DEFINITION = "if IsVRAllowedForActionType(actionType) then if level = PSTN then reportTrackingNumber is absent";
	
	class Default implements ESMAEMIRTransactionReportEMIR_VR_2002_04 {
	...
	class NoOp implements ESMAEMIRTransactionReportEMIR_VR_2002_04 {
