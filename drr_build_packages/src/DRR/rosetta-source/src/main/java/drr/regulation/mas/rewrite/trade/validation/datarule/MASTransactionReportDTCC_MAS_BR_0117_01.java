 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0117_01")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0117_01.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0117_01 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0117_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and leg2 -> periodicPayment -> floatingRateResetFrequencyMultiplier exists then leg2 -> periodicPayment -> floatingRateResetFrequencyPeriod exists";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0117_01 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0117_01 {
