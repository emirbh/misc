...
public class CFTCPart45LegOnlyExistsValidator implements ValidatorWithArg<CFTCPart45Leg, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CFTCPart45Leg> ValidationResult<CFTCPart45Leg> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("payerIdentifierFormat", ExistenceChecker.isSet((PartyIdentifierFormatEnum) o.getPayerIdentifierFormat()))
				.put("receiverIdentifierFormat", ExistenceChecker.isSet((PartyIdentifierFormatEnum) o.getReceiverIdentifierFormat()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CFTCPart45Leg", ValidationResult.ValidationType.ONLY_EXISTS, "CFTCPart45Leg", path, "");
		}
		return failure("CFTCPart45Leg", ValidationResult.ValidationType.ONLY_EXISTS, "CFTCPart45Leg", path, "",
