...
public class CommonDTCCAdditionalFieldsOnlyExistsValidator implements ValidatorWithArg<CommonDTCCAdditionalFields, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CommonDTCCAdditionalFields> ValidationResult<CommonDTCCAdditionalFields> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CommonDTCCAdditionalFields", ValidationResult.ValidationType.ONLY_EXISTS, "CommonDTCCAdditionalFields", path, "");
		}
		return failure("CommonDTCCAdditionalFields", ValidationResult.ValidationType.ONLY_EXISTS, "CommonDTCCAdditionalFields", path, "",
