...
public interface ESMAEMIRTransactionReportEMIR_VR_2061_01 extends Validator<ESMAEMIRTransactionReport> {
	...
	String DEFINITION = "if IsVRAllowedForActionType(actionType) and leg1 -> notionalQuantitySchedule exists then (leg1 -> notionalQuantitySchedule extract (if value exists then effectiveDate exists else effectiveDate is absent) then all = True)";
