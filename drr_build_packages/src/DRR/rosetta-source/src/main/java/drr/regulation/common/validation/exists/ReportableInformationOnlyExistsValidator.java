...
public class ReportableInformationOnlyExistsValidator implements ValidatorWithArg<ReportableInformation, Set<String>> {
	...
	public <T2 extends ReportableInformation> ValidationResult<ReportableInformation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("jurisdictionInformation", ExistenceChecker.isSet((List<? extends ReportableJurisdictionInformation>) o.getJurisdictionInformation()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ReportableInformation", ValidationResult.ValidationType.ONLY_EXISTS, "ReportableInformation", path, "");
		}
		return failure("ReportableInformation", ValidationResult.ValidationType.ONLY_EXISTS, "ReportableInformation", path, "",
