...
public abstract class DTCC_Leg1CommodityInstrumentIDRule implements ReportFunction<TransactionReportInstruction, String> {
	...
	//
	@Inject protected drr.regulation.common.dtcc.trade.reports.DTCC_Leg1CommodityInstrumentIDRule dTCC_Leg1CommodityInstrumentIDRule;
	...
	public static class DTCC_Leg1CommodityInstrumentIDRuleDefault extends DTCC_Leg1CommodityInstrumentIDRule {
		...
		protected String assignOutput(String output, TransactionReportInstruction input) {
			...
			if (areEqual(MapperS.of(isCSALeg1Aligned.evaluate(thenArg.get())), MapperS.of(true), CardinalityOperator.All).getOrDefault(false)) {
				final String string0 = dTCC_Leg1CommodityInstrumentIDRule.evaluate(thenArg.get());
				...
				final String string1 = dTCC_Leg2CommodityInstrumentIDRule.evaluate(thenArg.get());
