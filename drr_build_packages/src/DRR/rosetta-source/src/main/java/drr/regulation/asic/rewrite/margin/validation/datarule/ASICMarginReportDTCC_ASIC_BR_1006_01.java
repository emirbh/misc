 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICMarginReportDTCC_ASIC_BR_1006_01")
@ImplementedBy(ASICMarginReportDTCC_ASIC_BR_1006_01.Default.class)
public interface ASICMarginReportDTCC_ASIC_BR_1006_01 extends Validator<ASICMarginReport> {
	
	String NAME = "ASICMarginReportDTCC_ASIC_BR_1006_01";
	String DEFINITION = "trade.party.Counterparty_Validation( actionType to-enum ActionTypeEnum, counterparty1, counterparty2 )";
	
	class Default implements ASICMarginReportDTCC_ASIC_BR_1006_01 {
	...
	class NoOp implements ASICMarginReportDTCC_ASIC_BR_1006_01 {
