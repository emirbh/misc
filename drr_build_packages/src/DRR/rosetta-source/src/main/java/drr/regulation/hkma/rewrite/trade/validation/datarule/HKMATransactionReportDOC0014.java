 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0014")
@ImplementedBy(HKMATransactionReportDOC0014.Default.class)
public interface HKMATransactionReportDOC0014 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0014";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0014 {
	...
	class NoOp implements HKMATransactionReportDOC0014 {
