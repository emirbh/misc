 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRTransactionReportEMIR_VR_2078_01")
@ImplementedBy(ESMAEMIRTransactionReportEMIR_VR_2078_01.Default.class)
public interface ESMAEMIRTransactionReportEMIR_VR_2078_01 extends Validator<ESMAEMIRTransactionReport> {
	
	String NAME = "ESMAEMIRTransactionReportEMIR_VR_2078_01";
	String DEFINITION = "if (IsVRAllowedForActionType(actionType) or actionType = ActionTypeEnum -> TERM) and otherPayment exists then (otherPayment extract (if paymentType exists then if receiverFormat = PartyIdentifierFormatEnum -> Lei then GetOrFetchLeiData(empty, receiver) -> lei exists else receiver exists else receiver is absent) then all = True)";
	
	class Default implements ESMAEMIRTransactionReportEMIR_VR_2078_01 {
	...
	class NoOp implements ESMAEMIRTransactionReportEMIR_VR_2078_01 {
