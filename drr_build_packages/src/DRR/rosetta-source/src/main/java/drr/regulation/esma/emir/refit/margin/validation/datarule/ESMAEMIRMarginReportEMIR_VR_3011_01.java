 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRMarginReportEMIR_VR_3011_01")
@ImplementedBy(ESMAEMIRMarginReportEMIR_VR_3011_01.Default.class)
public interface ESMAEMIRMarginReportEMIR_VR_3011_01 extends Validator<ESMAEMIRMarginReport> {
	
	String NAME = "ESMAEMIRMarginReportEMIR_VR_3011_01";
	String DEFINITION = "if collateralisationCategory exists then True";
	
	class Default implements ESMAEMIRMarginReportEMIR_VR_3011_01 {
		...
		private ComparisonResult executeDataRule(ESMAEMIRMarginReport eSMAEMIRMarginReport) {
			try {
				if (exists(MapperS.of(eSMAEMIRMarginReport).<CollateralisationType3Code>map("getCollateralisationCategory", _eSMAEMIRMarginReport -> _eSMAEMIRMarginReport.getCollateralisationCategory())).getOrDefault(false)) {
	...
	class NoOp implements ESMAEMIRMarginReportEMIR_VR_3011_01 {
