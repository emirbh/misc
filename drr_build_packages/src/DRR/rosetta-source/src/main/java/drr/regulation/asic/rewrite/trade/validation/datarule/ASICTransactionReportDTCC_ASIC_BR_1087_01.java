 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICTransactionReportDTCC_ASIC_BR_1087_01")
@ImplementedBy(ASICTransactionReportDTCC_ASIC_BR_1087_01.Default.class)
public interface ASICTransactionReportDTCC_ASIC_BR_1087_01 extends Validator<ASICTransactionReport> {
	
	String NAME = "ASICTransactionReportDTCC_ASIC_BR_1087_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and [CommonAssetClass -> CRDT, CommonAssetClass -> EQUI, CommonAssetClass -> COMM] any = assetClass then if leg2 -> periodicPayment -> floatingRateIndicator exists then leg2 -> periodicPayment -> floatingRateReferencePeriod exists";
	
	class Default implements ASICTransactionReportDTCC_ASIC_BR_1087_01 {
	...
	class NoOp implements ASICTransactionReportDTCC_ASIC_BR_1087_01 {
