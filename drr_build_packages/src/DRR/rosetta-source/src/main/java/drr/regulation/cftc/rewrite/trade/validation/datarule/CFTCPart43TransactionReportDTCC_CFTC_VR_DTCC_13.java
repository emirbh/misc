 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_13")
@ImplementedBy(CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_13.Default.class)
public interface CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_13 extends Validator<CFTCPart43TransactionReport> {
	
	String NAME = "CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_13";
	String DEFINITION = "True";
	
	class Default implements CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_13 {
	...
	class NoOp implements CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_13 {
