 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart43TransactionReportEffectiveDateOfTheNotionalAmountCondition")
@ImplementedBy(CFTCPart43TransactionReportEffectiveDateOfTheNotionalAmountCondition.Default.class)
public interface CFTCPart43TransactionReportEffectiveDateOfTheNotionalAmountCondition extends Validator<CFTCPart43TransactionReport> {
	
	String NAME = "CFTCPart43TransactionReportEffectiveDateOfTheNotionalAmountCondition";
	String DEFINITION = "leg1 -> notionalAmountSchedule -> effectiveDate count <= 10 and leg2 -> notionalAmountSchedule -> effectiveDate count <= 10";
	
	class Default implements CFTCPart43TransactionReportEffectiveDateOfTheNotionalAmountCondition {
	...
	class NoOp implements CFTCPart43TransactionReportEffectiveDateOfTheNotionalAmountCondition {
