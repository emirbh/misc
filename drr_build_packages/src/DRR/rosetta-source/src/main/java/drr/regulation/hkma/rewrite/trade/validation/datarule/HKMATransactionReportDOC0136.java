 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0136")
@ImplementedBy(HKMATransactionReportDOC0136.Default.class)
public interface HKMATransactionReportDOC0136 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0136";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0136 {
	...
	class NoOp implements HKMATransactionReportDOC0136 {
