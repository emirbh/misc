 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0100_01")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0100_01.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0100_01 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0100_01";
	String DEFINITION = "if [CommonAssetClass -> EQUI, CommonAssetClass -> COMM, CommonAssetClass -> INTR] any = assetClass and [CommonContractType -> CFDS, CommonContractType -> FORW, CommonContractType -> SWAP, CommonContractType -> OTHR] any = contractType then common.price.PriceScheduleCount_Validation(actionType, priceSchedule)";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0100_01 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0100_01 {
