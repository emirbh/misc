 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart43TransactionReportUniqueTransactionIdentifierCondition")
@ImplementedBy(CFTCPart43TransactionReportUniqueTransactionIdentifierCondition.Default.class)
public interface CFTCPart43TransactionReportUniqueTransactionIdentifierCondition extends Validator<CFTCPart43TransactionReport> {
	
	String NAME = "CFTCPart43TransactionReportUniqueTransactionIdentifierCondition";
	...
	class Default implements CFTCPart43TransactionReportUniqueTransactionIdentifierCondition {
		...
		private ComparisonResult executeDataRule(CFTCPart43TransactionReport cFTCPart43TransactionReport) {
			try {
				if (notExists(MapperS.of(cFTCPart43TransactionReport).<String>map("getUniqueSwapIdentifier", _cFTCPart43TransactionReport -> _cFTCPart43TransactionReport.getUniqueSwapIdentifier())).getOrDefault(false)) {
				...
				return notExists(MapperS.of(cFTCPart43TransactionReport).<String>map("getUniqueTransactionIdentifier", _cFTCPart43TransactionReport -> _cFTCPart43TransactionReport.getUniqueTransactionIdentifier()));
			}
			catch (Exception ex) {
	...
	class NoOp implements CFTCPart43TransactionReportUniqueTransactionIdentifierCondition {
