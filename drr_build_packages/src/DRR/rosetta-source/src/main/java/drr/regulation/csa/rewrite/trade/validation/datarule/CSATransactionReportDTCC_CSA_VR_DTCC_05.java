 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_DTCC_05")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_DTCC_05.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_DTCC_05 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_DTCC_05";
	String DEFINITION = "True";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_DTCC_05 {
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_DTCC_05 {
