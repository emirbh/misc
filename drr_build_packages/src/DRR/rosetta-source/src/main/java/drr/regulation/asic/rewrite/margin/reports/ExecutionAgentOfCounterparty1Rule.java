...
@ImplementedBy(ExecutionAgentOfCounterparty1Rule.ExecutionAgentOfCounterparty1RuleDefault.class)
public abstract class ExecutionAgentOfCounterparty1Rule implements ReportFunction<CollateralReportInstruction, String> {
	...
	*/
	...
	public static class ExecutionAgentOfCounterparty1RuleDefault extends ExecutionAgentOfCounterparty1Rule {
		@Override
