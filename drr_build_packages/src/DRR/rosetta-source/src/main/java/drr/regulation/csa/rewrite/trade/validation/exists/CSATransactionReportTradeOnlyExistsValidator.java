...
public class CSATransactionReportTradeOnlyExistsValidator implements ValidatorWithArg<CSATransactionReportTrade, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CSATransactionReportTrade> ValidationResult<CSATransactionReportTrade> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("leg1", ExistenceChecker.isSet((CSALeg) o.getLeg1()))
				.put("leg2", ExistenceChecker.isSet((CSALeg) o.getLeg2()))
		...
		if (setFields.equals(fields)) {
			return success("CSATransactionReportTrade", ValidationResult.ValidationType.ONLY_EXISTS, "CSATransactionReportTrade", path, "");
		}
		return failure("CSATransactionReportTrade", ValidationResult.ValidationType.ONLY_EXISTS, "CSATransactionReportTrade", path, "",
