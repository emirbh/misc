 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_0143_04")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_0143_04.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_0143_04 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_0143_04";
	String DEFINITION = "if [AnnaDsbAssetClassEnum -> Credit, AnnaDsbAssetClassEnum -> Rates, AnnaDsbAssetClassEnum -> Equity, AnnaDsbAssetClassEnum -> Commodities] any = nonReportable -> postUpiData -> Header -> AssetClass or [AssetClassEnum -> Credit, AssetClassEnum -> InterestRate, AssetClassEnum -> Equity, AssetClassEnum -> Commodity] any = dtccAdditionalFields -> primaryAssetClass then (if leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriod exists and leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriod <> ADHO then leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier exists else leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier is absent)";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_0143_04 {
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_0143_04 {
