 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAValuationReportDOC0114")
@ImplementedBy(HKMAValuationReportDOC0114.Default.class)
public interface HKMAValuationReportDOC0114 extends Validator<HKMAValuationReport> {
	
	String NAME = "HKMAValuationReportDOC0114";
	String DEFINITION = "True";
	
	class Default implements HKMAValuationReportDOC0114 {
	...
	class NoOp implements HKMAValuationReportDOC0114 {
