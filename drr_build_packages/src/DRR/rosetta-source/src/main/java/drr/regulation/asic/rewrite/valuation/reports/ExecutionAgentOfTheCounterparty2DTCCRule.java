...
@ImplementedBy(ExecutionAgentOfTheCounterparty2DTCCRule.ExecutionAgentOfTheCounterparty2DTCCRuleDefault.class)
public abstract class ExecutionAgentOfTheCounterparty2DTCCRule implements ReportFunction<ValuationReportInstruction, String> {
	...
	*/
	...
	public static class ExecutionAgentOfTheCounterparty2DTCCRuleDefault extends ExecutionAgentOfTheCounterparty2DTCCRule {
		@Override
