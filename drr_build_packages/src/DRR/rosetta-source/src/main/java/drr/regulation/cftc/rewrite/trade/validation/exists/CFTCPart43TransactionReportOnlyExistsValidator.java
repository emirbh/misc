...
public class CFTCPart43TransactionReportOnlyExistsValidator implements ValidatorWithArg<CFTCPart43TransactionReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CFTCPart43TransactionReport> ValidationResult<CFTCPart43TransactionReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("nonReportable", ExistenceChecker.isSet((CFTCNonReportablePart43) o.getNonReportable()))
		...
		if (setFields.equals(fields)) {
			return success("CFTCPart43TransactionReport", ValidationResult.ValidationType.ONLY_EXISTS, "CFTCPart43TransactionReport", path, "");
		}
		return failure("CFTCPart43TransactionReport", ValidationResult.ValidationType.ONLY_EXISTS, "CFTCPart43TransactionReport", path, "",
