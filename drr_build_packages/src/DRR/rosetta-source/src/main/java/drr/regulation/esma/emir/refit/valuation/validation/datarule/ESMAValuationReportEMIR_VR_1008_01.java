 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAValuationReportEMIR_VR_1008_01")
@ImplementedBy(ESMAValuationReportEMIR_VR_1008_01.Default.class)
public interface ESMAValuationReportEMIR_VR_1008_01 extends Validator<ESMAValuationReport> {
	
	String NAME = "ESMAValuationReportEMIR_VR_1008_01";
	String DEFINITION = "Counterparty2IdentifierType_01_Validation(counterparty2IdentifierType)";
	
	class Default implements ESMAValuationReportEMIR_VR_1008_01 {
		...
		private ComparisonResult executeDataRule(ESMAValuationReport eSMAValuationReport) {
			try {
				return ComparisonResult.ofNullSafe(MapperS.of(counterparty2IdentifierType_01_Validation.evaluate(MapperS.of(eSMAValuationReport).<Boolean>map("getCounterparty2IdentifierType", _eSMAValuationReport -> _eSMAValuationReport.getCounterparty2IdentifierType()).get())));
			}
			catch (Exception ex) {
	...
	class NoOp implements ESMAValuationReportEMIR_VR_1008_01 {
