 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRTransactionReportEMIR_VR_1016_04")
@ImplementedBy(ESMAEMIRTransactionReportEMIR_VR_1016_04.Default.class)
public interface ESMAEMIRTransactionReportEMIR_VR_1016_04 extends Validator<ESMAEMIRTransactionReport> {
	
	String NAME = "ESMAEMIRTransactionReportEMIR_VR_1016_04";
	String DEFINITION = "if IsVRAllowedForActionType(actionType) then if GetOrFetchLeiData(nonReportable -> enrichment -> leiData, clearingMember) exists then GetOrFetchLeiData(nonReportable -> enrichment -> leiData, clearingMember) -> entityCategory <> LeiCategoryEnum -> Branch";
	
	class Default implements ESMAEMIRTransactionReportEMIR_VR_1016_04 {
	...
	class NoOp implements ESMAEMIRTransactionReportEMIR_VR_1016_04 {
