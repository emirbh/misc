 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRMarginReportEMIR_VR_3028_01")
@ImplementedBy(ESMAEMIRMarginReportEMIR_VR_3028_01.Default.class)
public interface ESMAEMIRMarginReportEMIR_VR_3028_01 extends Validator<ESMAEMIRMarginReport> {
	
	String NAME = "ESMAEMIRMarginReportEMIR_VR_3028_01";
	String DEFINITION = "if actionType exists then True";
	
	class Default implements ESMAEMIRMarginReportEMIR_VR_3028_01 {
		...
		private ComparisonResult executeDataRule(ESMAEMIRMarginReport eSMAEMIRMarginReport) {
			try {
				if (exists(MapperS.of(eSMAEMIRMarginReport).<MarginActionEnum>map("getActionType", _eSMAEMIRMarginReport -> _eSMAEMIRMarginReport.getActionType())).getOrDefault(false)) {
	...
	class NoOp implements ESMAEMIRMarginReportEMIR_VR_3028_01 {
