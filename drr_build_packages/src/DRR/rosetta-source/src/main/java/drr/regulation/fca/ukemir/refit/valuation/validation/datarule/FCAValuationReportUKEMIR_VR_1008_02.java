 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAValuationReportUKEMIR_VR_1008_02")
@ImplementedBy(FCAValuationReportUKEMIR_VR_1008_02.Default.class)
public interface FCAValuationReportUKEMIR_VR_1008_02 extends Validator<FCAValuationReport> {
	
	String NAME = "FCAValuationReportUKEMIR_VR_1008_02";
	String DEFINITION = "True";
	
	class Default implements FCAValuationReportUKEMIR_VR_1008_02 {
	...
	class NoOp implements FCAValuationReportUKEMIR_VR_1008_02 {
