 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAValuationReportUKEMIR_VR_1004_01")
@ImplementedBy(FCAValuationReportUKEMIR_VR_1004_01.Default.class)
public interface FCAValuationReportUKEMIR_VR_1004_01 extends Validator<FCAValuationReport> {
	
	String NAME = "FCAValuationReportUKEMIR_VR_1004_01";
	String DEFINITION = "Counterparty1_01_Validation(nonReportable -> enrichment, counterparty1)";
	
	class Default implements FCAValuationReportUKEMIR_VR_1004_01 {
	...
	class NoOp implements FCAValuationReportUKEMIR_VR_1004_01 {
