 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0034")
@ImplementedBy(HKMATransactionReportDOC0034.Default.class)
public interface HKMATransactionReportDOC0034 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0034";
	...
	class Default implements HKMATransactionReportDOC0034 {
	...
	class NoOp implements HKMATransactionReportDOC0034 {
