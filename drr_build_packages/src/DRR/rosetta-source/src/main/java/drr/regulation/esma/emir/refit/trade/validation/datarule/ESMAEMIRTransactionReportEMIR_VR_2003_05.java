...
public interface ESMAEMIRTransactionReportEMIR_VR_2003_05 extends Validator<ESMAEMIRTransactionReport> {
	...
	String DEFINITION = "if IsVRAllowedForActionType(actionType) then [uniqueTransactionIdentifier, uniqueTransactionIdentifierProprietary, reportTrackingNumber, subsequentPositionUTI] all <> priorUTI and [uniqueTransactionIdentifier, uniqueTransactionIdentifierProprietary, reportTrackingNumber, subsequentPositionUTI] all <> priorUTIProprietary";
