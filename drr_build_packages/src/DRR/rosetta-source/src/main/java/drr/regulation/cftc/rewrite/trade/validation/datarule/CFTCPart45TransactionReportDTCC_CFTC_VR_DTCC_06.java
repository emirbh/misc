 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart45TransactionReportDTCC_CFTC_VR_DTCC_06")
@ImplementedBy(CFTCPart45TransactionReportDTCC_CFTC_VR_DTCC_06.Default.class)
public interface CFTCPart45TransactionReportDTCC_CFTC_VR_DTCC_06 extends Validator<CFTCPart45TransactionReport> {
	
	String NAME = "CFTCPart45TransactionReportDTCC_CFTC_VR_DTCC_06";
	...
	class Default implements CFTCPart45TransactionReportDTCC_CFTC_VR_DTCC_06 {
	...
	class NoOp implements CFTCPart45TransactionReportDTCC_CFTC_VR_DTCC_06 {
