...
public abstract class InitialMarginPostedByReportingCounterpartyPostHaircut implements RosettaFunction {
	...
	//
	@Inject protected drr.standards.iosco.cde.version2.collateral.functions.InitialMarginPostedByReportingCounterpartyPostHaircut initialMarginPostedByReportingCounterpartyPostHaircut;
