...
import drr.regulation.csa.rewrite.trade.validation.CSATransactionReportPPDTypeFormatValidator;
import drr.regulation.csa.rewrite.trade.validation.CSATransactionReportPPDValidator;
...
import drr.regulation.csa.rewrite.trade.validation.exists.CSATransactionReportPPDOnlyExistsValidator;
 ...
 * @version 7.7.0
 */
@RosettaMeta(model=CSATransactionReportPPD.class)
public class CSATransactionReportPPDMeta implements RosettaMetaData<CSATransactionReportPPD> {

	@Override
	public List<Validator<? super CSATransactionReportPPD>> dataRules(ValidatorFactory factory) {
	...
	@Override
	public List<Function<? super CSATransactionReportPPD, QualifyResult>> getQualifyFunctions(QualifyFunctionFactory factory) {
		return Collections.emptyList();
	}
	
	@Override
	public Validator<? super CSATransactionReportPPD> validator(ValidatorFactory factory) {
		return factory.<CSATransactionReportPPD>create(CSATransactionReportPPDValidator.class);
	}

	@Override
	public Validator<? super CSATransactionReportPPD> typeFormatValidator(ValidatorFactory factory) {
		return factory.<CSATransactionReportPPD>create(CSATransactionReportPPDTypeFormatValidator.class);
	}

	@Deprecated
	@Override
	public Validator<? super CSATransactionReportPPD> validator() {
		return new CSATransactionReportPPDValidator();
	}

	@Deprecated
	@Override
	public Validator<? super CSATransactionReportPPD> typeFormatValidator() {
		return new CSATransactionReportPPDTypeFormatValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CSATransactionReportPPD, Set<String>> onlyExistsValidator() {
		return new CSATransactionReportPPDOnlyExistsValidator();
	}
}
