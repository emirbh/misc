 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0010")
@ImplementedBy(HKMATransactionReportDOC0010.Default.class)
public interface HKMATransactionReportDOC0010 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0010";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0010 {
	...
	class NoOp implements HKMATransactionReportDOC0010 {
