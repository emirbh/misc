 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportDTCC_SEC_VR_Counterparty2IdentifierSource")
@ImplementedBy(SECTransactionReportDTCC_SEC_VR_Counterparty2IdentifierSource.Default.class)
public interface SECTransactionReportDTCC_SEC_VR_Counterparty2IdentifierSource extends Validator<SECTransactionReport> {
	
	String NAME = "SECTransactionReportDTCC_SEC_VR_Counterparty2IdentifierSource";
	String DEFINITION = "True";
	
	class Default implements SECTransactionReportDTCC_SEC_VR_Counterparty2IdentifierSource {
	...
	class NoOp implements SECTransactionReportDTCC_SEC_VR_Counterparty2IdentifierSource {
