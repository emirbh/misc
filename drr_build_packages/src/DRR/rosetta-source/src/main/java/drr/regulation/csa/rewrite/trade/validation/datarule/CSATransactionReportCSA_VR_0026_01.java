 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportCSA_VR_0026_01")
@ImplementedBy(CSATransactionReportCSA_VR_0026_01.Default.class)
public interface CSATransactionReportCSA_VR_0026_01 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportCSA_VR_0026_01";
	String DEFINITION = "if (nonReportable -> postUpiData -> Header -> AssetClass = Foreign_Exchange or dtccAdditionalFields -> primaryAssetClass = ForeignExchange) and (nonReportable -> postUpiData -> Header -> InstrumentType = Option or nonReportable -> instrumentType = Option) then (leg1 -> notionalAmount exists and [callAmount, putAmount] any = leg1 -> notionalAmount) else if [AnnaDsbAssetClassEnum -> Credit, AnnaDsbAssetClassEnum -> Foreign_Exchange, AnnaDsbAssetClassEnum -> Equity, AnnaDsbAssetClassEnum -> Commodities] any = nonReportable -> postUpiData -> Header -> AssetClass or [AssetClassEnum -> Credit, AssetClassEnum -> ForeignExchange, AssetClassEnum -> Equity, AssetClassEnum -> Commodity] any = dtccAdditionalFields -> primaryAssetClass then leg1 -> notionalAmount exists";
	
	class Default implements CSATransactionReportCSA_VR_0026_01 {
	...
	class NoOp implements CSATransactionReportCSA_VR_0026_01 {
