...
public abstract class GetDerivEvt1 implements RosettaFunction {
	...
	* @return derivEvt 
	*/
	public DerivativeEvent6__1 evaluate(ASICTransactionReport drrReport) {
	...
	protected abstract DerivativeEvent6__1.DerivativeEvent6__1Builder doEvaluate(ASICTransactionReport drrReport);

	public static class GetDerivEvt1Default extends GetDerivEvt1 {
		@Override
		protected DerivativeEvent6__1.DerivativeEvent6__1Builder doEvaluate(ASICTransactionReport drrReport) {
		...
		protected DerivativeEvent6__1.DerivativeEvent6__1Builder assignOutput(DerivativeEvent6__1.DerivativeEvent6__1Builder derivEvt, ASICTransactionReport drrReport) {
