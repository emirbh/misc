 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0140")
@ImplementedBy(HKMAMarginReportDOC0140.Default.class)
public interface HKMAMarginReportDOC0140 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0140";
	String DEFINITION = "True";
	
	class Default implements HKMAMarginReportDOC0140 {
	...
	class NoOp implements HKMAMarginReportDOC0140 {
