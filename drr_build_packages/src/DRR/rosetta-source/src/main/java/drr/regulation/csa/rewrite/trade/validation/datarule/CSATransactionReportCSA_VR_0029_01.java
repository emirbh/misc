 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportCSA_VR_0029_01")
@ImplementedBy(CSATransactionReportCSA_VR_0029_01.Default.class)
public interface CSATransactionReportCSA_VR_0029_01 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportCSA_VR_0029_01";
	String DEFINITION = "if (nonReportable -> postUpiData -> Header -> AssetClass = Foreign_Exchange or dtccAdditionalFields -> primaryAssetClass = ForeignExchange) and callAmount exists then callCurrency exists else callCurrency is absent";
	
	class Default implements CSATransactionReportCSA_VR_0029_01 {
	...
	class NoOp implements CSATransactionReportCSA_VR_0029_01 {
