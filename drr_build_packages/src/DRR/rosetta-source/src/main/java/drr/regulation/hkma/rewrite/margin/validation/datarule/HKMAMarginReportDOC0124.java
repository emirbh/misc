 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0124")
@ImplementedBy(HKMAMarginReportDOC0124.Default.class)
public interface HKMAMarginReportDOC0124 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0124";
	String DEFINITION = "True";
	
	class Default implements HKMAMarginReportDOC0124 {
	...
	class NoOp implements HKMAMarginReportDOC0124 {
