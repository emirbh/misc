 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportDTCC_SEC_VR_Counterparty2")
@ImplementedBy(SECTransactionReportDTCC_SEC_VR_Counterparty2.Default.class)
public interface SECTransactionReportDTCC_SEC_VR_Counterparty2 extends Validator<SECTransactionReport> {
	
	String NAME = "SECTransactionReportDTCC_SEC_VR_Counterparty2";
	String DEFINITION = "True";
	
	class Default implements SECTransactionReportDTCC_SEC_VR_Counterparty2 {
	...
	class NoOp implements SECTransactionReportDTCC_SEC_VR_Counterparty2 {
