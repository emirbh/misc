...
public class CFTCTransactionReportTypeFormatValidator implements Validator<CFTCTransactionReport> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CFTCTransactionReport", ValidationResult.ValidationType.TYPE_FORMAT, "CFTCTransactionReport", path, "", res.getError());
				}
				return success("CFTCTransactionReport", ValidationResult.ValidationType.TYPE_FORMAT, "CFTCTransactionReport", path, "");
			})
			.collect(toList());
	}
