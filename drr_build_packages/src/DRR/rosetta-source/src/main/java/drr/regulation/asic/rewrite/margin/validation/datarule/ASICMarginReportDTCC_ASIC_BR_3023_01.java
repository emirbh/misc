 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICMarginReportDTCC_ASIC_BR_3023_01")
@ImplementedBy(ASICMarginReportDTCC_ASIC_BR_3023_01.Default.class)
public interface ASICMarginReportDTCC_ASIC_BR_3023_01 extends Validator<ASICMarginReport> {
	
	String NAME = "ASICMarginReportDTCC_ASIC_BR_3023_01";
	String DEFINITION = "if actionType = MarginActionEnum -> MARU or actionType = MarginActionEnum -> CORR then if variationMarginCollectedByTheCounterparty1PreHaircut exists then True";
	
	class Default implements ASICMarginReportDTCC_ASIC_BR_3023_01 {
	...
	class NoOp implements ASICMarginReportDTCC_ASIC_BR_3023_01 {
