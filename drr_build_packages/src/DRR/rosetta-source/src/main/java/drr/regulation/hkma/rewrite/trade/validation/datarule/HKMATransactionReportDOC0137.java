 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0137")
@ImplementedBy(HKMATransactionReportDOC0137.Default.class)
public interface HKMATransactionReportDOC0137 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0137";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0137 {
	...
	class NoOp implements HKMATransactionReportDOC0137 {
