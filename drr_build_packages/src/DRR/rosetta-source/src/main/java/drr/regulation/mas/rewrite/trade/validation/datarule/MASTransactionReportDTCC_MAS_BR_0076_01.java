 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0076_01")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0076_01.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0076_01 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0076_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and [CommonAssetClass -> INTR, CommonAssetClass -> CRDT, CommonAssetClass -> EQUI, CommonAssetClass -> CURR] any = assetClass then (leg1 -> notionalAmount exists and leg1 -> notionalAmount >= 0) or leg1 -> notionalAmount = 9999999999999999999999999";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0076_01 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0076_01 {
