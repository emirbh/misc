...
public abstract class VariationMarginPostedByReportingCounterpartyCurrency implements RosettaFunction {
	...
	//
	@Inject protected drr.standards.iosco.cde.version1.collateral.functions.VariationMarginPostedByReportingCounterpartyCurrency variationMarginPostedByReportingCounterpartyCurrency;
