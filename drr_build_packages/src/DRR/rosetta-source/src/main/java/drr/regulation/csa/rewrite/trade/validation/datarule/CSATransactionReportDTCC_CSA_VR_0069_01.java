 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_0069_01")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_0069_01.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_0069_01 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_0069_01";
	String DEFINITION = "if leg1 -> periodicPayment -> fixedRatePaymentFrequencyPeriod exists then leg1 -> periodicPayment -> fixedRateDayCountConvention exists else leg1 -> periodicPayment -> fixedRateDayCountConvention is absent";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_0069_01 {
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_0069_01 {
