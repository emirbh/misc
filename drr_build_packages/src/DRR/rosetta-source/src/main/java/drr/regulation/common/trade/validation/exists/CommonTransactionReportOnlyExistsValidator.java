...
public class CommonTransactionReportOnlyExistsValidator implements ValidatorWithArg<CommonTransactionReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CommonTransactionReport> ValidationResult<CommonTransactionReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CommonTransactionReport", ValidationResult.ValidationType.ONLY_EXISTS, "CommonTransactionReport", path, "");
		}
		return failure("CommonTransactionReport", ValidationResult.ValidationType.ONLY_EXISTS, "CommonTransactionReport", path, "",
