...
public class SECTransactionReportPPDTypeFormatValidator implements Validator<SECTransactionReportPPD> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("SECTransactionReportPPD", ValidationResult.ValidationType.TYPE_FORMAT, "SECTransactionReportPPD", path, "", res.getError());
				}
				return success("SECTransactionReportPPD", ValidationResult.ValidationType.TYPE_FORMAT, "SECTransactionReportPPD", path, "");
			})
			.collect(toList());
	}
