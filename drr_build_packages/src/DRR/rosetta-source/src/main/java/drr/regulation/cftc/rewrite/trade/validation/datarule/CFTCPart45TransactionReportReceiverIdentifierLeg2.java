...
public interface CFTCPart45TransactionReportReceiverIdentifierLeg2 extends Validator<CFTCPart45TransactionReport> {
	...
	String DEFINITION = "cftc.ValidatePartyIdentifierFormat( leg2 -> receiverIdentifier, leg2 -> receiverIdentifierFormat )";
	...
	class Default implements CFTCPart45TransactionReportReceiverIdentifierLeg2 {
		...
		private ComparisonResult executeDataRule(CFTCPart45TransactionReport cFTCPart45TransactionReport) {
			try {
				return ComparisonResult.ofNullSafe(MapperS.of(validatePartyIdentifierFormat.evaluate(MapperS.of(cFTCPart45TransactionReport).<CFTCPart45Leg>map("getLeg2", _cFTCPart45TransactionReport -> _cFTCPart45TransactionReport.getLeg2()).<String>map("getReceiverIdentifier", cFTCPart45Leg -> cFTCPart45Leg.getReceiverIdentifier()).get(), MapperS.of(cFTCPart45TransactionReport).<CFTCPart45Leg>map("getLeg2", _cFTCPart45TransactionReport -> _cFTCPart45TransactionReport.getLeg2()).<PartyIdentifierFormatEnum>map("getReceiverIdentifierFormat", cFTCPart45Leg -> cFTCPart45Leg.getReceiverIdentifierFormat()).get())));
			}
			catch (Exception ex) {
