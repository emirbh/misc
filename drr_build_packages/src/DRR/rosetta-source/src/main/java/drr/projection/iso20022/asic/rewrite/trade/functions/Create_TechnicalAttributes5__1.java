...
public abstract class Create_TechnicalAttributes5__1 implements RosettaFunction {
	...
	* @return techAttrbts 
	*/
	public TechnicalAttributes5__1 evaluate(ASICTransactionReport drrReport) {
	...
	protected abstract TechnicalAttributes5__1.TechnicalAttributes5__1Builder doEvaluate(ASICTransactionReport drrReport);

	public static class Create_TechnicalAttributes5__1Default extends Create_TechnicalAttributes5__1 {
		@Override
		protected TechnicalAttributes5__1.TechnicalAttributes5__1Builder doEvaluate(ASICTransactionReport drrReport) {
		...
		protected TechnicalAttributes5__1.TechnicalAttributes5__1Builder assignOutput(TechnicalAttributes5__1.TechnicalAttributes5__1Builder techAttrbts, ASICTransactionReport drrReport) {
			techAttrbts = toBuilder(TechnicalAttributes5__1.builder()
				.setTechRcrdId(MapperS.of(drrReport).<String>map("getTechnicalRecordId", aSICTransactionReport -> aSICTransactionReport.getTechnicalRecordId()).get())
				.setRptRctTmStmp(MapperS.of(drrReport).<ZonedDateTime>map("getReportingTimestamp", aSICTransactionReport -> aSICTransactionReport.getReportingTimestamp()).get())
				.build());
