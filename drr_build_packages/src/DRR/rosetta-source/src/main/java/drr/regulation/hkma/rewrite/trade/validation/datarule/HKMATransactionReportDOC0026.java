 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0026")
@ImplementedBy(HKMATransactionReportDOC0026.Default.class)
public interface HKMATransactionReportDOC0026 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0026";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then if leg1 -> periodicPayment -> fixedRatePaymentFrequencyPeriodMultiplier exists then leg1 -> periodicPayment -> fixedRatePaymentFrequencyPeriod exists";
	
	class Default implements HKMATransactionReportDOC0026 {
	...
	class NoOp implements HKMATransactionReportDOC0026 {
