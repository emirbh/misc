 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0119")
@ImplementedBy(HKMATransactionReportDOC0119.Default.class)
public interface HKMATransactionReportDOC0119 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0119";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then if leg1 -> periodicPayment -> floatingRateReferencePeriodMultiplier exists then leg1 -> periodicPayment -> floatingRateReferencePeriod exists";
	
	class Default implements HKMATransactionReportDOC0119 {
	...
	class NoOp implements HKMATransactionReportDOC0119 {
