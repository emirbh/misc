 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAValuationReportEMIR_VR_2001_03")
@ImplementedBy(ESMAValuationReportEMIR_VR_2001_03.Default.class)
public interface ESMAValuationReportEMIR_VR_2001_03 extends Validator<ESMAValuationReport> {
	
	String NAME = "ESMAValuationReportEMIR_VR_2001_03";
	String DEFINITION = "True";
	
	class Default implements ESMAValuationReportEMIR_VR_2001_03 {
	...
	class NoOp implements ESMAValuationReportEMIR_VR_2001_03 {
