...
import drr.regulation.sec.rewrite.trade.validation.SECTransactionReportPPDTypeFormatValidator;
import drr.regulation.sec.rewrite.trade.validation.SECTransactionReportPPDValidator;
...
import drr.regulation.sec.rewrite.trade.validation.exists.SECTransactionReportPPDOnlyExistsValidator;
 ...
 * @version 7.7.0
 */
@RosettaMeta(model=SECTransactionReportPPD.class)
public class SECTransactionReportPPDMeta implements RosettaMetaData<SECTransactionReportPPD> {

	@Override
	public List<Validator<? super SECTransactionReportPPD>> dataRules(ValidatorFactory factory) {
	...
	@Override
	public List<Function<? super SECTransactionReportPPD, QualifyResult>> getQualifyFunctions(QualifyFunctionFactory factory) {
		return Collections.emptyList();
	}
	
	@Override
	public Validator<? super SECTransactionReportPPD> validator(ValidatorFactory factory) {
		return factory.<SECTransactionReportPPD>create(SECTransactionReportPPDValidator.class);
	}

	@Override
	public Validator<? super SECTransactionReportPPD> typeFormatValidator(ValidatorFactory factory) {
		return factory.<SECTransactionReportPPD>create(SECTransactionReportPPDTypeFormatValidator.class);
	}

	@Deprecated
	@Override
	public Validator<? super SECTransactionReportPPD> validator() {
		return new SECTransactionReportPPDValidator();
	}

	@Deprecated
	@Override
	public Validator<? super SECTransactionReportPPD> typeFormatValidator() {
		return new SECTransactionReportPPDTypeFormatValidator();
	}
	
	@Override
	public ValidatorWithArg<? super SECTransactionReportPPD, Set<String>> onlyExistsValidator() {
		return new SECTransactionReportPPDOnlyExistsValidator();
	}
}
