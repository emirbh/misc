...
public abstract class Create_PartyIdentification248Choice__3 implements RosettaFunction {
	...
	* @return id 
	*/
	public PartyIdentification248Choice__3 evaluate(MASTransactionReport drrReport) {
	...
	protected abstract PartyIdentification248Choice__3.PartyIdentification248Choice__3Builder doEvaluate(MASTransactionReport drrReport);

	public static class Create_PartyIdentification248Choice__3Default extends Create_PartyIdentification248Choice__3 {
		@Override
		protected PartyIdentification248Choice__3.PartyIdentification248Choice__3Builder doEvaluate(MASTransactionReport drrReport) {
		...
		protected PartyIdentification248Choice__3.PartyIdentification248Choice__3Builder assignOutput(PartyIdentification248Choice__3.PartyIdentification248Choice__3Builder id, MASTransactionReport drrReport) {
			...
			if (areEqual(MapperS.of(drrReport).<Boolean>map("getCounterparty2IdentifierType", mASTransactionReport -> mASTransactionReport.getCounterparty2IdentifierType()), MapperS.of(true), CardinalityOperator.All).getOrDefault(false)) {
				ifThenElseResult0 = LegalPersonIdentification1__3.builder()
					.setId(create_OrganisationIdentification15Choice__3.evaluate(MapperS.of(drrReport).<Boolean>map("getCounterparty2IdentifierType", mASTransactionReport -> mASTransactionReport.getCounterparty2IdentifierType()).get(), MapperS.of(drrReport).<String>map("getCounterparty2", mASTransactionReport -> mASTransactionReport.getCounterparty2()).get()))
					.build();
			}
