 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSAMarginReportCSA_VR_0092_01")
@ImplementedBy(CSAMarginReportCSA_VR_0092_01.Default.class)
public interface CSAMarginReportCSA_VR_0092_01 extends Validator<CSAMarginReport> {
	
	String NAME = "CSAMarginReportCSA_VR_0092_01";
	...
	class Default implements CSAMarginReportCSA_VR_0092_01 {
		...
		private ComparisonResult executeDataRule(CSAMarginReport cSAMarginReport) {
			try {
				if (exists(MapperS.of(cSAMarginReport).<BigDecimal>map("getVariationMarginCollectedByTheCounterparty1PreHaircut", _cSAMarginReport -> _cSAMarginReport.getVariationMarginCollectedByTheCounterparty1PreHaircut())).getOrDefault(false)) {
	...
	class NoOp implements CSAMarginReportCSA_VR_0092_01 {
