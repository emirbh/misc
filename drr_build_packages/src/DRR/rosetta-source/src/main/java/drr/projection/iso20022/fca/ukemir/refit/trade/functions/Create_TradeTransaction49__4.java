...
public abstract class Create_TradeTransaction49__4 implements RosettaFunction {
	...
	* @return txData 
	*/
	public TradeTransaction49__4 evaluate(FCAUKEMIRTransactionReport drrReport) {
	...
	protected abstract TradeTransaction49__4.TradeTransaction49__4Builder doEvaluate(FCAUKEMIRTransactionReport drrReport);

	public static class Create_TradeTransaction49__4Default extends Create_TradeTransaction49__4 {
		@Override
		protected TradeTransaction49__4.TradeTransaction49__4Builder doEvaluate(FCAUKEMIRTransactionReport drrReport) {
		...
		protected TradeTransaction49__4.TradeTransaction49__4Builder assignOutput(TradeTransaction49__4.TradeTransaction49__4Builder txData, FCAUKEMIRTransactionReport drrReport) {
