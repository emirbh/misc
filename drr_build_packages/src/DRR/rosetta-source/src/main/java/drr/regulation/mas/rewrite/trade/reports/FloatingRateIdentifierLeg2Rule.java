...
@ImplementedBy(FloatingRateIdentifierLeg2Rule.FloatingRateIdentifierLeg2RuleDefault.class)
public abstract class FloatingRateIdentifierLeg2Rule implements ReportFunction<TransactionReportInstruction, String> {
	...
	*/
	...
	public static class FloatingRateIdentifierLeg2RuleDefault extends FloatingRateIdentifierLeg2Rule {
		@Override
		...
		protected String assignOutput(String output, TransactionReportInstruction input) {
			...
			final String string = floatingRateIdentifierRule.evaluate(thenArg2.get());
