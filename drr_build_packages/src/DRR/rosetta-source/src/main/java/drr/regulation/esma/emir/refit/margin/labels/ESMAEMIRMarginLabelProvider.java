package drr.regulation.esma.emir.refit.margin.labels;
...
public class ESMAEMIRMarginLabelProvider extends GraphBasedLabelProvider {
	public ESMAEMIRMarginLabelProvider() {
		super(new LabelNode());
