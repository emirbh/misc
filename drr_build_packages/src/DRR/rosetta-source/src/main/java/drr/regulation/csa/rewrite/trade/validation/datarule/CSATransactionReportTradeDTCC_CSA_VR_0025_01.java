 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportTradeDTCC_CSA_VR_0025_01")
@ImplementedBy(CSATransactionReportTradeDTCC_CSA_VR_0025_01.Default.class)
public interface CSATransactionReportTradeDTCC_CSA_VR_0025_01 extends Validator<CSATransactionReportTrade> {
	
	String NAME = "CSATransactionReportTradeDTCC_CSA_VR_0025_01";
	String DEFINITION = "if masterAgreementType is absent then masterAgreementVersion is absent";
	
	class Default implements CSATransactionReportTradeDTCC_CSA_VR_0025_01 {
		...
		private ComparisonResult executeDataRule(CSATransactionReportTrade cSATransactionReportTrade) {
			try {
				if (notExists(MapperS.of(cSATransactionReportTrade).<MasterAgreementEnum>map("getMasterAgreementType", _cSATransactionReportTrade -> _cSATransactionReportTrade.getMasterAgreementType())).getOrDefault(false)) {
	...
	class NoOp implements CSATransactionReportTradeDTCC_CSA_VR_0025_01 {
