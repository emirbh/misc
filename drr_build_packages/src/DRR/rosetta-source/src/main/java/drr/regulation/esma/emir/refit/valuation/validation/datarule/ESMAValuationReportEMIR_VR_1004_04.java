 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAValuationReportEMIR_VR_1004_04")
@ImplementedBy(ESMAValuationReportEMIR_VR_1004_04.Default.class)
public interface ESMAValuationReportEMIR_VR_1004_04 extends Validator<ESMAValuationReport> {
	
	String NAME = "ESMAValuationReportEMIR_VR_1004_04";
	String DEFINITION = "Counterparty1_04_Validation(nonReportable -> enrichment, counterparty1)";
	
	class Default implements ESMAValuationReportEMIR_VR_1004_04 {
	...
	class NoOp implements ESMAValuationReportEMIR_VR_1004_04 {
