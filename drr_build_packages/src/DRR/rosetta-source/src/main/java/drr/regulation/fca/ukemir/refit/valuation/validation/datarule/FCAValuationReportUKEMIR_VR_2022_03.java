 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAValuationReportUKEMIR_VR_2022_03")
@ImplementedBy(FCAValuationReportUKEMIR_VR_2022_03.Default.class)
public interface FCAValuationReportUKEMIR_VR_2022_03 extends Validator<FCAValuationReport> {
	
	String NAME = "FCAValuationReportUKEMIR_VR_2022_03";
	String DEFINITION = "ValuationCurrency_03_Validation(valuationAmount, valuationCurrency)";
	
	class Default implements FCAValuationReportUKEMIR_VR_2022_03 {
	...
	class NoOp implements FCAValuationReportUKEMIR_VR_2022_03 {
