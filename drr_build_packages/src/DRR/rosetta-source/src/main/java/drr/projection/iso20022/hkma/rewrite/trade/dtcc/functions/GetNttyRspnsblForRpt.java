...
import iso20022.auth030.hkma.dtcc.OrganisationIdentification15Choice__1;
...
public abstract class GetNttyRspnsblForRpt implements RosettaFunction {
	...
	*/
	public OrganisationIdentification15Choice__1 evaluate(HKMATransactionReport drrReport) {
	...
	protected abstract OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder doEvaluate(HKMATransactionReport drrReport);

	public static class GetNttyRspnsblForRptDefault extends GetNttyRspnsblForRpt {
		@Override
		protected OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder doEvaluate(HKMATransactionReport drrReport) {
		...
		protected OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder assignOutput(OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder nttyRspnsblForRpt, HKMATransactionReport drrReport) {
			nttyRspnsblForRpt = toBuilder(create_OrganisationIdentification15Choice__1.evaluate(MapperS.of(drrReport).<String>map("getEntityResponsibleForReporting", hKMATransactionReport -> hKMATransactionReport.getEntityResponsibleForReporting()).get()));
