...
import drr.regulation.hkma.rewrite.trade.meta.NotionalQuantityScheduleLeg1ReportMeta;
...
public interface NotionalQuantityScheduleLeg1Report extends RosettaModelObject {
	...
	interface NotionalQuantityScheduleLeg1ReportBuilder extends NotionalQuantityScheduleLeg1Report, RosettaModelObjectBuilder {
		...
		NotionalQuantityScheduleLeg1Report.NotionalQuantityScheduleLeg1ReportBuilder setQuantity(BigDecimal quantity);
	...
	class NotionalQuantityScheduleLeg1ReportBuilderImpl implements NotionalQuantityScheduleLeg1Report.NotionalQuantityScheduleLeg1ReportBuilder {
		...
		@RuneAttribute("quantity")
		@Override
		public NotionalQuantityScheduleLeg1Report.NotionalQuantityScheduleLeg1ReportBuilder setQuantity(BigDecimal _quantity) {
