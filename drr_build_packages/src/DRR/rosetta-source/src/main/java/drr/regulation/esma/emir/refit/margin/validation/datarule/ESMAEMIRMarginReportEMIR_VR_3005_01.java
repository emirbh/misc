 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRMarginReportEMIR_VR_3005_01")
@ImplementedBy(ESMAEMIRMarginReportEMIR_VR_3005_01.Default.class)
public interface ESMAEMIRMarginReportEMIR_VR_3005_01 extends Validator<ESMAEMIRMarginReport> {
	
	String NAME = "ESMAEMIRMarginReportEMIR_VR_3005_01";
	String DEFINITION = "if counterparty2IdentifierType exists then True";
	
	class Default implements ESMAEMIRMarginReportEMIR_VR_3005_01 {
		...
		private ComparisonResult executeDataRule(ESMAEMIRMarginReport eSMAEMIRMarginReport) {
			try {
				if (exists(MapperS.of(eSMAEMIRMarginReport).<Boolean>map("getCounterparty2IdentifierType", _eSMAEMIRMarginReport -> _eSMAEMIRMarginReport.getCounterparty2IdentifierType())).getOrDefault(false)) {
	...
	class NoOp implements ESMAEMIRMarginReportEMIR_VR_3005_01 {
