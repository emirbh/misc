					...
					.mapSingleToItem(item -> {
						...
						return MapperS.of(SecuritiesTransactionPrice17Choice__1.builder()
							.setMntryVal(AmountAndDirection106__1.builder()
								...
								.build())
							.setDcml(MapperS.of(drrReport).<PriceFormat>map("getPackageTransactionPrice", jFSATransactionReport -> jFSATransactionReport.getPackageTransactionPrice()).<BigDecimal>map("getDecimal", priceFormat -> priceFormat.getDecimal()).get())
							.build());
					}).get())
					...
					.mapSingleToItem(item -> {
						...
						return MapperS.of(SecuritiesTransactionPrice20Choice__1.builder()
							.setMntryVal(AmountAndDirection106__1.builder()
								...
								.setSgn(ifThenElseResult)
								.build())
							.setDcml(MapperS.of(drrReport).<PriceFormat>map("getPackageTransactionSpread", jFSATransactionReport -> jFSATransactionReport.getPackageTransactionSpread()).<BigDecimal>map("getDecimal", priceFormat -> priceFormat.getDecimal()).get())
