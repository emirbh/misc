 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3029_02")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3029_02.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3029_02 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3029_02";
	String DEFINITION = "CompareDateTo(eventDate, 2014, 2, 12) >= 0";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3029_02 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRMarginReport fCAUKEMIRMarginReport) {
			try {
				return greaterThanEquals(MapperS.of(compareDateTo.evaluate(MapperS.of(fCAUKEMIRMarginReport).<Date>map("getEventDate", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getEventDate()).get(), 2014, 2, 12)), MapperS.of(0), CardinalityOperator.All);
			}
			catch (Exception ex) {
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3029_02 {
