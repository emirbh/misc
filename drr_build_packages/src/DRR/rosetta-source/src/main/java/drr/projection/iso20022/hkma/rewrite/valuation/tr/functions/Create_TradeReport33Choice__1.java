...
public abstract class Create_TradeReport33Choice__1 implements RosettaFunction {
	...
	* @return rpt 
	*/
	public TradeReport33Choice__1 evaluate(HKMAValuationReport drrReport) {
	...
	protected abstract TradeReport33Choice__1.TradeReport33Choice__1Builder doEvaluate(HKMAValuationReport drrReport);

	protected abstract MapperS<ActionTypeEnum> actionType(HKMAValuationReport drrReport);

	public static class Create_TradeReport33Choice__1Default extends Create_TradeReport33Choice__1 {
		@Override
		protected TradeReport33Choice__1.TradeReport33Choice__1Builder doEvaluate(HKMAValuationReport drrReport) {
			TradeReport33Choice__1.TradeReport33Choice__1Builder rpt = TradeReport33Choice__1.builder();
			return assignOutput(rpt, drrReport);
		}
		
		protected TradeReport33Choice__1.TradeReport33Choice__1Builder assignOutput(TradeReport33Choice__1.TradeReport33Choice__1Builder rpt, HKMAValuationReport drrReport) {
		...
		@Override
		protected MapperS<ActionTypeEnum> actionType(HKMAValuationReport drrReport) {
			return MapperS.of(drrReport).<ActionTypeEnum>map("getActionType", hKMAValuationReport -> hKMAValuationReport.getActionType());
		}
	}
}
