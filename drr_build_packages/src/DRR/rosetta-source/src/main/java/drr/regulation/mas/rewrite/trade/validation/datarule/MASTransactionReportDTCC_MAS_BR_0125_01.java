 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0125_01")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0125_01.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0125_01 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0125_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and [CommonAssetClass -> INTR, CommonAssetClass -> CRDT, CommonAssetClass -> EQUI, CommonAssetClass -> COMM] any = assetClass and [CommonContractType -> FRAS, CommonContractType -> OPTN, CommonContractType -> OTHR] any = contractType and leg2 -> periodicPayment -> floatingRateIdentifier exists then leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriod exists";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0125_01 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0125_01 {
