 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICMarginReportDTCC_ASIC_BR_3016_01")
@ImplementedBy(ASICMarginReportDTCC_ASIC_BR_3016_01.Default.class)
public interface ASICMarginReportDTCC_ASIC_BR_3016_01 extends Validator<ASICMarginReport> {
	
	String NAME = "ASICMarginReportDTCC_ASIC_BR_3016_01";
	...
	class Default implements ASICMarginReportDTCC_ASIC_BR_3016_01 {
	...
	class NoOp implements ASICMarginReportDTCC_ASIC_BR_3016_01 {
