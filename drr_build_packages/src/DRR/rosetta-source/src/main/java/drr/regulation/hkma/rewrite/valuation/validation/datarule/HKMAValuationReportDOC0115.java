 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAValuationReportDOC0115")
@ImplementedBy(HKMAValuationReportDOC0115.Default.class)
public interface HKMAValuationReportDOC0115 extends Validator<HKMAValuationReport> {
	
	String NAME = "HKMAValuationReportDOC0115";
	String DEFINITION = "True";
	
	class Default implements HKMAValuationReportDOC0115 {
	...
	class NoOp implements HKMAValuationReportDOC0115 {
