...
@ImplementedBy(NewDerivativeTradeRepositoryRule.NewDerivativeTradeRepositoryRuleDefault.class)
public abstract class NewDerivativeTradeRepositoryRule implements ReportFunction<TransactionReportInstruction, String> {
	...
	*/
	...
	public static class NewDerivativeTradeRepositoryRuleDefault extends NewDerivativeTradeRepositoryRule {
		@Override
