 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0029_04")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0029_04.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0029_04 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0029_04";
	String DEFINITION = "FrequencyPeriodMultiplier_Validation( actionType, leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriod, leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier )";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0029_04 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0029_04 {
