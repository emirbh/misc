 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0101")
@ImplementedBy(HKMATransactionReportDOC0101.Default.class)
public interface HKMATransactionReportDOC0101 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0101";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0101 {
	...
	class NoOp implements HKMATransactionReportDOC0101 {
