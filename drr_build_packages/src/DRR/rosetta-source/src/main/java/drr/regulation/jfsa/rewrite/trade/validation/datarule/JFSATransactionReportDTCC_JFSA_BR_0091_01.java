 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0091_01")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0091_01.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0091_01 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0091_01";
	String DEFINITION = "common.payment.CallCurrency_Validationn( actionType, assetClass, callAmount, callCurrency )";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0091_01 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0091_01 {
