 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0011")
@ImplementedBy(HKMATransactionReportDOC0011.Default.class)
public interface HKMATransactionReportDOC0011 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0011";
	...
	class Default implements HKMATransactionReportDOC0011 {
	...
	class NoOp implements HKMATransactionReportDOC0011 {
