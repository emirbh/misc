 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0031")
@ImplementedBy(HKMATransactionReportDOC0031.Default.class)
public interface HKMATransactionReportDOC0031 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0031";
	...
	class Default implements HKMATransactionReportDOC0031 {
	...
	class NoOp implements HKMATransactionReportDOC0031 {
