package drr.regulation.esma.emir.refit.valuation.validation.exists;
...
public class ESMAValuationReportOnlyExistsValidator implements ValidatorWithArg<ESMAValuationReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends ESMAValuationReport> ValidationResult<ESMAValuationReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ESMAValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "ESMAValuationReport", path, "");
		}
		return failure("ESMAValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "ESMAValuationReport", path, "",
