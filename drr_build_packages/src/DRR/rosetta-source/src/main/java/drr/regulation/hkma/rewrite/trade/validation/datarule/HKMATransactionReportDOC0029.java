 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0029")
@ImplementedBy(HKMATransactionReportDOC0029.Default.class)
public interface HKMATransactionReportDOC0029 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0029";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then if leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier exists then leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriod exists";
	
	class Default implements HKMATransactionReportDOC0029 {
	...
	class NoOp implements HKMATransactionReportDOC0029 {
