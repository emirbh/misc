 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0030")
@ImplementedBy(HKMATransactionReportDOC0030.Default.class)
public interface HKMATransactionReportDOC0030 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0030";
	...
	class Default implements HKMATransactionReportDOC0030 {
	...
	class NoOp implements HKMATransactionReportDOC0030 {
