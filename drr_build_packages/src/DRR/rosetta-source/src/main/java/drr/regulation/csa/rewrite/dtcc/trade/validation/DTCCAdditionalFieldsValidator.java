package drr.regulation.csa.rewrite.dtcc.trade.validation;
...
public class DTCCAdditionalFieldsValidator implements Validator<DTCCAdditionalFields> {
	...
	private List<ComparisonResult> getComparisonResults(DTCCAdditionalFields o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("allocationType", (AllocationIndicatorEnum) o.getAllocationType() != null ? 1 : 0, 0, 1), 
				...
				checkCardinality("messageTypeTransaction", (String) o.getMessageTypeTransaction() != null ? 1 : 0, 0, 1), 
				checkCardinality("messageTypePPD", (String) o.getMessageTypePPD() != null ? 1 : 0, 0, 1), 
				...
				checkCardinality("tradeParty1BrokerIDType", (PartyIdentifierTypeEnum) o.getTradeParty1BrokerIDType() != null ? 1 : 0, 0, 1), 
				checkCardinality("versionTransaction", (String) o.getVersionTransaction() != null ? 1 : 0, 0, 1), 
				checkCardinality("versionPPD", (String) o.getVersionPPD() != null ? 1 : 0, 0, 1)
			);
	}
