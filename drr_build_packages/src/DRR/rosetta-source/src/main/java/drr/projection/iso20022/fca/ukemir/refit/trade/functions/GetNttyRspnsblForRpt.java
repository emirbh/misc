...
public abstract class GetNttyRspnsblForRpt implements RosettaFunction {
	...
	*/
	public OrganisationIdentification15Choice__1 evaluate(FCAUKEMIRTransactionReport drrReport) {
	...
	protected abstract OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder doEvaluate(FCAUKEMIRTransactionReport drrReport);

	public static class GetNttyRspnsblForRptDefault extends GetNttyRspnsblForRpt {
		@Override
		protected OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder doEvaluate(FCAUKEMIRTransactionReport drrReport) {
		...
		protected OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder assignOutput(OrganisationIdentification15Choice__1.OrganisationIdentification15Choice__1Builder nttyRspnsblForRpt, FCAUKEMIRTransactionReport drrReport) {
			nttyRspnsblForRpt = toBuilder(create_OrganisationIdentification15Choice__1.evaluate(MapperS.of(drrReport).<String>map("getEntityResponsibleForReporting", fCAUKEMIRTransactionReport -> fCAUKEMIRTransactionReport.getEntityResponsibleForReporting()).get()));
