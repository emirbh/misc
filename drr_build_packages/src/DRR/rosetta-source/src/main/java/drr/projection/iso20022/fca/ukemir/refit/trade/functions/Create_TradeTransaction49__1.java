...
public abstract class Create_TradeTransaction49__1 implements RosettaFunction {
	...
	* @return txData 
	*/
	public TradeTransaction49__1 evaluate(FCAUKEMIRTransactionReport drrReport) {
	...
	protected abstract TradeTransaction49__1.TradeTransaction49__1Builder doEvaluate(FCAUKEMIRTransactionReport drrReport);

	public static class Create_TradeTransaction49__1Default extends Create_TradeTransaction49__1 {
		@Override
		protected TradeTransaction49__1.TradeTransaction49__1Builder doEvaluate(FCAUKEMIRTransactionReport drrReport) {
		...
		protected TradeTransaction49__1.TradeTransaction49__1Builder assignOutput(TradeTransaction49__1.TradeTransaction49__1Builder txData, FCAUKEMIRTransactionReport drrReport) {
