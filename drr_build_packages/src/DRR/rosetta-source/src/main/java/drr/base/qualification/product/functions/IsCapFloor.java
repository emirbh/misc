...
@ImplementedBy(IsCapFloor.IsCapFloorDefault.class)
public abstract class IsCapFloor implements RosettaFunction {
	...
	*/
	...
	public static class IsCapFloorDefault extends IsCapFloor {
		@Override
		...
		protected Boolean assignOutput(Boolean result, NonTransferableProduct product) {
			result = areEqual(MapperS.of(qualify_InterestRate_CapFloor.evaluate(economicTermsForProduct.evaluate(product))), MapperS.of(true), CardinalityOperator.All).get();
