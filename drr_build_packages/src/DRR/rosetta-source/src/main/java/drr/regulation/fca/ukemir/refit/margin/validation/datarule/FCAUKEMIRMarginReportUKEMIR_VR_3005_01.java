 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3005_01")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3005_01.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3005_01 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3005_01";
	String DEFINITION = "if counterparty2IdentifierType exists then True";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3005_01 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRMarginReport fCAUKEMIRMarginReport) {
			try {
				if (exists(MapperS.of(fCAUKEMIRMarginReport).<Boolean>map("getCounterparty2IdentifierType", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getCounterparty2IdentifierType())).getOrDefault(false)) {
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3005_01 {
