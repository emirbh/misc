 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportDTCC_SEC_VR_FloatingRatePaymentFrequencyPeriodLeg2")
@ImplementedBy(SECTransactionReportDTCC_SEC_VR_FloatingRatePaymentFrequencyPeriodLeg2.Default.class)
public interface SECTransactionReportDTCC_SEC_VR_FloatingRatePaymentFrequencyPeriodLeg2 extends Validator<SECTransactionReport> {
	
	String NAME = "SECTransactionReportDTCC_SEC_VR_FloatingRatePaymentFrequencyPeriodLeg2";
	String DEFINITION = "if leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriod = EXPI then leg2 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier = 1";
	
	class Default implements SECTransactionReportDTCC_SEC_VR_FloatingRatePaymentFrequencyPeriodLeg2 {
	...
	class NoOp implements SECTransactionReportDTCC_SEC_VR_FloatingRatePaymentFrequencyPeriodLeg2 {
