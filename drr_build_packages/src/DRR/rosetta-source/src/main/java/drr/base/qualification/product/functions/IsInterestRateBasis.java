...
@ImplementedBy(IsInterestRateBasis.IsInterestRateBasisDefault.class)
public abstract class IsInterestRateBasis implements RosettaFunction {
	...
	*/
	...
	public static class IsInterestRateBasisDefault extends IsInterestRateBasis {
		@Override
