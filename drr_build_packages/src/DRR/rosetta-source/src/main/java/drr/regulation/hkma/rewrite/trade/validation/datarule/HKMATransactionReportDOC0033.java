 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0033")
@ImplementedBy(HKMATransactionReportDOC0033.Default.class)
public interface HKMATransactionReportDOC0033 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0033";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then if leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriod exists and leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriod = FrequencyPeriodEnum -> EXPI then leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier = 1";
	
	class Default implements HKMATransactionReportDOC0033 {
	...
	class NoOp implements HKMATransactionReportDOC0033 {
