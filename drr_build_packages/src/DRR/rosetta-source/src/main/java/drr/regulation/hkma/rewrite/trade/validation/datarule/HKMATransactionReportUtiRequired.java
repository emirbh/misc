 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportUtiRequired")
@ImplementedBy(HKMATransactionReportUtiRequired.Default.class)
public interface HKMATransactionReportUtiRequired extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportUtiRequired";
	String DEFINITION = "required choice uniqueTransactionIdentifier, uniqueTransactionIdentifierProprietary";
	
	class Default implements HKMATransactionReportUtiRequired {
		...
		private ComparisonResult executeDataRule(HKMATransactionReport hKMATransactionReport) {
			try {
				return choice(MapperS.of(hKMATransactionReport), Arrays.asList("uniqueTransactionIdentifier", "uniqueTransactionIdentifierProprietary"), ChoiceRuleValidationMethod.REQUIRED);
			}
			catch (Exception ex) {
	...
	class NoOp implements HKMATransactionReportUtiRequired {
