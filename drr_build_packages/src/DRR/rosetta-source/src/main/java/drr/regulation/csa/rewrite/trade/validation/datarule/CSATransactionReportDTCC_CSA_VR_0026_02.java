 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_0026_02")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_0026_02.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_0026_02 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_0026_02";
	String DEFINITION = "if leg1 -> notionalCurrency exists then leg1 -> notionalAmount exists";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_0026_02 {
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_0026_02 {
