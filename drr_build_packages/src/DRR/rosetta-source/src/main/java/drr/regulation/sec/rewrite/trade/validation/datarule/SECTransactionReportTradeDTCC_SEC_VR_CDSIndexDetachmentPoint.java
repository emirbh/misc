 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportTradeDTCC_SEC_VR_CDSIndexDetachmentPoint")
@ImplementedBy(SECTransactionReportTradeDTCC_SEC_VR_CDSIndexDetachmentPoint.Default.class)
public interface SECTransactionReportTradeDTCC_SEC_VR_CDSIndexDetachmentPoint extends Validator<SECTransactionReportTrade> {
	
	String NAME = "SECTransactionReportTradeDTCC_SEC_VR_CDSIndexDetachmentPoint";
	String DEFINITION = "if nonReportable -> postUpiData -> Derived -> UnderlyingAssetType = Index_Tranche or nonReportable -> underlyingAssetType = \"Index_Tranche\" then (cdSIndexDetachmentPoint exists and cdSIndexDetachmentPoint > cdSIndexAttachmentPoint) else cdSIndexDetachmentPoint is absent";
	
	class Default implements SECTransactionReportTradeDTCC_SEC_VR_CDSIndexDetachmentPoint {
	...
	class NoOp implements SECTransactionReportTradeDTCC_SEC_VR_CDSIndexDetachmentPoint {
