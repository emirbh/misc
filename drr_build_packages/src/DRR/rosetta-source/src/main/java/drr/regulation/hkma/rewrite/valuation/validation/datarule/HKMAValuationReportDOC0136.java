 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAValuationReportDOC0136")
@ImplementedBy(HKMAValuationReportDOC0136.Default.class)
public interface HKMAValuationReportDOC0136 extends Validator<HKMAValuationReport> {
	
	String NAME = "HKMAValuationReportDOC0136";
	String DEFINITION = "True";
	
	class Default implements HKMAValuationReportDOC0136 {
	...
	class NoOp implements HKMAValuationReportDOC0136 {
