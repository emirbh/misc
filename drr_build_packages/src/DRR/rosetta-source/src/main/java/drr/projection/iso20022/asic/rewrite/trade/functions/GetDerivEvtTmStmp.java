...
public abstract class GetDerivEvtTmStmp implements RosettaFunction {
	...
	* @return tmStmp 
	*/
	public DateAndDateTime2Choice__1 evaluate(ASICTransactionReport drrReport) {
	...
	protected abstract DateAndDateTime2Choice__1.DateAndDateTime2Choice__1Builder doEvaluate(ASICTransactionReport drrReport);

	public static class GetDerivEvtTmStmpDefault extends GetDerivEvtTmStmp {
		@Override
		protected DateAndDateTime2Choice__1.DateAndDateTime2Choice__1Builder doEvaluate(ASICTransactionReport drrReport) {
		...
		protected DateAndDateTime2Choice__1.DateAndDateTime2Choice__1Builder assignOutput(DateAndDateTime2Choice__1.DateAndDateTime2Choice__1Builder tmStmp, ASICTransactionReport drrReport) {
			tmStmp = toBuilder(DateAndDateTime2Choice__1.builder()
				.setDtTm(MapperS.of(drrReport).<ZonedDateTime>map("getEventTimestamp", aSICTransactionReport -> aSICTransactionReport.getEventTimestamp()).get())
				.build());
