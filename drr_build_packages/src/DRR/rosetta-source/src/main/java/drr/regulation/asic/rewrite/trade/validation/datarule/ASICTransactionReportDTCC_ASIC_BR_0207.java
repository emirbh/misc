 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICTransactionReportDTCC_ASIC_BR_0207")
@ImplementedBy(ASICTransactionReportDTCC_ASIC_BR_0207.Default.class)
public interface ASICTransactionReportDTCC_ASIC_BR_0207 extends Validator<ASICTransactionReport> {
	
	String NAME = "ASICTransactionReportDTCC_ASIC_BR_0207";
	...
	class Default implements ASICTransactionReportDTCC_ASIC_BR_0207 {
	...
	class NoOp implements ASICTransactionReportDTCC_ASIC_BR_0207 {
