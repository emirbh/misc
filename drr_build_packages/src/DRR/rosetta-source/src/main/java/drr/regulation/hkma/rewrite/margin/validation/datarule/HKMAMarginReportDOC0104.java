 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0104")
@ImplementedBy(HKMAMarginReportDOC0104.Default.class)
public interface HKMAMarginReportDOC0104 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0104";
	String DEFINITION = "True";
	
	class Default implements HKMAMarginReportDOC0104 {
	...
	class NoOp implements HKMAMarginReportDOC0104 {
