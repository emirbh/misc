 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0094_01")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0094_01.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0094_01 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0094_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and ((assetClass = CommonAssetClass -> INTR and contractType = CommonContractType -> CFDS) or ([CommonAssetClass -> EQUI, CommonAssetClass -> COMM] any = assetClass and [CommonContractType -> CFDS, CommonContractType -> FORW] any = contractType)) then price exists";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0094_01 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0094_01 {
