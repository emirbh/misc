 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0114")
@ImplementedBy(HKMATransactionReportDOC0114.Default.class)
public interface HKMATransactionReportDOC0114 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0114";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0114 {
	...
	class NoOp implements HKMATransactionReportDOC0114 {
