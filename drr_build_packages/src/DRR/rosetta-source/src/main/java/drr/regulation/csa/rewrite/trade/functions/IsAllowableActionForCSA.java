...
@ImplementedBy(IsAllowableActionForCSA.IsAllowableActionForCSADefault.class)
public abstract class IsAllowableActionForCSA implements RosettaFunction {
	...
	*/
	...
	public static class IsAllowableActionForCSADefault extends IsAllowableActionForCSA {
		@Override
