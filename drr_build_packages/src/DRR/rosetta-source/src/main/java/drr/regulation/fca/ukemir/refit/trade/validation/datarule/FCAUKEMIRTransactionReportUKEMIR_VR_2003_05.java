...
public interface FCAUKEMIRTransactionReportUKEMIR_VR_2003_05 extends Validator<FCAUKEMIRTransactionReport> {
	...
	String DEFINITION = "if IsVRAllowedForActionType(actionType) then if priorUTI exists then [uniqueTransactionIdentifier, uniqueTransactionIdentifierProprietary, reportTrackingNumber, subsequentPositionUTI] all <> priorUTI else [uniqueTransactionIdentifier, uniqueTransactionIdentifierProprietary, reportTrackingNumber, subsequentPositionUTI] all <> priorUTIProprietary";
