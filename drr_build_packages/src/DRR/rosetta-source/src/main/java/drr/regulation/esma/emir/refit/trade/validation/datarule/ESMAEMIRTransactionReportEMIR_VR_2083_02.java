 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRTransactionReportEMIR_VR_2083_02")
@ImplementedBy(ESMAEMIRTransactionReportEMIR_VR_2083_02.Default.class)
public interface ESMAEMIRTransactionReportEMIR_VR_2083_02 extends Validator<ESMAEMIRTransactionReport> {
	
	String NAME = "ESMAEMIRTransactionReportEMIR_VR_2083_02";
	String DEFINITION = "if IsVRAllowedForActionType(actionType) then if assetClass = INTR and underlyingIdentification exists then leg1 -> periodicPayment -> floatingRateIdentifier is absent";
	
	class Default implements ESMAEMIRTransactionReportEMIR_VR_2083_02 {
	...
	class NoOp implements ESMAEMIRTransactionReportEMIR_VR_2083_02 {
