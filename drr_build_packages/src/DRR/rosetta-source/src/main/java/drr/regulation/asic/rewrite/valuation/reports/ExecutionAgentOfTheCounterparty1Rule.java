...
@ImplementedBy(ExecutionAgentOfTheCounterparty1Rule.ExecutionAgentOfTheCounterparty1RuleDefault.class)
public abstract class ExecutionAgentOfTheCounterparty1Rule implements ReportFunction<ValuationReportInstruction, String> {
	...
	*/
	...
	public static class ExecutionAgentOfTheCounterparty1RuleDefault extends ExecutionAgentOfTheCounterparty1Rule {
		@Override
