...
@ImplementedBy(NameOfTheFloatingRateLeg2Rule.NameOfTheFloatingRateLeg2RuleDefault.class)
public abstract class NameOfTheFloatingRateLeg2Rule implements ReportFunction<TransactionReportInstruction, String> {
	...
	*/
	...
	public static class NameOfTheFloatingRateLeg2RuleDefault extends NameOfTheFloatingRateLeg2Rule {
		@Override
