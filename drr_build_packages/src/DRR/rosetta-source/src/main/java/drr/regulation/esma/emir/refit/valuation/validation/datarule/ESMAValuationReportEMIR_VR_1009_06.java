 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAValuationReportEMIR_VR_1009_06")
@ImplementedBy(ESMAValuationReportEMIR_VR_1009_06.Default.class)
public interface ESMAValuationReportEMIR_VR_1009_06 extends Validator<ESMAValuationReport> {
	
	String NAME = "ESMAValuationReportEMIR_VR_1009_06";
	String DEFINITION = "Counterparty2_06_Validation(counterparty2IdentifierType, counterparty2)";
	
	class Default implements ESMAValuationReportEMIR_VR_1009_06 {
		...
		private ComparisonResult executeDataRule(ESMAValuationReport eSMAValuationReport) {
			try {
				return ComparisonResult.ofNullSafe(MapperS.of(counterparty2_06_Validation.evaluate(MapperS.of(eSMAValuationReport).<Boolean>map("getCounterparty2IdentifierType", _eSMAValuationReport -> _eSMAValuationReport.getCounterparty2IdentifierType()).get(), MapperS.of(eSMAValuationReport).<String>map("getCounterparty2", _eSMAValuationReport -> _eSMAValuationReport.getCounterparty2()).get())));
			}
			catch (Exception ex) {
	...
	class NoOp implements ESMAValuationReportEMIR_VR_1009_06 {
