 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0138")
@ImplementedBy(HKMATransactionReportDOC0138.Default.class)
public interface HKMATransactionReportDOC0138 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0138";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0138 {
	...
	class NoOp implements HKMATransactionReportDOC0138 {
