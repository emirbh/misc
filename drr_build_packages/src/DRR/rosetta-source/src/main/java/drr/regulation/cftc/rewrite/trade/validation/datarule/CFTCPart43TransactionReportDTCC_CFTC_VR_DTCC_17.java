 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_17")
@ImplementedBy(CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_17.Default.class)
public interface CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_17 extends Validator<CFTCPart43TransactionReport> {
	
	String NAME = "CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_17";
	String DEFINITION = "if dtccAdditionalFields -> sefOrDcmAnonymousExecutionIndicator = True then dtccAdditionalFields -> sefOrDcmIndicator = True";
	
	class Default implements CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_17 {
	...
	class NoOp implements CFTCPart43TransactionReportDTCC_CFTC_VR_DTCC_17 {
