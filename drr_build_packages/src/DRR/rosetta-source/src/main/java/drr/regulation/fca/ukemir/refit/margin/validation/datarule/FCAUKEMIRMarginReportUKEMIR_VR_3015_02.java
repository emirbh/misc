 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3015_02")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3015_02.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3015_02 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3015_02";
	...
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3015_02 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRMarginReport fCAUKEMIRMarginReport) {
			try {
				if (contains(MapperC.<CollateralisationType3Code>of(MapperS.of(CollateralisationType3Code.PRC1), MapperS.of(CollateralisationType3Code.OWC1)), MapperS.of(fCAUKEMIRMarginReport).<CollateralisationType3Code>map("getCollateralisationCategory", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getCollateralisationCategory())).getOrDefault(false)) {
					return exists(MapperS.of(fCAUKEMIRMarginReport).<BigDecimal>map("getVariationMarginPostedByTheCounterparty1PreHaircut", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getVariationMarginPostedByTheCounterparty1PreHaircut())).andNullSafe(greaterThanEquals(MapperS.of(fCAUKEMIRMarginReport).<BigDecimal>map("getVariationMarginPostedByTheCounterparty1PreHaircut", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getVariationMarginPostedByTheCounterparty1PreHaircut()), MapperS.of(BigDecimal.valueOf(0)), CardinalityOperator.All));
				}
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3015_02 {
