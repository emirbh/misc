 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0143")
@ImplementedBy(HKMAMarginReportDOC0143.Default.class)
public interface HKMAMarginReportDOC0143 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0143";
	String DEFINITION = "True";
	
	class Default implements HKMAMarginReportDOC0143 {
	...
	class NoOp implements HKMAMarginReportDOC0143 {
