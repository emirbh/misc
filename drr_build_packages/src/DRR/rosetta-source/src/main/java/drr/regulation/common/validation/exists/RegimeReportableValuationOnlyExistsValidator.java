...
public class RegimeReportableValuationOnlyExistsValidator implements ValidatorWithArg<RegimeReportableValuation, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RegimeReportableValuation> ValidationResult<RegimeReportableValuation> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RegimeReportableValuation", ValidationResult.ValidationType.ONLY_EXISTS, "RegimeReportableValuation", path, "");
		}
		return failure("RegimeReportableValuation", ValidationResult.ValidationType.ONLY_EXISTS, "RegimeReportableValuation", path, "",
