...
public abstract class Create_TradeReport33Choice__1 implements RosettaFunction {
	...
	@Inject protected Create_CommonTradeDataReport71__8 create_CommonTradeDataReport71__8;
	...
	* @return rpt 
	*/
	public TradeReport33Choice__1 evaluate(JFSATransactionReport drrReport) {
	...
	protected abstract TradeReport33Choice__1.TradeReport33Choice__1Builder doEvaluate(JFSATransactionReport drrReport);

	protected abstract MapperS<ActionTypeEnum> actionType(JFSATransactionReport drrReport);

	public static class Create_TradeReport33Choice__1Default extends Create_TradeReport33Choice__1 {
		@Override
		protected TradeReport33Choice__1.TradeReport33Choice__1Builder doEvaluate(JFSATransactionReport drrReport) {
			TradeReport33Choice__1.TradeReport33Choice__1Builder rpt = TradeReport33Choice__1.builder();
			return assignOutput(rpt, drrReport);
		}
		
		protected TradeReport33Choice__1.TradeReport33Choice__1Builder assignOutput(TradeReport33Choice__1.TradeReport33Choice__1Builder rpt, JFSATransactionReport drrReport) {
		...
		@Override
		protected MapperS<ActionTypeEnum> actionType(JFSATransactionReport drrReport) {
			return MapperS.of(drrReport).<ActionTypeEnum>map("getActionType", jFSATransactionReport -> jFSATransactionReport.getActionType());
		}
	}
}
