 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart43TransactionReportPackageTransactionPriceCondition")
@ImplementedBy(CFTCPart43TransactionReportPackageTransactionPriceCondition.Default.class)
public interface CFTCPart43TransactionReportPackageTransactionPriceCondition extends Validator<CFTCPart43TransactionReport> {
	
	String NAME = "CFTCPart43TransactionReportPackageTransactionPriceCondition";
	...
	class Default implements CFTCPart43TransactionReportPackageTransactionPriceCondition {
		...
		private ComparisonResult executeDataRule(CFTCPart43TransactionReport cFTCPart43TransactionReport) {
			try {
				if (areEqual(MapperS.of(cFTCPart43TransactionReport).<Boolean>map("getPackageIndicator", _cFTCPart43TransactionReport -> _cFTCPart43TransactionReport.getPackageIndicator()), MapperS.of(true), CardinalityOperator.All).andNullSafe(notExists(MapperS.of(cFTCPart43TransactionReport).<PriceFormat>map("getPackageTransactionSpread", _cFTCPart43TransactionReport -> _cFTCPart43TransactionReport.getPackageTransactionSpread()))).getOrDefault(false)) {
					return exists(MapperS.of(cFTCPart43TransactionReport).<PriceFormat>map("getPackageTransactionPrice", _cFTCPart43TransactionReport -> _cFTCPart43TransactionReport.getPackageTransactionPrice()));
				}
				return notExists(MapperS.of(cFTCPart43TransactionReport).<PriceFormat>map("getPackageTransactionPrice", _cFTCPart43TransactionReport -> _cFTCPart43TransactionReport.getPackageTransactionPrice()));
			}
			catch (Exception ex) {
	...
	class NoOp implements CFTCPart43TransactionReportPackageTransactionPriceCondition {
