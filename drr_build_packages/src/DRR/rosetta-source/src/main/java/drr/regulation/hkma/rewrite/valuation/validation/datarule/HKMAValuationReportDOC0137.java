 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAValuationReportDOC0137")
@ImplementedBy(HKMAValuationReportDOC0137.Default.class)
public interface HKMAValuationReportDOC0137 extends Validator<HKMAValuationReport> {
	
	String NAME = "HKMAValuationReportDOC0137";
	String DEFINITION = "True";
	
	class Default implements HKMAValuationReportDOC0137 {
	...
	class NoOp implements HKMAValuationReportDOC0137 {
