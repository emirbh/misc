 ...
 * @version 7.7.0
 */
@RosettaDataRule("ReportableInformationMandatorilyClearableConditionESMA")
@ImplementedBy(ReportableInformationMandatorilyClearableConditionESMA.Default.class)
public interface ReportableInformationMandatorilyClearableConditionESMA extends Validator<ReportableInformation> {
	
	String NAME = "ReportableInformationMandatorilyClearableConditionESMA";
	String DEFINITION = "jurisdictionInformation then filter supervisoryBody = ESMA then if partyInformation -> mandatorilyClearable exists then partyInformation -> mandatorilyClearable distinct count = 1";
	
	class Default implements ReportableInformationMandatorilyClearableConditionESMA {
	...
	class NoOp implements ReportableInformationMandatorilyClearableConditionESMA {
