 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0082a_02")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0082a_02.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0082a_02 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0082a_02";
	String DEFINITION = "common.quantity.NotionalQuantityScheduleUnadjustedEffectiveDate_Validation( actionType, assetClass, leg1 -> notionalQuantitySchedule )";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0082a_02 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0082a_02 {
