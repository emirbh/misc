 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0008")
@ImplementedBy(HKMATransactionReportDOC0008.Default.class)
public interface HKMATransactionReportDOC0008 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0008";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0008 {
	...
	class NoOp implements HKMATransactionReportDOC0008 {
