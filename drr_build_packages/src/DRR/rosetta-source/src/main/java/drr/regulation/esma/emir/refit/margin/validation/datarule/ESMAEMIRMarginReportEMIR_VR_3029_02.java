 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRMarginReportEMIR_VR_3029_02")
@ImplementedBy(ESMAEMIRMarginReportEMIR_VR_3029_02.Default.class)
public interface ESMAEMIRMarginReportEMIR_VR_3029_02 extends Validator<ESMAEMIRMarginReport> {
	
	String NAME = "ESMAEMIRMarginReportEMIR_VR_3029_02";
	String DEFINITION = "CompareDateTo(eventDate, 2014, 2, 12) >= 0";
	
	class Default implements ESMAEMIRMarginReportEMIR_VR_3029_02 {
		...
		private ComparisonResult executeDataRule(ESMAEMIRMarginReport eSMAEMIRMarginReport) {
			try {
				return greaterThanEquals(MapperS.of(compareDateTo.evaluate(MapperS.of(eSMAEMIRMarginReport).<Date>map("getEventDate", _eSMAEMIRMarginReport -> _eSMAEMIRMarginReport.getEventDate()).get(), 2014, 2, 12)), MapperS.of(0), CardinalityOperator.All);
			}
			catch (Exception ex) {
	...
	class NoOp implements ESMAEMIRMarginReportEMIR_VR_3029_02 {
