 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICTransactionReportDTCC_ASIC_BR_1050_02")
@ImplementedBy(ASICTransactionReportDTCC_ASIC_BR_1050_02.Default.class)
public interface ASICTransactionReportDTCC_ASIC_BR_1050_02 extends Validator<ASICTransactionReport> {
	
	String NAME = "ASICTransactionReportDTCC_ASIC_BR_1050_02";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and (assetClass = INTR and contractType = SWAP) then if nonReportable -> postUpiData -> Header -> InstrumentType = Swap and nonReportable -> postUpiData -> Header -> AssetClass = Rates and (nonReportable -> postUpiData -> Header -> UseCase <> Fixed_Fixed or nonReportable -> postUpiData -> Header -> UseCase <> Cross_Currency_Fixed_Fixed) then leg1 -> fixedRate exists";
	
	class Default implements ASICTransactionReportDTCC_ASIC_BR_1050_02 {
	...
	class NoOp implements ASICTransactionReportDTCC_ASIC_BR_1050_02 {
