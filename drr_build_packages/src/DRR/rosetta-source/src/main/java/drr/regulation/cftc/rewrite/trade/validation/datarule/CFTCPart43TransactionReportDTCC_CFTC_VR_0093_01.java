 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart43TransactionReportDTCC_CFTC_VR_0093_01")
@ImplementedBy(CFTCPart43TransactionReportDTCC_CFTC_VR_0093_01.Default.class)
public interface CFTCPart43TransactionReportDTCC_CFTC_VR_0093_01 extends Validator<CFTCPart43TransactionReport> {
	
	String NAME = "CFTCPart43TransactionReportDTCC_CFTC_VR_0093_01";
	String DEFINITION = "if dtccAdditionalFields -> sefOrDcmIndicator = True then blockTradeElectionIndicator exists";
	
	class Default implements CFTCPart43TransactionReportDTCC_CFTC_VR_0093_01 {
		...
		private ComparisonResult executeDataRule(CFTCPart43TransactionReport cFTCPart43TransactionReport) {
			try {
				if (areEqual(MapperS.of(cFTCPart43TransactionReport).<DTCCAdditionalFields>map("getDtccAdditionalFields", _cFTCPart43TransactionReport -> _cFTCPart43TransactionReport.getDtccAdditionalFields()).<Boolean>map("getSefOrDcmIndicator", dTCCAdditionalFields -> dTCCAdditionalFields.getSefOrDcmIndicator()), MapperS.of(true), CardinalityOperator.All).getOrDefault(false)) {
					return exists(MapperS.of(cFTCPart43TransactionReport).<Boolean>map("getBlockTradeElectionIndicator", _cFTCPart43TransactionReport -> _cFTCPart43TransactionReport.getBlockTradeElectionIndicator()));
				}
	...
	class NoOp implements CFTCPart43TransactionReportDTCC_CFTC_VR_0093_01 {
