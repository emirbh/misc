 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSAMarginReportDTCC_JFSA_BR_0104_04")
@ImplementedBy(JFSAMarginReportDTCC_JFSA_BR_0104_04.Default.class)
public interface JFSAMarginReportDTCC_JFSA_BR_0104_04 extends Validator<JFSAMarginReport> {
	
	String NAME = "JFSAMarginReportDTCC_JFSA_BR_0104_04";
	String DEFINITION = "if actionType = MarginActionEnum -> MARU then (eventTimestamp <= reportingTimestamp)";
	
	class Default implements JFSAMarginReportDTCC_JFSA_BR_0104_04 {
		...
		private ComparisonResult executeDataRule(JFSAMarginReport jFSAMarginReport) {
			try {
				if (areEqual(MapperS.of(jFSAMarginReport).<MarginActionEnum>map("getActionType", _jFSAMarginReport -> _jFSAMarginReport.getActionType()), MapperS.of(MarginActionEnum.MARU), CardinalityOperator.All).getOrDefault(false)) {
					return lessThanEquals(MapperS.of(jFSAMarginReport).<ZonedDateTime>map("getEventTimestamp", _jFSAMarginReport -> _jFSAMarginReport.getEventTimestamp()), MapperS.of(jFSAMarginReport).<ZonedDateTime>map("getReportingTimestamp", _jFSAMarginReport -> _jFSAMarginReport.getReportingTimestamp()), CardinalityOperator.All);
				}
	...
	class NoOp implements JFSAMarginReportDTCC_JFSA_BR_0104_04 {
