...
public abstract class GetTxId implements RosettaFunction {
	...
	* @return txId 
	*/
	public UniqueTransactionIdentifier2Choice__2 evaluate(FCAValuationReport drrReport) {
	...
	protected abstract UniqueTransactionIdentifier2Choice__2.UniqueTransactionIdentifier2Choice__2Builder doEvaluate(FCAValuationReport drrReport);

	public static class GetTxIdDefault extends GetTxId {
		@Override
		protected UniqueTransactionIdentifier2Choice__2.UniqueTransactionIdentifier2Choice__2Builder doEvaluate(FCAValuationReport drrReport) {
		...
		protected UniqueTransactionIdentifier2Choice__2.UniqueTransactionIdentifier2Choice__2Builder assignOutput(UniqueTransactionIdentifier2Choice__2.UniqueTransactionIdentifier2Choice__2Builder txId, FCAValuationReport drrReport) {
			txId = toBuilder(UniqueTransactionIdentifier2Choice__2.builder()
				...
				.setPrtry(GenericIdentification175__3.builder()
					.setId(MapperS.of(drrReport).<String>map("getUniqueTransactionIdentifierProprietary", fCAValuationReport -> fCAValuationReport.getUniqueTransactionIdentifierProprietary()).get())
					.build())
				.build());
