 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAValuationReportUKEMIR_VR_2001_03")
@ImplementedBy(FCAValuationReportUKEMIR_VR_2001_03.Default.class)
public interface FCAValuationReportUKEMIR_VR_2001_03 extends Validator<FCAValuationReport> {
	
	String NAME = "FCAValuationReportUKEMIR_VR_2001_03";
	String DEFINITION = "True";
	
	class Default implements FCAValuationReportUKEMIR_VR_2001_03 {
	...
	class NoOp implements FCAValuationReportUKEMIR_VR_2001_03 {
