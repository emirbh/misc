...
public interface FCAUKEMIRTransactionReportUKEMIR_VR_1021_05 extends Validator<FCAUKEMIRTransactionReport> {
	...
	class Default implements FCAUKEMIRTransactionReportUKEMIR_VR_1021_05 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRTransactionReport fCAUKEMIRTransactionReport) {
			try {
				if (areEqual(MapperC.<ActionTypeEnum>of(MapperS.of(ActionTypeEnum.REVI), MapperS.of(ActionTypeEnum.TERM), MapperS.of(ActionTypeEnum.EROR)), MapperS.of(fCAUKEMIRTransactionReport).<ActionTypeEnum>map("getActionType", _fCAUKEMIRTransactionReport -> _fCAUKEMIRTransactionReport.getActionType()), CardinalityOperator.Any).getOrDefault(false)) {
	...
	class NoOp implements FCAUKEMIRTransactionReportUKEMIR_VR_1021_05 {
