...
public abstract class OriginalSwapSDRIdentifierRule implements ReportFunction<TransactionReportInstruction, String> {
	...
	@Inject protected drr.regulation.common.trade.link.reports.OriginalSwapSDRIdentifierRule originalSwapSDRIdentifierRule;
	...
	*/
	...
	public static class OriginalSwapSDRIdentifierRuleDefault extends OriginalSwapSDRIdentifierRule {
		...
		protected String assignOutput(String output, TransactionReportInstruction input) {
			...
			output = thenArg
				.mapSingleToItem(item -> MapperS.of(originalSwapSDRIdentifierRule.evaluate(item.get()))).get();
