...
@ImplementedBy(FXLeg2.FXLeg2Default.class)
public abstract class FXLeg2 implements RosettaFunction {
	...
	*/
	public Cashflow evaluate(NonTransferableProduct product, TradeLot tradeLot) {
		Cashflow.CashflowBuilder fxLeg2Builder = doEvaluate(product, tradeLot);
	...
	public static class FXLeg2Default extends FXLeg2 {
		@Override
		protected Cashflow.CashflowBuilder doEvaluate(NonTransferableProduct product, TradeLot tradeLot) {
			...
			return assignOutput(fxLeg2, product, tradeLot);
		}
		
		protected Cashflow.CashflowBuilder assignOutput(Cashflow.CashflowBuilder fxLeg2, NonTransferableProduct product, TradeLot tradeLot) {
			...
			fxLeg2 = toBuilder(ifThenElseResult.get());
