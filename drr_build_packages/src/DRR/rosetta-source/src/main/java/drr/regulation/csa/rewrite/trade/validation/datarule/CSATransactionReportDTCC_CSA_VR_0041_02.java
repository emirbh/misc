 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_0041_02")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_0041_02.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_0041_02 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_0041_02";
	String DEFINITION = "common.quantity.NotionalScheduleEffectiveDateDTCC_Validation( leg2 -> notionalAmountSchedule -> value, leg2 -> notionalAmountSchedule -> effectiveDate )";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_0041_02 {
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_0041_02 {
