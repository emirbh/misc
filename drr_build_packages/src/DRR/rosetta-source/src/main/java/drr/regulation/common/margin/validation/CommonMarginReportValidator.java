...
public class CommonMarginReportValidator implements Validator<CommonMarginReport> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommonMarginReport", ValidationResult.ValidationType.CARDINALITY, "CommonMarginReport", path, "", res.getError());
				}
				return success("CommonMarginReport", ValidationResult.ValidationType.CARDINALITY, "CommonMarginReport", path, "");
			})
			.collect(toList());
	}
