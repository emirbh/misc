 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportTradeDTCC_CSA_VR_DTCC_02")
@ImplementedBy(CSATransactionReportTradeDTCC_CSA_VR_DTCC_02.Default.class)
public interface CSATransactionReportTradeDTCC_CSA_VR_DTCC_02 extends Validator<CSATransactionReportTrade> {
	
	String NAME = "CSATransactionReportTradeDTCC_CSA_VR_DTCC_02";
	String DEFINITION = "if clearingMember exists then dtccAdditionalFields -> tradeParty1ClearingBrokerIDType exists";
	
	class Default implements CSATransactionReportTradeDTCC_CSA_VR_DTCC_02 {
		...
		private ComparisonResult executeDataRule(CSATransactionReportTrade cSATransactionReportTrade) {
			try {
				if (exists(MapperS.of(cSATransactionReportTrade).<String>map("getClearingMember", _cSATransactionReportTrade -> _cSATransactionReportTrade.getClearingMember())).getOrDefault(false)) {
	...
	class NoOp implements CSATransactionReportTradeDTCC_CSA_VR_DTCC_02 {
