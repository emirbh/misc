 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRTransactionReportEMIR_VR_2150_02")
@ImplementedBy(ESMAEMIRTransactionReportEMIR_VR_2150_02.Default.class)
public interface ESMAEMIRTransactionReportEMIR_VR_2150_02 extends Validator<ESMAEMIRTransactionReport> {
	
	String NAME = "ESMAEMIRTransactionReportEMIR_VR_2150_02";
	String DEFINITION = "if IsVRAllowedForActionType(actionType) then if tranche = False then cdSIndexDetachmentPoint is absent";
	
	class Default implements ESMAEMIRTransactionReportEMIR_VR_2150_02 {
	...
	class NoOp implements ESMAEMIRTransactionReportEMIR_VR_2150_02 {
