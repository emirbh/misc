...
public class SECTransactionReportTradeTypeFormatValidator implements Validator<SECTransactionReportTrade> {
	...
	private List<ComparisonResult> getComparisonResults(SECTransactionReportTrade o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkString("priorUTI", o.getPriorUTI(), 1, of(52), of(Pattern.compile("[a-zA-Z0-9](?:[a-zA-Z0-9\\:.\\_-]{0,50}[a-zA-Z0-9])?"))), 
				...
				checkString("priorUSI", o.getPriorUSI(), 1, of(42), of(Pattern.compile("[a-zA-Z0-9](?:[a-zA-Z0-9\\:.\\_-]{0,40}[a-zA-Z0-9])?"))), 
				...
				checkString("clearingSwapUTIs", o.getClearingSwapUTIs(), 1, of(52), of(Pattern.compile("[a-zA-Z0-9]{1,52}")))
			);
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("SECTransactionReportTrade", ValidationResult.ValidationType.TYPE_FORMAT, "SECTransactionReportTrade", path, "", res.getError());
				}
				return success("SECTransactionReportTrade", ValidationResult.ValidationType.TYPE_FORMAT, "SECTransactionReportTrade", path, "");
			})
			.collect(toList());
	}
