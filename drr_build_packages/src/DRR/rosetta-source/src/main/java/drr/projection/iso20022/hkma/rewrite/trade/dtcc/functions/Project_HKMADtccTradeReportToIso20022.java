...
import drr.projection.iso20022.hkma.rewrite.trade.dtcc.labels.Project_HKMADtccTradeReportToIso20022LabelProvider;
...
@RuneLabelProvider(labelProvider=Project_HKMADtccTradeReportToIso20022LabelProvider.class)
@Projection(format = SerializationFormat.XML)
@ImplementedBy(Project_HKMADtccTradeReportToIso20022.Project_HKMADtccTradeReportToIso20022Default.class)
public abstract class Project_HKMADtccTradeReportToIso20022 implements RosettaFunction {
	...
	*/
	...
	public static class Project_HKMADtccTradeReportToIso20022Default extends Project_HKMADtccTradeReportToIso20022 {
		@Override
