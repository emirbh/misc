package drr.standards.iosco.cde.version2.valuation.reports;
...
public abstract class ValuationCurrencyRule implements ReportFunction<TransactionReportInstructionBase, ISOCurrencyCodeEnum> {
	...
	//
	@Inject protected drr.standards.iosco.cde.version1.valuation.reports.ValuationCurrencyRule valuationCurrencyRule;
