 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_DTCC_03")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_DTCC_03.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_DTCC_03 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_DTCC_03";
	String DEFINITION = "True";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_DTCC_03 {
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_DTCC_03 {
