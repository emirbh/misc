 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart43TransactionReportNotionalAmountScheduleCondition_02")
@ImplementedBy(CFTCPart43TransactionReportNotionalAmountScheduleCondition_02.Default.class)
public interface CFTCPart43TransactionReportNotionalAmountScheduleCondition_02 extends Validator<CFTCPart43TransactionReport> {
	
	String NAME = "CFTCPart43TransactionReportNotionalAmountScheduleCondition_02";
	String DEFINITION = "leg1 -> notionalAmountSchedule -> value count <= 10 and leg2 -> notionalAmountSchedule -> value count <= 10";
	
	class Default implements CFTCPart43TransactionReportNotionalAmountScheduleCondition_02 {
	...
	class NoOp implements CFTCPart43TransactionReportNotionalAmountScheduleCondition_02 {
