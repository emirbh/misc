 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportTradeDTCC_SEC_VR_PriorUSIIDPrefix")
@ImplementedBy(SECTransactionReportTradeDTCC_SEC_VR_PriorUSIIDPrefix.Default.class)
public interface SECTransactionReportTradeDTCC_SEC_VR_PriorUSIIDPrefix extends Validator<SECTransactionReportTrade> {
	
	String NAME = "SECTransactionReportTradeDTCC_SEC_VR_PriorUSIIDPrefix";
	String DEFINITION = "True";
	
	class Default implements SECTransactionReportTradeDTCC_SEC_VR_PriorUSIIDPrefix {
	...
	class NoOp implements SECTransactionReportTradeDTCC_SEC_VR_PriorUSIIDPrefix {
