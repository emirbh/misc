 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportTradeCSA_VR_0074_01")
@ImplementedBy(CSATransactionReportTradeCSA_VR_0074_01.Default.class)
public interface CSATransactionReportTradeCSA_VR_0074_01 extends Validator<CSATransactionReportTrade> {
	
	String NAME = "CSATransactionReportTradeCSA_VR_0074_01";
	...
	class Default implements CSATransactionReportTradeCSA_VR_0074_01 {
		...
		private ComparisonResult executeDataRule(CSATransactionReportTrade cSATransactionReportTrade) {
			try {
				if (areEqual(MapperS.of(cSATransactionReportTrade).<ClearedEnum>map("getCleared", _cSATransactionReportTrade -> _cSATransactionReportTrade.getCleared()), MapperS.of(ClearedEnum.Y), CardinalityOperator.All).getOrDefault(false)) {
					return exists(MapperS.of(cSATransactionReportTrade).<ClearingAccountOriginEnum>map("getClearingAccountOrigin", _cSATransactionReportTrade -> _cSATransactionReportTrade.getClearingAccountOrigin()));
				}
				if (areEqual(MapperS.of(cSATransactionReportTrade).<ClearedEnum>map("getCleared", _cSATransactionReportTrade -> _cSATransactionReportTrade.getCleared()), MapperS.of(ClearedEnum.I), CardinalityOperator.All).orNullSafe(areEqual(MapperS.of(cSATransactionReportTrade).<ClearedEnum>map("getCleared", _cSATransactionReportTrade -> _cSATransactionReportTrade.getCleared()), MapperS.of(ClearedEnum.N), CardinalityOperator.All)).getOrDefault(false)) {
					return notExists(MapperS.of(cSATransactionReportTrade).<ClearingAccountOriginEnum>map("getClearingAccountOrigin", _cSATransactionReportTrade -> _cSATransactionReportTrade.getClearingAccountOrigin()));
				}
	...
	class NoOp implements CSATransactionReportTradeCSA_VR_0074_01 {
