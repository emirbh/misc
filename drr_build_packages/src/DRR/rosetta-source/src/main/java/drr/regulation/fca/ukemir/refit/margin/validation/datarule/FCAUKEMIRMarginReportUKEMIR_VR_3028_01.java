 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3028_01")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3028_01.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3028_01 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3028_01";
	String DEFINITION = "if actionType exists then True";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3028_01 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRMarginReport fCAUKEMIRMarginReport) {
			try {
				if (exists(MapperS.of(fCAUKEMIRMarginReport).<MarginActionEnum>map("getActionType", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getActionType())).getOrDefault(false)) {
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3028_01 {
