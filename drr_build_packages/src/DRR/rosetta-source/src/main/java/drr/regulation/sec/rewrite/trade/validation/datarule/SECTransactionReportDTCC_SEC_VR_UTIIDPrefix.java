 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportDTCC_SEC_VR_UTIIDPrefix")
@ImplementedBy(SECTransactionReportDTCC_SEC_VR_UTIIDPrefix.Default.class)
public interface SECTransactionReportDTCC_SEC_VR_UTIIDPrefix extends Validator<SECTransactionReport> {
	
	String NAME = "SECTransactionReportDTCC_SEC_VR_UTIIDPrefix";
	String DEFINITION = "True";
	
	class Default implements SECTransactionReportDTCC_SEC_VR_UTIIDPrefix {
	...
	class NoOp implements SECTransactionReportDTCC_SEC_VR_UTIIDPrefix {
