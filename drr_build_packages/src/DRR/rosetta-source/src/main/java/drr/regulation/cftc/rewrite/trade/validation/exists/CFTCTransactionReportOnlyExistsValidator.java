...
public class CFTCTransactionReportOnlyExistsValidator implements ValidatorWithArg<CFTCTransactionReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CFTCTransactionReport> ValidationResult<CFTCTransactionReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CFTCTransactionReport", ValidationResult.ValidationType.ONLY_EXISTS, "CFTCTransactionReport", path, "");
		}
		return failure("CFTCTransactionReport", ValidationResult.ValidationType.ONLY_EXISTS, "CFTCTransactionReport", path, "",
