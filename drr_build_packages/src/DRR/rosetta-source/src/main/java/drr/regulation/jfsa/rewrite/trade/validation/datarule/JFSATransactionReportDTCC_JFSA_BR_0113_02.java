 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0113_02")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0113_02.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0113_02 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0113_02";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and [CommonAssetClass -> CRDT, CommonAssetClass -> EQUI] any = assetClass then (if underlyingIdentificationType = X and underlyingIdentification is absent then nameOfTheUnderlyingIndex exists)";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0113_02 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0113_02 {
