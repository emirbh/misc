 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRTransactionReportUKEMIR_VR_1009_04")
@ImplementedBy(FCAUKEMIRTransactionReportUKEMIR_VR_1009_04.Default.class)
public interface FCAUKEMIRTransactionReportUKEMIR_VR_1009_04 extends Validator<FCAUKEMIRTransactionReport> {
	
	String NAME = "FCAUKEMIRTransactionReportUKEMIR_VR_1009_04";
	String DEFINITION = "Counterparty2_04_Validation( nonReportable -> enrichment, counterparty2IdentifierType, counterparty2 )";
	
	class Default implements FCAUKEMIRTransactionReportUKEMIR_VR_1009_04 {
	...
	class NoOp implements FCAUKEMIRTransactionReportUKEMIR_VR_1009_04 {
