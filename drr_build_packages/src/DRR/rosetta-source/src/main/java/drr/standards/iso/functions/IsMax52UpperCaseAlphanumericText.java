...
@ImplementedBy(IsMax52UpperCaseAlphanumericText.IsMax52UpperCaseAlphanumericTextDefault.class)
public abstract class IsMax52UpperCaseAlphanumericText implements RosettaFunction {
	...
	*/
	...
	public static class IsMax52UpperCaseAlphanumericTextDefault extends IsMax52UpperCaseAlphanumericText {
		@Override
