 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportDTCC_SEC_VR_Comment1")
@ImplementedBy(SECTransactionReportDTCC_SEC_VR_Comment1.Default.class)
public interface SECTransactionReportDTCC_SEC_VR_Comment1 extends Validator<SECTransactionReport> {
	
	String NAME = "SECTransactionReportDTCC_SEC_VR_Comment1";
	String DEFINITION = "True";
	
	class Default implements SECTransactionReportDTCC_SEC_VR_Comment1 {
	...
	class NoOp implements SECTransactionReportDTCC_SEC_VR_Comment1 {
