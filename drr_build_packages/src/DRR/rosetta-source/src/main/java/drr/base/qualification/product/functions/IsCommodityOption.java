...
@ImplementedBy(IsCommodityOption.IsCommodityOptionDefault.class)
public abstract class IsCommodityOption implements RosettaFunction {
	...
	*/
	...
	public static class IsCommodityOptionDefault extends IsCommodityOption {
		@Override
		...
		protected Boolean assignOutput(Boolean result, NonTransferableProduct product) {
			result = areEqual(MapperS.of(qualify_Commodity_Option.evaluate(economicTermsForProduct.evaluate(product))), MapperS.of(true), CardinalityOperator.All).get();
