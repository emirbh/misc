 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0095")
@ImplementedBy(HKMATransactionReportDOC0095.Default.class)
public interface HKMATransactionReportDOC0095 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0095";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0095 {
	...
	class NoOp implements HKMATransactionReportDOC0095 {
