 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAValuationReportDOC0040")
@ImplementedBy(HKMAValuationReportDOC0040.Default.class)
public interface HKMAValuationReportDOC0040 extends Validator<HKMAValuationReport> {
	
	String NAME = "HKMAValuationReportDOC0040";
	String DEFINITION = "True";
	
	class Default implements HKMAValuationReportDOC0040 {
	...
	class NoOp implements HKMAValuationReportDOC0040 {
