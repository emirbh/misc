 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0115_02")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0115_02.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0115_02 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0115_02";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and assetClass = CommonAssetClass -> INTR and [CommonContractType -> SWAP, CommonContractType -> SWPT] any = contractType then (if leg2 -> fixedRate is absent and leg2 -> periodicPayment -> nameOfTheFloatingRate is absent then leg2 -> periodicPayment -> floatingRateIndicator exists)";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0115_02 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0115_02 {
