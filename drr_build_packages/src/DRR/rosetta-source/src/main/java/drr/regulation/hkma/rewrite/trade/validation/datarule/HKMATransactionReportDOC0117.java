 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0117")
@ImplementedBy(HKMATransactionReportDOC0117.Default.class)
public interface HKMATransactionReportDOC0117 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0117";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0117 {
	...
	class NoOp implements HKMATransactionReportDOC0117 {
