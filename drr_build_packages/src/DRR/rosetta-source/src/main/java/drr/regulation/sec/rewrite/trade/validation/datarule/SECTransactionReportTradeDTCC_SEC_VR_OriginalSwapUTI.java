 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportTradeDTCC_SEC_VR_OriginalSwapUTI")
@ImplementedBy(SECTransactionReportTradeDTCC_SEC_VR_OriginalSwapUTI.Default.class)
public interface SECTransactionReportTradeDTCC_SEC_VR_OriginalSwapUTI extends Validator<SECTransactionReportTrade> {
	
	String NAME = "SECTransactionReportTradeDTCC_SEC_VR_OriginalSwapUTI";
	...
	class Default implements SECTransactionReportTradeDTCC_SEC_VR_OriginalSwapUTI {
	...
	class NoOp implements SECTransactionReportTradeDTCC_SEC_VR_OriginalSwapUTI {
