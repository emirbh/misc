 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSAMarginReportDTCC_JFSA_BR_0049_01")
@ImplementedBy(JFSAMarginReportDTCC_JFSA_BR_0049_01.Default.class)
public interface JFSAMarginReportDTCC_JFSA_BR_0049_01 extends Validator<JFSAMarginReport> {
	
	String NAME = "JFSAMarginReportDTCC_JFSA_BR_0049_01";
	String DEFINITION = "MarginAmount_Validation( actionType, collateralisationCategory, initialMarginCollectedByCounterparty1PostHaircut, [CollateralisationType3Code -> OWC2, CollateralisationType3Code -> OWP2, CollateralisationType3Code -> FLCL] )";
	
	class Default implements JFSAMarginReportDTCC_JFSA_BR_0049_01 {
		...
		private ComparisonResult executeDataRule(JFSAMarginReport jFSAMarginReport) {
			try {
				return ComparisonResult.ofNullSafe(MapperS.of(marginAmount_Validation.evaluate(MapperS.of(jFSAMarginReport).<MarginActionEnum>map("getActionType", _jFSAMarginReport -> _jFSAMarginReport.getActionType()).get(), MapperS.of(jFSAMarginReport).<CollateralisationType3Code>map("getCollateralisationCategory", _jFSAMarginReport -> _jFSAMarginReport.getCollateralisationCategory()).get(), MapperS.of(jFSAMarginReport).<BigDecimal>map("getInitialMarginCollectedByCounterparty1PostHaircut", _jFSAMarginReport -> _jFSAMarginReport.getInitialMarginCollectedByCounterparty1PostHaircut()).get(), MapperC.<CollateralisationType3Code>of(MapperS.of(CollateralisationType3Code.OWC2), MapperS.of(CollateralisationType3Code.OWP2), MapperS.of(CollateralisationType3Code.FLCL)).getMulti())));
			}
			catch (Exception ex) {
	...
	class NoOp implements JFSAMarginReportDTCC_JFSA_BR_0049_01 {
