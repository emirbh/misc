...
import iso20022.auth030.hkma.tr.TradeData43__2;
import iso20022.auth030.hkma.tr.TradeData43__3;
import iso20022.auth030.hkma.tr.TradeData43__4;
import iso20022.auth030.hkma.tr.TradeData43__5;
import iso20022.auth030.hkma.tr.TradeData43__6;
...
public abstract class Create_TradeReport33Choice__1 implements RosettaFunction {
	...
	@Inject protected Create_SupplementaryData1 create_SupplementaryData1;
	...
	* @return rpt 
	*/
	public TradeReport33Choice__1 evaluate(HKMATransactionReport drrReport) {
	...
	protected abstract TradeReport33Choice__1.TradeReport33Choice__1Builder doEvaluate(HKMATransactionReport drrReport);

	protected abstract MapperS<ActionTypeEnum> actionType(HKMATransactionReport drrReport);

	public static class Create_TradeReport33Choice__1Default extends Create_TradeReport33Choice__1 {
		@Override
		protected TradeReport33Choice__1.TradeReport33Choice__1Builder doEvaluate(HKMATransactionReport drrReport) {
			TradeReport33Choice__1.TradeReport33Choice__1Builder rpt = TradeReport33Choice__1.builder();
			return assignOutput(rpt, drrReport);
		}
		
		protected TradeReport33Choice__1.TradeReport33Choice__1Builder assignOutput(TradeReport33Choice__1.TradeReport33Choice__1Builder rpt, HKMATransactionReport drrReport) {
			...
			if (areEqual(actionType(drrReport), MapperS.of(ActionTypeEnum.NEWT), CardinalityOperator.All).getOrDefault(false)) {
				ifThenElseResult0 = TradeData43__1.builder()
					...
					.setSplmtryData(create_SupplementaryData1.evaluate(drrReport))
					.build();
			}
		...
		@Override
		protected MapperS<ActionTypeEnum> actionType(HKMATransactionReport drrReport) {
			return MapperS.of(drrReport).<ActionTypeEnum>map("getActionType", hKMATransactionReport -> hKMATransactionReport.getActionType());
		}
	}
}
