 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASMarginReportDTCC_MAS_BR_0063_01")
@ImplementedBy(MASMarginReportDTCC_MAS_BR_0063_01.Default.class)
public interface MASMarginReportDTCC_MAS_BR_0063_01 extends Validator<MASMarginReport> {
	
	String NAME = "MASMarginReportDTCC_MAS_BR_0063_01";
	String DEFINITION = "if [MarginActionEnum -> CORR, MarginActionEnum -> MARU] any = actionType then if [CollateralisationType3Code -> OWC2, CollateralisationType3Code -> OWP2, CollateralisationType3Code -> FLCL] any = collateralisationCategory then initialMarginCollectedByCounterparty1PostHaircut exists and initialMarginCollectedByCounterparty1PostHaircut >= 0 else if [CollateralisationType3Code -> OWC2, CollateralisationType3Code -> OWP2, CollateralisationType3Code -> FLCL] all <> collateralisationCategory then initialMarginCollectedByCounterparty1PostHaircut is absent";
	
	class Default implements MASMarginReportDTCC_MAS_BR_0063_01 {
			...
			try {
				if (areEqual(MapperC.<MarginActionEnum>of(MapperS.of(MarginActionEnum.CORR), MapperS.of(MarginActionEnum.MARU)), MapperS.of(mASMarginReport).<MarginActionEnum>map("getActionType", _mASMarginReport -> _mASMarginReport.getActionType()), CardinalityOperator.Any).getOrDefault(false)) {
					if (areEqual(MapperC.<CollateralisationType3Code>of(MapperS.of(CollateralisationType3Code.OWC2), MapperS.of(CollateralisationType3Code.OWP2), MapperS.of(CollateralisationType3Code.FLCL)), MapperS.of(mASMarginReport).<CollateralisationType3Code>map("getCollateralisationCategory", _mASMarginReport -> _mASMarginReport.getCollateralisationCategory()), CardinalityOperator.Any).getOrDefault(false)) {
						return exists(MapperS.of(mASMarginReport).<BigDecimal>map("getInitialMarginCollectedByCounterparty1PostHaircut", _mASMarginReport -> _mASMarginReport.getInitialMarginCollectedByCounterparty1PostHaircut())).andNullSafe(greaterThanEquals(MapperS.of(mASMarginReport).<BigDecimal>map("getInitialMarginCollectedByCounterparty1PostHaircut", _mASMarginReport -> _mASMarginReport.getInitialMarginCollectedByCounterparty1PostHaircut()), MapperS.of(BigDecimal.valueOf(0)), CardinalityOperator.All));
					}
					if (notEqual(MapperC.<CollateralisationType3Code>of(MapperS.of(CollateralisationType3Code.OWC2), MapperS.of(CollateralisationType3Code.OWP2), MapperS.of(CollateralisationType3Code.FLCL)), MapperS.of(mASMarginReport).<CollateralisationType3Code>map("getCollateralisationCategory", _mASMarginReport -> _mASMarginReport.getCollateralisationCategory()), CardinalityOperator.All).getOrDefault(false)) {
						return notExists(MapperS.of(mASMarginReport).<BigDecimal>map("getInitialMarginCollectedByCounterparty1PostHaircut", _mASMarginReport -> _mASMarginReport.getInitialMarginCollectedByCounterparty1PostHaircut()));
					}
	...
	class NoOp implements MASMarginReportDTCC_MAS_BR_0063_01 {
