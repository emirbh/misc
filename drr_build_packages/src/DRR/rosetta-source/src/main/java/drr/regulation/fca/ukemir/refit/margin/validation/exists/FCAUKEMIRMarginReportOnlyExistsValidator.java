...
public class FCAUKEMIRMarginReportOnlyExistsValidator implements ValidatorWithArg<FCAUKEMIRMarginReport, Set<String>> {
	...
	public <T2 extends FCAUKEMIRMarginReport> ValidationResult<FCAUKEMIRMarginReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("nonReportable", ExistenceChecker.isSet((FCAUKEMIRNonReportableCollateralData) o.getNonReportable()))
				.put("executionAgentOfCounterparty1", ExistenceChecker.isSet((String) o.getExecutionAgentOfCounterparty1()))
				.put("executionAgentOfCounterparty2", ExistenceChecker.isSet((String) o.getExecutionAgentOfCounterparty2()))
				.build();
