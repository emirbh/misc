 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0112_2")
@ImplementedBy(HKMAMarginReportDOC0112_2.Default.class)
public interface HKMAMarginReportDOC0112_2 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0112_2";
	String DEFINITION = "if [MarginActionEnum -> MARU, MarginActionEnum -> CORR] any = actionType and uti exists then variationMarginCollateralPortfolioCode = \"NOAP\" else variationMarginCollateralPortfolioCode is absent";
	
	class Default implements HKMAMarginReportDOC0112_2 {
		...
		private ComparisonResult executeDataRule(HKMAMarginReport hKMAMarginReport) {
			try {
				if (areEqual(MapperC.<MarginActionEnum>of(MapperS.of(MarginActionEnum.MARU), MapperS.of(MarginActionEnum.CORR)), MapperS.of(hKMAMarginReport).<MarginActionEnum>map("getActionType", _hKMAMarginReport -> _hKMAMarginReport.getActionType()), CardinalityOperator.Any).andNullSafe(exists(MapperS.of(hKMAMarginReport).<String>map("getUti", _hKMAMarginReport -> _hKMAMarginReport.getUti()))).getOrDefault(false)) {
					return areEqual(MapperS.of(hKMAMarginReport).<String>map("getVariationMarginCollateralPortfolioCode", _hKMAMarginReport -> _hKMAMarginReport.getVariationMarginCollateralPortfolioCode()), MapperS.of("NOAP"), CardinalityOperator.All);
				}
				return notExists(MapperS.of(hKMAMarginReport).<String>map("getVariationMarginCollateralPortfolioCode", _hKMAMarginReport -> _hKMAMarginReport.getVariationMarginCollateralPortfolioCode()));
			}
			catch (Exception ex) {
	...
	class NoOp implements HKMAMarginReportDOC0112_2 {
