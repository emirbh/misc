 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0095_01")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0095_01.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0095_01 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0095_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then (if leg1 -> notionalAmountSchedule -> value count <> leg1 -> notionalAmountSchedule -> effectiveDate count then False)";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0095_01 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0095_01 {
