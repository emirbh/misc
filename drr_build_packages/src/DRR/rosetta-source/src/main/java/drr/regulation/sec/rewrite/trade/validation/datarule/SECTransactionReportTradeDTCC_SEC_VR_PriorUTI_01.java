 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportTradeDTCC_SEC_VR_PriorUTI_01")
@ImplementedBy(SECTransactionReportTradeDTCC_SEC_VR_PriorUTI_01.Default.class)
public interface SECTransactionReportTradeDTCC_SEC_VR_PriorUTI_01 extends Validator<SECTransactionReportTrade> {
	
	String NAME = "SECTransactionReportTradeDTCC_SEC_VR_PriorUTI_01";
	...
	class Default implements SECTransactionReportTradeDTCC_SEC_VR_PriorUTI_01 {
	...
	class NoOp implements SECTransactionReportTradeDTCC_SEC_VR_PriorUTI_01 {
