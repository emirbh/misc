 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportTradeDTCC_SEC_VR_PayerIdentifierLeg1")
@ImplementedBy(SECTransactionReportTradeDTCC_SEC_VR_PayerIdentifierLeg1.Default.class)
public interface SECTransactionReportTradeDTCC_SEC_VR_PayerIdentifierLeg1 extends Validator<SECTransactionReportTrade> {
	
	String NAME = "SECTransactionReportTradeDTCC_SEC_VR_PayerIdentifierLeg1";
	String DEFINITION = "if leg1 -> receiverIdentifier exists or (buyerIdentifier is absent and sellerIdentifier is absent) then leg1 -> payerIdentifier exists and (leg1 -> payerIdentifier = counterparty1 or leg1 -> payerIdentifier = counterparty2) else leg1 -> payerIdentifier is absent";
	
	class Default implements SECTransactionReportTradeDTCC_SEC_VR_PayerIdentifierLeg1 {
	...
	class NoOp implements SECTransactionReportTradeDTCC_SEC_VR_PayerIdentifierLeg1 {
