 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICValuationReportDTCC_ASIC_BR_1007_01")
@ImplementedBy(ASICValuationReportDTCC_ASIC_BR_1007_01.Default.class)
public interface ASICValuationReportDTCC_ASIC_BR_1007_01 extends Validator<ASICValuationReport> {
	
	String NAME = "ASICValuationReportDTCC_ASIC_BR_1007_01";
	String DEFINITION = "trade.party.Counterparty_Validation(actionType, counterparty1, counterparty2)";
	
	class Default implements ASICValuationReportDTCC_ASIC_BR_1007_01 {
	...
	class NoOp implements ASICValuationReportDTCC_ASIC_BR_1007_01 {
