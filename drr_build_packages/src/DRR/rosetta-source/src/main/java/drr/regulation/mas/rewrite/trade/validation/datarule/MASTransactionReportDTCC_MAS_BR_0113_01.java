 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0113_01")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0113_01.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0113_01 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0113_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and [CommonAssetClass -> INTR, CommonAssetClass -> CRDT, CommonAssetClass -> EQUI, CommonAssetClass -> COMM] any = assetClass and (leg1 -> periodicPayment -> floatingRateIdentifier exists or leg1 -> periodicPayment -> nameOfTheFloatingRate exists) then leg1 -> periodicPayment -> floatingRateDayCountConvention exists";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0113_01 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0113_01 {
