 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSAMarginReportDTCC_JFSA_BR_0045_01")
@ImplementedBy(JFSAMarginReportDTCC_JFSA_BR_0045_01.Default.class)
public interface JFSAMarginReportDTCC_JFSA_BR_0045_01 extends Validator<JFSAMarginReport> {
	
	String NAME = "JFSAMarginReportDTCC_JFSA_BR_0045_01";
	String DEFINITION = "MarginAmount_Validation( actionType, collateralisationCategory, initialMarginPostedByTheCounterparty1PreHaircut, [CollateralisationType3Code -> OWC1, CollateralisationType3Code -> OWP1, CollateralisationType3Code -> FLCL] )";
	
	class Default implements JFSAMarginReportDTCC_JFSA_BR_0045_01 {
	...
	class NoOp implements JFSAMarginReportDTCC_JFSA_BR_0045_01 {
