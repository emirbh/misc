 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICTransactionReportDTCC_ASIC_BR_1032_01")
@ImplementedBy(ASICTransactionReportDTCC_ASIC_BR_1032_01.Default.class)
public interface ASICTransactionReportDTCC_ASIC_BR_1032_01 extends Validator<ASICTransactionReport> {
	
	String NAME = "ASICTransactionReportDTCC_ASIC_BR_1032_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and (assetClass = CommonAssetClass -> CURR and contractType = CommonContractType -> OPTN) then if (nonReportable -> postUpiData -> Header -> InstrumentType = Option and putAmount is absent and nonReportable -> postUpiData -> Header -> UseCase <> Digital_Option) then (callAmount exists and callAmount > 0)";
	
	class Default implements ASICTransactionReportDTCC_ASIC_BR_1032_01 {
	...
	class NoOp implements ASICTransactionReportDTCC_ASIC_BR_1032_01 {
