package drr.regulation.jfsa.rewrite.valuation.validation.exists;
...
public class JFSAValuationReportOnlyExistsValidator implements ValidatorWithArg<JFSAValuationReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends JFSAValuationReport> ValidationResult<JFSAValuationReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("JFSAValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "JFSAValuationReport", path, "");
		}
		return failure("JFSAValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "JFSAValuationReport", path, "",
