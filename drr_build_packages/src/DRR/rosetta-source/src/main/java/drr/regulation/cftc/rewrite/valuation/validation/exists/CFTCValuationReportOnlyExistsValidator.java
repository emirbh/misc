package drr.regulation.cftc.rewrite.valuation.validation.exists;
...
public class CFTCValuationReportOnlyExistsValidator implements ValidatorWithArg<CFTCValuationReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CFTCValuationReport> ValidationResult<CFTCValuationReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CFTCValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "CFTCValuationReport", path, "");
		}
		return failure("CFTCValuationReport", ValidationResult.ValidationType.ONLY_EXISTS, "CFTCValuationReport", path, "",
