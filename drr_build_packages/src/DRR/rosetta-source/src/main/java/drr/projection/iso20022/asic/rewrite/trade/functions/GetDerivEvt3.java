...
public abstract class GetDerivEvt3 implements RosettaFunction {
	...
	* @return derivEvt 
	*/
	public DerivativeEvent6__3 evaluate(ASICTransactionReport drrReport) {
	...
	protected abstract DerivativeEvent6__3.DerivativeEvent6__3Builder doEvaluate(ASICTransactionReport drrReport);

	public static class GetDerivEvt3Default extends GetDerivEvt3 {
		@Override
		protected DerivativeEvent6__3.DerivativeEvent6__3Builder doEvaluate(ASICTransactionReport drrReport) {
		...
		protected DerivativeEvent6__3.DerivativeEvent6__3Builder assignOutput(DerivativeEvent6__3.DerivativeEvent6__3Builder derivEvt, ASICTransactionReport drrReport) {
