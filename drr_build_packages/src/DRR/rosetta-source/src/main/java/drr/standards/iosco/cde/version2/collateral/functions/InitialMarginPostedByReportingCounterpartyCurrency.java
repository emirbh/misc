...
public abstract class InitialMarginPostedByReportingCounterpartyCurrency implements RosettaFunction {
	...
	//
	@Inject protected drr.standards.iosco.cde.version1.collateral.functions.InitialMarginPostedByReportingCounterpartyCurrency initialMarginPostedByReportingCounterpartyCurrency;
