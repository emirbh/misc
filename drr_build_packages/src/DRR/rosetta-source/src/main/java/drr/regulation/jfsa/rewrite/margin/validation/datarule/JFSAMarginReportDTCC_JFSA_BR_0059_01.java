 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSAMarginReportDTCC_JFSA_BR_0059_01")
@ImplementedBy(JFSAMarginReportDTCC_JFSA_BR_0059_01.Default.class)
public interface JFSAMarginReportDTCC_JFSA_BR_0059_01 extends Validator<JFSAMarginReport> {
	
	String NAME = "JFSAMarginReportDTCC_JFSA_BR_0059_01";
	String DEFINITION = "if actionType = MarginActionEnum -> MARU then (if excessCollateralCollectedByTheCounterparty1 < 0 then False)";
	
	class Default implements JFSAMarginReportDTCC_JFSA_BR_0059_01 {
		...
		private ComparisonResult executeDataRule(JFSAMarginReport jFSAMarginReport) {
			try {
				if (areEqual(MapperS.of(jFSAMarginReport).<MarginActionEnum>map("getActionType", _jFSAMarginReport -> _jFSAMarginReport.getActionType()), MapperS.of(MarginActionEnum.MARU), CardinalityOperator.All).getOrDefault(false)) {
					if (lessThan(MapperS.of(jFSAMarginReport).<BigDecimal>map("getExcessCollateralCollectedByTheCounterparty1", _jFSAMarginReport -> _jFSAMarginReport.getExcessCollateralCollectedByTheCounterparty1()), MapperS.of(BigDecimal.valueOf(0)), CardinalityOperator.All).getOrDefault(false)) {
	...
	class NoOp implements JFSAMarginReportDTCC_JFSA_BR_0059_01 {
