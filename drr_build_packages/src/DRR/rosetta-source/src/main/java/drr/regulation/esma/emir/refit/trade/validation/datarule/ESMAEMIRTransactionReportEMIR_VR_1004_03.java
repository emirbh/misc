 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAEMIRTransactionReportEMIR_VR_1004_03")
@ImplementedBy(ESMAEMIRTransactionReportEMIR_VR_1004_03.Default.class)
public interface ESMAEMIRTransactionReportEMIR_VR_1004_03 extends Validator<ESMAEMIRTransactionReport> {
	
	String NAME = "ESMAEMIRTransactionReportEMIR_VR_1004_03";
	String DEFINITION = "if [ActionTypeEnum -> TERM, ActionTypeEnum -> REVI, ActionTypeEnum -> EROR] any = actionType then GetOrFetchLeiData(nonReportable -> enrichment -> leiData, counterparty1) exists";
	
	class Default implements ESMAEMIRTransactionReportEMIR_VR_1004_03 {
	...
	class NoOp implements ESMAEMIRTransactionReportEMIR_VR_1004_03 {
