 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3023_02")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3023_02.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3023_02 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3023_02";
	...
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3023_02 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRMarginReport fCAUKEMIRMarginReport) {
			try {
				if (areEqual(MapperC.<CollateralisationType3Code>of(MapperS.of(CollateralisationType3Code.PRC2), MapperS.of(CollateralisationType3Code.OWC2)), MapperS.of(fCAUKEMIRMarginReport).<CollateralisationType3Code>map("getCollateralisationCategory", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getCollateralisationCategory()), CardinalityOperator.Any).getOrDefault(false)) {
					return greaterThanEquals(MapperS.of(fCAUKEMIRMarginReport).<BigDecimal>map("getVariationMarginCollectedByTheCounterparty1PreHaircut", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getVariationMarginCollectedByTheCounterparty1PreHaircut()), MapperS.of(BigDecimal.valueOf(0)), CardinalityOperator.All);
				}
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3023_02 {
