...
import drr.projection.iso20022.esma.emir.refit.trade.labels.Project_EsmaEmirTradeReportToIso20022LabelProvider;
...
@RuneLabelProvider(labelProvider=Project_EsmaEmirTradeReportToIso20022LabelProvider.class)
@Projection(format = SerializationFormat.XML)
@ImplementedBy(Project_EsmaEmirTradeReportToIso20022.Project_EsmaEmirTradeReportToIso20022Default.class)
public abstract class Project_EsmaEmirTradeReportToIso20022 implements RosettaFunction {
	...
	*/
	public Document evaluate(ESMAEMIRTransactionReport drrReport) {
	...
	protected abstract Document.DocumentBuilder doEvaluate(ESMAEMIRTransactionReport drrReport);

	public static class Project_EsmaEmirTradeReportToIso20022Default extends Project_EsmaEmirTradeReportToIso20022 {
		@Override
		protected Document.DocumentBuilder doEvaluate(ESMAEMIRTransactionReport drrReport) {
			Document.DocumentBuilder iso20022Report = Document.builder();
			return assignOutput(iso20022Report, drrReport);
		}
		
		protected Document.DocumentBuilder assignOutput(Document.DocumentBuilder iso20022Report, ESMAEMIRTransactionReport drrReport) {
			iso20022Report
