...
@ImplementedBy(Counterparty2FormatRule.Counterparty2FormatRuleDefault.class)
public abstract class Counterparty2FormatRule implements ReportFunction<TransactionReportInstruction, PartyIdentifierFormatEnum> {
	...
	*/
	...
	public static class Counterparty2FormatRuleDefault extends Counterparty2FormatRule {
		@Override
