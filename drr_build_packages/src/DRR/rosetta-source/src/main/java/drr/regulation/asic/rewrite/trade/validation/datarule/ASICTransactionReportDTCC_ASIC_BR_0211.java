 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICTransactionReportDTCC_ASIC_BR_0211")
@ImplementedBy(ASICTransactionReportDTCC_ASIC_BR_0211.Default.class)
public interface ASICTransactionReportDTCC_ASIC_BR_0211 extends Validator<ASICTransactionReport> {
	
	String NAME = "ASICTransactionReportDTCC_ASIC_BR_0211";
	...
	class Default implements ASICTransactionReportDTCC_ASIC_BR_0211 {
	...
	class NoOp implements ASICTransactionReportDTCC_ASIC_BR_0211 {
