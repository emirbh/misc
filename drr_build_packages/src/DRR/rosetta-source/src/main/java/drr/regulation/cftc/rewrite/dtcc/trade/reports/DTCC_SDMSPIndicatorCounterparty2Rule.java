...
@ImplementedBy(DTCC_SDMSPIndicatorCounterparty2Rule.DTCC_SDMSPIndicatorCounterparty2RuleDefault.class)
public abstract class DTCC_SDMSPIndicatorCounterparty2Rule implements ReportFunction<TransactionReportInstruction, List<Boolean>> {
	...
	*/
	...
	public static class DTCC_SDMSPIndicatorCounterparty2RuleDefault extends DTCC_SDMSPIndicatorCounterparty2Rule {
		@Override
