 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0114_02")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0114_02.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0114_02 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0114_02";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and [CommonAssetClass -> INTR, CommonAssetClass -> CRDT, CommonAssetClass -> EQUI, CommonAssetClass -> COMM] any = assetClass and [CommonContractType -> SWAP, CommonContractType -> SWPT] any = contractType and (leg2 -> periodicPayment -> floatingRateIdentifier exists or leg2 -> periodicPayment -> nameOfTheFloatingRate exists) then leg2 -> periodicPayment -> floatingRateDayCountConvention exists";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0114_02 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0114_02 {
