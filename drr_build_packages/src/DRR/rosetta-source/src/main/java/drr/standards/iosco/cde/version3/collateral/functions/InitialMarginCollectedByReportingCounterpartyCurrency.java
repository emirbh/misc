...
public abstract class InitialMarginCollectedByReportingCounterpartyCurrency implements RosettaFunction {
	...
	//
	@Inject protected drr.standards.iosco.cde.version2.collateral.functions.InitialMarginCollectedByReportingCounterpartyCurrency initialMarginCollectedByReportingCounterpartyCurrency;
