...
@ImplementedBy(Counterparty2FederalEntityIndicatorRule.Counterparty2FederalEntityIndicatorRuleDefault.class)
public abstract class Counterparty2FederalEntityIndicatorRule implements ReportFunction<TransactionReportInstruction, Boolean> {
	...
	*/
	...
	public static class Counterparty2FederalEntityIndicatorRuleDefault extends Counterparty2FederalEntityIndicatorRule {
		@Override
