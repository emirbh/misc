...
public class JFSAValuationReportValidator implements Validator<JFSAValuationReport> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("JFSAValuationReport", ValidationResult.ValidationType.CARDINALITY, "JFSAValuationReport", path, "", res.getError());
				}
				return success("JFSAValuationReport", ValidationResult.ValidationType.CARDINALITY, "JFSAValuationReport", path, "");
			})
			.collect(toList());
	}
