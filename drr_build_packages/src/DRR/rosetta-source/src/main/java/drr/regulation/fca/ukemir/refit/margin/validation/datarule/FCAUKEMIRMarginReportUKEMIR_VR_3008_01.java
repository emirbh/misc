 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3008_01")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3008_01.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3008_01 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3008_01";
	String DEFINITION = "if collateralPortfolioIndicator exists then True";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3008_01 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRMarginReport fCAUKEMIRMarginReport) {
			try {
				if (exists(MapperS.of(fCAUKEMIRMarginReport).<Boolean>map("getCollateralPortfolioIndicator", _fCAUKEMIRMarginReport -> _fCAUKEMIRMarginReport.getCollateralPortfolioIndicator())).getOrDefault(false)) {
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3008_01 {
