package drr.regulation.common.emir.validation.exists;
...
public class EMIRTransactionReportOnlyExistsValidator implements ValidatorWithArg<EMIRTransactionReport, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends EMIRTransactionReport> ValidationResult<EMIRTransactionReport> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("EMIRTransactionReport", ValidationResult.ValidationType.ONLY_EXISTS, "EMIRTransactionReport", path, "");
		}
		return failure("EMIRTransactionReport", ValidationResult.ValidationType.ONLY_EXISTS, "EMIRTransactionReport", path, "",
