 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportTradeCSA_VR_0126_01")
@ImplementedBy(CSATransactionReportTradeCSA_VR_0126_01.Default.class)
public interface CSATransactionReportTradeCSA_VR_0126_01 extends Validator<CSATransactionReportTrade> {
	
	String NAME = "CSATransactionReportTradeCSA_VR_0126_01";
	String DEFINITION = "if basketConstituents -> identifier exists then basketConstituents -> numberOfUnits count = basketConstituents -> unitOfMeasure count and basketConstituents -> numberOfUnits count = basketConstituents -> identifier count and basketConstituents -> numberOfUnits count = basketConstituents -> source count else basketConstituents -> numberOfUnits is absent";
	
	class Default implements CSATransactionReportTradeCSA_VR_0126_01 {
	...
	class NoOp implements CSATransactionReportTradeCSA_VR_0126_01 {
