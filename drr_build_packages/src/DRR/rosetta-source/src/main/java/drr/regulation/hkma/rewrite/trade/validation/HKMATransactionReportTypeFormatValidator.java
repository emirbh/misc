...
public class HKMATransactionReportTypeFormatValidator implements Validator<HKMATransactionReport> {
	...
	private List<ComparisonResult> getComparisonResults(HKMATransactionReport o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkString("counterparty2Name", o.getCounterparty2Name(), 1, of(150), of(Pattern.compile("[ -~]{1,150}"))), 
				...
				checkString("nameOfTheUnderlyingIndex", o.getNameOfTheUnderlyingIndex(), 1, of(50), of(Pattern.compile("[ -~]{1,50}"))), 
				...
				checkString("uniqueProductIdentifier", o.getUniqueProductIdentifier(), 0, empty(), of(Pattern.compile("[ -~]*"))), 
				...
				checkNumber("basketConstituentNumberOfUnits", o.getBasketConstituentNumberOfUnits(), of(18), of(13), empty(), empty()), 
				checkString("basketConstituentUnitOfMeasure", o.getBasketConstituentUnitOfMeasure(), 1, of(4), empty()), 
				checkString("productDescription", o.getProductDescription(), 1, of(255), of(Pattern.compile("[a-zA-Z0-9]{1,255}"))), 
				checkString("beneficiary", o.getBeneficiary(), 1, of(72), of(Pattern.compile("[a-zA-Z0-9]{1,72}"))), 
				checkString("uniqueProductIdentifierProprietary", o.getUniqueProductIdentifierProprietary(), 1, of(100), of(Pattern.compile("[a-zA-Z0-9]{1,100}")))
			);
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("HKMATransactionReport", ValidationResult.ValidationType.TYPE_FORMAT, "HKMATransactionReport", path, "", res.getError());
				}
				return success("HKMATransactionReport", ValidationResult.ValidationType.TYPE_FORMAT, "HKMATransactionReport", path, "");
			})
			.collect(toList());
	}
