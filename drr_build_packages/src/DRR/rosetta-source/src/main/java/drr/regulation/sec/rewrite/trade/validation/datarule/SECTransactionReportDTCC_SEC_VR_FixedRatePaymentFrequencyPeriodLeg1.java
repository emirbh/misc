 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportDTCC_SEC_VR_FixedRatePaymentFrequencyPeriodLeg1")
@ImplementedBy(SECTransactionReportDTCC_SEC_VR_FixedRatePaymentFrequencyPeriodLeg1.Default.class)
public interface SECTransactionReportDTCC_SEC_VR_FixedRatePaymentFrequencyPeriodLeg1 extends Validator<SECTransactionReport> {
	
	String NAME = "SECTransactionReportDTCC_SEC_VR_FixedRatePaymentFrequencyPeriodLeg1";
	String DEFINITION = "if leg1 -> periodicPayment -> fixedRatePaymentFrequencyPeriod = EXPI then leg1 -> periodicPayment -> fixedRatePaymentFrequencyPeriodMultiplier = 1";
	
	class Default implements SECTransactionReportDTCC_SEC_VR_FixedRatePaymentFrequencyPeriodLeg1 {
	...
	class NoOp implements SECTransactionReportDTCC_SEC_VR_FixedRatePaymentFrequencyPeriodLeg1 {
