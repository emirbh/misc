 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRMarginReportUKEMIR_VR_3003_02")
@ImplementedBy(FCAUKEMIRMarginReportUKEMIR_VR_3003_02.Default.class)
public interface FCAUKEMIRMarginReportUKEMIR_VR_3003_02 extends Validator<FCAUKEMIRMarginReport> {
	
	String NAME = "FCAUKEMIRMarginReportUKEMIR_VR_3003_02";
	String DEFINITION = "[LeiRegistrationStatusEnum -> Issued, LeiRegistrationStatusEnum -> PendingTransfer, LeiRegistrationStatusEnum -> PendingArchival] contains API_GetLeiData( entityResponsibleForReporting ) -> registrationStatus";
	
	class Default implements FCAUKEMIRMarginReportUKEMIR_VR_3003_02 {
	...
	class NoOp implements FCAUKEMIRMarginReportUKEMIR_VR_3003_02 {
