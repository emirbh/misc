 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_0143_03")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_0143_03.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_0143_03 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_0143_03";
	String DEFINITION = "if [AnnaDsbAssetClassEnum -> Credit, AnnaDsbAssetClassEnum -> Rates, AnnaDsbAssetClassEnum -> Equity, AnnaDsbAssetClassEnum -> Commodities] any = nonReportable -> postUpiData -> Header -> AssetClass or [AssetClassEnum -> Credit, AssetClassEnum -> InterestRate, AssetClassEnum -> Equity, AssetClassEnum -> Commodity] any = dtccAdditionalFields -> primaryAssetClass then (if leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriod exists and leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriod <> ADHO then leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier exists else leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier is absent)";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_0143_03 {
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_0143_03 {
