...
@ImplementedBy(ClearingSwapUTIIDRule.ClearingSwapUTIIDRuleDefault.class)
public abstract class ClearingSwapUTIIDRule implements ReportFunction<TransactionReportInstruction, List<String>> {
	...
	*/
	...
	public static class ClearingSwapUTIIDRuleDefault extends ClearingSwapUTIIDRule {
		@Override
