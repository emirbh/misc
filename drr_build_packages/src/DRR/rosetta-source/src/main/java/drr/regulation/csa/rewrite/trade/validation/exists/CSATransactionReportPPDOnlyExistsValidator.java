...
public class CSATransactionReportPPDOnlyExistsValidator implements ValidatorWithArg<CSATransactionReportPPD, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CSATransactionReportPPD> ValidationResult<CSATransactionReportPPD> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CSATransactionReportPPD", ValidationResult.ValidationType.ONLY_EXISTS, "CSATransactionReportPPD", path, "");
		}
		return failure("CSATransactionReportPPD", ValidationResult.ValidationType.ONLY_EXISTS, "CSATransactionReportPPD", path, "",
