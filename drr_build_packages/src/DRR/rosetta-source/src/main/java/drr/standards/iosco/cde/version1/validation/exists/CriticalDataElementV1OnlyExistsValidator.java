package drr.standards.iosco.cde.version1.validation.exists;
...
public class CriticalDataElementV1OnlyExistsValidator implements ValidatorWithArg<CriticalDataElementV1, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CriticalDataElementV1> ValidationResult<CriticalDataElementV1> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("leg1", ExistenceChecker.isSet((LegV1) o.getLeg1()))
				.put("leg2", ExistenceChecker.isSet((LegV1) o.getLeg2()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CriticalDataElementV1", ValidationResult.ValidationType.ONLY_EXISTS, "CriticalDataElementV1", path, "");
		}
		return failure("CriticalDataElementV1", ValidationResult.ValidationType.ONLY_EXISTS, "CriticalDataElementV1", path, "",
