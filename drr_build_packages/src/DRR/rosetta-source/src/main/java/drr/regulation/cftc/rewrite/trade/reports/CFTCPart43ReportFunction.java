...
import drr.regulation.cftc.rewrite.dtcc.trade.reports.DTCC_MessageTypePPDRule;
...
import drr.regulation.cftc.rewrite.dtcc.trade.reports.DTCC_VersionPPDRule;
import drr.regulation.cftc.rewrite.trade.CFTCPart43TransactionReport;
import drr.regulation.cftc.rewrite.trade.labels.CFTCPart43LabelProvider;
...
@RosettaReport(namespace="drr.regulation.cftc.rewrite.trade", body="CFTC", corpusList={"Part43"})
...
public abstract class CFTCPart43ReportFunction implements ReportFunction<TransactionReportInstruction, CFTCPart43TransactionReport> {
	...
	@Inject protected OtherPaymentP43Rule otherPaymentP43Rule;
	...
	*/
	...
	public static class CFTCPart43ReportFunctionDefault extends CFTCPart43ReportFunction {
		...
		protected CFTCPart43TransactionReport.CFTCPart43TransactionReportBuilder assignOutput(CFTCPart43TransactionReport.CFTCPart43TransactionReportBuilder output, TransactionReportInstruction input) {
			...
			output
				.setOtherPayment(otherPaymentP43Rule.evaluate(input));
			...
			output
				.getOrCreateDtccAdditionalFields()
				.setMessageType(dTCC_MessageTypePPDRule.evaluate(input));
			...
			output
				.getOrCreateDtccAdditionalFields()
				.setVersion(dTCC_VersionPPDRule.evaluate(input));
