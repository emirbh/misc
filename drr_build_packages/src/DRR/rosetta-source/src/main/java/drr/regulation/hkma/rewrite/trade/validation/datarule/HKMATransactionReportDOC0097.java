 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0097")
@ImplementedBy(HKMATransactionReportDOC0097.Default.class)
public interface HKMATransactionReportDOC0097 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0097";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0097 {
	...
	class NoOp implements HKMATransactionReportDOC0097 {
