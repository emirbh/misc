...
public abstract class SecondaryTransactionIdentifierRule implements ReportFunction<TransactionReportInstruction, String> {
	...
	@Inject protected drr.regulation.common.trade.link.reports.SecondaryTransactionIdentifierRule secondaryTransactionIdentifierRule;
		...
		protected String assignOutput(String output, TransactionReportInstruction input) {
			...
			final FieldWithMetaString fieldWithMetaString = thenArg
				.mapSingleToItem(item -> {
					final String string = secondaryTransactionIdentifierRule.evaluate(item.get());
