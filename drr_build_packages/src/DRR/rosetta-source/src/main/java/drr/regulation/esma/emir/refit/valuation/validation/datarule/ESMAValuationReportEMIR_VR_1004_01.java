 ...
 * @version 7.7.0
 */
@RosettaDataRule("ESMAValuationReportEMIR_VR_1004_01")
@ImplementedBy(ESMAValuationReportEMIR_VR_1004_01.Default.class)
public interface ESMAValuationReportEMIR_VR_1004_01 extends Validator<ESMAValuationReport> {
	
	String NAME = "ESMAValuationReportEMIR_VR_1004_01";
	String DEFINITION = "Counterparty1_01_Validation(nonReportable -> enrichment, counterparty1)";
	
	class Default implements ESMAValuationReportEMIR_VR_1004_01 {
	...
	class NoOp implements ESMAValuationReportEMIR_VR_1004_01 {
