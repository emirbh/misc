...
import drr.regulation.common.trade.link.reports.ClearingSwapUTIIDRule;
	...
	*/
	...
	public static class ClearingSwapUTIsRuleDefault extends ClearingSwapUTIsRule {
		...
		protected List<String> assignOutput(List<String> output, TransactionReportInstruction input) {
			...
			output = thenArg
				.mapSingleToList(item -> MapperC.<FieldWithMetaString>of(clearingSwapUTIIDRule.evaluate(item.get()).stream()
