...
public abstract class Create_PartyIdentification248Choice__3 implements RosettaFunction {
	...
	* @return id 
	*/
	public PartyIdentification248Choice__3 evaluate(PartyIdentifierFormat2Enum idFormat, String idFromReport, String schemeName) {
	...
	protected abstract PartyIdentification248Choice__3.PartyIdentification248Choice__3Builder doEvaluate(PartyIdentifierFormat2Enum idFormat, String idFromReport, String schemeName);

	public static class Create_PartyIdentification248Choice__3Default extends Create_PartyIdentification248Choice__3 {
		@Override
		protected PartyIdentification248Choice__3.PartyIdentification248Choice__3Builder doEvaluate(PartyIdentifierFormat2Enum idFormat, String idFromReport, String schemeName) {
		...
		protected PartyIdentification248Choice__3.PartyIdentification248Choice__3Builder assignOutput(PartyIdentification248Choice__3.PartyIdentification248Choice__3Builder id, PartyIdentifierFormat2Enum idFormat, String idFromReport, String schemeName) {
