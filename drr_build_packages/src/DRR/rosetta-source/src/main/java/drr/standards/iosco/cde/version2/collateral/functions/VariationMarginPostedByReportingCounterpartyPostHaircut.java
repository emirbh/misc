...
public abstract class VariationMarginPostedByReportingCounterpartyPostHaircut implements RosettaFunction {
	...
	//
	@Inject protected drr.standards.iosco.cde.version1.collateral.functions.VariationMarginPostedByReportingCounterpartyPostHaircut variationMarginPostedByReportingCounterpartyPostHaircut;
