...
@ImplementedBy(FloatingRateIdentifierLeg1Rule.FloatingRateIdentifierLeg1RuleDefault.class)
public abstract class FloatingRateIdentifierLeg1Rule implements ReportFunction<TransactionReportInstruction, String> {
	...
	*/
	...
	public static class FloatingRateIdentifierLeg1RuleDefault extends FloatingRateIdentifierLeg1Rule {
		@Override
