...
public abstract class VariationMarginCollectedByReportingCounterpartyPostHaircut implements RosettaFunction {
	...
	//
	@Inject protected drr.standards.iosco.cde.version2.collateral.functions.VariationMarginCollectedByReportingCounterpartyPostHaircut variationMarginCollectedByReportingCounterpartyPostHaircut;
	...
	*/
	...
	public static class VariationMarginCollectedByReportingCounterpartyPostHaircutDefault extends VariationMarginCollectedByReportingCounterpartyPostHaircut {
		...
		protected BigDecimal assignOutput(BigDecimal marginValue, ReportableCollateralBase reportableCollateral, Party reportingCounterparty) {
			marginValue = variationMarginCollectedByReportingCounterpartyPostHaircut.evaluate(reportableCollateral, reportingCounterparty);
