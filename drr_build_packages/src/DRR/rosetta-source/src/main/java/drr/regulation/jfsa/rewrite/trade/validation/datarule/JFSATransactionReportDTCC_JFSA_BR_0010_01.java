...
import drr.regulation.common.trade.party.functions.Direction1_Validation;
 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0010_01")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0010_01.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0010_01 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0010_01";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI, ActionTypeEnum -> PRTO, ActionTypeEnum -> EROR, ActionTypeEnum -> TERM] any = actionType then common.party.Direction1_Validation( direction1, leg1 -> direction2, leg2 -> direction2 )";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0010_01 {
	
		@Inject protected Direction1_Validation direction1_Validation;
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0010_01 {
