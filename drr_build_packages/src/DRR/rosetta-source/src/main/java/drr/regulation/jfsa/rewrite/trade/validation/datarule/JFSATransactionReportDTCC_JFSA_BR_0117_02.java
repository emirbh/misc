 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0117_02")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0117_02.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0117_02 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0117_02";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and assetClass <> CommonAssetClass -> CURR then (if leg2 -> periodicPayment -> floatingRateReferencePeriodMultiplier exists then leg2 -> periodicPayment -> floatingRateReferencePeriod exists)";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0117_02 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0117_02 {
