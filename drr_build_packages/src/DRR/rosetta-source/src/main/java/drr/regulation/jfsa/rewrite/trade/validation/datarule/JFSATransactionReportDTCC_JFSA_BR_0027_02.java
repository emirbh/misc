 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0027_02")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0027_02.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0027_02 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0027_02";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and assetClass <> CURR then (if leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriod exists then leg1 -> periodicPayment -> floatingRateDayCountConvention exists)";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0027_02 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0027_02 {
