 ...
 * @version 7.7.0
 */
@RosettaDataRule("MASTransactionReportDTCC_MAS_BR_0101_03")
@ImplementedBy(MASTransactionReportDTCC_MAS_BR_0101_03.Default.class)
public interface MASTransactionReportDTCC_MAS_BR_0101_03 extends Validator<MASTransactionReport> {
	
	String NAME = "MASTransactionReportDTCC_MAS_BR_0101_03";
	String DEFINITION = "common.price.StrikePrice_Validation_03( actionType, contractType, strikePriceSchedule, strikePrice )";
	
	class Default implements MASTransactionReportDTCC_MAS_BR_0101_03 {
	...
	class NoOp implements MASTransactionReportDTCC_MAS_BR_0101_03 {
