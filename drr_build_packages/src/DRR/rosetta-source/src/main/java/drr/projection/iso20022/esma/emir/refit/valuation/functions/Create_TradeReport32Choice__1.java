...
public abstract class Create_TradeReport32Choice__1 implements RosettaFunction {
	...
	* @return rpt 
	*/
	public TradeReport32Choice__1 evaluate(ESMAValuationReport drrReport) {
	...
	protected abstract TradeReport32Choice__1.TradeReport32Choice__1Builder doEvaluate(ESMAValuationReport drrReport);

	protected abstract MapperS<ActionTypeEnum> actionType(ESMAValuationReport drrReport);

	protected abstract MapperS<ReportLevelEnum> lvl(ESMAValuationReport drrReport);

	public static class Create_TradeReport32Choice__1Default extends Create_TradeReport32Choice__1 {
		@Override
		protected TradeReport32Choice__1.TradeReport32Choice__1Builder doEvaluate(ESMAValuationReport drrReport) {
			TradeReport32Choice__1.TradeReport32Choice__1Builder rpt = TradeReport32Choice__1.builder();
			return assignOutput(rpt, drrReport);
		}
		
		protected TradeReport32Choice__1.TradeReport32Choice__1Builder assignOutput(TradeReport32Choice__1.TradeReport32Choice__1Builder rpt, ESMAValuationReport drrReport) {
		...
		@Override
		protected MapperS<ActionTypeEnum> actionType(ESMAValuationReport drrReport) {
			return MapperS.of(drrReport).<ActionTypeEnum>map("getActionType", eSMAValuationReport -> eSMAValuationReport.getActionType());
		}
		
		@Override
		protected MapperS<ReportLevelEnum> lvl(ESMAValuationReport drrReport) {
			return MapperS.of(drrReport).<ReportLevelEnum>map("getLevel", eSMAValuationReport -> eSMAValuationReport.getLevel());
		}
	}
}
