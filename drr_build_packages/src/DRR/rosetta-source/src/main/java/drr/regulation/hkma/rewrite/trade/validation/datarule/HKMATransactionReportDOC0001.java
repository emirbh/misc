 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0001")
@ImplementedBy(HKMATransactionReportDOC0001.Default.class)
public interface HKMATransactionReportDOC0001 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0001";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then expirationDate >= executionTimestamp -> date";
	
	class Default implements HKMATransactionReportDOC0001 {
	...
	class NoOp implements HKMATransactionReportDOC0001 {
