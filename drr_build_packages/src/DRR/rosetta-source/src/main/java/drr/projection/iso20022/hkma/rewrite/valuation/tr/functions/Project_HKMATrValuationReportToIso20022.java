...
import drr.projection.iso20022.hkma.rewrite.valuation.tr.labels.Project_HKMATrValuationReportToIso20022LabelProvider;
...
@RuneLabelProvider(labelProvider=Project_HKMATrValuationReportToIso20022LabelProvider.class)
@Projection(format = SerializationFormat.XML)
@ImplementedBy(Project_HKMATrValuationReportToIso20022.Project_HKMATrValuationReportToIso20022Default.class)
public abstract class Project_HKMATrValuationReportToIso20022 implements RosettaFunction {
	...
	*/
	...
	public static class Project_HKMATrValuationReportToIso20022Default extends Project_HKMATrValuationReportToIso20022 {
		@Override
