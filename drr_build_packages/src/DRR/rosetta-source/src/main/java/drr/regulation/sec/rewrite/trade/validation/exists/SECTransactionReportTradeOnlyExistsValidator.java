...
public class SECTransactionReportTradeOnlyExistsValidator implements ValidatorWithArg<SECTransactionReportTrade, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends SECTransactionReportTrade> ValidationResult<SECTransactionReportTrade> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("clearingSwapUSIs", ExistenceChecker.isSet((List<String>) o.getClearingSwapUSIs()))
				.put("clearingSwapUTIs", ExistenceChecker.isSet((List<String>) o.getClearingSwapUTIs()))
				.put("originalSwapUSI", ExistenceChecker.isSet((String) o.getOriginalSwapUSI()))
				.put("allocationIndicator", ExistenceChecker.isSet((AllocationIndicatorEnum) o.getAllocationIndicator()))
				.put("jurisdiction", ExistenceChecker.isSet((JurisdictionEnum) o.getJurisdiction()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("SECTransactionReportTrade", ValidationResult.ValidationType.ONLY_EXISTS, "SECTransactionReportTrade", path, "");
		}
		return failure("SECTransactionReportTrade", ValidationResult.ValidationType.ONLY_EXISTS, "SECTransactionReportTrade", path, "",
