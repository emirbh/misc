...
import iso20022.auth030.hkma.dtcc.OrganisationIdentification38__1;
...
public abstract class Create_OrganisationIdentification15Choice__2 implements RosettaFunction {
	...
	* @return id 
	*/
	public OrganisationIdentification15Choice__2 evaluate(HKMAValuationReport drrReport, PartyIdentifierFormat2Enum idFormat, String idFromReport, String schemeName) {
	...
	protected abstract OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder doEvaluate(HKMAValuationReport drrReport, PartyIdentifierFormat2Enum idFormat, String idFromReport, String schemeName);
	...
	public static class Create_OrganisationIdentification15Choice__2Default extends Create_OrganisationIdentification15Choice__2 {
		@Override
		protected OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder doEvaluate(HKMAValuationReport drrReport, PartyIdentifierFormat2Enum idFormat, String idFromReport, String schemeName) {
		...
		protected OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder assignOutput(OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder id, HKMAValuationReport drrReport, PartyIdentifierFormat2Enum idFormat, String idFromReport, String schemeName) {
			...
			if (areEqual(MapperS.of(idFormat), MapperS.of(PartyIdentifierFormat2Enum.OTHER), CardinalityOperator.All).getOrDefault(false)) {
				ifThenElseResult1 = OrganisationIdentification38__1.builder()
					.setId(GenericIdentification175__2.builder()
						...
						.build())
					.setNm(MapperS.of(drrReport).<String>map("getCounterparty2Name", hKMAValuationReport -> hKMAValuationReport.getCounterparty2Name()).get())
					.build();
			}
