 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMAMarginReportDOC0114")
@ImplementedBy(HKMAMarginReportDOC0114.Default.class)
public interface HKMAMarginReportDOC0114 extends Validator<HKMAMarginReport> {
	
	String NAME = "HKMAMarginReportDOC0114";
	String DEFINITION = "True";
	
	class Default implements HKMAMarginReportDOC0114 {
	...
	class NoOp implements HKMAMarginReportDOC0114 {
