...
public abstract class GetDerivEvt2 implements RosettaFunction {
	...
	* @return derivEvt 
	*/
	public DerivativeEvent6__2 evaluate(MASValuationReport drrReport) {
	...
	protected abstract DerivativeEvent6__2.DerivativeEvent6__2Builder doEvaluate(MASValuationReport drrReport);

	public static class GetDerivEvt2Default extends GetDerivEvt2 {
		@Override
		protected DerivativeEvent6__2.DerivativeEvent6__2Builder doEvaluate(MASValuationReport drrReport) {
		...
		protected DerivativeEvent6__2.DerivativeEvent6__2Builder assignOutput(DerivativeEvent6__2.DerivativeEvent6__2Builder derivEvt, MASValuationReport drrReport) {
