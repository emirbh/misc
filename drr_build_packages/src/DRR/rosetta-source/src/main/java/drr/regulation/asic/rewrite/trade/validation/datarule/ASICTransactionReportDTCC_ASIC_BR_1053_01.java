 ...
 * @version 7.7.0
 */
@RosettaDataRule("ASICTransactionReportDTCC_ASIC_BR_1053_01")
@ImplementedBy(ASICTransactionReportDTCC_ASIC_BR_1053_01.Default.class)
public interface ASICTransactionReportDTCC_ASIC_BR_1053_01 extends Validator<ASICTransactionReport> {
	
	String NAME = "ASICTransactionReportDTCC_ASIC_BR_1053_01";
	...
	class Default implements ASICTransactionReportDTCC_ASIC_BR_1053_01 {
	...
	class NoOp implements ASICTransactionReportDTCC_ASIC_BR_1053_01 {
