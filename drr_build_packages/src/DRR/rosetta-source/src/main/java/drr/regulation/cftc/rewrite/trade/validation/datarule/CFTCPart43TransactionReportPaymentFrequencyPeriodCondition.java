 ...
 * @version 7.7.0
 */
@RosettaDataRule("CFTCPart43TransactionReportPaymentFrequencyPeriodCondition")
@ImplementedBy(CFTCPart43TransactionReportPaymentFrequencyPeriodCondition.Default.class)
public interface CFTCPart43TransactionReportPaymentFrequencyPeriodCondition extends Validator<CFTCPart43TransactionReport> {
	
	String NAME = "CFTCPart43TransactionReportPaymentFrequencyPeriodCondition";
	...
	class Default implements CFTCPart43TransactionReportPaymentFrequencyPeriodCondition {
	...
	class NoOp implements CFTCPart43TransactionReportPaymentFrequencyPeriodCondition {
