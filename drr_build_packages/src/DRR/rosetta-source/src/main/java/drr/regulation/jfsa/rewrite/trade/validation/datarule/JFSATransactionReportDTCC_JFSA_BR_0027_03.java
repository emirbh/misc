 ...
 * @version 7.7.0
 */
@RosettaDataRule("JFSATransactionReportDTCC_JFSA_BR_0027_03")
@ImplementedBy(JFSATransactionReportDTCC_JFSA_BR_0027_03.Default.class)
public interface JFSATransactionReportDTCC_JFSA_BR_0027_03 extends Validator<JFSATransactionReport> {
	
	String NAME = "JFSATransactionReportDTCC_JFSA_BR_0027_03";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType and assetClass <> CURR then (if leg2 -> periodicPayment -> fixedRatePaymentFrequencyPeriod exists then leg2 -> periodicPayment -> fixedRateDayCountConvention exists)";
	
	class Default implements JFSATransactionReportDTCC_JFSA_BR_0027_03 {
	...
	class NoOp implements JFSATransactionReportDTCC_JFSA_BR_0027_03 {
