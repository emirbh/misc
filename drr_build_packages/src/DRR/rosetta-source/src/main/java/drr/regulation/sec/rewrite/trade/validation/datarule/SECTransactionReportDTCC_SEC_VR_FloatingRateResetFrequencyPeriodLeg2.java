 ...
 * @version 7.7.0
 */
@RosettaDataRule("SECTransactionReportDTCC_SEC_VR_FloatingRateResetFrequencyPeriodLeg2")
@ImplementedBy(SECTransactionReportDTCC_SEC_VR_FloatingRateResetFrequencyPeriodLeg2.Default.class)
public interface SECTransactionReportDTCC_SEC_VR_FloatingRateResetFrequencyPeriodLeg2 extends Validator<SECTransactionReport> {
	
	String NAME = "SECTransactionReportDTCC_SEC_VR_FloatingRateResetFrequencyPeriodLeg2";
	String DEFINITION = "if ((nonReportable -> postUpiData -> Header -> InstrumentType = Swap or nonReportable -> instrumentType = Swap) and (nonReportable -> postUpiData -> Derived -> UnderlyingAssetType exists and nonReportable -> postUpiData -> Derived -> UnderlyingAssetType <> Fixed_Fixed or nonReportable -> underlyingAssetType <> \"Fixed_Fixed\")) and (leg1 -> periodicPayment -> floatingRateResetFrequencyPeriod is absent) then leg2 -> periodicPayment -> floatingRateResetFrequencyPeriod exists and (if leg2 -> periodicPayment -> floatingRateResetFrequencyPeriod = EXPI then leg2 -> periodicPayment -> floatingRateResetFrequencyMultiplier = 1 else True) else leg2 -> periodicPayment -> floatingRateResetFrequencyPeriod is absent";
	
	class Default implements SECTransactionReportDTCC_SEC_VR_FloatingRateResetFrequencyPeriodLeg2 {
	...
	class NoOp implements SECTransactionReportDTCC_SEC_VR_FloatingRateResetFrequencyPeriodLeg2 {
