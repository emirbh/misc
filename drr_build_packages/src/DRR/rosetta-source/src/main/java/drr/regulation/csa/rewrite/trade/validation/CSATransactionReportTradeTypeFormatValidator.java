...
public class CSATransactionReportTradeTypeFormatValidator implements Validator<CSATransactionReportTrade> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CSATransactionReportTrade", ValidationResult.ValidationType.TYPE_FORMAT, "CSATransactionReportTrade", path, "", res.getError());
				}
				return success("CSATransactionReportTrade", ValidationResult.ValidationType.TYPE_FORMAT, "CSATransactionReportTrade", path, "");
			})
			.collect(toList());
	}
