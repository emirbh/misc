...
@ImplementedBy(UnderlyingRule.UnderlyingRuleDefault.class)
public abstract class UnderlyingRule implements ReportFunction<TransactionReportInstruction, String> {
	...
	*/
	...
	public static class UnderlyingRuleDefault extends UnderlyingRule {
		@Override
