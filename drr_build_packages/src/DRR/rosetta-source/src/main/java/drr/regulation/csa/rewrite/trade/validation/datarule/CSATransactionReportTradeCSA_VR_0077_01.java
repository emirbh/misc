 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportTradeCSA_VR_0077_01")
@ImplementedBy(CSATransactionReportTradeCSA_VR_0077_01.Default.class)
public interface CSATransactionReportTradeCSA_VR_0077_01 extends Validator<CSATransactionReportTrade> {
	
	String NAME = "CSATransactionReportTradeCSA_VR_0077_01";
	String DEFINITION = "if cleared = Y or cleared = I then clearingExceptionsAndExemptionsCounterparty1 is absent";
	
	class Default implements CSATransactionReportTradeCSA_VR_0077_01 {
		...
		private ComparisonResult executeDataRule(CSATransactionReportTrade cSATransactionReportTrade) {
			try {
				if (areEqual(MapperS.of(cSATransactionReportTrade).<ClearedEnum>map("getCleared", _cSATransactionReportTrade -> _cSATransactionReportTrade.getCleared()), MapperS.of(ClearedEnum.Y), CardinalityOperator.All).orNullSafe(areEqual(MapperS.of(cSATransactionReportTrade).<ClearedEnum>map("getCleared", _cSATransactionReportTrade -> _cSATransactionReportTrade.getCleared()), MapperS.of(ClearedEnum.I), CardinalityOperator.All)).getOrDefault(false)) {
					return notExists(MapperS.of(cSATransactionReportTrade).<ClearingExceptionsAndExemptionsEnum>mapC("getClearingExceptionsAndExemptionsCounterparty1", _cSATransactionReportTrade -> _cSATransactionReportTrade.getClearingExceptionsAndExemptionsCounterparty1()));
				}
	...
	class NoOp implements CSATransactionReportTradeCSA_VR_0077_01 {
