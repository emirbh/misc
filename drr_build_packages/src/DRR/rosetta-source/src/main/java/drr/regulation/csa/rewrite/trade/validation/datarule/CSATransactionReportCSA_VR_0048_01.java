 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportCSA_VR_0048_01")
@ImplementedBy(CSATransactionReportCSA_VR_0048_01.Default.class)
public interface CSATransactionReportCSA_VR_0048_01 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportCSA_VR_0048_01";
	String DEFINITION = "if ([AnnaDsbAssetClassEnum -> Equity, AnnaDsbAssetClassEnum -> Commodities] any = nonReportable -> postUpiData -> Header -> AssetClass or [AssetClassEnum -> Equity, AssetClassEnum -> Commodity] any = dtccAdditionalFields -> primaryAssetClass) and price exists then priceNotation exists else priceNotation is absent";
	
	class Default implements CSATransactionReportCSA_VR_0048_01 {
	...
	class NoOp implements CSATransactionReportCSA_VR_0048_01 {
