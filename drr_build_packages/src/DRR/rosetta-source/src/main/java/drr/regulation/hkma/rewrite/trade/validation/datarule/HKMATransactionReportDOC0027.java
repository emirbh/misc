 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0027")
@ImplementedBy(HKMATransactionReportDOC0027.Default.class)
public interface HKMATransactionReportDOC0027 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0027";
	String DEFINITION = "if [ActionTypeEnum -> NEWT, ActionTypeEnum -> MODI, ActionTypeEnum -> CORR, ActionTypeEnum -> REVI] any = actionType then if leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriodMultiplier exists then leg1 -> periodicPayment -> floatingRatePaymentFrequencyPeriod exists";
	
	class Default implements HKMATransactionReportDOC0027 {
	...
	class NoOp implements HKMATransactionReportDOC0027 {
