 ...
 * @version 7.7.0
 */
@RosettaDataRule("FCAUKEMIRTransactionReportUKEMIR_VR_1006_01")
@ImplementedBy(FCAUKEMIRTransactionReportUKEMIR_VR_1006_01.Default.class)
public interface FCAUKEMIRTransactionReportUKEMIR_VR_1006_01 extends Validator<FCAUKEMIRTransactionReport> {
	
	String NAME = "FCAUKEMIRTransactionReportUKEMIR_VR_1006_01";
	...
	class Default implements FCAUKEMIRTransactionReportUKEMIR_VR_1006_01 {
		...
		private ComparisonResult executeDataRule(FCAUKEMIRTransactionReport fCAUKEMIRTransactionReport) {
			try {
				...
				if ((_boolean == null ? false : _boolean)) {
					if (areEqual(MapperS.of(fCAUKEMIRTransactionReport).<NatureOfCounterpartyEnum>map("getNatureOfCounterparty1", _fCAUKEMIRTransactionReport -> _fCAUKEMIRTransactionReport.getNatureOfCounterparty1()), MapperS.of(NatureOfCounterpartyEnum.F), CardinalityOperator.All).andNullSafe(exists(MapperS.of(fCAUKEMIRTransactionReport).<String>mapC("getCorporateSectorOfTheCounterparty1", _fCAUKEMIRTransactionReport -> _fCAUKEMIRTransactionReport.getCorporateSectorOfTheCounterparty1()))).getOrDefault(false)) {
	...
	class NoOp implements FCAUKEMIRTransactionReportUKEMIR_VR_1006_01 {
