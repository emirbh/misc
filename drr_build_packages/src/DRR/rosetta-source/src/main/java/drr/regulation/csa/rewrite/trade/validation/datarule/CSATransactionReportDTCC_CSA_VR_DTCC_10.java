 ...
 * @version 7.7.0
 */
@RosettaDataRule("CSATransactionReportDTCC_CSA_VR_DTCC_10")
@ImplementedBy(CSATransactionReportDTCC_CSA_VR_DTCC_10.Default.class)
public interface CSATransactionReportDTCC_CSA_VR_DTCC_10 extends Validator<CSATransactionReport> {
	
	String NAME = "CSATransactionReportDTCC_CSA_VR_DTCC_10";
	String DEFINITION = "True";
	
	class Default implements CSATransactionReportDTCC_CSA_VR_DTCC_10 {
	...
	class NoOp implements CSATransactionReportDTCC_CSA_VR_DTCC_10 {
