 ...
 * @version 7.7.0
 */
@RosettaDataRule("HKMATransactionReportDOC0115")
@ImplementedBy(HKMATransactionReportDOC0115.Default.class)
public interface HKMATransactionReportDOC0115 extends Validator<HKMATransactionReport> {
	
	String NAME = "HKMATransactionReportDOC0115";
	String DEFINITION = "True";
	
	class Default implements HKMATransactionReportDOC0115 {
	...
	class NoOp implements HKMATransactionReportDOC0115 {
