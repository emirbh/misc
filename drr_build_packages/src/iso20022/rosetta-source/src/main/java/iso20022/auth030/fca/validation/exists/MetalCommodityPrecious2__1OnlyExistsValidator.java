...
public class MetalCommodityPrecious2__1OnlyExistsValidator implements ValidatorWithArg<MetalCommodityPrecious2__1, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends MetalCommodityPrecious2__1> ValidationResult<MetalCommodityPrecious2__1> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("MetalCommodityPrecious2__1", ValidationResult.ValidationType.ONLY_EXISTS, "MetalCommodityPrecious2__1", path, "");
		}
		return failure("MetalCommodityPrecious2__1", ValidationResult.ValidationType.ONLY_EXISTS, "MetalCommodityPrecious2__1", path, "",
