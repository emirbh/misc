...
public class TradeTransaction49__3Validator implements Validator<TradeTransaction49__3> {
	...
	private List<ComparisonResult> getComparisonResults(TradeTransaction49__3 o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("cmmdty", (AssetClassCommodity6Choice__2) o.getCmmdty() != null ? 1 : 0, 0, 1), 
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeTransaction49__3", ValidationResult.ValidationType.CARDINALITY, "TradeTransaction49__3", path, "", res.getError());
				}
				return success("TradeTransaction49__3", ValidationResult.ValidationType.CARDINALITY, "TradeTransaction49__3", path, "");
			})
			.collect(toList());
	}
