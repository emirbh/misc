...
public class TradeTransaction50__8Validator implements Validator<TradeTransaction50__8> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeTransaction50__8", ValidationResult.ValidationType.CARDINALITY, "TradeTransaction50__8", path, "", res.getError());
				}
				return success("TradeTransaction50__8", ValidationResult.ValidationType.CARDINALITY, "TradeTransaction50__8", path, "");
			})
			.collect(toList());
	}
