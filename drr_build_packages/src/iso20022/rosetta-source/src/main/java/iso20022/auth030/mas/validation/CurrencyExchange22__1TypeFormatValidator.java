		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CurrencyExchange22__1", ValidationResult.ValidationType.TYPE_FORMAT, "CurrencyExchange22__1", path, "", res.getError());
				}
				return success("CurrencyExchange22__1", ValidationResult.ValidationType.TYPE_FORMAT, "CurrencyExchange22__1", path, "");
			})
			.collect(toList());
	}
