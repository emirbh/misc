...
import iso20022.auth030.hkma.tr.meta.FertilizerCommodityPotash2Meta;
...
@RuneDataType(value="FertilizerCommodityPotash2", model="iso20022", builder=FertilizerCommodityPotash2.FertilizerCommodityPotash2BuilderImpl.class, version="${project.version}")
