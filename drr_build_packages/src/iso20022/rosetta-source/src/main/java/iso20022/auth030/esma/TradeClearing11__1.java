...
import iso20022.auth030.esma.meta.TradeClearing11__1Meta;
...
public interface TradeClearing11__1 extends RosettaModelObject {
	 ...
	 */
	ClearingObligationType1Code getClrOblgtn();
	/**
	...
	default void process(RosettaPath path, Processor processor) {
		processor.processBasic(path.newSubPath("clrOblgtn"), ClearingObligationType1Code.class, getClrOblgtn(), this);
	...
	interface TradeClearing11__1Builder extends TradeClearing11__1, RosettaModelObjectBuilder {
		...
		TradeClearing11__1.TradeClearing11__1Builder setClrOblgtn(ClearingObligationType1Code clrOblgtn);
	...
	class TradeClearing11__1Impl implements TradeClearing11__1 {
		private final ClearingObligationType1Code clrOblgtn;
		...
		protected void setBuilderFields(TradeClearing11__1.TradeClearing11__1Builder builder) {
			ofNullable(getClrOblgtn()).ifPresent(builder::setClrOblgtn);
		...
		public boolean equals(Object o) {
			...
			if (!Objects.equals(clrOblgtn, _that.getClrOblgtn())) return false;
		...
		public int hashCode() {
			int _result = 0;
			_result = 31 * _result + (clrOblgtn != null ? clrOblgtn.getClass().getName().hashCode() : 0);
	...
	class TradeClearing11__1BuilderImpl implements TradeClearing11__1.TradeClearing11__1Builder {
		...
		@RuneAttribute("clrOblgtn")
		@Override
		public TradeClearing11__1.TradeClearing11__1Builder setClrOblgtn(ClearingObligationType1Code _clrOblgtn) {
			this.clrOblgtn = _clrOblgtn == null ? null : _clrOblgtn;
			return this;
		}
		...
		public boolean hasData() {
			if (getClrOblgtn()!=null) return true;
		...
		public TradeClearing11__1.TradeClearing11__1Builder merge(RosettaModelObjectBuilder other, BuilderMerger merger) {
			...
			merger.mergeBasic(getClrOblgtn(), o.getClrOblgtn(), this::setClrOblgtn);
