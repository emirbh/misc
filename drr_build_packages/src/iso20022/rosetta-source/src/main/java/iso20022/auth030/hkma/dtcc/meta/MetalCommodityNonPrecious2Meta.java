...
import iso20022.auth030.hkma.dtcc.validation.MetalCommodityNonPrecious2TypeFormatValidator;
import iso20022.auth030.hkma.dtcc.validation.MetalCommodityNonPrecious2Validator;
import iso20022.auth030.hkma.dtcc.validation.exists.MetalCommodityNonPrecious2OnlyExistsValidator;
...
public class MetalCommodityNonPrecious2Meta implements RosettaMetaData<MetalCommodityNonPrecious2> {
	...
	@Override
	public Validator<? super MetalCommodityNonPrecious2> validator(ValidatorFactory factory) {
		return factory.<MetalCommodityNonPrecious2>create(MetalCommodityNonPrecious2Validator.class);
	}

	@Override
	public Validator<? super MetalCommodityNonPrecious2> typeFormatValidator(ValidatorFactory factory) {
		return factory.<MetalCommodityNonPrecious2>create(MetalCommodityNonPrecious2TypeFormatValidator.class);
	}
