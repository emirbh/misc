...
public class Counterparty45__1Validator implements Validator<Counterparty45__1> {
	...
	private List<ComparisonResult> getComparisonResults(Counterparty45__1 o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("tradgCpcty", (TradingCapacity7Code) o.getTradgCpcty() != null ? 1 : 0, 1, 1), 
				checkCardinality("drctnOrSd", (Direction4Choice) o.getDrctnOrSd() != null ? 1 : 0, 0, 1), 
				checkCardinality("tradrLctn", (String) o.getTradrLctn() != null ? 1 : 0, 1, 1), 
				checkCardinality("bookgLctn", (String) o.getBookgLctn() != null ? 1 : 0, 1, 1)
			);
	}
