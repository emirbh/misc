		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("QuantityTerm1__1", ValidationResult.ValidationType.TYPE_FORMAT, "QuantityTerm1__1", path, "", res.getError());
				}
				return success("QuantityTerm1__1", ValidationResult.ValidationType.TYPE_FORMAT, "QuantityTerm1__1", path, "");
			})
			.collect(toList());
	}
