...
public class TradeData42__3Validator implements Validator<TradeData42__3> {
	...
	private List<ComparisonResult> getComparisonResults(TradeData42__3 o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("cmonTradData", (CommonTradeDataReport69__3) o.getCmonTradData() != null ? 1 : 0, 1, 1), 
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeData42__3", ValidationResult.ValidationType.CARDINALITY, "TradeData42__3", path, "", res.getError());
				}
				return success("TradeData42__3", ValidationResult.ValidationType.CARDINALITY, "TradeData42__3", path, "");
			})
			.collect(toList());
	}
