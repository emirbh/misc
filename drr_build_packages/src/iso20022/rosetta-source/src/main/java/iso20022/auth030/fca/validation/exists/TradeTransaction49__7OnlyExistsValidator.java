...
public class TradeTransaction49__7OnlyExistsValidator implements ValidatorWithArg<TradeTransaction49__7, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends TradeTransaction49__7> ValidationResult<TradeTransaction49__7> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("TradeTransaction49__7", ValidationResult.ValidationType.ONLY_EXISTS, "TradeTransaction49__7", path, "");
		}
		return failure("TradeTransaction49__7", ValidationResult.ValidationType.ONLY_EXISTS, "TradeTransaction49__7", path, "",
