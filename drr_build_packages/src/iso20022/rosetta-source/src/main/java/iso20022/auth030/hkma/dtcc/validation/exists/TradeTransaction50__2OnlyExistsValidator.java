...
public class TradeTransaction50__2OnlyExistsValidator implements ValidatorWithArg<TradeTransaction50__2, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends TradeTransaction50__2> ValidationResult<TradeTransaction50__2> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("nonStdsdTerm", ExistenceChecker.isSet((Boolean) o.getNonStdsdTerm()))
				...
				.put("cmmdty", ExistenceChecker.isSet((AssetClassCommodity7Choice) o.getCmmdty()))
		...
		if (setFields.equals(fields)) {
			return success("TradeTransaction50__2", ValidationResult.ValidationType.ONLY_EXISTS, "TradeTransaction50__2", path, "");
		}
		return failure("TradeTransaction50__2", ValidationResult.ValidationType.ONLY_EXISTS, "TradeTransaction50__2", path, "",
