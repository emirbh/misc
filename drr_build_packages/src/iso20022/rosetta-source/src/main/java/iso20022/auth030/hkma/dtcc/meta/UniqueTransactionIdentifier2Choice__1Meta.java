...
import iso20022.auth030.hkma.dtcc.validation.UniqueTransactionIdentifier2Choice__1TypeFormatValidator;
import iso20022.auth030.hkma.dtcc.validation.UniqueTransactionIdentifier2Choice__1Validator;
import iso20022.auth030.hkma.dtcc.validation.datarule.UniqueTransactionIdentifier2Choice__1Choice;
import iso20022.auth030.hkma.dtcc.validation.exists.UniqueTransactionIdentifier2Choice__1OnlyExistsValidator;
...
public class UniqueTransactionIdentifier2Choice__1Meta implements RosettaMetaData<UniqueTransactionIdentifier2Choice__1> {
	...
	public List<Validator<? super UniqueTransactionIdentifier2Choice__1>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<UniqueTransactionIdentifier2Choice__1>create(UniqueTransactionIdentifier2Choice__1Choice.class)
		);
	}
