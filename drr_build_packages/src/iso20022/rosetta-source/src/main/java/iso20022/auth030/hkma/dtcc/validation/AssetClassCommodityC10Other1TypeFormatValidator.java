		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AssetClassCommodityC10Other1", ValidationResult.ValidationType.TYPE_FORMAT, "AssetClassCommodityC10Other1", path, "", res.getError());
				}
				return success("AssetClassCommodityC10Other1", ValidationResult.ValidationType.TYPE_FORMAT, "AssetClassCommodityC10Other1", path, "");
			})
			.collect(toList());
	}
