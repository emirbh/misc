		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PaperCommodityPulp2__1", ValidationResult.ValidationType.CARDINALITY, "PaperCommodityPulp2__1", path, "", res.getError());
				}
				return success("PaperCommodityPulp2__1", ValidationResult.ValidationType.CARDINALITY, "PaperCommodityPulp2__1", path, "");
			})
			.collect(toList());
	}
