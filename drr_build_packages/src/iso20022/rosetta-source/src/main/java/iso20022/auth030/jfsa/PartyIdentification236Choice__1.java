...
import iso20022.auth030.jfsa.meta.PartyIdentification236Choice__1Meta;
...
public interface PartyIdentification236Choice__1 extends RosettaModelObject {
	...
	/*********************** Getter Methods  ***********************/
	OrganisationIdentification15Choice__2 getLgl();
	...
	default void process(RosettaPath path, Processor processor) {
		processRosetta(path.newSubPath("lgl"), processor, OrganisationIdentification15Choice__2.class, getLgl());
	...
	interface PartyIdentification236Choice__1Builder extends PartyIdentification236Choice__1, RosettaModelObjectBuilder {
		OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder getOrCreateLgl();
		@Override
		OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder getLgl();
		...
		PartyIdentification236Choice__1.PartyIdentification236Choice__1Builder setLgl(OrganisationIdentification15Choice__2 lgl);
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			processRosetta(path.newSubPath("lgl"), processor, OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder.class, getLgl());
	...
	class PartyIdentification236Choice__1Impl implements PartyIdentification236Choice__1 {
		private final OrganisationIdentification15Choice__2 lgl;
		...
		@RuneAttribute("lgl")
		public OrganisationIdentification15Choice__2 getLgl() {
			return lgl;
		}
	...
	class PartyIdentification236Choice__1BuilderImpl implements PartyIdentification236Choice__1.PartyIdentification236Choice__1Builder {
		...
		protected OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder lgl;
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("lgl")
		public OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder getLgl() {
			return lgl;
		}
		
		@Override
		public OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder getOrCreateLgl() {
			OrganisationIdentification15Choice__2.OrganisationIdentification15Choice__2Builder result;
			if (lgl!=null) {
				result = lgl;
			}
			else {
				result = lgl = OrganisationIdentification15Choice__2.builder();
			}
		...
		@RuneAttribute("lgl")
		@Override
		public PartyIdentification236Choice__1.PartyIdentification236Choice__1Builder setLgl(OrganisationIdentification15Choice__2 _lgl) {
