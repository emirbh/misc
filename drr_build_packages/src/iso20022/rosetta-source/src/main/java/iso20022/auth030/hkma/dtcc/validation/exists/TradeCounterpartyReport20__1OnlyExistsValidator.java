...
public class TradeCounterpartyReport20__1OnlyExistsValidator implements ValidatorWithArg<TradeCounterpartyReport20__1, Set<String>> {
	...
	public <T2 extends TradeCounterpartyReport20__1> ValidationResult<TradeCounterpartyReport20__1> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("brkr", ExistenceChecker.isSet((OrganisationIdentification15Choice__3) o.getBrkr()))
				.put("submitgAgt", ExistenceChecker.isSet((OrganisationIdentification15Choice__4) o.getSubmitgAgt()))
				.put("clrMmb", ExistenceChecker.isSet((PartyIdentification248Choice__3) o.getClrMmb()))
				.put("bnfcry", ExistenceChecker.isSet((PartyIdentification248Choice__4) o.getBnfcry()))
				.put("nttyRspnsblForRpt", ExistenceChecker.isSet((OrganisationIdentification15Choice__1) o.getNttyRspnsblForRpt()))
				.put("exctnAgt", ExistenceChecker.isSet((List<? extends OrganisationIdentification15Choice__6>) o.getExctnAgt()))
				.build();
