...
public class NotionalAmount5__2Validator implements Validator<NotionalAmount5__2> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("NotionalAmount5__2", ValidationResult.ValidationType.CARDINALITY, "NotionalAmount5__2", path, "", res.getError());
				}
				return success("NotionalAmount5__2", ValidationResult.ValidationType.CARDINALITY, "NotionalAmount5__2", path, "");
			})
			.collect(toList());
	}
