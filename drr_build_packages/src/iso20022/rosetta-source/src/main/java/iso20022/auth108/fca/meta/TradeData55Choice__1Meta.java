...
import iso20022.auth108.fca.validation.TradeData55Choice__1TypeFormatValidator;
import iso20022.auth108.fca.validation.TradeData55Choice__1Validator;
import iso20022.auth108.fca.validation.datarule.TradeData55Choice__1Choice;
import iso20022.auth108.fca.validation.exists.TradeData55Choice__1OnlyExistsValidator;
...
public class TradeData55Choice__1Meta implements RosettaMetaData<TradeData55Choice__1> {
	...
	public List<Validator<? super TradeData55Choice__1>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<TradeData55Choice__1>create(TradeData55Choice__1Choice.class)
		);
	}
