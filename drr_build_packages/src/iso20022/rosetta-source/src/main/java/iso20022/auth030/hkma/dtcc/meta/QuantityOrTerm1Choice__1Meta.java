...
import iso20022.auth030.hkma.dtcc.validation.QuantityOrTerm1Choice__1TypeFormatValidator;
import iso20022.auth030.hkma.dtcc.validation.QuantityOrTerm1Choice__1Validator;
import iso20022.auth030.hkma.dtcc.validation.datarule.QuantityOrTerm1Choice__1Choice;
import iso20022.auth030.hkma.dtcc.validation.exists.QuantityOrTerm1Choice__1OnlyExistsValidator;
...
public class QuantityOrTerm1Choice__1Meta implements RosettaMetaData<QuantityOrTerm1Choice__1> {
	...
	public List<Validator<? super QuantityOrTerm1Choice__1>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<QuantityOrTerm1Choice__1>create(QuantityOrTerm1Choice__1Choice.class)
		);
	}
