		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FertilizerCommodityUreaAndAmmoniumNitrate2", ValidationResult.ValidationType.TYPE_FORMAT, "FertilizerCommodityUreaAndAmmoniumNitrate2", path, "", res.getError());
				}
				return success("FertilizerCommodityUreaAndAmmoniumNitrate2", ValidationResult.ValidationType.TYPE_FORMAT, "FertilizerCommodityUreaAndAmmoniumNitrate2", path, "");
			})
			.collect(toList());
	}
