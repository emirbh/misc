...
import iso20022.auth030.hkma.dtcc.meta.TradeData43__4Meta;
 ...
 */
@RosettaDataType(value="TradeData43__4", builder=TradeData43__4.TradeData43__4BuilderImpl.class, version="${project.version}")
@RuneDataType(value="TradeData43__4", model="iso20022", builder=TradeData43__4.TradeData43__4BuilderImpl.class, version="${project.version}")
public interface TradeData43__4 extends RosettaModelObject {

	TradeData43__4Meta metaData = new TradeData43__4Meta();
	 ...
	 */
	CommonTradeDataReport71__4 getCmonTradData();
	/**
	...
	/*********************** Build Methods  ***********************/
	TradeData43__4 build();
	
	TradeData43__4.TradeData43__4Builder toBuilder();
	
	static TradeData43__4.TradeData43__4Builder builder() {
		return new TradeData43__4.TradeData43__4BuilderImpl();
	}

	/*********************** Utility Methods  ***********************/
	@Override
	default RosettaMetaData<? extends TradeData43__4> metaData() {
		return metaData;
	}
	
	@Override
	@RuneAttribute("@type")
	default Class<? extends TradeData43__4> getType() {
		return TradeData43__4.class;
	}
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processRosetta(path.newSubPath("cmonTradData"), processor, CommonTradeDataReport71__4.class, getCmonTradData());
	...
	/*********************** Builder Interface  ***********************/
	interface TradeData43__4Builder extends TradeData43__4, RosettaModelObjectBuilder {
		...
		CommonTradeDataReport71__4.CommonTradeDataReport71__4Builder getOrCreateCmonTradData();
		@Override
		CommonTradeDataReport71__4.CommonTradeDataReport71__4Builder getCmonTradData();
		...
		TradeData43__4.TradeData43__4Builder setCtrPtySpcfcData(CounterpartySpecificData36__2 ctrPtySpcfcData);
		TradeData43__4.TradeData43__4Builder setCmonTradData(CommonTradeDataReport71__4 cmonTradData);
		TradeData43__4.TradeData43__4Builder setTechAttrbts(TechnicalAttributes5__1 techAttrbts);
		TradeData43__4.TradeData43__4Builder setSplmtryData(SupplementaryData1 splmtryData);
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			...
			processRosetta(path.newSubPath("cmonTradData"), processor, CommonTradeDataReport71__4.CommonTradeDataReport71__4Builder.class, getCmonTradData());
		...
		TradeData43__4.TradeData43__4Builder prune();
	}

	/*********************** Immutable Implementation of TradeData43__4  ***********************/
	class TradeData43__4Impl implements TradeData43__4 {
		private final CounterpartySpecificData36__2 ctrPtySpcfcData;
		private final CommonTradeDataReport71__4 cmonTradData;
		private final TechnicalAttributes5__1 techAttrbts;
		private final SupplementaryData1 splmtryData;
		
		protected TradeData43__4Impl(TradeData43__4.TradeData43__4Builder builder) {
		...
		public CommonTradeDataReport71__4 getCmonTradData() {
			return cmonTradData;
		}
		...
		@Override
		public TradeData43__4 build() {
			return this;
		}
		
		@Override
		public TradeData43__4.TradeData43__4Builder toBuilder() {
			TradeData43__4.TradeData43__4Builder builder = builder();
			setBuilderFields(builder);
			return builder;
		}
		
		protected void setBuilderFields(TradeData43__4.TradeData43__4Builder builder) {
		...
		public boolean equals(Object o) {
			...
			TradeData43__4 _that = getType().cast(o);
	...
	/*********************** Builder Implementation of TradeData43__4  ***********************/
	class TradeData43__4BuilderImpl implements TradeData43__4.TradeData43__4Builder {
	
		protected CounterpartySpecificData36__2.CounterpartySpecificData36__2Builder ctrPtySpcfcData;
		protected CommonTradeDataReport71__4.CommonTradeDataReport71__4Builder cmonTradData;
		...
		@Required
		@RuneAttribute("cmonTradData")
		public CommonTradeDataReport71__4.CommonTradeDataReport71__4Builder getCmonTradData() {
			return cmonTradData;
		}
		
		@Override
		public CommonTradeDataReport71__4.CommonTradeDataReport71__4Builder getOrCreateCmonTradData() {
			CommonTradeDataReport71__4.CommonTradeDataReport71__4Builder result;
			if (cmonTradData!=null) {
				result = cmonTradData;
			}
			else {
				result = cmonTradData = CommonTradeDataReport71__4.builder();
			}
		...
		@RuneAttribute("ctrPtySpcfcData")
		@Override
		public TradeData43__4.TradeData43__4Builder setCtrPtySpcfcData(CounterpartySpecificData36__2 _ctrPtySpcfcData) {
		...
		@RuneAttribute("cmonTradData")
		@Override
		public TradeData43__4.TradeData43__4Builder setCmonTradData(CommonTradeDataReport71__4 _cmonTradData) {
		...
		@RuneAttribute("techAttrbts")
		@Override
		public TradeData43__4.TradeData43__4Builder setTechAttrbts(TechnicalAttributes5__1 _techAttrbts) {
		...
		@RuneAttribute("splmtryData")
		@Override
		public TradeData43__4.TradeData43__4Builder setSplmtryData(SupplementaryData1 _splmtryData) {
		...
		@Override
		public TradeData43__4 build() {
			return new TradeData43__4.TradeData43__4Impl(this);
		}
		...
		@Override
		public TradeData43__4.TradeData43__4Builder prune() {
		...
		@SuppressWarnings("unchecked")
		@Override
		public TradeData43__4.TradeData43__4Builder merge(RosettaModelObjectBuilder other, BuilderMerger merger) {
			TradeData43__4.TradeData43__4Builder o = (TradeData43__4.TradeData43__4Builder) other;
