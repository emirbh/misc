		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ClearingPartyAndTime22Choice__2", ValidationResult.ValidationType.CARDINALITY, "ClearingPartyAndTime22Choice__2", path, "", res.getError());
				}
				return success("ClearingPartyAndTime22Choice__2", ValidationResult.ValidationType.CARDINALITY, "ClearingPartyAndTime22Choice__2", path, "");
			})
			.collect(toList());
	}
