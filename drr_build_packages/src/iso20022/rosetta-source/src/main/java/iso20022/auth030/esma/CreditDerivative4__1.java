...
import iso20022.auth030.esma.meta.CreditDerivative4__1Meta;
...
public interface CreditDerivative4__1 extends RosettaModelObject {
	...
	Integer getVrsn();
	/**
	 * Factor to apply to the actual notional to adjust it to all the previous credit events in the index series.   Usage: The figure varies between 0 and 100.
	 */
	BigDecimal getIndxFctr();
	/**
	 * Indicates whether the derivative contract is tranched or not.
	 */
	TrancheIndicator3Choice getTrch();
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processRosetta(path.newSubPath("trch"), processor, TrancheIndicator3Choice.class, getTrch());
	}
	...
	interface CreditDerivative4__1Builder extends CreditDerivative4__1, RosettaModelObjectBuilder {
		...
		TrancheIndicator3Choice.TrancheIndicator3ChoiceBuilder getOrCreateTrch();
		@Override
		TrancheIndicator3Choice.TrancheIndicator3ChoiceBuilder getTrch();
		...
		CreditDerivative4__1.CreditDerivative4__1Builder setTrch(TrancheIndicator3Choice trch);
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			...
			processor.processBasic(path.newSubPath("vrsn"), Integer.class, getVrsn(), this);
			processor.processBasic(path.newSubPath("indxFctr"), BigDecimal.class, getIndxFctr(), this);
			processRosetta(path.newSubPath("trch"), processor, TrancheIndicator3Choice.TrancheIndicator3ChoiceBuilder.class, getTrch());
		}
	...
	class CreditDerivative4__1Impl implements CreditDerivative4__1 {
		...
		private final TrancheIndicator3Choice trch;
	...
	class CreditDerivative4__1BuilderImpl implements CreditDerivative4__1.CreditDerivative4__1Builder {
		...
		protected TrancheIndicator3Choice.TrancheIndicator3ChoiceBuilder trch;
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("trch")
		public TrancheIndicator3Choice.TrancheIndicator3ChoiceBuilder getTrch() {
			return trch;
		}
		
		@Override
		public TrancheIndicator3Choice.TrancheIndicator3ChoiceBuilder getOrCreateTrch() {
			TrancheIndicator3Choice.TrancheIndicator3ChoiceBuilder result;
			if (trch!=null) {
				result = trch;
			}
			else {
				result = trch = TrancheIndicator3Choice.builder();
			}
		...
		@RuneAttribute("trch")
		@Override
		public CreditDerivative4__1.CreditDerivative4__1Builder setTrch(TrancheIndicator3Choice _trch) {
