...
import iso20022.auth030.hkma.dtcc.meta.EnergyCommodityOil3Meta;
...
@RuneDataType(value="EnergyCommodityOil3", model="iso20022", builder=EnergyCommodityOil3.EnergyCommodityOil3BuilderImpl.class, version="${project.version}")
