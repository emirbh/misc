...
import iso20022.auth030.hkma.dtcc.meta.DerivativesTradeReportV04Meta;
 ...
 */
@RosettaDataType(value="DerivativesTradeReportV04", builder=DerivativesTradeReportV04.DerivativesTradeReportV04BuilderImpl.class, version="${project.version}")
@RuneDataType(value="DerivativesTradeReportV04", model="iso20022", builder=DerivativesTradeReportV04.DerivativesTradeReportV04BuilderImpl.class, version="${project.version}")
