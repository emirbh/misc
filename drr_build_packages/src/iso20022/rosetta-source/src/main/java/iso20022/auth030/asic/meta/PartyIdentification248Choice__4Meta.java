...
import iso20022.auth030.asic.validation.PartyIdentification248Choice__4TypeFormatValidator;
import iso20022.auth030.asic.validation.PartyIdentification248Choice__4Validator;
import iso20022.auth030.asic.validation.datarule.PartyIdentification248Choice__4Choice;
import iso20022.auth030.asic.validation.exists.PartyIdentification248Choice__4OnlyExistsValidator;
...
public class PartyIdentification248Choice__4Meta implements RosettaMetaData<PartyIdentification248Choice__4> {
	...
	public List<Validator<? super PartyIdentification248Choice__4>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<PartyIdentification248Choice__4>create(PartyIdentification248Choice__4Choice.class)
		);
	}
