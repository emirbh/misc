...
public class FreightCommodityWet3__1Meta implements RosettaMetaData<FreightCommodityWet3__1> {
	...
	@Override
	public Validator<? super FreightCommodityWet3__1> validator(ValidatorFactory factory) {
		return factory.<FreightCommodityWet3__1>create(FreightCommodityWet3__1Validator.class);
	}

	@Override
	public Validator<? super FreightCommodityWet3__1> typeFormatValidator(ValidatorFactory factory) {
		return factory.<FreightCommodityWet3__1>create(FreightCommodityWet3__1TypeFormatValidator.class);
	}
