...
public class TradeData42__5OnlyExistsValidator implements ValidatorWithArg<TradeData42__5, Set<String>> {
	...
	public <T2 extends TradeData42__5> ValidationResult<TradeData42__5> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("ctrPtySpcfcData", ExistenceChecker.isSet((CounterpartySpecificData36__4) o.getCtrPtySpcfcData()))
		...
		if (setFields.equals(fields)) {
			return success("TradeData42__5", ValidationResult.ValidationType.ONLY_EXISTS, "TradeData42__5", path, "");
		}
		return failure("TradeData42__5", ValidationResult.ValidationType.ONLY_EXISTS, "TradeData42__5", path, "",
