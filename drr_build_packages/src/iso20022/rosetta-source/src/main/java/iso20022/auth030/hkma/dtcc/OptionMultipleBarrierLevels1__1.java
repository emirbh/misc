...
import iso20022.auth030.hkma.dtcc.meta.OptionMultipleBarrierLevels1__1Meta;
...
public interface OptionMultipleBarrierLevels1__1 extends RosettaModelObject {
	...
	/*********************** Getter Methods  ***********************/
	/**
	 * Specifies the lower of the two barrier levels as a predetermined price.
	 */
	SecuritiesTransactionPrice23Choice__1 getLwrLvl();
	/**
	 * Specifies the higher of the two barrier levels as a predetermined price.
	 */
