		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("OrganisationIdentification38__4", ValidationResult.ValidationType.CARDINALITY, "OrganisationIdentification38__4", path, "", res.getError());
				}
				return success("OrganisationIdentification38__4", ValidationResult.ValidationType.CARDINALITY, "OrganisationIdentification38__4", path, "");
			})
			.collect(toList());
	}
