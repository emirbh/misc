...
public class CommonTradeDataReport71__8Validator implements Validator<CommonTradeDataReport71__8> {
	...
	private List<ComparisonResult> getComparisonResults(CommonTradeDataReport71__8 o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("txData", (TradeTransaction50__8) o.getTxData() != null ? 1 : 0, 1, 1)
			);
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommonTradeDataReport71__8", ValidationResult.ValidationType.CARDINALITY, "CommonTradeDataReport71__8", path, "", res.getError());
				}
				return success("CommonTradeDataReport71__8", ValidationResult.ValidationType.CARDINALITY, "CommonTradeDataReport71__8", path, "");
			})
			.collect(toList());
	}
