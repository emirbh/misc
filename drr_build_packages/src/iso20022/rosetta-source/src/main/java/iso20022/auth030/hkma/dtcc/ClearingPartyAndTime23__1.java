...
import iso20022.auth030.hkma.dtcc.meta.ClearingPartyAndTime23__1Meta;
...
public interface ClearingPartyAndTime23__1 extends RosettaModelObject {
	 ...
	 */
	OrganisationIdentification15Choice__7 getCcp();
	...
	default void process(RosettaPath path, Processor processor) {
		processRosetta(path.newSubPath("ccp"), processor, OrganisationIdentification15Choice__7.class, getCcp());
	}
	

	/*********************** Builder Interface  ***********************/
	interface ClearingPartyAndTime23__1Builder extends ClearingPartyAndTime23__1, RosettaModelObjectBuilder {
		OrganisationIdentification15Choice__7.OrganisationIdentification15Choice__7Builder getOrCreateCcp();
		@Override
		OrganisationIdentification15Choice__7.OrganisationIdentification15Choice__7Builder getCcp();
		ClearingPartyAndTime23__1.ClearingPartyAndTime23__1Builder setCcp(OrganisationIdentification15Choice__7 ccp);

		@Override
		default void process(RosettaPath path, BuilderProcessor processor) {
			processRosetta(path.newSubPath("ccp"), processor, OrganisationIdentification15Choice__7.OrganisationIdentification15Choice__7Builder.class, getCcp());
		}
	...
	class ClearingPartyAndTime23__1Impl implements ClearingPartyAndTime23__1 {
		private final OrganisationIdentification15Choice__7 ccp;
		...
		@RuneAttribute("ccp")
		public OrganisationIdentification15Choice__7 getCcp() {
			return ccp;
		}
	...
	class ClearingPartyAndTime23__1BuilderImpl implements ClearingPartyAndTime23__1.ClearingPartyAndTime23__1Builder {
		...
		protected OrganisationIdentification15Choice__7.OrganisationIdentification15Choice__7Builder ccp;
		
		@Override
		@RosettaAttribute("ccp")
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("ccp")
		public OrganisationIdentification15Choice__7.OrganisationIdentification15Choice__7Builder getCcp() {
			return ccp;
		}
		
		@Override
		public OrganisationIdentification15Choice__7.OrganisationIdentification15Choice__7Builder getOrCreateCcp() {
			OrganisationIdentification15Choice__7.OrganisationIdentification15Choice__7Builder result;
			if (ccp!=null) {
				result = ccp;
			}
			else {
				result = ccp = OrganisationIdentification15Choice__7.builder();
			}
		...
		@RuneAttribute("ccp")
		@Override
		public ClearingPartyAndTime23__1.ClearingPartyAndTime23__1Builder setCcp(OrganisationIdentification15Choice__7 _ccp) {
