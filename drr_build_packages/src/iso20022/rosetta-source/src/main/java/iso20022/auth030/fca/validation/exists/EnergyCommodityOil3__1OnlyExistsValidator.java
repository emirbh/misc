...
public class EnergyCommodityOil3__1OnlyExistsValidator implements ValidatorWithArg<EnergyCommodityOil3__1, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends EnergyCommodityOil3__1> ValidationResult<EnergyCommodityOil3__1> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("EnergyCommodityOil3__1", ValidationResult.ValidationType.ONLY_EXISTS, "EnergyCommodityOil3__1", path, "");
		}
		return failure("EnergyCommodityOil3__1", ValidationResult.ValidationType.ONLY_EXISTS, "EnergyCommodityOil3__1", path, "",
