...
public class InterestRateLegs14__3Validator implements Validator<InterestRateLegs14__3> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("InterestRateLegs14__3", ValidationResult.ValidationType.CARDINALITY, "InterestRateLegs14__3", path, "", res.getError());
				}
				return success("InterestRateLegs14__3", ValidationResult.ValidationType.CARDINALITY, "InterestRateLegs14__3", path, "");
			})
			.collect(toList());
	}
