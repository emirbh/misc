...
import iso20022.auth030.fca.validation.TradeData57Choice__1TypeFormatValidator;
import iso20022.auth030.fca.validation.TradeData57Choice__1Validator;
import iso20022.auth030.fca.validation.datarule.TradeData57Choice__1Choice;
import iso20022.auth030.fca.validation.exists.TradeData57Choice__1OnlyExistsValidator;
...
public class TradeData57Choice__1Meta implements RosettaMetaData<TradeData57Choice__1> {
	...
	public List<Validator<? super TradeData57Choice__1>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<TradeData57Choice__1>create(TradeData57Choice__1Choice.class)
		);
	}
