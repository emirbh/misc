...
public class SecuritiesTransactionPrice17Choice__1Validator implements Validator<SecuritiesTransactionPrice17Choice__1> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("SecuritiesTransactionPrice17Choice__1", ValidationResult.ValidationType.CARDINALITY, "SecuritiesTransactionPrice17Choice__1", path, "", res.getError());
				}
				return success("SecuritiesTransactionPrice17Choice__1", ValidationResult.ValidationType.CARDINALITY, "SecuritiesTransactionPrice17Choice__1", path, "");
			})
			.collect(toList());
	}
