...
import iso20022.auth108.hkma.dtcc.meta.CollateralPortfolioCode6Choice__1Meta;
...
public interface CollateralPortfolioCode6Choice__1 extends RosettaModelObject {
	...
	default void process(RosettaPath path, Processor processor) {
		processRosetta(path.newSubPath("mrgnPrtflCd"), processor, MarginPortfolio4.class, getMrgnPrtflCd());
	}
	

	/*********************** Builder Interface  ***********************/
	interface CollateralPortfolioCode6Choice__1Builder extends CollateralPortfolioCode6Choice__1, RosettaModelObjectBuilder {
		MarginPortfolio4.MarginPortfolio4Builder getOrCreateMrgnPrtflCd();
		@Override
		MarginPortfolio4.MarginPortfolio4Builder getMrgnPrtflCd();
		CollateralPortfolioCode6Choice__1.CollateralPortfolioCode6Choice__1Builder setMrgnPrtflCd(MarginPortfolio4 mrgnPrtflCd);

		@Override
		default void process(RosettaPath path, BuilderProcessor processor) {
			processRosetta(path.newSubPath("mrgnPrtflCd"), processor, MarginPortfolio4.MarginPortfolio4Builder.class, getMrgnPrtflCd());
		}
	...
	class CollateralPortfolioCode6Choice__1Impl implements CollateralPortfolioCode6Choice__1 {
		private final MarginPortfolio4 mrgnPrtflCd;
	...
	class CollateralPortfolioCode6Choice__1BuilderImpl implements CollateralPortfolioCode6Choice__1.CollateralPortfolioCode6Choice__1Builder {
		...
		protected MarginPortfolio4.MarginPortfolio4Builder mrgnPrtflCd;
		...
		@Required
		@RuneAttribute("mrgnPrtflCd")
		public MarginPortfolio4.MarginPortfolio4Builder getMrgnPrtflCd() {
			return mrgnPrtflCd;
		}
		
		@Override
		public MarginPortfolio4.MarginPortfolio4Builder getOrCreateMrgnPrtflCd() {
			MarginPortfolio4.MarginPortfolio4Builder result;
			if (mrgnPrtflCd!=null) {
				result = mrgnPrtflCd;
			}
			else {
				result = mrgnPrtflCd = MarginPortfolio4.builder();
			}
		...
		@RuneAttribute("mrgnPrtflCd")
		@Override
		public CollateralPortfolioCode6Choice__1.CollateralPortfolioCode6Choice__1Builder setMrgnPrtflCd(MarginPortfolio4 _mrgnPrtflCd) {
