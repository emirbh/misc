...
public class EnergyCommodityOther2__1Validator implements Validator<EnergyCommodityOther2__1> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EnergyCommodityOther2__1", ValidationResult.ValidationType.CARDINALITY, "EnergyCommodityOther2__1", path, "", res.getError());
				}
				return success("EnergyCommodityOther2__1", ValidationResult.ValidationType.CARDINALITY, "EnergyCommodityOther2__1", path, "");
			})
			.collect(toList());
	}
