...
import iso20022.auth030.hkma.tr.meta.AssetClassCommodity7ChoiceMeta;
 ...
 */
@RosettaDataType(value="AssetClassCommodity7Choice", builder=AssetClassCommodity7Choice.AssetClassCommodity7ChoiceBuilderImpl.class, version="${project.version}")
@RuneDataType(value="AssetClassCommodity7Choice", model="iso20022", builder=AssetClassCommodity7Choice.AssetClassCommodity7ChoiceBuilderImpl.class, version="${project.version}")
