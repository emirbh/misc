...
public class TradeTransaction49__2OnlyExistsValidator implements ValidatorWithArg<TradeTransaction49__2, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends TradeTransaction49__2> ValidationResult<TradeTransaction49__2> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("TradeTransaction49__2", ValidationResult.ValidationType.ONLY_EXISTS, "TradeTransaction49__2", path, "");
		}
		return failure("TradeTransaction49__2", ValidationResult.ValidationType.ONLY_EXISTS, "TradeTransaction49__2", path, "",
