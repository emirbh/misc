...
import iso20022.auth030.fca.meta.AssetClassCommodity6Choice__2Meta;
 ...
 */
@RosettaDataType(value="AssetClassCommodity6Choice__2", builder=AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2BuilderImpl.class, version="${project.version}")
@RuneDataType(value="AssetClassCommodity6Choice__2", model="iso20022", builder=AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2BuilderImpl.class, version="${project.version}")
public interface AssetClassCommodity6Choice__2 extends RosettaModelObject {

	AssetClassCommodity6Choice__2Meta metaData = new AssetClassCommodity6Choice__2Meta();
	 ...
	 */
	AssetClassCommodityEnvironmental3Choice__2 getEnvttl();
	/**
	...
	/*********************** Build Methods  ***********************/
	AssetClassCommodity6Choice__2 build();
	
	AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder toBuilder();
	
	static AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder builder() {
		return new AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2BuilderImpl();
	}

	/*********************** Utility Methods  ***********************/
	@Override
	default RosettaMetaData<? extends AssetClassCommodity6Choice__2> metaData() {
		return metaData;
	}
	
	@Override
	@RuneAttribute("@type")
	default Class<? extends AssetClassCommodity6Choice__2> getType() {
		return AssetClassCommodity6Choice__2.class;
	}
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processRosetta(path.newSubPath("envttl"), processor, AssetClassCommodityEnvironmental3Choice__2.class, getEnvttl());
	...
	/*********************** Builder Interface  ***********************/
	interface AssetClassCommodity6Choice__2Builder extends AssetClassCommodity6Choice__2, RosettaModelObjectBuilder {
		...
		AssetClassCommodityEnvironmental3Choice__2.AssetClassCommodityEnvironmental3Choice__2Builder getOrCreateEnvttl();
		@Override
		AssetClassCommodityEnvironmental3Choice__2.AssetClassCommodityEnvironmental3Choice__2Builder getEnvttl();
		...
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setAgrcltrl(AssetClassCommodityAgricultural6Choice__1 agrcltrl);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setNrgy(AssetClassCommodityEnergy3Choice__1 nrgy);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setEnvttl(AssetClassCommodityEnvironmental3Choice__2 envttl);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setFrtlzr(AssetClassCommodityFertilizer4Choice__1 frtlzr);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setFrght(AssetClassCommodityFreight4Choice__1 frght);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setIndstrlPdct(AssetClassCommodityIndustrialProduct2Choice__1 indstrlPdct);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setInfltn(AssetClassCommodityInflation1 infltn);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setMetl(AssetClassCommodityMetal2Choice__1 metl);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setMultiCmmdtyExtc(AssetClassCommodityMultiCommodityExotic1 multiCmmdtyExtc);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setOffclEcnmcSttstcs(AssetClassCommodityOfficialEconomicStatistics1 offclEcnmcSttstcs);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setOthr(AssetClassCommodityOther1 othr);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setOthrC10(AssetClassCommodityC10Other1 othrC10);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setPpr(AssetClassCommodityPaper4Choice__1 ppr);
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setPlprpln(AssetClassCommodityPolypropylene4Choice__1 plprpln);
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			...
			processRosetta(path.newSubPath("envttl"), processor, AssetClassCommodityEnvironmental3Choice__2.AssetClassCommodityEnvironmental3Choice__2Builder.class, getEnvttl());
		...
		AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder prune();
	}

	/*********************** Immutable Implementation of AssetClassCommodity6Choice__2  ***********************/
	class AssetClassCommodity6Choice__2Impl implements AssetClassCommodity6Choice__2 {
		private final AssetClassCommodityAgricultural6Choice__1 agrcltrl;
		private final AssetClassCommodityEnergy3Choice__1 nrgy;
		private final AssetClassCommodityEnvironmental3Choice__2 envttl;
		...
		protected AssetClassCommodity6Choice__2Impl(AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder builder) {
		...
		public AssetClassCommodityEnvironmental3Choice__2 getEnvttl() {
			return envttl;
		}
		...
		@Override
		public AssetClassCommodity6Choice__2 build() {
			return this;
		}
		
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder toBuilder() {
			AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder builder = builder();
			setBuilderFields(builder);
			return builder;
		}
		
		protected void setBuilderFields(AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder builder) {
		...
		public boolean equals(Object o) {
			...
			AssetClassCommodity6Choice__2 _that = getType().cast(o);
		...
		public String toString() {
			return "AssetClassCommodity6Choice__2 {" +
	...
	/*********************** Builder Implementation of AssetClassCommodity6Choice__2  ***********************/
	class AssetClassCommodity6Choice__2BuilderImpl implements AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder {
		...
		protected AssetClassCommodityEnvironmental3Choice__2.AssetClassCommodityEnvironmental3Choice__2Builder envttl;
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("envttl")
		public AssetClassCommodityEnvironmental3Choice__2.AssetClassCommodityEnvironmental3Choice__2Builder getEnvttl() {
			return envttl;
		}
		
		@Override
		public AssetClassCommodityEnvironmental3Choice__2.AssetClassCommodityEnvironmental3Choice__2Builder getOrCreateEnvttl() {
			AssetClassCommodityEnvironmental3Choice__2.AssetClassCommodityEnvironmental3Choice__2Builder result;
			if (envttl!=null) {
				result = envttl;
			}
			else {
				result = envttl = AssetClassCommodityEnvironmental3Choice__2.builder();
			}
		...
		@RuneAttribute("agrcltrl")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setAgrcltrl(AssetClassCommodityAgricultural6Choice__1 _agrcltrl) {
		...
		@RuneAttribute("nrgy")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setNrgy(AssetClassCommodityEnergy3Choice__1 _nrgy) {
		...
		@RuneAttribute("envttl")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setEnvttl(AssetClassCommodityEnvironmental3Choice__2 _envttl) {
		...
		@RuneAttribute("frtlzr")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setFrtlzr(AssetClassCommodityFertilizer4Choice__1 _frtlzr) {
		...
		@RuneAttribute("frght")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setFrght(AssetClassCommodityFreight4Choice__1 _frght) {
		...
		@RuneAttribute("indstrlPdct")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setIndstrlPdct(AssetClassCommodityIndustrialProduct2Choice__1 _indstrlPdct) {
		...
		@RuneAttribute("infltn")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setInfltn(AssetClassCommodityInflation1 _infltn) {
		...
		@RuneAttribute("metl")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setMetl(AssetClassCommodityMetal2Choice__1 _metl) {
		...
		@RuneAttribute("multiCmmdtyExtc")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setMultiCmmdtyExtc(AssetClassCommodityMultiCommodityExotic1 _multiCmmdtyExtc) {
		...
		@RuneAttribute("offclEcnmcSttstcs")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setOffclEcnmcSttstcs(AssetClassCommodityOfficialEconomicStatistics1 _offclEcnmcSttstcs) {
		...
		@RuneAttribute("othr")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setOthr(AssetClassCommodityOther1 _othr) {
		...
		@RuneAttribute("othrC10")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setOthrC10(AssetClassCommodityC10Other1 _othrC10) {
		...
		@RuneAttribute("ppr")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setPpr(AssetClassCommodityPaper4Choice__1 _ppr) {
		...
		@RuneAttribute("plprpln")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder setPlprpln(AssetClassCommodityPolypropylene4Choice__1 _plprpln) {
		...
		@Override
		public AssetClassCommodity6Choice__2 build() {
			return new AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Impl(this);
		}
		...
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder prune() {
		...
		@SuppressWarnings("unchecked")
		@Override
		public AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder merge(RosettaModelObjectBuilder other, BuilderMerger merger) {
			AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder o = (AssetClassCommodity6Choice__2.AssetClassCommodity6Choice__2Builder) other;
		...
		@Override
		public String toString() {
			return "AssetClassCommodity6Choice__2Builder {" +
				"agrcltrl=" + this.agrcltrl + ", " +
				"nrgy=" + this.nrgy + ", " +
				"envttl=" + this.envttl + ", " +
				"frtlzr=" + this.frtlzr + ", " +
