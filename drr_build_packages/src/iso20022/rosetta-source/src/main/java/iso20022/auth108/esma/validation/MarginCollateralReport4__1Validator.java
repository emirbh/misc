		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MarginCollateralReport4__1", ValidationResult.ValidationType.CARDINALITY, "MarginCollateralReport4__1", path, "", res.getError());
				}
				return success("MarginCollateralReport4__1", ValidationResult.ValidationType.CARDINALITY, "MarginCollateralReport4__1", path, "");
			})
			.collect(toList());
	}
