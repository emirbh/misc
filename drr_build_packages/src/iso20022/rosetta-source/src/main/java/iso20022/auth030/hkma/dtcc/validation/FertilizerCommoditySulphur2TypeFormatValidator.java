		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FertilizerCommoditySulphur2", ValidationResult.ValidationType.TYPE_FORMAT, "FertilizerCommoditySulphur2", path, "", res.getError());
				}
				return success("FertilizerCommoditySulphur2", ValidationResult.ValidationType.TYPE_FORMAT, "FertilizerCommoditySulphur2", path, "");
			})
			.collect(toList());
	}
