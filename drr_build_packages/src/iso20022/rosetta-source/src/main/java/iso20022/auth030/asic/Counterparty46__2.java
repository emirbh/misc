...
import iso20022.auth030.asic.meta.Counterparty46__2Meta;
...
public interface Counterparty46__2 extends RosettaModelObject {
	...
	/*********************** Getter Methods  ***********************/
	PartyIdentification248Choice__4 getIdTp();
	...
	default void process(RosettaPath path, Processor processor) {
		processRosetta(path.newSubPath("idTp"), processor, PartyIdentification248Choice__4.class, getIdTp());
	}
	

	/*********************** Builder Interface  ***********************/
	interface Counterparty46__2Builder extends Counterparty46__2, RosettaModelObjectBuilder {
		PartyIdentification248Choice__4.PartyIdentification248Choice__4Builder getOrCreateIdTp();
		@Override
		PartyIdentification248Choice__4.PartyIdentification248Choice__4Builder getIdTp();
		Counterparty46__2.Counterparty46__2Builder setIdTp(PartyIdentification248Choice__4 idTp);

		@Override
		default void process(RosettaPath path, BuilderProcessor processor) {
			processRosetta(path.newSubPath("idTp"), processor, PartyIdentification248Choice__4.PartyIdentification248Choice__4Builder.class, getIdTp());
		}
	...
	class Counterparty46__2Impl implements Counterparty46__2 {
		private final PartyIdentification248Choice__4 idTp;
		...
		@Required
		@RuneAttribute("idTp")
		public PartyIdentification248Choice__4 getIdTp() {
			return idTp;
		}
	...
	class Counterparty46__2BuilderImpl implements Counterparty46__2.Counterparty46__2Builder {
		...
		protected PartyIdentification248Choice__4.PartyIdentification248Choice__4Builder idTp;
		...
		@Required
		@RuneAttribute("idTp")
		public PartyIdentification248Choice__4.PartyIdentification248Choice__4Builder getIdTp() {
			return idTp;
		}
		
		@Override
		public PartyIdentification248Choice__4.PartyIdentification248Choice__4Builder getOrCreateIdTp() {
			PartyIdentification248Choice__4.PartyIdentification248Choice__4Builder result;
			if (idTp!=null) {
				result = idTp;
			}
			else {
				result = idTp = PartyIdentification248Choice__4.builder();
			}
		...
		@RuneAttribute("idTp")
		@Override
		public Counterparty46__2.Counterparty46__2Builder setIdTp(PartyIdentification248Choice__4 _idTp) {
