...
import iso20022.auth030.hkma.dtcc.meta.UniqueTransactionIdentifier3Choice__1Meta;
...
@RuneDataType(value="UniqueTransactionIdentifier3Choice__1", model="iso20022", builder=UniqueTransactionIdentifier3Choice__1.UniqueTransactionIdentifier3Choice__1BuilderImpl.class, version="${project.version}")
public interface UniqueTransactionIdentifier3Choice__1 extends RosettaModelObject {
	 ...
	 */
	GenericIdentification175__4 getPrtry();
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processRosetta(path.newSubPath("prtry"), processor, GenericIdentification175__4.class, getPrtry());
	}
	...
	interface UniqueTransactionIdentifier3Choice__1Builder extends UniqueTransactionIdentifier3Choice__1, RosettaModelObjectBuilder {
		GenericIdentification175__4.GenericIdentification175__4Builder getOrCreatePrtry();
		@Override
		GenericIdentification175__4.GenericIdentification175__4Builder getPrtry();
		UniqueTransactionIdentifier3Choice__1.UniqueTransactionIdentifier3Choice__1Builder setUnqTxIdr(String unqTxIdr);
		UniqueTransactionIdentifier3Choice__1.UniqueTransactionIdentifier3Choice__1Builder setPrtry(GenericIdentification175__4 prtry);

		@Override
		default void process(RosettaPath path, BuilderProcessor processor) {
			processor.processBasic(path.newSubPath("unqTxIdr"), String.class, getUnqTxIdr(), this);
			processRosetta(path.newSubPath("prtry"), processor, GenericIdentification175__4.GenericIdentification175__4Builder.class, getPrtry());
		}
	...
	class UniqueTransactionIdentifier3Choice__1Impl implements UniqueTransactionIdentifier3Choice__1 {
		...
		private final GenericIdentification175__4 prtry;
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("prtry")
		public GenericIdentification175__4 getPrtry() {
			return prtry;
		}
	...
	class UniqueTransactionIdentifier3Choice__1BuilderImpl implements UniqueTransactionIdentifier3Choice__1.UniqueTransactionIdentifier3Choice__1Builder {
		...
		protected GenericIdentification175__4.GenericIdentification175__4Builder prtry;
		...
		@Accessor(AccessorType.GETTER)
		@RuneAttribute("prtry")
		public GenericIdentification175__4.GenericIdentification175__4Builder getPrtry() {
			return prtry;
		}
		
		@Override
		public GenericIdentification175__4.GenericIdentification175__4Builder getOrCreatePrtry() {
			GenericIdentification175__4.GenericIdentification175__4Builder result;
			if (prtry!=null) {
				result = prtry;
			}
			else {
				result = prtry = GenericIdentification175__4.builder();
			}
		...
		@RuneAttribute("prtry")
		@Override
		public UniqueTransactionIdentifier3Choice__1.UniqueTransactionIdentifier3Choice__1Builder setPrtry(GenericIdentification175__4 _prtry) {
