...
import iso20022.auth030.hkma.tr.FinancialInstrumentContractType2Code;
...
public class ContractType15__1OnlyExistsValidator implements ValidatorWithArg<ContractType15__1, Set<String>> {
	...
	public <T2 extends ContractType15__1> ValidationResult<ContractType15__1> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("undrlygAsstTradgPltfmIdr", ExistenceChecker.isSet((String) o.getUndrlygAsstTradgPltfmIdr()))
				.put("undrlygAsstPricSrc", ExistenceChecker.isSet((String) o.getUndrlygAsstPricSrc()))
				...
				.put("plcOfSttlm", ExistenceChecker.isSet((String) o.getPlcOfSttlm()))
