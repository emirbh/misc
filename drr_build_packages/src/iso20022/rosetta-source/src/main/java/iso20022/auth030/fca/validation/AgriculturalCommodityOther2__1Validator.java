...
public class AgriculturalCommodityOther2__1Validator implements Validator<AgriculturalCommodityOther2__1> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AgriculturalCommodityOther2__1", ValidationResult.ValidationType.CARDINALITY, "AgriculturalCommodityOther2__1", path, "", res.getError());
				}
				return success("AgriculturalCommodityOther2__1", ValidationResult.ValidationType.CARDINALITY, "AgriculturalCommodityOther2__1", path, "");
			})
			.collect(toList());
	}
