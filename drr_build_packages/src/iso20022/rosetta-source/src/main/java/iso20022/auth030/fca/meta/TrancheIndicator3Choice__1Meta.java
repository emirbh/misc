...
import iso20022.auth030.fca.validation.TrancheIndicator3Choice__1TypeFormatValidator;
import iso20022.auth030.fca.validation.TrancheIndicator3Choice__1Validator;
import iso20022.auth030.fca.validation.datarule.TrancheIndicator3Choice__1Choice;
import iso20022.auth030.fca.validation.exists.TrancheIndicator3Choice__1OnlyExistsValidator;
...
public class TrancheIndicator3Choice__1Meta implements RosettaMetaData<TrancheIndicator3Choice__1> {
	...
	public List<Validator<? super TrancheIndicator3Choice__1>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<TrancheIndicator3Choice__1>create(TrancheIndicator3Choice__1Choice.class)
		);
	}
