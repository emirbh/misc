...
public class TradeTransaction50__6Validator implements Validator<TradeTransaction50__6> {
	...
	private List<ComparisonResult> getComparisonResults(TradeTransaction50__6 o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("collPrtflCd", (CollateralPortfolioCode6Choice__1) o.getCollPrtflCd() != null ? 1 : 0, 0, 1), 
				checkCardinality("pltfmIdr", (String) o.getPltfmIdr() != null ? 1 : 0, 0, 1), 
				checkCardinality("txPric", (PriceData2__2) o.getTxPric() != null ? 1 : 0, 0, 1), 
				checkCardinality("ntnlAmt", (NotionalAmountLegs5__2) o.getNtnlAmt() != null ? 1 : 0, 0, 1), 
				checkCardinality("ntnlQty", (NotionalQuantityLegs5__2) o.getNtnlQty() != null ? 1 : 0, 0, 1), 
				checkCardinality("dlvryTp", (PhysicalTransferType4Code) o.getDlvryTp() != null ? 1 : 0, 0, 1), 
				checkCardinality("exctnTmStmp", (ZonedDateTime) o.getExctnTmStmp() != null ? 1 : 0, 0, 1), 
				...
				checkCardinality("tradClr", (TradeClearing11__2) o.getTradClr() != null ? 1 : 0, 0, 1), 
				checkCardinality("intrstRate", (InterestRateLegs14__3) o.getIntrstRate() != null ? 1 : 0, 0, 1), 
				checkCardinality("ccy", (CurrencyExchange22__1) o.getCcy() != null ? 1 : 0, 0, 1), 
				checkCardinality("optn", (OptionOrSwaption11__2) o.getOptn() != null ? 1 : 0, 0, 1), 
