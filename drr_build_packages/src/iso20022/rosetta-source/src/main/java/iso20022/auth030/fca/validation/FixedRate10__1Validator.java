...
public class FixedRate10__1Validator implements Validator<FixedRate10__1> {
	...
	private List<ComparisonResult> getComparisonResults(FixedRate10__1 o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("rate", (SecuritiesTransactionPrice14Choice__1) o.getRate() != null ? 1 : 0, 1, 1), 
				checkCardinality("dayCnt", (InterestComputationMethodFormat7__1) o.getDayCnt() != null ? 1 : 0, 1, 1), 
				checkCardinality("pmtFrqcy", (InterestRateFrequency3Choice__1) o.getPmtFrqcy() != null ? 1 : 0, 1, 1)
			);
	}
