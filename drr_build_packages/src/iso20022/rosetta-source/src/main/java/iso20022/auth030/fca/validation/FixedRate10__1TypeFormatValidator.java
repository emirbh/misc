		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FixedRate10__1", ValidationResult.ValidationType.TYPE_FORMAT, "FixedRate10__1", path, "", res.getError());
				}
				return success("FixedRate10__1", ValidationResult.ValidationType.TYPE_FORMAT, "FixedRate10__1", path, "");
			})
			.collect(toList());
	}
