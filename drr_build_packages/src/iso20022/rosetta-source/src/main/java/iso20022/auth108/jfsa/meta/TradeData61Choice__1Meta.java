...
import iso20022.auth108.jfsa.validation.TradeData61Choice__1TypeFormatValidator;
import iso20022.auth108.jfsa.validation.TradeData61Choice__1Validator;
import iso20022.auth108.jfsa.validation.datarule.TradeData61Choice__1Choice;
import iso20022.auth108.jfsa.validation.exists.TradeData61Choice__1OnlyExistsValidator;
...
public class TradeData61Choice__1Meta implements RosettaMetaData<TradeData61Choice__1> {
	...
	public List<Validator<? super TradeData61Choice__1>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<TradeData61Choice__1>create(TradeData61Choice__1Choice.class)
		);
	}
