...
public class NaturalPersonIdentification3__3Validator implements Validator<NaturalPersonIdentification3__3> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("NaturalPersonIdentification3__3", ValidationResult.ValidationType.CARDINALITY, "NaturalPersonIdentification3__3", path, "", res.getError());
				}
				return success("NaturalPersonIdentification3__3", ValidationResult.ValidationType.CARDINALITY, "NaturalPersonIdentification3__3", path, "");
			})
			.collect(toList());
	}
