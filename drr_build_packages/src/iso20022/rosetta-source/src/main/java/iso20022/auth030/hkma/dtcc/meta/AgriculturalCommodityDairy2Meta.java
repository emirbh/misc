...
import iso20022.auth030.hkma.dtcc.validation.AgriculturalCommodityDairy2TypeFormatValidator;
import iso20022.auth030.hkma.dtcc.validation.AgriculturalCommodityDairy2Validator;
import iso20022.auth030.hkma.dtcc.validation.exists.AgriculturalCommodityDairy2OnlyExistsValidator;
...
public class AgriculturalCommodityDairy2Meta implements RosettaMetaData<AgriculturalCommodityDairy2> {
	...
	@Override
	public Validator<? super AgriculturalCommodityDairy2> validator(ValidatorFactory factory) {
		return factory.<AgriculturalCommodityDairy2>create(AgriculturalCommodityDairy2Validator.class);
	}

	@Override
	public Validator<? super AgriculturalCommodityDairy2> typeFormatValidator(ValidatorFactory factory) {
		return factory.<AgriculturalCommodityDairy2>create(AgriculturalCommodityDairy2TypeFormatValidator.class);
	}
