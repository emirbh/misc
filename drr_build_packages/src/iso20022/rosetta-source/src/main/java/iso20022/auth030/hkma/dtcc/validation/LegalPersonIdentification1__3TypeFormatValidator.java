		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LegalPersonIdentification1__3", ValidationResult.ValidationType.TYPE_FORMAT, "LegalPersonIdentification1__3", path, "", res.getError());
				}
				return success("LegalPersonIdentification1__3", ValidationResult.ValidationType.TYPE_FORMAT, "LegalPersonIdentification1__3", path, "");
			})
			.collect(toList());
	}
