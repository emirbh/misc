		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeTransaction49__1", ValidationResult.ValidationType.TYPE_FORMAT, "TradeTransaction49__1", path, "", res.getError());
				}
				return success("TradeTransaction49__1", ValidationResult.ValidationType.TYPE_FORMAT, "TradeTransaction49__1", path, "");
			})
			.collect(toList());
	}
