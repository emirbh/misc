...
public class TradeTransaction49__7Validator implements Validator<TradeTransaction49__7> {
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeTransaction49__7", ValidationResult.ValidationType.CARDINALITY, "TradeTransaction49__7", path, "", res.getError());
				}
				return success("TradeTransaction49__7", ValidationResult.ValidationType.CARDINALITY, "TradeTransaction49__7", path, "");
			})
			.collect(toList());
	}
