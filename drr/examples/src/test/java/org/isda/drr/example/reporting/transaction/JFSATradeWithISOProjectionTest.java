...
final class JFSATradeWithISOProjectionTest extends AbstractReportingTest {
    ...
    void JFSATradeWithISOProjectionExampleTest() throws IOException {
        ...
        JFSATransactionReport report = runReport(transactionReportInstruction);
     ...
     */
    private JFSATransactionReport runReport(TransactionReportInstruction transactionReportInstruction) throws IOException {

        // Generate the JFSA transaction report
        final JFSATransactionReport report = reportFunc.evaluate(transactionReportInstruction);
