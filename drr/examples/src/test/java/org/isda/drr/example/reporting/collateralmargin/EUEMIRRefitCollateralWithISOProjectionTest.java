...
final class EUEMIRRefitCollateralWithISOProjectionTest extends AbstractReportingTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EUEMIRRefitCollateralWithISOProjectionTest.class);
    ...
    void EUEMIRCollateralWithISOProjectionExampleTest() throws IOException {
        ...
        ESMAEMIRMarginReport report = runReport(collateralReportInstruction);
     ...
     */
    ESMAEMIRMarginReport runReport(CollateralReportInstruction collateralReportInstruction) throws IOException {

        // Generate the EMIR margin report
        final ESMAEMIRMarginReport report = reportFunc.evaluate(collateralReportInstruction);
