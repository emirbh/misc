...
final class UKEMIRCollateralWithISOProjectionTest extends AbstractReportingTest {
    ...
    void UKEMIRCollateralWithISOProjectionExampleTest() throws IOException {
        ...
        FCAUKEMIRMarginReport report = runReport(collateralReportInstruction);
     ...
     */
    FCAUKEMIRMarginReport runReport(CollateralReportInstruction collateralReportInstruction) throws IOException {

        // Generate the UK EMIR margin report
        final FCAUKEMIRMarginReport report = reportFunc.evaluate(collateralReportInstruction);
