...
final class HKMACollateralWithISOProjectionTest extends AbstractReportingTest {
    ...
    private HKMAMarginReport HKMAMarginReport() throws IOException {
        ...
        HKMAMarginReport report = runReport(collateralReportInstruction);
     ...
     */
    HKMAMarginReport runReport(CollateralReportInstruction collateralReportInstruction) throws IOException {

        // Generate the HKMA margin report
        final HKMAMarginReport report = reportFunc.evaluate(collateralReportInstruction);
