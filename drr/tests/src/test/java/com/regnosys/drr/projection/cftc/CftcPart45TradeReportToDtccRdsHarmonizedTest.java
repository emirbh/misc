package com.regnosys.drr.projection.cftc;
...
public class CftcPart45TradeReportToDtccRdsHarmonizedTest {
    @RegisterExtension
    static TransformTestExtension<Project_CftcPart45TradeReportToDtccRdsHarmonized> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_CftcPart45TradeReportToDtccRdsHarmonized.class)
