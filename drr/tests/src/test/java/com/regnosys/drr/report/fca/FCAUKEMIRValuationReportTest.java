package com.regnosys.drr.report.fca;
...
public class FCAUKEMIRValuationReportTest {
    @RegisterExtension
    static TransformTestExtension<FCAUKEMIRValuationReportFunction> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    REPORT_CONFIG_PATH,
                    FCAUKEMIRValuationReportFunction.class);
