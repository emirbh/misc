...
public class EsmaEmirValuationIso20022ReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_EsmaEmirValuationReportToIso20022> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_EsmaEmirValuationReportToIso20022.class)
