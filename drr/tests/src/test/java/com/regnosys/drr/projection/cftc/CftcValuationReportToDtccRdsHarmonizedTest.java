...
public class CftcValuationReportToDtccRdsHarmonizedTest {
    @RegisterExtension
    static TransformTestExtension<Project_CFTCValuationReportToDtccRdsHarmonized> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_CFTCValuationReportToDtccRdsHarmonized.class)
