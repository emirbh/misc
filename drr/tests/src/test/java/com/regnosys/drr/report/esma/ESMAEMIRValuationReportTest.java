...
public class ESMAEMIRValuationReportTest {
    @RegisterExtension
    static TransformTestExtension<ESMAEMIRValuationReportFunction> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    REPORT_CONFIG_PATH,
                    ESMAEMIRValuationReportFunction.class);
