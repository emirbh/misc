package com.regnosys.drr.projection.fca;
...
public class FcaUkEmirValuationIso20022ReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_FcaUkEmirValuationReportToIso20022> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_FcaUkEmirValuationReportToIso20022.class)
                    .withSchemaValidation(Resources.getResource(Auth030FcaModelConfig.SCHEMA_PATH));
