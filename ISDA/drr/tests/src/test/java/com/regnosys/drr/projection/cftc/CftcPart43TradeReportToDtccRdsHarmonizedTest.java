...
public class CftcPart43TradeReportToDtccRdsHarmonizedTest {
    @RegisterExtension
    static TransformTestExtension<Project_CftcPart43TradeReportToDtccRdsHarmonized> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_CftcPart43TradeReportToDtccRdsHarmonized.class)
