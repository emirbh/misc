...
val transformCommodityDeliverySwap: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
...
val transformEtd10YearNoteFuture: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformEtd10YearNoteOption: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformEtdCocoaFuture: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformEtdCocoaOption: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
        val acceptedReportableEvent = accept(transformEtdHelper.getEtdCocoaOption(reportableEvent))
        return transformTransactionHelper.createTransactionReportInstructionSelf(acceptedReportableEvent)
    }
val transformEtdFutureSecurityProduct: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformEtdOptionSecurityProduct: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformEstrFeaturesCme: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformEstrOptionCme: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformGoldFutureEtd: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformGoldOptionEtd: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformSocGenEquityListedOption: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
...
val transformSocGenEquityListedFuture: (String) -> TransactionReportInstruction =
    fun(input): TransactionReportInstruction {
        val reportableEvent = deserializeRosettaObject(ReportableEvent::class.java)(input)
