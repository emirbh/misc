package com.regnosys.drr.report.cftc;
...
public class CftcValuationReportTest {

    @RegisterExtension
    static TransformTestExtension<CFTCValuationReportFunction> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    REPORT_CONFIG_PATH,
                    CFTCValuationReportFunction.class);
