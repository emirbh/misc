package com.regnosys.drr.report.sec;
...
public class SECTradeReportTest {

    @RegisterExtension
    static TransformTestExtension<SECTradeReportFunction> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    REPORT_CONFIG_PATH,
                    SECTradeReportFunction.class);
