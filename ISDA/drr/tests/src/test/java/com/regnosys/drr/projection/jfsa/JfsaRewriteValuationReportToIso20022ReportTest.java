package com.regnosys.drr.projection.jfsa;
...
public class JfsaRewriteValuationReportToIso20022ReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_JFSARewriteValuationReportToIso20022> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_JFSARewriteValuationReportToIso20022.class)
