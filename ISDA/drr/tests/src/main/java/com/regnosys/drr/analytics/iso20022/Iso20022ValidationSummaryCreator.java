...
class Iso20022ValidationSummaryCreator {
    ...
    public static final TransformData EMIR_VALUATION = new TransformData(Project_EsmaEmirValuationReportToIso20022.class, Auth030EsmaModelConfig.SCHEMA_PATH);
    ...
    public static final TransformData FCA_UKEMIR_VALUATION = new TransformData(Project_FcaUkEmirValuationReportToIso20022.class, Auth030FcaModelConfig.SCHEMA_PATH);
    ...
    public static final TransformData JFSA_VALUATION = new TransformData(Project_JFSARewriteValuationReportToIso20022.class, Auth030JfsaModelConfig.SCHEMA_PATH);
