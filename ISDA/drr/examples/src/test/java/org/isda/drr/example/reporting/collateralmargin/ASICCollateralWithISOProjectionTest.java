...
final class ASICCollateralWithISOProjectionTest extends AbstractReportingTest {
    ...
    void ASICCollateralWithISOProjectionExampleTest() throws IOException {
        ...
        ASICMarginReport report = runReport(collateralReportInstruction);
     ...
     */
    ASICMarginReport runReport(CollateralReportInstruction collateralReportInstruction) throws IOException {

        // Generate the ASIC margin report
        final ASICMarginReport report = reportFunc.evaluate(collateralReportInstruction);
