...
final class HKMATradeWithISOProjectionTest extends AbstractReportingTest {
    ...
    private HKMATransactionReport HKMATradeReport() throws IOException {
        ...
        HKMATransactionReport report = runReport(transactionReportInstruction);
     ...
     */
    private HKMATransactionReport runReport(TransactionReportInstruction transactionReportInstruction) throws IOException {
        // Generate the HKMA transaction report
        final HKMATransactionReport report = reportFunc.evaluate(transactionReportInstruction);
