...
final class MASTradeWithISOProjectionTest extends AbstractReportingTest {
    ...
    void MasTradeWithISOProjectionExampleTest() throws IOException {
        ...
        MASTransactionReport report = runReport(transactionReportInstruction);
     ...
     */
    private MASTransactionReport runReport(TransactionReportInstruction transactionReportInstruction) throws IOException {

        // Generate the MAS transaction report
        final MASTransactionReport report = reportFunc.evaluate(transactionReportInstruction);
