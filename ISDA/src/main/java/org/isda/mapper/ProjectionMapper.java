 ...
 * (ISO 20022 XML for ESMA/FCA, DTCC RDS Harmonized XML for CFTC).
 */
public final class ProjectionMapper {
    ...
    public ProjectionMapper(Injector injector) {
        ...
        this.cftcPart45Projection = injector.getInstance(Project_CftcPart45TradeReportToDtccRdsHarmonized.class);
        this.cftcPart43Projection = injector.getInstance(Project_CftcPart43TradeReportToDtccRdsHarmonized.class);
    }
